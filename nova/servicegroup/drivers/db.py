...
op|':'
newline|'\n'
comment|'# need to catch DB type errors'
nl|'\n'
indent|'            '
name|'exc_cls'
op|'='
...
op|'.'
name|'DBError'
comment|'# oslo.db exception base class'
newline|'\n'
dedent|''
name|'else'
op|':'
newline|'\n'
comment|'# need to catch messaging timeouts'
nl|'\n'
indent|'            '
name|'exc_cls'
op|'='
...
name|'_LI'
op|'('
string|"'Recovered connection to nova-conductor '"
nl|'\n'
...
newline|'\n'
nl|'\n'
comment|'# the type of failure depends on use of remote or local conductor'
nl|'\n'
dedent|''
dedent|''
name|'except'
