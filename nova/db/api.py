...
newline|'\n'
indent|'    '
string|'"""Get an computeService or raise if it does not exist."""'
newline|'\n'
name|'return'
name|'IMPL'
op|'.'
...
newline|'\n'
indent|'    '
string|'"""Create a computeService from the values dictionary."""'
newline|'\n'
name|'return'
name|'IMPL'
op|'.'
...
newline|'\n'
indent|'    '
string|'"""Set the given properties on an computeService and update it.\n\n    Raises NotFound if computeService does not exist.\n\n    """'
newline|'\n'
nl|'\n'
name|'return'
name|'IMPL'
