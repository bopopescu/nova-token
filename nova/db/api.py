...
newline|'\n'
indent|'    '
string|'"""Get (instance_count, total_cores, total_ram) for user."""'
newline|'\n'
name|'return'
name|'IMPL'
op|'.'
...
newline|'\n'
indent|'    '
string|'"""Create a quota for the given user and project."""'
newline|'\n'
name|'return'
name|'IMPL'
op|'.'
...
newline|'\n'
indent|'    '
string|'"""Retrieve all quotas associated with a given user and project."""'
newline|'\n'
name|'return'
name|'IMPL'
op|'.'
...
newline|'\n'
indent|'    '
string|'"""Retrieve the remaining quotas associated with a given project."""'
newline|'\n'
name|'return'
name|'IMPL'
op|'.'
...
newline|'\n'
indent|'    '
string|'"""Destroy the quota class or raise if it does not exist."""'
newline|'\n'
name|'return'
name|'IMPL'
op|'.'
...
newline|'\n'
indent|'    '
string|'"""Destroy all quotas associated with a given quota class."""'
newline|'\n'
name|'return'
name|'IMPL'
op|'.'
...
newline|'\n'
indent|'    '
string|'"""Create a quota usage for the given user and resource."""'
newline|'\n'
name|'return'
name|'IMPL'
op|'.'
...
newline|'\n'
indent|'    '
string|'"""Retrieve all usage associated with a given user."""'
newline|'\n'
name|'return'
name|'IMPL'
op|'.'
...
newline|'\n'
indent|'    '
string|'"""Destroy the quota usage or raise if it does not exist."""'
newline|'\n'
name|'return'
name|'IMPL'
op|'.'
...
newline|'\n'
indent|'    '
string|'"""Create a reservation for the given user and resource."""'
newline|'\n'
name|'return'
name|'IMPL'
op|'.'
...
newline|'\n'
indent|'    '
string|'"""Retrieve all reservations associated with a given user."""'
newline|'\n'
name|'return'
name|'IMPL'
op|'.'
...
newline|'\n'
indent|'    '
string|'"""Destroy all quotas associated with a given user."""'
newline|'\n'
name|'return'
name|'IMPL'
op|'.'
...
newline|'\n'
indent|'    '
string|'"""Get (volume_count, gigabytes) for user."""'
newline|'\n'
name|'return'
name|'IMPL'
op|'.'
...
newline|'\n'
indent|'    '
string|'"""Get all volumes belonging to an instance."""'
newline|'\n'
name|'return'
name|'IMPL'
op|'.'
...
newline|'\n'
indent|'    '
string|'"""Set the given properties on a volume and update it.\n\n    Raises NotFound if volume does not exist.\n\n    """'
newline|'\n'
name|'return'
name|'IMPL'
op|'.'
...
newline|'\n'
indent|'    '
string|'"""Get all snapshots for a volume."""'
newline|'\n'
name|'return'
name|'IMPL'
op|'.'
...
newline|'\n'
indent|'    '
string|'"""Set the given properties on a snapshot and update it.\n\n    Raises NotFound if snapshot does not exist.\n\n    """'
newline|'\n'
name|'return'
name|'IMPL'
op|'.'
...
newline|'\n'
indent|'    '
string|'"""Get all security groups belonging to a user."""'
newline|'\n'
name|'return'
name|'IMPL'
op|'.'
...
newline|'\n'
indent|'    '
string|'"""Count number of security groups for a user in specific project."""'
newline|'\n'
name|'return'
name|'IMPL'
op|'.'
...
newline|'\n'
indent|'    '
string|'"""Delete the given system metadata item."""'
newline|'\n'
name|'IMPL'
op|'.'
name|'instance_system_metadata_delete'
...
newline|'\n'
indent|'    '
string|'"""Get all the volumes inside the window.\n\n    Specifying a project_id will filter for a certain project."""'
newline|'\n'
name|'return'
name|'IMPL'
op|'.'
...
newline|'\n'
indent|'    '
string|'"""Get a specific SM Flavor given label."""'
newline|'\n'
name|'return'
name|'IMPL'
op|'.'
