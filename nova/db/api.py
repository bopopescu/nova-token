...
string|"'backend'"
op|','
string|"'nova.openstack.common.db.options'"
op|','
nl|'\n'
DECL|variable|group
name|'group'
...
nl|'\n'
nl|'\n'
DECL|function|instance_extra_create
dedent|''
name|'def'
name|'instance_extra_create'
op|'('
name|'context'
op|','
name|'values'
...
newline|'\n'
indent|'    '
string|'"""Create the instance extra data record\n    """'
newline|'\n'
name|'return'
name|'IMPL'
op|'.'
