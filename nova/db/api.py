...
nl|'\n'
nl|'\n'
DECL|function|compute_node_get_by_service_id
dedent|''
name|'def'
...
nl|'\n'
nl|'\n'
DECL|function|aggregate_metadata_get_by_metadata_key
dedent|''
name|'def'
...
newline|'\n'
indent|'    '
string|'"""Get metadata for an aggregate by metadata key."""'
newline|'\n'
name|'return'
name|'IMPL'
op|'.'
