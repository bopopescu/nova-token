...
newline|'\n'
nl|'\n'
comment|'# The maximum value a signed INT type may have'
nl|'\n'
DECL|variable|MAX_INT
name|'MAX_INT'
op|'='
number|'0x7FFFFFFF'
newline|'\n'
...
newline|'\n'
indent|'    '
string|'"""Return a context manager for a cell database connection."""'
newline|'\n'
name|'return'
name|'IMPL'
op|'.'
...
newline|'\n'
indent|'    '
string|'"""Get the minimum service version in the database."""'
newline|'\n'
name|'return'
name|'IMPL'
op|'.'
...
newline|'\n'
indent|'    '
string|'"""Get a service by hostname and topic it listens to."""'
newline|'\n'
name|'return'
name|'IMPL'
op|'.'
...
newline|'\n'
indent|'    '
string|'"""Get a service by hostname and binary."""'
newline|'\n'
name|'return'
name|'IMPL'
op|'.'
...
nl|'\n'
nl|'\n'
comment|'# TODO(edleafe): remove once the compute node resource provider migration is'
nl|'\n'
comment|'# complete, and this distinction is no longer necessary.'
nl|'\n'
...
newline|'\n'
indent|'    '
string|'"""Get compute nodes by host name\n\n    :param context: The security context (admin)\n    :param host: Name of the host\n\n    :returns: List of dictionaries each containing compute node properties\n    """'
newline|'\n'
name|'return'
name|'IMPL'
op|'.'
...
newline|'\n'
indent|'    '
string|'"""Delete a compute node from the database.\n\n    :param context: The security context\n    :param compute_id: ID of the compute node\n\n    Raises ComputeHostNotFound if compute node with the given ID doesn\'t exist.\n    """'
newline|'\n'
name|'return'
name|'IMPL'
op|'.'
...
newline|'\n'
indent|'    '
string|'"""Get a list of all dnsdomains in our database."""'
newline|'\n'
name|'return'
name|'IMPL'
op|'.'
...
newline|'\n'
indent|'    '
string|'"""Finds a migration by the migration id and the instance uuid."""'
newline|'\n'
name|'return'
name|'IMPL'
op|'.'
...
newline|'\n'
indent|'    '
string|'"""Finds all unconfirmed migrations within the confirmation window for\n    a specific destination compute host.\n    """'
newline|'\n'
name|'return'
name|'IMPL'
op|'.'
...
newline|'\n'
indent|'    '
string|'"""Finds all migrations of an instance in progress."""'
newline|'\n'
name|'return'
name|'IMPL'
op|'.'
...
newline|'\n'
comment|'# Note: This function exists for backwards compatibility since calls to'
nl|'\n'
comment|'# the instance layer coming in over RPC may specify the single sort'
nl|'\n'
comment|'# key/direction values; in this case, this function is invoked instead'
nl|'\n'
comment|"# of the 'instance_get_all_by_filters_sort' function."
nl|'\n'
name|'return'
name|'IMPL'
op|'.'
...
newline|'\n'
indent|'    '
string|'"""Get all instances that match all filters sorted by multiple keys.\n\n    sort_keys and sort_dirs must be a list of strings.\n    """'
newline|'\n'
name|'return'
name|'IMPL'
op|'.'
...
newline|'\n'
indent|'    '
string|'"""Get instances with rules granted to them by a list of secgroups ids."""'
newline|'\n'
name|'return'
name|'IMPL'
op|'.'
...
newline|'\n'
indent|'    '
string|'"""Get the group an instance is a member of."""'
newline|'\n'
name|'return'
name|'IMPL'
op|'.'
...
newline|'\n'
indent|'    '
string|'"""Retrieve the names of resources whose quotas are calculated on a\n       per-project rather than a per-user basis.\n    """'
newline|'\n'
name|'return'
name|'IMPL'
op|'.'
...
newline|'\n'
indent|'    '
string|'"""Get all block device mapping belonging to a list of instances."""'
newline|'\n'
name|'return'
name|'IMPL'
op|'.'
...
newline|'\n'
indent|'    '
string|'"""Get block device mapping for a given volume."""'
newline|'\n'
name|'return'
name|'IMPL'
op|'.'
...
newline|'\n'
indent|'    '
string|'"""Get block device mapping for a given volume ID and instance UUID."""'
newline|'\n'
name|'return'
name|'IMPL'
op|'.'
...
newline|'\n'
indent|'    '
string|'"""Get all rules for a given instance."""'
newline|'\n'
name|'return'
name|'IMPL'
op|'.'
...
newline|'\n'
indent|'    '
string|'"""Get all instance flavors."""'
newline|'\n'
name|'return'
name|'IMPL'
op|'.'
...
newline|'\n'
indent|'    '
string|'"""Get PCI device by address."""'
newline|'\n'
name|'return'
name|'IMPL'
op|'.'
...
newline|'\n'
indent|'    '
string|'"""Get all PCI devices for one host."""'
newline|'\n'
name|'return'
name|'IMPL'
op|'.'
...
newline|'\n'
indent|'    '
string|'"""Get PCI devices allocated to instance."""'
newline|'\n'
name|'return'
name|'IMPL'
op|'.'
...
newline|'\n'
indent|'    '
string|'"""Get all PCI devices by parent address."""'
newline|'\n'
name|'return'
name|'IMPL'
op|'.'
...
newline|'\n'
indent|'    '
string|'"""Delete a PCI device record."""'
newline|'\n'
name|'return'
name|'IMPL'
op|'.'
...
nl|'\n'
nl|'\n'
DECL|function|computenode_uuids_online_data_migration
dedent|''
name|'def'
...
newline|'\n'
indent|'    '
string|'"""Add tag to the instance."""'
newline|'\n'
name|'return'
name|'IMPL'
op|'.'
...
newline|'\n'
indent|'    '
string|'"""Replace all of the instance tags with specified list of tags."""'
newline|'\n'
name|'return'
name|'IMPL'
op|'.'
...
newline|'\n'
indent|'    '
string|'"""Get all tags for a given instance."""'
newline|'\n'
name|'return'
name|'IMPL'
op|'.'
...
newline|'\n'
indent|'    '
string|'"""Delete specified tag from the instance."""'
newline|'\n'
name|'return'
name|'IMPL'
op|'.'
...
newline|'\n'
indent|'    '
string|'"""Delete all tags from the instance."""'
newline|'\n'
name|'return'
name|'IMPL'
op|'.'
...
newline|'\n'
indent|'    '
string|'"""Check if specified tag exist on the instance."""'
newline|'\n'
name|'return'
name|'IMPL'
op|'.'
