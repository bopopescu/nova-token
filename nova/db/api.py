...
nl|'\n'
nl|'\n'
DECL|function|instance_get_by_ip
dedent|''
name|'def'
...
newline|'\n'
indent|'    '
string|'"""Gets an instance by fixed ipaddress or raise if it does not exist."""'
newline|'\n'
name|'return'
name|'_impl'
op|'.'
...
newline|'\n'
indent|'    '
string|'"""Gets all instance belonging to a project."""'
newline|'\n'
name|'return'
name|'_impl'
op|'.'
...
newline|'\n'
indent|'    '
string|'"""Gets all instance belonging to a reservation."""'
newline|'\n'
name|'return'
name|'_impl'
op|'.'
