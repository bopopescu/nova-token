...
name|'DEFINE_string'
op|'('
string|"'vsa_name_template'"
op|','
string|"'vsa-%08x'"
op|','
nl|'\n'
string|"'Template string to be used to generate VSA names'"
op|')'
newline|'\n'
nl|'\n'
DECL|variable|IMPL
...
newline|'\n'
indent|'    '
string|'"""Get all allocated fixed ips filtered by instance host."""'
newline|'\n'
name|'return'
name|'IMPL'
op|'.'
...
newline|'\n'
indent|'    '
string|'"""Gets all virtual interfaces on network."""'
newline|'\n'
name|'return'
name|'IMPL'
op|'.'
...
newline|'\n'
indent|'    '
string|'"""Stop the instance or raise if it does not exist."""'
newline|'\n'
name|'return'
name|'IMPL'
op|'.'
...
newline|'\n'
indent|'    '
string|'"""Get an instance for a fixed ip by IPv6 address."""'
newline|'\n'
name|'return'
name|'IMPL'
op|'.'
...
newline|'\n'
indent|'    '
string|'"""Purges (removes) an instance type from DB.\n\n    Use instance_type_destroy for most cases\n\n    """'
newline|'\n'
name|'return'
name|'IMPL'
op|'.'
...
newline|'\n'
indent|'    '
string|'"""Purges (removes) a volume type from DB.\n\n    Use volume_type_destroy for most cases\n\n    """'
newline|'\n'
name|'return'
name|'IMPL'
op|'.'
...
newline|'\n'
indent|'    '
string|'"""Creates Virtual Storage Array record."""'
newline|'\n'
name|'return'
name|'IMPL'
op|'.'
...
newline|'\n'
indent|'    '
string|'"""Updates Virtual Storage Array record."""'
newline|'\n'
name|'return'
name|'IMPL'
op|'.'
...
newline|'\n'
indent|'    '
string|'"""Deletes Virtual Storage Array record."""'
newline|'\n'
name|'return'
name|'IMPL'
op|'.'
...
newline|'\n'
indent|'    '
string|'"""Get Virtual Storage Array record by ID."""'
newline|'\n'
name|'return'
name|'IMPL'
op|'.'
...
newline|'\n'
indent|'    '
string|'"""Get all Virtual Storage Array records."""'
newline|'\n'
name|'return'
name|'IMPL'
op|'.'
...
newline|'\n'
indent|'    '
string|'"""Get all Virtual Storage Array records by project ID."""'
newline|'\n'
name|'return'
name|'IMPL'
op|'.'
