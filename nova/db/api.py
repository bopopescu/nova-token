...
newline|'\n'
indent|'    '
string|'"""Create a floating ip for a given address on the specified host."""'
newline|'\n'
name|'return'
name|'IMPL'
op|'.'
...
newline|'\n'
indent|'    '
string|'"""Get security groups owned by the given user"""'
newline|'\n'
name|'return'
name|'IMPL'
op|'.'
...
newline|'\n'
indent|'    '
string|'"""Get user\'s named security group"""'
newline|'\n'
name|'return'
name|'IMPL'
op|'.'
