...
op|':'
newline|'\n'
comment|'# NOTE(dprince): We should remove this conditional when we compress 201'
nl|'\n'
comment|'# which also adds an index on instances.uuid'
nl|'\n'
nl|'\n'
comment|'# NOTE(dprince): This is a bit of a hack to avoid changing migration'
nl|'\n'
comment|'# 201... but also keep test_archive_deleted_rows_fk_constraint'
nl|'\n'
comment|'# passing. Not having this cause fkey mismatch errors. We'
nl|'\n'
comment|'# name it differently to avoid causing failures in 201.'
nl|'\n'
comment|'# See comments here: https://review.openstack.org/#/c/54172/5'
nl|'\n'
indent|'        '
name|'Index'
op|'('
...
newline|'\n'
nl|'\n'
comment|'# NOTE(dprince): 185_rename_unique_constraints.py from Havana added'
nl|'\n'
comment|'# a duplicate index on the address column'
nl|'\n'
comment|'# We fix this in 192_change_virtual_interface_uc.py and will be addressed'
nl|'\n'
comment|'# in the next patchset in this series.'
nl|'\n'
name|'if'
name|'migrate_engine'
op|'.'
...
nl|'\n'
nl|'\n'
comment|'# instance group indexes'
nl|'\n'
name|'Index'
op|'('
...
newline|'\n'
nl|'\n'
comment|'# MySQL/PostgreSQL indexes'
nl|'\n'
name|'if'
name|'migrate_engine'
op|'.'
