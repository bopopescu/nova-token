...
nl|'\n'
nl|'\n'
comment|'# NOTE(dprince): We skip these columns for now.'
nl|'\n'
comment|'# These get cleaned up in 184_fix_159_migration_sync_shadow_table'
nl|'\n'
DECL|variable|_SHADOW_SKIPS
dedent|''
name|'_SHADOW_SKIPS'
op|'='
op|'['
...
op|':'
newline|'\n'
comment|'#NOTE(dprince): Skip for now. This is fixed in'
nl|'\n'
comment|'# 183_fix_157_migration_sync_shadow_table'
nl|'\n'
indent|'            '
name|'continue'
newline|'\n'
