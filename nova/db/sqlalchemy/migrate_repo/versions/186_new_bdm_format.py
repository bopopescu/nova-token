...
name|'instance_uuid'
op|','
name|'instance_image_ref'
op|','
name|'instance_root_device'
op|','
nl|'\n'
name|'bdm_id'
op|','
...
nl|'\n'
comment|'#                  a bootable volume still have consistent data.'
nl|'\n'
dedent|''
name|'bootable'
op|'='
