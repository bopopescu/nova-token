...
nl|'\n'
nl|'\n'
DECL|function|_create_shadow_tables
dedent|''
name|'def'
name|'_create_shadow_tables'
op|'('
name|'migrate_engine'
op|')'
op|':'
...
name|'name'
op|'='
string|"'shadow_instances0locked_by'"
op|')'
newline|'\n'
name|'column_copy'
op|'='
...
nl|'\n'
nl|'\n'
comment|'# NOTE(dprince): we add these here so our schema contains dump tables'
nl|'\n'
comment|'# which were added in migration 209 (in Havana). We can drop these in'
nl|'\n'
comment|'# Icehouse: https://bugs.launchpad.net/nova/+bug/1266538'
nl|'\n'
DECL|function|_create_dump_tables
dedent|''
dedent|''
name|'def'
name|'_create_dump_tables'
op|'('
name|'migrate_engine'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
comment|'# task log unique constraint'
nl|'\n'
dedent|''
dedent|''
name|'task_log_uc'
...
newline|'\n'
nl|'\n'
comment|'# networks unique constraint'
nl|'\n'
name|'UniqueConstraint'
op|'('
string|"'vlan'"
...
newline|'\n'
nl|'\n'
comment|'# instance_type_name constraint'
nl|'\n'
name|'UniqueConstraint'
op|'('
string|"'name'"
...
newline|'\n'
nl|'\n'
comment|'# flavorid unique constraint'
nl|'\n'
name|'UniqueConstraint'
op|'('
string|"'flavorid'"
...
newline|'\n'
nl|'\n'
comment|'# instance_type_projects constraint'
nl|'\n'
name|'inst_type_uc_name'
op|'='
string|"'uniq_instance_type_projects0instance_type_id0'"
op|'+'
string|"'project_id0deleted'"
newline|'\n'
name|'UniqueConstraint'
op|'('
string|"'instance_type_id'"
...
newline|'\n'
nl|'\n'
comment|'# floating_ips unique constraint'
nl|'\n'
name|'UniqueConstraint'
op|'('
string|"'address'"
...
name|'uc_name'
op|'='
string|"'uniq_instance_type_extra_specs0instance_type_id0key0deleted'"
newline|'\n'
name|'UniqueConstraint'
op|'('
string|"'instance_type_id'"
...
newline|'\n'
nl|'\n'
comment|'# created first (to preserve ordering for schema diffs)'
nl|'\n'
name|'mysql_pre_indexes'
op|'='
op|'['
nl|'\n'
name|'Index'
...
newline|'\n'
nl|'\n'
comment|'# created later (to preserve ordering for schema diffs)'
nl|'\n'
name|'mysql_post_indexes'
op|'='
op|'['
nl|'\n'
name|'Index'
...
newline|'\n'
nl|'\n'
comment|'# Common indexes (indexes we apply to all databases)'
nl|'\n'
comment|'# NOTE: order specific for MySQL diff support'
nl|'\n'
name|'common_indexes'
op|'='
op|'['
...
nl|'\n'
nl|'\n'
comment|'# NOTE(dprince): This is now a duplicate index on MySQL and needs to'
nl|'\n'
comment|'# be removed there. We leave it here so the Index ordering'
nl|'\n'
comment|'# matches on schema diffs (for MySQL).'
nl|'\n'
comment|'# See Havana migration 186_new_bdm_format where we dropped the'
nl|'\n'
comment|'# virtual_name column.'
nl|'\n'
comment|'# IceHouse fix is here: https://bugs.launchpad.net/nova/+bug/1265839'
nl|'\n'
name|'Index'
op|'('
nl|'\n'
...
newline|'\n'
nl|'\n'
comment|"# NOTE(dprince): PostgreSQL doesn't allow duplicate indexes"
nl|'\n'
comment|'# so we skip creation of select indexes (so schemas match exactly).'
nl|'\n'
dedent|''
name|'POSTGRES_INDEX_SKIPS'
op|'='
op|'['
nl|'\n'
comment|'# See Havana migration 186_new_bdm_format where we dropped the'
...
newline|'\n'
nl|'\n'
comment|'# special case for migrations_by_host_nodes_and_status_idx index'
nl|'\n'
name|'if'
name|'migrate_engine'
op|'.'
...
nl|'\n'
string|'"migrations (source_compute(100), dest_compute(100), "'
nl|'\n'
...
op|'('
string|"'Downgrade from Havana is unsupported.'"
op|')'
newline|'\n'
dedent|''
endmarker|''
