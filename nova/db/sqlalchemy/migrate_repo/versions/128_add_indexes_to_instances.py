...
newline|'\n'
nl|'\n'
comment|'# Based on service_get_all_compute_sorted'
nl|'\n'
...
newline|'\n'
nl|'\n'
comment|'# Based on instance_get_all_by_reservation'
nl|'\n'
comment|'# from: nova/db/sqlalchemy/api.py'
nl|'\n'
dedent|''
...
newline|'\n'
nl|'\n'
comment|'# Based on instance_get_active_by_window'
nl|'\n'
comment|'# from: nova/db/sqlalchemy/api.py'
nl|'\n'
dedent|''
...
newline|'\n'
nl|'\n'
comment|'# Based on security_group_in_use'
nl|'\n'
comment|'# from: nova/db/sqlalchemy/api.py'
nl|'\n'
dedent|''
...
newline|'\n'
nl|'\n'
comment|'# Based on instance_get_all_hung_in_rebooting'
nl|'\n'
comment|'# from: nova/db/sqlalchemy/api.py'
nl|'\n'
dedent|''
