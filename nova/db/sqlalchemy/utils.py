...
newline|'\n'
indent|'    '
string|'"""This method is used to drop all old rows that have the same values for\n    columns in uc_columns.\n    """'
newline|'\n'
name|'meta'
op|'='
name|'MetaData'
...
op|')'
newline|'\n'
comment|'# NOTE(I159): when the type of column `deleted` is changed from boolean'
nl|'\n'
comment|'# to int, the corresponding CHECK constraint is dropped too. But'
nl|'\n'
comment|'# starting from SQLAlchemy version 0.8.3, those CHECK constraints'
nl|'\n'
comment|"# aren't dropped anymore. So despite the fact that column deleted is"
nl|'\n'
comment|'# of type int now, we still restrict its values to be either 0 or 1.'
nl|'\n'
name|'constraint_markers'
op|'='
op|'('
nl|'\n'
...
op|','
nl|'\n'
string|'"deleted IN (:param_1, :param_2)"'
nl|'\n'
op|')'
newline|'\n'
name|'return'
