...
newline|'\n'
nl|'\n'
comment|'# TODO(ekudryashova): remove this after both nova and oslo.db'
nl|'\n'
comment|'# will use oslo.utils library'
nl|'\n'
comment|'# NOTE: Both projects(nova and oslo.db) use `timeutils.utcnow`, which'
nl|'\n'
comment|'# returns specified time(if override_time is set). Time overriding is'
nl|'\n'
comment|'# only used by unit tests, but in a lot of places, temporarily overriding'
nl|'\n'
comment|'# this columns helps to avoid lots of calls of timeutils.set_override'
nl|'\n'
comment|'# from different places in unit tests.'
nl|'\n'
...
nl|'\n'
comment|'# nova.virt.hardware.VirtNUMAHostTopology.to_json()'
nl|'\n'
...
nl|'\n'
comment|'# Duplicates `block_device_mapping_instance_uuid_device_name_idx`'
nl|'\n'
comment|'# index.'
nl|'\n'
name|'Index'
