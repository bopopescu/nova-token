...
newline|'\n'
indent|'    '
string|'"""Represates an iscsi target_id for a given host"""'
newline|'\n'
DECL|variable|__tablename__
name|'__tablename__'
op|'='
...
name|'primaryjoin'
op|'='
string|"'and_(TargetId.volume_id==Volume.id,'"
nl|'\n'
string|"'TargetId.deleted==False)'"
op|')'
newline|'\n'
nl|'\n'
nl|'\n'
...
newline|'\n'
indent|'    '
string|'"""Represents an authorization token for all API transactions. Fields\n    are a string representing the actual token and a user id for mapping\n    to the actual user"""'
newline|'\n'
DECL|variable|__tablename__
name|'__tablename__'
op|'='
