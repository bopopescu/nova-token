...
op|')'
newline|'\n'
comment|'# C: when calling service_create()'
nl|'\n'
comment|'# D: never deleted. instead of deleting cloumn "deleted" is true'
nl|'\n'
comment|'#    when host is down'
nl|'\n'
comment|'#    b/c Host.id is foreign key of service, and records'
nl|'\n'
comment|'#    of the "service" table are not deleted.'
nl|'\n'
comment|'# R: Column "deleted" is true when calling hosts_up() and host is down.'
nl|'\n'
nl|'\n'
nl|'\n'
DECL|class|Service
...
newline|'\n'
nl|'\n'
comment|'# To remember at which host a instance booted.'
nl|'\n'
comment|'# An instance may moved to other host by live migraiton.'
nl|'\n'
DECL|variable|launch_at
name|'launch_at'
op|'='
name|'Column'
op|'('
...
name|'create_engine'
newline|'\n'
comment|'#models = (Service, Instance, Volume, ExportDevice, IscsiTarget, FixedIp,'
nl|'\n'
comment|'#          FloatingIp, Network, SecurityGroup,'
nl|'\n'
comment|'#          SecurityGroupIngressRule, SecurityGroupInstanceAssociation,'
nl|'\n'
comment|'#          AuthToken, User, Project)  # , Image, Host'
nl|'\n'
name|'models'
op|'='
op|'('
