...
newline|'\n'
nl|'\n'
comment|'# FIXME(sbauza: Host field is nullable because some old Juno compute nodes'
nl|'\n'
comment|'# can still report stats from an old ResourceTracker without setting this'
nl|'\n'
comment|'# field.'
nl|'\n'
comment|'# This field has to be set non-nullable in a later cycle (probably Lxxx)'
nl|'\n'
comment|'# once we are sure that all compute nodes in production report it.'
nl|'\n'
DECL|variable|host
name|'host'
op|'='
...
newline|'\n'
nl|'\n'
comment|'# extra_resources is a json string containing arbitrary'
nl|'\n'
comment|'# data about additional resources.'
nl|'\n'
...
newline|'\n'
nl|'\n'
comment|'# json-encode string containing compute node statistics'
nl|'\n'
DECL|variable|stats
name|'stats'
op|'='
...
newline|'\n'
nl|'\n'
comment|'# json-encoded dict that contains NUMA topology as generated by'
nl|'\n'
comment|'# objects.NUMATopoloogy._to_json()'
nl|'\n'
...
newline|'\n'
nl|'\n'
comment|'# allocation ratios provided by the RT'
nl|'\n'
...
op|')'
newline|'\n'
DECL|variable|ephemeral_key_uuid
...
newline|'\n'
nl|'\n'
comment|"# NOTE(sbiswas7): 'scheduled_at' is still in the database"
nl|'\n'
comment|'# and can be removed in the future release.'
nl|'\n'
nl|'\n'
...
newline|'\n'
nl|'\n'
comment|'# This always refers to the availability_zone kwarg passed in /servers and'
nl|'\n'
comment|'# provided as an API option, not at all related to the host AZ the instance'
nl|'\n'
comment|'# belongs to.'
nl|'\n'
...
newline|'\n'
indent|'    '
string|'"""Represents a cache of information about an instance\n    """'
newline|'\n'
DECL|variable|__tablename__
name|'__tablename__'
op|'='
...
op|')'
newline|'\n'
DECL|variable|migration_context
...
name|'name'
op|'='
string|"'uniq_security_groups0project_id0'"
nl|'\n'
string|"'name0deleted'"
op|')'
op|','
...
op|')'
newline|'\n'
DECL|variable|memory_processed
...
op|')'
newline|'\n'
DECL|variable|memory_remaining
...
name|'name'
op|'='
string|'"uniq_aggregate_metadata0aggregate_id0key0deleted"'
nl|'\n'
op|')'
op|','
nl|'\n'
...
newline|'\n'
indent|'    '
string|'"""Represents a PCI host device that can be passed through to instances.\n    """'
newline|'\n'
DECL|variable|__tablename__
name|'__tablename__'
op|'='
...
newline|'\n'
nl|'\n'
comment|'# physical address of device domain:bus:slot.func (0000:09:01.1)'
nl|'\n'
DECL|variable|address
name|'address'
op|'='
...
newline|'\n'
nl|'\n'
comment|'# label is abstract device name, that is used to unify devices with the'
nl|'\n'
comment|'# same functionality with different addresses or host.'
nl|'\n'
DECL|variable|label
name|'label'
op|'='
...
op|')'
newline|'\n'
comment|'# the request_id is used to identify a device that is allocated for a'
nl|'\n'
comment|'# particular request'
nl|'\n'
DECL|variable|request_id
name|'request_id'
op|'='
...
string|"'and_('"
nl|'\n'
string|"'PciDevice.instance_uuid == Instance.uuid,'"
nl|'\n'
string|"'PciDevice.deleted == 0)'"
op|')'
newline|'\n'
nl|'\n'
nl|'\n'
...
newline|'\n'
indent|'    '
string|'"""Represents the tag for a resource."""'
newline|'\n'
nl|'\n'
DECL|variable|__tablename__
name|'__tablename__'
...
name|'primaryjoin'
op|'='
string|"'and_(Tag.resource_id == Instance.uuid,'"
nl|'\n'
string|"'Instance.deleted == 0)'"
op|','
nl|'\n'
...
newline|'\n'
indent|'    '
string|'"""Represents a mapping to a providers of resources."""'
newline|'\n'
nl|'\n'
DECL|variable|__tablename__
name|'__tablename__'
...
newline|'\n'
indent|'    '
string|'"""Represents a quantity of available resource."""'
newline|'\n'
nl|'\n'
DECL|variable|__tablename__
name|'__tablename__'
...
op|')'
newline|'\n'
DECL|variable|resource_provider_id
...
op|')'
newline|'\n'
DECL|variable|resource_class_id
...
op|')'
newline|'\n'
DECL|variable|resource_provider
...
op|'='
op|'('
string|"'and_(Inventory.resource_provider_id == '"
nl|'\n'
string|"'ResourceProvider.id)'"
op|')'
op|','
nl|'\n'
DECL|variable|foreign_keys
...
nl|'\n'
nl|'\n'
DECL|class|ResourceProviderAggregate
dedent|''
name|'class'
name|'ResourceProviderAggregate'
op|'('
name|'BASE'
op|','
name|'models'
...
newline|'\n'
indent|'    '
string|'"""Assocate a resource provider with an aggregate."""'
newline|'\n'
nl|'\n'
DECL|variable|__tablename__
name|'__tablename__'
