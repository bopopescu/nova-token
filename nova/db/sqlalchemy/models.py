...
op|','
nl|'\n'
comment|'# MySQL has a limit of 3072 bytes for an multi-column index. This'
nl|'\n'
comment|'# index ends up being larger than that using the utf-8 encoding.'
nl|'\n'
comment|'# Limiting the index to the prefixes will keep it under the limit.'
nl|'\n'
comment|'# FIXME(johannes): Is it MySQL or InnoDB that imposes the limit?'
nl|'\n'
name|'Index'
op|'('
