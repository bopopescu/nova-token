...
nl|'\n'
nl|'\n'
DECL|class|InstanceDiagnostics
dedent|''
name|'class'
...
newline|'\n'
indent|'    '
string|'"""Represents a guest VM\'s diagnostics"""'
newline|'\n'
DECL|variable|__tablename__
name|'__tablename__'
op|'='
string|'"instance_diagnostics"'
newline|'\n'
DECL|variable|id
name|'id'
op|'='
...
newline|'\n'
nl|'\n'
DECL|variable|memory_available
