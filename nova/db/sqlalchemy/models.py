...
name|'ForeignKey'
op|'('
string|"'virtual_storage_arrays.id'"
op|')'
op|','
nl|'\n'
name|'nullable'
...
newline|'\n'
nl|'\n'
comment|'#admin_pass = Column(String(255))'
nl|'\n'
nl|'\n'
comment|'#disks = relationship(VsaDiskAssociation,'
nl|'\n'
comment|"#                    backref=backref('vsa', uselist=False),"
nl|'\n'
comment|'#                    foreign_keys=id,'
nl|'\n'
comment|"#                    primaryjoin='and_(VsaDiskAssociation.vsa_id == '"
nl|'\n'
comment|"#                                'VirtualStorageArray.id)')"
nl|'\n'
nl|'\n'
nl|'\n'
...
newline|'\n'
indent|'    '
string|'"""Represents the known drive types (storage media)."""'
newline|'\n'
DECL|variable|__tablename__
name|'__tablename__'
op|'='
...
name|'primaryjoin'
op|'='
string|"'and_(Volume.drive_type_id == '"
nl|'\n'
string|"'DriveTypes.id)'"
op|')'
newline|'\n'
nl|'\n'
comment|'#'
nl|'\n'
comment|'#class VsaDiskAssociation(BASE, NovaBase):'
nl|'\n'
comment|'#    """associates drive types with Virtual Storage Arrays."""'
nl|'\n'
comment|"#    __tablename__ = 'vsa_disk_association'"
nl|'\n'
comment|'#'
nl|'\n'
comment|'#    id = Column(Integer, primary_key=True, autoincrement=True)'
nl|'\n'
comment|'#'
nl|'\n'
comment|"#    drive_type_id = Column(Integer, ForeignKey('drive_types.id'))"
nl|'\n'
comment|"#    vsa_id = Column(Integer, ForeignKey('virtual_storage_arrays.id'))"
nl|'\n'
comment|'#'
nl|'\n'
comment|'#    disk_num = Column(Integer, nullable=False) # number of disks'
nl|'\n'
nl|'\n'
nl|'\n'
DECL|class|Quota
...
newline|'\n'
nl|'\n'
comment|'# TODO(tr3buchet): cut the cord, removed foreign key and backrefs'
nl|'\n'
DECL|variable|instance_id
name|'instance_id'
op|'='
