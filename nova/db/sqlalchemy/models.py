...
name|'name'
op|'='
string|'"unique_virtual_interfaces0address"'
op|')'
op|','
nl|'\n'
op|')'
...
op|')'
newline|'\n'
comment|'# FIXME(comstud): username and password refer to the credentials'
nl|'\n'
comment|'# used for talking with the AMQP server within a particular cell.'
nl|'\n'
comment|'# This table needs cleanup to support more generic cells'
nl|'\n'
comment|'# communication (including via 0mq, for instance)'
nl|'\n'
DECL|variable|username
name|'username'
op|'='
