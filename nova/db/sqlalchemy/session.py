...
name|'_'
op|'('
string|'"Using postgresql/eventlet db_pool."'
op|')'
op|')'
newline|'\n'
name|'pool_args'
...
name|'_'
op|'('
string|'"SQLAlchemy Engine Arguments: %(engine_args)s"'
op|')'
op|'%'
name|'locals'
op|'('
...
name|'_'
op|'('
string|'"Eventlet Pool Arguments: %(pool_args)s"'
op|')'
op|'%'
name|'locals'
op|'('
