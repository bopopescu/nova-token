...
newline|'\n'
nl|'\n'
DECL|variable|connection_opts
name|'connection_opts'
op|'='
op|'['
nl|'\n'
name|'cfg'
...
nl|'\n'
nl|'\n'
DECL|variable|_MASTER_FACADE
name|'_MASTER_FACADE'
op|'='
name|'None'
newline|'\n'
DECL|variable|_SLAVE_FACADE
name|'_SLAVE_FACADE'
op|'='
name|'None'
newline|'\n'
...
newline|'\n'
nl|'\n'
comment|'# Retrieve ComputeNode, Service'
nl|'\n'
name|'compute_node'
op|'='
name|'models'
...
newline|'\n'
indent|'    '
string|'""":returns: a tuple of (models.FixedIp, models.Network, models.Instance)\n    """'
newline|'\n'
name|'try'
op|':'
newline|'\n'
