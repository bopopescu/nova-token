...
name|'require_context'
newline|'\n'
DECL|function|fixed_ip_get_by_instance_and_network
name|'def'
name|'fixed_ip_get_by_instance_and_network'
op|'('
name|'context'
op|','
name|'instance_id'
...
name|'exception'
op|'.'
name|'NoFixedIpFoundForMacAddress'
op|'('
name|'mac_id'
op|'='
name|'mac_id'
...
op|']'
newline|'\n'
comment|'# get project ids from instance'
nl|'\n'
name|'project_id'
op|'='
name|'instance_ref'
