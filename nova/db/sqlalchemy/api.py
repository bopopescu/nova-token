...
newline|'\n'
indent|'    '
string|'"""Return instances the match all filters"""'
newline|'\n'
nl|'\n'
DECL|function|_filter_by_ipv6
name|'def'
name|'_filter_by_ipv6'
op|'('
name|'instance'
op|','
name|'filter_re'
...
newline|'\n'
nl|'\n'
DECL|function|_filter_by_display_name
dedent|''
name|'def'
...
newline|'\n'
nl|'\n'
DECL|function|_filter_by_column
dedent|''
name|'def'
name|'_filter_by_column'
op|'('
name|'instance'
op|','
name|'filter_name'
...
newline|'\n'
nl|'\n'
comment|'# Filters that we can do along with the SQL query...'
nl|'\n'
dedent|''
dedent|''
name|'query_filter_funcs'
op|'='
op|'{'
nl|'\n'
string|"'project_id'"
