...
op|':'
newline|'\n'
comment|'# TODO(devcamcar): Change to decorate and check project_id separately.'
nl|'\n'
indent|'    '
name|'if'
name|'is_user_context'
...
nl|'\n'
comment|'# random idea for system user:'
nl|'\n'
comment|'#   ctx = context.system_user(on_behalf_of=user, read_deleted=False)'
nl|'\n'
comment|'# TODO(devcamcar): Rename to network_get_all_by_project'
nl|'\n'
