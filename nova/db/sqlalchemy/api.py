...
name|'_'
op|'('
string|'"%s does not exist or is not "'
nl|'\n'
string|'"a compute node."'
op|')'
op|'%'
name|'host'
op|')'
...
name|'_'
op|'('
string|"'No service for %(host)s, %(binary)s'"
op|')'
nl|'\n'
op|'%'
name|'locals'
...
name|'_'
op|'('
string|"'No fixed ips for this host defined'"
op|')'
op|')'
newline|'\n'
nl|'\n'
...
name|'require_context'
newline|'\n'
DECL|function|fixed_ip_get_all_by_instance
name|'def'
...
name|'_'
op|'('
string|"'No address for instance %s'"
op|')'
op|'%'
name|'instance_id'
op|')'
...
name|'require_context'
newline|'\n'
DECL|function|fixed_ip_get_all_by_mac_address
name|'def'
name|'fixed_ip_get_all_by_mac_address'
op|'('
name|'context'
op|','
name|'mac_address_id'
...
name|'_'
op|'('
string|"'No fixed_ips for mac_address_id %s'"
op|')'
op|'%'
nl|'\n'
name|'instance_id'
...
newline|'\n'
nl|'\n'
comment|'# get mac address row'
nl|'\n'
name|'mac_ref'
op|'='
name|'mac_address_get_by_address'
op|'('
name|'context'
op|','
name|'mac'
...
newline|'\n'
nl|'\n'
comment|'# look up instance based on instance_id from mac address row'
nl|'\n'
name|'result'
op|'='
name|'session'
...
name|'require_context'
newline|'\n'
DECL|function|mac_address_create
name|'def'
...
newline|'\n'
indent|'    '
string|'"""create a new mac address record in teh database\n\n    context = request context object\n    values = dict containing column values\n    """'
newline|'\n'
name|'mac_address_ref'
op|'='
name|'models'
op|'.'
name|'MacAddress'
...
op|')'
newline|'\n'
comment|"#    instance_id = values['instance_id']"
nl|'\n'
comment|"#    network_id = values['network_id']"
nl|'\n'
comment|'#'
nl|'\n'
comment|'#    session = get_session()'
nl|'\n'
comment|'#    with session.begin():'
nl|'\n'
comment|'#        instance = instance_get(context, instance_id, session=session)'
nl|'\n'
comment|'#        network = network_get(context, network_id, session=session)'
nl|'\n'
comment|'#        mac_address.instance = instance'
nl|'\n'
comment|'#        mac_address.network = network'
nl|'\n'
comment|'#        mac_address_ref.save(session=session)'
nl|'\n'
comment|'#    return mac_address_ref'
nl|'\n'
nl|'\n'
nl|'\n'
dedent|''
...
name|'require_context'
newline|'\n'
DECL|function|mac_address_get
name|'def'
name|'mac_address_get'
op|'('
name|'context'
op|','
name|'mac_address_id'
...
newline|'\n'
indent|'    '
string|'"""gets a mac address from the table\n\n    context = request context object\n    mac_address_id = id of the mac_address\n    """'
newline|'\n'
name|'session'
op|'='
name|'get_session'
...
name|'require_context'
newline|'\n'
DECL|function|mac_address_get_by_address
name|'def'
name|'mac_address_get_by_address'
op|'('
name|'context'
...
name|'require_context'
newline|'\n'
DECL|function|mac_address_get_by_fixed_ip
name|'def'
name|'mac_address_get_by_fixed_ip'
op|'('
name|'context'
op|','
name|'fixed_ip_id'
...
name|'require_context'
newline|'\n'
DECL|function|mac_address_get_all_by_instance
name|'def'
name|'mac_address_get_all_by_instance'
op|'('
name|'context'
op|','
name|'instance_id'
...
newline|'\n'
indent|'    '
string|'"""gets all mac addresses for instance\n\n    context = request context object\n    instance_id = instance to retreive macs for\n    """'
newline|'\n'
name|'session'
op|'='
name|'get_session'
...
name|'require_context'
newline|'\n'
DECL|function|mac_address_get_by_instance_and_network
name|'def'
...
newline|'\n'
indent|'    '
string|'"""gets mac address for instance that\'s associated with network"""'
newline|'\n'
name|'session'
op|'='
name|'get_session'
...
name|'require_admin_context'
newline|'\n'
DECL|function|mac_address_get_all_by_network
name|'def'
name|'mac_address_get_all_by_network'
op|'('
name|'context'
op|','
name|'network_id'
...
name|'require_context'
newline|'\n'
DECL|function|mac_address_delete
name|'def'
...
newline|'\n'
indent|'    '
string|'"""delete mac address record in teh database\n\n    context = request context object\n    instance_id = instance to remove macs for\n    """'
newline|'\n'
name|'ref'
op|'='
name|'mac_address_get_by_address'
...
name|'require_context'
newline|'\n'
DECL|function|mac_address_delete_by_instance
name|'def'
name|'mac_address_delete_by_instance'
op|'('
name|'context'
op|','
name|'instance_id'
...
newline|'\n'
indent|'    '
string|'"""delete mac address records in the database that are associated\n    with the instance given by instance_id\n\n    context = request context object\n    instance_id = instance to remove macs for\n    """'
newline|'\n'
name|'refs'
op|'='
name|'mac_address_get_all_by_instance'
...
op|']'
newline|'\n'
comment|'# get mac rows associated with instance'
nl|'\n'
name|'mac_refs'
op|'='
name|'mac_address_get_all_by_instance'
...
op|')'
newline|'\n'
comment|'# compile of list of the mac_addresses sorted by network id'
nl|'\n'
name|'macs'
op|'='
op|'['
...
op|']'
newline|'\n'
comment|'# combine prefixes and macs into (prefix,mac) pairs'
nl|'\n'
name|'prefix_mac_pairs'
op|'='
name|'zip'
op|'('
name|'prefixes'
...
op|')'
newline|'\n'
comment|'# return list containing ipv6 address for each pair'
nl|'\n'
name|'return'
op|'['
name|'utils'
...
name|'_'
op|'('
string|"'no keypair for user %(user_id)s,'"
nl|'\n'
string|"' name %(name)s'"
op|')'
op|'%'
...
name|'_'
op|'('
string|"'Network with cidr %s does not exist'"
op|')'
op|'%'
nl|'\n'
name|'cidr'
...
name|'_'
op|'('
string|"'No volume for instance %s'"
op|')'
op|'%'
name|'instance_id'
op|')'
...
name|'_'
op|'('
string|"'No security group named %(group_name)s'"
nl|'\n'
...
name|'_'
op|'('
string|'"No migration found with id %s"'
op|')'
nl|'\n'
op|'%'
name|'id'
...
name|'_'
op|'('
string|'"No migration found for instance "'
nl|'\n'
string|'"%(instance_id)s with status %(status)s"'
op|')'
op|'%'
name|'locals'
op|'('
...
name|'_'
op|'('
string|"'No console pool of type %(console_type)s '"
nl|'\n'
...
name|'_'
op|'('
string|'"No instance type with id %s"'
op|')'
op|'%'
name|'id'
op|')'
...
name|'_'
op|'('
string|'"No instance type with name %s"'
op|')'
op|'%'
name|'name'
op|')'
...
name|'_'
op|'('
string|'"No flavor with flavorid %s"'
op|')'
op|'%'
name|'id'
op|')'
...
name|'_'
op|'('
string|'"No zone with id %(zone_id)s"'
op|')'
op|'%'
name|'locals'
op|'('
...
name|'_'
op|'('
string|"'Invalid metadata key for instance %s'"
op|')'
op|'%'
nl|'\n'
name|'instance_id'
