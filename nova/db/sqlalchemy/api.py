...
name|'require_admin_context'
newline|'\n'
DECL|function|instance_set_lock
name|'def'
name|'instance_set_lock'
op|'('
name|'context'
op|','
name|'instance_id'
...
nl|'\n'
nl|'\n'
comment|'#@require_admin_context'
nl|'\n'
comment|'#def instance_is_locked(context, instance_id):'
nl|'\n'
comment|'#    """'
nl|'\n'
comment|"#    return the boolean state of (instance with instance_id)'s lock"
nl|'\n'
comment|'#'
nl|'\n'
comment|'#    """'
nl|'\n'
comment|'#    instance_ref = instance_get(context, instance_id)'
nl|'\n'
comment|"#    return instance_ref['locked']"
nl|'\n'
nl|'\n'
nl|'\n'
comment|'###################'
