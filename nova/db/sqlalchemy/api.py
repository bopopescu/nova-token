...
op|':'
newline|'\n'
comment|"# Are there any other groups that haven't been deleted"
nl|'\n'
comment|'# that include this group in their rules?'
nl|'\n'
indent|'        '
name|'rules'
op|'='
...
nl|'\n'
nl|'\n'
DECL|function|_cell_get_by_id_query
dedent|''
name|'def'
name|'_cell_get_by_id_query'
op|'('
name|'context'
op|','
name|'cell_id'
