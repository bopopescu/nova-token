...
op|':'
newline|'\n'
comment|'# This method returns a tuple of (models.FixedIp, models.Network,'
nl|'\n'
comment|'# models.Instance).'
nl|'\n'
indent|'    '
name|'if'
name|'not'
...
op|')'
newline|'\n'
comment|'# TODO(deva): remove extra_specs from here after it is included'
nl|'\n'
comment|'#             in system_metadata. Until then, the baremetal driver'
nl|'\n'
comment|'#             needs extra_specs added to instance[]'
nl|'\n'
name|'inst_type_ref'
op|'='
...
op|':'
newline|'\n'
comment|"# NOTE(comstud): It appears that sqlalchemy doesn't refresh"
nl|'\n'
comment|'# the instance_type model after you update the ID.  You end'
nl|'\n'
comment|"# up with an instance_type model that only has 'id' updated,"
nl|'\n'
comment|'# but the rest of the model has the data from the old'
nl|'\n'
...
name|'require_admin_context'
newline|'\n'
DECL|function|migration_get_in_progress_by_host
name|'def'
