...
newline|'\n'
nl|'\n'
comment|'# We pass a function here rather than a value so we can lazily evaluate'
nl|'\n'
comment|"# get_session. In all cases we want to use the default value even if we've"
nl|'\n'
comment|'# been explicitly passed a value of None'
nl|'\n'
DECL|function|_default
name|'def'
name|'_default'
op|'('
name|'kwarg'
...
newline|'\n'
nl|'\n'
comment|"# Can't use a slave if it's not specified"
nl|'\n'
name|'if'
name|'CONF'
op|'.'
...
newline|'\n'
nl|'\n'
comment|"# No default for base_model; it's handled below"
nl|'\n'
name|'base_model'
op|'='
name|'kwargs'
