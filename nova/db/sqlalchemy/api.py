...
nl|'\n'
nl|'\n'
DECL|function|_instance_extra_get_by_instance_uuid_query
dedent|''
name|'def'
name|'_instance_extra_get_by_instance_uuid_query'
op|'('
name|'context'
op|','
name|'instance_uuid'
...
nl|'\n'
nl|'\n'
DECL|function|_raise_overquota_exception
dedent|''
name|'def'
name|'_raise_overquota_exception'
op|'('
name|'project_quotas'
op|','
name|'user_quotas'
