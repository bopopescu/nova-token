...
nl|'\n'
nl|'\n'
comment|'# FIXME should we just do this in the constructor automatically'
nl|'\n'
comment|'#       and return the shelf and blade id with volume data in'
nl|'\n'
comment|'#       volume_get?'
nl|'\n'
...
op|':'
newline|'\n'
comment|'# FIXME where should this exception go?'
nl|'\n'
indent|'        '
name|'raise'
name|'NoMoreBlades'
...
op|':'
newline|'\n'
comment|'# FIXME: should probably do this in one call'
nl|'\n'
indent|'    '
name|'volume_ref'
op|'='
