...
newline|'\n'
nl|'\n'
comment|"# NOTE(msdubov): Using lower-level 'select' queries and joining the tables"
nl|'\n'
comment|'#                manually here allows to gain 3x speed-up and to have 5x'
nl|'\n'
comment|'#                less network load / memory usage compared to the sqla ORM.'
nl|'\n'
nl|'\n'
indent|'    '
name|'engine'
...
newline|'\n'
nl|'\n'
comment|'# Retrieve ComputeNode, Service, Stat.'
nl|'\n'
name|'compute_node'
op|'='
name|'models'
...
newline|'\n'
nl|'\n'
comment|'# NOTE(msdubov): Transferring sqla.RowProxy objects to dicts.'
nl|'\n'
dedent|''
name|'stats'
op|'='
...
newline|'\n'
nl|'\n'
comment|'# Join ComputeNode & Service manually.'
nl|'\n'
name|'services'
op|'='
op|'{'
...
newline|'\n'
nl|'\n'
comment|'# Join ComputeNode & ComputeNodeStat manually.'
nl|'\n'
comment|'# NOTE(msdubov): ComputeNode and ComputeNodeStat map 1-to-Many.'
nl|'\n'
comment|'#                Running time is (asymptotically) optimal due to the use'
nl|'\n'
comment|'#                of iterators (itertools.groupby() for ComputeNodeStat and'
nl|'\n'
comment|'#                iter() for ComputeNode) - we handle each record only once.'
nl|'\n'
dedent|''
name|'compute_nodes'
op|'.'
...
newline|'\n'
indent|'    '
string|'"""Delete a ComputeNode record and prune its stats."""'
newline|'\n'
name|'session'
op|'='
name|'get_session'
...
op|':'
newline|'\n'
comment|"# Prune the compute node's stats"
nl|'\n'
indent|'        '
name|'_update_stats'
op|'('
...
op|':'
newline|'\n'
comment|'# NOTE (vsergeyev): To get existing address we have to do each'
nl|'\n'
comment|'#                   time session.flush().'
nl|'\n'
comment|'#                   See related note at line 697.'
nl|'\n'
indent|'                '
name|'session'
op|'.'
...
nl|'\n'
nl|'\n'
DECL|function|_get_user_quota_usages
dedent|''
name|'def'
name|'_get_user_quota_usages'
op|'('
name|'context'
op|','
name|'session'
...
nl|'\n'
nl|'\n'
DECL|function|_get_project_quota_usages
dedent|''
name|'def'
name|'_get_project_quota_usages'
op|'('
name|'context'
op|','
name|'session'
...
newline|'\n'
nl|'\n'
comment|'# If quota_cores is unlimited [-1]:'
nl|'\n'
comment|'# - set cores headroom based on instances headroom:'
nl|'\n'
name|'if'
name|'user_quotas'
op|'.'
...
newline|'\n'
nl|'\n'
comment|'# If quota_ram is unlimited [-1]:'
nl|'\n'
comment|'# - set ram headroom based on instances headroom:'
nl|'\n'
dedent|''
dedent|''
name|'if'
...
newline|'\n'
indent|'            '
name|'_instance_group_metadata_add'
op|'('
name|'context'
op|','
name|'group'
...
nl|'\n'
nl|'\n'
DECL|function|_instance_group_metadata_add
dedent|''
name|'def'
name|'_instance_group_metadata_add'
op|'('
