...
name|'require_context'
newline|'\n'
DECL|function|instance_get_all_by_column
name|'def'
name|'instance_get_all_by_column'
op|'('
name|'context'
op|','
name|'column'
...
newline|'\n'
indent|'    '
string|'"""Get all instances by exact match against the specified DB column\n    \'column_data\' can be a list.\n    """'
newline|'\n'
name|'session'
op|'='
name|'get_session'
...
op|':'
newline|'\n'
comment|'# Set up the dictionary for filter_by()'
nl|'\n'
indent|'        '
name|'query_filter'
op|'='
...
name|'require_context'
newline|'\n'
DECL|function|instance_get_all_by_column_regexp
name|'def'
name|'instance_get_all_by_column_regexp'
op|'('
name|'context'
op|','
name|'column'
...
newline|'\n'
indent|'    '
string|'"""Get all instances by using regular expression matching against\n    a particular DB column\n    """'
newline|'\n'
name|'session'
op|'='
name|'get_session'
...
newline|'\n'
nl|'\n'
comment|"# MySQL 'regexp' is not portable, so we must do our own matching."
nl|'\n'
comment|'# First... grab all Instances.'
nl|'\n'
name|'prefix'
op|'='
name|'session'
...
op|']'
newline|'\n'
comment|'# Now do the regexp matching'
nl|'\n'
dedent|''
name|'compiled_regexp'
op|'='
name|'re'
op|'.'
name|'compile'
...
name|'require_context'
newline|'\n'
DECL|function|instance_get_all_by_name_regexp
name|'def'
name|'instance_get_all_by_name_regexp'
op|'('
name|'context'
op|','
name|'name_regexp'
...
name|'require_context'
newline|'\n'
DECL|function|instance_get_all_by_ip_regexp
name|'def'
name|'instance_get_all_by_ip_regexp'
op|'('
name|'context'
op|','
name|'ip_regexp'
...
newline|'\n'
nl|'\n'
comment|'# Query both FixedIp and FloatingIp tables to get matches.'
nl|'\n'
comment|'# Since someone could theoretically search for something that matches'
nl|'\n'
comment|'# instances in both tables... we need to use a dictionary keyed'
nl|'\n'
comment|"# on instance ID to make sure we return only 1.  We can't key off"
nl|'\n'
comment|"# of 'instance' because it's just a reference and will be different"
nl|'\n'
comment|'# addresses even though they might point to the same instance ID.'
nl|'\n'
name|'instances'
op|'='
op|'{'
...
name|'joinedload_all'
op|'('
string|"'instance.fixed_ips.floating_ips'"
op|')'
op|')'
op|'.'
name|'options'
...
name|'joinedload'
op|'('
string|"'instance.virtual_interfaces'"
op|')'
op|')'
op|'.'
name|'options'
...
name|'joinedload'
op|'('
string|"'instance.security_groups'"
op|')'
op|')'
op|'.'
name|'options'
...
name|'joinedload_all'
op|'('
string|"'instance.fixed_ips.network'"
op|')'
op|')'
op|'.'
name|'options'
...
op|'('
nl|'\n'
string|"'fixed_ip.instance.fixed_ips.floating_ips'"
op|')'
op|')'
op|'.'
name|'options'
...
name|'joinedload'
op|'('
string|"'fixed_ip.instance.virtual_interfaces'"
op|')'
op|')'
op|'.'
name|'options'
...
name|'joinedload'
op|'('
string|"'fixed_ip.instance.security_groups'"
op|')'
op|')'
op|'.'
name|'options'
...
op|'('
nl|'\n'
string|"'fixed_ip.instance.fixed_ips.network'"
op|')'
op|')'
op|'.'
name|'options'
...
name|'joinedload'
op|'('
string|"'fixed_ip.instance.metadata'"
op|')'
op|')'
op|'.'
name|'options'
...
name|'joinedload'
op|'('
string|"'fixed_ip.instance.instance_type'"
op|')'
op|')'
op|'.'
name|'filter_by'
...
name|'require_context'
newline|'\n'
DECL|function|instance_get_all_by_ipv6_regexp
name|'def'
name|'instance_get_all_by_ipv6_regexp'
op|'('
name|'context'
op|','
name|'ipv6_regexp'
...
name|'ipv6_addrs'
op|'='
name|'_ipv6_get_by_instance_ref'
op|'('
name|'context'
op|','
name|'instance'
...
nl|'\n'
nl|'\n'
DECL|function|_ipv6_get_by_instance_ref
dedent|''
dedent|''
name|'def'
name|'_ipv6_get_by_instance_ref'
