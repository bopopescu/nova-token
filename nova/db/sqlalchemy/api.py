...
op|':'
newline|'\n'
comment|'# TODO(devcamcar): Ensure floating ip belongs to user.'
nl|'\n'
comment|'#                  Only possible if it is associated with an instance.'
nl|'\n'
comment|'#                  May have to use system context for this always.'
nl|'\n'
indent|'    '
name|'if'
name|'not'
