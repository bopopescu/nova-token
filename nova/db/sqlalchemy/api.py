...
newline|'\n'
nl|'\n'
comment|'# Allow us to hold the save operation until later; keeps the'
nl|'\n'
comment|'# transaction in quota_reserve() from breaking too early'
nl|'\n'
name|'if'
name|'save'
op|':'
...
name|'require_context'
newline|'\n'
DECL|function|reservation_get_all_by_project
name|'def'
name|'reservation_get_all_by_project'
op|'('
name|'context'
op|','
name|'project_id'
...
op|':'
newline|'\n'
comment|"# Note we're inhibiting save..."
nl|'\n'
indent|'                '
name|'usages'
op|'['
