...
op|')'
newline|'\n'
comment|'# NOTE(comstud): This forces instance_type to be loaded so it'
nl|'\n'
comment|'# exists in the ref when we return.  Fixes lazy loading issues.'
nl|'\n'
name|'instance_ref'
op|'.'
name|'instance_type'
...
nl|'\n'
nl|'\n'
DECL|function|_get_instance_data
dedent|''
name|'def'
...
name|'require_admin_context'
newline|'\n'
DECL|function|instance_data_get_for_user
name|'def'
name|'instance_data_get_for_user'
op|'('
name|'context'
op|','
name|'user_id'
...
op|':'
newline|'\n'
comment|"# NOTE(tr3buchet): let's leave it alone if it's already deleted"
nl|'\n'
indent|'        '
name|'if'
name|'info_cache'
...
name|'require_context'
newline|'\n'
DECL|function|quota_get_for_user
name|'def'
name|'quota_get_for_user'
op|'('
name|'context'
op|','
name|'user_id'
...
name|'require_context'
newline|'\n'
DECL|function|quota_get_all_by_user
name|'def'
...
name|'require_context'
newline|'\n'
DECL|function|quota_get_remaining
name|'def'
name|'quota_get_remaining'
op|'('
name|'context'
op|','
name|'project_id'
...
name|'require_context'
newline|'\n'
DECL|function|quota_create_for_user
name|'def'
...
name|'require_context'
newline|'\n'
DECL|function|quota_update_for_user
name|'def'
...
name|'require_context'
newline|'\n'
DECL|function|quota_destroy_for_user
name|'def'
name|'quota_destroy_for_user'
op|'('
name|'context'
op|','
name|'user_id'
...
name|'require_admin_context'
newline|'\n'
DECL|function|quota_class_destroy
name|'def'
name|'quota_class_destroy'
op|'('
name|'context'
op|','
name|'class_name'
...
name|'require_admin_context'
newline|'\n'
DECL|function|quota_class_destroy_all_by_name
name|'def'
name|'quota_class_destroy_all_by_name'
op|'('
name|'context'
op|','
name|'class_name'
...
name|'require_context'
newline|'\n'
DECL|function|quota_usage_get_all_by_user
name|'def'
name|'quota_usage_get_all_by_user'
op|'('
name|'context'
op|','
name|'user_id'
...
name|'require_admin_context'
newline|'\n'
DECL|function|quota_usage_create
name|'def'
name|'quota_usage_create'
op|'('
name|'context'
op|','
name|'user_id'
...
op|':'
newline|'\n'
comment|'# Assume caller started a transaction'
nl|'\n'
indent|'        '
name|'do_update'
op|'('
...
name|'require_admin_context'
newline|'\n'
DECL|function|quota_usage_destroy
name|'def'
name|'quota_usage_destroy'
op|'('
name|'context'
op|','
name|'user_id'
...
name|'require_context'
newline|'\n'
DECL|function|reservation_get_all_by_user
name|'def'
name|'reservation_get_all_by_user'
op|'('
name|'context'
op|','
name|'user_id'
...
nl|'\n'
nl|'\n'
DECL|function|_quota_reservations
dedent|''
name|'def'
name|'_quota_reservations'
op|'('
name|'session'
op|','
name|'context'
...
name|'require_admin_context'
newline|'\n'
DECL|function|quota_destroy_all_by_user
name|'def'
name|'quota_destroy_all_by_user'
op|'('
name|'context'
op|','
name|'user_id'
...
nl|'\n'
nl|'\n'
DECL|function|_get_volume_data
dedent|''
name|'def'
name|'_get_volume_data'
op|'('
name|'context'
op|','
name|'project_id'
...
name|'require_admin_context'
newline|'\n'
DECL|function|volume_data_get_for_user
name|'def'
name|'volume_data_get_for_user'
op|'('
name|'context'
op|','
name|'user_id'
...
name|'require_admin_context'
newline|'\n'
DECL|function|volume_get_all_by_instance_uuid
name|'def'
...
newline|'\n'
indent|'    '
string|'"""Create ec2 compatable volume by provided uuid"""'
newline|'\n'
name|'ec2_volume_ref'
op|'='
name|'models'
...
newline|'\n'
indent|'    '
string|'"""Create ec2 compatable snapshot by provided uuid"""'
newline|'\n'
...
name|'require_context'
newline|'\n'
DECL|function|snapshot_get_all_for_volume
name|'def'
...
name|'require_context'
newline|'\n'
DECL|function|security_group_get_by_user
name|'def'
...
name|'require_context'
newline|'\n'
DECL|function|security_group_count_by_user
name|'def'
name|'security_group_count_by_user'
op|'('
name|'context'
op|','
name|'user_id'
...
name|'require_context'
newline|'\n'
DECL|function|instance_system_metadata_delete
name|'def'
name|'instance_system_metadata_delete'
op|'('
name|'context'
op|','
name|'instance_uuid'
...
nl|'\n'
nl|'\n'
DECL|function|_instance_system_metadata_get_item
dedent|''
name|'def'
name|'_instance_system_metadata_get_item'
op|'('
name|'context'
op|','
name|'instance_uuid'
...
op|':'
newline|'\n'
comment|"# Two queries necessary because join with update doesn't work."
nl|'\n'
indent|'    '
name|'t'
op|'='
...
op|':'
newline|'\n'
comment|"# Don't need synchronize the session since we will not use the query result"
nl|'\n'
indent|'    '
name|'_instance_type_extra_specs_get_query'
op|'('
...
name|'require_context'
newline|'\n'
DECL|function|volume_get_active_by_window
name|'def'
name|'volume_get_active_by_window'
op|'('
name|'context'
op|','
name|'begin'
...
newline|'\n'
indent|'    '
string|'"""Return volumes that were active during window."""'
newline|'\n'
name|'session'
op|'='
name|'get_session'
...
name|'_'
op|'('
string|'"No backend config with sr uuid "'
nl|'\n'
string|'"%(sr_uuid)s"'
op|')'
op|'%'
...
name|'_'
op|'('
string|"'%(sm_flavor_id) flavor not found'"
op|')'
op|'%'
name|'locals'
op|'('
...
name|'_'
op|'('
string|'"No sm_flavor called %(sm_flavor_id)s"'
op|')'
op|'%'
name|'locals'
op|'('
...
name|'require_admin_context'
newline|'\n'
DECL|function|sm_flavor_get_by_label
name|'def'
name|'sm_flavor_get_by_label'
op|'('
name|'context'
op|','
...
name|'_'
op|'('
string|'"No sm_flavor called %(sm_flavor_label)s"'
op|')'
op|'%'
name|'locals'
op|'('
...
newline|'\n'
indent|'    '
string|'"""Create ec2 compatable instance by provided uuid"""'
newline|'\n'
