...
name|'joinedload_all'
op|'('
string|"'virtual_interfaces.network'"
op|')'
op|')'
op|'.'
name|'options'
...
op|'('
nl|'\n'
string|"'virtual_interfaces.fixed_ips.floating_ips'"
op|')'
op|')'
op|'.'
name|'options'
...
name|'joinedload'
op|'('
string|"'virtual_interfaces.instance'"
op|')'
op|')'
op|'.'
name|'options'
...
newline|'\n'
nl|'\n'
DECL|function|_regexp_filter_by_ipv6
name|'def'
name|'_regexp_filter_by_ipv6'
op|'('
name|'instance'
op|','
name|'filter_re'
...
newline|'\n'
nl|'\n'
DECL|function|_regexp_filter_by_ip
dedent|''
name|'def'
name|'_regexp_filter_by_ip'
op|'('
name|'instance'
op|','
name|'filter_re'
...
name|'require_context'
newline|'\n'
DECL|function|instance_get_by_fixed_ip
name|'def'
...
newline|'\n'
indent|'    '
string|'"""Return instance ref by exact match of FixedIP"""'
newline|'\n'
name|'fixed_ip_ref'
op|'='
name|'fixed_ip_get_by_address'
...
name|'require_context'
newline|'\n'
DECL|function|instance_get_by_fixed_ipv6
name|'def'
name|'instance_get_by_fixed_ipv6'
op|'('
name|'context'
op|','
name|'address'
...
newline|'\n'
indent|'    '
string|'"""Return instance ref by exact match of IPv6"""'
newline|'\n'
name|'session'
op|'='
name|'get_session'
