...
name|'require_admin_context'
newline|'\n'
DECL|function|service_does_host_exist
name|'def'
name|'service_does_host_exist'
op|'('
name|'context'
op|','
name|'host_name'
...
name|'None'
newline|'\n'
comment|"# NOTE(boris-42): `SELECT IN` doesn't work with None values because"
nl|'\n'
comment|'#                 they are incomparable.'
nl|'\n'
name|'if'
name|'None'
name|'in'
...
nl|'\n'
nl|'\n'
DECL|function|action_get_by_id
dedent|''
name|'def'
...
newline|'\n'
indent|'    '
string|'"""Get the action by id and given instance."""'
newline|'\n'
name|'action'
op|'='
name|'model_query'
