...
nl|'\n'
comment|'#             SELECT services.*, inst_count.instance_count'
nl|'\n'
comment|'#             FROM services LEFT OUTER JOIN'
nl|'\n'
comment|'#             (SELECT host, count(*) AS instance_count'
nl|'\n'
comment|'#              FROM instances GROUP BY host) AS inst_count'
nl|'\n'
comment|'#             ON services.host = inst_count.host'
nl|'\n'
indent|'        '
name|'topic'
op|'='
