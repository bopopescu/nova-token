...
nl|'\n'
nl|'\n'
DECL|function|daemon_get_all_by_topic
dedent|''
name|'def'
name|'daemon_get_all_by_topic'
op|'('
name|'context'
op|','
name|'topic'
...
nl|'\n'
nl|'\n'
DECL|function|daemon_get_all_compute_sorted
dedent|''
dedent|''
name|'def'
...
nl|'\n'
comment|'#             SELECT daemons.*, inst_count.instance_count'
nl|'\n'
comment|'#             FROM daemons LEFT OUTER JOIN'
nl|'\n'
