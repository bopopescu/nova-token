...
name|'exception'
op|'.'
name|'NoFloatingIpsFoundForInstance'
op|'('
name|'instance_id'
op|'='
name|'instance_id'
...
newline|'\n'
indent|'    '
string|'"""Create a new instance type. In order to pass in metadata,\n    the values dict should contain a \'meta\' key/value pair:\n\n    {\'meta\' : {\'k1\': \'v1\', \'k2\': \'v2\', ...}}\n\n    """'
newline|'\n'
name|'try'
op|':'
newline|'\n'
...
name|'require_context'
newline|'\n'
DECL|function|instance_type_metadata_get
name|'def'
...
name|'require_context'
newline|'\n'
DECL|function|instance_type_metadata_delete
name|'def'
...
name|'require_context'
newline|'\n'
DECL|function|instance_type_metadata_get_item
name|'def'
name|'instance_type_metadata_get_item'
op|'('
name|'context'
op|','
name|'instance_type_id'
...
name|'require_context'
newline|'\n'
DECL|function|instance_type_metadata_update_or_create
name|'def'
