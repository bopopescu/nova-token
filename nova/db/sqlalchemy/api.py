...
name|'_'
op|'('
string|'"%s does not exist or not "'
nl|'\n'
string|'"compute node."'
op|')'
op|'%'
...
name|'require_admin_context'
newline|'\n'
DECL|function|compute_service_get
name|'def'
name|'compute_service_get'
op|'('
name|'context'
op|','
name|'compute_id'
...
name|'require_admin_context'
newline|'\n'
DECL|function|compute_service_create
name|'def'
...
name|'require_admin_context'
newline|'\n'
DECL|function|compute_service_update
name|'def'
name|'compute_service_update'
op|'('
name|'context'
op|','
name|'compute_id'
