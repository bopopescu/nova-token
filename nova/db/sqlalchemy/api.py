...
name|'require_context'
newline|'\n'
DECL|function|_instance_get_sum_by_host_and_project
name|'def'
name|'_instance_get_sum_by_host_and_project'
op|'('
name|'context'
op|','
name|'column'
...
name|'require_admin_context'
newline|'\n'
DECL|function|host_deactivated
name|'def'
name|'host_deactivated'
op|'('
name|'context'
op|','
name|'host'
