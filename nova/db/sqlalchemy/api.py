...
nl|'\n'
nl|'\n'
comment|'#TODO(gundlach): instance_create and volume_create are nearly identical'
nl|'\n'
comment|'#and should be refactored.  I expect there are other copy-and-paste'
nl|'\n'
comment|'#functions between the two of them as well.'
nl|'\n'
nl|'\n'
nl|'\n'
dedent|''
...
name|'if'
name|'not'
name|'instance_internal_id_exists'
op|'('
name|'context'
op|','
name|'internal_id'
...
name|'require_context'
newline|'\n'
DECL|function|instance_get_by_internal_id
name|'def'
...
name|'require_context'
newline|'\n'
DECL|function|instance_internal_id_exists
name|'def'
name|'instance_internal_id_exists'
op|'('
name|'context'
...
name|'_'
op|'('
string|'"No console with id %(instance)s"'
op|')'
op|'%'
nl|'\n'
op|'{'
