...
op|')'
newline|'\n'
name|'instance_info_cache_delete_by_instance_id'
op|'('
name|'context'
op|','
name|'instance_id'
...
name|'joinedload_all'
op|'('
string|"'fixed_ips.virtual_interface'"
op|')'
op|')'
op|'.'
name|'options'
...
newline|'\n'
nl|'\n'
DECL|function|_exact_match_filter
dedent|''
name|'def'
name|'_exact_match_filter'
op|'('
name|'query'
op|','
name|'column'
...
newline|'\n'
indent|'        '
string|'"""Do exact match against a column.  value to match can be a list\n        so you can match any value in the list.\n        """'
newline|'\n'
name|'if'
name|'isinstance'
op|'('
...
op|':'
newline|'\n'
comment|'# Do the matching and remove the filter from the dictionary'
nl|'\n'
comment|"# so we don't try it again below.."
nl|'\n'
indent|'        '
name|'query_prefix'
op|'='
...
newline|'\n'
indent|'    '
string|'"""Return instances that were continuously active over window."""'
newline|'\n'
name|'session'
op|'='
name|'get_session'
...
newline|'\n'
indent|'    '
string|'"""Return instances and joins that were continuously active over window."""'
newline|'\n'
name|'session'
op|'='
name|'get_session'
...
name|'require_context'
newline|'\n'
DECL|function|instance_info_cache_delete_by_instance_id
name|'def'
name|'instance_info_cache_delete_by_instance_id'
op|'('
name|'context'
...
name|'require_volume_exists'
newline|'\n'
DECL|function|volume_metadata_delete_all
name|'def'
name|'volume_metadata_delete_all'
op|'('
name|'context'
op|','
name|'volume_id'
...
newline|'\n'
nl|'\n'
comment|'# FIXME(sirp): this should update deleted_at and updated_at as well'
nl|'\n'
name|'records'
op|'='
name|'instance_type_ref'
...
newline|'\n'
indent|'    '
string|'""" Marks specific volume_type as deleted"""'
newline|'\n'
name|'volume_type_ref'
op|'='
name|'model_query'
...
newline|'\n'
nl|'\n'
comment|'# FIXME(sirp): we should be setting deleted_at and updated_at here'
nl|'\n'
name|'records'
op|'='
name|'volume_type_ref'
...
name|'require_admin_context'
newline|'\n'
DECL|function|volume_type_purge
name|'def'
...
newline|'\n'
indent|'    '
string|'""" Removes specific volume_type from DB\n        Usually volume_type_destroy should be used\n    """'
newline|'\n'
name|'volume_type_ref'
op|'='
name|'model_query'
...
nl|'\n'
nl|'\n'
DECL|function|instance_fault_get_by_instance
dedent|''
name|'def'
name|'instance_fault_get_by_instance'
op|'('
name|'context'
op|','
name|'instance_uuid'
...
newline|'\n'
indent|'    '
string|'"""Get first instance fault with the given instance uuid."""'
newline|'\n'
name|'return'
name|'model_query'
op|'('
