...
name|'execute'
op|'('
string|"'update network_indexes set deleted=1 where network_id=:id'"
op|','
nl|'\n'
op|'{'
string|"'id'"
...
name|'execute'
op|'('
string|"'update export_devices set deleted=1 where network_id=:id'"
op|','
nl|'\n'
op|'{'
string|"'id'"
...
nl|'\n'
nl|'\n'
comment|'# NOTE(vish): should this code go up a layer?'
nl|'\n'
DECL|function|volume_ensure_blades
dedent|''
name|'def'
name|'volume_ensure_blades'
op|'('
