...
name|'DEFINE_integer'
op|'('
string|"'quota_personality_max_files'"
op|','
number|'5'
op|','
nl|'\n'
string|"'number of personality files allowed'"
op|')'
newline|'\n'
name|'flags'
op|'.'
name|'DEFINE_integer'
op|'('
string|"'quota_personality_max_content_bytes'"
op|','
number|'10'
op|'*'
number|'1024'
op|','
nl|'\n'
string|"'number of bytes allowed per personality file'"
op|')'
newline|'\n'
name|'flags'
op|'.'
name|'DEFINE_integer'
op|'('
string|"'quota_personality_max_path_bytes'"
op|','
number|'255'
op|','
nl|'\n'
string|"'number of bytes allowed per personality file path'"
op|')'
newline|'\n'
nl|'\n'
nl|'\n'
...
nl|'\n'
nl|'\n'
DECL|function|allowed_personality_files
dedent|''
name|'def'
...
newline|'\n'
indent|'    '
string|'"""Return the number of personality files allowed"""'
newline|'\n'
name|'return'
name|'FLAGS'
op|'.'
...
nl|'\n'
nl|'\n'
DECL|function|allowed_personality_content_bytes
dedent|''
name|'def'
...
newline|'\n'
indent|'    '
string|'"""Return the number of bytes allowed per personality content"""'
newline|'\n'
name|'return'
name|'FLAGS'
op|'.'
...
nl|'\n'
nl|'\n'
DECL|function|allowed_personality_path_bytes
dedent|''
name|'def'
...
newline|'\n'
indent|'    '
string|'"""Return the number of bytes allowed in a personality file path"""'
newline|'\n'
name|'return'
name|'FLAGS'
op|'.'
