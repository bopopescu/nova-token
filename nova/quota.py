...
nl|'\n'
nl|'\n'
string|'"""Quotas for resources per project."""'
newline|'\n'
nl|'\n'
name|'import'
name|'datetime'
...
name|'debug'
op|'('
string|"'Getting all quota usages for project: %s'"
op|','
name|'project_id'
op|')'
newline|'\n'
...
name|'debug'
op|'('
string|"'Getting quotas for user %(user_id)s and project '"
nl|'\n'
string|"'%(project_id)s. Resources: %(keys)s'"
op|','
nl|'\n'
op|'{'
string|"'user_id'"
...
name|'debug'
op|'('
string|"'Getting quotas for project %(project_id)s. Resources: '"
nl|'\n'
string|"'%(keys)s'"
op|','
op|'{'
...
name|'debug'
op|'('
string|"'Reserving resources using context.project_id: %s'"
op|','
nl|'\n'
name|'project_id'
op|')'
...
name|'debug'
op|'('
string|"'Reserving resources using context.user_id: %s'"
op|','
nl|'\n'
name|'user_id'
op|')'
...
name|'debug'
op|'('
string|"'Attempting to reserve resources for project %(project_id)s '"
nl|'\n'
string|"'and user %(user_id)s. Deltas: %(deltas)s'"
op|','
nl|'\n'
op|'{'
string|"'project_id'"
...
name|'debug'
op|'('
string|"'Quota limits for project %(project_id)s: '"
nl|'\n'
string|"'%(project_quotas)s'"
op|','
op|'{'
string|"'project_id'"
op|':'
...
name|'debug'
op|'('
string|"'Quotas for project %(project_id)s after resource sync: '"
nl|'\n'
string|"'%(quotas)s'"
op|','
op|'{'
...
name|'debug'
op|'('
string|"'Quotas for project %(project_id)s and user %(user_id)s '"
nl|'\n'
string|"'after resource sync: %(quotas)s'"
op|','
nl|'\n'
op|'{'
string|"'project_id'"
