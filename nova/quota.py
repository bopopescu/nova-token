...
newline|'\n'
indent|'        '
string|'"""Get a specific quota by user."""'
newline|'\n'
nl|'\n'
name|'return'
name|'db'
...
newline|'\n'
nl|'\n'
DECL|member|get_remaining_quotas
dedent|''
name|'def'
...
newline|'\n'
indent|'        '
string|'"""Get the remaining quotas for the given project."""'
newline|'\n'
name|'defaults'
op|'='
name|'self'
...
newline|'\n'
indent|'        '
string|'"""Retrieve the quotas for the given user.\n\n        :param context: The request context, for access checks.\n        :param user_id: The ID of the user to return quotas for.\n        :param project_id: The ID of the project to return quotas for.\n        :param quota_class: If project_id != context.project_id, the\n                            quota class cannot be determined.  This\n                            parameter allows it to be specified.\n        :param defaults: If True, the quota class value (or the\n                         default value, if there is no value from the\n                         quota class) will be reported if there is no\n                         specific value for the resource.\n        :param usages: If True, the current in_use and reserved counts\n                       will also be returned.\n        """'
newline|'\n'
nl|'\n'
name|'return'
name|'self'
...
newline|'\n'
indent|'        '
string|'"""Retrieve the remaining quotas for the given project.\n\n        :param context: The request context, for access checks.\n        :param project_id: The ID of the project to return quotas for.\n        """'
newline|'\n'
nl|'\n'
name|'return'
name|'self'
