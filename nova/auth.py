...
nl|'\n'
nl|'\n'
comment|'# anthony - the User class has moved to nova.models'
nl|'\n'
comment|'#class User(AuthBase):'
nl|'\n'
comment|'#    """Object representing a user"""'
nl|'\n'
comment|'#    def __init__(self, id, name, access, secret, admin):'
nl|'\n'
comment|'#        AuthBase.__init__(self)'
nl|'\n'
comment|'#        self.id = id'
nl|'\n'
...
comment|'#'
nl|'\n'
comment|'#    def is_superuser(self):'
nl|'\n'
comment|'#        return AuthManager().is_superuser(self)'
nl|'\n'
comment|'#'
nl|'\n'
comment|'#    def is_admin(self):'
nl|'\n'
comment|'#        return AuthManager().is_admin(self)'
nl|'\n'
comment|'#'
nl|'\n'
comment|'#    def has_role(self, role):'
nl|'\n'
comment|'#        return AuthManager().has_role(self, role)'
nl|'\n'
comment|'#'
nl|'\n'
comment|'#    def add_role(self, role):'
nl|'\n'
comment|'#        return AuthManager().add_role(self, role)'
nl|'\n'
comment|'#'
nl|'\n'
comment|'#    def remove_role(self, role):'
nl|'\n'
comment|'#        return AuthManager().remove_role(self, role)'
nl|'\n'
comment|'#'
nl|'\n'
comment|'#    def is_project_member(self, project):'
nl|'\n'
comment|'#        return AuthManager().is_project_member(self, project)'
nl|'\n'
comment|'#'
nl|'\n'
comment|'#    def is_project_manager(self, project):'
nl|'\n'
comment|'#        return AuthManager().is_project_manager(self, project)'
nl|'\n'
comment|'#'
nl|'\n'
comment|'#    def generate_key_pair(self, name):'
nl|'\n'
comment|'#        return AuthManager().generate_key_pair(self.id, name)'
nl|'\n'
comment|'#'
nl|'\n'
comment|'#    def create_key_pair(self, name, public_key, fingerprint):'
nl|'\n'
comment|'#        return AuthManager().create_key_pair(self.id,'
nl|'\n'
comment|'#                                             name,'
nl|'\n'
comment|'#                                             public_key,'
...
comment|'#'
nl|'\n'
comment|'#    def get_key_pair(self, name):'
nl|'\n'
comment|'#        return AuthManager().get_key_pair(self.id, name)'
nl|'\n'
comment|'#'
nl|'\n'
comment|'#    def delete_key_pair(self, name):'
nl|'\n'
comment|'#        return AuthManager().delete_key_pair(self.id, name)'
nl|'\n'
comment|'#'
nl|'\n'
comment|'#    def get_key_pairs(self):'
nl|'\n'
comment|'#        return AuthManager().get_key_pairs(self.id)'
nl|'\n'
comment|'#'
nl|'\n'
comment|'#    def __repr__(self):'
nl|'\n'
comment|'#        return "User(\'%s\', \'%s\', \'%s\', \'%s\', %s)" % (self.id,'
nl|'\n'
comment|'#                                                     self.name,'
nl|'\n'
comment|'#                                                     self.access,'
