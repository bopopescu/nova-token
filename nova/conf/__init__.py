...
nl|'\n'
comment|'# from nova.conf import compute'
nl|'\n'
comment|'# from nova.conf import conductor'
nl|'\n'
...
nl|'\n'
comment|'# from nova.conf import ephemeral_storage_encryption'
nl|'\n'
...
nl|'\n'
comment|'# from nova.conf import ironic'
nl|'\n'
...
nl|'\n'
comment|'# from nova.conf import virt'
nl|'\n'
...
nl|'\n'
comment|'# compute.register_opts(CONF)'
nl|'\n'
comment|'# conductor.register_opts(CONF)'
nl|'\n'
...
nl|'\n'
comment|'# ephemeral_storage_encryption.register_opts(CONF)'
nl|'\n'
...
nl|'\n'
comment|'# ironic.register_opts(CONF)'
nl|'\n'
...
nl|'\n'
comment|'# virt.register_opts(CONF)'
nl|'\n'
