...
nl|'\n'
nl|'\n'
comment|'# As the devices have been assigned to an instance,'
nl|'\n'
comment|'# we defer the change till the instance is destroyed.'
nl|'\n'
comment|'# We will not sync the new properties with database'
nl|'\n'
comment|'# before that.'
nl|'\n'
nl|'\n'
...
op|':'
newline|'\n'
comment|'# Note(yjiang5): When an instance is resized, the devices in the'
nl|'\n'
