...
newline|'\n'
indent|'        '
string|'"""02: Unknown error occurs on finding instance on DB. """'
newline|'\n'
nl|'\n'
name|'db'
op|'.'
...
newline|'\n'
nl|'\n'
comment|'# the case of no fixed ip found on DB( instance_get_fixed_address '
nl|'\n'
comment|'# returns unknown error) is ommited because it is same as test02'
nl|'\n'
nl|'\n'
DECL|member|test03
dedent|''
...
newline|'\n'
indent|'        '
string|'"""03: no fixed ip found on DB,  """'
newline|'\n'
nl|'\n'
name|'db'
op|'.'
...
newline|'\n'
indent|'        '
string|'"""04: no fixed_ip found on DB. """'
newline|'\n'
nl|'\n'
name|'db'
op|'.'
...
newline|'\n'
indent|'        '
string|'"""05: NotAuthrized occurs on finding volume on DB. """'
newline|'\n'
nl|'\n'
name|'db'
op|'.'
...
newline|'\n'
indent|'        '
string|'"""06: Unexpected exception occurs on finding volume on DB. """'
newline|'\n'
nl|'\n'
name|'db'
op|'.'
...
newline|'\n'
nl|'\n'
comment|'# ensure_filtering_rules_for_instance mainly access to libvirt.'
nl|'\n'
comment|'# Therefore, exception may be libvirt-related one, but cannot expect.'
nl|'\n'
comment|'# so, for test cases, just expect unkonwn exception( TypeError is just a case)'
nl|'\n'
DECL|member|test09
dedent|''
name|'def'
...
newline|'\n'
indent|'        '
string|'"""09: self.driver.ensure_filtering_rules_for_instance raises unexpected exception. """'
newline|'\n'
name|'self'
op|'.'
name|'manager'
...
newline|'\n'
indent|'        '
string|'"""10: volume/fixed_ip found on DB, all procedure finish\n        successfully.. """'
newline|'\n'
nl|'\n'
name|'result'
op|'='
...
newline|'\n'
indent|'        '
string|'"""11: if db_instance_get issues NotFound.\n        """'
newline|'\n'
name|'db'
op|'.'
name|'instance_get'
...
newline|'\n'
indent|'        '
string|'"""12: if db_instance_get issues Unexpected Error.\n        """'
newline|'\n'
name|'db'
op|'.'
name|'instance_get'
...
newline|'\n'
indent|'        '
string|'"""13: if rpc.call returns rpc.RemoteError. """'
newline|'\n'
nl|'\n'
name|'rpc'
op|'.'
...
newline|'\n'
indent|'        '
string|'"""14: if rpc.call returns rpc.RemoteError and instance_set_state\n           also ends up err. (then , unexpected err occurs, in this case\n           TypeError)\n        """'
newline|'\n'
name|'rpc'
op|'.'
name|'call'
...
newline|'\n'
indent|'        '
string|'"""15: if rpc.call returns rpc.RemoteError and volume_get_all_by_instance\n           also ends up err. (then , unexpected err occurs, in this case\n           TypeError)\n        """'
newline|'\n'
name|'rpc'
op|'.'
name|'call'
...
newline|'\n'
indent|'        '
string|'"""16: if rpc.call finish successfully, e, and live_migration raises\n        TypeError(Unexpected error), which means unexpected libvirt-related one. """'
newline|'\n'
name|'rpc'
op|'.'
name|'call'
