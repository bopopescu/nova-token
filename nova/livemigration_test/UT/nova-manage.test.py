...
newline|'\n'
nl|'\n'
comment|'# only AoE is supported for now'
nl|'\n'
name|'FLAGS'
op|'.'
name|'volume_driver'
...
newline|'\n'
indent|'        '
string|'"""11: nova-manage instances live_migration ec2_id(invalid id) host"""'
newline|'\n'
nl|'\n'
name|'db'
op|'.'
...
name|'find'
op|'('
string|"'Check its progress using euca-describe-instances'"
op|')'
op|')'
newline|'\n'
name|'self'
