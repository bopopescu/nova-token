...
nl|'\n'
nl|'\n'
DECL|class|SchedulerQueryDriverNotFound
dedent|''
name|'class'
...
name|'_'
op|'('
string|'"Scheduler Query Driver %(driver_name)s could not be found."'
op|')'
newline|'\n'
nl|'\n'
nl|'\n'
DECL|class|BadSchedulerQueryDriver
dedent|''
name|'class'
...
name|'_'
op|'('
string|'"Invalid Scheduler Query Driver selected."'
op|')'
newline|'\n'
nl|'\n'
nl|'\n'
