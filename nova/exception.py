...
nl|'\n'
nl|'\n'
DECL|class|NoFixedIpsFoundForMacAddress
dedent|''
name|'class'
name|'NoFixedIpsFoundForMacAddress'
op|'('
name|'NotFound'
op|')'
op|':'
...
name|'_'
op|'('
string|'"Mac Address %(mac_id)s has zero associated fixed ips."'
op|')'
newline|'\n'
nl|'\n'
nl|'\n'
