...
name|'_'
op|'('
string|'"Instance %(instance_id)s is busy. (%(task_state)s)"'
op|')'
newline|'\n'
nl|'\n'
nl|'\n'
DECL|class|InstanceSnapshotting
dedent|''
name|'class'
...
name|'_'
op|'('
string|'"Instance %(instance_uuid)s is currently snapshotting."'
op|')'
newline|'\n'
nl|'\n'
nl|'\n'
DECL|class|InstanceBackingUp
dedent|''
name|'class'
...
name|'_'
op|'('
string|'"Instance %(instance_uuid)s is currently being backed up."'
op|')'
newline|'\n'
nl|'\n'
nl|'\n'
