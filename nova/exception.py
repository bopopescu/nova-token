...
nl|'\n'
nl|'\n'
comment|'#TODO: EOL this exception!'
nl|'\n'
DECL|class|Invalid
dedent|''
dedent|''
...
name|'message'
op|'='
string|'"Instance is not \'suspended\'."'
newline|'\n'
nl|'\n'
nl|'\n'
...
name|'message'
op|'='
string|'"Failed to resume server: %(reson)s."'
newline|'\n'
nl|'\n'
nl|'\n'
...
name|'message'
op|'='
string|'"Compute service on %(host)s is unavailable at this time."'
newline|'\n'
nl|'\n'
nl|'\n'
...
name|'message'
op|'='
string|'"The supplied hypervisor type of %(type)s is invalid."'
newline|'\n'
nl|'\n'
nl|'\n'
