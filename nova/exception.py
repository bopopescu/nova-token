...
name|'_'
op|'('
string|'"No fixed IP associated with address %(address)s."'
op|')'
newline|'\n'
nl|'\n'
nl|'\n'
...
nl|'\n'
nl|'\n'
DECL|class|NoFixedIpsFoundForVirtualInterface
dedent|''
name|'class'
name|'NoFixedIpsFoundForVirtualInterface'
op|'('
name|'NoFixedIpFound'
op|')'
op|':'
...
nl|'\n'
nl|'\n'
DECL|class|NoFixedIpsDefinedForHost
dedent|''
name|'class'
name|'NoFixedIpsDefinedForHost'
op|'('
name|'NotFound'
op|')'
op|':'
...
name|'_'
op|'('
string|'"Zero fixed ips defined for host %(host)s."'
op|')'
newline|'\n'
nl|'\n'
nl|'\n'
...
nl|'\n'
nl|'\n'
DECL|class|NoFloatingIpFoundForProject
dedent|''
name|'class'
name|'NoFloatingIpFoundForProject'
op|'('
name|'FloatingIpNotFound'
op|')'
op|':'
