...
name|'_'
op|'('
string|"'Resuming any in progress delete operations'"
op|')'
op|')'
newline|'\n'
name|'for'
...
name|'_'
op|'('
string|'"Resuming delete on volume: %s"'
op|')'
op|','
name|'volume'
op|'['
...
op|':'
newline|'\n'
comment|'# create the volume from an image'
nl|'\n'
indent|'                '
name|'image_service'
op|','
...
op|':'
newline|'\n'
comment|'#copy the image onto the volume.'
nl|'\n'
indent|'            '
name|'self'
op|'.'
name|'_copy_image_to_volume'
op|'('
name|'context'
op|','
name|'volume_ref'
...
newline|'\n'
nl|'\n'
DECL|member|_copy_image_to_volume
dedent|''
name|'def'
name|'_copy_image_to_volume'
op|'('
...
newline|'\n'
indent|'        '
string|'"""Downloads Glance image to the specified volume. """'
newline|'\n'
name|'volume_id'
op|'='
name|'volume'
...
name|'_'
op|'('
string|'"Downloaded image %(image_id)s to %(volume_id)s "'
nl|'\n'
string|'"successfully"'
op|')'
op|'%'
...
newline|'\n'
indent|'        '
string|'"""Uploads the specified volume to Glance."""'
newline|'\n'
name|'payload'
op|'='
op|'{'
...
name|'_'
op|'('
string|'"Uploaded volume %(volume_id)s to "'
nl|'\n'
string|'"image (%(image_id)s) successfully"'
op|')'
op|'%'
name|'locals'
op|'('
