...
name|'_'
op|'('
string|"'Specify san_password or '"
nl|'\n'
string|"'san_private_key'"
op|')'
op|')'
...
nl|'\n'
nl|'\n'
DECL|class|SolidFireSanISCSIDriver
dedent|''
dedent|''
name|'class'
...
name|'_'
op|'('
string|'"Error in SolidFire API response, status was: %s"'
nl|'\n'
op|'%'
name|'response'
op|'.'
...
name|'_'
op|'('
string|'"Error in SolidFire API response data was: %s"'
nl|'\n'
op|'%'
name|'data'
op|')'
...
name|'_'
op|'('
string|'"Enter SolidFire create_volume..."'
op|')'
op|')'
newline|'\n'
name|'GB'
...
name|'iqn'
op|'='
string|"'iqn.2010-01.com.solidfire:'"
op|'+'
name|'v'
op|'['
string|"'iqn'"
...
name|'_'
op|'('
string|'"Leaving SolidFire create_volume"'
op|')'
op|')'
newline|'\n'
name|'return'
