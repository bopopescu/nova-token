...
string|"'Either '"
nl|'\n'
string|"'netapp_storage_service or netapp_storage_service_prefix must '"
nl|'\n'
string|"'be set'"
op|')'
op|')'
...
newline|'\n'
indent|'    '
string|'"""Represents a LUN on NetApp storage."""'
newline|'\n'
nl|'\n'
DECL|member|__init__
name|'def'
...
newline|'\n'
nl|'\n'
DECL|member|get_metadata_property
dedent|''
name|'def'
name|'get_metadata_property'
op|'('
name|'self'
op|','
name|'prop'
...
newline|'\n'
indent|'        '
string|'"""Get the metadata property of a LUN."""'
newline|'\n'
name|'if'
name|'prop'
name|'in'
...
name|'_'
op|'('
string|'"No metadata property %(prop)s defined for the LUN %(name)s"'
op|')'
newline|'\n'
name|'LOG'
op|'.'
...
nl|'\n'
nl|'\n'
DECL|class|NetAppCmodeISCSIDriver
dedent|''
dedent|''
name|'class'
...
newline|'\n'
indent|'    '
string|'"""NetApp C-mode iSCSI volume driver."""'
newline|'\n'
nl|'\n'
DECL|member|__init__
name|'def'
...
name|'_'
op|'('
string|'"Success getting LUN list from server"'
op|')'
op|')'
newline|'\n'
nl|'\n'
...
name|'_'
op|'('
string|'"Created LUN with name %s"'
op|')'
op|'%'
name|'name'
op|')'
...
name|'_'
op|'('
string|'"Mapped LUN %(handle)s to the initiator %(initiator_name)s"'
op|')'
newline|'\n'
name|'LOG'
op|'.'
...
newline|'\n'
nl|'\n'
name|'target_details_list'
op|'='
name|'server'
op|'.'
name|'GetLunTargetDetails'
op|'('
name|'Handle'
op|'='
name|'handle'
...
name|'_'
op|'('
string|'"Succesfully fetched target details for LUN %(handle)s and "'
nl|'\n'
string|'"initiator %(initiator_name)s"'
op|')'
newline|'\n'
name|'LOG'
op|'.'
...
name|'_'
op|'('
string|"'Failed to get LUN target details for the LUN %s'"
op|')'
newline|'\n'
name|'raise'
name|'exception'
...
name|'_'
op|'('
string|"'Failed to get target portal for the LUN %s'"
op|')'
newline|'\n'
name|'raise'
name|'exception'
...
name|'_'
op|'('
string|"'Failed to get target IQN for the LUN %s'"
op|')'
newline|'\n'
name|'raise'
name|'exception'
...
name|'_'
op|'('
string|'"Unmapped LUN %(handle)s from the initiator "'
nl|'\n'
string|'"%(initiator_name)s"'
op|')'
newline|'\n'
name|'LOG'
op|'.'
...
newline|'\n'
indent|'        '
string|'"""Adds LUN to cache table."""'
newline|'\n'
name|'if'
name|'not'
name|'isinstance'
...
name|'_'
op|'('
string|'"Object is not a NetApp LUN."'
op|')'
newline|'\n'
name|'raise'
name|'exception'
...
newline|'\n'
indent|'        '
string|'"""Clone LUN with the given handle to the new name."""'
newline|'\n'
name|'server'
op|'='
name|'self'
...
name|'_'
op|'('
string|'"Cloned LUN with new name %s"'
op|')'
op|'%'
name|'new_name'
op|')'
...
newline|'\n'
nl|'\n'
DECL|member|_create_metadata_list
dedent|''
name|'def'
name|'_create_metadata_list'
op|'('
...
newline|'\n'
indent|'        '
string|'"""Creates metadata from kwargs."""'
newline|'\n'
name|'metadata'
op|'='
op|'['
...
newline|'\n'
indent|'        '
string|'"""Get the details for a LUN from our cache table."""'
newline|'\n'
name|'if'
name|'not'
name|'name'
...
name|'_'
op|'('
string|'"Could not find handle for LUN named %s"'
op|')'
op|'%'
name|'name'
op|')'
...
newline|'\n'
indent|'        '
string|'"""Creates dictionary from metadata array."""'
newline|'\n'
name|'meta_dict'
op|'='
op|'{'
