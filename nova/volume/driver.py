...
newline|'\n'
comment|'# NOTE(vish): Sometimes complains that the volume is still'
nl|'\n'
comment|'#             open, so delay and try again before failing'
nl|'\n'
name|'try'
op|':'
newline|'\n'
...
name|'exception'
op|'('
string|'"lvremove threw an error, recovering"'
op|')'
newline|'\n'
name|'yield'
name|'self'
...
newline|'\n'
comment|'# NOTE(vish): These commands can partially fail sometimes, but'
nl|'\n'
comment|'#             running them a second time on failure will usually'
nl|'\n'
comment|'#             pick up the remaining tasks even though it also'
nl|'\n'
comment|'#             raises an exception.  We therefore ignore the'
nl|'\n'
comment|'#             failure on the second try.'
nl|'\n'
name|'try'
op|':'
newline|'\n'
...
name|'exception'
op|'('
string|'"vblade stop threw an error, recovering"'
op|')'
newline|'\n'
name|'yield'
name|'self'
...
name|'exception'
op|'('
string|'"vblade destroy threw an error, recovering"'
op|')'
newline|'\n'
name|'yield'
name|'self'
...
newline|'\n'
comment|'# NOTE(ja): wait for blades to appear'
nl|'\n'
name|'yield'
name|'self'
op|'.'
