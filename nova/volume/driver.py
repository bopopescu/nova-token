...
newline|'\n'
indent|'        '
string|'"""Gets iscsi configuration, ideally from saved information in the\n        volume entity, but falling back to discovery if need be."""'
newline|'\n'
nl|'\n'
name|'properties'
op|'='
...
name|'_try_execute'
op|'('
string|'"rbd --pool %s --size %d create %s"'
op|'%'
nl|'\n'
op|'('
name|'FLAGS'
...
name|'_try_execute'
op|'('
string|'"qemu-img create sheepdog:%s %s"'
op|'%'
nl|'\n'
op|'('
name|'volume'
