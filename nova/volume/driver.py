...
name|'debug'
op|'('
string|'"Fake AOE: create_volume %s, %s"'
op|','
name|'volume_id'
op|','
name|'size'
...
name|'debug'
op|'('
string|'"Fake AOE: delete_volume %s"'
op|','
name|'volume_id'
op|')'
newline|'\n'
...
name|'debug'
op|'('
string|'"Fake AOE: create_export %s, %s, %s"'
op|','
nl|'\n'
name|'volume_id'
op|','
...
name|'debug'
op|'('
string|'"Fake AOE: remove_export %s, %s, %s"'
op|','
nl|'\n'
name|'volume_id'
op|','
...
op|')'
newline|'\n'
comment|'# NOTE(vish): no need for thise to be async, but it may be'
nl|'\n'
comment|'#             best to explicitly do them at some other time'
nl|'\n'
name|'utils'
op|'.'
name|'execute'
