...
name|'BoolOpt'
op|'('
string|"'storwize_svc_vol_easytier'"
op|','
nl|'\n'
DECL|variable|default
name|'default'
...
name|'help'
op|'='
string|"'Enable Easy Tier for volumes'"
op|')'
op|','
nl|'\n'
name|'cfg'
...
newline|'\n'
nl|'\n'
comment|'# Check that rsize is set'
nl|'\n'
dedent|''
...
name|'_'
op|'('
string|"'If compression is set to True, rsize must '"
nl|'\n'
string|"'also be set (not equal to -1)'"
op|')'
op|')'
newline|'\n'
nl|'\n'
...
op|'='
op|'('
string|"'-rsize %(rsize)s %(autoex)s -warning %(warn)s'"
op|'%'
nl|'\n'
op|'{'
string|"'rsize'"
...
nl|'\n'
string|"'-iogrp 0 -size %(size)s -unit '"
nl|'\n'
string|"'%(unit)s %(easytier)s %(ssh_cmd_se_opt)s'"
nl|'\n'
op|'%'
op|'{'
string|"'name'"
