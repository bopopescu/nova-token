...
newline|'\n'
nl|'\n'
DECL|member|_reraise_translated_snapshot_exception
dedent|''
name|'def'
name|'_reraise_translated_snapshot_exception'
op|'('
name|'self'
op|','
name|'snapshot_id'
...
newline|'\n'
indent|'        '
string|'"""Transform the exception for the snapshot but keep its traceback\n        intact."""'
newline|'\n'
name|'exc_type'
op|','
name|'exc_value'
...
name|'self'
op|'.'
name|'_translate_snapshot_exception'
op|'('
name|'snapshot_id'
op|','
name|'exc_value'
...
newline|'\n'
nl|'\n'
DECL|member|_translate_snapshot_exception
dedent|''
name|'def'
name|'_translate_snapshot_exception'
op|'('
