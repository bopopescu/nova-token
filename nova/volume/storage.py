...
op|','
nl|'\n'
string|"'AoE starting shelf_id for this node'"
op|')'
newline|'\n'
name|'flags'
op|'.'
...
name|'DEFINE_integer'
op|'('
string|"'slots_per_shelf'"
op|','
nl|'\n'
number|'16'
op|','
nl|'\n'
string|"'Number of AoE slots per shelf'"
op|')'
newline|'\n'
name|'flags'
op|'.'
...
op|':'
newline|'\n'
comment|'# TODO(josh): Get rid of this destructor, volumes destroy themselves'
nl|'\n'
indent|'        '
name|'if'
name|'FLAGS'
...
name|'debug'
op|'('
string|'"Next shelf.blade is %s.%s"'
op|','
name|'shelf_id'
op|','
name|'blade_id'
