...
newline|'\n'
indent|'        '
string|'""" returns a list of volume objects for a project """'
newline|'\n'
comment|"# TODO(termie): I don't understand why this is doing a range"
nl|'\n'
comment|'#for volume_id in datastore.Redis.instance().lrange("project:%s:volumes" %'
nl|'\n'
comment|'#project, 0, -1):'
nl|'\n'
name|'for'
...
name|'runthis'
op|'('
string|'"Discovering AOE devices: %s"'
op|','
...
name|'Popen'
op|'('
string|'"sudo ls -1 /var/lib/vblade-persist/vblades/"'
op|','
name|'shell'
op|'='
name|'True'
