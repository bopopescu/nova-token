...
newline|'\n'
nl|'\n'
comment|'# tolerate size as stringified int'
nl|'\n'
dedent|''
dedent|''
name|'size'
...
name|'_'
op|'('
string|'"Volume size \'%s\' must be an integer and greater than 0"'
op|')'
nl|'\n'
op|'%'
name|'size'
...
name|'GB'
newline|'\n'
comment|'#check image size is not larger than volume size.'
nl|'\n'
name|'if'
name|'image_size_in_gb'
op|'>'
...
name|'_'
op|'('
string|"'Size of specified image is larger than volume size.'"
op|')'
newline|'\n'
name|'raise'
name|'exception'
...
nl|'\n'
comment|'# Note(zhiteng): update volume quota reservation'
nl|'\n'
indent|'            '
name|'try'
op|':'
...
name|'_'
op|'('
string|'"Failed to update quota for deleting volume."'
op|')'
op|')'
newline|'\n'
nl|'\n'
...
op|':'
newline|'\n'
comment|'# Need to remove all_tenants to pass the filtering below.'
nl|'\n'
indent|'            '
name|'del'
name|'search_opts'
...
newline|'\n'
nl|'\n'
DECL|member|_check_volume_availability
dedent|''
name|'def'
name|'_check_volume_availability'
op|'('
name|'self'
op|','
name|'context'
...
newline|'\n'
indent|'        '
string|'"""Check if the volume can be used."""'
newline|'\n'
name|'if'
name|'volume'
op|'['
...
name|'_'
op|'('
string|"'Volume status must be available/in-use.'"
op|')'
newline|'\n'
name|'raise'
name|'exception'
...
name|'_'
op|'('
string|"'Volume status is in-use.'"
op|')'
newline|'\n'
name|'raise'
name|'exception'
...
name|'wrap_check_policy'
newline|'\n'
DECL|member|copy_volume_to_image
name|'def'
...
newline|'\n'
indent|'        '
string|'"""Create a new image from the specified volume."""'
newline|'\n'
name|'self'
op|'.'
name|'_check_volume_availability'
