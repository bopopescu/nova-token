...
name|'False'
op|','
string|"'serviceize this process'"
op|')'
newline|'\n'
comment|'# NOTE(termie): right now I am defaulting to using syslog when we serviceize'
nl|'\n'
...
name|'True'
op|','
string|"'output to syslog when serviceizing'"
op|')'
newline|'\n'
name|'flags'
op|'.'
...
name|'message'
op|'='
string|'"pidfile %s does not exist. Service not running?\\n"'
newline|'\n'
name|'sys'
op|'.'
name|'stderr'
...
newline|'\n'
nl|'\n'
comment|'# Try killing the service process    '
nl|'\n'
dedent|''
name|'try'
op|':'
...
newline|'\n'
indent|'    '
string|'"""Does the work of serviceizing the process"""'
newline|'\n'
name|'logging'
op|'.'
name|'getLogger'
