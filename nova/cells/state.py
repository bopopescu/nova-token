...
newline|'\n'
nl|'\n'
DECL|function|_defaultdict_int
name|'def'
name|'_defaultdict_int'
op|'('
op|')'
op|':'
newline|'\n'
...
newline|'\n'
nl|'\n'
comment|'# NOTE: This works because it is only used for computes found'
nl|'\n'
comment|'# in the cell this is run in. It can not be used to check on'
nl|'\n'
comment|'# computes in a child cell from the api cell. If this is run'
nl|'\n'
comment|'# in the api cell objects.ComputeNodeList.get_all() above will'
nl|'\n'
