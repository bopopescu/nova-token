...
op|')'
newline|'\n'
comment|'# NOTE(sbauza): Yes, this is ugly but cells_utils is calling cells.db'
nl|'\n'
comment|'# which itself calls cells.rpcapi... You meant import cycling ? Gah.'
nl|'\n'
name|'from'
name|'nova'
op|'.'
...
op|':'
newline|'\n'
comment|"# NOTE(sbauza): Since Cells v1 is quite feature-freeze, we don't want"
nl|'\n'
comment|'# to pass down request_spec to the manager and rather keep the'
nl|'\n'
comment|'# cell conductor providing a new RequestSpec like the original'
nl|'\n'
comment|'# behaviour'
nl|'\n'
indent|'        '
