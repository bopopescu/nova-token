...
newline|'\n'
DECL|function|_get_paginated_instances
name|'def'
name|'_get_paginated_instances'
op|'('
name|'context'
op|','
name|'filters'
...
op|']'
newline|'\n'
comment|'# NOTE(melwitt/alaski): Need a list that supports assignment for'
nl|'\n'
comment|'# shuffle.  And pop() on the returned result.'
nl|'\n'
name|'instances'
op|'='
name|'list'
...
name|'cells'
op|'.'
name|'instance_update_sync_database_limit'
newline|'\n'
name|'marker'
op|'='
name|'None'
