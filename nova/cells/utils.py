...
op|':'
newline|'\n'
comment|'# TODO(sbauza): Cells messaging service is still using the DB API for'
nl|'\n'
comment|'# returning service_get() and service_get_all(). Until we fix that and'
nl|'\n'
comment|"# converge all messsaging calls by using NovaObjects, we can't modify"
nl|'\n'
comment|'# _add_cell_to_service to return a ServiceProxy'
nl|'\n'
indent|'        '
name|'compute_proxy'
op|'.'
