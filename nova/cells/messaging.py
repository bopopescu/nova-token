...
nl|'\n'
comment|"# 'cell_name' is included in this list.. because we'll set it"
nl|'\n'
comment|'# ourselves based on the reverse of the routing path.  metadata'
nl|'\n'
comment|"# is only updated in the API cell, so we don't listen to what"
nl|'\n'
comment|'# the child cell tells us.'
nl|'\n'
...
name|'_'
op|'('
string|'"Got update for instance %(instance_uuid)s: "'
nl|'\n'
string|'"%(instance)s"'
op|')'
op|'%'
...
name|'_'
op|'('
string|'"Got update to delete instance %(instance_uuid)s"'
op|')'
op|'%'
nl|'\n'
name|'locals'
