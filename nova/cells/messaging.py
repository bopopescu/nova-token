...
op|')'
newline|'\n'
comment|'# FIXME(comstud): This is temporary/transitional until I can'
nl|'\n'
comment|'# work out a better way to pass full objects down.'
nl|'\n'
dedent|''
dedent|''
name|'EXPECTS_OBJECTS'
op|'='
op|'['
string|"'start'"
op|','
...
name|'None'
newline|'\n'
comment|"# shelve and unshelve requires 'info_cache' and 'metadata',"
nl|'\n'
comment|'# because of this fetching same from database.'
nl|'\n'
name|'if'
name|'method'
name|'in'
...
op|')'
newline|'\n'
comment|'# NOTE(sbauza): Cells Manager is calling'
nl|'\n'
comment|'# cells_utils.add_cell_to_compute_node with this result so we need'
nl|'\n'
comment|'# to convert it back to a dict so as to prevent the coercion to an'
nl|'\n'
comment|'# integer for the ID field (which then becomes a string)'
nl|'\n'
name|'return'
name|'objects_base'
op|'.'
...
newline|'\n'
nl|'\n'
DECL|member|_apply_expected_states
dedent|''
name|'def'
...
op|':'
newline|'\n'
comment|'# Make sure we have the dict form that we need for'
nl|'\n'
comment|'# instance_update.'
nl|'\n'
indent|'            '
name|'instance'
op|'['
