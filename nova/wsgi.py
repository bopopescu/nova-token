...
newline|'\n'
indent|'        '
string|'"""Return a fake httplib connection object for this Application"""'
newline|'\n'
...
newline|'\n'
indent|'            '
string|'"""Faked version of httplib.HTTPConnection to talk to app."""'
newline|'\n'
DECL|member|__init__
name|'def'
name|'__init__'
...
newline|'\n'
nl|'\n'
comment|'# httplib.Response has a read() method...fake it out'
nl|'\n'
DECL|function|fake_reader
name|'def'
name|'fake_reader'
op|'('
op|')'
