...
nl|'\n'
nl|'\n'
DECL|variable|ALLOW_TRIGGER_CRASH_DUMP
...
op|']'
newline|'\n'
comment|'# states we allow to trigger crash dump'
nl|'\n'
nl|'\n'
DECL|variable|ALLOW_RESOURCE_REMOVAL
...
op|']'
newline|'\n'
comment|'# states we allow resources to be freed in'
nl|'\n'
endmarker|''
end_unit
