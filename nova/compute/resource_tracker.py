...
newline|'\n'
indent|'    '
string|'"""Returns True if the instance is in one of the resizing states.\n\n    :param instance: `nova.objects.Instance` object\n    """'
newline|'\n'
name|'vm'
op|'='
name|'instance'
...
op|':'
newline|'\n'
comment|'# NOTE(jaypipes): ComputeNode.pci_device_pools is set below'
nl|'\n'
comment|'# in _update_usage_from_instance().'
nl|'\n'
indent|'            '
name|'self'
op|'.'
...
newline|'\n'
indent|'        '
string|'"""Create a claim for a rebuild operation."""'
newline|'\n'
name|'instance_type'
op|'='
name|'instance'
...
newline|'\n'
indent|'        '
string|'"""Create a claim for a resize or cold-migration move."""'
newline|'\n'
name|'return'
name|'self'
op|'.'
...
name|'self'
op|'.'
name|'_claim_existing_migration'
op|'('
name|'migration'
op|')'
newline|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|_claim_existing_migration
dedent|''
name|'def'
name|'_claim_existing_migration'
op|'('
...
newline|'\n'
nl|'\n'
DECL|member|_unset_instance_host_and_node
dedent|''
name|'def'
name|'_unset_instance_host_and_node'
op|'('
name|'self'
op|','
name|'instance'
...
name|'self'
op|'.'
name|'_get_migration_context_resource'
op|'('
nl|'\n'
...
newline|'\n'
nl|'\n'
comment|'# update the allocation ratios for the related ComputeNode object'
nl|'\n'
name|'self'
op|'.'
name|'compute_node'
...
name|'_LW'
op|'('
string|'"Cannot get the metrics from %(mon)s; "'
nl|'\n'
string|'"error: %(exc)s"'
op|')'
op|','
...
newline|'\n'
nl|'\n'
DECL|member|_pair_instances_to_migrations
dedent|''
name|'def'
name|'_pair_instances_to_migrations'
op|'('
name|'self'
op|','
name|'migrations'
...
op|':'
newline|'\n'
comment|"# NOTE(danms): If this happens, we don't set it here, and"
nl|'\n'
comment|'# let the code either fail or lazy-load the instance later'
nl|'\n'
comment|'# which is what happened before we added this optimization.'
nl|'\n'
comment|'# This _should_ not be possible, of course.'
nl|'\n'
indent|'                '
name|'LOG'
op|'.'
...
name|'_LE'
op|'('
string|"'Migration for instance %(uuid)s refers to '"
nl|'\n'
string|"'another host\\'s instance!'"
op|')'
op|','
nl|'\n'
op|'{'
...
op|':'
newline|'\n'
comment|'# TODO(jaypipes): Move this into _init_compute_node()'
nl|'\n'
indent|'            '
name|'if'
name|'not'
...
newline|'\n'
nl|'\n'
DECL|member|_is_trackable_migration
dedent|''
name|'def'
name|'_is_trackable_migration'
op|'('
name|'self'
op|','
name|'migration'
...
op|':'
newline|'\n'
comment|'# Only look at resize/migrate migration and evacuation records'
nl|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|_get_migration_context_resource
dedent|''
name|'def'
name|'_get_migration_context_resource'
op|'('
...
op|')'
newline|'\n'
comment|'# NOTE(claudiub): In Python 3, you cannot compare NoneTypes.'
nl|'\n'
name|'if'
op|'('
name|'not'
...
op|':'
newline|'\n'
comment|'# NOTE(ndipanov): Certain migration types (all but resize)'
nl|'\n'
comment|'# do not change flavors so there is no need to stash'
nl|'\n'
comment|'# them. In that case - just get the instance flavor.'
nl|'\n'
indent|'            '
name|'return'
name|'instance'
