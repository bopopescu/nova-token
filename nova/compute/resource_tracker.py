...
nl|'\n'
comment|"# set the 'host' field and continue the build:"
nl|'\n'
indent|'            '
name|'instance_ref'
op|'='
...
name|'_'
op|'('
string|'"Host field should be not be set on the instance "'
nl|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|_set_instance_host
dedent|''
name|'def'
name|'_set_instance_host'
op|'('
...
newline|'\n'
indent|'        '
string|'"""Purge claims.  They are no longer needed once the audit process\n        reconciles usage values from the database.\n        """'
newline|'\n'
name|'self'
op|'.'
name|'claims'
