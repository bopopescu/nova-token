...
op|')'
newline|'\n'
comment|"# NOTE(sbauza): We don't want to miss the first creation event"
nl|'\n'
name|'self'
op|'.'
...
name|'_'
op|'('
string|'"Total physical ram (MB): %(pram)s, "'
nl|'\n'
string|'"total allocated virtual ram (MB): %(vram)s"'
op|')'
op|','
nl|'\n'
op|'{'
...
name|'_'
op|'('
string|'"Total physical disk (GB): %(pdisk)s, "'
nl|'\n'
string|'"total allocated virtual disk (GB): %(vdisk)s"'
op|')'
op|','
nl|'\n'
op|'{'
...
op|']'
newline|'\n'
comment|'# NOTE(sbauza): Now the DB update is asynchronous, we need to locally'
nl|'\n'
comment|'#               update the values'
nl|'\n'
dedent|''
name|'self'
op|'.'
...
op|')'
newline|'\n'
comment|"# NOTE (ndipanov): Make sure we don't try to lazy-load extra_specs"
nl|'\n'
comment|'# from the object, if there were none stashed in system_metadata'
nl|'\n'
dedent|''
name|'extracted_flavor'
op|'.'
