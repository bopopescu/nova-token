...
newline|'\n'
comment|'# NOTE(pmurray): allow json strings as some drivers pass in'
nl|'\n'
comment|"# stats in that way - they shouldn't really do that."
nl|'\n'
name|'if'
name|'stats'
name|'is'
...
newline|'\n'
nl|'\n'
DECL|member|update_stats_for_migration
dedent|''
name|'def'
