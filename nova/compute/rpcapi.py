...
newline|'\n'
nl|'\n'
DECL|member|_warn_buggy_live_migrations
dedent|''
name|'def'
name|'_warn_buggy_live_migrations'
op|'('
name|'self'
op|','
name|'data'
...
op|':'
newline|'\n'
comment|'# NOTE(danms): We know that libvirt live migration with shared block'
nl|'\n'
comment|'# storage was buggy (potential loss of data) before version 3.32.'
nl|'\n'
comment|'# Since we need to support live migration with older clients, we need'
nl|'\n'
comment|'# to warn the operator of this possibility. The logic below tries to'
nl|'\n'
comment|'# decide if a warning should be emitted, assuming the positive if'
nl|'\n'
comment|'# not sure. This can be removed when we bump to RPC API version 4.0.'
nl|'\n'
indent|'        '
name|'if'
name|'data'
...
op|':'
newline|'\n'
comment|'# Shared block storage, or unknown'
nl|'\n'
indent|'                '
name|'should_warn'
op|'='
...
op|':'
newline|'\n'
comment|'# Specifically not shared block storage'
nl|'\n'
indent|'                '
name|'should_warn'
op|'='
...
op|':'
newline|'\n'
comment|'# Unknown, so warn to be safe'
nl|'\n'
indent|'            '
name|'should_warn'
op|'='
...
name|'_LW'
op|'('
string|"'Live migration with clients before RPC version '"
nl|'\n'
string|"'3.32 is known to be buggy with shared block '"
nl|'\n'
string|"'storage. See '"
nl|'\n'
string|"'https://bugs.launchpad.net/nova/+bug/1250751 for '"
nl|'\n'
