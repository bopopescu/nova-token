...
newline|'\n'
nl|'\n'
DECL|member|_check_live_migration_api_version
dedent|''
name|'def'
name|'_check_live_migration_api_version'
op|'('
name|'self'
op|','
name|'server'
...
op|':'
newline|'\n'
comment|'# NOTE(angdraug): live migration involving a compute host running Nova'
nl|'\n'
comment|'# API older than v3.32 as either source or destination can cause'
nl|'\n'
comment|'# instance disks to be deleted from shared storage'
nl|'\n'
indent|'        '
name|'if'
name|'not'
