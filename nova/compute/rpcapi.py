...
op|':'
newline|'\n'
comment|'# NOTE(eliqiao): This is a new feature that is only available'
nl|'\n'
comment|'# once all compute nodes support at least version 4.11.'
nl|'\n'
comment|'# This means the new REST API that supports this needs to handle'
nl|'\n'
comment|'# this exception correctly. This can all be removed when we bump'
nl|'\n'
comment|'# the major version of this RPC API.'
nl|'\n'
indent|'            '
name|'if'
name|'block_migration'
