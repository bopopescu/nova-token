...
newline|'\n'
comment|'# NOTE(markwash): regular api manipulates the migration here, but we'
nl|'\n'
comment|"# don't have access to it. So to preserve the interface just update the"
nl|'\n'
comment|'# vm and task state.'
nl|'\n'
name|'self'
op|'.'
name|'update'
...
newline|'\n'
comment|"# NOTE(markwash): regular api manipulates migration here, but we don't"
nl|'\n'
comment|'# have the migration in the api database. So to preserve the interface'
nl|'\n'
comment|'# just update the vm and task state without calling super()'
nl|'\n'
name|'self'
op|'.'
name|'update'
