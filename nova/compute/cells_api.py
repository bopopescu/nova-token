...
op|':'
newline|'\n'
comment|'# NOTE(sbauza): Creation of the Service object involves creating'
nl|'\n'
comment|'# a ComputeNode object in this case. Now that the relationship'
nl|'\n'
comment|'# between those is removed, we can safely remove the compute_node'
nl|'\n'
comment|"# field from the DB until we're removing the SQLA relationship too."
nl|'\n'
comment|"# We're sure that no consumers of this method are using the"
nl|'\n'
comment|'# nested compute_node field.'
nl|'\n'
indent|'            '
name|'if'
string|"'compute_node'"
