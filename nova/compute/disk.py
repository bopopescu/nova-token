...
name|'warn'
op|'('
string|'"Input partition size not evenly divisible by sector size: %d / %d"'
op|'('
name|'file_size'
op|','
name|'sector_size'
...
name|'warn'
op|'('
string|'"Bytes for local storage not evenly divisible by sector size: %d / %d"'
op|'('
name|'local_bytes'
op|','
name|'sector_size'
...
name|'sshdir'
op|')'
comment|"#error on existing dir doesn't matter"
newline|'\n'
name|'execute'
op|'('
