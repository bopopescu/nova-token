...
name|'inlineCallbacks'
newline|'\n'
DECL|function|_inject_dns_into_fs
name|'def'
name|'_inject_dns_into_fs'
op|'('
name|'dns'
...
name|'inlineCallbacks'
newline|'\n'
DECL|function|_remove_network_udev
name|'def'
name|'_remove_network_udev'
op|'('
name|'fs'
...
op|':'
newline|'\n'
comment|'# TODO(justinsb): This is correct for Ubuntu, but might not be right for'
nl|'\n'
comment|'#  other distros.  There is a much bigger discussion to be had about what'
nl|'\n'
comment|'#  we inject and how we inject it.'
nl|'\n'
indent|'    '
name|'rulesfile'
op|'='
...
string|"'rules.d'"
op|','
string|"'70-persistent-net.rules'"
op|')'
newline|'\n'
name|'yield'
name|'execute'
