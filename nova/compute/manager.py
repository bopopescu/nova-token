...
name|'_'
op|'('
string|'"Instance %(instance_uuid)s has been destroyed "'
nl|'\n'
string|'"from under us while trying to set it to ERROR"'
op|')'
op|'%'
nl|'\n'
name|'locals'
...
name|'_'
op|'('
string|'"Instance %s already deleted from database. "'
nl|'\n'
string|'"Attempting forceful vm deletion"'
op|')'
nl|'\n'
op|'%'
name|'instance_uuid'
...
name|'_'
op|'('
string|'"Exception encountered while terminating the "'
nl|'\n'
string|'"instance %s"'
op|')'
op|'%'
...
name|'_'
op|'('
string|"'trying to destroy already destroyed instance: %s'"
op|')'
newline|'\n'
name|'raise'
name|'exception'
...
name|'_'
op|'('
string|'"Cannot rebuild instance [%(instance_uuid)s]"'
nl|'\n'
string|'", because the given image does not exist."'
op|')'
newline|'\n'
name|'LOG'
op|'.'
...
name|'_'
op|'('
string|'"Cannot rebuild instance [%(instance_uuid)s]: %(exc)s"'
op|')'
newline|'\n'
name|'LOG'
op|'.'
...
nl|'\n'
string|"'instance: %(instance_uuid)s (state: '"
nl|'\n'
string|"'%(current_power_state)s '"
nl|'\n'
...
name|'_'
op|'('
string|"'Attach failed %(mountpoint)s, removing'"
op|')'
op|','
nl|'\n'
name|'locals'
...
name|'_'
op|'('
string|'"Updated the info_cache for instance %s"'
op|')'
op|'%'
nl|'\n'
name|'instance'
...
name|'_'
op|'('
string|'"Instance found in database but not known by "'
nl|'\n'
string|'"hypervisor. Setting power state to NOSTATE"'
op|')'
op|','
nl|'\n'
name|'locals'
...
nl|'\n'
string|'"\'%(name_label)s\' which is marked as "'
nl|'\n'
