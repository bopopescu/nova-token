...
nl|'\n'
nl|'\n'
DECL|function|instance_lock_checked
dedent|''
dedent|''
dedent|''
name|'def'
...
nl|'\n'
nl|'\n'
DECL|class|_V2ComputeManagerProxy
dedent|''
name|'class'
name|'_V2ComputeManagerProxy'
op|'('
...
comment|'# Notes:'
nl|'\n'
comment|'# - can remove checks_instance_lock()'
nl|'\n'
comment|'# - lock/unlock_instance() removed'
nl|'\n'
comment|'# - get_instance_disk_info() removed'
nl|'\n'
comment|'# - compare_cpu() removed'
nl|'\n'
comment|'# - create/check/cleanup_shared_storage_test_file() removed'
nl|'\n'
comment|'# - make rollback_live_migration() private'
nl|'\n'
nl|'\n'
DECL|member|__init__
name|'def'
...
newline|'\n'
nl|'\n'
comment|'# require instance, remove instance_uuid'
nl|'\n'
dedent|''
op|'@'
name|'instance_lock_checked'
...
newline|'\n'
nl|'\n'
comment|'# require instance, remove instance_id'
nl|'\n'
DECL|member|check_can_live_migrate_destination
dedent|''
name|'def'
...
comment|'# require instance, remove instance_uuid'
nl|'\n'
comment|'# require instance_type, remove instance_type_id'
nl|'\n'
dedent|''
op|'@'
name|'instance_lock_checked'
...
comment|'# remove kwargs'
nl|'\n'
comment|'# add new_pass and injected_files'
nl|'\n'
dedent|''
op|'@'
name|'instance_lock_checked'
