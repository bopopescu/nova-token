...
newline|'\n'
indent|'        '
string|'""" Check the host cpu is compatible to a cpu given by xml."""'
newline|'\n'
name|'return'
name|'self'
op|'.'
...
newline|'\n'
indent|'        '
string|'"""make tmpfile under FLAGS.instance_path."""'
newline|'\n'
name|'fd'
op|','
name|'name'
...
op|')'
newline|'\n'
comment|'# No essential reason to write dateinfo. just for debugging reason.'
nl|'\n'
name|'os'
op|'.'
name|'fdopen'
...
newline|'\n'
indent|'        '
string|'"""Confirm existence of the tmpfile given by path."""'
newline|'\n'
name|'if'
name|'not'
name|'os'
...
name|'_'
op|'('
string|'"%(instance_id)s(%(ec2_id)s) doesnt have fixed_ip"'
op|')'
newline|'\n'
name|'raise'
name|'exception'
...
name|'_'
op|'('
string|'"setup_compute_network() fail %(i)d th. "'
nl|'\n'
...
nl|'\n'
comment|'# On destination host, this nwfilter is necessary.'
nl|'\n'
...
name|'name'
newline|'\n'
comment|'#fixed_ip = self.db.instance_get_fixed_address(ctxt, instance_id)'
nl|'\n'
comment|'# Not return if fixed_ip is not found, otherwise,'
nl|'\n'
comment|'# instance never be accessible..'
nl|'\n'
comment|'#if None == fixed_ip:'
nl|'\n'
comment|"#    LOG.warn(_('fixed_ip is not found for %s.') % i_name)"
nl|'\n'
comment|"#self.db.fixed_ip_update(ctxt, fixed_ip, {'host': dest})"
nl|'\n'
nl|'\n'
name|'try'
op|':'
...
newline|'\n'
indent|'        '
string|'"""Instance/volume state is recovered from migrating -> running."""'
newline|'\n'
nl|'\n'
name|'if'
name|'not'
