...
op|')'
newline|'\n'
comment|'# Failed during spawn so little point in trying a clean shutdown'
nl|'\n'
dedent|''
name|'self'
op|'.'
...
newline|'\n'
nl|'\n'
comment|'# May have been allocated previously and rescheduled to this host'
nl|'\n'
indent|'        '
name|'network_info'
op|'='
...
op|':'
newline|'\n'
comment|'# possiblity instance no longer exists, no point in continuing'
nl|'\n'
indent|'            '
name|'LOG'
op|'.'
...
op|':'
newline|'\n'
comment|'# Note:  Have already shutdown the instance'
nl|'\n'
indent|'            '
name|'self'
op|'.'
...
op|':'
newline|'\n'
comment|'# Note(Phild): Would have performed a clean shudown (if'
nl|'\n'
comment|'# requested) at the point of the original soft delete'
nl|'\n'
comment|'# so no need to do it here'
nl|'\n'
indent|'                    '
name|'self'
op|'.'
...
op|':'
newline|'\n'
comment|'# Note(phild): Could be that we missed the original'
nl|'\n'
comment|'# delete request, so give the instance a chance to'
nl|'\n'
comment|'# stop cleanly'
nl|'\n'
indent|'                        '
name|'self'
op|'.'
