...
newline|'\n'
comment|'# TODO(ndipanov): Remove this once all code using this method is'
nl|'\n'
comment|'# converted to BDM objects. Currently this means only'
nl|'\n'
comment|'# _reschedule_or_error'
nl|'\n'
name|'if'
op|'('
name|'bdms'
