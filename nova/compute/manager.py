...
string|"'Setting this to 0 will disable, but this will change in '"
nl|'\n'
string|'\'Juno to mean "run at the default rate".\''
op|')'
op|','
nl|'\n'
comment|'# TODO(gilliard): Clean the above message after the K release'
...
op|':'
newline|'\n'
comment|'# NOTE(danms): Use getitem syntax for the instance until'
nl|'\n'
comment|'# all the callers are using objects'
nl|'\n'
indent|'            '
name|'return'
name|'self'
...
nl|'\n'
string|"'host (%(our_host)s) but its state is '"
nl|'\n'
string|"'(%(task_state)s)'"
op|','
nl|'\n'
...
op|')'
newline|'\n'
DECL|function|do_revert_resize
name|'def'
name|'do_revert_resize'
op|'('
name|'context'
op|','
name|'instance'
...
newline|'\n'
nl|'\n'
comment|'# NOTE(lbragstad): Here we should make sure to update the instance'
nl|'\n'
comment|'# object before the migration in the event the'
nl|'\n'
comment|'# _poll_unconfirmed_resizes periodic task is run in between the'
nl|'\n'
comment|'# instance and migration updates. If we update the instance first the'
nl|'\n'
comment|'# migration record will sync in _confirm_resize the next time the'
nl|'\n'
comment|'# periodic task is run, versus erroring out because the migration has'
nl|'\n'
comment|"# 'finished' and the instance doesn't have task state RESIZE_FINISH."
nl|'\n'
name|'instance'
op|'.'
name|'vm_state'
...
op|')'
newline|'\n'
DECL|function|do_finish_resize
name|'def'
name|'do_finish_resize'
op|'('
name|'context'
op|','
name|'disk_info'
...
name|'None'
newline|'\n'
comment|'# TODO(geekinutah): Once bw_usage_cache object is created'
nl|'\n'
comment|'#                   need to revisit this and slaveify.'
nl|'\n'
name|'usage'
op|'='
name|'self'
...
op|':'
newline|'\n'
comment|'# TODO(geekinutah): Same here, pls slaveify'
nl|'\n'
indent|'                    '
name|'usage'
op|'='
...
newline|'\n'
nl|'\n'
comment|'# FIXME(comstud): Dummy quota object for now. See bug 1296414.'
nl|'\n'
comment|'# We have potential for inconsistency if we decide here to not'
nl|'\n'
comment|'# update quotas. _delete_instance() should determine whether or'
nl|'\n'
comment|'# not to update quotas based on if instance is in a SOFT_DELETED'
nl|'\n'
