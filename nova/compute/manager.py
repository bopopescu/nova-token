...
newline|'\n'
nl|'\n'
comment|'# NOTE(russellb): There are two versions of the checks_instance_lock'
nl|'\n'
comment|'# decorator.  This function is the core code for it.  This just serves'
nl|'\n'
comment|'# as a transition from when every function expected a context'
nl|'\n'
comment|'# and instance_uuid as positional arguments to where everything is a kwarg,'
nl|'\n'
comment|'# and the function may get either an instance_uuid or an instance.'
nl|'\n'
DECL|function|_checks_instance_lock_core
name|'def'
name|'_checks_instance_lock_core'
op|'('
name|'self'
op|','
name|'cb'
...
op|'='
name|'False'
comment|"# Implied, since we wouldn't be here otherwise"
newline|'\n'
dedent|''
name|'else'
op|':'
...
op|')'
newline|'\n'
DECL|function|decorated_function_new
name|'def'
name|'decorated_function_new'
op|'('
name|'self'
op|','
name|'context'
...
newline|'\n'
nl|'\n'
comment|'# NOTE(russellb): There are two versions of the wrap_instance_fault'
nl|'\n'
comment|'# decorator.  This function is the core code for it.  This just serves'
nl|'\n'
comment|'# as a transition from when every function expected a context'
...
comment|'# and the function may get either an instance_uuid or an instance.'
nl|'\n'
DECL|function|_wrap_instance_fault_core
name|'def'
name|'_wrap_instance_fault_core'
op|'('
name|'self'
op|','
name|'cb'
...
nl|'\n'
comment|'# filters are present, calling it once is enough.'
nl|'\n'
name|'if'
name|'count'
op|'=='
...
op|'('
op|')'
comment|'# save original exception'
newline|'\n'
name|'rescheduled'
op|'='
name|'False'
...
newline|'\n'
nl|'\n'
DECL|function|_log_original_error
name|'def'
...
op|':'
newline|'\n'
comment|'# do not attempt retry if network de-allocation occurs:'
nl|'\n'
indent|'            '
name|'_log_original_error'
op|'('
...
name|'_'
op|'('
string|'"Re-scheduling instance: attempt %d"'
op|')'
op|','
nl|'\n'
name|'retry'
...
newline|'\n'
nl|'\n'
comment|'# TODO(russellb): no-db-compute: Send the old instance type info'
nl|'\n'
comment|"# that is needed via rpc so db access isn't required here."
nl|'\n'
dedent|''
...
op|':'
newline|'\n'
comment|'# Note(maoy): there is no need to propergate the error'
nl|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|_add_instance_fault_from_exc
dedent|''
name|'def'
name|'_add_instance_fault_from_exc'
op|'('
