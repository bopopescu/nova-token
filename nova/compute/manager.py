...
newline|'\n'
nl|'\n'
comment|'# Creating nova-instance-instance-xxx,'
nl|'\n'
comment|'# this is written to libvirt.xml,'
nl|'\n'
comment|'# and can be seen when executin "virsh nwfiter-list"'
nl|'\n'
comment|'# On destination host, this nwfilter is necessary.'
nl|'\n'
comment|'# In addition this method is creating security rule ingress rule'
nl|'\n'
...
name|'_'
op|'('
string|"'Pre live migration failed(err at %s)'"
op|')'
op|','
name|'dest'
op|')'
...
newline|'\n'
nl|'\n'
comment|'# Waiting for setting up nwfilter such as, nova-instance-instance-xxx.'
nl|'\n'
