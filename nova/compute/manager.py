...
op|':'
newline|'\n'
comment|'# NOTE(jk0): Since the default local_gb of m1.tiny is 0, we will'
nl|'\n'
comment|'# allow the check to proceed. We may want to look into changing the'
nl|'\n'
comment|'# default size to 1GB.'
nl|'\n'
indent|'                '
name|'return'
newline|'\n'
...
name|'host'
newline|'\n'
comment|'# NOTE(vish): used by virt but not in database'
nl|'\n'
name|'updates'
op|'['
