...
op|':'
newline|'\n'
comment|'# FIXME(comstud): See bug 1296414. Quotas here should only be'
nl|'\n'
comment|'# committed if the instance is not SOFT_DELETED. If there were'
nl|'\n'
comment|'# some sort of race and the instance was SOFT_DELETED, we should'
nl|'\n'
comment|'# not commit quotas, as they would have already been done in'
nl|'\n'
comment|'# soft_delete().'
nl|'\n'
indent|'        '
