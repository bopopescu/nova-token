...
nl|'\n'
comment|'# FIXME(comstud): Would be nice to consolidate this into'
nl|'\n'
comment|'# a single query to nova-conductor.'
nl|'\n'
indent|'            '
name|'for'
name|'uuid'
...
newline|'\n'
comment|"# Get the network info from network API, but don't let it"
nl|'\n'
comment|"# update the cache, as that will hit the DB.  We'll update"
nl|'\n'
comment|'# the cache ourselves via the conductor.'
nl|'\n'
name|'network_info'
op|'='
name|'self'
