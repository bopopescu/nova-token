...
newline|'\n'
nl|'\n'
DECL|member|_get_and_check_image_metadata
dedent|''
dedent|''
name|'def'
name|'_get_and_check_image_metadata'
...
op|':'
newline|'\n'
comment|'# Disregard missing field or bad data rather than put the instance'
nl|'\n'
comment|"# into an ERROR state that can't be communicated back to the user"
nl|'\n'
indent|'            '
name|'return'
name|'image_meta'
...
op|')'
newline|'\n'
comment|'# NOTE(danms): We fetched instances above without the'
nl|'\n'
comment|'# system_metadata for efficiency. If we get here, we need'
nl|'\n'
comment|'# to re-fetch with it so that _delete_instace() can extract'
nl|'\n'
comment|'# instance_type information.'
nl|'\n'
name|'instance'
op|'='
name|'capi'
