...
name|'network_info'
newline|'\n'
comment|'# NOTE(JoshNang) This also saves the changes to the instance from'
nl|'\n'
comment|"# _allocate_network_async, as they aren't saved in that function"
nl|'\n'
comment|'# to prevent races.'
nl|'\n'
name|'instance'
op|'.'
name|'save'
