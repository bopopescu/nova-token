...
name|'_'
op|'('
string|'"""setup_compute_node fail %(i)d th. """'
nl|'\n'
string|'"""retry up to %(max_retry)d """'
nl|'\n'
string|'"""(%(ec2_id)s == %(i_name)s"""'
op|')'
op|'%'
name|'locals'
op|'('
...
name|'_'
op|'('
string|'"Pre live migration for %(ec2_id)s failed at %(dest)s"'
op|')'
newline|'\n'
name|'LOG'
op|'.'
...
newline|'\n'
nl|'\n'
comment|'# e should be raised. just calling "raise" may raise NotFound.'
nl|'\n'
dedent|''
name|'raise'
name|'e'
