...
newline|'\n'
nl|'\n'
DECL|member|_get_instances_at_startup
dedent|''
dedent|''
name|'def'
...
newline|'\n'
indent|'        '
string|"'''Get instances for this host during service init.'''"
newline|'\n'
name|'attempt'
op|'='
number|'0'
...
nl|'\n'
comment|'# running when nova-compute started.'
nl|'\n'
name|'try'
op|':'
newline|'\n'
...
nl|'\n'
string|"'Is it running? Or did nova-compute start '"
nl|'\n'
...
newline|'\n'
nl|'\n'
comment|'# getting all vms on this host'
nl|'\n'
...
op|':'
newline|'\n'
comment|'# try to find all local instances by uuid'
nl|'\n'
indent|'            '
name|'for'
name|'uuid'
...
name|'_'
op|'('
string|"'Instance %(uuid)s found in the '"
nl|'\n'
...
op|':'
newline|'\n'
comment|"# the driver doesn't support uuids listing, will do it in ugly way"
nl|'\n'
indent|'            '
name|'for'
name|'instance_name'
...
op|':'
newline|'\n'
comment|"# couldn't find better way to find instance in db by it's"
nl|'\n'
comment|'# name if i will run on the list of this host instances it'
nl|'\n'
comment|'# will be hard to ignore instances that were created'
nl|'\n'
comment|"# outside openstack. returns -1 if instance name doesn't"
nl|'\n'
comment|'# match template'
nl|'\n'
indent|'                    '
name|'instance_id'
op|'='
...
name|'_'
op|'('
string|"'Instance %(instance_name)s found in the '"
nl|'\n'
string|"'hypervisor, but not in the database'"
op|')'
op|','
...
name|'_'
op|'('
string|"'instance host %(instance_host)s is not equal to '"
nl|'\n'
string|"'current host %(host)s. '"
nl|'\n'
string|"'Deleting zombie instance %(instance_name)s'"
op|')'
op|','
nl|'\n'
name|'locals'
...
op|':'
newline|'\n'
comment|"# if driver doesn't support recreate return with failure"
nl|'\n'
indent|'                    '
name|'_msg'
op|'='
name|'_'
op|'('
string|"'instance recreate is not implemented '"
nl|'\n'
...
name|'_'
op|'('
string|'"Invalid state of instance files on "'
nl|'\n'
string|'"shared storage"'
op|')'
newline|'\n'
name|'raise'
name|'exception'
...
name|'_'
op|'('
string|"'disk on shared storage,'"
nl|'\n'
string|"'recreating using existing disk'"
op|')'
op|')'
newline|'\n'
dedent|''
...
name|'_'
op|'('
string|'"disk not on shared storage"'
nl|'\n'
string|'"rebuilding from: \'%s\'"'
op|')'
op|'%'
name|'str'
op|'('
...
newline|'\n'
nl|'\n'
comment|"# We can't run volume disconnect on source because"
nl|'\n'
comment|'# the host is down. Just marking volume as detached'
nl|'\n'
comment|'# in db, anyway the zombie instance going to be deleted'
nl|'\n'
comment|'# from source during init_host when host comes back'
nl|'\n'
name|'self'
op|'.'
name|'volume_api'
...
op|')'
newline|'\n'
comment|"# pull in new password here since the original password isn't in"
nl|'\n'
comment|'# the db'
nl|'\n'
name|'admin_password'
...
op|')'
newline|'\n'
comment|'# NOTE(danms): remove this when RPC API < 2.5 compatibility'
nl|'\n'
comment|'# is no longer needed'
nl|'\n'
dedent|''
...
name|'_'
op|'('
string|'"Faild to detach volume %(volume_id)s from %(mp)s"'
op|')'
newline|'\n'
name|'LOG'
op|'.'
...
newline|'\n'
nl|'\n'
comment|'# assign the volume to host system'
nl|'\n'
comment|'# needed by the lefthand volume driver and maybe others'
nl|'\n'
dedent|''
name|'connector'
op|'='
...
name|'_'
op|'('
string|'"Instance is paused or suspended "'
nl|'\n'
string|'"unexpectedly. Calling "'
nl|'\n'
string|'"the stop API."'
op|')'
op|','
