...
nl|'\n'
comment|"#NOTE(tr3buchet): I don't see why we'd save it here when the network"
nl|'\n'
comment|'#                 manager is saving it.'
nl|'\n'
name|'if'
name|'not'
name|'FLAGS'
...
nl|'\n'
string|'"Setting state to shutoff."'
op|')'
op|'%'
name|'locals'
op|'('
