...
name|'_'
op|'('
string|'"check_instance_lock: arguments: |%s| |%s| |%s|"'
op|')'
op|','
nl|'\n'
name|'self'
...
newline|'\n'
indent|'        '
string|'"""Insert compute node specific information to DB."""'
newline|'\n'
nl|'\n'
name|'try'
op|':'
...
name|'_'
op|'('
string|'"Detach volume %s from mountpoint %s on instance %s"'
op|')'
op|','
nl|'\n'
name|'volume_id'
...
newline|'\n'
indent|'        '
string|'"""remove the tmpfile given by path."""'
newline|'\n'
name|'return'
name|'utils'
op|'.'
