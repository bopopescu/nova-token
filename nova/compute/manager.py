...
op|')'
newline|'\n'
comment|'# Pull the system_metadata before we delete the instance, so we'
nl|'\n'
comment|'# can pass it to delete.end notification, as it will not be able'
nl|'\n'
comment|'# to look it up anymore, if it needs it.'
nl|'\n'
name|'system_meta'
op|'='
name|'self'
