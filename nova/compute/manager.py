begin_unit
comment|'#: tabstop=4 shiftwidth=4 softtabstop=4'
nl|'\n'
nl|'\n'
...
nl|'\n'
comment|'# block devices for swap and ephemeralN will be'
nl|'\n'
comment|'# created by virt driver locally in compute node.'
nl|'\n'
indent|'                '
name|'assert'
op|'('
