...
newline|'\n'
nl|'\n'
comment|"# NOTE(comstud): Since we've not updated the DB yet with the new"
nl|'\n'
comment|'# image_ref, and rebuild.start should have image_ref_url pointing'
nl|'\n'
comment|'# to the new image ref, we need to override it.'
nl|'\n'
comment|'# Arguably, image_ref_url should still contain the old image at'
nl|'\n'
comment|"# this point and we should pass a 'new_image_ref_url', instead."
nl|'\n'
name|'image_ref_url'
op|'='
name|'utils'
...
newline|'\n'
nl|'\n'
comment|"# NOTE(comstud): Now that we've shutdown the old instance, we"
nl|'\n'
comment|'# can update the image_ref in the DB.'
nl|'\n'
name|'instance'
op|'='
name|'self'
