...
newline|'\n'
indent|'        '
string|'"""Reset the root/admin password for  an instance on this server."""'
newline|'\n'
name|'context'
op|'='
name|'context'
...
name|'debug'
op|'('
string|"'instance %s: resetting root password'"
op|','
nl|'\n'
name|'instance_ref'
op|'['
...
name|'NOSTATE'
op|','
string|"'resetting_password'"
op|')'
newline|'\n'
comment|'#### TODO: (dabo) not sure how we will implement this yet.'
nl|'\n'
name|'new_pass'
op|'='
name|'self'
