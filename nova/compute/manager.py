...
name|'_'
op|'('
string|"'instance live snapshotting'"
op|')'
op|','
name|'context'
op|'='
...
name|'_'
op|'('
string|"'Instance was deleted during snapshot.'"
op|')'
newline|'\n'
name|'LOG'
op|'.'
...
newline|'\n'
nl|'\n'
comment|'# If Cinder initiated the swap, it will keep the original ID'
nl|'\n'
name|'comp_ret'
op|'='
name|'self'
