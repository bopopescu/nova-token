...
newline|'\n'
nl|'\n'
comment|'# TODO(blamar): Detach volumes prior to rebuild.'
nl|'\n'
nl|'\n'
comment|'# NOTE(blamar): The driver interface seems to indicate `destroy` is an'
nl|'\n'
comment|'#               async call, but the implementations look sync...'
nl|'\n'
name|'self'
op|'.'
name|'driver'
...
newline|'\n'
indent|'        '
string|'"""Finishes the second half of reverting a resize, powering back on\n        the source instance and reverting the resized attributes in the\n        database"""'
newline|'\n'
name|'instance_ref'
op|'='
name|'self'
...
newline|'\n'
indent|'        '
string|'"""Return connection information for an vnc console."""'
newline|'\n'
name|'context'
op|'='
name|'context'
...
name|'_'
op|'('
string|'"%(instance_id)s(%(ec2_id)s) does not have fixed_ip."'
op|')'
newline|'\n'
name|'raise'
name|'exception'
...
op|':'
newline|'\n'
comment|'# Assume that NOSTATE => spawning'
nl|'\n'
