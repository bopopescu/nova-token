...
name|'help'
op|'='
string|'"Automatically confirm resizes and cold migrations "'
nl|'\n'
string|'"after N seconds. Set to 0 to disable."'
op|')'
op|','
nl|'\n'
name|'cfg'
...
name|'_LI'
op|'('
string|'"Successfully reverted task state from %s on "'
nl|'\n'
string|'"failure for instance."'
op|')'
op|','
name|'original_task_state'
op|','
...
name|'debug'
op|'('
string|"'Unexpected attempt to cancel events during shutdown.'"
op|')'
newline|'\n'
name|'return'
newline|'\n'
...
comment|'# us to do so.'
nl|'\n'
comment|'# NOTE(vladikr): SR-IOV ports should be deallocated to'
nl|'\n'
comment|'# allow new sriov pci devices to be allocated on a new host.'
nl|'\n'
comment|'# Otherwise, if devices with pci addresses are already allocated'
nl|'\n'
comment|'# on the destination host, the instance will fail to spawn.'
nl|'\n'
comment|'# info_cache.network_info should be present at this stage.'
nl|'\n'
name|'if'
op|'('
name|'self'
...
name|'self'
op|'.'
name|'deallocate_sriov_ports_on_reschedule'
op|'('
name|'instance'
op|')'
op|')'
...
newline|'\n'
nl|'\n'
DECL|member|deallocate_sriov_ports_on_reschedule
dedent|''
dedent|''
name|'def'
name|'deallocate_sriov_ports_on_reschedule'
...
name|'_LW'
op|'('
string|"'Ignoring EndpointNotFound for '"
nl|'\n'
string|"'volume %(volume_id)s: %(exc)s'"
op|')'
op|','
nl|'\n'
op|'{'
...
name|'_LW'
op|'('
string|"'Ignoring unknown cinder exception for '"
nl|'\n'
string|"'volume %(volume_id)s: %(exc)s'"
op|')'
op|','
...
name|'_LW'
op|'('
string|"'Ignoring unknown exception for '"
nl|'\n'
string|"'volume %(volume_id)s: %(exc)s'"
op|')'
op|','
...
nl|'\n'
comment|"# effect of a trigger depends on user's configuration."
nl|'\n'
name|'self'
op|'.'
name|'driver'
...
name|'debug'
op|'('
string|"'Instance was deleted while rebuilding'"
op|','
nl|'\n'
name|'instance'
op|'='
...
op|')'
newline|'\n'
comment|'# NOTE(ndipanov): This frees the resources with the resource_tracker'
nl|'\n'
name|'self'
op|'.'
name|'_update_resource_tracker'
...
op|':'
newline|'\n'
comment|'# If the volume is attached to another host (evacuate) then'
nl|'\n'
comment|'# this connector is for the wrong host. Use the connector that'
nl|'\n'
comment|'# was stored in connection_info instead (if we have one, and it'
nl|'\n'
comment|'# is for the expected host).'
nl|'\n'
indent|'            '
name|'stashed_connector'
op|'='
name|'connection_info'
op|'.'
name|'get'
...
op|':'
newline|'\n'
comment|'# Volume was attached before we began stashing connectors'
nl|'\n'
indent|'                '
name|'LOG'
op|'.'
...
name|'_LW'
op|'('
string|'"Host mismatch detected, but stashed "'
nl|'\n'
string|'"volume connector not found. Instance host is "'
nl|'\n'
string|'"%(ihost)s, but volume connector host is "'
nl|'\n'
string|'"%(chost)s."'
op|')'
op|','
...
op|':'
newline|'\n'
comment|'# Unexpected error. The stashed connector is also not matching'
nl|'\n'
comment|'# the needed instance host.'
nl|'\n'
indent|'                '
name|'LOG'
op|'.'
...
name|'_LE'
op|'('
string|'"Host mismatch detected in stashed volume "'
nl|'\n'
string|'"connector. Will use local volume connector. "'
nl|'\n'
string|'"Instance host is %(ihost)s. Local volume "'
nl|'\n'
string|'"connector host is %(chost)s. Stashed volume "'
nl|'\n'
string|'"connector host is %(schost)s."'
op|')'
op|','
nl|'\n'
op|'{'
...
op|':'
newline|'\n'
comment|'# Fix found. Use stashed connector.'
nl|'\n'
indent|'                '
name|'LOG'
op|'.'
name|'debug'
op|'('
string|'"Host mismatch detected. Found usable stashed "'
nl|'\n'
string|'"volume connector. Instance host is %(ihost)s. "'
nl|'\n'
string|'"Local volume connector host was %(chost)s. "'
nl|'\n'
string|'"Stashed volume connector host is %(schost)s."'
op|','
nl|'\n'
op|'{'
string|"'ihost'"
...
name|'debug'
op|'('
string|"'destination check data is %s'"
op|','
name|'dest_check_data'
op|')'
newline|'\n'
...
name|'debug'
op|'('
string|"'pre_live_migration data is %s'"
op|','
name|'migrate_data'
op|')'
newline|'\n'
...
name|'debug'
op|'('
string|"'driver pre_live_migration data is %s'"
op|'%'
name|'migrate_data'
op|')'
newline|'\n'
...
name|'debug'
op|'('
string|"'pre_live_migration result data is %s'"
op|','
name|'migrate_data'
op|')'
newline|'\n'
...
name|'debug'
op|'('
string|"'live_migration data is %s'"
op|','
name|'migrate_data'
op|')'
newline|'\n'
...
newline|'\n'
comment|'# NOTE(pkoniszewski): block migration specific params are set inside'
nl|'\n'
comment|'# migrate_data objects for drivers that expose block live migration'
nl|'\n'
comment|'# information (i.e. Libvirt and Xenapi). For other drivers cleanup is'
nl|'\n'
comment|'# not needed.'
nl|'\n'
...
name|'_LE'
op|'('
string|"'Unexpected error during post live migration at '"
nl|'\n'
...
op|':'
newline|'\n'
comment|'# Restore instance state and update host'
nl|'\n'
indent|'            '
name|'current_power_state'
op|'='
...
newline|'\n'
nl|'\n'
DECL|member|update_available_resource_for_node
dedent|''
dedent|''
dedent|''
dedent|''
