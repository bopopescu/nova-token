...
name|'_'
op|'('
string|'"instance %s//%s: Failed to spawn"'
op|')'
op|','
nl|'\n'
name|'instance_ref'
...
name|'_'
op|'('
string|'"Terminating instance %s//%s"'
op|')'
op|','
nl|'\n'
name|'instance_ref'
...
name|'_'
op|'('
string|"'instance %s//%s: snapshotting'"
op|')'
op|','
nl|'\n'
name|'instance_ref'
...
nl|'\n'
string|"'instance: %s//%s (state: %s excepted: %s)'"
op|')'
op|','
nl|'\n'
name|'instance_ref'
...
name|'_'
op|'('
string|"'instance %s//%s: unrescuing'"
op|')'
op|','
nl|'\n'
name|'instance_ref'
...
name|'_'
op|'('
string|'"instance %s//%s: retrieving diagnostics"'
op|')'
op|','
nl|'\n'
name|'instance_ref'
...
name|'_'
op|'('
string|"'instance %s//%s: suspending'"
op|')'
op|','
nl|'\n'
name|'instance_ref'
...
name|'_'
op|'('
string|'"Get console output for instance %s//%s"'
op|')'
op|','
nl|'\n'
name|'instance_ref'
...
name|'_'
op|'('
string|'"instance %s//%s: attaching volume %s to %s"'
op|')'
op|','
nl|'\n'
name|'instance_ref'
...
name|'_'
op|'('
string|'"instance %s//%s: attach failed %s, removing"'
op|')'
op|','
nl|'\n'
name|'instance_ref'
...
name|'_'
op|'('
string|'"Detach volume %s from mountpoint %s on instance %s//%s"'
op|')'
op|','
nl|'\n'
name|'volume_id'
...
name|'_'
op|'('
string|'"Detaching volume from unknown instance %s//%s"'
op|')'
op|','
nl|'\n'
name|'instance_ref'
