...
nl|'\n'
nl|'\n'
DECL|function|checks_instance_lock_uuid
dedent|''
name|'def'
name|'checks_instance_lock_uuid'
op|'('
name|'function'
op|')'
op|':'
...
newline|'\n'
comment|'# TODO(ironcamel): Once the instance_id -> instance_uuid switch is'
nl|'\n'
comment|'# complete, rename this function to checks_instance_lock and delete the'
nl|'\n'
comment|'# existing checks_instance_lock. And also inline _decorated_function().'
nl|'\n'
op|'@'
name|'functools'
op|'.'
