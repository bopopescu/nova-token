...
newline|'\n'
indent|'        '
string|'"""Get the number of physical computer cpu core ."""'
newline|'\n'
name|'return'
name|'open'
op|'('
...
name|'error'
op|'('
string|"'Not found fixedip for %s\\n%s'"
op|','
nl|'\n'
name|'ec2_id'
op|','
...
newline|'\n'
nl|'\n'
comment|'# 3. getting network refs'
nl|'\n'
dedent|''
name|'network_ref'
op|'='
...
newline|'\n'
nl|'\n'
comment|'# 4. security rules (filtering rules)'
nl|'\n'
name|'secgrp_refs'
op|'='
name|'db'
...
newline|'\n'
nl|'\n'
comment|'# 5. if any volume is mounted, prepare here.'
nl|'\n'
name|'if'
number|'0'
op|'!='
...
newline|'\n'
nl|'\n'
comment|'# 6. create nova-instance-instance-xxx in hypervisor through libvirt'
nl|'\n'
comment|'#     (This rule can be seen by executing virsh nwfilter-list)'
nl|'\n'
dedent|''
name|'self'
op|'.'
...
newline|'\n'
nl|'\n'
comment|'# 7. insert filtering rule'
nl|'\n'
name|'for'
name|'secgrp_ref'
name|'in'
