...
nl|'\n'
string|"'id: %(id)s snapshot: %(snapshot_id)s '"
nl|'\n'
...
newline|'\n'
nl|'\n'
DECL|function|_make_network_info
dedent|''
dedent|''
name|'def'
name|'_make_network_info'
op|'('
op|')'
op|':'
newline|'\n'
...
op|':'
newline|'\n'
comment|"# NOTE(vish): This could be a cast because we don't do"
nl|'\n'
comment|"# anything with the address currently, but I'm leaving it as a"
nl|'\n'
comment|'# call to ensure that network setup completes.  We will'
nl|'\n'
comment|'# eventually also need to save the address here.'
nl|'\n'
indent|'                '
name|'network_info'
op|'='
...
newline|'\n'
nl|'\n'
DECL|function|_make_block_device_info
dedent|''
name|'def'
name|'_make_block_device_info'
op|'('
op|')'
op|':'
newline|'\n'
...
newline|'\n'
nl|'\n'
DECL|function|_deallocate_network
dedent|''
name|'def'
...
name|'_'
op|'('
string|'"Instance \'%(instance_id)s\' failed to spawn. "'
nl|'\n'
string|'"Details: %(error)s"'
op|')'
op|'%'
name|'locals'
op|'('
...
op|':'
newline|'\n'
comment|'# NOTE(sirp): 3-arg raise needed since Eventlet clears exceptions'
nl|'\n'
comment|'# when switching between greenthreads.'
nl|'\n'
indent|'            '
name|'type_'
op|','
...
op|':'
newline|'\n'
comment|'# FIXME(sirp): when/if'
nl|'\n'
comment|'# https://github.com/jcrocholl/pep8/pull/27 merges, we can add'
nl|'\n'
comment|'# a per-line disable flag here for W602'
nl|'\n'
indent|'                '
name|'raise'
name|'type_'
...
comment|'#              I think start will fail due to the files still'
nl|'\n'
comment|"#              existing.  I don't really know what the purpose of"
nl|'\n'
comment|'#              stop and start are when compared to pause and unpause'
nl|'\n'
name|'self'
op|'.'
name|'_shutdown_instance'
...
newline|'\n'
nl|'\n'
comment|"# NOTE(blamar): None of the virt drivers use the 'callback' param"
nl|'\n'
name|'self'
op|'.'
name|'driver'
...
name|'_'
op|'('
string|'"Error during poll_rebooting_instances: %s"'
op|')'
op|','
nl|'\n'
name|'unicode'
...
name|'_'
op|'('
string|'"Error during poll_unconfirmed_resizes: %s"'
op|')'
op|','
nl|'\n'
name|'unicode'
...
name|'_'
op|'('
string|'"Error during power_state sync: %s"'
op|')'
op|','
name|'unicode'
op|'('
...
name|'_'
op|'('
string|'"Error during reclamation of queued deletes: %s"'
op|')'
op|','
nl|'\n'
name|'unicode'
...
op|':'
newline|'\n'
comment|'# Not all hypervisors have bandwidth polling implemented yet.'
nl|'\n'
comment|"# If they don't id doesn't break anything, they just don't get the"
nl|'\n'
comment|'# info in the usage events. (mdragon)'
nl|'\n'
indent|'            '
name|'pass'
newline|'\n'
...
name|'_'
op|'('
string|'"Error updating bandwidth usage: %s"'
op|')'
op|','
nl|'\n'
name|'unicode'
...
newline|'\n'
nl|'\n'
DECL|member|_update_bandwidth_usage
dedent|''
name|'def'
name|'_update_bandwidth_usage'
op|'('
