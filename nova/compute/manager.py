...
newline|'\n'
nl|'\n'
comment|'# Verify that all the BDMs have a device_name set and assign a default'
nl|'\n'
comment|'# one to the ones missing it with the help of the driver.'
nl|'\n'
name|'self'
op|'.'
...
newline|'\n'
nl|'\n'
comment|"# FIXME(comstud): Remove 'image_type', 'backup_type', and 'rotation'"
nl|'\n'
comment|'#                 on next major RPC version bump.'
nl|'\n'
dedent|''
op|'@'
name|'object_compat'
