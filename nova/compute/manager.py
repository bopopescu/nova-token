...
op|')'
newline|'\n'
comment|'# TODO(yamahata): creatning volume simulteneously'
nl|'\n'
comment|'#                 reduce creation time?'
nl|'\n'
name|'volume_api'
op|'.'
name|'wait_creation'
...
op|')'
newline|'\n'
comment|'# instance state will be updated to stopped by _poll_istance_states()'
nl|'\n'
nl|'\n'
dedent|''
op|'@'
...
newline|'\n'
indent|'        '
string|'"""Attach a volume to an instnace at boot time. So actual attach\n        is done by instance creation"""'
newline|'\n'
nl|'\n'
comment|'# TODO(yamahata):'
nl|'\n'
