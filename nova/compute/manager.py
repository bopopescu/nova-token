...
newline|'\n'
nl|'\n'
comment|'# TODO: Block migration needs empty image at destination host'
nl|'\n'
comment|'# before migration starts, so if any failure occurs,'
nl|'\n'
comment|'# any empty images has to be deleted. but not sure adding below'
nl|'\n'
comment|'# method is appropreate here. for now, admin has to delete manually.'
nl|'\n'
comment|'# rpc.cast(ctxt,'
nl|'\n'
comment|'#          self.db.queue_get_for(ctxt, FLAGS.compute_topic, dest),'
nl|'\n'
comment|'#          {"method": "self.driver.destroy",'
nl|'\n'
comment|'#           "args": {\'instance\':instance_ref})'
nl|'\n'
nl|'\n'
