...
name|'_LW'
op|'('
string|"'Failed to delete volume: %(volume_id)s due '"
nl|'\n'
string|"'to %(exc)s'"
op|')'
op|','
...
name|'staticmethod'
newline|'\n'
DECL|member|_save_instance_info
name|'def'
name|'_save_instance_info'
op|'('
name|'instance'
op|','
name|'instance_type'
...
nl|'\n'
string|'"%(num_db_instances)s instances in the database and "'
nl|'\n'
string|'"%(num_vm_instances)s instances on the hypervisor."'
op|')'
op|','
nl|'\n'
op|'{'
...
name|'_LW'
op|'('
string|'"Instance shutdown by itself. Calling the stop "'
nl|'\n'
string|'"API. Current vm_state: %(vm_state)s, current "'
nl|'\n'
string|'"task_state: %(task_state)s, current DB "'
nl|'\n'
string|'"power_state: %(db_power_state)s, current VM "'
nl|'\n'
string|'"power_state: %(vm_power_state)s"'
op|')'
op|','
nl|'\n'
op|'{'
...
nl|'\n'
string|'"current DB power_state: %(db_power_state)s, "'
nl|'\n'
