...
op|')'
newline|'\n'
comment|'# The MAC address for this instance is tied to the host so if'
nl|'\n'
comment|"# we're going to reschedule we have to free the network details"
nl|'\n'
comment|'# and reallocate on the next host.'
nl|'\n'
name|'if'
name|'self'
op|'.'
...
op|':'
newline|'\n'
comment|'# self.driver.cleanup() usually performs  vif unplugging'
nl|'\n'
