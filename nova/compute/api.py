...
op|':'
newline|'\n'
comment|"# NOTE(sirp): '0' and '1' could be a bool value or an ID.  Since"
nl|'\n'
comment|"# there are many other ways to specify bools (e.g. 't', 'f'), it's"
nl|'\n'
comment|'# better to treat as an ID.'
nl|'\n'
indent|'            '
name|'return'
name|'None'
...
newline|'\n'
nl|'\n'
comment|'# FIXME(sirp): this check should go in'
nl|'\n'
comment|'# `_checks_for_create_and_rebuild`, however Tempest has a bug in'
nl|'\n'
comment|'# its quota checking test where its submitting a bad image ID. So'
nl|'\n'
comment|'# if `_get_image` is called first, we get a `ImageNotFound`'
nl|'\n'
comment|'# exception instead of a OverlimitException.'
nl|'\n'
name|'self'
op|'.'
name|'_check_metadata_properties_quota'
