...
newline|'\n'
nl|'\n'
comment|'# Should we create instances all-at-once or as single-shot requests.'
nl|'\n'
comment|'# Different schedulers use different approaches.'
nl|'\n'
comment|'# This is cached across all API instances.'
nl|'\n'
DECL|variable|should_create_all_at_once
name|'should_create_all_at_once'
op|'='
name|'None'
comment|'# None implies uninitialized.'
newline|'\n'
nl|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|get_all_across_zones
dedent|''
name|'def'
name|'get_all_across_zones'
op|'('
name|'self'
op|','
name|'context'
...
newline|'\n'
indent|'        '
string|'"""Get all instances with this reservation_id, across\n        all available Zones (if any).\n        """'
newline|'\n'
name|'instances'
op|'='
name|'self'
...
newline|'\n'
indent|'        '
string|'"""Associate a floating ip with an instance."""'
newline|'\n'
name|'instance'
op|'='
name|'self'
