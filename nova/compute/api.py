...
newline|'\n'
nl|'\n'
comment|'# grab the architecture from glance'
nl|'\n'
dedent|''
name|'architecture'
op|'='
...
op|':'
newline|'\n'
comment|'# NOTE(mikal): user_data is stored in a text column, and the'
nl|'\n'
comment|'# database might silently truncate if its over length.'
nl|'\n'
indent|'                '
name|'raise'
name|'exception'
...
op|':'
newline|'\n'
comment|'# Clean up as best we can.'
nl|'\n'
indent|'            '
name|'with'
name|'excutils'
...
op|')'
newline|'\n'
comment|'#Note(jogo): db allows for multiple compute services per host'
nl|'\n'
name|'for'
name|'service'
name|'in'
...
newline|'\n'
nl|'\n'
comment|'# change instance state and notify'
nl|'\n'
dedent|''
name|'old_vm_state'
op|'='
...
newline|'\n'
nl|'\n'
comment|'# NOTE(sirp): `instance_test_and_set` only sets the task-state in the'
nl|'\n'
comment|'# DB, but we also need to set it on the current instance so that the'
nl|'\n'
comment|'# correct value is passed down to the compute manager.'
nl|'\n'
name|'instance'
op|'['
string|"'task_state'"
...
string|'"%(overs)s quota exceeded for %(pid)s,"'
nl|'\n'
string|'" tried to resize instance. %(msg)s"'
op|')'
op|','
name|'locals'
op|'('
...
name|'reason'
op|'='
string|"'availability zone mismatch'"
op|')'
newline|'\n'
dedent|''
name|'self'
