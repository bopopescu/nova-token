...
newline|'\n'
nl|'\n'
DECL|member|_check_personality_file_quota
dedent|''
name|'def'
name|'_check_personality_file_quota'
op|'('
name|'self'
op|','
name|'context'
...
name|'quota'
op|'.'
name|'allowed_personality_files'
op|'('
name|'context'
op|')'
newline|'\n'
...
name|'_'
op|'('
string|'"Personality limit exceeded. You can "'
nl|'\n'
string|'"only have %d personalities when "'
nl|'\n'
string|'"creating an instance."'
op|')'
op|'%'
name|'limit'
op|','
nl|'\n'
string|'"PersonalityLimitExceeded"'
op|')'
newline|'\n'
dedent|''
name|'path_limit'
...
name|'quota'
op|'.'
name|'allowed_personality_path_bytes'
op|'('
name|'context'
op|')'
newline|'\n'
...
name|'quota'
op|'.'
name|'allowed_personality_content_bytes'
op|'('
name|'context'
op|')'
newline|'\n'
...
name|'_'
op|'('
string|'"Personality file path limit exceeded."'
op|')'
op|','
nl|'\n'
string|'"PersonalityLimitExceeded"'
...
name|'_'
op|'('
string|'"Personality file content limit exceeded."'
op|')'
op|','
nl|'\n'
string|'"PersonalityLimitExceeded"'
