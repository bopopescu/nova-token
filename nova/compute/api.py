...
string|"'migrating'"
op|':'
string|'"Instance %s is being migrated"'
op|','
nl|'\n'
string|"'stopping'"
op|':'
string|'"Instance %s is being stopped"'
op|'}'
newline|'\n'
name|'msg'
op|'='
...
name|'_'
op|'('
string|'"Quota exceeeded for %(pid)s, tried to set "'
nl|'\n'
...
name|'_'
op|'('
string|'"Quota exceeeded for %(pid)s, metadata property "'
nl|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|_check_create_parameters
dedent|''
dedent|''
dedent|''
name|'def'
name|'_check_create_parameters'
op|'('
name|'self'
op|','
name|'context'
...
nl|'\n'
comment|'# tell vm driver to attach volume at boot time by updating'
nl|'\n'
...
dedent|''
name|'def'
name|'_ask_scheduler_to_create_instance'
op|'('
name|'self'
op|','
name|'context'
...
newline|'\n'
indent|'        '
string|'"""Send the run_instance request to the schedulers for processing."""'
newline|'\n'
name|'pid'
op|'='
name|'context'
...
nl|'\n'
string|'" instance %(instance_id)s (single-shot)"'
op|')'
op|'%'
name|'locals'
op|'('
...
newline|'\n'
nl|'\n'
DECL|member|create_all_at_once
dedent|''
name|'def'
...
newline|'\n'
indent|'        '
string|'"""Provision the instances by passing the whole request to\n        the Scheduler for execution. Returns a Reservation ID\n        related to the creation of all of these instances."""'
newline|'\n'
name|'num_instances'
op|','
name|'base_options'
...
nl|'\n'
string|'"stopped(%(_state_description)s)"'
op|')'
op|'%'
name|'locals'
op|'('
...
newline|'\n'
nl|'\n'
DECL|function|_get_all_by_reservation_id
name|'def'
name|'_get_all_by_reservation_id'
op|'('
name|'reservation_id'
op|')'
op|':'
newline|'\n'
indent|'            '
string|'"""Get instances by reservation ID"""'
newline|'\n'
comment|'# reservation_id implies recurse_zones'
nl|'\n'
name|'search_opts'
op|'['
...
newline|'\n'
nl|'\n'
DECL|function|_get_all_by_project_id
dedent|''
name|'def'
name|'_get_all_by_project_id'
op|'('
name|'project_id'
op|')'
op|':'
newline|'\n'
indent|'            '
string|'"""Get instances by project ID"""'
newline|'\n'
name|'return'
name|'self'
op|'.'
...
newline|'\n'
nl|'\n'
DECL|function|_get_all_by_fixed_ip
dedent|''
name|'def'
name|'_get_all_by_fixed_ip'
op|'('
name|'fixed_ip'
op|')'
op|':'
newline|'\n'
indent|'            '
string|'"""Get instance by fixed IP"""'
newline|'\n'
name|'try'
op|':'
newline|'\n'
...
newline|'\n'
nl|'\n'
DECL|function|_get_all_by_instance_name
dedent|''
name|'def'
name|'_get_all_by_instance_name'
op|'('
name|'instance_name_regexp'
op|')'
op|':'
newline|'\n'
indent|'            '
string|'"""Get instances by matching the Instance.name property"""'
newline|'\n'
name|'return'
name|'self'
op|'.'
...
newline|'\n'
indent|'            '
string|'"""Get instances by matching IPv4 addresses"""'
newline|'\n'
name|'return'
name|'self'
op|'.'
...
newline|'\n'
nl|'\n'
DECL|function|_get_all_by_ipv6
dedent|''
name|'def'
name|'_get_all_by_ipv6'
op|'('
name|'ipv6_regexp'
op|')'
op|':'
newline|'\n'
indent|'            '
string|'"""Get instances by matching IPv6 addresses"""'
newline|'\n'
name|'return'
name|'self'
op|'.'
...
newline|'\n'
nl|'\n'
DECL|function|_get_all_by_column_regexp
dedent|''
name|'def'
name|'_get_all_by_column_regexp'
op|'('
name|'column_regexp'
op|','
name|'column'
...
newline|'\n'
indent|'            '
string|'"""Get instances by regular expression matching\n            Instance.<column>\n            """'
newline|'\n'
name|'return'
name|'self'
op|'.'
...
newline|'\n'
nl|'\n'
DECL|function|_get_all_by_column
dedent|''
name|'def'
name|'_get_all_by_column'
op|'('
name|'column_data'
op|','
name|'column'
...
newline|'\n'
indent|'            '
string|'"""Get instances by exact matching Instance.<column>"""'
newline|'\n'
name|'return'
name|'self'
op|'.'
...
newline|'\n'
nl|'\n'
DECL|function|_get_all_by_flavor
dedent|''
name|'def'
name|'_get_all_by_flavor'
op|'('
name|'flavor_id'
op|')'
op|':'
newline|'\n'
indent|'            '
string|'"""Get instances by flavor ID"""'
newline|'\n'
name|'try'
op|':'
newline|'\n'
...
newline|'\n'
nl|'\n'
comment|'# Define the search params that we will allow.  This is a mapping'
nl|'\n'
comment|'# of the search param to tuple of (function_to_call, (function_args))'
nl|'\n'
comment|"# A 'None' function means it's an optional parameter that will"
nl|'\n'
comment|'# influence the search results, but itself is not a search option.'
nl|'\n'
comment|'# Search options are mutually exclusive'
nl|'\n'
dedent|''
name|'known_params'
op|'='
...
op|','
nl|'\n'
comment|'# Mutually exclusive options'
nl|'\n'
string|"'name'"
op|':'
op|'('
...
newline|'\n'
nl|'\n'
comment|"# FIXME(comstud): 'fresh' and 'changes-since' are currently not"
nl|'\n'
comment|'# implemented...'
nl|'\n'
nl|'\n'
...
newline|'\n'
nl|'\n'
comment|'# Mutually exclusive serach options are any options that have'
nl|'\n'
comment|'# a function to call.  Raise an exception if more than 1 is'
nl|'\n'
comment|'# specified...'
nl|'\n'
comment|'# NOTE(comstud): Ignore unknown options.  The OS API will'
nl|'\n'
comment|"# do it's own verification on options.."
nl|'\n'
name|'found_opts'
op|'='
op|'['
...
name|'_'
op|'('
string|'"More than 1 mutually exclusive "'
nl|'\n'
string|'"search option specified: %(found_opt_str)s"'
op|')'
op|'%'
name|'locals'
op|'('
...
op|')'
newline|'\n'
comment|'# Nope.  Return all instances if the request is in admin context..'
nl|'\n'
dedent|''
name|'elif'
name|'context'
...
op|')'
newline|'\n'
comment|'# Nope.  Return all instances for the user/project'
nl|'\n'
dedent|''
name|'else'
op|':'
...
newline|'\n'
nl|'\n'
comment|'# Convert any responses into a list of instances'
nl|'\n'
dedent|''
dedent|''
name|'if'
...
op|')'
newline|'\n'
comment|'# API does state search by status, instead of the real power'
nl|'\n'
comment|"# state.  So if we're searching by 'state', we need to"
nl|'\n'
comment|"# convert this back into 'status'"
nl|'\n'
name|'state'
op|'='
name|'new_search_opts'
...
op|':'
newline|'\n'
comment|'# Might be a list.. we can only use 1.'
nl|'\n'
indent|'            '
name|'if'
name|'isinstance'
...
newline|'\n'
nl|'\n'
comment|'# Recurse zones.  Need admin context for this.'
nl|'\n'
dedent|''
name|'admin_context'
op|'='
...
newline|'\n'
nl|'\n'
comment|'# Fixed IP returns a FixedIpNotFound when an instance is not'
nl|'\n'
comment|'# found...'
nl|'\n'
dedent|''
...
name|'_'
op|'('
string|'"Instance already building"'
op|')'
newline|'\n'
name|'raise'
name|'exception'
...
name|'_'
op|'('
string|'"Requested flavor %(flavor_id)d "'
nl|'\n'
...
name|'_'
op|'('
string|'"Invalid flavor: cannot downsize"'
nl|'\n'
string|'"instances"'
op|')'
op|')'
...
name|'_'
op|'('
string|'"Invalid flavor: cannot use"'
nl|'\n'
string|'"the same flavor. "'
op|')'
op|')'
newline|'\n'
nl|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|update_or_create_instance_metadata
dedent|''
name|'def'
