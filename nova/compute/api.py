...
op|')'
newline|'\n'
comment|'# TODO (dabo) Need to verify whether an internal_id or a db id'
nl|'\n'
comment|'# id being passed; use get_instance or get, respectively.'
nl|'\n'
comment|'#instance = self.get(context, instance_id)'
nl|'\n'
dedent|''
name|'except'
name|'exception'
...
op|')'
newline|'\n'
comment|'#TODO: (dabo) resolve that this is the correct call: '
nl|'\n'
comment|'# get_instance vs. get. Depends on whether we get an internal_id '
nl|'\n'
comment|'# or an actual db id.'
nl|'\n'
comment|'#instance = self.get(context, instance_id)'
nl|'\n'
dedent|''
...
name|'_'
op|'('
string|"'Instance % was not found during terminate'"
op|')'
op|','
nl|'\n'
name|'instance_id'
