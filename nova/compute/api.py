...
nl|'\n'
nl|'\n'
DECL|function|id_to_default_hostname
name|'def'
name|'id_to_default_hostname'
op|'('
name|'internal_id'
op|')'
op|':'
...
nl|'\n'
nl|'\n'
DECL|function|id_to_ec2_hostname
dedent|''
name|'def'
name|'id_to_ec2_hostname'
op|'('
name|'internal_id'
op|')'
op|':'
...
nl|'\n'
nl|'\n'
DECL|variable|HOSTNAME_FORMATTERS
dedent|''
name|'HOSTNAME_FORMATTERS'
op|'='
op|'{'
string|"'default'"
op|':'
...
newline|'\n'
nl|'\n'
comment|"# If kernel_id/ramdisk_id isn't explicitly set in API call"
nl|'\n'
comment|"# we take the defaults from the image's metadata"
nl|'\n'
name|'if'
name|'kernel_id'
name|'is'
...
newline|'\n'
indent|'        '
string|'"""Terminate and remove an instance."""'
newline|'\n'
name|'logging'
op|'.'
name|'debug'
...
newline|'\n'
indent|'        '
string|'"""Get information about a specific instance."""'
newline|'\n'
name|'rv'
op|'='
name|'self'
