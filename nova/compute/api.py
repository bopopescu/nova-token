...
op|':'
newline|'\n'
comment|'# NOTE(russellb) If the group does not already exist, we need'
nl|'\n'
comment|'# to automatically create it to be backwards compatible with'
nl|'\n'
comment|"# old handling of the 'group' scheduler hint.  The policy type"
nl|'\n'
comment|"# will be 'legacy', indicating that this group was created to"
nl|'\n'
comment|'# emulate legacy group behavior.'
nl|'\n'
indent|'                '
name|'quotas'
op|'='
