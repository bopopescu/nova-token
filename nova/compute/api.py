...
op|':'
newline|'\n'
comment|'# TODO(mdbooth) Raise a more descriptive exception here.'
nl|'\n'
comment|'# This is the exception which calling code expects, but'
nl|'\n'
comment|"# it's potentially misleading to the user."
nl|'\n'
indent|'                    '
name|'raise'
name|'exception'
...
newline|'\n'
nl|'\n'
DECL|member|_merge_with_image_bdms
dedent|''
name|'def'
name|'_merge_with_image_bdms'
op|'('
name|'self'
op|','
name|'block_device_mapping'
...
newline|'\n'
indent|'        '
string|'"""Override any block devices from the image by device name"""'
newline|'\n'
name|'device_names'
op|'='
name|'set'
...
op|':'
newline|'\n'
comment|'# TODO(flwang): The log level will be changed to INFO after'
nl|'\n'
comment|'# string freeze (Liberty).'
nl|'\n'
indent|'            '
name|'LOG'
op|'.'
name|'debug'
op|'('
string|'"It\'s not supported to backup volume backed instance."'
op|','
nl|'\n'
name|'context'
op|'='
...
newline|'\n'
nl|'\n'
comment|'# The properties set up above and in extra_properties have precedence'
nl|'\n'
name|'properties'
op|'.'
name|'update'
...
newline|'\n'
comment|'# TODO(ft): Get metadata from the instance to avoid waste DB request'
nl|'\n'
name|'img'
op|'='
name|'instance'
...
newline|'\n'
nl|'\n'
comment|'# NOTE (ndipanov): Remove swap/ephemerals from mappings as they will be'
nl|'\n'
comment|'# in the block_device_mapping for the new image.'
nl|'\n'
dedent|''
name|'image_mappings'
op|'='
...
newline|'\n'
indent|'        '
string|'"""Calculate deltas required to adjust quota for an instance upsize.\n        """'
newline|'\n'
name|'return'
name|'API'
op|'.'
...
newline|'\n'
indent|'        '
string|'"""Calculate deltas required to reverse a prior upsizing\n        quota adjustment.\n        """'
newline|'\n'
name|'old_flavor'
op|'='
name|'objects'
...
newline|'\n'
indent|'        '
string|'"""Calculate deltas required to adjust quota for an instance downsize.\n        """'
newline|'\n'
name|'old_flavor'
op|'='
name|'instance'
