...
newline|'\n'
comment|'#NOTE(bcwaldon): we need to use the integer id here since manager uses'
nl|'\n'
comment|'# db.instance_get, not db.instance_get_by_uuid'
nl|'\n'
name|'instance_id'
op|'='
name|'instance'
...
newline|'\n'
nl|'\n'
DECL|member|_get_native_instance_id
dedent|''
name|'def'
name|'_get_native_instance_id'
op|'('
name|'self'
op|','
name|'context'
...
newline|'\n'
indent|'        '
string|'"""If an instance id is a UUID, convert it to a native ID."""'
newline|'\n'
name|'if'
name|'utils'
op|'.'
