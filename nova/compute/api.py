...
op|':'
newline|'\n'
comment|'# NOTE (ndipanov): For now assume that image mapping is legacy'
nl|'\n'
indent|'            '
name|'block_device_mapping'
op|'+='
...
newline|'\n'
nl|'\n'
comment|'# TODO(xqueralt): Use new style BDM in volume snapshots'
nl|'\n'
name|'bdms'
op|'='
name|'self'
...
newline|'\n'
nl|'\n'
comment|'# Clean the BDM of the database related fields to prevent'
nl|'\n'
comment|'# duplicates in the future (e.g. the id was being preserved)'
nl|'\n'
dedent|''
name|'for'
name|'field'
...
newline|'\n'
nl|'\n'
comment|'# Clean the extra volume related fields that will be generated'
nl|'\n'
comment|'# when booting from the new snapshot.'
nl|'\n'
name|'bdm'
op|'.'
name|'pop'
