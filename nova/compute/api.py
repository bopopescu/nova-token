...
newline|'\n'
nl|'\n'
comment|'# FIXME(kpepple) this needs to be changed from using the old constant'
nl|'\n'
comment|'#type_data = db.instance_type_get_by_name(context.get_admin_context(), instance_type)'
nl|'\n'
name|'type_data'
op|'='
name|'instance_types'
