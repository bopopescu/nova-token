...
name|'staticmethod'
newline|'\n'
DECL|member|_update_instance_group_by_name
name|'def'
name|'_update_instance_group_by_name'
op|'('
name|'context'
op|','
name|'instance_uuids'
...
op|':'
newline|'\n'
comment|'# NOTE(russellb) If the group does not already exist, we need to'
nl|'\n'
comment|'# automatically create it to be backwards compatible with old'
nl|'\n'
comment|"# handling of the 'group' scheduler hint.  The policy type will be"
nl|'\n'
comment|"# 'legacy', indicating that this group was created to emulate"
nl|'\n'
comment|'# legacy group behavior.'
nl|'\n'
indent|'            '
name|'ig'
op|'='
...
name|'staticmethod'
newline|'\n'
DECL|member|_update_instance_group
name|'def'
name|'_update_instance_group'
op|'('
name|'context'
op|','
name|'instances'
