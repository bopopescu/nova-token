...
newline|'\n'
nl|'\n'
comment|"# NOTE(sandy): For now we're just going to pass in the"
nl|'\n'
comment|'# instance_type record to the scheduler. In a later phase'
nl|'\n'
comment|"# we'll be ripping this whole for-loop out and deferring the"
nl|'\n'
comment|'# creation of the Instance record. At that point all this will'
nl|'\n'
comment|'# change.'
nl|'\n'
name|'filter_driver'
...
op|','
name|'should_defer_database_create'
op|'='
name|'API'
op|'.'
name|'scheduler_rules'
...
newline|'\n'
nl|'\n'
DECL|member|_set_admin_password
dedent|''
name|'def'
