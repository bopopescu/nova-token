...
name|'_'
op|'('
string|'"Instance %(instance_id)s is not in an \'active\' state. It "'
nl|'\n'
string|'"is currently %(vm_state)s. Shutdown aborted."'
op|')'
op|'%'
name|'locals'
op|'('
...
nl|'\n'
nl|'\n'
DECL|function|_is_delete_queued
dedent|''
name|'def'
name|'_is_delete_queued'
op|'('
name|'instance'
op|','
name|'instance_id'
...
name|'_'
op|'('
string|'"Instance %(instance_id)s is not in a \'deleted\' state. It "'
nl|'\n'
string|'"is currently %(vm_state)s. Action aborted."'
op|')'
op|'%'
name|'locals'
op|'('
...
newline|'\n'
nl|'\n'
comment|'# FIXME: How to handle no host?'
nl|'\n'
name|'host'
op|'='
name|'instance'
