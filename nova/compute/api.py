...
name|'BoolOpt'
op|'('
string|"'default_shutdown_on_delete'"
op|','
nl|'\n'
DECL|variable|default
name|'default'
...
name|'help'
op|'='
string|"'Control what happens to the Guest OS when an instance '"
nl|'\n'
string|"'is deleted. '"
nl|'\n'
string|"'If set to true instances will be given a chance to '"
nl|'\n'
string|"'shutdown before they are destroyed.'"
op|')'
op|','
nl|'\n'
op|']'
...
name|'CONF'
op|'.'
name|'default_shutdown_on_delete'
newline|'\n'
nl|'\n'
dedent|''
name|'self'
