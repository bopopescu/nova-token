...
nl|'\n'
comment|'#                instance id twice (one for ipv4 and ipv4)'
nl|'\n'
name|'ids'
op|'='
name|'set'
...
newline|'\n'
nl|'\n'
comment|'# NOTE(jkoelker) When this flips to using UUIDS the name'
nl|'\n'
comment|'#                needs to be updated accordingingly'
nl|'\n'
name|'ip_instances'
op|'='
op|'['
