...
newline|'\n'
nl|'\n'
comment|'# For backward compatible we need raise HTTPRequestEntityTooLarge'
nl|'\n'
comment|'# so we need to keep InvalidMetadataSize exception here'
nl|'\n'
dedent|''
name|'if'
name|'len'
...
op|':'
newline|'\n'
comment|'# If instance is in shelved_offloaded state or'
nl|'\n'
comment|'# instance.host is None, then delete instance'
nl|'\n'
comment|'# from db and clean bdms info and network info.'
nl|'\n'
indent|'                    '
name|'self'
op|'.'
...
op|':'
newline|'\n'
comment|'# Check if compute service is up.'
nl|'\n'
indent|'                    '
name|'service'
op|'='
