...
op|']'
newline|'\n'
comment|"# 'name' means Instance.display_name"
nl|'\n'
comment|"# 'instance_name' means Instance.name"
nl|'\n'
dedent|''
name|'if'
string|"'name'"
...
op|':'
newline|'\n'
comment|'# special cased for ec2.  we end up ignoring all other'
nl|'\n'
...
newline|'\n'
nl|'\n'
comment|'# Recurse zones.  Need admin context for this.  Send along'
nl|'\n'
comment|'# the un-modified search options we received..'
nl|'\n'
dedent|''
name|'admin_context'
op|'='
...
newline|'\n'
nl|'\n'
comment|'# fixed_ip searching should return a FixedIpNotFound exception'
nl|'\n'
comment|'# when an instance is not found...'
nl|'\n'
dedent|''
dedent|''
name|'fixed_ip'
