...
name|'DEFINE_boolean'
op|'('
string|"'api_check_vm_states'"
op|','
name|'True'
op|','
nl|'\n'
string|"'Filter calls by vm state'"
op|')'
newline|'\n'
nl|'\n'
nl|'\n'
...
name|'_'
op|'('
string|'"Instance %(instance_uuid)s is not in a \'soft delete\' "'
nl|'\n'
...
op|':'
newline|'\n'
DECL|function|_state_checker_wrap
indent|'        '
name|'def'
name|'_state_checker_wrap'
op|'('
name|'api'
op|','
name|'context'
...
nl|'\n'
comment|"# only going to create 1 instance and we're in a single"
nl|'\n'
comment|'# zone deployment.  This speeds up API responses for builds'
nl|'\n'
...
op|')'
newline|'\n'
comment|'#TODO (ameade): this check should be removed after everything'
nl|'\n'
comment|'#in compute manager expects uuids instead of ids'
nl|'\n'
name|'if'
name|'utils'
op|'.'
...
newline|'\n'
nl|'\n'
comment|'# hostignore and portignore are compatibility params for noVNC'
nl|'\n'
name|'return'
op|'{'
string|"'url'"
