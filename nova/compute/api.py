...
newline|'\n'
indent|'    '
string|'"""Decorator that makes sure that the host exists."""'
newline|'\n'
DECL|function|wrapped
name|'def'
name|'wrapped'
...
newline|'\n'
indent|'        '
string|'"""Returns a summary list of enabled hosts, optionally filtering\n        by zone and/or service type.\n        """'
newline|'\n'
name|'LOG'
op|'.'
name|'debug'
