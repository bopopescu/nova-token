...
op|')'
newline|'\n'
comment|'#Salvatore - No kernel and ramdisk for raw images'
nl|'\n'
dedent|''
name|'if'
op|'('
...
name|'debug'
op|'('
string|'"Creating a raw instance (no kernel and ramdisk) - Paravirtualization:%s"'
op|'%'
name|'str'
op|'('
name|'pv_kernel'
...
newline|'\n'
nl|'\n'
comment|'# Make sure we have access to kernel and ramdisk (as long as we want them)'
nl|'\n'
dedent|''
name|'if'
op|'('
...
op|']'
newline|'\n'
comment|'#Salvatore TODO: PV or HVM'
nl|'\n'
name|'base_options'
op|'='
op|'{'
