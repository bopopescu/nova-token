...
newline|'\n'
nl|'\n'
DECL|member|_check_injected_file_format
dedent|''
dedent|''
dedent|''
name|'def'
name|'_check_injected_file_format'
op|'('
name|'self'
op|','
name|'injected_files'
...
newline|'\n'
indent|'        '
string|'"""Ensure given injected files are in the correct format."""'
newline|'\n'
name|'for'
name|'_'
op|','
...
name|'_'
op|'('
string|'"File contents must be base64 encoded."'
op|')'
newline|'\n'
name|'raise'
name|'exception'
...
newline|'\n'
indent|'        '
string|'"""Create number of instances requested, given quotas.\n\n        Create the number of instances requested if quota and\n        other arguments check out ok.\n        """'
newline|'\n'
name|'if'
name|'not'
name|'instance_type'
...
newline|'\n'
indent|'        '
string|'"""Retrieves whether or not a finished migration exists for\n        an instance"""'
newline|'\n'
name|'try'
op|':'
newline|'\n'
