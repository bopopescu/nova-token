...
op|')'
newline|'\n'
comment|'# TODO(termie): this is ugly but required because the db layer returns'
nl|'\n'
comment|'#               models rather than dicts and the models support'
nl|'\n'
comment|"#               properties that are 'backreferences'"
nl|'\n'
name|'return'
name|'d'
newline|'\n'
