...
newline|'\n'
nl|'\n'
DECL|member|_get_all_by_reservation_id
dedent|''
name|'def'
...
newline|'\n'
nl|'\n'
DECL|member|_get_all_by_project_id
dedent|''
name|'def'
...
newline|'\n'
nl|'\n'
DECL|member|_get_all_by_fixed_ip
dedent|''
name|'def'
...
newline|'\n'
nl|'\n'
DECL|member|_get_all_by_name
dedent|''
name|'def'
name|'_get_all_by_name'
op|'('
name|'self'
op|','
name|'context'
...
newline|'\n'
nl|'\n'
DECL|member|_get_all_by_ip6
dedent|''
name|'def'
name|'_get_all_by_ip6'
op|'('
name|'self'
op|','
name|'context'
...
newline|'\n'
nl|'\n'
DECL|member|_get_all_by_column
dedent|''
name|'def'
...
newline|'\n'
nl|'\n'
comment|'# Columns we can do a generic search on'
nl|'\n'
name|'search_columns'
op|'='
op|'['
...
newline|'\n'
nl|'\n'
comment|'# Options that are mutually exclusive'
nl|'\n'
name|'exclusive_opts'
op|'='
op|'['
...
newline|'\n'
nl|'\n'
comment|'# See if a valid search option was passed in.'
nl|'\n'
comment|'# Ignore unknown search options for possible forward compatability.'
nl|'\n'
comment|'# Raise an exception if more than 1 search option is specified'
nl|'\n'
name|'found_opt'
op|'='
name|'None'
...
nl|'\n'
string|'"search option specified (%(found_opt)s and "'
nl|'\n'
string|'"%(opt)s were both specified"'
op|')'
op|'%'
name|'locals'
op|'('
