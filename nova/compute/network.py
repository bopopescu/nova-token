...
newline|'\n'
nl|'\n'
comment|'#    NOTE(todd): Unused?'
nl|'\n'
comment|'#    @classmethod'
nl|'\n'
comment|'#    def get_all_hosts(cls):'
nl|'\n'
comment|'#        for vlan in Vlan.all():'
nl|'\n'
comment|'#            network_str = vlan.subnet()'
nl|'\n'
comment|'#            for host in model.Host.associated_to("network", network_str):'
nl|'\n'
comment|'#                yield host'
nl|'\n'
nl|'\n'
...
nl|'\n'
comment|'# TODO(todd): probably make this a class method on Vlan'
nl|'\n'
