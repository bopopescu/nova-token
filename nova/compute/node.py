...
name|'warning'
op|'('
string|'"Error running template: %s"'
op|'%'
name|'e'
op|')'
newline|'\n'
...
newline|'\n'
nl|'\n'
comment|"# For now, we assume that if we're not using a kernel, we're using a partitioned disk image"
nl|'\n'
comment|'# where the target partition is the first partition'
nl|'\n'
...
name|'FLAGS'
op|'.'
name|'simple_network_dns_template'
op|')'
name|'as'
name|'f'
op|':'
