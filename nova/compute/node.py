...
op|':'
newline|'\n'
comment|'# TODO(termie): Termie has an idea for wrapping this connection failure'
nl|'\n'
comment|'#               pattern to be more elegant.  -todd'
nl|'\n'
indent|'        '
name|'try'
op|':'
...
op|':'
newline|'\n'
comment|'# FIXME(todd): this is just for debugging during testing'
nl|'\n'
indent|'            '
name|'print'
string|'"FUUUUUUUUUUUUUUUUUUUUUU: %s"'
op|'%'
name|'ex'
newline|'\n'
name|'logging'
