...
name|'_'
op|'('
string|'"Total %(type_)s: %(total)d %(unit)s, used: %(used)d %(unit)s"'
op|')'
newline|'\n'
name|'LOG'
op|'.'
...
name|'_'
op|'('
string|'"%(type_)s limit not specified, defaulting to "'
nl|'\n'
string|'"unlimited"'
op|')'
op|'%'
...
name|'_'
op|'('
string|'"%(type_)s limit: %(limit)d %(unit)s, free: %(free)d "'
nl|'\n'
string|'"%(unit)s"'
op|')'
op|'%'
...
name|'_'
op|'('
string|'"Unable to claim resources.  Free %(type_)s %(free)d "'
nl|'\n'
