...
newline|'\n'
nl|'\n'
comment|'# NOTE(jwcroppe): Convert all the `perc` values to their integer forms'
nl|'\n'
comment|'# since pre-conversion their values are within the range [0, 1] and the'
nl|'\n'
comment|'# objects.MonitorMetric.value field requires an integer.'
nl|'\n'
name|'perc'
op|'='
op|'('
