...
newline|'\n'
nl|'\n'
comment|'# Get a list of block devices for this instance.'
nl|'\n'
name|'disks'
op|'='
name|'get_disks'
...
newline|'\n'
nl|'\n'
comment|'# Get a list of all network interfaces for this instance.'
nl|'\n'
name|'interfaces'
op|'='
name|'get_interfaces'
...
name|'exception'
op|'('
string|"'unexpected libvirt error'"
op|')'
newline|'\n'
name|'time'
op|'.'
