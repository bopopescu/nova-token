...
string|"'rebooting'"
newline|'\n'
DECL|variable|REBOOT_PENDING
name|'REBOOT_PENDING'
op|'='
string|"'reboot_pending'"
newline|'\n'
DECL|variable|REBOOT_STARTED
name|'REBOOT_STARTED'
op|'='
string|"'reboot_started'"
newline|'\n'
...
newline|'\n'
DECL|variable|REBOOT_PENDING_HARD
name|'REBOOT_PENDING_HARD'
op|'='
string|"'reboot_pending_hard'"
newline|'\n'
DECL|variable|REBOOT_STARTED_HARD
name|'REBOOT_STARTED_HARD'
op|'='
string|"'reboot_started_hard'"
newline|'\n'
nl|'\n'
