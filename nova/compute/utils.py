...
nl|'\n'
nl|'\n'
DECL|function|periodic_task_spacing_warn
dedent|''
dedent|''
name|'def'
...
name|'_LW'
op|'('
string|'"Value of 0 or None specified for %s."'
nl|'\n'
string|'" This behaviour will change in meaning in the K release, to"'
nl|'\n'
string|'" mean \'call at the default rate\' rather than \'do not call\'."'
nl|'\n'
string|'" To keep the \'do not call\' behaviour, use a negative value."'
op|')'
op|','
nl|'\n'
name|'config_option_name'
