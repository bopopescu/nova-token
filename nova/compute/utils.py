...
op|':'
newline|'\n'
comment|'# NOTE(vish): this will generate a unique device name that is not'
nl|'\n'
comment|'#             in use already. It is a reasonable guess at where'
nl|'\n'
comment|'#             it will show up in a linux guest, but it may not'
nl|'\n'
comment|'#             always be correct'
nl|'\n'
indent|'    '
name|'req_prefix'
op|'='
...
name|'match'
op|'('
string|'"(^/dev/x{0,1}[a-z]d)[a-z]+[0-9]*$"'
op|','
name|'mappings'
op|'['
string|"'root'"
