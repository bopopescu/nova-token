...
op|')'
newline|'\n'
name|'libvirt_default_ephemerals'
op|'='
op|'['
op|']'
newline|'\n'
nl|'\n'
name|'bdm_named_lists'
op|'='
name|'zip'
op|'('
op|'('
...
op|':'
newline|'\n'
comment|'# Libvirt will create a default ephemeral if instance allows'
nl|'\n'
comment|'# and was not overridden.'
nl|'\n'
indent|'        '
name|'if'
op|'('
...
newline|'\n'
nl|'\n'
comment|"# Libvirt will create a default swap if it's in instance type"
nl|'\n'
comment|'# and it was not supplied or overridden'
nl|'\n'
dedent|''
dedent|''
name|'if'
...
newline|'\n'
nl|'\n'
comment|'# NOTE(xqueralt): This can be removed when we have libvirt'
nl|'\n'
comment|"# defaulting it's own device names."
nl|'\n'
dedent|''
name|'if'
name|'driver'
