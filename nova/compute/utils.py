...
nl|'\n'
nl|'\n'
DECL|function|parse_decimal_id
dedent|''
name|'def'
...
newline|'\n'
nl|'\n'
comment|'# split template to get prefix and suffix'
nl|'\n'
name|'tokens'
op|'='
name|'template'
...
op|':'
newline|'\n'
comment|'# template prefix not match'
nl|'\n'
indent|'            '
name|'return'
op|'-'
...
op|':'
newline|'\n'
comment|'# template suffix not match'
nl|'\n'
indent|'            '
name|'return'
op|'-'
...
newline|'\n'
nl|'\n'
comment|'# validate that instance_id length matches'
nl|'\n'
dedent|''
...
newline|'\n'
nl|'\n'
comment|'# if expected length is empty it means instance_id can be of any length'
nl|'\n'
name|'if'
name|'expected_length'
op|':'
...
number|'1'
newline|'\n'
comment|'# if instance_id has preciding zeroes it must be of expected length'
nl|'\n'
dedent|''
name|'if'
op|'('
...
newline|'\n'
nl|'\n'
comment|'# if the minimal expected length empty, there should be no preceding zeros'
nl|'\n'
dedent|''
dedent|''
name|'elif'
...
newline|'\n'
nl|'\n'
comment|'# finding base of the template to convert to decimal'
nl|'\n'
dedent|''
name|'base_fmt'
op|'='
