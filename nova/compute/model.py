begin_unit
comment|'# vim: tabstop=4 shiftwidth=4 softtabstop=4 expandtab'
nl|'\n'
...
newline|'\n'
nl|'\n'
comment|'# class Reservation(object):'
nl|'\n'
comment|'#     """ ORM wrapper for a batch of launched instances """'
nl|'\n'
...
comment|'#'
nl|'\n'
comment|'# class NodeDirectory(object):'
nl|'\n'
comment|'#     def __init__(self):'
nl|'\n'
comment|'#         pass'
