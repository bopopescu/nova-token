...
name|'DEFINE_integer'
op|'('
string|"'total_memory_mb'"
op|','
number|'1000'
op|','
nl|'\n'
string|"'amount of memory a node has for VMs in MB'"
op|')'
newline|'\n'
name|'flags'
op|'.'
name|'DEFINE_integer'
op|'('
string|"'total_disk_gb'"
op|','
number|'1000'
op|','
nl|'\n'
string|"'amount of disk space a node has for VMs in GB'"
op|')'
newline|'\n'
nl|'\n'
...
newline|'\n'
comment|'# NOTE(vish): The ip association should be just a single value, but'
nl|'\n'
comment|'#             to maintain consistency it is using the standard'
nl|'\n'
comment|'#             association and the ugly method for retrieving'
nl|'\n'
comment|'#             the first item in the set below.'
nl|'\n'
name|'result'
op|'='
name|'datastore'
...
newline|'\n'
indent|'        '
string|'"""number of seconds remaining before expiration"""'
newline|'\n'
name|'now'
op|'='
name|'datetime'
