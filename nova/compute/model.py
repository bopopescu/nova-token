...
op|'('
nl|'\n'
string|'"no model class for %s when building association from %s"'
op|'%'
nl|'\n'
op|'('
name|'klsname'
...
newline|'\n'
comment|"# XXX: doesn't track migration between projects, just adds the first one"
nl|'\n'
...
string|'""" Call into superclass to save object, then save associations """'
newline|'\n'
comment|"# XXX: doesn't clear out from host list after crash, termination, etc"
nl|'\n'
name|'success'
op|'='
name|'super'
