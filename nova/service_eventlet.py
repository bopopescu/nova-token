...
nl|'\n'
comment|'#if FLAGS.nodaemon and not FLAGS.logfile:'
nl|'\n'
comment|'#    FLAGS.logfile = "-"'
nl|'\n'
comment|'#if not FLAGS.logfile:'
nl|'\n'
comment|"#    FLAGS.logfile = '%s.log' % name"
nl|'\n'
comment|'#if not FLAGS.prefix:'
nl|'\n'
...
newline|'\n'
nl|'\n'
comment|'#formatter = logging.Formatter('
nl|'\n'
comment|"#    '(%(name)s): %(levelname)s %(message)s')"
nl|'\n'
comment|'#handler = logging.StreamHandler()'
nl|'\n'
comment|'#handler.setFormatter(formatter)'
nl|'\n'
comment|'#logging.getLogger().addHandler(handler)'
nl|'\n'
nl|'\n'
dedent|''
name|'if'
