...
newline|'\n'
nl|'\n'
comment|'# NOTE(russellb): This method is now deprecated and can be removed in'
nl|'\n'
comment|'# version 2.0 of the RPC API'
nl|'\n'
dedent|''
op|'@'
name|'messaging'
...
newline|'\n'
nl|'\n'
comment|'# NOTE(danms): This method is now deprecated and can be removed in'
nl|'\n'
comment|'# version 2.0 of the RPC API'
nl|'\n'
...
newline|'\n'
nl|'\n'
comment|'# NOTE(danms): This method can be removed in version 2.0 of this API.'
nl|'\n'
...
newline|'\n'
nl|'\n'
comment|'# NOTE(hanlind): This method is now deprecated and can be removed in'
nl|'\n'
comment|'# version v2.0 of the RPC API.'
nl|'\n'
...
op|':'
newline|'\n'
comment|'# NOTE(belliott) prune_stats is no longer relevant and will be'
nl|'\n'
comment|'# ignored'
nl|'\n'
indent|'        '
...
op|':'
newline|'\n'
comment|"# NOTE(danms): In Icehouse, the 'stats' was changed from a dict"
nl|'\n'
comment|'# to a JSON string. If we get a dict-based value, convert it to'
nl|'\n'
comment|'# JSON, which the lower layers now expect. This can be removed'
nl|'\n'
comment|'# in version 2.0 of the RPC API'
nl|'\n'
indent|'            '
name|'values'
op|'['
...
newline|'\n'
nl|'\n'
comment|'# TODO(timello): originally, instance_type in request_spec'
nl|'\n'
comment|"# on compute.api.resize does not have 'extra_specs', so we"
nl|'\n'
comment|'# remove it for now to keep tests backward compatibility.'
nl|'\n'
name|'request_spec'
op|'['
...
nl|'\n'
nl|'\n'
DECL|class|_ConductorManagerV2Proxy
dedent|''
dedent|''
name|'class'
name|'_ConductorManagerV2Proxy'
...
newline|'\n'
nl|'\n'
comment|'# TODO(danms): This can be removed in v3.0 of the RPC API'
nl|'\n'
DECL|member|aggregate_host_add
dedent|''
name|'def'
...
newline|'\n'
nl|'\n'
comment|'# TODO(comstud): This can be removed in version 3.0 of RPCAPI'
nl|'\n'
DECL|member|quota_commit
dedent|''
name|'def'
