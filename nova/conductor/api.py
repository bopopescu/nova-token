...
op|':'
newline|'\n'
comment|'# FIXME(comstud): bug 1153795: Conductor manager should accept'
nl|'\n'
comment|'# a project_id kwarg to be able to pass to the quota commit call.'
nl|'\n'
indent|'        '
name|'if'
name|'project_id'
...
comment|'# FIXME(comstud): bug 1153795: Conductor manager should accept'
nl|'\n'
comment|'# a project_id kwarg to be able to pass to the quota rollback call.'
nl|'\n'
indent|'        '
name|'if'
name|'project_id'
