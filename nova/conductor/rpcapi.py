...
newline|'\n'
nl|'\n'
comment|'# TODO(hanlind): This method can be removed once oslo.versionedobjects'
nl|'\n'
comment|'# has been converted to use version_manifests in remotable_classmethod'
nl|'\n'
comment|'# operations, which will use the new class action handler.'
nl|'\n'
...
op|':'
newline|'\n'
comment|"# NOTE(danms): If we're new enough, collect the object"
nl|'\n'
comment|'# version manifest and redirect the call to the newer'
nl|'\n'
comment|'# class action handler'
nl|'\n'
indent|'            '
name|'versions'
op|'='
