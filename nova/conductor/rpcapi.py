...
op|':'
newline|'\n'
comment|'# If the remote side is >= 1.51, it defaults to legacy=True.'
nl|'\n'
comment|"# If it's older, it only understands the legacy format."
nl|'\n'
indent|'            '
name|'version'
op|'='
...
op|':'
newline|'\n'
comment|"# If we require new style data, but can't ask for it, then we must"
nl|'\n'
comment|'# fail here.'
nl|'\n'
indent|'            '
