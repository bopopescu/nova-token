...
newline|'\n'
indent|'        '
string|'"""Initialize, but do not start, an API service."""'
newline|'\n'
name|'self'
op|'.'
name|'name'
...
newline|'\n'
indent|'        '
string|'"""Attempt to find \'paste\' configuration file."""'
newline|'\n'
name|'location'
op|'='
name|'wsgi'
...
name|'_'
op|'('
string|'"Using paste.deploy config: %s"'
op|')'
op|','
name|'location'
op|')'
...
newline|'\n'
indent|'        '
string|'"""Read and return the \'paste\' configuration file."""'
newline|'\n'
name|'return'
name|'wsgi'
op|'.'
...
newline|'\n'
indent|'        '
string|'"""Using the loaded configuration, return the WSGI application."""'
newline|'\n'
name|'return'
name|'wsgi'
op|'.'
...
newline|'\n'
indent|'        '
string|'"""Start serving this API using loaded configuration."""'
newline|'\n'
name|'self'
op|'.'
name|'server'
