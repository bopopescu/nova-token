...
op|')'
newline|'\n'
comment|'# NOTE(jk0): Raise a ^C which is caught by the caller and cleanly'
nl|'\n'
comment|'# shuts down the service. This does not yet handle eventlet'
nl|'\n'
comment|'# threads.'
nl|'\n'
name|'raise'
