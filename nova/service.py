...
newline|'\n'
indent|'        '
string|'"""Logic to ensure logging is going to work correctly for services.\n\n        :returns: None\n\n        """'
newline|'\n'
name|'logging'
op|'.'
name|'setup'
...
name|'_'
op|'('
string|'"Nova Version (%(_version)s)"'
op|')'
op|'%'
name|'self'
op|'.'
...
newline|'\n'
indent|'        '
string|'"""Logic to ensure flags/configuration are correctly set.\n\n        :returns: None\n\n        """'
newline|'\n'
name|'utils'
op|'.'
