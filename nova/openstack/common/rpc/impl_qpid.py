...
op|','
nl|'\n'
comment|'# NOTE(russellb) If any additional versions are added (beyond 1 and 2),'
nl|'\n'
comment|'# this file could probably use some additional refactoring so that the'
nl|'\n'
comment|'# differences between each version are split into different classes.'
nl|'\n'
name|'cfg'
op|'.'
name|'IntOpt'
op|'('
string|"'qpid_topology_version'"
op|','
nl|'\n'
DECL|variable|default
name|'default'
...
name|'help'
op|'='
string|'"The qpid topology version to use.  Version 1 is what "'
nl|'\n'
string|'"was originally used by impl_qpid.  Version 2 includes "'
nl|'\n'
string|'"some backwards-incompatible changes that allow broker "'
nl|'\n'
string|'"federation to work.  Users should update to version 2 "'
nl|'\n'
string|'"when they are able to take everything down, as it "'
nl|'\n'
string|'"requires a clean break."'
op|')'
op|','
nl|'\n'
op|']'
...
nl|'\n'
nl|'\n'
DECL|function|raise_invalid_topology_version
name|'def'
name|'raise_invalid_topology_version'
op|'('
name|'conf'
op|')'
op|':'
...
name|'_'
op|'('
string|'"Invalid value for qpid_topology_version: %d"'
op|')'
op|'%'
nl|'\n'
name|'conf'
...
newline|'\n'
indent|'        '
string|'"""Declare the reciever on connect."""'
newline|'\n'
name|'self'
op|'.'
name|'_declare_receiver'
op|'('
name|'session'
op|')'
newline|'\n'
...
op|':'
newline|'\n'
comment|'# TODO(sandy): Need support for optional ack_on_error.'
nl|'\n'
indent|'            '
name|'self'
op|'.'
