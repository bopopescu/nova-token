...
nl|'\n'
string|"'valid values are TLSv1, SSLv23 and SSLv3. SSLv2 may '"
nl|'\n'
string|"'be available on some distributions'"
nl|'\n'
op|')'
op|','
nl|'\n'
...
newline|'\n'
nl|'\n'
comment|'# Return the extended behavior or just have the default behavior'
nl|'\n'
dedent|''
name|'return'
name|'ssl_params'
