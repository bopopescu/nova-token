...
newline|'\n'
indent|'    '
string|'"""Deserialization wrapper."""'
newline|'\n'
name|'LOG'
op|'.'
name|'debug'
...
newline|'\n'
indent|'    '
string|'"""A tiny wrapper around ZeroMQ.\n\n    Simplifies the send/recv protocol and connection management.\n    Can be used as a Context (supports the \'with\' statement).\n    """'
newline|'\n'
nl|'\n'
...
newline|'\n'
indent|'    '
string|'"""A consumer class implementing a centralized casting broker (PULL-PUSH).\n\n    Used for RoundRobin requests.\n    """'
newline|'\n'
nl|'\n'
DECL|member|__init__
name|'def'
...
newline|'\n'
indent|'    '
string|'"""A consumer class implementing a topic-based proxy.\n\n    Forwards to IPC sockets.\n    """'
newline|'\n'
nl|'\n'
DECL|member|__init__
name|'def'
...
name|'_'
op|'('
string|'"Required IPC directory does not exist at"'
nl|'\n'
string|'" %s"'
op|')'
op|'%'
...
name|'_'
op|'('
string|'"Permission denied to IPC directory at"'
nl|'\n'
string|'" %s"'
op|')'
op|'%'
...
newline|'\n'
indent|'    '
string|'"""A consumer class implementing a consumer for messages.\n\n    Can also be used as a 1:1 proxy\n    """'
newline|'\n'
nl|'\n'
DECL|member|__init__
name|'def'
...
newline|'\n'
indent|'    '
string|'"""Wraps the sending of messages.\n\n    Dispatches to the matchmaker and sends message to all relevant hosts.\n    """'
newline|'\n'
name|'conf'
op|'='
name|'CONF'
...
name|'endswith'
op|'('
string|"'matchmaker.MatchMakerRing'"
op|')'
op|':'
newline|'\n'
indent|'            '
...
name|'_'
op|'('
string|"'rpc_zmq_matchmaker = %(orig)s is deprecated; use'"
nl|'\n'
string|"' %(new)s instead'"
op|')'
op|'%'
name|'dict'
op|'('
