...
newline|'\n'
nl|'\n'
comment|'# TODO(pekowsk): Remove import cfg and below comment in Havana.'
nl|'\n'
comment|'# This import should no longer be needed when the amqp_rpc_single_reply_queue'
nl|'\n'
comment|'# option is removed.'
nl|'\n'
name|'from'
name|'oslo'
op|'.'
...
newline|'\n'
nl|'\n'
comment|'# TODO(pekowski): Remove this option in Havana.'
nl|'\n'
...
name|'BoolOpt'
op|'('
string|"'amqp_rpc_single_reply_queue'"
op|','
nl|'\n'
...
name|'help'
op|'='
string|"'Enable a fast single reply queue if using AMQP based '"
nl|'\n'
string|"'RPC like RabbitMQ or Qpid.'"
op|')'
op|','
nl|'\n'
op|']'
...
nl|'\n'
comment|'# pool. The unit tests get here via the teatDown() method. In the run'
nl|'\n'
...
name|'_'
op|'('
string|"'no calling threads waiting for msg_id : %s'"
nl|'\n'
string|"', message : %s'"
op|')'
op|'%'
...
newline|'\n'
indent|'    '
string|'"""Base class for a delayed invocation manager used by\n    the Connection class to start up green threads\n    to handle incoming messages.\n    """'
newline|'\n'
nl|'\n'
DECL|member|__init__
name|'def'
...
newline|'\n'
indent|'    '
string|'"""Wraps a straight callback to allow it to be invoked in a green\n    thread.\n    """'
newline|'\n'
nl|'\n'
DECL|member|__init__
name|'def'
...
name|'_'
op|'('
string|"'Timed out waiting for RPC response.'"
op|')'
op|')'
newline|'\n'
name|'self'
...
nl|'\n'
nl|'\n'
comment|'#TODO(pekowski): Remove MulticallWaiter() in Havana.'
nl|'\n'
...
newline|'\n'
comment|'# TODO(pekowski): Remove all these comments in Havana.'
nl|'\n'
comment|'# For amqp_rpc_single_reply_queue = False,'
nl|'\n'
...
comment|'# the pool'
nl|'\n'
comment|'# For amqp_rpc_single_reply_queue = True,'
nl|'\n'
comment|"# The 'with' statement is mandatory for closing the connection"
nl|'\n'
name|'LOG'
op|'.'
name|'debug'
...
newline|'\n'
nl|'\n'
comment|'# TODO(pekowski): Remove this flag and the code under the if clause'
nl|'\n'
comment|'#                 in Havana.'
nl|'\n'
name|'if'
