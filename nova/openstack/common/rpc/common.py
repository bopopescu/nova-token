...
nl|'\n'
nl|'\n'
comment|'# TODO(russellb) Turn this on after Grizzly.'
nl|'\n'
DECL|variable|_SEND_RPC_ENVELOPE
...
name|'_'
op|'('
string|"'Failed to sanitize %(item)s. Key error %(err)s'"
op|')'
op|','
nl|'\n'
op|'{'
...
newline|'\n'
indent|'    '
string|'"""This encapsulates some actual exception that is expected to be\n    hit by an RPC proxy object. Merely instantiating it records the\n    current exception information, which will be passed back to the\n    RPC client without exceptional logging."""'
newline|'\n'
DECL|member|__init__
name|'def'
name|'__init__'
