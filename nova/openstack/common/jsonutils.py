...
name|'json'
newline|'\n'
comment|'# NOTE(mriedem): Make sure we have a new enough version of simplejson'
nl|'\n'
comment|'# to support the namedobject_as_tuple argument. This can be removed'
nl|'\n'
comment|'# in the Kilo release when python 2.6 support is dropped.'
nl|'\n'
name|'if'
string|"'namedtuple_as_object'"
name|'in'
name|'inspect'
op|'.'
name|'getargspec'
