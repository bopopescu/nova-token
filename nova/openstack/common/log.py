...
name|'default'
op|'='
string|"'%(asctime)s.%(msecs)d %(levelname)s %(name)s '"
nl|'\n'
string|"'[%(request_id)s %(user)s %(tenant)s] %(instance)s'"
nl|'\n'
string|"'%(message)s'"
op|','
nl|'\n'
...
name|'default'
op|'='
string|"'%(asctime)s.%(msecs)d %(process)d %(levelname)s '"
nl|'\n'
...
name|'default'
op|'='
string|"'%(asctime)s.%(msecs)d %(process)d TRACE %(name)s '"
nl|'\n'
string|"'%(instance)s'"
op|','
nl|'\n'
