...
op|':'
newline|'\n'
comment|'# NOTE(mrodden): catch any Message/other object and'
nl|'\n'
comment|'#                coerce to unicode before they can get'
nl|'\n'
comment|'#                to the python logging and possibly'
nl|'\n'
comment|'#                cause string encoding trouble'
nl|'\n'
indent|'        '
name|'if'
name|'not'
