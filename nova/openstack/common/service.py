...
op|':'
newline|'\n'
DECL|variable|_signal_handlers_set
indent|'    '
name|'_signal_handlers_set'
op|'='
name|'set'
op|'('
op|')'
...
name|'classmethod'
newline|'\n'
DECL|member|_handle_class_signals
name|'def'
name|'_handle_class_signals'
op|'('
name|'cls'
op|','
op|'*'
...
newline|'\n'
nl|'\n'
comment|'# Parent signals with SIGTERM when it wants us to go away.'
nl|'\n'
dedent|''
name|'signal'
op|'.'
