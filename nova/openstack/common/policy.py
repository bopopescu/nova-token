...
name|'debug'
op|'('
string|'"Rules successfully reloaded"'
op|')'
newline|'\n'
nl|'\n'
...
newline|'\n'
indent|'        '
string|'"""Locate the policy json data file.\n\n        :param policy_file: Custom policy file to locate.\n\n        :returns: The policy path\n\n        :raises: ConfigFilesNotFoundError if the file couldn\'t\n                 be located.\n        """'
newline|'\n'
name|'policy_file'
op|'='
name|'CONF'
...
newline|'\n'
nl|'\n'
comment|'# NOTE(flaper87): Not logging target or creds to avoid'
nl|'\n'
comment|'# potential security issues.'
nl|'\n'
name|'LOG'
op|'.'
name|'debug'
op|'('
string|'"Rule %s will be now enforced"'
op|'%'
name|'rule'
op|')'
newline|'\n'
...
name|'_LE'
op|'('
string|'"Failed to understand rule %r"'
op|')'
op|'%'
name|'rule'
op|')'
