...
newline|'\n'
nl|'\n'
DECL|member|_force_use_list_notifier
dedent|''
name|'def'
name|'_force_use_list_notifier'
op|'('
name|'self'
op|')'
op|':'
...
op|'!='
nl|'\n'
string|"'nova.openstack.common.notifier.list_notifier'"
op|')'
op|':'
newline|'\n'
indent|'            '
...
newline|'\n'
nl|'\n'
comment|'# See if we need to turn on the list notifier'
nl|'\n'
dedent|''
dedent|''
name|'for'
