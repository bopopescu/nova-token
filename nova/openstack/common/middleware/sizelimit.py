...
nl|'\n'
DECL|variable|max_req_body_size
...
name|'help'
op|'='
string|"'The maximum body size for each '"
nl|'\n'
string|"' request, in bytes.'"
op|')'
newline|'\n'
nl|'\n'
DECL|variable|CONF
...
newline|'\n'
indent|'        '
string|'"""Initiates LimitingReader object.\n\n        :param data: Underlying data object\n        :param limit: maximum number of bytes the reader should allow\n        """'
newline|'\n'
name|'self'
op|'.'
name|'data'
...
name|'in_favor_of'
op|'='
string|"'oslo.middleware.RequestBodySizeLimiter'"
op|')'
newline|'\n'
