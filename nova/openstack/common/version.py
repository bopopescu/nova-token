...
newline|'\n'
indent|'        '
string|'"""Make the VersionInfo object behave like a string."""'
newline|'\n'
name|'return'
name|'self'
op|'.'
...
newline|'\n'
indent|'        '
string|'"""Include the name."""'
newline|'\n'
name|'return'
string|'"VersionInfo(%s:%s)"'
op|'%'
op|'('
name|'self'
op|'.'
...
op|':'
newline|'\n'
comment|'# The most likely cause for this is running tests in a tree'
nl|'\n'
comment|'# produced from a tarball where the package itself has not been'
nl|'\n'
comment|'# installed into anything. Revert to setup-time logic.'
nl|'\n'
indent|'            '
name|'from'
name|'nova'
