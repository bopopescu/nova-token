...
op|','
op|'('
string|"'_wrap_db_error() can only be applied to methods of '"
nl|'\n'
string|"'subclasses of sqlalchemy.orm.session.Session.'"
op|')'
newline|'\n'
nl|'\n'
name|'return'
...
newline|'\n'
indent|'    '
string|'"""Ensures that MySQL, PostgreSQL or DB2 connections are alive.\n\n    Borrowed from:\n    http://groups.google.com/group/sqlalchemy/msg/a4ce563d802c929f\n    """'
newline|'\n'
name|'cursor'
op|'='
name|'dbapi_conn'
...
newline|'\n'
nl|'\n'
comment|'# if the database server has gone away, all connections in the pool'
nl|'\n'
comment|'# have become invalid and we can safely close all of them here,'
nl|'\n'
comment|'# rather than waste time on checking of every single connection'
nl|'\n'
name|'engine'
op|'.'
name|'dispose'
...
newline|'\n'
nl|'\n'
comment|'# this will be handled by SQLAlchemy and will force it to create'
nl|'\n'
comment|'# a new connection and retry the original action'
nl|'\n'
name|'raise'
name|'sqla_exc'
op|'.'
...
nl|'\n'
nl|'\n'
DECL|function|_mysql_get_effective_sql_mode
dedent|''
name|'def'
name|'_mysql_get_effective_sql_mode'
op|'('
name|'engine'
op|')'
op|':'
newline|'\n'
indent|'    '
string|'"""Returns the effective SQL mode for connections from the engine pool.\n\n    Returns ``None`` if the mode isn\'t available, otherwise returns the mode.\n\n    """'
newline|'\n'
comment|'# Get the real effective SQL mode. Even when unset by'
nl|'\n'
...
nl|'\n'
comment|'# Also note that the checkout listener will be called on execute to'
nl|'\n'
comment|"# set the mode if it's registered."
nl|'\n'
name|'row'
op|'='
name|'engine'
...
nl|'\n'
nl|'\n'
DECL|function|_mysql_check_effective_sql_mode
dedent|''
name|'def'
name|'_mysql_check_effective_sql_mode'
op|'('
name|'engine'
op|')'
op|':'
newline|'\n'
indent|'    '
string|'"""Logs a message based on the effective SQL mode for MySQL connections."""'
newline|'\n'
name|'realmode'
op|'='
name|'_mysql_get_effective_sql_mode'
...
nl|'\n'
nl|'\n'
DECL|function|_mysql_set_mode_callback
dedent|''
dedent|''
name|'def'
name|'_mysql_set_mode_callback'
op|'('
name|'engine'
op|','
name|'sql_mode'
...
newline|'\n'
indent|'        '
string|'"""Initialize EngineFacade using oslo.config config instance options.\n\n        :param connection_string: SQLAlchemy connection string\n        :type connection_string: string\n\n        :param conf: oslo.config config instance\n        :type conf: oslo.config.cfg.ConfigOpts\n\n        :param sqlite_fk: enable foreign keys in SQLite\n        :type sqlite_fk: bool\n\n        :param autocommit: use autocommit mode for created Session instances\n        :type autocommit: bool\n\n        :param expire_on_commit: expire session objects on commit\n        :type expire_on_commit: bool\n\n        """'
newline|'\n'
nl|'\n'
name|'return'
name|'cls'
