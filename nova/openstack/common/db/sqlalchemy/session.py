...
name|'execute'
op|'('
string|'"SET SESSION sql_mode = TRADITIONAL;"'
op|')'
newline|'\n'
nl|'\n'
nl|'\n'
...
name|'_'
op|'('
string|'"This application has not enabled MySQL "'
nl|'\n'
string|'"traditional mode, which means silent "'
nl|'\n'
string|'"data corruption may occur. "'
nl|'\n'
string|'"Please encourage the application "'
nl|'\n'
string|'"developers to enable this mode."'
op|')'
op|')'
newline|'\n'
dedent|''
