...
name|'msg'
op|'='
string|'"Unknown scheme \'%s\' found in URI"'
newline|'\n'
nl|'\n'
DECL|member|__init__
name|'def'
...
name|'msg'
op|'='
string|'"The Store URI %s was malformed. Reason: %s"'
newline|'\n'
nl|'\n'
DECL|member|__init__
name|'def'
...
newline|'\n'
indent|'    '
string|'"""Error resulting from a client sending bad input to a server"""'
newline|'\n'
name|'pass'
newline|'\n'
nl|'\n'
nl|'\n'
DECL|class|MissingArgumentError
dedent|''
name|'class'
...
nl|'\n'
nl|'\n'
DECL|class|ClientConnectionError
dedent|''
name|'class'
...
newline|'\n'
indent|'    '
string|'"""Error resulting from a client connecting to a server"""'
newline|'\n'
name|'pass'
newline|'\n'
nl|'\n'
