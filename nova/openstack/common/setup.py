...
name|'_run_shell_command'
op|'('
string|'"git rev-list --abbrev-commit HEAD"'
op|')'
newline|'\n'
name|'return'
name|'len'
...
nl|'\n'
nl|'\n'
DECL|function|get_version_from_git
dedent|''
name|'def'
name|'get_version_from_git'
op|'('
name|'pre_version'
op|')'
op|':'
...
op|'('
nl|'\n'
string|'"git describe --exact-match"'
op|','
nl|'\n'
name|'throw_on_error'
op|'='
...
name|'_run_shell_command'
op|'('
string|'"git log -n1 --pretty=format:%h"'
op|')'
newline|'\n'
name|'return'
string|'"%s.a%s.g%s"'
...
nl|'\n'
nl|'\n'
DECL|function|get_version_from_pkg_info
dedent|''
name|'def'
