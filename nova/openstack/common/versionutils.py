...
nl|'\n'
comment|'# and added to the oslo-incubator requrements'
nl|'\n'
op|'@'
name|'functools'
op|'.'
...
nl|'\n'
nl|'\n'
comment|'# Track the messages we have sent already. See'
nl|'\n'
comment|'# report_deprecated_feature().'
nl|'\n'
DECL|variable|_deprecated_messages_sent
dedent|''
...
nl|'\n'
nl|'\n'
DECL|function|report_deprecated_feature
name|'def'
name|'report_deprecated_feature'
op|'('
name|'logger'
...
newline|'\n'
indent|'    '
string|'"""Call this function when a deprecated feature is used.\n\n    If the system is configured for fatal deprecations then the message\n    is logged at the \'critical\' level and :class:`DeprecatedConfig` will\n    be raised.\n\n    Otherwise, the message will be logged (once) at the \'warn\' level.\n\n    :raises: :class:`DeprecatedConfig` if the system is configured for\n             fatal deprecations.\n    """'
newline|'\n'
name|'stdmsg'
op|'='
name|'_'
