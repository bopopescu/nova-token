...
newline|'\n'
indent|'        '
string|'"""Retrieve the opt value as an integer from ConfigParser."""'
newline|'\n'
name|'return'
op|'['
name|'int'
...
newline|'\n'
nl|'\n'
DECL|function|_list_config_dir
name|'def'
name|'_list_config_dir'
op|'('
op|')'
op|':'
newline|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|_do_check_required_opts
dedent|''
dedent|''
name|'def'
name|'_do_check_required_opts'
op|'('
name|'self'
op|','
name|'opts'
