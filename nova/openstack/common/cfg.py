...
newline|'\n'
indent|'    '
string|'"""Apply tilde expansion and absolutization to a path."""'
newline|'\n'
name|'return'
name|'os'
op|'.'
...
newline|'\n'
nl|'\n'
DECL|member|_get_argparse_container
dedent|''
dedent|''
name|'def'
name|'_get_argparse_container'
...
newline|'\n'
nl|'\n'
DECL|member|_get_argparse_kwargs
dedent|''
dedent|''
name|'def'
name|'_get_argparse_kwargs'
...
newline|'\n'
indent|'        '
string|'"""Build a dict of keyword arguments for argparse\'s add_argument().\n\n        Most opt types extend this method to customize the behaviour of the\n        options added to argparse.\n\n        :param group: an optional group\n        :param kwargs: optional keyword arguments to add to\n        :returns: a dict of keyword arguments\n        """'
newline|'\n'
name|'if'
name|'not'
name|'self'
...
newline|'\n'
nl|'\n'
DECL|member|_get_argparse_prefix
dedent|''
name|'def'
name|'_get_argparse_prefix'
op|'('
...
name|'ValueError'
op|'('
string|"'positional boolean args not supported'"
op|')'
newline|'\n'
dedent|''
name|'super'
...
newline|'\n'
nl|'\n'
DECL|member|_add_inverse_to_argparse
dedent|''
name|'def'
name|'_add_inverse_to_argparse'
op|'('
...
newline|'\n'
indent|'        '
string|'"""Extends the base argparse keyword dict for boolean options."""'
newline|'\n'
nl|'\n'
name|'kwargs'
op|'='
...
newline|'\n'
nl|'\n'
comment|'# metavar has no effect for BoolOpt'
nl|'\n'
name|'if'
string|"'metavar'"
name|'in'
...
newline|'\n'
indent|'        '
string|'"""Extends the base argparse keyword dict for integer options."""'
newline|'\n'
name|'return'
name|'super'
op|'('
...
newline|'\n'
indent|'        '
string|'"""Extends the base argparse keyword dict for float options."""'
newline|'\n'
name|'return'
name|'super'
op|'('
...
newline|'\n'
nl|'\n'
DECL|class|_StoreListAction
name|'class'
name|'_StoreListAction'
op|'('
name|'argparse'
op|'.'
name|'Action'
...
newline|'\n'
indent|'        '
string|'"""Extends the base argparse keyword dict for list options."""'
newline|'\n'
name|'return'
name|'Opt'
op|'.'
...
newline|'\n'
indent|'        '
string|'"""Extends the base argparse keyword dict for multi str options."""'
newline|'\n'
name|'kwargs'
op|'='
name|'super'
...
newline|'\n'
indent|'        '
string|'"""Add argparse sub-parsers and invoke the handler method."""'
newline|'\n'
name|'dest'
op|'='
name|'self'
...
newline|'\n'
nl|'\n'
DECL|member|_get_argparse_group
dedent|''
dedent|''
name|'def'
name|'_get_argparse_group'
...
newline|'\n'
indent|'            '
string|'"""Build an argparse._ArgumentGroup for this group."""'
newline|'\n'
name|'self'
op|'.'
name|'_argparse_group'
...
newline|'\n'
indent|'        '
string|'"""Initialize a ConfigCliParser object for option parsing."""'
newline|'\n'
nl|'\n'
name|'if'
name|'prog'
...
newline|'\n'
indent|'        '
string|'"""A generator function for iterating CLI opts."""'
newline|'\n'
name|'for'
name|'info'
op|','
...
newline|'\n'
nl|'\n'
comment|"# argparse ignores default=None for nargs='*'"
nl|'\n'
dedent|''
name|'if'
name|'opt'
...
newline|'\n'
indent|'            '
string|'"""Construct a SubCommandAttr object.\n\n            :param conf: a ConfigOpts object\n            :param group: an OptGroup object\n            :param dest: the name of the sub-parser\n            """'
newline|'\n'
name|'self'
op|'.'
name|'_conf'
...
newline|'\n'
indent|'            '
string|'"""Look up a sub-parser name or argument value."""'
newline|'\n'
name|'if'
name|'name'
op|'=='
