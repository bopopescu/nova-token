...
nl|'\n'
comment|'# and without parents.'
nl|'\n'
comment|'#'
nl|'\n'
comment|"# In the 'with-parents' case (with kwargs present), this function needs to"
nl|'\n'
...
comment|'#'
nl|'\n'
comment|"# In the 'without-parents' case, the original function will be passed"
nl|'\n'
