...
newline|'\n'
indent|'        '
string|'"""end if \'with\' statement.  We\'re done here."""'
newline|'\n'
name|'self'
op|'.'
name|'_done'
...
newline|'\n'
indent|'        '
string|'"""Put Connection back into the pool if this ConnectionContext\n        is being deleted\n        """'
newline|'\n'
name|'self'
op|'.'
name|'_done'
...
nl|'\n'
nl|'\n'
DECL|function|create_consumer_set
dedent|''
dedent|''
name|'def'
...
op|':'
newline|'\n'
comment|'# FIXME(comstud): Replace this however necessary'
nl|'\n'
comment|'# Returns an object that you can call .wait() on to consume'
nl|'\n'
comment|'# all queues?'
nl|'\n'
comment|'# Needs to have a .close() which will stop consuming?'
nl|'\n'
comment|'# Needs to also have an attach_to_eventlet method for tests?'
nl|'\n'
indent|'    '
name|'raise'
name|'NotImplemented'
