...
op|':'
newline|'\n'
comment|'# FIXME(jbresnah) a system call to cp could have'
nl|'\n'
comment|'# significant performance advantages, however we'
nl|'\n'
comment|'# do not have the path to files at this point in'
nl|'\n'
comment|'# the abstraction.'
nl|'\n'
indent|'                    '
name|'shutil'
op|'.'
