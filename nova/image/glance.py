...
newline|'\n'
comment|'# NOTE(sirp): We need to use get_images_detailed and not get_images'
nl|'\n'
comment|'# here because we need `is_public` and properties included so we can'
nl|'\n'
comment|'# filter by user'
nl|'\n'
name|'filtered'
op|'='
op|'['
