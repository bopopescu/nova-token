...
newline|'\n'
indent|'    '
string|'"""Return a random glance url from the api servers we know about."""'
newline|'\n'
name|'return'
name|'next'
op|'('
...
nl|'\n'
nl|'\n'
DECL|function|_endpoint_from_image_ref
dedent|''
name|'def'
name|'_endpoint_from_image_ref'
op|'('
name|'image_href'
op|')'
op|':'
newline|'\n'
indent|'    '
string|'"""Return the image_ref and guessed endpoint from an image url.\n\n    :param image_href: href of an image\n    :returns: a tuple of the form (image_id, endpoint_url)\n    """'
newline|'\n'
name|'parts'
op|'='
name|'image_href'
...
op|']'
newline|'\n'
comment|'# the endpoint is everything in the url except the last 3 bits'
nl|'\n'
comment|"# which are version, 'images', and image_id"
nl|'\n'
name|'endpoint'
op|'='
string|"'/'"
...
nl|'\n'
nl|'\n'
DECL|function|_glanceclient_from_endpoint
dedent|''
name|'def'
...
op|'}'
newline|'\n'
comment|"# NOTE(sdague): even if we aren't using keystone, it doesn't"
nl|'\n'
comment|'# hurt to send these headers.'
nl|'\n'
name|'params'
op|'['
...
nl|'\n'
nl|'\n'
DECL|function|_determine_curr_major_version
dedent|''
name|'def'
...
op|']'
newline|'\n'
comment|'# The \'id\' value looks like "v2.2",'
nl|'\n'
comment|'# so grab the major version number which is 2 in this case'
nl|'\n'
name|'res'
op|'='
name|'int'
...
name|'_LE'
op|'('
string|'"Unable to determine the glance API version"'
op|')'
op|')'
newline|'\n'
nl|'\n'
...
name|'api_server'
newline|'\n'
comment|'# NOTE(sdague): remove in O.'
nl|'\n'
name|'LOG'
op|'.'
name|'warning'
...
name|'_LW'
op|'('
string|'"No protocol specified in for api_server \'%s\', "'
nl|'\n'
string|'"please update [glance] api_servers with fully "'
nl|'\n'
string|'"qualified url including scheme (http / https)"'
op|')'
op|','
nl|'\n'
name|'api_server'
...
op|':'
newline|'\n'
comment|'# Convert generator results to a list, so that we can'
nl|'\n'
comment|'# catch any potential exceptions now and retry the call.'
nl|'\n'
indent|'                    '
name|'return'
name|'list'
...
newline|'\n'
nl|'\n'
comment|'# Retrieve properties for verification of Glance image signature'
nl|'\n'
dedent|''
name|'verifier'
op|'='
...
name|'_LE'
op|'('
string|"'Image signature verification failed '"
nl|'\n'
string|"'for image: %s'"
op|')'
op|','
...
newline|'\n'
nl|'\n'
comment|'# Perform image signature verification'
nl|'\n'
indent|'            '
name|'if'
name|'verifier'
...
name|'_LI'
op|'('
string|"'Image signature verification succeeded '"
nl|'\n'
string|"'for image: %s'"
op|')'
op|','
...
op|')'
newline|'\n'
comment|"# NOTE(mdorman): 'size' attribute must not be 'None', so use 0 instead"
nl|'\n'
dedent|''
dedent|''
name|'elif'
...
nl|'\n'
comment|'# will result in an additional lookup to glance for said attr.'
nl|'\n'
