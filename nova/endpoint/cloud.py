...
newline|'\n'
nl|'\n'
DECL|member|_convert_address
dedent|''
name|'def'
name|'_convert_address'
op|'('
name|'self'
op|','
...
op|':'
newline|'\n'
comment|'# FIXME(vish): this should go away when network.py stores info properly'
nl|'\n'
indent|'        '
name|'address'
op|'='
...
op|':'
newline|'\n'
comment|'# right now all addresses are allocated locally'
nl|'\n'
