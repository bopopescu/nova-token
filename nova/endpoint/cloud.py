...
newline|'\n'
nl|'\n'
DECL|member|_refresh_security_group
dedent|''
name|'def'
name|'_refresh_security_group'
op|'('
name|'self'
op|','
name|'security_group'
...
name|'db'
op|'.'
name|'instance_get_floating_ip_address'
op|'('
name|'None'
op|','
nl|'\n'
...
newline|'\n'
nl|'\n'
comment|"# TODO(soren): Lots and lots of input validation. We're accepting"
nl|'\n'
comment|'#              strings here (such as ipProtocol), which is put into'
nl|'\n'
comment|'#              filter rules verbatim.'
nl|'\n'
comment|'# TODO(soren): Dupe detection. Adding the same rule twice actually'
nl|'\n'
comment|'#              adds the same rule twice to the rule set, which is'
nl|'\n'
comment|'#              pointless.'
nl|'\n'
...
comment|'#              is sketchy.'
nl|'\n'
comment|'# TODO(soren): De-duplicate the turning method arguments into dict stuff.'
nl|'\n'
comment|'#              revoke_security_group_ingress uses the exact same logic.'
nl|'\n'
dedent|''
op|'@'
name|'rbac'
