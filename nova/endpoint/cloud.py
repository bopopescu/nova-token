...
op|':'
newline|'\n'
comment|'# TODO(vish): region_name is an array.  Support filtering'
nl|'\n'
indent|'        '
name|'return'
op|'{'
...
op|'='
name|'None'
comment|'#network_model.get_public_ip_for_instance('
newline|'\n'
comment|"#              i['instance_id'])"
nl|'\n'
name|'i'
op|'['
string|"'private_dns_name'"
...
name|'security_group'
newline|'\n'
comment|"# inst['hostname'] = inst.id # FIXME(ja): id isn't assigned until create"
nl|'\n'
nl|'\n'
name|'inst_id'
op|'='
...
name|'debug'
op|'('
string|'"Casting to node for %s/%s\'s instance %s"'
op|'%'
nl|'\n'
op|'('
name|'context'
...
op|')'
newline|'\n'
comment|'# defer.returnValue(self._format_instances(context, reservation_id))'
nl|'\n'
dedent|''
name|'return'
name|'self'
...
op|')'
newline|'\n'
comment|'# network_topic = yield self._get_network_topic(context)'
nl|'\n'
name|'for'
name|'name'
name|'in'
...
nl|'\n'
comment|'# floating_ip = network_model.get_public_ip_for_instance(i)'
nl|'\n'
comment|'# if floating_ip:'
nl|'\n'
comment|'#     logging.debug("Disassociating address %s" % floating_ip)'
nl|'\n'
...
nl|'\n'
comment|'#     rpc.cast(network_topic,'
nl|'\n'
comment|'#              {"method": "disassociate_floating_ip",'
nl|'\n'
comment|'#               "args": {"floating_ip": floating_ip}})'
nl|'\n'
comment|'# '
nl|'\n'
comment|"# fixed_ip = instance.get('private_dns_name', None)"
nl|'\n'
comment|'# if fixed_ip:'
nl|'\n'
comment|'#     logging.debug("Deallocating address %s" % fixed_ip)'
nl|'\n'
comment|"#     # NOTE(vish): Right now we don't really care if the ip is"
nl|'\n'
...
comment|'#     rpc.cast(network_topic,'
nl|'\n'
comment|'#              {"method": "deallocate_fixed_ip",'
nl|'\n'
comment|'#               "args": {"fixed_ip": fixed_ip}})'
nl|'\n'
nl|'\n'
dedent|''
name|'if'
...
op|')'
newline|'\n'
comment|'# defer.returnValue(True)'
nl|'\n'
dedent|''
dedent|''
name|'return'
