...
op|')'
newline|'\n'
comment|'#allocate_data = yield rpc.call(network_topic,'
nl|'\n'
comment|'#         {"method": "allocate_fixed_ip",'
nl|'\n'
comment|'#          "args": {"user_id": context.user.id,'
nl|'\n'
comment|'#                   "project_id": context.project.id,'
nl|'\n'
comment|'#                   "security_group": security_group,'
nl|'\n'
comment|'#                   "is_vpn": is_vpn,'
nl|'\n'
comment|'#                   "hostname": inst.instance_id}})'
nl|'\n'
name|'allocate_data'
op|'='
op|'{'
