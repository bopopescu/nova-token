...
name|'db'
op|'.'
name|'security_group_get_by_user'
op|'('
name|'context'
op|','
name|'context'
...
comment|'#'
nl|'\n'
comment|"#                 [{ 'groupDescription': group.description,"
nl|'\n'
comment|"#                     'groupName' : group.name,"
nl|'\n'
comment|"#                     'ownerId': context.user.id,"
nl|'\n'
comment|"#                     'ipPermissions' : ["
nl|'\n'
comment|"#                        { 'ipProtocol' : rule.protocol,"
nl|'\n'
comment|"#                          'fromPort' : rule.from_port,"
nl|'\n'
comment|"#                          'toPort' : rule.to_port,"
nl|'\n'
comment|"#                          'ipRanges' : [ { 'cidrIp' : rule.cidr } ] } for rule in group.rules ] } for group in \\"
nl|'\n'
comment|'#'
nl|'\n'
comment|'#        return groups'
nl|'\n'
nl|'\n'
dedent|''
op|'@'
...
name|'db'
op|'.'
name|'security_group_get_by_user_and_name'
op|'('
name|'context'
op|','
nl|'\n'
...
name|'break'
newline|'\n'
comment|'# If we make it here, we have a match'
nl|'\n'
dedent|''
dedent|''
name|'db'
