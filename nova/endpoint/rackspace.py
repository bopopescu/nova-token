...
op|')'
newline|'\n'
comment|'#self._connect("/v1.0", controller=AuthenticationAPI())'
nl|'\n'
comment|'#cloud = CloudServerAPI()'
nl|'\n'
comment|'#self._connect("/servers", controller=cloud.launch_server,'
nl|'\n'
comment|'#              conditions={"method": ["POST"]})'
nl|'\n'
comment|'#self._connect("/servers/{server_id}", controller=cloud.delete_server,'
nl|'\n'
comment|'#              conditions={\'method\': ["DELETE"]})'
nl|'\n'
comment|'#self._connect("/servers", controller=cloud)'
nl|'\n'
nl|'\n'
nl|'\n'
