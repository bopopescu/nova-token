...
newline|'\n'
indent|'    '
string|'"""Filter out hosts that have already been attempted for scheduling\n    purposes\n    """'
newline|'\n'
nl|'\n'
...
newline|'\n'
indent|'        '
string|'"""Skip hosts that have already been attempted"""'
newline|'\n'
name|'retry'
op|'='
name|'filter_properties'
...
name|'_'
op|'('
string|'"Previously tried hosts: %(hosts)s.  (host=%(host)s)"'
op|')'
op|'%'
nl|'\n'
name|'locals'
