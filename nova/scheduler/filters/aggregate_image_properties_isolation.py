...
op|')'
newline|'\n'
comment|'# NOTE(sbauza): Aggregate metadata is only strings, we need to'
nl|'\n'
comment|'# stringify the property to match with the option'
nl|'\n'
comment|'# TODO(sbauza): Fix that very ugly pattern matching'
nl|'\n'
name|'if'
name|'prop'
name|'and'
