...
op|':'
newline|'\n'
comment|'# NOTE(Vek): If all the weights are unique, then the sort'
nl|'\n'
comment|'#            below undoes this shuffle; however, if'
nl|'\n'
comment|'#            several responses from several zones have the'
nl|'\n'
comment|'#            same weight, then this shuffle serves to'
nl|'\n'
comment|'#            break up the monolithic blocks and cause the'
nl|'\n'
comment|'#            instances to be uniformly spread across the'
nl|'\n'
comment|'#            zones.'
nl|'\n'
indent|'            '
