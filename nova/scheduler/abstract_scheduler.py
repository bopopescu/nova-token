...
name|'_'
op|'('
string|'"Scheduler only understands"'
nl|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|hold_filter_hosts
dedent|''
name|'def'
name|'hold_filter_hosts'
op|'('
name|'self'
op|','
name|'topic'
...
newline|'\n'
comment|'# NOTE(dabo): The logic used by the current _schedule() method'
nl|'\n'
comment|'# is incorrect. Since this task is just to refactor the classes,'
nl|'\n'
comment|"# I'm not fixing the logic now - that will be the next task."
nl|'\n'
comment|'# So for now this method is just renamed; afterwards this will'
nl|'\n'
comment|'# become the filter_hosts() method, and the one below will'
nl|'\n'
comment|'# be removed.'
nl|'\n'
name|'filter_name'
