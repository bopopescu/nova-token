...
op|')'
newline|'\n'
comment|'# This is being returned instead of raised, so that when results are'
nl|'\n'
comment|'# processed in unmarshal_result() after the greenpool.imap completes,'
nl|'\n'
comment|'# the exception can be raised there if no other zones had a response.'
nl|'\n'
name|'return'
name|'exception'
op|'.'
