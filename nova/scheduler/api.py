...
newline|'\n'
indent|'        '
string|'"""Wrap method to supply an argument."""'
newline|'\n'
DECL|function|_wrap
name|'def'
name|'_wrap'
...
name|'debug'
op|'('
string|'"***** GOT EXCEPTION %s FROM CHILD"'
op|'%'
name|'e'
op|')'
newline|'\n'
...
name|'debug'
op|'('
string|'"***** REROUTING TO ASK CHILDREN"'
op|')'
newline|'\n'
name|'return'
name|'self'
...
name|'debug'
op|'('
string|'"****** COULD NOT FIND INSTANCE"'
op|')'
newline|'\n'
comment|'#return exception.InstanceNotFound(instance_id=self.item_uuid)'
nl|'\n'
name|'return'
name|'None'
newline|'\n'
...
name|'debug'
op|'('
string|'"****** REDIRECT HANDLER - RAISING %s"'
op|'%'
name|'e'
op|'.'
name|'results'
