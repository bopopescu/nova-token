...
name|'_'
op|'('
string|'"*** CALLING ZONE %(args)s ^^ %(kwargs)s"'
op|')'
op|'%'
name|'locals'
op|'('
...
comment|'#asdads'
newline|'\n'
comment|'# TODO (dabo) - want to be able to re-raise here.'
nl|'\n'
comment|'# Returning a string now; raising was causing issues.'
nl|'\n'
comment|'# raise e'
nl|'\n'
name|'return'
