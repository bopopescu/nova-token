...
op|':'
newline|'\n'
comment|'# Ignores exception raised from consume_from_instance() so that'
nl|'\n'
...
newline|'\n'
indent|'        '
string|'"""Update metrics from a ComputeNode object."""'
newline|'\n'
...
nl|'\n'
comment|'# and when consume_from_instance() is run, we can safely say that there'
nl|'\n'
