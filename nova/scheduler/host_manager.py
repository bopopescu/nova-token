...
newline|'\n'
indent|'        '
string|'"""Update all information about a host."""'
newline|'\n'
nl|'\n'
op|'@'
name|'utils'
...
op|':'
newline|'\n'
comment|'# Scheduler API is inherently multi-threaded as every incoming RPC'
nl|'\n'
comment|"# message will be dispatched in it's own green thread. So the"
nl|'\n'
comment|'# shared host state should be updated in a consistent way to make'
nl|'\n'
comment|'# sure its data is valid under concurrent write operations.'
nl|'\n'
indent|'            '
name|'if'
name|'compute'
...
name|'debug'
op|'('
string|'"Update host state from compute node: %s"'
op|','
name|'compute'
op|')'
newline|'\n'
...
name|'debug'
op|'('
string|'"Update host state with aggregates: %s"'
op|','
name|'aggregates'
op|')'
newline|'\n'
...
name|'debug'
op|'('
string|'"Update host state with service dict: %s"'
op|','
name|'service'
op|')'
newline|'\n'
...
name|'debug'
op|'('
string|'"Update host state with instances: %s"'
op|','
name|'inst_dict'
op|')'
newline|'\n'
...
newline|'\n'
indent|'        '
string|'"""Incrementally update host state from a RequestSpec object."""'
newline|'\n'
nl|'\n'
op|'@'
name|'utils'
...
comment|"# message will be dispatched in it's own green thread. So the"
nl|'\n'
comment|'# shared host state should be consumed in a consistent way to make'
nl|'\n'
comment|'# sure its data is valid under concurrent write operations.'
nl|'\n'
indent|'            '
...
name|'return'
op|'('
string|'"(%(host)s, %(node)s) ram: %(free_ram)sMB "'
nl|'\n'
string|'"disk: %(free_disk)sMB io_ops: %(num_io_ops)s "'
nl|'\n'
string|'"instances: %(num_instances)s"'
op|'%'
nl|'\n'
op|'{'
string|"'host'"
...
newline|'\n'
nl|'\n'
DECL|member|_get_aggregates_info
dedent|''
name|'def'
name|'_get_aggregates_info'
op|'('
