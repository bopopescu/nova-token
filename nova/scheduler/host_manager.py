...
name|'_'
op|'('
string|"'Host filter ignoring hosts: %(ignored_hosts)s'"
op|')'
newline|'\n'
name|'LOG'
op|'.'
...
nl|'\n'
string|'"value of \'%(forced_hosts)s\'"'
op|')'
newline|'\n'
name|'LOG'
op|'.'
...
name|'_'
op|'('
string|"'Host filter forcing available hosts to %(forced_hosts)s'"
op|')'
newline|'\n'
name|'LOG'
op|'.'
