...
op|':'
newline|'\n'
comment|'# Not specified; use the default'
nl|'\n'
indent|'            '
name|'filters'
op|'='
...
op|':'
newline|'\n'
comment|"# Get the full list (only considering 'compute' services)"
nl|'\n'
indent|'            '
name|'all_hosts'
op|'='
...
op|']'
newline|'\n'
comment|'# Make sure that the requested filters are legitimate.'
nl|'\n'
dedent|''
