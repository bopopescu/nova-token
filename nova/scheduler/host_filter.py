...
name|'DEFINE_string'
op|'('
string|"'default_host_filter_driver'"
op|','
nl|'\n'
string|"'nova.scheduler.host_filter.AllHostsFilter'"
op|','
nl|'\n'
string|"'Which driver to use for filtering hosts.'"
op|')'
newline|'\n'
nl|'\n'
nl|'\n'
...
newline|'\n'
indent|'    '
string|'"""Base class for host filter drivers."""'
newline|'\n'
nl|'\n'
...
newline|'\n'
indent|'        '
string|'"""module.classname of the filter driver"""'
newline|'\n'
name|'return'
string|'"%s.%s"'
op|'%'
...
newline|'\n'
indent|'    '
string|'"""NOP host filter driver. Returns all hosts in ZoneManager.\n    This essentially does what the old Scheduler+Chance used\n    to give us."""'
newline|'\n'
nl|'\n'
DECL|member|instance_type_to_filter
name|'def'
...
newline|'\n'
indent|'    '
string|'"""HostFilter driver hard-coded to work with InstanceType records."""'
newline|'\n'
nl|'\n'
DECL|member|instance_type_to_filter
name|'def'
...
newline|'\n'
indent|'    '
string|'"""Host Filter driver to allow simple JSON-based grammar for\n       selecting hosts."""'
newline|'\n'
nl|'\n'
DECL|member|_equals
name|'def'
...
newline|'\n'
comment|'# FIXME(sirp): use utils.import_class here'
nl|'\n'
dedent|''
name|'for'
name|'driver'
