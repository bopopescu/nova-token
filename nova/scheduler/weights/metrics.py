...
name|'help'
op|'='
string|"'How to treat the unavailable metrics. When a '"
nl|'\n'
string|"'metric is NOT available for a host, if it is set '"
nl|'\n'
string|"'to be True, it would raise an exception, so it '"
nl|'\n'
string|"'is recommended to use the scheduler filter '"
nl|'\n'
string|"'MetricFilter to filter out those hosts. If it is '"
nl|'\n'
string|"'set to be False, the unavailable metric would be '"
nl|'\n'
string|"'treated as a negative factor in weighing '"
nl|'\n'
string|"'process, the returned value would be set by '"
nl|'\n'
string|"'the option weight_of_unavailable.'"
op|')'
op|','
nl|'\n'
name|'cfg'
...
name|'help'
op|'='
string|"'The final weight value to be returned if '"
nl|'\n'
string|"'required is set to False and any one of the '"
nl|'\n'
string|"'metrics set by weight_setting is unavailable.'"
op|')'
op|','
nl|'\n'
op|']'
