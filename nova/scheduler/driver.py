...
name|'DEFINE_string'
op|'('
string|"'scheduler_zone_manager'"
op|','
nl|'\n'
string|"'nova.scheduler.zone_manager.ZoneManager'"
op|','
nl|'\n'
string|"'The scheduler zone manager class to use'"
op|')'
newline|'\n'
name|'flags'
op|'.'
...
newline|'\n'
indent|'        '
string|'"""Must override this for zones to work."""'
newline|'\n'
name|'raise'
name|'NotImplementedError'
op|'('
name|'_'
op|'('
string|'"Must implement \'select\' method"'
op|')'
op|')'
newline|'\n'
nl|'\n'
...
nl|'\n'
nl|'\n'
comment|'# Refresh compute_nodes table'
nl|'\n'
name|'topic'
op|'='
name|'db'
