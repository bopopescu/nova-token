...
nl|'\n'
string|'"(time synchronize problem?)"'
op|')'
op|')'
newline|'\n'
nl|'\n'
...
name|'_'
op|'('
string|'"%s is not alive(time "'
nl|'\n'
string|'"synchronize problem?)"'
op|')'
op|'%'
name|'src'
op|')'
...
name|'_'
op|'('
string|'"host %s where instance was launched "'
nl|'\n'
...
nl|'\n'
string|'"(%(orig_hypervisor)s->"'
nl|'\n'
string|'"%(dest_hypervisor)s)\')"'
op|'%'
name|'locals'
op|'('
op|')'
...
name|'_'
op|'('
string|'"%(ec2_id)s is not capable to "'
nl|'\n'
string|'"migrate %(dest)s (host:%(mem_avail)s "'
nl|'\n'
...
name|'_'
op|'('
string|'"Cannot comfirm tmpfile at %(ipath)s is on "'
nl|'\n'
