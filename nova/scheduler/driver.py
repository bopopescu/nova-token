...
name|'driver'
newline|'\n'
comment|'# TODO(Yingxin): Change to catch stevedore.exceptions.NoMatches'
nl|'\n'
comment|'# after stevedore v1.9.0'
nl|'\n'
dedent|''
name|'except'
name|'RuntimeError'
op|':'
newline|'\n'
comment|'# NOTE(Yingxin): Loading full class path is deprecated and'
nl|'\n'
comment|'# should be removed in the N release.'
nl|'\n'
indent|'            '
name|'try'
op|':'
...
name|'_LW'
op|'('
string|'"DEPRECATED: scheduler_host_manager uses "'
nl|'\n'
...
name|'_'
op|'('
string|'"Cannot load host manager from configuration "'
nl|'\n'
string|'"scheduler_host_manager = %(conf)s."'
op|')'
op|','
nl|'\n'
op|'{'
