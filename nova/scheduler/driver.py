...
op|')'
newline|'\n'
comment|'# Get the instance_group if it exists. This will be written to the'
nl|'\n'
comment|'# system_metadata as it will be used when the VM is deleted'
nl|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|instance_group_data
dedent|''
name|'def'
...
newline|'\n'
indent|'        '
string|'"""Return the the group data for the instance group."""'
newline|'\n'
nl|'\n'
name|'return'
name|'conductor_api'
...
newline|'\n'
nl|'\n'
DECL|member|instance_group_hosts
dedent|''
name|'def'
...
newline|'\n'
indent|'        '
string|'"""Return the list of hosts that have VM\'s from the instance_group."""'
newline|'\n'
nl|'\n'
name|'instances'
op|'='
