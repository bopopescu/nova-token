...
op|'('
op|'('
string|'"""%s doesnt have compatibility to %s"""'
nl|'\n'
string|'"""(where %s was launched at)"""'
op|')'
op|')'
newline|'\n'
name|'ec2_id'
...
name|'_'
op|'('
string|"'%s is not capable to migrate %s(host:%s <= instance:%s)'"
op|')'
newline|'\n'
name|'raise'
name|'exception'
...
name|'_'
op|'('
string|'"""Cannot comfirm %s at %s to confirm shared storage."""'
nl|'\n'
string|'"""Check if %s is same shared storage"""'
op|')'
op|')'
newline|'\n'
name|'logging'
