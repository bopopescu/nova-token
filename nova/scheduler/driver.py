...
name|'reason'
op|'='
string|'"Block migration can not be used with shared storage."'
newline|'\n'
name|'raise'
name|'exception'
op|'.'
...
name|'_'
op|'('
string|'"Unable to migrate %(ec2_id)s to %(dest)s: Lack of  "'
nl|'\n'
string|'"disk(host:%(avail)s <= instance:%(mem_inst)s)"'
op|')'
newline|'\n'
name|'raise'
name|'exception'
...
string|'"Unable to migrate %(ec2_id)s to %(dest)s: Lack of  "'
nl|'\n'
string|'"disk(host:%(avail)s <= instance:%(disk_inst)s)"'
op|')'
newline|'\n'
name|'raise'
name|'exception'
