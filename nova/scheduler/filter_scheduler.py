...
name|'num_instances'
newline|'\n'
comment|'# TODO(sbauza): Modify the interfaces for HostManager and filters to'
nl|'\n'
comment|'# accept the RequestSpec object directly (in a later patch hopefully)'
nl|'\n'
name|'filter_properties'
op|'='
name|'spec_obj'
...
op|')'
newline|'\n'
comment|'# NOTE(sbauza): Adding temporarly some keys since filters are'
nl|'\n'
comment|'# directly using it - until we provide directly RequestSpec'
nl|'\n'
name|'filter_properties'
op|'.'
name|'update'
...
nl|'\n'
comment|'# provided as non-fields for the RequestSpec once we provide it to the'
nl|'\n'
comment|'# filters'
nl|'\n'
name|'filter_properties'
...
nl|'\n'
comment|'# TODO(sbauza): Temporary use of the old legacy dict until we'
nl|'\n'
comment|'# modify HostManager to use the RequestSpec object'
nl|'\n'
name|'spec_dict'
op|'='
name|'spec_obj'
