...
op|':'
newline|'\n'
comment|"# NOTE: We're only focused on compute instances right now,"
nl|'\n'
comment|'# so this method will always raise NoValidHost().'
nl|'\n'
indent|'        '
name|'msg'
op|'='
...
name|'self'
op|'.'
name|'_legacy_schedule_run_instance'
op|'('
name|'context'
op|','
name|'request_spec'
...
newline|'\n'
nl|'\n'
DECL|member|_legacy_schedule_run_instance
dedent|''
name|'def'
name|'_legacy_schedule_run_instance'
op|'('
