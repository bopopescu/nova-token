...
op|')'
newline|'\n'
comment|'# LOG.debug(_("Comparing %(str1)s and %(str2)s. "\\'
nl|'\n'
comment|'#            "Result %(result)s"), locals())'
nl|'\n'
name|'return'
name|'result'
newline|'\n'
nl|'\n'
DECL|member|_compare_sizes_exact_match
dedent|''
name|'def'
name|'_compare_sizes_exact_match'
op|'('
name|'self'
op|','
name|'cap_capacity'
...
name|'size_gb'
newline|'\n'
comment|'# LOG.debug(_("Comparing %(cap_capacity)d and %(size_gb)d. "\\'
nl|'\n'
comment|'#            "Result %(result)s"), locals())'
nl|'\n'
name|'return'
...
newline|'\n'
nl|'\n'
DECL|member|_compare_sizes_approxim
dedent|''
name|'def'
...
op|':'
newline|'\n'
comment|'# LOG.debug(_("One of required capabilities found: %s:%s"),'
nl|'\n'
comment|"#            cap['cap1'], drive_type[cap['cap2']])"
nl|'\n'
indent|'                '
name|'pass'
newline|'\n'
...
name|'_'
op|'('
string|'"Filter hosts for drive type %(drive_type)s"'
op|')'
op|'%'
name|'locals'
op|'('
...
name|'_'
op|'('
string|'"Adding host %s to the list"'
op|')'
op|','
name|'host'
op|')'
...
name|'_'
op|'('
string|'"Found hosts %(filtered_hosts)s"'
op|')'
op|'%'
name|'locals'
op|'('
...
newline|'\n'
nl|'\n'
DECL|member|_alg_least_used_host
dedent|''
dedent|''
name|'def'
name|'_alg_least_used_host'
op|'('
name|'self'
op|','
name|'request_spec'
...
name|'_'
op|'('
string|'"Selecting best host for %(size)sGB volume of type "'
string|'"%(drive_type)s from %(all_hosts)s"'
op|')'
op|','
name|'locals'
op|'('
...
name|'_'
op|'('
string|'"Best host found: %(best_host)s. "'
...
newline|'\n'
nl|'\n'
DECL|member|_alg_most_avail_capacity
dedent|''
name|'def'
name|'_alg_most_avail_capacity'
op|'('
name|'self'
op|','
name|'request_spec'
...
op|'('
string|'"Best host found: %(best_host)s. "'
string|'"(available capacity %(max_avail)s)"'
op|')'
op|','
name|'locals'
op|'('
...
newline|'\n'
nl|'\n'
comment|'#self._alg_most_avail_capacity(request_spec, all_hosts, selected_hosts)'
nl|'\n'
nl|'\n'
indent|'        '
name|'if'
...
name|'_'
op|'('
string|'"Assigning host to volume %s"'
op|')'
op|'%'
name|'vol'
op|'['
...
name|'_'
op|'('
string|'"Assigned host %(host)s, capabilities %(qos_cap)s"'
op|')'
op|','
nl|'\n'
name|'locals'
...
name|'_'
op|'('
string|'"END: volume_params %(volume_params)s"'
op|')'
op|'%'
name|'locals'
op|'('
...
name|'_'
op|'('
string|'"Service states BEFORE %s"'
op|')'
op|','
nl|'\n'
name|'self'
...
newline|'\n'
nl|'\n'
comment|'# otherwise - drive type is loaded'
nl|'\n'
name|'LOG'
op|'.'
name|'debug'
...
name|'_'
op|'('
string|'"Spawning volume %d with drive type %s"'
op|')'
op|','
nl|'\n'
name|'volume_ref'
