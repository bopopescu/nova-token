...
newline|'\n'
nl|'\n'
comment|'# NOTE (David Subiros) : If the exception is raised during run_instance'
nl|'\n'
comment|'#                        method, we may or may not have an instance_id'
nl|'\n'
...
name|'return'
newline|'\n'
comment|'# FIXME(comstud): Clean this up after fully on UUIDs.'
nl|'\n'
dedent|''
name|'instance_id'
op|'='
...
name|'_'
op|'('
string|'"Setting instance %(instance_id)s to "'
nl|'\n'
string|'"ERROR state."'
op|')'
op|'%'
...
newline|'\n'
comment|'# Update latest compute_node table'
nl|'\n'
name|'topic'
op|'='
name|'db'
