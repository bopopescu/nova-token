...
nl|'\n'
comment|'# NOTE(markmc): This remains only for backwards compat support'
nl|'\n'
comment|'# and can be removed when we bump the major version'
nl|'\n'
name|'return'
name|'functools'
op|'.'
...
op|')'
newline|'\n'
comment|'# FIXME(comstud): We really need to move error handling closer'
nl|'\n'
comment|'# to where the errors occur so we can deal with errors on'
nl|'\n'
comment|'# individual instances when scheduling multiple.'
nl|'\n'
name|'if'
...
nl|'\n'
nl|'\n'
DECL|class|_V2SchedulerManagerProxy
dedent|''
dedent|''
name|'class'
name|'_V2SchedulerManagerProxy'
...
comment|'# Notes:'
nl|'\n'
comment|'# - remove get_host_list()'
nl|'\n'
comment|'# - remove get_service_capabilities()'
nl|'\n'
comment|'# - add explicit live_migration() method'
nl|'\n'
comment|'# - remove __getattr__ magic which is replaced by schedule()'
nl|'\n'
nl|'\n'
DECL|member|__init__
name|'def'
...
newline|'\n'
nl|'\n'
comment|'# Remove instance_id, require instance'
nl|'\n'
comment|'# Remove topic'
nl|'\n'
comment|'# Make block_migration and disk_over_commit required'
nl|'\n'
DECL|member|live_migration
dedent|''
name|'def'
...
newline|'\n'
nl|'\n'
comment|'# Remove update_db'
nl|'\n'
comment|'# Remove instance_uuid, require instance'
nl|'\n'
comment|'# Remove instance_type_id, require instance_type'
nl|'\n'
comment|'# Remove topic'
nl|'\n'
comment|'# Make reservations required'
nl|'\n'
DECL|member|prep_resize
dedent|''
name|'def'
...
newline|'\n'
nl|'\n'
comment|'# Remove reservations and topic'
nl|'\n'
comment|'# Require instance_uuids in request_spec'
nl|'\n'
DECL|member|run_instance
dedent|''
name|'def'
...
nl|'\n'
comment|'# require service_name, host and capabilities'
nl|'\n'
DECL|member|update_service_capabilities
dedent|''
name|'def'
