...
op|':'
newline|'\n'
comment|'# If this affects a particular instance, move that'
nl|'\n'
comment|'# instance to the ERROR state'
nl|'\n'
indent|'            '
name|'if'
string|"'instance_id'"
...
name|'_'
op|'('
string|'"Failed to %(driver_method)s: %(e)s.  "'
nl|'\n'
string|'"Putting instance %(instance_id)s into "'
nl|'\n'
string|'"ERROR state."'
op|')'
op|'%'
