...
name|'_'
op|'('
string|'"Bad child zone scaling values for Zone: "'
nl|'\n'
string|'"%(zone)s"'
op|')'
op|'%'
...
newline|'\n'
nl|'\n'
comment|"# TODO(sirp): weigh_hosts should also be a function of 'topic' or"
nl|'\n'
comment|'# resources, so that we can apply different objective functions to it'
nl|'\n'
nl|'\n'
...
newline|'\n'
comment|'# NOTE(sirp): The default logic is the equivalent to AllHostsFilter'
nl|'\n'
name|'service_states'
op|'='
name|'self'
