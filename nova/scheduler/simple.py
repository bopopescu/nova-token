...
name|'_'
op|'('
string|"'SimpleScheduler now only covers volume scheduling '"
nl|'\n'
string|"'and is deprecated in Folsom. Non-volume functionality in '"
nl|'\n'
string|"'SimpleScheduler has been replaced by FilterScheduler'"
op|')'
op|')'
newline|'\n'
name|'super'
...
name|'_'
op|'('
string|"'nova-volume functionality is deprecated in Folsom '"
nl|'\n'
string|"'and will be removed in Grizzly.  Volumes are now handled '"
nl|'\n'
string|"'by Cinder'"
op|')'
op|')'
