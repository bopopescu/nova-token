...
op|','
nl|'\n'
comment|'# Run instances expects encoded userdata, it is decoded in the'
nl|'\n'
comment|'# get_metadata_call. autorun.sh also decodes the zip file, hence'
nl|'\n'
comment|'# the double encoding.'
nl|'\n'
name|'user_data'
op|'='
name|'zippy'
...
comment|'#     try:'
nl|'\n'
comment|'#         secgroup = conn.create_security_group("vpn-secgroup",'
nl|'\n'
comment|'#                                               "vpn-secgroup")'
nl|'\n'
comment|'#         secgroup.authorize(ip_protocol = "udp", from_port = "1194",'
nl|'\n'
comment|'#                            to_port = "1194", cidr_ip = "0.0.0.0/0")'
nl|'\n'
comment|'#         secgroup.authorize(ip_protocol = "tcp", from_port = "80",'
nl|'\n'
comment|'#                            to_port = "80", cidr_ip = "0.0.0.0/0")'
nl|'\n'
comment|'#         secgroup.authorize(ip_protocol = "tcp", from_port = "22",'
nl|'\n'
comment|'#                            to_port = "22", cidr_ip = "0.0.0.0/0")'
nl|'\n'
comment|'#     except:'
nl|'\n'
comment|'#         pass'
