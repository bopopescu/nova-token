...
name|'CommandFilter'
op|'('
string|'"/usr/sbin/ip6tables-save"'
op|','
string|'"root"'
op|')'
op|','
...
name|'CommandFilter'
op|'('
string|'"/usr/sbin/iptables-restore"'
op|','
string|'"root"'
op|')'
op|','
...
name|'CommandFilter'
op|'('
string|'"/usr/sbin/ip6tables-restore"'
op|','
string|'"root"'
op|')'
op|','
...
nl|'\n'
nl|'\n'
comment|"# nova/virt/disk/api.py: 'touch', target"
nl|'\n'
name|'filters'
op|'.'
name|'CommandFilter'
...
nl|'\n'
nl|'\n'
comment|'# nova/virt/libvirt/utils.py:'
nl|'\n'
name|'filters'
op|'.'
name|'CommandFilter'
