...
nl|'\n'
comment|'#   a call to release_fixed_ip in the network manager, or it will'
nl|'\n'
comment|'#   be timed out periodically if the lease fails.'
nl|'\n'
comment|'# - otherwise, we release the ip immediately'
nl|'\n'
nl|'\n'
