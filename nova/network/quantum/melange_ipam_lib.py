...
newline|'\n'
nl|'\n'
comment|'# create a entry in the network table, even though'
nl|'\n'
comment|'# most data is stored in melange.  This is used to'
nl|'\n'
comment|'# store data not kept by melange (e.g., priority)'
nl|'\n'
comment|"# and to 'fake' other parts of nova (e.g., the API)"
nl|'\n'
comment|'# until we get get all accesses to be via the'
nl|'\n'
comment|'# network manager API.'
nl|'\n'
dedent|''
name|'net'
op|'='
