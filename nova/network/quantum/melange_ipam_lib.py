...
op|']'
newline|'\n'
comment|'# This is confusing, if there are IPs for the given net, vif,'
nl|'\n'
comment|'# tenant trifecta we assume that is the tenant for that network'
nl|'\n'
name|'for'
name|'tid'
name|'in'
...
newline|'\n'
nl|'\n'
DECL|member|get_instance_ids_by_ip_address
dedent|''
name|'def'
...
op|')'
newline|'\n'
comment|'# TODO (aaron.lee) melange should be storing & returning instance_uuid!'
nl|'\n'
name|'return'
op|'['
name|'ip'
...
newline|'\n'
indent|'        '
string|'"""This call is not supported in quantum yet"""'
newline|'\n'
name|'return'
op|'['
op|']'
