...
nl|'\n'
nl|'\n'
comment|'# this is a simple json-only serializer to use until'
nl|'\n'
comment|'# we can just grab the standard serializer'
nl|'\n'
comment|'# from the quantum library'
nl|'\n'
...
op|':'
newline|'\n'
comment|'# Temporarily set format and tenant for this request'
nl|'\n'
indent|'            '
op|'('
name|'format'
