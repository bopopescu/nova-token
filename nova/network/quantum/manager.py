...
newline|'\n'
nl|'\n'
comment|"# FIXME: (danwent). We'd like to have the manager be completely"
nl|'\n'
comment|'# decoupled from the nova networks table.'
nl|'\n'
comment|'# However, other parts of nova sometimes go behind'
nl|'\n'
comment|'# our back and access network data directly from the DB.  So'
nl|'\n'
comment|'# for now, the quantum manager knows that there is a nova'
nl|'\n'
comment|'# networks DB table and accesses it here.'
nl|'\n'
comment|'# updating the virtual_interfaces table to use UUIDs would'
nl|'\n'
comment|'# be one solution, but this would require significant work'
nl|'\n'
comment|'# elsewhere.'
nl|'\n'
indent|'            '
