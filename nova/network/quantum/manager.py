...
op|')'
newline|'\n'
comment|"# TODO(bgh): We'll need to enable these when we implement the full L3"
nl|'\n'
comment|'# functionalities'
nl|'\n'
comment|'# self.driver.ensure_metadata_ip()'
nl|'\n'
comment|'# self.driver.metadata_forward()'
nl|'\n'
nl|'\n'
...
name|'project_id'
newline|'\n'
comment|"# TODO(bgh): The project_id isn't getting populated here for some"
nl|'\n'
comment|"# reason.. I'm not sure if it's an invalid assumption or just a bug."
nl|'\n'
comment|"# In order to get the right quantum_net_id we'll have to query all the"
nl|'\n'
comment|'# project_ids for now.'
nl|'\n'
name|'if'
name|'project_id'
name|'is'
...
newline|'\n'
nl|'\n'
comment|"# Quantum may also know about networks that aren't in the networks"
nl|'\n'
comment|'# table so we need to query Quanutm for any tenant networks and add'
nl|'\n'
comment|'# them to net_proj_pairs.'
nl|'\n'
dedent|''
name|'qnets'
op|'='
...
op|')'
newline|'\n'
comment|'# Tell melange to allocate an IP'
nl|'\n'
name|'ip'
op|'='
name|'self'
...
newline|'\n'
nl|'\n'
comment|'# TODO(bgh): if this is the last instance for the network'
nl|'\n'
comment|'# then we should actually just kill the dhcp server.'
nl|'\n'
nl|'\n'
