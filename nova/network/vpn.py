...
newline|'\n'
indent|'    '
string|'"""No ports available to allocate for the given ip"""'
newline|'\n'
name|'pass'
newline|'\n'
nl|'\n'
...
newline|'\n'
indent|'        '
string|'"""Key that ports are stored under in redis"""'
newline|'\n'
name|'return'
string|"'ip:%s:ports'"
op|'%'
...
newline|'\n'
indent|'        '
string|'"""Creates the set of ports for the ip if it doesn\'t already exist"""'
newline|'\n'
