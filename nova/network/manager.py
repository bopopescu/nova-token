...
name|'warn'
op|'('
string|'"IP %s released that is still allocated"'
op|','
name|'address'
op|')'
newline|'\n'
...
newline|'\n'
indent|'        '
string|'"""Allocate vpn ip for network"""'
newline|'\n'
comment|'# TODO(vish): There is a possible concurrency issue here.'
nl|'\n'
name|'network_ref'
op|'='
name|'db'
...
op|')'
newline|'\n'
comment|'# TODO(vish): Should this be fixed_ip_is_allocated?'
nl|'\n'
name|'if'
name|'fixed_ip_ref'
op|'['
