...
newline|'\n'
indent|'        '
string|'"""Sets the listen address before sending update to the driver."""'
newline|'\n'
name|'network_ref'
op|'['
string|"'dhcp_server'"
...
op|')'
newline|'\n'
DECL|function|_sync_get_dhcp_ip
name|'def'
name|'_sync_get_dhcp_ip'
op|'('
op|')'
op|':'
newline|'\n'
...
op|':'
newline|'\n'
comment|'# NOTE(vish): multi_host networks need to be set on all boxes'
nl|'\n'
indent|'            '
name|'if'
name|'network'
...
nl|'\n'
comment|'#self.set_network_hosts(context)'
nl|'\n'
nl|'\n'
...
newline|'\n'
nl|'\n'
comment|'# return only networks which have host set or are multi_host'
nl|'\n'
name|'return'
op|'['
name|'network'
