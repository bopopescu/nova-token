...
op|':'
newline|'\n'
comment|'#    def _regexp_filter_by_ipv6(instance, filter_re):'
nl|'\n'
comment|"#        for interface in instance['virtual_interfaces']:"
nl|'\n'
comment|"#            fixed_ipv6 = interface.get('fixed_ipv6')"
nl|'\n'
comment|'#            if fixed_ipv6 and filter_re.match(fixed_ipv6):'
nl|'\n'
comment|'#                return True'
nl|'\n'
...
nl|'\n'
nl|'\n'
comment|'#    def _regexp_filter_by_ip(instance, filter_re):'
nl|'\n'
comment|"#        for interface in instance['virtual_interfaces']:"
nl|'\n'
comment|"#            for fixed_ip in interface['fixed_ips']:"
nl|'\n'
comment|"#                if not fixed_ip or not fixed_ip['address']:"
nl|'\n'
comment|'#                    continue'
nl|'\n'
comment|"#                if filter_re.match(fixed_ip['address']):"
nl|'\n'
comment|'#                    return True'
nl|'\n'
comment|"#                for floating_ip in fixed_ip.get('floating_ips', []):"
nl|'\n'
comment|"#                    if not floating_ip or not floating_ip['address']:"
nl|'\n'
comment|'#                        continue'
nl|'\n'
comment|"#                    if filter_re.match(floating_ip['address']):"
nl|'\n'
comment|'#                        return True'
nl|'\n'
comment|'#        return False'
