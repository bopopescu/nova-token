...
nl|'\n'
string|'"allocate fixed IP. %(used)s of %(allowed)s are in "'
nl|'\n'
string|'"use or are already reserved."'
op|')'
op|','
nl|'\n'
op|'{'
...
name|'_'
op|'('
string|"'Error cleaning up fixed ip allocation. '"
nl|'\n'
string|"'Manual cleanup may be required.'"
op|')'
op|','
nl|'\n'
name|'exc_info'
