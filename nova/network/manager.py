...
nl|'\n'
nl|'\n'
comment|'#TODO(sandy) - PEP8 until this is checked ...'
nl|'\n'
...
op|']'
newline|'\n'
comment|'# Find the network that contains this IP ...'
nl|'\n'
name|'network'
op|'='
name|'None'
...
nl|'\n'
nl|'\n'
comment|'# TODO(sandy): Switched to multi-IP support'
nl|'\n'
DECL|member|deallocate_fixed_ip
dedent|''
dedent|''
...
newline|'\n'
indent|'        '
string|'"""Returns a list of fixed ips to the pool."""'
newline|'\n'
name|'for'
name|'network'
name|'in'
