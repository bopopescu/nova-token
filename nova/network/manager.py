...
newline|'\n'
comment|'# TODO(mriedem): Remove this compat shim when network RPC API version'
nl|'\n'
comment|'# 1.0 is dropped.'
nl|'\n'
name|'if'
name|'not'
name|'isinstance'
...
op|':'
newline|'\n'
comment|'# NOTE(vish): I strongly suspect the v6 subnet is not used'
nl|'\n'
