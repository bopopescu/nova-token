...
nl|'\n'
comment|'#             security group refresh. This is somewhat ineffecient'
nl|'\n'
...
op|':'
newline|'\n'
comment|"# NOTE(russellb) This will get hit if we're tearing down an"
nl|'\n'
comment|'# instance before it finished getting created.  In that'
nl|'\n'
comment|'# case a vif may never have been associated with the'
nl|'\n'
comment|'# fixed_ip.'
nl|'\n'
indent|'                    '
