...
name|'msg'
op|'='
string|'"requested cidr (%s) conflicts with existing smaller"'
string|'" cidr"'
newline|'\n'
name|'raise'
name|'ValueError'
...
name|'msg'
op|'='
string|'"Not enough subnets avail to satisfy requested "'
string|'"num_net works - some subnets in requested range"'
...
op|')'
newline|'\n'
comment|'# after splitting ensure there were enough to satisfy the'
nl|'\n'
