...
op|')'
newline|'\n'
name|'floating_driver_zone_list'
op|'='
name|'self'
op|'.'
...
op|')'
newline|'\n'
name|'instance_driver_zone_list'
op|'='
name|'self'
op|'.'
...
nl|'\n'
string|"'changing zone to |%(zone)s|.'"
op|')'
op|','
nl|'\n'
op|'{'
...
newline|'\n'
nl|'\n'
comment|'# TODO(tr3buchet): return model'
nl|'\n'
name|'return'
name|'network_info'
newline|'\n'
...
newline|'\n'
indent|'        '
string|'"""Returns a NetworkInfo object containing all network information\n        for an instance"""'
newline|'\n'
name|'nw_info'
op|'='
name|'network_model'
...
newline|'\n'
nl|'\n'
comment|"# determine which of the instance's fixed IPs are on this network"
nl|'\n'
dedent|''
name|'network_IPs'
op|'='
...
newline|'\n'
nl|'\n'
comment|'# at this point nova networks can only have 2 subnets,'
nl|'\n'
comment|'# one for v4 and one for v6, all ips will belong to the v4 subnet'
nl|'\n'
comment|'# and the v6 subnet contains a single calculated v6 address'
nl|'\n'
dedent|''
dedent|''
name|'for'
...
op|':'
newline|'\n'
comment|'# since subnet currently has no IPs, easily add them all'
nl|'\n'
indent|'                    '
name|'subnet'
op|'['
...
newline|'\n'
indent|'        '
string|'"""Returns the dict representing necessary fields from network"""'
newline|'\n'
name|'network_dict'
op|'='
op|'{'
...
newline|'\n'
nl|'\n'
comment|'# get dns information from network'
nl|'\n'
name|'dns'
op|'='
op|'['
...
newline|'\n'
nl|'\n'
comment|'# if network contains v4 subnet'
nl|'\n'
dedent|''
name|'if'
name|'network'
...
op|')'
newline|'\n'
comment|'# if either dns address is v4, add it to subnet'
nl|'\n'
name|'for'
name|'ip'
name|'in'
...
newline|'\n'
nl|'\n'
comment|'# TODO(tr3buchet): add routes to subnet once it makes sense'
nl|'\n'
comment|'# create default route from gateway'
nl|'\n'
comment|"#route = network_model.Route(cidr=network['cidr'],"
nl|'\n'
comment|"#                             gateway=network['gateway'])"
nl|'\n'
comment|'#subnet.add_route(route)'
nl|'\n'
nl|'\n'
comment|'# store subnet for return'
nl|'\n'
dedent|''
dedent|''
name|'subnets'
...
newline|'\n'
nl|'\n'
comment|'# if network contains a v6 subnet'
nl|'\n'
dedent|''
name|'if'
name|'network'
...
op|')'
newline|'\n'
comment|'# if either dns address is v6, add it to subnet'
nl|'\n'
name|'for'
name|'entry'
name|'in'
...
comment|'# create default route from gateway'
nl|'\n'
comment|"#route = network_model.Route(cidr=network['cidr_v6'],"
nl|'\n'
comment|"#                             gateway=network['gateway_v6'])"
nl|'\n'
comment|'#subnet.add_route(route)'
nl|'\n'
nl|'\n'
