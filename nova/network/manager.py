...
indent|'            '
name|'print'
string|"'<<<<<< nova.network.manager.init_host <<<<'"
newline|'\n'
name|'print'
string|"'<<<<<< nova.network.manager.init_host (%s)<<<<'"
op|'%'
name|'network'
op|'['
string|"'id'"
...
newline|'\n'
name|'print'
string|"'<<<<<< nova.network.manager.set_network_host <<<<'"
newline|'\n'
name|'print'
string|"'<<<<<< nova.network.manager.set_network_host (%s)<<<<'"
op|'%'
name|'network_id'
newline|'\n'
name|'logging'
