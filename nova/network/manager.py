...
newline|'\n'
nl|'\n'
DECL|member|allocate_mac_addresses
dedent|''
name|'def'
name|'allocate_mac_addresses'
op|'('
name|'self'
op|','
name|'context'
...
op|':'
newline|'\n'
comment|'#TODO(tr3buchet) find the specific exception'
nl|'\n'
indent|'                    '
name|'mac_address'
op|'['
...
newline|'\n'
indent|'        '
string|'"""Gets a fixed ip from a host\'s pool."""'
newline|'\n'
...
op|')'
newline|'\n'
comment|'#        network_ref = self.db.network_get_by_bridge(context,'
nl|'\n'
comment|'#                                                    FLAGS.flat_network_bridge)'
nl|'\n'
name|'for'
name|'network'
name|'in'
...
nl|'\n'
nl|'\n'
comment|'#    def setup_new_instance(self, context, instance_id, host):'
nl|'\n'
comment|'#        """allocate the network config for a new instance on host"""'
nl|'\n'
comment|'#        for network in DB_NETWORKGETALLBYHOST():'
nl|'\n'
comment|'#            ip = self.allocate_fixed_ip(context, instance_id, network)'
nl|'\n'
nl|'\n'
nl|'\n'
