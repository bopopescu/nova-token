...
newline|'\n'
indent|'        '
string|'"""Do any initialization for a standalone service."""'
newline|'\n'
name|'self'
op|'.'
name|'driver'
...
name|'_'
op|'('
string|"'IP %(address)s leased to bad mac'"
nl|'\n'
string|"' %(inst_addr)s vs %(mac)s'"
op|')'
op|'%'
name|'locals'
op|'('
...
name|'_'
op|'('
string|"'IP %(address)s released from bad mac'"
nl|'\n'
string|"' %(inst_addr)s vs %(mac)s'"
op|')'
op|'%'
