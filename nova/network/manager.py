...
op|','
nl|'\n'
comment|'# TODO(mathrock): Deprecate in Grizzly, remove in Havana'
nl|'\n'
name|'cfg'
op|'.'
name|'StrOpt'
...
name|'help'
op|'='
string|"'DEPRECATED - Fixed IP address block.'"
nl|'\n'
string|"'If set to an empty string, the subnet range(s) will be '"
nl|'\n'
string|"'automatically determined and configured.'"
op|')'
op|','
nl|'\n'
name|'cfg'
