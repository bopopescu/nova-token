...
name|'msg'
op|'='
string|'"network_size * num_networks exceeds cidr size"'
newline|'\n'
name|'raise'
name|'ValueError'
op|'('
...
name|'msg'
op|'='
string|'"requested cidr (%s) conflicts with existing supernet"'
newline|'\n'
name|'raise'
name|'ValueError'
op|'('
...
op|')'
newline|'\n'
comment|'# watch for smaller subnets conflicting'
nl|'\n'
dedent|''
dedent|''
name|'used_supernets'
...
name|'msg'
op|'='
string|'"requested cidr (%s) conflicts with existing smaller cidr"'
newline|'\n'
name|'raise'
name|'ValueError'
op|'('
...
op|':'
newline|'\n'
comment|'# split supernet into subnets'
nl|'\n'
indent|'            '
name|'next_cidr'
op|'='
...
name|'msg'
op|'='
string|'"Not enough subnets avail to satisfy requested num_net"'
string|'"works - some subnets in requested range already in use"'
newline|'\n'
name|'raise'
name|'ValueError'
op|'('
...
op|')'
newline|'\n'
comment|'# after splitting ensure there were enough to satisfy the num_networks'
nl|'\n'
name|'if'
name|'len'
op|'('
...
name|'msg'
op|'='
string|'"Not enough subnets avail to satisfy requested num_networks"'
newline|'\n'
name|'raise'
name|'ValueError'
op|'('
