...
name|'help'
op|'='
string|"'Use per-port DHCP options with Neutron'"
op|')'
op|','
nl|'\n'
op|']'
...
op|')'
newline|'\n'
comment|'# NOTE(mriedem): OverQuota in neutron is a 409'
nl|'\n'
name|'if'
name|'e'
op|'.'
...
name|'_'
op|'('
string|'"Failed to delete port %s"'
op|')'
newline|'\n'
name|'LOG'
op|'.'
...
name|'_'
op|'('
string|'"Failed to delete neutron port %(portid)s"'
op|')'
nl|'\n'
op|'%'
op|'{'
...
name|'_'
op|'('
string|'"Failed to delete neutron port %s"'
op|')'
op|'%'
nl|'\n'
name|'port_id'
...
op|':'
newline|'\n'
comment|'# keep this caching-free version of the get_instance_nw_info method'
nl|'\n'
comment|'# because it is used by the caching logic itself.'
nl|'\n'
indent|'        '
name|'LOG'
op|'.'
...
op|':'
newline|'\n'
comment|'# Note(arosen): on interface-attach networks only contains the'
nl|'\n'
comment|'# network that the interface is being attached to.'
nl|'\n'
nl|'\n'
indent|'        '
name|'search_opts'
...
op|':'
newline|'\n'
comment|'# retrieve networks from info_cache to get correct nic order'
nl|'\n'
indent|'            '
name|'network_cache'
op|'='
...
newline|'\n'
nl|'\n'
comment|'# Unfortunately, this is sometimes in unicode and sometimes not'
nl|'\n'
indent|'            '
name|'if'
name|'isinstance'
...
nl|'\n'
comment|'# Needed when interfaces are added to existing instances.'
nl|'\n'
dedent|''
name|'for'
name|'iface'
