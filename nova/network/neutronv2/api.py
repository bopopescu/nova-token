...
newline|'\n'
nl|'\n'
DECL|variable|DEFAULT_SECGROUP
...
name|'ks_loading'
op|'.'
name|'load_auth_from_conf_options'
op|'('
name|'conf'
op|','
name|'NEUTRON_GROUP'
...
newline|'\n'
nl|'\n'
DECL|member|_clean_security_groups
dedent|''
name|'def'
name|'_clean_security_groups'
op|'('
name|'self'
op|','
...
op|':'
newline|'\n'
comment|'# If no networks were requested and none are available, consider'
nl|'\n'
comment|'# it a bad request.'
nl|'\n'
indent|'            '
name|'if'
name|'not'
...
op|':'
newline|'\n'
comment|"# Neutron can't apply security groups to a port"
nl|'\n'
comment|'# for a network without L3 assignements.'
nl|'\n'
indent|'                    '
name|'raise'
name|'exception'
...
op|':'
newline|'\n'
comment|"# We don't want to apply security groups on port"
nl|'\n'
comment|'# for a network defined with'
nl|'\n'
comment|"# 'port_security_enabled=False'."
nl|'\n'
indent|'                    '
name|'raise'
name|'exception'
...
name|'staticmethod'
newline|'\n'
DECL|member|_populate_mac_address
name|'def'
name|'_populate_mac_address'
op|'('
name|'instance'
...
newline|'\n'
indent|'        '
string|'"""Add the updated MAC address value to the update_port request body.\n\n        Currently this is done only for PF passthrough.\n        """'
newline|'\n'
name|'if'
name|'pci_request_id'
name|'is'
...
op|':'
newline|'\n'
comment|"# NOTE(ndipanov): We shouldn't ever get here since"
nl|'\n'
comment|'# InstancePCIRequest instances built from network requests'
nl|'\n'
comment|'# only ever index a single device, which needs to be'
nl|'\n'
comment|'# successfully claimed for this to be called as part of'
nl|'\n'
comment|'# allocate_networks method'
nl|'\n'
indent|'                '
name|'LOG'
op|'.'
...
name|'_LE'
op|'('
string|'"PCI request %s does not have a "'
nl|'\n'
string|'"unique device associated with it. Unable to "'
nl|'\n'
string|'"determine MAC address"'
op|')'
op|','
nl|'\n'
name|'pci_request'
...
name|'_LE'
op|'('
string|'"Could not determine MAC address for %(addr)s, "'
nl|'\n'
string|'"error: %(e)s"'
op|')'
op|','
