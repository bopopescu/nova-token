...
op|','
nl|'\n'
comment|'# deprecated in Kilo, may be removed in Mitaka'
nl|'\n'
comment|'# NOTE(mikal): we could have removed in Liberty, but we forgot to set'
nl|'\n'
comment|'# deprecated_for_removal for this flag so no warnings were emitted.'
nl|'\n'
name|'cfg'
op|'.'
name|'StrOpt'
...
nl|'\n'
string|"'DEPRECATED: specify an auth_plugin and appropriate '"
nl|'\n'
string|"'credentials instead.'"
op|')'
op|','
nl|'\n'
comment|'# deprecated in Kilo, may be removed in Mitaka'
...
nl|'\n'
string|"'context. DEPRECATED: specify an auth_plugin and '"
nl|'\n'
string|"'appropriate credentials instead.'"
op|')'
op|','
nl|'\n'
comment|'# deprecated in Kilo, may be removed in Mitaka'
...
name|'help'
op|'='
string|"'Authorization strategy for connecting to neutron in '"
nl|'\n'
string|"'admin context. DEPRECATED: specify an auth_plugin and '"
nl|'\n'
string|"'appropriate credentials instead. If an auth_plugin is '"
nl|'\n'
string|"'specified strategy will be ignored.'"
op|')'
op|','
nl|'\n'
...
name|'_'
op|'('
string|'\'For "noauth" authentication strategy, the \''
nl|'\n'
string|"'endpoint must be specified conf.neutron.url'"
op|')'
newline|'\n'
name|'raise'
name|'neutron_client_exc'
...
newline|'\n'
nl|'\n'
comment|"# NOTE(jamielennox): This will actually send 'noauth' as the token"
nl|'\n'
comment|"# value because the plugin requires you to send something. It doesn't"
nl|'\n'
comment|'# matter as it will be ignored anyway.'
nl|'\n'
dedent|''
name|'return'
name|'token_endpoint'
...
name|'_'
op|'('
string|"'Unknown auth strategy: %s'"
op|')'
op|'%'
name|'conf'
op|'.'
...
newline|'\n'
indent|'        '
string|'"""Get floatingip gracefully handling 404 from Neutron."""'
newline|'\n'
name|'try'
op|':'
newline|'\n'
...
newline|'\n'
nl|'\n'
comment|'# In that case we should repopulate ports from the state of'
nl|'\n'
comment|'# Neutron.'
nl|'\n'
dedent|''
