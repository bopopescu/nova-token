...
name|'_'
op|'('
string|'"Using neutron_admin_tenant_name for authentication "'
nl|'\n'
string|'"is deprecated and will be removed in the next "'
nl|'\n'
string|'"release.  Use neutron_admin_tenant_id instead."'
op|')'
op|')'
newline|'\n'
dedent|''
