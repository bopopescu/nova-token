...
string|"'Address |%(address)s| is not allocated '"
nl|'\n'
string|"'to your project |%(project)s|'"
op|')'
op|','
nl|'\n'
op|'{'
...
newline|'\n'
nl|'\n'
DECL|member|_floating_ip_pool_exists
dedent|''
dedent|''
dedent|''
name|'def'
...
newline|'\n'
indent|'        '
string|'"""Returns true if the specified floating IP pool exists. Otherwise,\n        returns false.\n        """'
newline|'\n'
name|'pools'
op|'='
op|'['
...
op|')'
newline|'\n'
comment|'# number of updated rows will be 0 if concurrently another'
nl|'\n'
...
nl|'\n'
string|'"belongs to instance %(instance_uuid)s. "'
nl|'\n'
string|'"Will not migrate it "'
op|')'
op|','
nl|'\n'
op|'{'
...
nl|'\n'
string|"'either the floating or instance DNS driver. '"
nl|'\n'
