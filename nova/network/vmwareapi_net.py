...
name|'_'
op|'('
string|'"There is no physical network adapter with the name"'
nl|'\n'
string|'" %s on the ESX host"'
op|')'
op|'%'
name|'vlan_interface'
op|')'
...
name|'_'
op|'('
string|'"There is no virtual switch associated with "'
nl|'\n'
string|'"the physical network adapter with name %s"'
op|')'
op|'%'
nl|'\n'
name|'vlan_interface'
...
name|'_'
op|'('
string|'"VLAN tag is not appropriate for the port "'
nl|'\n'
string|'"group %(bridge)s. Expected VLAN tag is "'
nl|'\n'
