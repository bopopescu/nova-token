...
name|'refresh_cache'
newline|'\n'
DECL|variable|_update_instance_cache
name|'_update_instance_cache'
op|'='
name|'shiny_api'
op|'.'
name|'update_instance_cache_with_nw_info'
newline|'\n'
DECL|variable|update_instance_cache_with_nw_info
name|'update_instance_cache_with_nw_info'
op|'='
name|'_update_instance_cache'
newline|'\n'
...
newline|'\n'
nl|'\n'
comment|'# NOTE(jkoelker) These functions where added to the api after'
nl|'\n'
comment|'#                deprecation. Stubs provided for support documentation'
nl|'\n'
