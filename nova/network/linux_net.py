...
name|'_confirm_rule'
op|'('
string|'"-t nat -A nova_prerouting -s 0.0.0.0/0 "'
nl|'\n'
...
name|'_confirm_rule'
op|'('
string|'"-t nat -A nova_postrouting -s %s "'
nl|'\n'
...
name|'_confirm_rule'
op|'('
string|'"-A nova_postrouting -s %s MASQUERADE"'
op|'%'
name|'FLAGS'
op|'.'
name|'private_range'
...
name|'_confirm_rule'
op|'('
string|'"-A nova_postrouting -s %(range)s -d %(range)s"'
op|'%'
op|'{'
string|"'range'"
op|':'
...
name|'_confirm_rule'
op|'('
string|'"nova_forward -d %s -p udp --dport 1194 -j ACCEPT"'
op|'%'
name|'private_ip'
op|')'
newline|'\n'
...
op|'('
nl|'\n'
string|'"nova_prerouting -t nat -d %s -p udp --dport %s -j DNAT --to %s:1194"'
nl|'\n'
op|'%'
op|'('
name|'public_ip'
...
name|'_confirm_rule'
op|'('
string|'"nova_prerouting -t nat -d %s -j DNAT --to %s"'
nl|'\n'
op|'%'
op|'('
name|'floating_ip'
...
name|'_confirm_rule'
op|'('
string|'"nova_postrouting -t nat -s %s -j SNAT --to %s"'
nl|'\n'
op|'%'
op|'('
name|'fixed_ip'
...
name|'_confirm_rule'
op|'('
string|'"nova_forward -d %s -p icmp -j ACCEPT"'
nl|'\n'
op|'%'
op|'('
name|'fixed_ip'
...
op|'('
nl|'\n'
string|'"nova_forward -d %s -p %s --dport %s -j ACCEPT"'
nl|'\n'
op|'%'
op|'('
name|'fixed_ip'
...
name|'_confirm_rule'
op|'('
string|'"nova_forward --in-interface %s -j ACCEPT"'
op|'%'
name|'bridge'
op|')'
newline|'\n'
