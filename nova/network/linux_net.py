...
nl|'\n'
nl|'\n'
comment|'# NOTE(cfb): This is a temporary fix to LP #1316621. We really want to call'
nl|'\n'
comment|'#            ebtables with --concurrent. In order to do that though we need'
nl|'\n'
comment|'#            libvirt to support this. Additionally since ebtables --concurrent'
nl|'\n'
comment|'#            will hang indefinitely waiting on the lock we need to teach'
nl|'\n'
comment|'#            oslo_concurrency.processutils how to timeout a long running'
nl|'\n'
comment|'#            process first. Once those are complete we can replace all of this'
nl|'\n'
comment|'#            with calls to ebtables --concurrent and a reasonable timeout.'
nl|'\n'
