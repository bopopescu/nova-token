...
op|':'
newline|'\n'
comment|'# NOTE(vish): If the gateway already exists we are fine'
nl|'\n'
indent|'            '
name|'out'
op|','
...
name|'Error'
op|'('
string|'"Failed to reset gateway: %s"'
op|'%'
name|'err'
op|')'
newline|'\n'
...
newline|'\n'
indent|'    '
string|'"""Get a string containing a network\'s hosts config in dhcp-host format"""'
newline|'\n'
name|'hosts'
op|'='
op|'['
