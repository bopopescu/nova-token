...
name|'_'
op|'('
string|'"Error clearing stale veth %s"'
op|')'
op|'%'
name|'dev'
op|')'
...
newline|'\n'
string|'""" for for all Linux interface drivers."""'
newline|'\n'
nl|'\n'
DECL|member|plug
name|'def'
...
newline|'\n'
indent|'        '
string|'"""Destory Linux device, return device name"""'
newline|'\n'
name|'raise'
name|'NotImplementedError'
op|'('
...
name|'_'
op|'('
string|'"Failed unplugging VLAN interface \'%s\'"'
op|')'
op|','
nl|'\n'
name|'vlan_interface'
...
name|'_'
op|'('
string|'"Unplugged VLAN interface \'%s\'"'
op|')'
op|','
name|'vlan_interface'
op|')'
...
name|'_'
op|'('
string|'"Failed unplugging bridge interface \'%s\'"'
op|')'
op|','
name|'bridge'
op|')'
...
name|'_'
op|'('
string|'"Unplugged bridge interface \'%s\'"'
op|')'
op|','
name|'bridge'
op|')'
...
op|':'
newline|'\n'
comment|'# block arp traffic to address accross the interface'
nl|'\n'
indent|'    '
name|'rules'
op|'='
...
op|')'
newline|'\n'
comment|'# block ip traffic to address accross the interface'
nl|'\n'
name|'ipv4_filter'
op|'.'
name|'add_rule'
...
op|','
nl|'\n'
string|"'-m physdev --physdev-in %s -d %s -j DROP'"
nl|'\n'
op|'%'
op|'('
name|'interface'
...
op|','
nl|'\n'
string|"'-m physdev --physdev-out %s -s %s -j DROP'"
nl|'\n'
op|'%'
op|'('
name|'interface'
...
name|'_'
op|'('
string|'"Failed unplugging gateway interface \'%s\'"'
op|')'
op|','
name|'dev'
op|')'
...
name|'_'
op|'('
string|'"Unplugged gateway interface \'%s\'"'
op|')'
op|','
name|'dev'
op|')'
