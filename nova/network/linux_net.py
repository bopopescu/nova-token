...
op|':'
newline|'\n'
comment|"# NOTE(vish): if we don't give an ip to the bridge, we set up a route"
nl|'\n'
...
name|'_execute'
op|'('
string|'"sudo route add -net %s dev %s"'
op|'%'
nl|'\n'
op|'('
name|'net_attrs'
...
name|'_execute'
op|'('
string|'"sudo route add default gw %s"'
op|'%'
name|'gateway'
op|')'
newline|'\n'
