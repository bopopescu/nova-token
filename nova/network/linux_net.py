...
newline|'\n'
indent|'    '
string|'"""A class for handling large collections of IPs efficiently"""'
newline|'\n'
nl|'\n'
DECL|member|__init__
name|'def'
...
newline|'\n'
nl|'\n'
DECL|member|iptables_source_match
dedent|''
name|'def'
