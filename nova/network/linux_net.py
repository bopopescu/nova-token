...
newline|'\n'
nl|'\n'
comment|'# We add a SNATTING chain after our (wrapped) POSTROUTING chain'
nl|'\n'
comment|'# so that rules added there will be applied after whatever we have in'
nl|'\n'
comment|'# (the wrapped) POSTROUTING.'
nl|'\n'
dedent|''
dedent|''
dedent|''
