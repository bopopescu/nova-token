...
nl|'\n'
string|'" %(chain)r %(rule)r %(wrap)r %(head)r"'
op|')'
op|','
nl|'\n'
op|'{'
...
newline|'\n'
nl|'\n'
comment|'# We add a SNATTING chain to the shared nova-postrouting-bottom chain'
nl|'\n'
...
newline|'\n'
nl|'\n'
comment|'# And then we add a floating-ip-snat chain and jump to first thing in'
nl|'\n'
comment|'# the SNATTING chain.'
nl|'\n'
name|'self'
op|'.'
name|'ipv4'
