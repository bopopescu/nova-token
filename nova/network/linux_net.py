...
newline|'\n'
comment|'# create a decision dictionary for default gateway for eache instance'
nl|'\n'
name|'default_gateway_network_node'
op|'='
name|'dict'
op|'('
op|')'
...
op|']'
newline|'\n'
comment|'# nic number is decided by \x8f\x87\x94\xd4 from this function in xxx function'
nl|'\n'
name|'vifs'
op|'='
name|'db'
...
name|'continue'
newline|'\n'
comment|'# offer a default gateway to the first virtual interface of instance'
nl|'\n'
dedent|''
name|'first_vif'
op|'='
...
op|','
nl|'\n'
string|'"external-ids:iface-id=nova-%s"'
op|'%'
name|'dev'
op|','
nl|'\n'
