...
newline|'\n'
indent|'        '
string|'"""Datastore key where hosts are stored"""'
newline|'\n'
name|'return'
...
newline|'\n'
indent|'        '
string|'"""Returns a hash of all hosts allocated in this network"""'
newline|'\n'
name|'return'
name|'datastore'
op|'.'
...
newline|'\n'
indent|'        '
string|'"""Returns a list of all assigned keys"""'
newline|'\n'
name|'return'
name|'datastore'
op|'.'
...
newline|'\n'
indent|'        '
string|'"""List all allocated addresses"""'
newline|'\n'
name|'for'
name|'address'
name|'in'
...
newline|'\n'
indent|'        '
string|'"""Creates a PublicAddress object"""'
newline|'\n'
name|'addr'
op|'='
name|'cls'
...
newline|'\n'
indent|'        '
string|'"""Returns assigned addresses as PublicAddress objects"""'
newline|'\n'
name|'for'
name|'address'
name|'in'
...
newline|'\n'
indent|'        '
string|'"""Returns a specific public ip as PublicAddress object"""'
newline|'\n'
name|'if'
name|'public_ip'
name|'in'
...
newline|'\n'
comment|'# TODO(vish): This is completely the wrong way to do this, but'
nl|'\n'
comment|"#             I'm getting the network binary working before I"
nl|'\n'
comment|'#             tackle doing this the right way.'
nl|'\n'
name|'logging'
op|'.'
name|'debug'
