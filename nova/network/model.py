...
newline|'\n'
nl|'\n'
comment|'# NOTE(vish): address states allocated, leased, deallocated'
nl|'\n'
...
newline|'\n'
indent|'        '
string|'"""Creates an FixedIp object"""'
newline|'\n'
name|'addr'
op|'='
name|'cls'
...
newline|'\n'
nl|'\n'
DECL|member|_create_assigned_set
dedent|''
name|'def'
name|'_create_assigned_set'
op|'('
