...
newline|'\n'
nl|'\n'
comment|"# Constant for max length of 'bridge' in Network class"
nl|'\n'
comment|'# Chosen to match max Linux NIC name length'
nl|'\n'
DECL|variable|BRIDGE_NAME_LEN
name|'BRIDGE_NAME_LEN'
op|'='
number|'14'
newline|'\n'
nl|'\n'
