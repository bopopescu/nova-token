...
op|'='
op|'('
string|'\'{"vendor_id": "8086", "address": "*: *: *.6",\''
op|'+'
nl|'\n'
string|'\'"product_id": "5057", "physical_network": "hr_net"}\''
op|')'
newline|'\n'
name|'pci'
op|'='
...
op|'='
op|'('
string|'\'{"address": "0000:0a:0b:00.5", \''
op|'+'
nl|'\n'
string|'\'"physical_network": "hr_net"}\''
op|')'
newline|'\n'
name|'self'
op|'.'
...
name|'pci_info'
op|'='
string|'\'{"address": "0000:h4.12:6", "physical_network": "hr_net"}\''
newline|'\n'
name|'self'
op|'.'
name|'assertRaises'
...
op|'='
op|'('
string|'\'{"address": "%x:0a:00.5", "physical_network":"hr_net"}\''
nl|'\n'
op|'%'
op|'('
name|'devspec'
...
op|'='
op|'('
string|'\'{"address": "0000:%x:00.5", "physical_network":"hr_net"}\''
nl|'\n'
op|'%'
op|'('
name|'devspec'
...
op|'='
op|'('
string|'\'{"address": "0000:0a:%x.5", "physical_network":"hr_net"}\''
nl|'\n'
op|'%'
op|'('
name|'devspec'
...
name|'pci_info'
op|'='
string|'\'{"vendor_id":"8086", "product_id":"5057"}\''
newline|'\n'
name|'pci'
op|'='
name|'devspec'
...
name|'pci_info'
op|'='
string|'\'{"address":":0a:00.", "physical_network":"hr_net"}\''
newline|'\n'
name|'pci'
op|'='
name|'devspec'
...
name|'pci_info'
op|'='
string|'\'{"address":"0000:0a:00.0", "physical_network":"hr_net"}\''
newline|'\n'
name|'pci'
op|'='
name|'devspec'
...
op|'='
op|'('
string|'\'{"vendor_id": "8086","address": "*: *: *.5",\''
op|'+'
nl|'\n'
string|'\'"product_id": "5057", "physical_network": "hr_net"}\''
op|')'
...
op|'='
op|'('
string|'\'{"vendor_id": "8087","address": "*: *: *.5", \''
op|'+'
nl|'\n'
string|'\'"product_id": "5057", "physical_network": "hr_net"}\''
op|')'
...
op|'='
op|'('
string|'\'{"vendor_id": "80860", "address": "*:*:*.5", \''
op|'+'
nl|'\n'
string|'\'"product_id": "5057", "physical_network": "hr_net"}\''
op|')'
...
op|'+'
nl|'\n'
string|'\'"product_id": "5056", "physical_network": "hr_net"}\''
op|')'
newline|'\n'
name|'pci'
op|'='
...
op|'+'
nl|'\n'
string|'\'"product_id": "50570", "physical_network": "hr_net"}\''
op|')'
newline|'\n'
name|'exc'
op|'='
...
op|'='
op|'('
string|'\'{"devname": "eth0", "vendor_id":"8086", \''
op|'+'
nl|'\n'
string|'\'"address":"*:*:*.5", "physical_network": "hr_net"}\''
op|')'
newline|'\n'
name|'self'
op|'.'
...
name|'pci_info'
op|'='
string|'\'{"devname": "eth0", "physical_network": "hr_net"}\''
newline|'\n'
name|'pci'
op|'='
name|'devspec'
...
name|'pci_info'
op|'='
string|'\'{"devname": "lo", "physical_network": "hr_net"}\''
newline|'\n'
name|'exc'
op|'='
name|'self'
