...
op|':'
newline|'\n'
comment|'# note(krtaylor): File creation problems with tests in'
nl|'\n'
comment|'# venv using .pgpass authentication, changed to'
nl|'\n'
comment|'# PGPASSWORD environment variable which is no longer'
nl|'\n'
comment|'# planned to be deprecated'
nl|'\n'
indent|'                '
op|'('
name|'user'
