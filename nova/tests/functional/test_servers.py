...
name|'stub_out'
op|'('
string|"'nova.virt.fake.FakeDriver.spawn'"
op|','
name|'throw_error'
op|')'
newline|'\n'
...
nl|'\n'
nl|'\n'
DECL|class|ServersTestV219
dedent|''
name|'class'
name|'ServersTestV219'
op|'('
name|'ServersTestBase'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|_rebuild_server
dedent|''
name|'def'
name|'_rebuild_server'
op|'('
name|'self'
op|','
name|'server_id'
...
newline|'\n'
nl|'\n'
DECL|member|_create_server_and_verify
dedent|''
name|'def'
name|'_create_server_and_verify'
op|'('
name|'self'
op|','
name|'set_desc'
...
op|':'
newline|'\n'
comment|'# Creates a server with a description and verifies it is'
nl|'\n'
comment|'# in the GET responses.'
nl|'\n'
indent|'        '
name|'created_server_id'
op|'='
...
name|'self'
op|'.'
name|'_verify_server_description'
op|'('
name|'created_server_id'
op|','
name|'expected_desc'
...
newline|'\n'
nl|'\n'
DECL|member|_update_server_and_verify
dedent|''
name|'def'
name|'_update_server_and_verify'
op|'('
name|'self'
op|','
name|'server_id'
...
op|':'
newline|'\n'
comment|'# Updates a server with a description and verifies it is'
nl|'\n'
comment|'# in the GET responses.'
nl|'\n'
indent|'        '
...
newline|'\n'
nl|'\n'
DECL|member|_rebuild_server_and_verify
dedent|''
name|'def'
name|'_rebuild_server_and_verify'
op|'('
name|'self'
op|','
name|'server_id'
...
op|':'
newline|'\n'
comment|'# Rebuilds a server with a description and verifies it is'
nl|'\n'
comment|'# in the GET responses.'
nl|'\n'
indent|'        '
...
newline|'\n'
nl|'\n'
DECL|member|_verify_server_description
dedent|''
name|'def'
name|'_verify_server_description'
op|'('
...
op|':'
newline|'\n'
comment|'# Calls GET on the servers and verifies that the description'
nl|'\n'
comment|'# is set as expected in the response, or not set at all.'
nl|'\n'
indent|'        '
name|'response'
op|'='
...
op|':'
newline|'\n'
comment|'# Verify the description is set as expected (can be None)'
nl|'\n'
indent|'            '
name|'self'
op|'.'
...
op|':'
newline|'\n'
comment|'# Verify the description is not included in the response.'
nl|'\n'
indent|'            '
name|'self'
op|'.'
...
newline|'\n'
nl|'\n'
DECL|member|_create_assertRaisesRegex
dedent|''
dedent|''
name|'def'
name|'_create_assertRaisesRegex'
op|'('
name|'self'
op|','
name|'desc'
...
op|':'
newline|'\n'
comment|'# Verifies that a 400 error is thrown on create server'
nl|'\n'
indent|'        '
name|'with'
name|'self'
...
newline|'\n'
nl|'\n'
DECL|member|_update_assertRaisesRegex
dedent|''
name|'def'
name|'_update_assertRaisesRegex'
op|'('
name|'self'
op|','
name|'server_id'
...
op|':'
newline|'\n'
comment|'# Verifies that a 400 error is thrown on update server'
nl|'\n'
indent|'        '
name|'with'
name|'self'
...
newline|'\n'
nl|'\n'
DECL|member|_rebuild_assertRaisesRegex
dedent|''
name|'def'
name|'_rebuild_assertRaisesRegex'
op|'('
name|'self'
op|','
name|'server_id'
...
op|':'
newline|'\n'
comment|'# Verifies that a 400 error is thrown on rebuild server'
nl|'\n'
indent|'        '
name|'with'
name|'self'
...
newline|'\n'
nl|'\n'
DECL|member|test_create_server_with_description
dedent|''
name|'def'
name|'test_create_server_with_description'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
comment|'# Create and get a server with a description'
nl|'\n'
name|'self'
op|'.'
name|'_create_server_and_verify'
...
op|')'
newline|'\n'
comment|'# Create and get a server with an empty description'
nl|'\n'
name|'self'
op|'.'
name|'_create_server_and_verify'
...
op|')'
newline|'\n'
comment|'# Create and get a server with description set to None'
nl|'\n'
name|'self'
op|'.'
name|'_create_server_and_verify'
...
op|')'
newline|'\n'
comment|'# Create and get a server without setting the description'
nl|'\n'
name|'self'
op|'.'
name|'_create_server_and_verify'
...
newline|'\n'
nl|'\n'
DECL|member|test_update_server_with_description
dedent|''
name|'def'
name|'test_update_server_with_description'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
comment|'# Create a server with an initial description'
nl|'\n'
name|'server_id'
op|'='
name|'self'
...
newline|'\n'
nl|'\n'
comment|'# Update and get the server with a description'
nl|'\n'
name|'self'
op|'.'
name|'_update_server_and_verify'
...
op|')'
newline|'\n'
comment|'# Update and get the server name without changing the description'
nl|'\n'
name|'self'
op|'.'
name|'_update_server_and_verify'
...
op|')'
newline|'\n'
comment|'# Update and get the server with an empty description'
nl|'\n'
name|'self'
op|'.'
name|'_update_server_and_verify'
...
op|')'
newline|'\n'
comment|'# Update and get the server by removing the description (set to None)'
nl|'\n'
name|'self'
op|'.'
name|'_update_server_and_verify'
...
op|')'
newline|'\n'
comment|'# Update and get the server with a 2nd new description'
nl|'\n'
name|'self'
op|'.'
name|'_update_server_and_verify'
...
newline|'\n'
nl|'\n'
DECL|member|test_rebuild_server_with_description
dedent|''
name|'def'
name|'test_rebuild_server_with_description'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
comment|'# Rebuild and get the server with a description'
nl|'\n'
name|'self'
op|'.'
name|'_rebuild_server_and_verify'
...
op|')'
newline|'\n'
comment|'# Rebuild and get the server name without changing the description'
nl|'\n'
name|'self'
op|'.'
name|'_rebuild_server_and_verify'
...
op|')'
newline|'\n'
comment|'# Rebuild and get the server with an empty description'
nl|'\n'
name|'self'
op|'.'
name|'_rebuild_server_and_verify'
...
op|')'
newline|'\n'
comment|'# Rebuild and get the server by removing the description (set to None)'
nl|'\n'
name|'self'
op|'.'
name|'_rebuild_server_and_verify'
...
op|')'
newline|'\n'
comment|'# Rebuild and get the server with a 2nd new description'
nl|'\n'
name|'self'
op|'.'
name|'_rebuild_server_and_verify'
...
newline|'\n'
nl|'\n'
DECL|member|test_version_compatibility
dedent|''
name|'def'
name|'test_version_compatibility'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
comment|'# Create a server with microversion v2.19 and a description.'
nl|'\n'
name|'self'
op|'.'
name|'_headers'
...
op|']'
newline|'\n'
comment|'# Verify that the description is not included on V2.18 GETs'
nl|'\n'
name|'self'
op|'.'
name|'_headers'
...
op|')'
newline|'\n'
comment|'# Verify that updating the server with description on V2.18'
nl|'\n'
comment|'# results in a 400 error'
nl|'\n'
name|'self'
op|'.'
name|'_update_assertRaisesRegex'
...
name|'server_id'
op|','
string|"'test update 2.18'"
op|')'
newline|'\n'
comment|'# Verify that rebuilding the server with description on V2.18'
nl|'\n'
comment|'# results in a 400 error'
nl|'\n'
name|'self'
...
newline|'\n'
nl|'\n'
comment|'# Create a server on V2.18 and verify that the description'
nl|'\n'
comment|'# defaults to the name on a V2.19 GET'
nl|'\n'
name|'self'
op|'.'
name|'_headers'
...
newline|'\n'
nl|'\n'
comment|'# Verify that creating a server with description on V2.18'
nl|'\n'
comment|'# results in a 400 error'
nl|'\n'
name|'self'
...
name|'_create_assertRaisesRegex'
op|'('
string|"'test create 2.18'"
op|')'
newline|'\n'
nl|'\n'
DECL|member|test_description_errors
dedent|''
name|'def'
name|'test_description_errors'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
comment|'# Create servers with invalid descriptions.  These throw 400.'
nl|'\n'
comment|'# Invalid unicode with non-printable control char'
nl|'\n'
name|'self'
op|'.'
name|'_create_assertRaisesRegex'
op|'('
string|"u'invalid\\0dstring'"
op|')'
newline|'\n'
comment|'# Description is longer than 255 chars'
nl|'\n'
name|'self'
op|'.'
name|'_create_assertRaisesRegex'
...
newline|'\n'
nl|'\n'
comment|'# Update and rebuild servers with invalid descriptions.'
nl|'\n'
comment|'# These throw 400.'
nl|'\n'
name|'server_id'
op|'='
name|'self'
