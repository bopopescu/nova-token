...
nl|'\n'
op|'('
string|"'API DB Migration %i does not have a '"
nl|'\n'
...
newline|'\n'
nl|'\n'
comment|'# Ensure the foreign key still exists'
nl|'\n'
name|'inspector'
op|'='
name|'reflection'
