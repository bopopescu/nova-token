...
nl|'\n'
nl|'\n'
DECL|class|FlavorAccessTestsBase
name|'class'
name|'FlavorAccessTestsBase'
op|'('
name|'api_sample_base'
op|'.'
...
nl|'\n'
nl|'\n'
DECL|class|FlavorAccessV27SampleJsonTests
dedent|''
dedent|''
name|'class'
name|'FlavorAccessV27SampleJsonTests'
op|'('
name|'FlavorAccessTestsBase'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_add_tenant_access_to_public_flavor
dedent|''
name|'def'
name|'test_add_tenant_access_to_public_flavor'
op|'('
name|'self'
op|')'
op|':'
...
op|'}'
newline|'\n'
comment|'# Version 2.7+ will return HTTPConflict (409)'
nl|'\n'
comment|'# if the flavor is public'
nl|'\n'
name|'response'
op|'='
name|'self'
