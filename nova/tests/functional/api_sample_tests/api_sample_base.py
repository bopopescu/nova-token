...
nl|'\n'
comment|'# will be used. As of now it is being used for server POST request'
nl|'\n'
comment|'# to avoid duplicate copy of server req and resp sample files.'
nl|'\n'
comment|"# Example - ServersSampleBase's _post_server method."
nl|'\n'
dedent|''
name|'elif'
name|'cls'
