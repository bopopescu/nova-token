...
op|'('
nl|'\n'
string|"'nova.api.openstack.compute.contrib.extended_server_attributes.'"
nl|'\n'
...
nl|'\n'
nl|'\n'
DECL|class|ExtendedServerAttributesJsonTestV216
dedent|''
dedent|''
name|'class'
name|'ExtendedServerAttributesJsonTestV216'
op|'('
name|'ExtendedServerAttributesJsonTest'
op|')'
op|':'
