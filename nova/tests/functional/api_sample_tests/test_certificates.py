...
op|'('
nl|'\n'
string|"'nova.api.openstack.compute.contrib.certificates.Certificates'"
op|')'
newline|'\n'
name|'return'
name|'f'
...
name|'stub_out'
op|'('
string|"'nova.crypto.ensure_ca_filesystem'"
op|','
nl|'\n'
name|'fake_crypto'
op|'.'
...
name|'stub_out'
op|'('
string|"'nova.crypto.generate_x509_cert'"
op|','
nl|'\n'
name|'fake_crypto'
op|'.'
