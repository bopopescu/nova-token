...
string|'"nova.api.openstack.compute.legacy_v2.contrib."'
nl|'\n'
string|'"used_limits.Used_limits"'
op|')'
newline|'\n'
nl|'\n'
...
op|'='
op|'('
string|'"nova.api.openstack.compute.legacy_v2.contrib.used_limits."'
nl|'\n'
string|'"Used_limits"'
op|')'
newline|'\n'
...
op|'('
nl|'\n'
string|'"nova.api.openstack.compute.legacy_v2.contrib.used_limits_for_admin."'
nl|'\n'
...
op|'('
nl|'\n'
string|"'nova.api.openstack.compute.legacy_v2.contrib.volumes.Volumes'"
op|')'
newline|'\n'
name|'return'
name|'f'
