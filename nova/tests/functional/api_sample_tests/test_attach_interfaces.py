...
name|'stub_out'
op|'('
string|"'nova.network.api.API.list_ports'"
op|','
name|'fake_list_ports'
op|')'
newline|'\n'
...
name|'stub_out'
op|'('
string|"'nova.network.api.API.show_port'"
op|','
name|'fake_show_port'
op|')'
newline|'\n'
...
name|'stub_out'
op|'('
string|"'nova.compute.api.API.attach_interface'"
op|','
nl|'\n'
name|'fake_attach_interface'
op|')'
...
name|'stub_out'
op|'('
string|"'nova.compute.api.API.detach_interface'"
op|','
nl|'\n'
name|'fake_detach_interface'
op|')'
