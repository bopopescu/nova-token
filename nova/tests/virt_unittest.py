...
op|')'
newline|'\n'
comment|'# Those are XenAPI related'
nl|'\n'
name|'flags'
op|'.'
name|'DECLARE'
...
newline|'\n'
nl|'\n'
DECL|member|test_create_iscsi_storage_raise_unable_to_create_sr_exception
dedent|''
name|'def'
name|'test_create_iscsi_storage_raise_unable_to_create_sr_exception'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_find_sr_from_vbd_raise_no_exception
dedent|''
name|'def'
name|'test_find_sr_from_vbd_raise_no_exception'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_destroy_iscsi_storage
dedent|''
name|'def'
name|'test_destroy_iscsi_storage'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_introduce_vdi_raise_no_exception
dedent|''
name|'def'
name|'test_introduce_vdi_raise_no_exception'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_introduce_vdi_raise_unable_get_vdi_record_exception
dedent|''
name|'def'
name|'test_introduce_vdi_raise_unable_get_vdi_record_exception'
op|'('
name|'self'
op|')'
op|':'
