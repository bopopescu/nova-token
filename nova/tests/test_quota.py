...
newline|'\n'
nl|'\n'
DECL|member|test_allowed_file_injection_files
dedent|''
name|'def'
name|'test_allowed_file_injection_files'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_allowed_file_injection_file_bytes
dedent|''
name|'def'
name|'test_allowed_file_injection_file_bytes'
op|'('
name|'self'
op|')'
op|':'
