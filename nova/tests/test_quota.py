...
newline|'\n'
nl|'\n'
DECL|member|destroy_all_by_user
dedent|''
name|'def'
name|'destroy_all_by_user'
op|'('
name|'self'
op|','
name|'context'
...
newline|'\n'
nl|'\n'
DECL|member|test_destroy_all_by_user
dedent|''
name|'def'
name|'test_destroy_all_by_user'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|_stub_get_by_user
dedent|''
name|'def'
name|'_stub_get_by_user'
op|'('
name|'self'
op|')'
op|':'
...
name|'append'
op|'('
string|"'quota_usage_get_all_by_user'"
op|')'
newline|'\n'
name|'self'
op|'.'
...
newline|'\n'
nl|'\n'
DECL|member|_stub_get_user_quotas
dedent|''
name|'def'
name|'_stub_get_user_quotas'
op|'('
name|'self'
op|')'
op|':'
