...
op|':'
newline|'\n'
comment|'# wrap the session object to see which stats get updated'
nl|'\n'
indent|'            '
name|'orig_add'
op|'='
...
newline|'\n'
nl|'\n'
comment|'# no stats should have been added to the session:'
nl|'\n'
name|'self'
op|'.'
name|'assertEqual'
...
name|'sqlalchemy_api'
op|','
string|"'_update_stats'"
op|','
name|'update'
op|')'
newline|'\n'
nl|'\n'
comment|'# save with same (unchanged) stats again:'
nl|'\n'
name|'values'
op|'='
op|'{'
