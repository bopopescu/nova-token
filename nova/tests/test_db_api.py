...
newline|'\n'
nl|'\n'
DECL|member|test_instance_fault_get_by_instance_first_fault
dedent|''
name|'def'
name|'test_instance_fault_get_by_instance_first_fault'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
indent|'        '
string|'"""Instance_fault_get_by_instance should return the latest fault """'
newline|'\n'
name|'ctxt'
op|'='
name|'context'
