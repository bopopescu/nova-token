...
op|':'
newline|'\n'
comment|'# Ensure _extra_specs are returned from _instance_update.'
nl|'\n'
indent|'        '
name|'ctxt'
op|'='
...
nl|'\n'
nl|'\n'
DECL|class|TestFixedIPGetByNetworkHost
dedent|''
dedent|''
dedent|''
name|'class'
name|'TestFixedIPGetByNetworkHost'
op|'('
name|'test'
op|'.'
name|'TestCase'
...
op|':'
newline|'\n'
DECL|member|test_not_found_exception
indent|'    '
name|'def'
...
newline|'\n'
nl|'\n'
DECL|member|test_fixed_ip_found
dedent|''
name|'def'
name|'test_fixed_ip_found'
op|'('
name|'self'
op|')'
op|':'
