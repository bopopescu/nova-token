...
name|'_'
op|'('
string|'"does not exist or is not a "'
nl|'\n'
string|'"compute node."'
op|')'
op|')'
...
nl|'\n'
nl|'\n'
DECL|function|fake_openstack_init
dedent|''
name|'def'
name|'fake_openstack_init'
op|'('
name|'self'
op|','
name|'username'
