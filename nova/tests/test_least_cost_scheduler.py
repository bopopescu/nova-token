...
op|')'
newline|'\n'
comment|'#self.old_flag = FLAGS.default_host_filter_driver'
nl|'\n'
comment|'#FLAGS.default_host_filter_driver = \\'
nl|'\n'
comment|"#                    'nova.scheduler.host_filter.AllHostsFilter'"
nl|'\n'
name|'self'
op|'.'
name|'instance_type'
...
op|':'
newline|'\n'
comment|'#FLAGS.default_host_filter_driver = self.old_flag'
nl|'\n'
indent|'        '
name|'super'
op|'('
