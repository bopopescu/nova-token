...
newline|'\n'
nl|'\n'
DECL|member|test_all_new_migrations_have_downgrade
dedent|''
name|'def'
name|'test_all_new_migrations_have_downgrade'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
comment|'# NOTE(sirp): These migrations are old enough so that a downgrade'
nl|'\n'
comment|"# isn't a hard requirement. Would be nice to have, in these cases,"
nl|'\n'
comment|'# though, too.'
nl|'\n'
indent|'        '
