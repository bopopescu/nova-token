...
newline|'\n'
nl|'\n'
DECL|member|test_compute_can_update_available_resource
dedent|''
name|'def'
name|'test_compute_can_update_available_resource'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
indent|'        '
string|'"""Confirm compute updates their record of compute-service table."""'
newline|'\n'
name|'host'
op|'='
string|"'foo'"
...
newline|'\n'
nl|'\n'
comment|'# Any mocks are not working without UnsetStubs() here.'
nl|'\n'
name|'self'
op|'.'
name|'mox'
...
newline|'\n'
nl|'\n'
comment|'# This testcase want to test calling update_available_resource.'
nl|'\n'
comment|'# No need to call periodic call, then below variable must be set 0.'
nl|'\n'
name|'serv'
op|'.'
...
newline|'\n'
nl|'\n'
comment|'# Just doing start()-stop(), not confirm new db record is created,'
nl|'\n'
comment|'# because update_available_resource() works only in'
nl|'\n'
comment|'# libvirt environment. This testcase confirms'
nl|'\n'
comment|'# update_available_resource() is called. Otherwise, mox complains.'
nl|'\n'
name|'self'
op|'.'
name|'mox'
