...
nl|'\n'
comment|'# because update_available_resource() works only in libvirt environment.'
nl|'\n'
comment|'# This testcase confirms update_available_resource() is called.'
nl|'\n'
comment|'# Otherwise, mox complains.'
nl|'\n'
name|'self'
op|'.'
name|'mox'
