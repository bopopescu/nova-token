...
newline|'\n'
nl|'\n'
comment|'# temporary variable to store host/binary/self.mox'
nl|'\n'
comment|'# from each method to fake class.'
nl|'\n'
DECL|variable|global_host
dedent|''
dedent|''
name|'global_host'
op|'='
name|'None'
newline|'\n'
DECL|variable|global_binary
name|'global_binary'
op|'='
name|'None'
newline|'\n'
DECL|variable|global_mox
name|'global_mox'
op|'='
name|'None'
newline|'\n'
...
newline|'\n'
indent|'    '
string|'"""Fake computemanager manager for tests"""'
newline|'\n'
nl|'\n'
...
op|','
nl|'\n'
string|"'nova.tests.test_service.FakeComputeManager'"
op|')'
newline|'\n'
comment|'# ReplayAll has been executed FakeComputeManager.__init__()'
nl|'\n'
