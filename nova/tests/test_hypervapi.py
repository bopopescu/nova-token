...
name|'_volume_id'
op|'='
string|"'d3f99512-af51-4a75-aee1-79875e016159'"
newline|'\n'
name|'self'
op|'.'
name|'_context'
...
newline|'\n'
nl|'\n'
comment|'# NOTE (rmk): Resume now takes 3 mandatory args. These tests need to'
nl|'\n'
comment|'# be updated but cannot be without involvement from the maintainers'
nl|'\n'
comment|'# of the HyperV driver/tests.'
nl|'\n'
...
newline|'\n'
nl|'\n'
comment|'# NOTE: (rmk): See comment for test_resume().'
nl|'\n'
