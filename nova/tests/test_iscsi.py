...
op|'['
nl|'\n'
string|'"/usr/sbin/tgt-admin --conf ./blaa --update blaa"'
op|','
nl|'\n'
string|'"tgtadm --op show --lld=iscsi --mode=target --tid=1"'
op|','
nl|'\n'
string|'"/usr/bin/tgt-admin --conf ./blaa --delete blaa"'
op|']'
op|')'
newline|'\n'
nl|'\n'
...
op|','
nl|'\n'
string|'"ietadm --op new --tid=%(tid)s --lun=%(lun)s "'
nl|'\n'
