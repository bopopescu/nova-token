...
newline|'\n'
nl|'\n'
DECL|member|test_dhcp_lease_output
dedent|''
name|'def'
name|'test_dhcp_lease_output'
op|'('
name|'self'
op|')'
op|':'
...
op|')'
newline|'\n'
comment|'# This will throw an exception if the octet is invalid'
nl|'\n'
name|'int'
op|'('
name|'octet'
...
newline|'\n'
nl|'\n'
comment|'# And this will raise an exception in case of an invalid IP'
nl|'\n'
dedent|''
name|'IPy'
op|'.'
