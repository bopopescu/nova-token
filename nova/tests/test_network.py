...
nl|'\n'
comment|'# not use this file except in compliance with the License. You may obtain # a copy of the License at'
nl|'\n'
comment|'#'
nl|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|get_instance_ids_by_ip_regex
dedent|''
name|'def'
name|'get_instance_ids_by_ip_regex'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|get_instance_ids_by_ipv6_regex
dedent|''
name|'def'
name|'get_instance_ids_by_ipv6_regex'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|get_instance_ids_by_ip
dedent|''
name|'def'
name|'get_instance_ids_by_ip'
op|'('
name|'self'
op|')'
op|':'
