...
name|'db'
op|','
string|"'network_get_requested_networks'"
op|')'
newline|'\n'
name|'self'
op|'.'
...
name|'db'
op|','
string|'"fixed_ip_validate_by_network_address"'
op|')'
newline|'\n'
nl|'\n'
...
name|'db'
op|'.'
name|'network_get_requested_networks'
op|'('
name|'mox'
op|'.'
name|'IgnoreArg'
...
name|'db'
op|'.'
name|'fixed_ip_validate_by_network_address'
op|'('
name|'mox'
op|'.'
name|'IgnoreArg'
...
name|'db'
op|','
string|"'fixed_ip_associate_by_address'"
op|')'
newline|'\n'
name|'self'
op|'.'
...
name|'db'
op|'.'
name|'fixed_ip_associate_by_address'
op|'('
name|'mox'
op|'.'
name|'IgnoreArg'
