...
newline|'\n'
nl|'\n'
DECL|function|fake_show_avail
dedent|''
name|'def'
name|'fake_show_avail'
op|'('
name|'meh'
op|','
name|'context'
...
name|'run_instances'
newline|'\n'
comment|"# when image doesn't have 'image_state' attr at all"
nl|'\n'
name|'self'
op|'.'
name|'assertRaises'
...
op|')'
newline|'\n'
comment|"# when image has 'image_state' yet not 'available'"
nl|'\n'
name|'self'
op|'.'
name|'stubs'
...
op|')'
newline|'\n'
comment|'# when image has valid image_state'
nl|'\n'
name|'self'
op|'.'
name|'stubs'
