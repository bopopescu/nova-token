...
newline|'\n'
nl|'\n'
DECL|member|test_revoke_security_group_ingress_by_id
dedent|''
name|'def'
name|'test_revoke_security_group_ingress_by_id'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_authorize_security_group_ingress_by_id
dedent|''
name|'def'
name|'test_authorize_security_group_ingress_by_id'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_rescue_unrescue_instance
dedent|''
name|'def'
name|'test_rescue_unrescue_instance'
op|'('
name|'self'
op|')'
op|':'
...
op|')'
newline|'\n'
comment|'# NOTE(vish): This currently does no validation, it simply makes sure'
nl|'\n'
comment|"#             that the code path doesn't throw an exception."
nl|'\n'
name|'self'
op|'.'
name|'cloud'
