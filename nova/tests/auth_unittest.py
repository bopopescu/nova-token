...
newline|'\n'
nl|'\n'
comment|'# TODO(todd): Have a test class that tests just the AuthManager functions'
nl|'\n'
comment|'#             and different test classes for User and Project wrappers'
nl|'\n'
...
op|')'
newline|'\n'
comment|'# NOTE(todd): have to reload after the add_to_project'
nl|'\n'
name|'project'
op|'='
name|'self'
...
op|')'
newline|'\n'
comment|'# NOTE(todd): have to reload after the membership modifications'
nl|'\n'
name|'project'
op|'='
name|'self'
