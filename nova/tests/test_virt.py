...
newline|'\n'
nl|'\n'
DECL|member|_nwfilterLookupByName
dedent|''
name|'def'
name|'_nwfilterLookupByName'
op|'('
name|'self'
op|','
name|'ignore'
...
newline|'\n'
nl|'\n'
DECL|member|_filterDefineXMLMock
dedent|''
name|'def'
...
newline|'\n'
nl|'\n'
DECL|member|multinic_iptables_test
dedent|''
name|'def'
name|'multinic_iptables_test'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
comment|'# should attempt to undefine just the instance filter'
nl|'\n'
name|'self'
op|'.'
name|'assertEquals'
...
newline|'\n'
nl|'\n'
comment|'# should attempt to undefine 2 filters: instance and instance-secgroup'
nl|'\n'
name|'self'
op|'.'
name|'assertEquals'
