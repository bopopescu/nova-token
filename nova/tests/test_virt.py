...
op|':'
newline|'\n'
comment|'# keep from changing state of actual firewall'
nl|'\n'
comment|'#def fake_function(*args, **kwargs):'
nl|'\n'
comment|'#    pass'
nl|'\n'
comment|'#self.fw.iptables.apply = fake_function'
nl|'\n'
comment|'#self.fw.nwfilter.setup_basic_filtering = fake_function'
nl|'\n'
nl|'\n'
