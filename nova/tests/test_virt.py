...
newline|'\n'
nl|'\n'
DECL|member|libvirt_dependant_setup
name|'def'
name|'libvirt_dependant_setup'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
indent|'        '
string|'"""A setup method of LibvirtConnection dependent test."""'
newline|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|libvirt_dependant_teardown
dedent|''
name|'def'
name|'libvirt_dependant_teardown'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
indent|'        '
string|'"""teardown method of LibvirtConnection dependent test."""'
newline|'\n'
name|'if'
name|'self'
op|'.'
...
op|')'
newline|'\n'
comment|'# vcpu_used is checked at test_get_vcpu_used.'
nl|'\n'
name|'c4'
op|'='
op|'('
...
name|'msg'
op|'='
string|"'Cannot update compute manager specific info'"
newline|'\n'
name|'c1'
op|'='
op|'('
...
op|')'
newline|'\n'
comment|'# Nothing to do with setting post_method/recover_method or not.'
nl|'\n'
name|'ret'
op|'='
name|'conn'
