...
name|'skip_test'
op|'('
string|'"Please review this test to ensure intent"'
op|')'
newline|'\n'
...
op|')'
newline|'\n'
comment|"# Re-get the instance so it's bound to an actual session"
nl|'\n'
name|'instance_ref'
op|'='
name|'db'
...
newline|'\n'
nl|'\n'
comment|"#network_ref = db.project_get_networks(self.context, 'fake')[0]"
nl|'\n'
comment|"#fixed_ip = {'address': ip, 'network_id': network_ref['id']}"
nl|'\n'
nl|'\n'
comment|'#admin_ctxt = context.get_admin_context()'
nl|'\n'
comment|'#db.fixed_ip_create(admin_ctxt, fixed_ip)'
nl|'\n'
comment|"#db.fixed_ip_update(admin_ctxt, ip, {'allocated': True,"
nl|'\n'
comment|"#                                    'instance_id': inst_id})"
nl|'\n'
nl|'\n'
name|'self'
op|'.'
