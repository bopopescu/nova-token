...
name|'skip_test'
op|'('
string|'"This isn\'t testing anything"'
op|')'
newline|'\n'
...
newline|'\n'
nl|'\n'
comment|'# NOTE(jkoelker): This just takes the first network and runs with it'
nl|'\n'
comment|'#                 Should probably do something more inteligent'
nl|'\n'
name|'networks_ref'
op|'='
name|'db'
