...
newline|'\n'
indent|'        '
string|'"""Attempt to terminate an invalid instance"""'
newline|'\n'
name|'self'
op|'.'
name|'expect_http'
...
name|'fail'
op|'('
string|'"Unexpected EC2ResponseError: %s "'
nl|'\n'
string|'"(expected KeyPairExists)"'
op|'%'
name|'e'
op|'.'
name|'code'
...
newline|'\n'
nl|'\n'
comment|'# Test block group_name of non alphanumeric characters, spaces,'
nl|'\n'
comment|'# dashes, and underscores.'
nl|'\n'
name|'security_group_name'
op|'='
string|'"aa #^% -=99"'
...
op|')'
newline|'\n'
comment|'# For icmp, only -1:-1 is allowed for type:code'
nl|'\n'
name|'self'
op|'.'
name|'assertRaises'
...
newline|'\n'
nl|'\n'
comment|'# Can not delete the group while it is still used by'
nl|'\n'
