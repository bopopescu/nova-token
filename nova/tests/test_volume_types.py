...
newline|'\n'
nl|'\n'
DECL|member|test_volume_type_create_then_purge
dedent|''
name|'def'
name|'test_volume_type_create_then_purge'
op|'('
name|'self'
op|')'
op|':'
...
op|','
nl|'\n'
string|"'drive type was incorrectly deleted'"
op|')'
newline|'\n'
nl|'\n'
name|'volume_types'
...
op|','
nl|'\n'
string|"'drive type was not purged'"
op|')'
newline|'\n'
nl|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|test_repeated_vol_types_should_raise_api_error
dedent|''
name|'def'
name|'test_repeated_vol_types_should_raise_api_error'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
indent|'        '
string|'"""Ensures that volume duplicates raises ApiError"""'
newline|'\n'
name|'new_name'
op|'='
name|'self'
