...
op|')'
newline|'\n'
comment|"# NOTE(johannes): logging can't be used reliably from a thread"
nl|'\n'
comment|"# since it can deadlock with eventlet. It's safe for our faked"
nl|'\n'
comment|'# sessions to be called synchronously in the unit tests. (see'
nl|'\n'
comment|'# bug 946687)'
nl|'\n'
name|'stubs'
...
nl|'\n'
nl|'\n'
DECL|function|stubout_image_service_get
dedent|''
name|'def'
name|'stubout_image_service_get'
op|'('
name|'stubs'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|function|_fake_fetch_image_glance_disk
name|'def'
name|'_fake_fetch_image_glance_disk'
op|'('
name|'context'
op|','
name|'session'
