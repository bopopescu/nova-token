...
newline|'\n'
nl|'\n'
comment|'# old line was only to set a network to a project'
nl|'\n'
comment|'# this line is from the middle of the new functionality and makes no'
nl|'\n'
comment|'# sense to call this way, but it makes the tests work'
nl|'\n'
name|'self'
op|'.'
name|'network'
