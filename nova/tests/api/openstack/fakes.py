...
nl|'\n'
nl|'\n'
comment|'# TODO(jaypipes): Remove this when stub_out_glance() is removed after'
nl|'\n'
comment|'# image metadata pieces are fixed to call nova.image.API instead of the'
nl|'\n'
comment|'# nova.image.glance module directly.'
nl|'\n'
