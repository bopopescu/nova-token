...
name|'api_v3'
newline|'\n'
comment|'# TODO(cyeoh): bp nova-api-core-as-extensions'
nl|'\n'
comment|'# Still need to implement versions for v3 API'
nl|'\n'
comment|"#    mapper['/'] = openstack_api.FaultWrapper(versions.Versions())"
nl|'\n'
name|'return'
name|'mapper'
newline|'\n'
