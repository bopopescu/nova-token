...
nl|'\n'
nl|'\n'
comment|"#self.assertEqual(media_types.tag.split('}')[1], 'media-types')"
nl|'\n'
comment|'#for i, media_node in enumerate(media_type_nodes):'
nl|'\n'
comment|"#self.assertEqual(media_node.tag.split('}')[1], 'media-type')"
nl|'\n'
comment|"#for key, val in version_data['version']['media-types'][i].items():"
nl|'\n'
comment|'#self.assertEqual(val, media_node.get(key))'
nl|'\n'
nl|'\n'
