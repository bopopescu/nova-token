...
newline|'\n'
nl|'\n'
DECL|member|test_post_request_extension_with_stub_mgr
dedent|''
name|'def'
name|'test_post_request_extension_with_stub_mgr'
op|'('
name|'self'
op|')'
op|':'
...
name|'blank'
op|'('
string|'"/v1.1/flavors/1?test_param=foo"'
op|')'
newline|'\n'
name|'request'
op|'.'
