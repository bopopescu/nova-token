...
newline|'\n'
nl|'\n'
DECL|member|test_get_uuid_from_href
dedent|''
name|'def'
name|'test_get_uuid_from_href'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_uuid_from_href_bad_request
dedent|''
name|'def'
name|'test_get_uuid_from_href_bad_request'
op|'('
name|'self'
op|')'
op|':'
