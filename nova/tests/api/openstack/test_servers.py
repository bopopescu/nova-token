...
op|']'
newline|'\n'
comment|'# RM(4047): Figure otu what is up with the 1.1 api and multi-nic'
nl|'\n'
comment|'#self.assertEqual(len(addresses["public"]), len(public))'
nl|'\n'
comment|'#self.assertEqual(addresses["public"][0],'
nl|'\n'
comment|'#    {"version": 4, "addr": public[0]})'
nl|'\n'
comment|'#self.assertEqual(len(addresses["private"]), 1)'
nl|'\n'
comment|'#self.assertEqual(addresses["private"][0],'
nl|'\n'
comment|'#    {"version": 4, "addr": private})'
nl|'\n'
nl|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|test_create_instance_v1_1_image_id
dedent|''
name|'def'
name|'test_create_instance_v1_1_image_id'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_create_instance_v1_1_image_link
dedent|''
name|'def'
name|'test_create_instance_v1_1_image_link'
op|'('
name|'self'
op|')'
op|':'
...
name|'image_ref'
op|'='
string|"'http://localhost/v1.1/image/3'"
newline|'\n'
name|'body'
op|'='
op|'{'
...
newline|'\n'
nl|'\n'
DECL|member|test_create_instance_v1_1_no_valid_image
dedent|''
name|'def'
name|'test_create_instance_v1_1_no_valid_image'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_create_instance_v1_1_flavor_link
dedent|''
name|'def'
name|'test_create_instance_v1_1_flavor_link'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_create_instance_v1_1_flavor_id
dedent|''
name|'def'
name|'test_create_instance_v1_1_flavor_id'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_create_instance_v1_1_no_valid_flavor
dedent|''
name|'def'
name|'test_create_instance_v1_1_no_valid_flavor'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
indent|'        '
name|'image_self_link'
op|'='
string|'"http://servers.api.openstack.org/v1.1/1234/"'
op|'+'
...
string|'"id"'
op|':'
string|'"52415800-8b69-11e0-9b19-734f6f006e54"'
op|','
nl|'\n'
string|'"links"'
op|':'
...
string|'"href"'
op|':'
string|'"http://servers.api.openstack.org/"'
op|'+'
string|'"v1.1/1234/images/52415800-8b69-11"'
op|'+'
string|'"e0-9b19-734f6f006e54"'
op|','
nl|'\n'
op|'}'
op|','
...
string|'"http://servers.api.openstack.org/"'
op|'+'
string|'"1234/images/52415800-8b69-11e0-9b"'
op|'+'
string|'"19-734f6f006e54"'
op|','
nl|'\n'
op|'}'
op|','
