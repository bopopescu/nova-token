...
nl|'\n'
nl|'\n'
DECL|function|return_server_with_attributes_by_uuid
dedent|''
name|'def'
name|'return_server_with_attributes_by_uuid'
op|'('
op|'**'
name|'kwargs'
op|')'
...
nl|'\n'
nl|'\n'
DECL|function|create_fixed_ips
dedent|''
name|'def'
name|'create_fixed_ips'
op|'('
name|'project_id'
op|','
name|'publics'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_server_by_id_malformed_vif
dedent|''
name|'def'
name|'test_get_server_by_id_malformed_vif'
op|'('
name|'self'
op|')'
op|':'
...
op|':'
newline|'\n'
comment|'# ipv6 flag is off by default'
nl|'\n'
indent|'        '
name|'privates'
op|'='
...
name|'blank'
op|'('
string|"'/v1.1/fake/servers/%s/ips'"
op|'%'
name|'FAKE_UUID'
op|')'
newline|'\n'
...
name|'url'
op|'='
string|"'/v1.1/fake/servers/%s/ips/public'"
op|'%'
name|'FAKE_UUID'
newline|'\n'
name|'req'
...
name|'url'
op|'='
string|"'/v1.1/fake/servers/%s/ips/network_0'"
op|'%'
name|'FAKE_UUID'
newline|'\n'
name|'req'
...
name|'blank'
op|'('
string|"'/v1.1/fake/servers?limit=asdf'"
op|')'
newline|'\n'
name|'self'
op|'.'
...
name|'url'
op|'='
string|"'/v1.1/fake/servers?marker=%s'"
op|'%'
name|'get_fake_uuid'
op|'('
number|'2'
...
name|'url'
op|'='
string|"'/v1.1/fake/servers?limit=2&marker=%s'"
op|'%'
name|'get_fake_uuid'
op|'('
number|'1'
...
name|'blank'
op|'('
string|"'/v1.1/fake/servers?tenant_id=fake'"
op|','
nl|'\n'
...
name|'blank'
op|'('
string|"'/v1.1/fake/servers?status=unknown'"
op|')'
newline|'\n'
name|'self'
op|'.'
...
name|'image_href'
op|'='
string|"'http://localhost/v1.1/fake/images/2'"
newline|'\n'
name|'flavor_ref'
op|'='
