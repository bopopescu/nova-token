...
op|':'
newline|'\n'
comment|'# part one: stubs it to be locked and test pause'
nl|'\n'
...
newline|'\n'
nl|'\n'
comment|'# set get to return locked'
nl|'\n'
dedent|''
name|'self'
op|'.'
...
newline|'\n'
nl|'\n'
comment|'# expect a 404 since it was locked'
nl|'\n'
name|'self'
op|'.'
name|'assertEqual'
...
newline|'\n'
nl|'\n'
comment|'# Part two: stubs it to be unlocked and test pause'
nl|'\n'
...
newline|'\n'
nl|'\n'
comment|'# expect a 202 since it was unlocked'
nl|'\n'
name|'self'
op|'.'
name|'assertEqual'
