...
newline|'\n'
nl|'\n'
comment|'# part one: stubs it to be locked and attempt pause expecting exception'
nl|'\n'
DECL|function|get_locked
name|'def'
name|'get_locked'
op|'('
name|'self'
...
newline|'\n'
nl|'\n'
comment|'# pause should raise exception on locked instance'
nl|'\n'
name|'self'
op|'.'
name|'assertRaises'
...
newline|'\n'
nl|'\n'
comment|'# Part two: stubs it to be unlocked and attempt pause expecting success'
nl|'\n'
DECL|function|get_unlocked
name|'def'
name|'get_unlocked'
op|'('
name|'self'
...
newline|'\n'
nl|'\n'
comment|'# expecting no exception, test will fail if exception is raised'
nl|'\n'
name|'res'
op|'='
name|'req'
