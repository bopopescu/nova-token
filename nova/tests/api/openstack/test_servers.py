...
newline|'\n'
nl|'\n'
DECL|member|test_update_server_description_v1_1
dedent|''
name|'def'
name|'test_update_server_description_v1_1'
op|'('
name|'self'
op|')'
op|':'
...
op|':'
newline|'\n'
comment|'# assert that parameter conversion from description'
nl|'\n'
comment|'# to display_description worked correctly'
nl|'\n'
indent|'            '
name|'self'
op|'.'
