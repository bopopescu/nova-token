...
op|'('
nl|'\n'
string|'"unknown options \'unknownoption\'"'
op|')'
op|'>'
op|'-'
number|'1'
...
op|'('
nl|'\n'
string|'"unknown options \'instance_name\'"'
op|')'
op|'>'
op|'-'
number|'1'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_servers_allows_instance_name3_v1_1
dedent|''
name|'def'
name|'test_get_servers_allows_instance_name3_v1_1'
op|'('
name|'self'
op|')'
op|':'
...
op|')'
newline|'\n'
comment|"#self.assertEqual(1, server['id'])"
nl|'\n'
nl|'\n'
...
nl|'\n'
nl|'\n'
DECL|class|TextAddressesXMLSerialization
dedent|''
dedent|''
name|'class'
name|'TextAddressesXMLSerialization'
op|'('
name|'test'
op|'.'
name|'TestCase'
