...
op|','
nl|'\n'
comment|'#"accessIPv4" : "67.23.10.132",'
nl|'\n'
comment|'#"accessIPv6" : "::babe:67.23.10.132",'
nl|'\n'
string|'"image"'
op|':'
op|'{'
...
nl|'\n'
nl|'\n'
DECL|class|ServersTestv1_1
dedent|''
dedent|''
name|'class'
name|'ServersTestv1_1'
op|'('
name|'test'
op|'.'
name|'TestCase'
...
name|'self'
op|'.'
name|'_stub_instance_v1_1'
op|'('
op|')'
newline|'\n'
nl|'\n'
DECL|member|_stub_instance_v1_1
dedent|''
name|'def'
name|'_stub_instance_v1_1'
op|'('
