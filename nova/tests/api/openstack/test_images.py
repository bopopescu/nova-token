...
newline|'\n'
nl|'\n'
DECL|member|test_create_propertified_images_with_instance_id
dedent|''
name|'def'
name|'test_create_propertified_images_with_instance_id'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
comment|'#image_metas = self.service.detail(self.context)'
nl|'\n'
comment|'#self.assertDictMatch(image_metas[0], expected)'
nl|'\n'
nl|'\n'
DECL|member|test_create_propertified_images_without_instance_id
dedent|''
name|'def'
name|'test_create_propertified_images_without_instance_id'
op|'('
name|'self'
op|')'
op|':'
