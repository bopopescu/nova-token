...
newline|'\n'
nl|'\n'
DECL|member|test_get_image_v1_1_xml
dedent|''
name|'def'
name|'test_get_image_v1_1_xml'
op|'('
name|'self'
op|')'
op|':'
...
string|"'serverRef'"
op|':'
string|'"http://localhost:8774/v1.1/servers/42"'
op|','
nl|'\n'
string|"'updated'"
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_create_image_v1_1_xml_serialization
dedent|''
name|'def'
name|'test_create_image_v1_1_xml_serialization'
op|'('
name|'self'
op|')'
op|':'
