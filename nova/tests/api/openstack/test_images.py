...
name|'href'
op|'='
string|'"http://localhost/v1.1/images/124"'
newline|'\n'
name|'bookmark'
op|'='
string|'"http://localhost/images/124"'
newline|'\n'
name|'server_href'
op|'='
...
string|'"href"'
op|':'
string|'"http://localhost/images/123"'
op|','
nl|'\n'
op|'}'
op|']'
...
string|'"href"'
op|':'
string|'"http://localhost/v1.1/images/125"'
op|','
nl|'\n'
op|'}'
op|','
...
string|'"href"'
op|':'
string|'"http://localhost/images/125"'
op|','
nl|'\n'
op|'}'
op|']'
...
string|'"href"'
op|':'
string|'"http://localhost/v1.1/images/126"'
op|','
nl|'\n'
op|'}'
op|','
...
string|'"href"'
op|':'
string|'"http://localhost/images/126"'
op|','
nl|'\n'
op|'}'
op|']'
...
string|'"href"'
op|':'
string|'"http://localhost/v1.1/images/127"'
op|','
nl|'\n'
op|'}'
op|','
...
string|'"href"'
op|':'
string|'"http://localhost/images/127"'
op|','
nl|'\n'
op|'}'
op|']'
...
string|'"href"'
op|':'
string|'"http://localhost/v1.1/images/129"'
op|','
nl|'\n'
op|'}'
op|','
...
string|'"href"'
op|':'
string|'"http://localhost/images/129"'
op|','
nl|'\n'
op|'}'
op|']'
...
name|'blank'
op|'('
string|"'/v1.1/images/detail?name=testname'"
op|')'
newline|'\n'
name|'request'
op|'.'
...
name|'blank'
op|'('
string|"'/v1.1/images/detail?status=ACTIVE'"
op|')'
newline|'\n'
name|'request'
op|'.'
...
name|'blank'
op|'('
string|"'/v1.1/images/detail?property-test=3'"
op|')'
newline|'\n'
name|'request'
op|'.'
...
name|'blank'
op|'('
string|"'/v1.1/images/detail?server='"
nl|'\n'
string|"'http://localhost:8774/servers/12'"
op|')'
newline|'\n'
...
name|'blank'
op|'('
string|"'/v1.1/images/detail?changes-since='"
nl|'\n'
string|"'2011-01-24T17:08Z'"
op|')'
newline|'\n'
...
name|'blank'
op|'('
string|"'/v1.1/images/detail?type=BASE'"
op|')'
newline|'\n'
name|'request'
op|'.'
...
newline|'\n'
indent|'        '
string|'"""Name is also required for backups"""'
newline|'\n'
name|'body'
op|'='
name|'dict'
...
newline|'\n'
nl|'\n'
DECL|member|test_create_backup_with_rotation_and_backup_type
dedent|''
name|'def'
name|'test_create_backup_with_rotation_and_backup_type'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
comment|'# FIXME(sirp): teardown needed?'
nl|'\n'
name|'FLAGS'
op|'.'
...
newline|'\n'
nl|'\n'
comment|'# FIXME(sirp): should the fact that backups are admin_only be a FLAG'
nl|'\n'
name|'body'
op|'='
name|'dict'
...
newline|'\n'
nl|'\n'
DECL|member|test_create_image_with_invalid_image_type
dedent|''
name|'def'
name|'test_create_image_with_invalid_image_type'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
indent|'        '
string|'"""Valid image_types are snapshot | daily | weekly"""'
newline|'\n'
comment|'# FIXME(sirp): teardown needed?'
nl|'\n'
name|'FLAGS'
...
newline|'\n'
nl|'\n'
DECL|member|test_create_image_v1_1_actual_server_ref
dedent|''
name|'def'
name|'test_create_image_v1_1_actual_server_ref'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_create_image_v1_1_actual_server_ref_port
dedent|''
name|'def'
name|'test_create_image_v1_1_actual_server_ref_port'
op|'('
name|'self'
op|')'
op|':'
...
name|'serverRef'
op|'='
string|"'http://localhost:8774/v1.1/servers/1'"
newline|'\n'
name|'serverBookmark'
op|'='
string|"'http://localhost:8774/servers/1'"
newline|'\n'
name|'body'
op|'='
name|'dict'
...
newline|'\n'
nl|'\n'
DECL|member|test_create_image_v1_1_server_ref_bad_hostname
dedent|''
name|'def'
name|'test_create_image_v1_1_server_ref_bad_hostname'
op|'('
name|'self'
op|')'
op|':'
...
name|'serverRef'
op|'='
string|"'http://asdf/v1.1/servers/1'"
newline|'\n'
name|'body'
op|'='
name|'dict'
...
newline|'\n'
nl|'\n'
DECL|member|test_create_image_v1_1_no_server_ref
dedent|''
name|'def'
name|'test_create_image_v1_1_no_server_ref'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_create_image_v1_1_server_ref_missing_version
dedent|''
name|'def'
name|'test_create_image_v1_1_server_ref_missing_version'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_create_image_v1_1_server_ref_missing_id
dedent|''
name|'def'
name|'test_create_image_v1_1_server_ref_missing_id'
op|'('
name|'self'
op|')'
op|':'
