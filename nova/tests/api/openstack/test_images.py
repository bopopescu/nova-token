...
newline|'\n'
nl|'\n'
DECL|member|test_get_image_request_filters
dedent|''
name|'def'
name|'test_get_image_request_filters'
op|'('
name|'self'
op|')'
op|':'
...
op|'('
nl|'\n'
string|"'/v1.1/images/detail?status=ACTIVE&name=testname&property-test=3'"
op|')'
newline|'\n'
name|'request'
op|'.'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_image_request_filters_not_supported
dedent|''
name|'def'
name|'test_get_image_request_filters_not_supported'
op|'('
name|'self'
op|')'
op|':'
