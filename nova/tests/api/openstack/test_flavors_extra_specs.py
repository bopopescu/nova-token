...
nl|'\n'
nl|'\n'
DECL|function|return_create_flavor_extra_specs_max
name|'def'
name|'return_create_flavor_extra_specs_max'
op|'('
name|'context'
op|','
name|'flavor_id'
...
indent|'    '
name|'return'
name|'stub_max_flavor_extra_specs'
op|'('
op|')'
newline|'\n'
nl|'\n'
...
newline|'\n'
nl|'\n'
DECL|function|stub_max_flavor_extra_specs
dedent|''
name|'def'
name|'stub_max_flavor_extra_specs'
op|'('
...
name|'blank'
op|'('
string|"'/v1.1/flavors/1/extra/key5'"
op|')'
newline|'\n'
name|'req'
op|'.'
...
op|','
nl|'\n'
name|'return_empty_flavor_metadata'
op|')'
newline|'\n'
name|'req'
op|'='
...
name|'blank'
op|'('
string|"'/v1.1/flavors/1/extra/key6'"
op|')'
newline|'\n'
name|'req'
op|'.'
...
op|','
nl|'\n'
name|'return_create_instance_type_extra_specs'
op|')'
newline|'\n'
name|'req'
op|'='
...
name|'blank'
op|'('
string|"'/v1.1/flavors/1/extra/key1'"
op|')'
newline|'\n'
name|'req'
op|'.'
...
name|'blank'
op|'('
string|"'/v1.1/flavors/1/extra/bad'"
op|')'
newline|'\n'
name|'req'
op|'.'
...
op|','
nl|'\n'
name|'return_create_instance_type_extra_specs_max'
op|')'
newline|'\n'
name|'req'
op|'='
