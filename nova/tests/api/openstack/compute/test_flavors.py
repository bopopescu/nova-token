...
newline|'\n'
indent|'        '
string|'"""Ensure you cannot list flavors with invalid minRam param."""'
newline|'\n'
name|'req'
op|'='
name|'fakes'
...
newline|'\n'
indent|'        '
string|'"""Flavor lists may be filtered by minDisk."""'
newline|'\n'
name|'req'
op|'='
name|'fakes'
...
newline|'\n'
indent|'        '
string|'"""Ensure you cannot list flavors with invalid minDisk param."""'
newline|'\n'
name|'req'
op|'='
name|'fakes'
...
newline|'\n'
nl|'\n'
comment|'# Add a new disabled type to the list of instance_types/flavors'
nl|'\n'
name|'self'
op|'.'
name|'req'
