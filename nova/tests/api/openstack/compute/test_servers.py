...
newline|'\n'
nl|'\n'
DECL|member|test_get_server_with_volumes_attached
dedent|''
name|'def'
name|'test_get_server_with_volumes_attached'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_build_server_detail_with_volumes_attached
dedent|''
name|'def'
name|'test_build_server_detail_with_volumes_attached'
op|'('
name|'self'
op|')'
op|':'
