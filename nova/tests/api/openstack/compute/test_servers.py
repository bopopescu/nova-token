...
newline|'\n'
nl|'\n'
DECL|member|test_get_server_no_image
dedent|''
name|'def'
name|'test_get_server_no_image'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|function|fake_add_image_ref
dedent|''
name|'def'
name|'fake_add_image_ref'
op|'('
name|'context'
op|','
name|'instance'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_servers_no_image
dedent|''
dedent|''
name|'def'
name|'test_get_servers_no_image'
op|'('
name|'self'
op|')'
op|':'
...
op|')'
newline|'\n'
comment|"# Delete request can be ignored, because it's been accepted and"
nl|'\n'
comment|'# forwarded to the compute service already.'
nl|'\n'
name|'self'
op|'.'
name|'assertFalse'
...
newline|'\n'
indent|'    '
string|'"""Tests of places we throw 422 Unprocessable Entity from."""'
newline|'\n'
nl|'\n'
DECL|member|setUp
name|'def'
