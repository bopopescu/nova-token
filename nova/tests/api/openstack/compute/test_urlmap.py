...
newline|'\n'
nl|'\n'
DECL|member|test_path_content_type_v21
dedent|''
name|'def'
name|'test_path_content_type_v21'
op|'('
name|'self'
op|')'
op|':'
...
name|'url'
op|'='
string|"'/v2.1/fake/extensions/extensions.json'"
newline|'\n'
name|'req'
op|'='
name|'webob'
...
name|'url'
op|'='
string|"'/v2.1/fake/extensions/extensions'"
newline|'\n'
name|'req'
op|'='
name|'webob'
