...
op|')'
newline|'\n'
DECL|member|test_rescue_raises_not_implemented
name|'def'
name|'test_rescue_raises_not_implemented'
op|'('
name|'self'
op|','
name|'rescue_mock'
...
op|')'
newline|'\n'
DECL|member|test_unrescue_raises_not_implemented
name|'def'
name|'test_unrescue_raises_not_implemented'
op|'('
name|'self'
op|','
name|'unrescue_mock'
