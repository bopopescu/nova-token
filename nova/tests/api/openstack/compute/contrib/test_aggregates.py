...
newline|'\n'
nl|'\n'
DECL|member|test_update_with_bad_host_aggregate
dedent|''
name|'def'
name|'test_update_with_bad_host_aggregate'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_add_host_with_already_added_to_another_aggregate
dedent|''
name|'def'
name|'test_add_host_with_already_added_to_another_aggregate'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_add_host_with_host_in_wrong_availability_zone
dedent|''
name|'def'
name|'test_add_host_with_host_in_wrong_availability_zone'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_set_metadata_with_bad_host_aggregate
dedent|''
name|'def'
name|'test_set_metadata_with_bad_host_aggregate'
op|'('
name|'self'
op|')'
op|':'
