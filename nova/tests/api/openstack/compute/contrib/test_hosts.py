...
op|':'
newline|'\n'
comment|'# Verify that the compute hosts are returned.'
nl|'\n'
indent|'        '
name|'hosts'
op|'='
...
op|':'
newline|'\n'
comment|'# A host given as an argument does not exists.'
nl|'\n'
indent|'        '
name|'self'
op|'.'
...
op|':'
newline|'\n'
comment|'# No instance are running on the given host.'
nl|'\n'
indent|'        '
name|'ctxt'
op|'='
...
op|':'
newline|'\n'
comment|'# show() works correctly as expected.'
nl|'\n'
indent|'        '
name|'ctxt'
op|'='
