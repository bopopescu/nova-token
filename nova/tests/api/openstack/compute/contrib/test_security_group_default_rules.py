...
nl|'\n'
nl|'\n'
DECL|class|TestSecurityGroupDefaultRulesNeutron
dedent|''
name|'class'
name|'TestSecurityGroupDefaultRulesNeutron'
op|'('
name|'test'
op|'.'
name|'TestCase'
...
newline|'\n'
nl|'\n'
DECL|member|test_security_group_default_rules_list_not_implemented_neturon
dedent|''
name|'def'
name|'test_security_group_default_rules_list_not_implemented_neturon'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_security_group_default_rules_show_not_implemented_neturon
dedent|''
name|'def'
name|'test_security_group_default_rules_show_not_implemented_neturon'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_security_group_default_rules_delete_not_implemented_neturon
dedent|''
name|'def'
name|'test_security_group_default_rules_delete_not_implemented_neturon'
op|'('
name|'self'
op|')'
op|':'
