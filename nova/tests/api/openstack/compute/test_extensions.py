...
newline|'\n'
nl|'\n'
DECL|member|test_core_authorizer_throws_exception_if_policy_fails
dedent|''
name|'def'
name|'test_core_authorizer_throws_exception_if_policy_fails'
op|'('
name|'self'
op|')'
op|':'
...
op|','
nl|'\n'
string|'"compute:used_limits_for_admin"'
op|','
nl|'\n'
name|'target'
op|')'
