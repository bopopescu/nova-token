...
newline|'\n'
nl|'\n'
DECL|member|test_index_with_format1
dedent|''
name|'def'
name|'test_index_with_format1'
op|'('
name|'self'
op|')'
op|':'
...
op|'('
nl|'\n'
string|"'/os-instance_usage_audit_log?before='"
op|'+'
name|'before'
op|')'
newline|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|test_index_with_format2
dedent|''
name|'def'
name|'test_index_with_format2'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_index_with_invalid_format
dedent|''
name|'def'
name|'test_index_with_invalid_format'
op|'('
name|'self'
op|')'
op|':'
...
op|'('
nl|'\n'
string|"'/os-instance_usage_audit_log?before=abc'"
op|')'
newline|'\n'
name|'self'
op|'.'
...
newline|'\n'
nl|'\n'
DECL|member|test_index_with_running
dedent|''
name|'def'
name|'test_index_with_running'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_index_with_errors
dedent|''
name|'def'
name|'test_index_with_errors'
op|'('
name|'self'
op|')'
op|':'
