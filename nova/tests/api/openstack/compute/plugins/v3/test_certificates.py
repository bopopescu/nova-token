...
nl|'\n'
nl|'\n'
DECL|function|fake_get_root_cert_not_found
name|'def'
name|'fake_get_root_cert_not_found'
op|'('
name|'context'
op|','
op|'*'
...
newline|'\n'
nl|'\n'
DECL|member|test_certificates_show_not_found
dedent|''
name|'def'
name|'test_certificates_show_not_found'
op|'('
name|'self'
op|')'
op|':'
