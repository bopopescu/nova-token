...
nl|'\n'
nl|'\n'
DECL|class|ServerActionsPolicyTest
dedent|''
name|'class'
name|'ServerActionsPolicyTest'
op|'('
name|'test'
op|'.'
name|'NoDBTestCase'
...
op|','
nl|'\n'
string|"'compute_extension:v3:os-server-actions'"
op|':'
nl|'\n'
name|'policy'
op|'.'
...
name|'blank'
op|'('
string|"'/servers/12/os-server-actions'"
op|')'
newline|'\n'
name|'self'
op|'.'
...
op|'('
nl|'\n'
string|"'/servers/12/os-server-actions/1'"
op|')'
newline|'\n'
name|'self'
op|'.'
...
op|','
nl|'\n'
string|"'compute_extension:v3:os-server-actions:events'"
op|':'
nl|'\n'
name|'policy'
op|'.'
