...
nl|'\n'
nl|'\n'
DECL|class|QuantumV2Subclass
dedent|''
dedent|''
name|'class'
name|'QuantumV2Subclass'
op|'('
name|'quantum_api'
op|'.'
name|'API'
...
newline|'\n'
nl|'\n'
comment|'#    def test_can_check_loaded_extensions(self):'
nl|'\n'
comment|"#self.ext_mgr.extensions = {'os-fake': None}"
nl|'\n'
comment|"#self.assertTrue(self.controller.ext_mgr.is_loaded('os-fake'))"
nl|'\n'
comment|"#self.assertFalse(self.controller.ext_mgr.is_loaded('os-not-loaded'))"
nl|'\n'
nl|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|test_requested_networks_quantumv2_enabled_with_port
dedent|''
name|'def'
name|'test_requested_networks_quantumv2_enabled_with_port'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_requested_networks_quantumv2_enabled_with_network
dedent|''
name|'def'
name|'test_requested_networks_quantumv2_enabled_with_network'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_requested_networks_quantumv2_enabled_with_network_and_port
dedent|''
name|'def'
name|'test_requested_networks_quantumv2_enabled_with_network_and_port'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_requested_networks_quantumv2_disabled_with_port
dedent|''
name|'def'
name|'test_requested_networks_quantumv2_disabled_with_port'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_requested_networks_quantumv2_subclass_with_port
dedent|''
name|'def'
name|'test_requested_networks_quantumv2_subclass_with_port'
op|'('
name|'self'
op|')'
op|':'
...
name|'cls'
op|'='
string|"'nova.tests.api.openstack.compute.test_servers.QuantumV2Subclass'"
newline|'\n'
name|'self'
op|'.'
name|'flags'
...
string|'"href"'
op|':'
string|'"http://localhost/v3/fake/servers/%s"'
op|'%'
name|'uuid'
op|','
nl|'\n'
...
name|'url'
op|'='
string|"'/v3/fake/servers/%s/ips/network_0'"
op|'%'
name|'FAKE_UUID'
newline|'\n'
name|'req'
...
name|'blank'
op|'('
string|"'/v3/fake/servers?reservation_id=foo'"
op|')'
newline|'\n'
name|'res_dict'
op|'='
...
name|'blank'
op|'('
string|"'/v3/fake/servers?limit=3'"
op|')'
newline|'\n'
name|'res_dict'
op|'='
...
name|'blank'
op|'('
string|"'/v3/fake/servers?limit=aaa'"
op|')'
newline|'\n'
name|'self'
op|'.'
...
name|'blank'
op|'('
string|"'/v3/fake/servers/detail?limit=3'"
op|')'
newline|'\n'
name|'res'
op|'='
...
name|'blank'
op|'('
string|"'/v3/fake/servers/detail?limit=aaa'"
op|')'
newline|'\n'
name|'self'
op|'.'
...
name|'blank'
op|'('
string|"'/v3/fake/servers?limit=30'"
op|')'
newline|'\n'
name|'res_dict'
op|'='
...
name|'blank'
op|'('
string|"'/v3/fake/servers?limit=asdf'"
op|')'
newline|'\n'
name|'self'
op|'.'
...
name|'url'
op|'='
string|"'/v3/fake/servers?marker=%s'"
op|'%'
name|'fakes'
op|'.'
name|'get_fake_uuid'
...
name|'url'
op|'='
string|"'/v3/fake/servers?limit=2&marker=%s'"
op|'%'
name|'fakes'
op|'.'
name|'get_fake_uuid'
...
name|'blank'
op|'('
string|"'/v3/fake/servers?limit=2&marker=asdf'"
op|')'
newline|'\n'
name|'self'
op|'.'
...
name|'blank'
op|'('
string|"'/v3/fake/servers?unknownoption=whee'"
op|')'
newline|'\n'
name|'servers'
op|'='
...
name|'blank'
op|'('
string|"'/v3/fake/servers?image=12345'"
op|')'
newline|'\n'
name|'servers'
op|'='
...
name|'blank'
op|'('
string|"'/v3/fake/servers?tenant_id=fake'"
op|','
nl|'\n'
...
name|'blank'
op|'('
string|"'/v3/fake/servers?all_tenants=1'"
op|')'
newline|'\n'
name|'res'
op|'='
...
name|'blank'
op|'('
string|"'/v3/fake/servers?flavor=12345'"
op|')'
newline|'\n'
name|'servers'
op|'='
...
name|'blank'
op|'('
string|"'/v3/fake/servers?flavor=abcde'"
op|')'
newline|'\n'
name|'servers'
op|'='
...
name|'blank'
op|'('
string|"'/v3/fake/servers?status=active'"
op|')'
newline|'\n'
name|'servers'
op|'='
...
name|'blank'
op|'('
string|"'/v3/fake/servers?status=baloney'"
op|','
nl|'\n'
name|'use_admin_context'
op|'='
...
name|'blank'
op|'('
string|"'/v3/fake/servers?status=deleted'"
op|','
nl|'\n'
name|'use_admin_context'
op|'='
...
name|'blank'
op|'('
string|"'/v3/fake/servers?name=whee.*'"
op|')'
newline|'\n'
name|'servers'
op|'='
...
name|'blank'
op|'('
string|"'/v3/fake/servers?ip6=ffff.*'"
op|','
nl|'\n'
name|'use_admin_context'
op|'='
...
newline|'\n'
comment|'#xml request which raises LookupError'
nl|'\n'
name|'req'
op|'.'
name|'body'
...
string|"'application/xml'"
newline|'\n'
comment|'#xml request which raises ExpatError'
nl|'\n'
name|'req'
op|'.'
name|'body'
...
name|'image_href'
op|'='
string|"'http://localhost/v3/fake/images/%s'"
op|'%'
name|'image_uuid'
newline|'\n'
name|'access_ipv4'
...
name|'blank'
op|'('
string|"'/v3/fake/servers/a/action'"
op|')'
newline|'\n'
name|'req'
op|'.'
...
name|'blank'
op|'('
string|"'/v3/fake/servers/1234/action'"
op|')'
newline|'\n'
name|'self'
op|'.'
...
comment|'#     }'
nl|'\n'
comment|"#     req = fakes.HTTPRequest.blank('/v2/fake/servers')"
nl|'\n'
...
comment|'# TODO(cyeoh): bp-v3-api-unittests'
nl|'\n'
comment|'# This needs to be ported to the os-multiple-create extension tests'
nl|'\n'
comment|'# def test_create_instance_invalid_negative_min(self):'
nl|'\n'
comment|"#     self.ext_mgr.extensions = {'os-multiple-create': 'fake'}"
nl|'\n'
comment|"#     image_href = '76fa36fc-c930-4bf3-8c8a-ea2a2420deb6'"
nl|'\n'
comment|"#     flavor_ref = 'http://localhost/123/flavors/3'"
...
comment|'#     }'
nl|'\n'
comment|"#     req = fakes.HTTPRequestV3.blank('/v3/fake/servers')"
nl|'\n'
comment|"#     req.method = 'POST'"
nl|'\n'
comment|'#     req.body = jsonutils.dumps(body)'
...
comment|'# This needs to be ported to the os-multiple-create extension tests'
nl|'\n'
comment|'# def test_create_instance_invalid_negative_max(self):'
nl|'\n'
comment|"#     self.ext_mgr.extensions = {'os-multiple-create': 'fake'}"
nl|'\n'
comment|"#     image_href = '76fa36fc-c930-4bf3-8c8a-ea2a2420deb6'"
...
comment|'# This needs to be ported to the os-multiple-create extension tests'
nl|'\n'
comment|'# def test_create_instance_invalid_alpha_min(self):'
nl|'\n'
comment|"#     self.ext_mgr.extensions = {'os-multiple-create': 'fake'}"
nl|'\n'
comment|"#     image_href = '76fa36fc-c930-4bf3-8c8a-ea2a2420deb6'"
...
comment|'# This needs to be ported to the os-multiple-create extension tests'
nl|'\n'
comment|'# def test_create_instance_invalid_alpha_max(self):'
nl|'\n'
comment|"#     self.ext_mgr.extensions = {'os-multiple-create': 'fake'}"
nl|'\n'
comment|"#     image_href = '76fa36fc-c930-4bf3-8c8a-ea2a2420deb6'"
...
comment|'# This needs to be ported to the os-multiple-create extension tests'
nl|'\n'
comment|'# def test_create_multiple_instances(self):'
nl|'\n'
comment|'#     """Test creating multiple instances but not asking for'
nl|'\n'
...
comment|'#     req.headers["content-type"] = "application/json"'
nl|'\n'
comment|'#     res = self.controller.create(req, body).obj'
nl|'\n'
nl|'\n'
comment|'#     self.assertEqual(FAKE_UUID, res["server"]["id"])'
nl|'\n'
comment|'#     self._check_admin_pass_len(res["server"])'
nl|'\n'
nl|'\n'
comment|'# TODO(cyeoh): bp-v3-api-unittests'
nl|'\n'
comment|'# This needs to be ported to the os-multiple-create extension tests'
nl|'\n'
comment|'# def test_create_multiple_instances_pass_disabled(self):'
nl|'\n'
comment|'#     """Test creating multiple instances but not asking for'
nl|'\n'
comment|'#     reservation_id'
...
comment|"#     self.ext_mgr.extensions = {'os-multiple-create': 'fake'}"
nl|'\n'
comment|'#     self.flags(enable_instance_password=False)'
nl|'\n'
comment|"#     image_href = '76fa36fc-c930-4bf3-8c8a-ea2a2420deb6'"
nl|'\n'
comment|"#     flavor_ref = 'http://localhost/123/flavors/3'"
...
comment|'#     self.assertEqual(FAKE_UUID, res["server"]["id"])'
nl|'\n'
comment|'#     self._check_admin_pass_missing(res["server"])'
nl|'\n'
nl|'\n'
comment|'# TODO(cyeoh): bp-v3-api-unittests'
nl|'\n'
comment|'# This needs to be ported to the os-multiple-create extension tests'
nl|'\n'
comment|'# def test_create_multiple_instances_resv_id_return(self):'
nl|'\n'
comment|'#     """Test creating multiple instances with asking for'
nl|'\n'
comment|'#     reservation_id'
nl|'\n'
comment|'#     """'
...
comment|"#             'personality': [],"
nl|'\n'
comment|"#             'return_reservation_id': True"
nl|'\n'
comment|'#         }'
nl|'\n'
comment|'#     }'
...
comment|'#     req.headers["content-type"] = "application/json"'
nl|'\n'
comment|'#     res = self.controller.create(req, body)'
nl|'\n'
nl|'\n'
comment|"#     reservation_id = res.obj.get('reservation_id')"
nl|'\n'
comment|'#     self.assertNotEqual(reservation_id, "")'
nl|'\n'
comment|'#     self.assertNotEqual(reservation_id, None)'
nl|'\n'
comment|'#     self.assertTrue(len(reservation_id) > 1)'
nl|'\n'
nl|'\n'
comment|'# TODO(cyeoh): bp-v3-api-unittests'
nl|'\n'
comment|'# This needs to be ported to the os-multiple-create extension tests'
nl|'\n'
comment|'# def test_create_multiple_instances_with_multiple_volume_bdm(self):'
nl|'\n'
comment|'#     """'
nl|'\n'
comment|'#     Test that a BadRequest is raised if multiple instances'
nl|'\n'
comment|'#     are requested with a list of block device mappings for volumes.'
nl|'\n'
comment|'#     """'
nl|'\n'
comment|"#     self.ext_mgr.extensions = {'os-multiple-create': 'fake'}"
...
comment|'#     min_count = 2'
nl|'\n'
comment|"#     bdm = [{'device_name': 'foo1', 'volume_id': 'vol-xxxx'},"
nl|'\n'
comment|"#            {'device_name': 'foo2', 'volume_id': 'vol-yyyy'}"
nl|'\n'
comment|'#     ]'
nl|'\n'
comment|'#     params = {'
nl|'\n'
comment|"#               'block_device_mapping': bdm,"
nl|'\n'
comment|"#               'min_count': min_count"
nl|'\n'
comment|'#     }'
nl|'\n'
...
nl|'\n'
comment|"#         self.assertEqual(kwargs['min_count'], 2)"
nl|'\n'
comment|"#         self.assertEqual(len(kwargs['block_device_mapping']), 2)"
nl|'\n'
...
comment|'#     self.assertRaises(webob.exc.HTTPBadRequest,'
nl|'\n'
comment|'#                       self._test_create_extra, params, no_image=True)'
nl|'\n'
nl|'\n'
comment|'# TODO(cyeoh): bp-v3-api-unittests'
nl|'\n'
comment|'# This needs to be ported to the os-multiple-create extension tests'
nl|'\n'
comment|'# def test_create_multiple_instances_with_single_volume_bdm(self):'
nl|'\n'
comment|'#     """'
nl|'\n'
comment|'#     Test that a BadRequest is raised if multiple instances'
nl|'\n'
comment|'#     are requested to boot from a single volume.'
nl|'\n'
comment|'#     """'
nl|'\n'
comment|"#     self.ext_mgr.extensions = {'os-multiple-create': 'fake'}"
...
comment|"#         self.assertEqual(kwargs['min_count'], 2)"
nl|'\n'
comment|"#         self.assertEqual(kwargs['block_device_mapping']['volume_id'],"
nl|'\n'
comment|"#                         'vol-xxxx')"
nl|'\n'
comment|'#         return old_create(*args, **kwargs)'
...
comment|'# This needs to be ported to the os-multiple-create extension tests'
nl|'\n'
comment|'# def test_create_multiple_instance_with_non_integer_max_count(self):'
nl|'\n'
comment|"#     self.ext_mgr.extensions = {'os-multiple-create': 'fake'}"
nl|'\n'
comment|"#     image_href = '76fa36fc-c930-4bf3-8c8a-ea2a2420deb6'"
...
comment|'#     self.assertRaises(webob.exc.HTTPBadRequest,'
nl|'\n'
comment|'#                       self.controller.create, req, body)'
nl|'\n'
nl|'\n'
comment|'# TODO(cyeoh): bp-v3-api-unittests'
nl|'\n'
comment|'# This needs to be ported to the os-multiple-create extension tests'
nl|'\n'
comment|'# def test_create_multiple_instance_with_non_integer_min_count(self):'
nl|'\n'
comment|"#     self.ext_mgr.extensions = {'os-multiple-create': 'fake'}"
nl|'\n'
comment|"#     image_href = '76fa36fc-c930-4bf3-8c8a-ea2a2420deb6'"
...
comment|'# TODO(cyeoh): bp-v3-api-unittests'
nl|'\n'
comment|'# This needs to be ported to the os-security-groups extension tests'
nl|'\n'
comment|'# def test_create_instance_with_security_group_enabled(self):'
nl|'\n'
comment|"#     self.ext_mgr.extensions = {'os-security-groups': 'fake'}"
nl|'\n'
comment|"#     group = 'foo'"
nl|'\n'
comment|'#     old_create = compute_api.API.create'
nl|'\n'
nl|'\n'
comment|'#     def sec_group_get(ctx, proj, name):'
nl|'\n'
comment|'#         if name == group:'
nl|'\n'
comment|'#             return True'
nl|'\n'
comment|'#         else:'
nl|'\n'
comment|'#             raise exception.SecurityGroupNotFoundForProject('
nl|'\n'
comment|'#                 project_id=proj, security_group_id=name)'
nl|'\n'
nl|'\n'
comment|'#     def create(*args, **kwargs):'
nl|'\n'
comment|"#         self.assertEqual(kwargs['security_group'], [group])"
nl|'\n'
comment|'#         return old_create(*args, **kwargs)'
nl|'\n'
nl|'\n'
comment|"#     self.stubs.Set(db, 'security_group_get_by_name', sec_group_get)"
nl|'\n'
comment|'#     # negative test'
nl|'\n'
comment|'#     self.assertRaises(webob.exc.HTTPBadRequest,'
nl|'\n'
comment|'#                       self._test_create_extra,'
nl|'\n'
comment|"#                       {'security_groups': [{'name': 'bogus'}]})"
nl|'\n'
comment|'#     # positive test - extra assert in create path'
nl|'\n'
comment|"#     self.stubs.Set(compute_api.API, 'create', create)"
nl|'\n'
comment|"#     self._test_create_extra({'security_groups': [{'name': group}]})"
nl|'\n'
nl|'\n'
...
comment|'# TODO(cyeoh): bp-v3-api-unittests'
nl|'\n'
comment|'# This needs to be ported to the OS-DCF extension tests'
nl|'\n'
comment|'# def test_create_instance_with_disk_config_enabled(self):'
nl|'\n'
comment|"#     self.ext_mgr.extensions = {'OS-DCF': 'fake'}"
nl|'\n'
...
nl|'\n'
comment|"#     params = {'auto_disk_config': 'AUTO'}"
nl|'\n'
comment|'#     old_create = compute_api.API.create'
nl|'\n'
nl|'\n'
comment|'#     def create(*args, **kwargs):'
nl|'\n'
comment|"#         self.assertEqual(kwargs['auto_disk_config'], 'AUTO')"
nl|'\n'
comment|'#         return old_create(*args, **kwargs)'
nl|'\n'
nl|'\n'
...
comment|'# TODO(cyeoh): bp-v3-api-unittests'
nl|'\n'
comment|'# This needs to be ported to the OS-SCH-HNT extension tests'
nl|'\n'
comment|'# def test_create_instance_with_scheduler_hints_enabled(self):'
nl|'\n'
comment|"#     self.ext_mgr.extensions = {'OS-SCH-HNT': 'fake'}"
nl|'\n'
comment|"#     hints = {'a': 'b'}"
nl|'\n'
comment|"#     params = {'scheduler_hints': hints}"
nl|'\n'
comment|'#     old_create = compute_api.API.create'
nl|'\n'
nl|'\n'
comment|'#     def create(*args, **kwargs):'
nl|'\n'
comment|"#         self.assertEqual(kwargs['scheduler_hints'], hints)"
nl|'\n'
comment|'#         return old_create(*args, **kwargs)'
nl|'\n'
nl|'\n'
...
comment|'# TODO(cyeoh): bp-v3-api-unittests'
nl|'\n'
comment|'# This needs to be ported to the os-volumes extension tests'
nl|'\n'
comment|'# def test_create_instance_with_volumes_enabled(self):'
nl|'\n'
comment|"#     self.ext_mgr.extensions = {'os-volumes': 'fake'}"
nl|'\n'
comment|"#     bdm = [{'device_name': 'foo'}]"
nl|'\n'
comment|"#     params = {'block_device_mapping': bdm}"
nl|'\n'
comment|'#     old_create = compute_api.API.create'
nl|'\n'
nl|'\n'
comment|'#     def create(*args, **kwargs):'
nl|'\n'
comment|"#         self.assertEqual(kwargs['block_device_mapping'], bdm)"
nl|'\n'
comment|'#         return old_create(*args, **kwargs)'
nl|'\n'
nl|'\n'
...
comment|'# This needs to be ported to the os-volumes extension tests'
nl|'\n'
comment|'# def test_create_instance_with_volumes_enabled_no_image(self):'
nl|'\n'
comment|'#     """'
nl|'\n'
comment|'#     Test that the create will fail if there is no image'
nl|'\n'
comment|'#     and no bdms supplied in the request'
nl|'\n'
comment|'#     """'
nl|'\n'
comment|"#     self.ext_mgr.extensions = {'os-volumes': 'fake'}"
...
comment|'#     def create(*args, **kwargs):'
nl|'\n'
comment|"#         self.assertNotIn('imageRef', kwargs)"
nl|'\n'
comment|'#         return old_create(*args, **kwargs)'
nl|'\n'
nl|'\n'
...
comment|'#     self.assertRaises(webob.exc.HTTPBadRequest,'
nl|'\n'
comment|'#                       self._test_create_extra, {}, no_image=True)'
nl|'\n'
nl|'\n'
comment|'# TODO(cyeoh): bp-v3-api-unittests'
nl|'\n'
comment|'# This needs to be ported to the os-volumes extension tests'
nl|'\n'
comment|'# def test_create_instance_with_volumes_enabled_and_bdms_no_image(self):'
nl|'\n'
comment|'#     """'
nl|'\n'
comment|'#     Test that the create works if there is no image supplied but'
nl|'\n'
comment|'#     os-volumes extension is enabled and bdms are supplied'
nl|'\n'
comment|'#     """'
nl|'\n'
comment|"#     self.ext_mgr.extensions = {'os-volumes': 'fake'}"
...
comment|'# This needs to be ported to the os-volumes extension tests'
nl|'\n'
comment|'# def test_create_instance_with_device_name_not_string(self):'
nl|'\n'
comment|"#     self.ext_mgr.extensions = {'os-volumes': 'fake'}"
nl|'\n'
comment|"#     bdm = [{'delete_on_termination': 1,"
nl|'\n'
comment|"#             'device_name': 123,"
nl|'\n'
comment|"#             'volume_size': 1,"
nl|'\n'
comment|"#             'volume_id': '11111111-1111-1111-1111-111111111111'}]"
nl|'\n'
comment|"#     params = {'block_device_mapping': bdm}"
nl|'\n'
comment|'#     old_create = compute_api.API.create'
...
comment|'# This needs to be ported to the os-volumes extension tests'
nl|'\n'
comment|'# def test_create_instance_with_device_name_empty(self):'
nl|'\n'
comment|"#     self.ext_mgr.extensions = {'os-volumes': 'fake'}"
nl|'\n'
comment|"#     bdm = [{'delete_on_termination': 1,"
...
comment|'# This needs to be ported to the os-volumes extension tests'
nl|'\n'
comment|'# def test_create_instance_with_device_name_too_long(self):'
nl|'\n'
comment|"#     self.ext_mgr.extensions = {'os-volumes': 'fake'}"
nl|'\n'
comment|"#     bdm = [{'delete_on_termination': 1,"
nl|'\n'
comment|"#             'device_name': 'a' * 256,"
nl|'\n'
comment|"#             'volume_size': 1,"
nl|'\n'
comment|"#             'volume_id': '11111111-1111-1111-1111-111111111111'}]"
...
comment|'# This needs to be ported to the os-volumes extension tests'
nl|'\n'
comment|'# def test_create_instance_with_space_in_device_name(self):'
nl|'\n'
comment|"#     self.ext_mgr.extensions = {'os-volumes': 'fake'}"
nl|'\n'
comment|"#     bdm = [{'delete_on_termination': 1,"
nl|'\n'
comment|"#             'device_name': 'vd a',"
nl|'\n'
comment|"#             'volume_size': 1,"
nl|'\n'
comment|"#             'volume_id': '11111111-1111-1111-1111-111111111111'}]"
...
comment|'# This needs to be ported to the os-volumes extension tests'
nl|'\n'
comment|'# def test_create_instance_with_bdm_delete_on_termination(self):'
nl|'\n'
comment|"#     self.ext_mgr.extensions = {'os-volumes': 'fake'}"
nl|'\n'
comment|"#     bdm = [{'device_name': 'foo1', 'delete_on_termination': 1},"
nl|'\n'
comment|"#            {'device_name': 'foo2', 'delete_on_termination': True},"
nl|'\n'
comment|"#            {'device_name': 'foo3', 'delete_on_termination': 'invalid'},"
nl|'\n'
comment|"#            {'device_name': 'foo4', 'delete_on_termination': 0},"
nl|'\n'
comment|"#            {'device_name': 'foo5', 'delete_on_termination': False}]"
nl|'\n'
comment|'#     expected_dbm = ['
nl|'\n'
comment|"#         {'device_name': 'foo1', 'delete_on_termination': True},"
nl|'\n'
comment|"#         {'device_name': 'foo2', 'delete_on_termination': True},"
nl|'\n'
comment|"#         {'device_name': 'foo3', 'delete_on_termination': False},"
nl|'\n'
comment|"#         {'device_name': 'foo4', 'delete_on_termination': False},"
nl|'\n'
comment|"#         {'device_name': 'foo5', 'delete_on_termination': False}]"
nl|'\n'
comment|"#     params = {'block_device_mapping': bdm}"
...
comment|'#     def create(*args, **kwargs):'
nl|'\n'
comment|"#         self.assertEqual(kwargs['block_device_mapping'], expected_dbm)"
nl|'\n'
comment|'#         return old_create(*args, **kwargs)'
nl|'\n'
nl|'\n'
...
comment|'# TODO(cyeoh): bp-v3-api-unittests'
nl|'\n'
comment|'# This needs to be ported to the os-user-data extension tests'
nl|'\n'
comment|'# def test_create_instance_with_user_data_enabled(self):'
nl|'\n'
comment|"#     self.ext_mgr.extensions = {'os-user-data': 'fake'}"
nl|'\n'
comment|"#     user_data = 'fake'"
nl|'\n'
comment|"#     params = {'user_data': user_data}"
nl|'\n'
comment|'#     old_create = compute_api.API.create'
nl|'\n'
nl|'\n'
comment|'#     def create(*args, **kwargs):'
nl|'\n'
comment|"#         self.assertEqual(kwargs['user_data'], user_data)"
nl|'\n'
comment|'#         return old_create(*args, **kwargs)'
nl|'\n'
nl|'\n'
...
comment|'# TODO(cyeoh): bp-v3-api-unittests'
nl|'\n'
comment|'# This needs to be ported to the os-availability-zone extension tests'
nl|'\n'
comment|'# def test_create_instance_with_availability_zone_enabled(self):'
nl|'\n'
comment|"#     self.ext_mgr.extensions = {'os-availability-zone': 'fake'}"
nl|'\n'
comment|"#     availability_zone = 'fake'"
nl|'\n'
comment|"#     params = {'availability_zone': availability_zone}"
nl|'\n'
comment|'#     old_create = compute_api.API.create'
nl|'\n'
nl|'\n'
comment|'#     def create(*args, **kwargs):'
nl|'\n'
comment|"#         self.assertEqual(kwargs['availability_zone'], availability_zone)"
nl|'\n'
comment|'#         return old_create(*args, **kwargs)'
nl|'\n'
nl|'\n'
...
comment|'# TODO(cyeoh): bp-v3-api-unittests'
nl|'\n'
comment|'# This needs to be ported to the os-multi-create extension tests'
nl|'\n'
comment|'# def test_create_instance_with_multiple_create_enabled(self):'
nl|'\n'
comment|"#     self.ext_mgr.extensions = {'os-multiple-create': 'fake'}"
nl|'\n'
comment|'#     min_count = 2'
...
comment|"#         self.assertEqual(kwargs['min_count'], 2)"
nl|'\n'
comment|"#         self.assertEqual(kwargs['max_count'], 3)"
nl|'\n'
comment|'#         return old_create(*args, **kwargs)'
nl|'\n'
nl|'\n'
...
nl|'\n'
nl|'\n'
DECL|member|test_create_instance_with_networks_disabled_quantumv2
dedent|''
name|'def'
name|'test_create_instance_with_networks_disabled_quantumv2'
op|'('
name|'self'
op|')'
op|':'
...
name|'image_href'
op|'='
string|"'http://localhost/v3/images/2'"
newline|'\n'
name|'flavor_ref'
op|'='
...
name|'flavor_ref'
op|'='
string|"'http://localhost/v3/flavors/asdf'"
newline|'\n'
name|'body'
op|'='
name|'dict'
...
name|'image_href'
op|'='
string|"'http://localhost/v3/fake/images/2'"
newline|'\n'
name|'flavor_ref'
op|'='
op|'-'
...
name|'flavor_ref'
op|'='
string|"'http://localhost/v3/flavors/17'"
newline|'\n'
name|'body'
op|'='
name|'dict'
...
comment|'# TODO(cyeoh): bp-v3-api-unittests'
nl|'\n'
comment|'# This needs to be ported to the os-config-drive extension tests'
nl|'\n'
comment|'# def test_create_instance_with_config_drive(self):'
nl|'\n'
comment|"#     self.ext_mgr.extensions = {'os-config-drive': 'fake'}"
nl|'\n'
comment|"#     image_href = '76fa36fc-c930-4bf3-8c8a-ea2a2420deb6'"
nl|'\n'
comment|"#     flavor_ref = 'http://localhost/v3/fake/flavors/3'"
nl|'\n'
comment|'#     body = {'
nl|'\n'
comment|"#         'server': {"
nl|'\n'
comment|"#             'name': 'config_drive_test',"
nl|'\n'
comment|"#             'imageRef': image_href,"
nl|'\n'
comment|"#             'flavorRef': flavor_ref,"
...
nl|'\n'
nl|'\n'
comment|"#     server = res['server']"
nl|'\n'
comment|"#     self.assertEqual(FAKE_UUID, server['id'])"
nl|'\n'
nl|'\n'
comment|'# TODO(cyeoh): bp-v3-api-unittests'
nl|'\n'
comment|'# This needs to be ported to the os-config-drive extension tests'
nl|'\n'
comment|'# def test_create_instance_with_config_drive_as_id(self):'
nl|'\n'
comment|"#     self.ext_mgr.extensions = {'os-config-drive': 'fake'}"
nl|'\n'
comment|"#     image_href = '76fa36fc-c930-4bf3-8c8a-ea2a2420deb6'"
...
comment|"#             'personality': {},"
nl|'\n'
comment|"#             'config_drive': image_href,"
nl|'\n'
comment|'#         },'
nl|'\n'
comment|'#     }'
...
comment|'# This needs to be ported to the os-config-drive extension tests'
nl|'\n'
comment|'# def test_create_instance_with_bad_config_drive(self):'
nl|'\n'
comment|"#     self.ext_mgr.extensions = {'os-config-drive': 'fake'}"
nl|'\n'
comment|"#     image_href = '76fa36fc-c930-4bf3-8c8a-ea2a2420deb6'"
...
comment|'# This needs to be ported to the os-config-drive extension tests'
nl|'\n'
comment|'# def test_create_instance_without_config_drive(self):'
nl|'\n'
comment|"#     self.ext_mgr.extensions = {'os-config-drive': 'fake'}"
nl|'\n'
comment|"#     image_href = '76fa36fc-c930-4bf3-8c8a-ea2a2420deb6'"
...
comment|'# TODO(cyeoh): bp-v3-api-unittests'
nl|'\n'
comment|'# This needs to be ported to the scheduler hints extension tests'
nl|'\n'
comment|'#   def test_request_with_scheduler_hints_and_alternate_namespace_prefix(self):'
nl|'\n'
comment|'#         serial_request = """'
nl|'\n'
comment|'# <ns2:server xmlns:ns2="http://docs.openstack.org/compute/api/v2"'
nl|'\n'
comment|'#      name="new-server-test"'
nl|'\n'
comment|'#      imageRef="1"'
nl|'\n'
comment|'#      flavorRef="2">'
nl|'\n'
comment|'#      <ns2:metadata><ns2:meta key="hello">world</ns2:meta></ns2:metadata>'
nl|'\n'
comment|'#      <os:scheduler_hints'
nl|'\n'
comment|'#      xmlns:os="http://docs.openstack.org/compute/ext/scheduler-hints/api/v2">'
nl|'\n'
comment|'#              <hypervisor>xen</hypervisor>'
nl|'\n'
comment|'#              <near>eb999657-dd6b-464e-8713-95c532ac3b18</near>'
nl|'\n'
comment|'#      </os:scheduler_hints>'
nl|'\n'
comment|'#      </ns2:server>'
...
comment|'#         """'
nl|'\n'
comment|'#         request = self.deserializer.deserialize(serial_request)'
nl|'\n'
comment|'#         expected = {'
nl|'\n'
comment|'#             "server": {'
nl|'\n'
comment|"#                 'OS-SCH-HNT:scheduler_hints': {"
nl|'\n'
comment|"#                     'hypervisor': ['xen'],"
nl|'\n'
comment|"#                     'near': ['eb999657-dd6b-464e-8713-95c532ac3b18']"
nl|'\n'
comment|'#                 },'
nl|'\n'
comment|'#                 "name": "new-server-test",'
...
comment|'#         }'
nl|'\n'
comment|"#         self.assertEquals(request['body'], expected)"
nl|'\n'
nl|'\n'
...
string|'"imageRef"'
op|':'
string|'"http://localhost:8774/v3/images/2"'
op|','
nl|'\n'
string|'"flavorRef"'
op|':'
...
string|'"flavorRef"'
op|':'
string|'"http://localhost:8774/v3/flavors/3"'
op|','
nl|'\n'
op|'}'
op|','
...
comment|'# This needs to be ported to the OS-DCF extension tests'
nl|'\n'
comment|'# def test_request_with_disk_config(self):'
nl|'\n'
comment|'#     serial_request = """'
nl|'\n'
comment|'# <server xmlns="http://docs.openstack.org/compute/api/v2"'
nl|'\n'
comment|'# xmlns:OS-DCF="http://docs.openstack.org/compute/ext/disk_config/api/v1.1"'
nl|'\n'
comment|'#  name="new-server-test" imageRef="1" flavorRef="1"'
nl|'\n'
comment|'#  OS-DCF:diskConfig="AUTO">'
nl|'\n'
comment|'# </server>"""'
nl|'\n'
comment|'#     request = self.deserializer.deserialize(serial_request)'
nl|'\n'
comment|'#     expected = {"server": {'
nl|'\n'
comment|'#             "name": "new-server-test",'
nl|'\n'
comment|'#             "imageRef": "1",'
...
comment|'# This needs to be ported to the scheduler hints extension tests'
nl|'\n'
comment|'# def test_request_with_scheduler_hints(self):'
nl|'\n'
comment|'#     serial_request = """'
nl|'\n'
comment|'# <server xmlns="http://docs.openstack.org/compute/api/v2"'
nl|'\n'
comment|'#  xmlns:OS-SCH-HNT='
nl|'\n'
comment|'#  "http://docs.openstack.org/compute/ext/scheduler-hints/api/v2"'
nl|'\n'
comment|'#  name="new-server-test" imageRef="1" flavorRef="1">'
nl|'\n'
comment|'#    <OS-SCH-HNT:scheduler_hints>'
nl|'\n'
comment|'#      <different_host>'
nl|'\n'
comment|'#        7329b667-50c7-46a6-b913-cb2a09dfeee0'
nl|'\n'
comment|'#      </different_host>'
nl|'\n'
comment|'#      <different_host>'
nl|'\n'
comment|'#        f31efb24-34d2-43e1-8b44-316052956a39'
nl|'\n'
comment|'#      </different_host>'
nl|'\n'
comment|'#    </OS-SCH-HNT:scheduler_hints>'
...
comment|'# This needs to be ported to the os-config-drive extension tests'
nl|'\n'
comment|'# def test_request_with_config_drive(self):'
nl|'\n'
comment|'#     serial_request = """'
nl|'\n'
comment|'# <server xmlns="http://docs.openstack.org/compute/api/v2"'
...
comment|'# This needs to be ported to the OS-DCF extension tests'
nl|'\n'
comment|'# class TestServerActionRequestXMLDeserializer(test.TestCase):'
nl|'\n'
nl|'\n'
comment|'#     def setUp(self):'
nl|'\n'
comment|'#         super(TestServerActionRequestXMLDeserializer, self).setUp()'
nl|'\n'
comment|'#         self.deserializer = servers.ActionDeserializer()'
nl|'\n'
nl|'\n'
comment|'#     def test_rebuild_request(self):'
nl|'\n'
comment|'#         serial_request = """'
nl|'\n'
comment|'# <rebuild xmlns="http://docs.openstack.org/compute/api/v1.1"'
nl|'\n'
comment|'#    xmlns:OS-DCF="http://docs.openstack.org/compute/ext/disk_config/api/v1.1"'
nl|'\n'
comment|'#    OS-DCF:diskConfig="MANUAL" imageRef="1"/>"""'
nl|'\n'
comment|'#         request = self.deserializer.deserialize(serial_request)'
nl|'\n'
comment|'#         expected = {'
...
comment|'#                 "imageRef": "1",'
nl|'\n'
comment|'#                 "OS-DCF:diskConfig": "MANUAL",'
nl|'\n'
comment|'#                 },'
nl|'\n'
comment|'#             }'
...
nl|'\n'
nl|'\n'
comment|'#     def test_rebuild_request_auto_disk_config_compat(self):'
nl|'\n'
comment|'#         serial_request = """'
nl|'\n'
comment|'# <rebuild xmlns="http://docs.openstack.org/compute/api/v1.1"'
...
comment|'#    xmlns:OS-DCF="http://docs.openstack.org/compute/ext/disk_config/api/v1.1"'
nl|'\n'
comment|'#    auto_disk_config="MANUAL" imageRef="1"/>"""'
nl|'\n'
comment|'#         request = self.deserializer.deserialize(serial_request)'
nl|'\n'
comment|'#         expected = {'
...
nl|'\n'
nl|'\n'
comment|'#     def test_resize_request(self):'
nl|'\n'
comment|'#         serial_request = """'
nl|'\n'
comment|'# <resize xmlns="http://docs.openstack.org/compute/api/v1.1"'
nl|'\n'
comment|'#    xmlns:OS-DCF="http://docs.openstack.org/compute/ext/disk_config/api/v1.1"'
nl|'\n'
comment|'#    OS-DCF:diskConfig="MANUAL" flavorRef="1"/>"""'
nl|'\n'
comment|'#         request = self.deserializer.deserialize(serial_request)'
nl|'\n'
comment|'#         expected = {'
...
nl|'\n'
nl|'\n'
comment|'#     def test_resize_request_auto_disk_config_compat(self):'
nl|'\n'
comment|'#         serial_request = """'
nl|'\n'
comment|'# <resize xmlns="http://docs.openstack.org/compute/api/v1.1"'
...
comment|'#    xmlns:OS-DCF="http://docs.openstack.org/compute/ext/disk_config/api/v1.1"'
nl|'\n'
comment|'#    auto_disk_config="MANUAL" flavorRef="1"/>"""'
nl|'\n'
comment|'#         request = self.deserializer.deserialize(serial_request)'
nl|'\n'
comment|'#         expected = {'
...
name|'SERVER_NEXT'
op|'='
string|"'http://localhost/v3/servers?limit=%s&marker=%s'"
newline|'\n'
