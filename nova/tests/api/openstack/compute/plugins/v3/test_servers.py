...
name|'blank'
op|'('
string|"'/servers?tenant_id=newfake'"
op|')'
newline|'\n'
name|'res'
op|'='
...
newline|'\n'
nl|'\n'
DECL|member|test_tenant_id_filter_implies_all_tenants
dedent|''
name|'def'
name|'test_tenant_id_filter_implies_all_tenants'
op|'('
name|'self'
op|')'
op|':'
...
op|')'
newline|'\n'
comment|'# The project_id assertion checks that the project_id'
nl|'\n'
comment|'# filter is set to that specified in the request url and'
nl|'\n'
comment|'# not that of the context, verifying that the all_tenants'
nl|'\n'
comment|'# flag was enabled'
nl|'\n'
name|'self'
op|'.'
name|'assertEqual'
...
name|'blank'
op|'('
string|"'/servers?all_tenants=false'"
op|','
nl|'\n'
name|'use_admin_context'
op|'='
...
name|'blank'
op|'('
string|"'/servers?all_tenants=xxx'"
op|','
nl|'\n'
name|'use_admin_context'
op|'='
...
newline|'\n'
nl|'\n'
DECL|function|test_admin_password
dedent|''
name|'def'
...
newline|'\n'
nl|'\n'
DECL|member|test_show_no_image
dedent|''
dedent|''
dedent|''
name|'def'
name|'test_show_no_image'
op|'('
name|'self'
op|')'
op|':'
...
op|')'
newline|'\n'
comment|'# Only need to verify the "image"'
nl|'\n'
name|'image_root'
op|'='
name|'root'
...
nl|'\n'
nl|'\n'
DECL|class|TestServerRebuildXMLDeserializer
dedent|''
dedent|''
name|'class'
name|'TestServerRebuildXMLDeserializer'
op|'('
name|'test'
op|'.'
name|'NoDBTestCase'
...
nl|'\n'
nl|'\n'
DECL|class|FakeDiskConfigExt
dedent|''
dedent|''
name|'class'
name|'FakeDiskConfigExt'
op|'('
name|'extensions'
op|'.'
...
name|'namespace'
op|'='
string|'"http://docs.openstack.org/compute/ext/disk_config/api/v3"'
newline|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|_test_load_deserialize_extension_point
dedent|''
name|'def'
name|'_test_load_deserialize_extension_point'
op|'('
name|'self'
op|','
name|'name'
...
newline|'\n'
indent|'        '
name|'extension_point_func'
op|'='
string|"'server_xml_extract_%s_deserialize'"
op|'%'
name|'name'
newline|'\n'
name|'if'
...
op|','
nl|'\n'
string|"'%s_xml_deserialize_manager'"
op|'%'
name|'name'
op|')'
op|')'
...
newline|'\n'
nl|'\n'
DECL|member|test_load_create_xml_deserialize_extension_point
dedent|''
name|'def'
name|'test_load_create_xml_deserialize_extension_point'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_load_resize_xml_deserialize_extension_point
dedent|''
name|'def'
name|'test_load_resize_xml_deserialize_extension_point'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_load_rebuild_xml_deserialize_extension_point
dedent|''
name|'def'
name|'test_load_rebuild_xml_deserialize_extension_point'
op|'('
name|'self'
op|')'
op|':'
