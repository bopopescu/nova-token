...
newline|'\n'
nl|'\n'
DECL|function|test_xml_create_exception
dedent|''
name|'def'
name|'test_xml_create_exception'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
DECL|function|fake_availablity_extract_xml_deserialize
indent|'        '
name|'def'
name|'fake_availablity_extract_xml_deserialize'
op|'('
name|'self'
op|','
nl|'\n'
