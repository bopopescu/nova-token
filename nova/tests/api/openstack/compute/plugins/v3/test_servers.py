...
name|'url'
op|'='
string|"'/v3/servers/%s/ips/network_0'"
op|'%'
name|'FAKE_UUID'
newline|'\n'
name|'req'
...
name|'blank'
op|'('
string|"'/servers?reservation_id=foo'"
op|')'
newline|'\n'
name|'res_dict'
op|'='
...
name|'blank'
op|'('
string|"'/servers/detail?limit=aaa'"
op|')'
newline|'\n'
name|'self'
op|'.'
...
name|'url'
op|'='
string|"'/v3/servers?limit=2&marker=%s'"
op|'%'
name|'fakes'
op|'.'
name|'get_fake_uuid'
...
name|'blank'
op|'('
string|"'/servers?limit=2&marker=asdf'"
op|')'
newline|'\n'
name|'self'
op|'.'
...
name|'blank'
op|'('
string|"'/servers?unknownoption=whee'"
op|')'
newline|'\n'
name|'servers'
op|'='
...
comment|'#     }'
nl|'\n'
comment|"#     req = fakes.HTTPRequestV3.blank('/servers')"
nl|'\n'
comment|"#     req.method = 'POST'"
nl|'\n'
comment|'#     req.body = jsonutils.dumps(body)'
