...
newline|'\n'
nl|'\n'
DECL|member|test_keypair_create_without_keypair
dedent|''
name|'def'
name|'test_keypair_create_without_keypair'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_keypair_create_without_name
dedent|''
name|'def'
name|'test_keypair_create_without_name'
op|'('
name|'self'
op|')'
op|':'
...
name|'assertEqual'
op|'('
string|'"Invalid input for field/attribute keypair. "'
nl|'\n'
string|'"Value: {u\'public_key\': u\'public key\'}. "'
nl|'\n'
string|'"\'name\' is a required property"'
op|','
nl|'\n'
name|'res_dict'
op|'['
...
name|'assertEqual'
op|'('
string|'"Invalid input for field/attribute name. "'
nl|'\n'
string|'"Value: . u\'\' is too short"'
op|','
nl|'\n'
name|'res_dict'
op|'['
...
op|'='
string|'"Invalid input for field/attribute name. "'
string|'"Value: %s. u\'%s\' is too long"'
op|'%'
op|'('
name|'name'
op|','
...
op|'('
nl|'\n'
string|'"Invalid input for field/attribute name. Value: test/keypair. "'
nl|'\n'
string|'"u\'test/keypair\' does not match \'^(?! )[a-zA-Z0-9. _-]*(?<! )$\'"'
op|','
nl|'\n'
name|'res_dict'
op|'['
...
op|'('
nl|'\n'
string|"'Keypair data is invalid: failed to generate fingerprint'"
op|','
nl|'\n'
name|'res_dict'
op|'['
