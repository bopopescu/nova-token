...
op|':'
newline|'\n'
DECL|function|stub_flavor_access_add
indent|'        '
name|'def'
name|'stub_flavor_access_add'
op|'('
name|'context'
op|','
name|'flavorid'
...
newline|'\n'
nl|'\n'
DECL|member|test_add_tenant_access_without_policy_check
dedent|''
name|'def'
name|'test_add_tenant_access_without_policy_check'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_remove_tenant_access_without_policy_check
dedent|''
name|'def'
name|'test_remove_tenant_access_without_policy_check'
op|'('
name|'self'
op|')'
op|':'
