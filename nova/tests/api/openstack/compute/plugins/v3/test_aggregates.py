...
name|'assertIn'
op|'('
string|'"compute_extension:v3:os-aggregates:index"'
op|','
nl|'\n'
name|'exc'
op|'.'
...
name|'assertIn'
op|'('
string|'"compute_extension:v3:os-aggregates:create"'
op|','
nl|'\n'
name|'exc'
op|'.'
...
name|'assertIn'
op|'('
string|'"compute_extension:v3:os-aggregates:show"'
op|','
nl|'\n'
name|'exc'
op|'.'
...
name|'assertIn'
op|'('
string|'"compute_extension:v3:os-aggregates:update"'
op|','
nl|'\n'
name|'exc'
op|'.'
...
newline|'\n'
nl|'\n'
DECL|member|test_update_with_invalid_request
dedent|''
name|'def'
name|'test_update_with_invalid_request'
op|'('
name|'self'
op|')'
op|':'
...
name|'assertIn'
op|'('
string|'"compute_extension:v3:os-aggregates:add_host"'
op|','
nl|'\n'
name|'exc'
op|'.'
...
name|'assertIn'
op|'('
string|'"compute_extension:v3:os-aggregates:remove_host"'
op|','
nl|'\n'
name|'exc'
op|'.'
...
name|'assertIn'
op|'('
string|'"compute_extension:v3:os-aggregates:set_metadata"'
op|','
nl|'\n'
name|'exc'
op|'.'
...
newline|'\n'
nl|'\n'
DECL|member|test_set_metadata_with_invalid_request
dedent|''
name|'def'
name|'test_set_metadata_with_invalid_request'
op|'('
name|'self'
op|')'
op|':'
