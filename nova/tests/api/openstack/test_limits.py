...
nl|'\n'
nl|'\n'
DECL|class|LimitsControllerV10Test
dedent|''
dedent|''
name|'class'
name|'LimitsControllerV10Test'
op|'('
name|'BaseLimitTestSuite'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|_setup_absolute_limits
dedent|''
name|'def'
name|'_setup_absolute_limits'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_empty_index_xml
dedent|''
name|'def'
name|'test_empty_index_xml'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
indent|'        '
string|'"""Test getting limit details in XML."""'
newline|'\n'
name|'request'
op|'='
name|'self'
...
nl|'\n'
nl|'\n'
DECL|class|LimitsControllerV11Test
dedent|''
dedent|''
name|'class'
name|'LimitsControllerV11Test'
op|'('
name|'BaseLimitTestSuite'
op|')'
op|':'
...
newline|'\n'
indent|'        '
string|'"""Test a rate-limited (403) GET request through middleware."""'
newline|'\n'
name|'request'
op|'='
name|'webob'
...
newline|'\n'
indent|'        '
string|'"""Test a rate-limited (403) response as XML"""'
newline|'\n'
name|'request'
op|'='
name|'webob'
...
name|'False'
op|','
string|'"Failure to reject invalid input"'
newline|'\n'
nl|'\n'
...
name|'False'
op|','
string|'"Failure to reject bad rule"'
newline|'\n'
nl|'\n'
...
name|'False'
op|','
string|'"Failure to reject missing rule argument"'
newline|'\n'
nl|'\n'
...
name|'False'
op|','
string|'"Failure to reject invalid value"'
newline|'\n'
nl|'\n'
...
name|'False'
op|','
string|'"Failure to reject invalid unit"'
newline|'\n'
nl|'\n'
