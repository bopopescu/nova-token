...
newline|'\n'
nl|'\n'
DECL|member|test_v10_xml_serializer
dedent|''
name|'def'
name|'test_v10_xml_serializer'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
indent|'        '
string|'"""Ensure that a v1.0 request responds with a v1.0 xmlns"""'
newline|'\n'
name|'request'
op|'='
name|'webob'
...
newline|'\n'
nl|'\n'
DECL|member|test_v11_xml_serializer
dedent|''
name|'def'
name|'test_v11_xml_serializer'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
indent|'        '
string|'"""Ensure that a v1.1 request responds with a v1.1 xmlns"""'
newline|'\n'
name|'request'
op|'='
name|'webob'
