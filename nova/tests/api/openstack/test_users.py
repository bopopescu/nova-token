...
newline|'\n'
nl|'\n'
DECL|member|test_get_user_list_xml
dedent|''
name|'def'
name|'test_get_user_list_xml'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_user_by_id_xml
dedent|''
name|'def'
name|'test_get_user_by_id_xml'
op|'('
name|'self'
op|')'
op|':'
...
name|'blank'
op|'('
string|"'/v1.1/fake/users/id2.xml'"
op|')'
newline|'\n'
name|'res'
op|'='
...
newline|'\n'
nl|'\n'
DECL|member|test_user_create_xml
dedent|''
name|'def'
name|'test_user_create_xml'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_user_update_xml
dedent|''
name|'def'
name|'test_user_update_xml'
op|'('
name|'self'
op|')'
op|':'
