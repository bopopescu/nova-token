...
nl|'\n'
nl|'\n'
DECL|class|XMLTemplateSerializerTest
dedent|''
dedent|''
name|'class'
name|'XMLTemplateSerializerTest'
op|'('
name|'test'
op|'.'
name|'TestCase'
...
op|':'
newline|'\n'
comment|'# First, check what happens when we fall back on the default'
nl|'\n'
comment|'# option'
nl|'\n'
indent|'        '
...
newline|'\n'
nl|'\n'
comment|'# Now, check that we get back a template'
nl|'\n'
name|'tmpl'
op|'='
name|'self'
...
newline|'\n'
nl|'\n'
DECL|member|test_serialize_default
dedent|''
name|'def'
name|'test_serialize_default'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_serialize_multi_default
dedent|''
name|'def'
name|'test_serialize_multi_default'
op|'('
name|'self'
op|')'
op|':'
...
op|'='
op|'('
string|"'<servers><server><a>(2,3)</a></server>'"
nl|'\n'
string|"'<server><a>(3,4)</a></server></servers>'"
op|')'
newline|'\n'
name|'result'
op|'='
...
newline|'\n'
nl|'\n'
DECL|member|test_serialize_explicit
dedent|''
name|'def'
name|'test_serialize_explicit'
op|'('
name|'self'
op|')'
op|':'
...
op|'='
op|'('
string|'"<?xmlversion=\'1.0\'encoding=\'UTF-8\'?>"'
nl|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|test_serialize_multi_explicit
dedent|''
name|'def'
name|'test_serialize_multi_explicit'
op|'('
name|'self'
op|')'
op|':'
...
string|'"<?xmlversion=\'1.0\'encoding=\'UTF-8\'?>"'
nl|'\n'
string|'\'<serversxmlns="asdf"><a>(2,3)</a>\''
nl|'\n'
string|"'<a>(3,4)</a></servers>'"
op|')'
newline|'\n'
name|'tmpl'
op|'='
...
newline|'\n'
nl|'\n'
DECL|member|test_serialize_multi
dedent|''
name|'def'
name|'test_serialize_multi'
op|'('
name|'self'
op|')'
op|':'
...
op|':'
newline|'\n'
DECL|member|test_make_flat_dict
indent|'    '
name|'def'
