...
nl|'\n'
nl|'\n'
DECL|variable|_fake_compute_actions
dedent|''
name|'_fake_compute_actions'
op|'='
op|'['
nl|'\n'
name|'dict'
...
nl|'\n'
nl|'\n'
DECL|function|fake_compute_actions
name|'def'
name|'fake_compute_actions'
op|'('
name|'_1'
op|','
name|'_2'
...
name|'url'
op|'='
string|"'/v2/fake/servers/%s/ips/public'"
op|'%'
name|'FAKE_UUID'
newline|'\n'
name|'req'
...
op|'('
nl|'\n'
string|'"/v2/fake/servers/%s/actions"'
op|'%'
name|'FAKE_UUID'
op|')'
newline|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|test_server_actions_after_reboot
dedent|''
name|'def'
name|'test_server_actions_after_reboot'
op|'('
name|'self'
op|')'
op|':'
...
op|')'
newline|'\n'
comment|'# Assume the instance is in ACTIVE state before calling reboot'
nl|'\n'
name|'self'
op|'.'
name|'stubs'
...
nl|'\n'
nl|'\n'
DECL|class|ServerHeadersSerializationTest
dedent|''
dedent|''
dedent|''
dedent|''
name|'class'
name|'ServerHeadersSerializationTest'
op|'('
name|'test'
op|'.'
name|'TestCase'
...
newline|'\n'
nl|'\n'
DECL|member|test_rebuild_location
dedent|''
name|'def'
name|'test_rebuild_location'
op|'('
name|'self'
op|')'
op|':'
