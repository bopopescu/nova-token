...
newline|'\n'
indent|'        '
string|'"""Test URL path specifying v1.1 returns v1.1 content."""'
newline|'\n'
name|'req'
op|'='
name|'webob'
...
newline|'\n'
indent|'        '
string|'"""Test Content-Type specifying v1.1 returns v1.1 content."""'
newline|'\n'
name|'req'
op|'='
name|'webob'
...
newline|'\n'
indent|'        '
string|'"""Test Accept header specifying v1.1 returns v1.1 content."""'
newline|'\n'
name|'req'
op|'='
name|'webob'
...
name|'url'
op|'='
string|"'/v1.1/foobar/images/cedef40a-ed67-4d10-800e-17455edce175.json'"
newline|'\n'
name|'req'
op|'='
name|'webob'
...
name|'url'
op|'='
string|"'/v1.1/foobar/images/cedef40a-ed67-4d10-800e-17455edce175'"
newline|'\n'
name|'req'
op|'='
name|'webob'
