...
name|'getLogger'
op|'('
string|"'nova.tests.api.openstack.v2.contrib.test_vsa'"
op|')'
newline|'\n'
nl|'\n'
...
op|':'
newline|'\n'
DECL|variable|serializer_class
indent|'    '
name|'serializer_class'
op|'='
name|'vsa_ext'
