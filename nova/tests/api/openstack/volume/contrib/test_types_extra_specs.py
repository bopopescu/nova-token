...
name|'api_path'
op|'='
string|"'/v1/fake/os-volume-types/1/extra_specs'"
newline|'\n'
name|'self'
op|'.'
name|'controller'
...
nl|'\n'
nl|'\n'
DECL|class|VolumeTypeExtraSpecsUnprocessableEntityTestCase
dedent|''
dedent|''
name|'class'
name|'VolumeTypeExtraSpecsUnprocessableEntityTestCase'
op|'('
name|'test'
op|'.'
name|'TestCase'
...
newline|'\n'
nl|'\n'
DECL|member|_unprocessable_extra_specs_create
dedent|''
name|'def'
name|'_unprocessable_extra_specs_create'
op|'('
name|'self'
op|','
name|'body'
...
name|'blank'
op|'('
string|"'/v2/fake/types/1/extra_specs'"
op|')'
newline|'\n'
name|'req'
op|'.'
...
newline|'\n'
nl|'\n'
DECL|member|_unprocessable_extra_specs_update
dedent|''
name|'def'
name|'_unprocessable_extra_specs_update'
op|'('
name|'self'
op|','
name|'body'
...
newline|'\n'
nl|'\n'
DECL|member|test_update_empty_body
dedent|''
name|'def'
