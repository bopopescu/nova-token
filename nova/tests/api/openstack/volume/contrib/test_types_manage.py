...
nl|'\n'
nl|'\n'
DECL|class|VolumeTypesUnprocessableEntityTestCase
dedent|''
dedent|''
name|'class'
name|'VolumeTypesUnprocessableEntityTestCase'
op|'('
name|'test'
op|'.'
name|'TestCase'
...
newline|'\n'
nl|'\n'
DECL|member|_unprocessable_volume_type_create
dedent|''
name|'def'
name|'_unprocessable_volume_type_create'
op|'('
name|'self'
op|','
name|'body'
