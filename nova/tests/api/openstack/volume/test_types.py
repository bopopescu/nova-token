...
newline|'\n'
nl|'\n'
DECL|member|test_view_builder_show
dedent|''
name|'def'
name|'test_view_builder_show'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_view_builder_list
dedent|''
name|'def'
name|'test_view_builder_list'
op|'('
name|'self'
op|')'
op|':'
