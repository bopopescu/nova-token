...
name|'payload'
op|'='
string|'"""{\'admin_password\':\'mypassword\'}"""'
newline|'\n'
name|'expected'
op|'='
...
name|'payload'
op|'='
string|'"""<adminPass>mypassword</adminPass>"""'
newline|'\n'
name|'expected'
op|'='
...
name|'payload'
op|'='
string|'"""<admin_password>mypassword</admin_password>"""'
newline|'\n'
name|'expected'
op|'='
...
newline|'\n'
nl|'\n'
DECL|member|test_xml_attribute
dedent|''
name|'def'
name|'test_xml_attribute'
op|'('
name|'self'
op|')'
op|':'
...
name|'payload'
op|'='
string|'"""body: {"changePassword": {"adminPass": "1234567"}}"""'
newline|'\n'
name|'expected'
op|'='
string|'"""body: {"changePassword": {"adminPass": "****"}}"""'
newline|'\n'
name|'self'
op|'.'
name|'assertEqual'
...
name|'payload'
op|'='
string|'"""body: {"rescue": {"admin_password": "1234567"}}"""'
newline|'\n'
name|'expected'
op|'='
string|'"""body: {"rescue": {"admin_password": "****"}}"""'
newline|'\n'
name|'self'
op|'.'
name|'assertEqual'
...
newline|'\n'
nl|'\n'
DECL|member|test_xml_message
dedent|''
name|'def'
name|'test_xml_message'
op|'('
name|'self'
op|')'
op|':'
