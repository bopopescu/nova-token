...
newline|'\n'
indent|'        '
string|'"""Return BadRequest if user passes an invalid diskConfig value."""'
newline|'\n'
name|'req'
op|'='
name|'fakes'
...
name|'expected_msg'
op|'='
string|'\'{"badRequest": {"message": "RAX-DCF:diskConfig must\''
string|'\' be either \\\'MANUAL\\\' or \\\'AUTO\\\'.", "code": 400}}\''
newline|'\n'
name|'self'
op|'.'
name|'assertEqual'
