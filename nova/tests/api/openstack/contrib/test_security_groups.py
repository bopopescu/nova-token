...
name|'blank'
op|'('
string|"'/v1.1/servers/invalid/action'"
op|')'
newline|'\n'
name|'req'
op|'.'
...
name|'blank'
op|'('
string|"'/v1.1/servers/10000/action'"
op|')'
newline|'\n'
name|'req'
op|'.'
...
newline|'\n'
nl|'\n'
DECL|member|test_associate_xml
dedent|''
name|'def'
name|'test_associate_xml'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_disassociate_xml
dedent|''
name|'def'
name|'test_disassociate_xml'
op|'('
name|'self'
op|')'
op|':'
