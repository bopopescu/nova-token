...
newline|'\n'
nl|'\n'
DECL|member|test_create_instance_with_security_group_empty_list_json
dedent|''
name|'def'
name|'test_create_instance_with_security_group_empty_list_json'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_create_instance_with_security_group_non_existing_json
dedent|''
name|'def'
name|'test_create_instance_with_security_group_non_existing_json'
op|'('
name|'self'
op|')'
op|':'
...
name|'blank'
op|'('
string|"'/v1.1/123/os-create-server-ext/1'"
op|')'
newline|'\n'
name|'req'
op|'.'
