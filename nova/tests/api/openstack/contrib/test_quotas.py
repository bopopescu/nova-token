...
name|'uri'
op|'='
string|"'/v1.1/fake_tenant/os-quota-sets/fake_tenant/defaults'"
newline|'\n'
name|'req'
op|'='
name|'webob'
...
name|'blank'
op|'('
string|"'/v1.1/1234/os-quota-sets/1234'"
op|')'
newline|'\n'
name|'req'
op|'.'
...
name|'blank'
op|'('
string|"'/v1.1/fake/os-quota-sets/1234'"
op|')'
newline|'\n'
name|'req'
op|'.'
...
name|'blank'
op|'('
string|"'/v1.1/1234/os-quota-sets/update_me'"
op|')'
newline|'\n'
name|'req'
op|'.'
