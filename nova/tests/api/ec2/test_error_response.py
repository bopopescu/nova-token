...
newline|'\n'
nl|'\n'
DECL|member|test_exception_ec2_client
dedent|''
name|'def'
name|'test_exception_ec2_client'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_unexpected_exception_ec2_client
dedent|''
name|'def'
name|'test_unexpected_exception_ec2_client'
op|'('
name|'self'
op|')'
op|':'
