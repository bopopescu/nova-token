...
newline|'\n'
nl|'\n'
DECL|member|test_show_raises_on_missing_credential
dedent|''
name|'def'
name|'test_show_raises_on_missing_credential'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
DECL|function|raise_missing_credentials
indent|'        '
name|'def'
name|'raise_missing_credentials'
op|'('
op|'*'
name|'args'
op|','
...
newline|'\n'
nl|'\n'
DECL|member|test_client_raises_forbidden
dedent|''
name|'def'
name|'test_client_raises_forbidden'
op|'('
name|'self'
op|')'
op|':'
