...
op|':'
newline|'\n'
comment|'# FIXME(sirp): we can probably use stubs library here rather than'
nl|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|test_show_makes_datetimes_iso
dedent|''
name|'def'
name|'test_show_makes_datetimes_iso'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_detail_makes_datetimes_iso
dedent|''
name|'def'
name|'test_detail_makes_datetimes_iso'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_makes_datetimes_iso
dedent|''
name|'def'
name|'test_get_makes_datetimes_iso'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|_make_iso_fixtures
dedent|''
name|'def'
name|'_make_iso_fixtures'
op|'('
