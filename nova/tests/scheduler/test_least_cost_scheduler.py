...
nl|'\n'
nl|'\n'
comment|'# TODO(sirp): unify this with test_host_filter tests? possibility of sharing'
nl|'\n'
comment|'# test setup code'
nl|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|test_fill_first_cost_fn
dedent|''
name|'def'
name|'test_fill_first_cost_fn'
op|'('
name|'self'
op|')'
op|':'
...
op|'['
nl|'\n'
string|"'nova.scheduler.least_cost.fill_first_cost_fn'"
nl|'\n'
op|']'
newline|'\n'
name|'FLAGS'
op|'.'
name|'fill_first_cost_fn_weight'
op|'='
number|'1'
newline|'\n'
nl|'\n'
