...
newline|'\n'
nl|'\n'
DECL|member|test_trap_not_found_locally
dedent|''
dedent|''
name|'def'
name|'test_trap_not_found_locally'
op|'('
name|'self'
op|')'
op|':'
...
nl|'\n'
nl|'\n'
DECL|class|FakeNovaClientOpenStack
dedent|''
dedent|''
name|'class'
name|'FakeNovaClientOpenStack'
op|'('
name|'object'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
comment|'# FIXME(sirp): for now the _error_trap code is catching errors and'
nl|'\n'
comment|'# converting them to a ("ERROR", "string") tuples. The code (and this'
nl|'\n'
comment|'# test) should eventually handle real exceptions.'
nl|'\n'
name|'expected'
op|'='
op|'['
