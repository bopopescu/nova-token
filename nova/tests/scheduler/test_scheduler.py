...
newline|'\n'
indent|'        '
string|'"""Raise exception when src compute node is does not exist."""'
newline|'\n'
nl|'\n'
name|'self'
op|'.'
...
newline|'\n'
indent|'        '
string|'"""Confirm live_migration to hypervisor of different type raises"""'
newline|'\n'
name|'self'
op|'.'
name|'mox'
...
newline|'\n'
indent|'        '
string|'"""Confirm live migration to older hypervisor raises"""'
newline|'\n'
name|'self'
op|'.'
name|'mox'
