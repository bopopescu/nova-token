...
newline|'\n'
nl|'\n'
DECL|member|test_no_valid_host_exception_on_start
dedent|''
dedent|''
name|'def'
name|'test_no_valid_host_exception_on_start'
op|'('
name|'self'
op|')'
op|':'
...
name|'_'
op|'('
string|'"Test NoValidHost exception"'
op|')'
op|')'
newline|'\n'
dedent|''
...
op|')'
newline|'\n'
comment|'# assert that the instance goes to ERROR state'
nl|'\n'
name|'self'
op|'.'
name|'_assert_state'
...
newline|'\n'
nl|'\n'
DECL|member|test_no_valid_host_exception_on_run_with_id
dedent|''
name|'def'
name|'test_no_valid_host_exception_on_run_with_id'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
indent|'        '
string|'"""check the vm goes to ERROR state if run_instance fails"""'
newline|'\n'
nl|'\n'
DECL|function|NoValidHost_raiser
name|'def'
...
newline|'\n'
nl|'\n'
DECL|member|test_no_valid_host_exception_on_run_without_id
dedent|''
name|'def'
name|'test_no_valid_host_exception_on_run_without_id'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
indent|'        '
string|'"""check error handler doesn\'t raise if instance wasn\'t created"""'
newline|'\n'
nl|'\n'
DECL|function|NoValidHost_raiser
name|'def'
...
newline|'\n'
nl|'\n'
DECL|member|test_isolation_of_images
dedent|''
name|'def'
name|'test_isolation_of_images'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_non_isolation_of_not_isolated_images
dedent|''
name|'def'
name|'test_non_isolation_of_not_isolated_images'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_isolated_images_are_resource_bound
dedent|''
name|'def'
name|'test_isolated_images_are_resource_bound'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_isolated_images_disable_resource_checking
dedent|''
name|'def'
name|'test_isolated_images_disable_resource_checking'
op|'('
name|'self'
op|')'
op|':'
