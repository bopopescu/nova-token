...
newline|'\n'
nl|'\n'
DECL|function|_fake_filter_hosts
name|'def'
name|'_fake_filter_hosts'
op|'('
name|'topic'
op|','
name|'request_info'
...
newline|'\n'
nl|'\n'
DECL|function|_fake_weigh_hosts
dedent|''
name|'def'
name|'_fake_weigh_hosts'
op|'('
name|'request_info'
op|','
name|'hosts'
