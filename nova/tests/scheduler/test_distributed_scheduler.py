...
newline|'\n'
nl|'\n'
DECL|member|test_populate_filter_properties
dedent|''
name|'def'
name|'test_populate_filter_properties'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
comment|'# No original host results in not ignoring'
nl|'\n'
name|'request_spec'
op|'='
op|'{'
...
newline|'\n'
nl|'\n'
comment|'# Original host but avoid is False should not ignore it'
nl|'\n'
name|'request_spec'
op|'='
op|'{'
...
newline|'\n'
nl|'\n'
comment|'# Original host but avoid is True should ignore it'
nl|'\n'
name|'request_spec'
op|'='
op|'{'
