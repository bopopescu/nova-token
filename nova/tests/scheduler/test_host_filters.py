...
nl|'\n'
nl|'\n'
DECL|function|stub_out_https_backend
name|'def'
name|'stub_out_https_backend'
op|'('
name|'stubs'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|function|fake_do_request
dedent|''
dedent|''
name|'def'
name|'fake_do_request'
op|'('
name|'self'
op|','
op|'*'
...
nl|'\n'
comment|'# when specifying a method (in this case, our standard filters)'
nl|'\n'
name|'classes'
op|'='
name|'filters'
...
newline|'\n'
nl|'\n'
DECL|member|test_ram_filter_sets_memory_limit
dedent|''
name|'def'
name|'test_ram_filter_sets_memory_limit'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
indent|'        '
string|'"""Test that ram filter sets a filter_property denoting the memory\n        ceiling.\n        """'
newline|'\n'
name|'self'
op|'.'
name|'_stub_service_is_up'
...
newline|'\n'
nl|'\n'
DECL|member|test_compute_filter_passes_same_inst_props
dedent|''
name|'def'
name|'test_compute_filter_passes_same_inst_props'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_compute_filter_fails_different_inst_props
dedent|''
name|'def'
name|'test_compute_filter_fails_different_inst_props'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_compute_filter_passes_partial_inst_props
dedent|''
name|'def'
name|'test_compute_filter_passes_partial_inst_props'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_compute_filter_fails_partial_inst_props
dedent|''
name|'def'
name|'test_compute_filter_fails_partial_inst_props'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_compute_filter_passes_without_inst_props
dedent|''
name|'def'
name|'test_compute_filter_passes_without_inst_props'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_compute_filter_fails_without_host_props
dedent|''
name|'def'
name|'test_compute_filter_fails_without_host_props'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_compute_filter_passes_extra_specs_simple1
dedent|''
name|'def'
name|'test_compute_filter_passes_extra_specs_simple1'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_compute_filter_passes_extra_specs_simple2
dedent|''
name|'def'
name|'test_compute_filter_passes_extra_specs_simple2'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_compute_filter_fails_extra_specs_simple1
dedent|''
name|'def'
name|'test_compute_filter_fails_extra_specs_simple1'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_compute_filter_fails_extra_specs_simple2
dedent|''
name|'def'
name|'test_compute_filter_fails_extra_specs_simple2'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_compute_filter_fails_extra_specs_simple3
dedent|''
name|'def'
name|'test_compute_filter_fails_extra_specs_simple3'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_compute_filter_fails_extra_specs_simple4
dedent|''
name|'def'
name|'test_compute_filter_fails_extra_specs_simple4'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_compute_filter_fails_extra_specs_simple5
dedent|''
name|'def'
name|'test_compute_filter_fails_extra_specs_simple5'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_compute_filter_fails_extra_specs_with_bogus_ops
dedent|''
name|'def'
name|'test_compute_filter_fails_extra_specs_with_bogus_ops'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_compute_filter_passes_extra_specs_with_op_eq
dedent|''
name|'def'
name|'test_compute_filter_passes_extra_specs_with_op_eq'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_compute_filter_passes_extra_specs_with_op_eq2
dedent|''
name|'def'
name|'test_compute_filter_passes_extra_specs_with_op_eq2'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_compute_filter_passes_extra_specs_with_op_eq3
dedent|''
name|'def'
name|'test_compute_filter_passes_extra_specs_with_op_eq3'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_compute_filter_fails_extra_specs_with_op_eq
dedent|''
name|'def'
name|'test_compute_filter_fails_extra_specs_with_op_eq'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_compute_filter_fails_extra_specs_with_op_eq3
dedent|''
name|'def'
name|'test_compute_filter_fails_extra_specs_with_op_eq3'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_compute_filter_fails_extra_specs_with_op_eq4
dedent|''
name|'def'
name|'test_compute_filter_fails_extra_specs_with_op_eq4'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_compute_filter_passes_extra_specs_with_op_seq
dedent|''
name|'def'
name|'test_compute_filter_passes_extra_specs_with_op_seq'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_compute_filter_fails_extra_specs_with_op_seq
dedent|''
name|'def'
name|'test_compute_filter_fails_extra_specs_with_op_seq'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_compute_filter_passes_extra_specs_with_op_sneq
dedent|''
name|'def'
name|'test_compute_filter_passes_extra_specs_with_op_sneq'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_compute_filter_fails_extra_specs_with_op_sneq
dedent|''
name|'def'
name|'test_compute_filter_fails_extra_specs_with_op_sneq'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_compute_filter_passes_extra_specs_with_op_sgle
dedent|''
name|'def'
name|'test_compute_filter_passes_extra_specs_with_op_sgle'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_compute_filter_fails_extra_specs_with_op_sge
dedent|''
name|'def'
name|'test_compute_filter_fails_extra_specs_with_op_sge'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_compute_filter_fails_extra_specs_with_op_sle
dedent|''
name|'def'
name|'test_compute_filter_fails_extra_specs_with_op_sle'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_compute_filter_passes_extra_specs_with_op_sgl
dedent|''
name|'def'
name|'test_compute_filter_passes_extra_specs_with_op_sgl'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_compute_filter_fails_extra_specs_with_op_sl
dedent|''
name|'def'
name|'test_compute_filter_fails_extra_specs_with_op_sl'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_compute_filter_fails_extra_specs_with_op_sg
dedent|''
name|'def'
name|'test_compute_filter_fails_extra_specs_with_op_sg'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_compute_filter_passes_extra_specs_with_op_in
dedent|''
name|'def'
name|'test_compute_filter_passes_extra_specs_with_op_in'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_compute_filter_passes_extra_specs_with_op_in2
dedent|''
name|'def'
name|'test_compute_filter_passes_extra_specs_with_op_in2'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_compute_filter_passes_extra_specs_with_op_in3
dedent|''
name|'def'
name|'test_compute_filter_passes_extra_specs_with_op_in3'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_compute_filter_fails_extra_specs_with_op_in
dedent|''
name|'def'
name|'test_compute_filter_fails_extra_specs_with_op_in'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_compute_filter_fails_extra_specs_with_op_in2
dedent|''
name|'def'
name|'test_compute_filter_fails_extra_specs_with_op_in2'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_compute_filter_passes_extra_specs_with_op_or
dedent|''
name|'def'
name|'test_compute_filter_passes_extra_specs_with_op_or'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_compute_filter_passes_extra_specs_with_op_or2
dedent|''
name|'def'
name|'test_compute_filter_passes_extra_specs_with_op_or2'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_compute_filter_fails_extra_specs_with_op_or
dedent|''
name|'def'
name|'test_compute_filter_fails_extra_specs_with_op_or'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_compute_filter_fails_extra_specs_with_op_or2
dedent|''
name|'def'
name|'test_compute_filter_fails_extra_specs_with_op_or2'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_compute_filter_passes_extra_specs_with_op_le
dedent|''
name|'def'
name|'test_compute_filter_passes_extra_specs_with_op_le'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_compute_filter_fails_extra_specs_with_op_le
dedent|''
name|'def'
name|'test_compute_filter_fails_extra_specs_with_op_le'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_compute_filter_passes_extra_specs_with_op_ge
dedent|''
name|'def'
name|'test_compute_filter_passes_extra_specs_with_op_ge'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_compute_filter_fails_extra_specs_with_op_ge
dedent|''
name|'def'
name|'test_compute_filter_fails_extra_specs_with_op_ge'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_aggregate_filter_passes_extra_specs
dedent|''
name|'def'
name|'test_aggregate_filter_passes_extra_specs'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_aggregate_filter_fails_extra_specs
dedent|''
name|'def'
name|'test_aggregate_filter_fails_extra_specs'
op|'('
name|'self'
op|')'
op|':'
...
name|'DATA'
op|'='
string|'\'{"hosts":[{"host_name":"host1","trust_lvl":"trusted"}]}\''
newline|'\n'
name|'self'
op|'.'
name|'_stub_service_is_up'
...
name|'DATA'
op|'='
string|'\'{"hosts":[{"host_name":"host1","trust_lvl":"untrusted"}]}\''
newline|'\n'
name|'self'
op|'.'
name|'_stub_service_is_up'
...
newline|'\n'
nl|'\n'
DECL|member|test_arch_filter_same
dedent|''
name|'def'
name|'test_arch_filter_same'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_arch_filter_different
dedent|''
name|'def'
name|'test_arch_filter_different'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_arch_filter_without_permitted_instances
dedent|''
name|'def'
name|'test_arch_filter_without_permitted_instances'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
indent|'        '
string|'"""Test case where retry/re-scheduling is disabled"""'
newline|'\n'
name|'filt_cls'
op|'='
name|'self'
...
newline|'\n'
indent|'        '
string|'"""Host not previously tried"""'
newline|'\n'
name|'filt_cls'
op|'='
name|'self'
