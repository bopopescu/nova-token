...
op|')'
newline|'\n'
comment|'# filter all hosts that can support 30 ram and 300 disk'
nl|'\n'
name|'cooked'
op|'='
name|'hf'
...
newline|'\n'
nl|'\n'
DECL|member|test_instance_type_filter_reserved_memory
dedent|''
name|'def'
name|'test_instance_type_filter_reserved_memory'
op|'('
name|'self'
op|')'
op|':'
...
op|')'
newline|'\n'
comment|'# filter all hosts that can support 30 ram and 300 disk after'
nl|'\n'
comment|'# reserving 2048 ram'
nl|'\n'
name|'cooked'
op|'='
name|'hf'
