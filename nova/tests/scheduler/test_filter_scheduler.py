...
op|':'
newline|'\n'
comment|'# Test for necessary explosion when max retries is exceeded.'
nl|'\n'
indent|'        '
name|'self'
op|'.'
...
newline|'\n'
nl|'\n'
DECL|member|test_live_migration_dest_check_service_memory_overcommit
dedent|''
name|'def'
name|'test_live_migration_dest_check_service_memory_overcommit'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
comment|'# Live-migration should work since default is to overcommit memory.'
nl|'\n'
name|'self'
op|'.'
name|'mox'
...
newline|'\n'
nl|'\n'
DECL|member|test_live_migration_assert_memory_no_overcommit
dedent|''
name|'def'
name|'test_live_migration_assert_memory_no_overcommit'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
comment|'# Test that memory check passes with no memory overcommit.'
nl|'\n'
DECL|function|fake_get
indent|'        '
name|'def'
...
newline|'\n'
nl|'\n'
DECL|member|test_live_migration_assert_memory_no_overcommit_lack_memory
dedent|''
name|'def'
name|'test_live_migration_assert_memory_no_overcommit_lack_memory'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
comment|'# Test that memory check fails with no memory overcommit.'
nl|'\n'
DECL|function|fake_get
indent|'        '
name|'def'
...
newline|'\n'
nl|'\n'
DECL|member|test_live_migration_assert_memory_overcommit
dedent|''
name|'def'
name|'test_live_migration_assert_memory_overcommit'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
comment|'# Test that memory check passes with memory overcommit.'
nl|'\n'
DECL|function|fake_get
indent|'        '
name|'def'
...
newline|'\n'
nl|'\n'
DECL|member|test_live_migration_assert_memory_overcommit_lack_memory
dedent|''
name|'def'
name|'test_live_migration_assert_memory_overcommit_lack_memory'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
comment|'# Test that memory check fails with memory overcommit.'
nl|'\n'
DECL|function|fake_get
indent|'        '
name|'def'
