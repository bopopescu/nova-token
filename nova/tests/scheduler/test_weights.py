...
newline|'\n'
nl|'\n'
DECL|member|test_all_weighers_with_deprecated_config1
dedent|''
name|'def'
name|'test_all_weighers_with_deprecated_config1'
op|'('
name|'self'
op|')'
op|':'
...
name|'assertIn'
op|'('
string|"'_LeastCostWeigher'"
op|','
name|'class_names'
op|')'
newline|'\n'
nl|'\n'
DECL|member|test_all_weighers_with_deprecated_config2
dedent|''
name|'def'
name|'test_all_weighers_with_deprecated_config2'
op|'('
name|'self'
op|')'
op|':'
