...
name|'Exception'
op|'('
string|'"URI was None, but fake libvirt is configured"'
nl|'\n'
string|'" to not accept this."'
op|')'
newline|'\n'
nl|'\n'
dedent|''
...
op|','
nl|'\n'
string|'"libvir: error : no connection driver "'
nl|'\n'
...
name|'_'
op|'('
string|'"Please extend fake libvirt module to support "'
nl|'\n'
string|'"this auth method"'
op|')'
op|')'
newline|'\n'
nl|'\n'
