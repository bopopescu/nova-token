...
name|'do_test_images'
op|'('
string|"'1mb.manifest.xml'"
op|','
name|'True'
op|','
nl|'\n'
string|"'image_bucket1'"
op|','
string|"'i-testing1'"
op|')'
newline|'\n'
nl|'\n'
DECL|member|test_images_no_kernel_or_ramdisk
dedent|''
name|'def'
name|'test_images_no_kernel_or_ramdisk'
op|'('
name|'self'
op|')'
op|':'
...
name|'do_test_images'
op|'('
string|"'1mb.no_kernel_or_ramdisk.manifest.xml'"
op|','
nl|'\n'
name|'False'
op|','
string|"'image_bucket2'"
op|','
string|"'i-testing2'"
op|')'
newline|'\n'
nl|'\n'
DECL|member|do_test_images
dedent|''
name|'def'
name|'do_test_images'
op|'('
...
name|'manifest_file'
op|','
name|'expect_kernel_and_ramdisk'
op|','
nl|'\n'
name|'image_bucket'
op|','
...
op|':'
newline|'\n'
comment|'# Verify the default kernel and ramdisk are set'
nl|'\n'
indent|'            '
name|'self'
op|'.'
...
op|':'
newline|'\n'
comment|'# Verify that the default kernel and ramdisk (the one from FLAGS)'
nl|'\n'
comment|"# doesn't get embedded in the metadata"
nl|'\n'
indent|'            '
name|'self'
op|'.'
