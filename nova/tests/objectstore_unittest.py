...
nl|'\n'
comment|'# TODO: This fails on the test box with a permission denied error'
nl|'\n'
comment|'# Also, doing these things in a global tempdir means that different runs of'
nl|'\n'
comment|'# the test suite on the same box could clobber each other.'
nl|'\n'
comment|"#for path in glob.glob(os.path.abspath(os.path.join(oss_tempdir, '../test_oss-*'))):"
nl|'\n'
comment|'#    if path != oss_tempdir:'
nl|'\n'
comment|'#        shutil.rmtree(path)'
nl|'\n'
nl|'\n'
nl|'\n'
...
op|':'
newline|'\n'
comment|'# Otherwise we end up with an unclean reactor'
nl|'\n'
...
newline|'\n'
nl|'\n'
comment|"# Don't attempt to reuse connections"
nl|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|_ensure_empty_list
dedent|''
name|'def'
name|'_ensure_empty_list'
op|'('
name|'self'
op|','
name|'l'
...
newline|'\n'
nl|'\n'
DECL|member|_ensure_only_bucket
dedent|''
name|'def'
name|'_ensure_only_bucket'
op|'('
name|'self'
op|','
name|'l'
...
number|'1'
op|','
string|'"List didn\'t have exactly one element in it"'
op|')'
newline|'\n'
name|'self'
op|'.'
...
newline|'\n'
nl|'\n'
DECL|function|ensure_only_bucket
name|'def'
name|'ensure_only_bucket'
op|'('
name|'l'
op|','
name|'name'
