...
nl|'\n'
comment|'#    self.manager = manager.AuthManager()'
nl|'\n'
comment|"#    self.user = self.manager.create_user('fake', 'fake', 'fake',"
nl|'\n'
comment|'#                                         admin=True)'
nl|'\n'
comment|"#    self.project = self.manager.create_project('fake', 'fake', 'fake')"
nl|'\n'
...
nl|'\n'
comment|'#    self.manager.delete_project(self.project)'
nl|'\n'
comment|'#    self.manager.delete_user(self.user)'
nl|'\n'
