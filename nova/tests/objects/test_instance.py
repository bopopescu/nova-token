...
newline|'\n'
nl|'\n'
DECL|member|test_save_exp_task_state_havana
dedent|''
name|'def'
name|'test_save_exp_task_state_havana'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_compat_strings
dedent|''
name|'def'
name|'test_compat_strings'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_compat_pci_devices
dedent|''
name|'def'
name|'test_compat_pci_devices'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_compat_info_cache
dedent|''
name|'def'
name|'test_compat_info_cache'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|_test_get_flavor
dedent|''
name|'def'
name|'_test_get_flavor'
op|'('
name|'self'
op|','
name|'namespace'
...
newline|'\n'
nl|'\n'
DECL|member|_test_set_flavor
dedent|''
name|'def'
name|'_test_set_flavor'
op|'('
name|'self'
op|','
name|'namespace'
...
newline|'\n'
nl|'\n'
DECL|member|test_set_flavor
dedent|''
name|'def'
name|'test_set_flavor'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_delete_flavor_no_namespace_fails
dedent|''
name|'def'
name|'test_delete_flavor_no_namespace_fails'
op|'('
name|'self'
op|')'
op|':'
...
nl|'\n'
nl|'\n'
DECL|class|TestAddImageRef
dedent|''
dedent|''
name|'class'
name|'TestAddImageRef'
op|'('
name|'test'
op|'.'
name|'TestCase'
...
name|'patch'
op|'('
string|"'nova.objects.BlockDeviceMappingList.root_metadata'"
op|')'
newline|'\n'
DECL|member|test_add_image_ref
name|'def'
name|'test_add_image_ref'
op|'('
name|'self'
op|','
name|'mock_root_metadata'
op|')'
op|':'
newline|'\n'
indent|'        '
