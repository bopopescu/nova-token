...
newline|'\n'
nl|'\n'
DECL|member|echo_data_directly
dedent|''
name|'def'
name|'echo_data_directly'
op|'('
name|'self'
op|','
name|'context'
...
newline|'\n'
nl|'\n'
DECL|member|test_filter_json_params
dedent|''
name|'def'
name|'test_filter_json_params'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_filter_post_params
dedent|''
name|'def'
name|'test_filter_post_params'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_string_resp
dedent|''
name|'def'
name|'test_string_resp'
op|'('
name|'self'
op|')'
op|':'
...
name|'blank'
op|'('
string|"'/fake/echo_data_directly'"
op|')'
newline|'\n'
name|'req'
op|'.'
...
nl|'\n'
nl|'\n'
DECL|class|LimitedTestCase
dedent|''
dedent|''
name|'class'
name|'LimitedTestCase'
op|'('
name|'test'
op|'.'
name|'TestCase'
...
op|':'
newline|'\n'
DECL|member|test_limited_class_getattr
indent|'    '
name|'def'
name|'test_limited_class_getattr'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
comment|'# Allowed are still visible'
nl|'\n'
name|'self'
op|'.'
name|'assertTrue'
...
newline|'\n'
nl|'\n'
comment|'# Non-allowed are no longer visible'
nl|'\n'
name|'self'
op|'.'
name|'assertRaises'
...
newline|'\n'
nl|'\n'
DECL|member|test_limited_class_dir
dedent|''
name|'def'
name|'test_limited_class_dir'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_limited_class_no_allowed
dedent|''
name|'def'
name|'test_limited_class_no_allowed'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
nl|'\n'
comment|'# New MyLimited class with no _allowed variable'
nl|'\n'
DECL|class|MyLimited
indent|'        '
name|'class'
...
newline|'\n'
nl|'\n'
comment|'# Nothing in MyProxy object visible now'
nl|'\n'
name|'self'
op|'.'
name|'assertNotIn'
