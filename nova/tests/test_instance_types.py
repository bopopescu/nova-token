...
newline|'\n'
indent|'        '
string|'"""Ensure instance types raises InvalidInput for invalid characters"""'
newline|'\n'
name|'name'
op|'='
...
newline|'\n'
indent|'        '
string|'"""Ensure destroy said path of no name raises error"""'
newline|'\n'
name|'self'
op|'.'
name|'assertRaises'
...
newline|'\n'
indent|'        '
string|'"""Ensure deleted instance types can be read when querying flavor_id"""'
newline|'\n'
name|'inst_type_name'
op|'='
string|'"test"'
...
nl|'\n'
comment|'# in get_instance_type_by_flavor_id() is set to use read_deleted.'
nl|'\n'
name|'instance_types'
op|'.'
name|'destroy'
...
newline|'\n'
indent|'        '
string|'"""Ensure deleted instance types with active instances can be read"""'
newline|'\n'
name|'ctxt'
op|'='
name|'context'
