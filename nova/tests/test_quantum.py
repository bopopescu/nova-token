...
newline|'\n'
nl|'\n'
comment|'# Create an actual project -- with this we will touch more of'
nl|'\n'
comment|'# the code in QuantumManager (related to fetching networks, etc)'
nl|'\n'
name|'for'
name|'x'
name|'in'
