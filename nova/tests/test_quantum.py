...
nl|'\n'
comment|"# don't want.  So we delete them."
nl|'\n'
nl|'\n'
name|'ctx'
op|'='
...
newline|'\n'
nl|'\n'
comment|"# I've found that other unit tests have a nasty habit of"
nl|'\n'
comment|'# of creating fixed IPs and not cleaning up, which can'
nl|'\n'
comment|'# confuse these tests, so we clean them all.'
nl|'\n'
dedent|''
name|'session'
op|'='
...
newline|'\n'
nl|'\n'
comment|'# Cannot run this unit tests auotmatically for now, as it requires'
nl|'\n'
comment|'# melange to be running locally.'
nl|'\n'
comment|'#'
nl|'\n'
