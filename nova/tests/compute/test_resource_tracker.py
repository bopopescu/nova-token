...
newline|'\n'
nl|'\n'
comment|"# the expired claim's instance is assumed to still exist, so the"
nl|'\n'
comment|'# resources should be counted:'
nl|'\n'
name|'self'
op|'.'
name|'assertEqual'
...
newline|'\n'
nl|'\n'
comment|'# this abort should do nothing because the claim was purged due to'
nl|'\n'
comment|'# expiration:'
nl|'\n'
name|'self'
...
newline|'\n'
nl|'\n'
comment|'# should have usage from both instances:'
nl|'\n'
name|'self'
op|'.'
name|'assertEqual'
