...
newline|'\n'
nl|'\n'
DECL|member|_fake_instance_type_create
dedent|''
name|'def'
name|'_fake_instance_type_create'
op|'('
name|'self'
op|','
op|'**'
...
newline|'\n'
nl|'\n'
DECL|member|_fake_instance_type_get
dedent|''
name|'def'
name|'_fake_instance_type_get'
op|'('
...
newline|'\n'
nl|'\n'
DECL|member|testDisabledResizeClaim
dedent|''
name|'def'
name|'testDisabledResizeClaim'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|testDisabledResizeContextClaim
dedent|''
name|'def'
name|'testDisabledResizeContextClaim'
op|'('
name|'self'
op|')'
op|':'
...
name|'db'
op|','
string|"'migration_get_in_progress_by_host'"
op|','
nl|'\n'
name|'self'
op|'.'
name|'_fake_migration_get_in_progress_by_host'
op|')'
newline|'\n'
nl|'\n'
name|'self'
...
newline|'\n'
nl|'\n'
DECL|member|_fake_migration_get_in_progress_by_host
dedent|''
name|'def'
name|'_fake_migration_get_in_progress_by_host'
op|'('
...
nl|'\n'
comment|'# resources should still be help at the source based on the'
nl|'\n'
comment|'# migration:'
nl|'\n'
indent|'        '
...
newline|'\n'
nl|'\n'
DECL|member|test_set_instance_host
dedent|''
name|'def'
name|'test_set_instance_host'
op|'('
name|'self'
op|')'
op|':'
