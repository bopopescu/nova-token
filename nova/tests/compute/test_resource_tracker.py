...
nl|'\n'
nl|'\n'
DECL|class|DeletedNodeTestCase
dedent|''
dedent|''
name|'class'
name|'DeletedNodeTestCase'
op|'('
name|'BaseTrackerTestCase'
op|')'
op|':'
newline|'\n'
nl|'\n'
DECL|member|test_remove_deleted_node
indent|'    '
name|'def'
name|'test_remove_deleted_node'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|function|_get_available_resource
name|'def'
name|'_get_available_resource'
op|'('
name|'nodename'
op|')'
op|':'
