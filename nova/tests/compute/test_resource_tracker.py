...
name|'self'
op|'.'
name|'_fake_instance_get_all_by_filters'
op|')'
newline|'\n'
nl|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|_fake_instance_get_all_by_filters
dedent|''
name|'def'
name|'_fake_instance_get_all_by_filters'
op|'('
...
newline|'\n'
nl|'\n'
DECL|member|testDisabledContextClaim
dedent|''
name|'def'
name|'testDisabledContextClaim'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
comment|'# basic context manager variation:'
nl|'\n'
indent|'        '
name|'with'
name|'self'
...
newline|'\n'
nl|'\n'
DECL|member|testDisabledFreeResources
dedent|''
name|'def'
name|'testDisabledFreeResources'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|testInsufficientMemoryClaim
dedent|''
name|'def'
name|'testInsufficientMemoryClaim'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
indent|'        '
string|'"""Exceed memory limit of 5MB"""'
newline|'\n'
name|'claim'
op|'='
name|'self'
...
newline|'\n'
nl|'\n'
DECL|member|testInsufficientDiskClaim
dedent|''
name|'def'
name|'testInsufficientDiskClaim'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
indent|'        '
string|'"""Exceed disk limit of 5GB"""'
newline|'\n'
name|'claim'
op|'='
name|'self'
...
newline|'\n'
nl|'\n'
comment|'# 2nd update compute node from the virt layer.  because the claim is'
nl|'\n'
comment|'# in-progress (unfinished), the audit will actually mark the resources'
nl|'\n'
comment|'# as unsubscribed:'
nl|'\n'
name|'self'
op|'.'
name|'tracker'
...
newline|'\n'
nl|'\n'
DECL|member|testExpiredClaims
dedent|''
name|'def'
name|'testExpiredClaims'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
indent|'        '
string|'"""Test that old claims get cleaned up automatically if not finished\n        or aborted explicitly.\n        """'
newline|'\n'
name|'claim'
op|'='
name|'self'
...
newline|'\n'
nl|'\n'
comment|'# and an unexpired claim'
nl|'\n'
name|'claim2'
op|'='
name|'self'
...
newline|'\n'
nl|'\n'
comment|'# expired claims get expunged when audit runs:'
nl|'\n'
name|'self'
op|'.'
name|'tracker'
...
newline|'\n'
nl|'\n'
comment|'# and just call finish & abort to ensure expired claims do not cause'
nl|'\n'
comment|'# any other explosions:'
nl|'\n'
name|'self'
op|'.'
name|'tracker'
...
newline|'\n'
nl|'\n'
DECL|member|testContextClaim
dedent|''
name|'def'
name|'testContextClaim'
op|'('
name|'self'
op|')'
op|':'
