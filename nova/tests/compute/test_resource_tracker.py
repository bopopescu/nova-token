...
name|'self'
op|'.'
name|'_fake_instance_extra_get_by_instance_uuid'
op|')'
newline|'\n'
name|'self'
op|'.'
...
newline|'\n'
nl|'\n'
DECL|member|_fake_instance_extra_get_by_instance_uuid
dedent|''
name|'def'
name|'_fake_instance_extra_get_by_instance_uuid'
op|'('
...
newline|'\n'
nl|'\n'
DECL|member|test_create_resource
dedent|''
name|'def'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_instance_type_stash_false
dedent|''
name|'def'
name|'test_get_instance_type_stash_false'
op|'('
name|'self'
op|')'
op|':'
...
nl|'\n'
nl|'\n'
DECL|class|StatsJsonTestCase
dedent|''
dedent|''
name|'class'
name|'StatsJsonTestCase'
op|'('
name|'BaseTrackerTestCase'
op|')'
op|':'
...
nl|'\n'
nl|'\n'
DECL|class|StatsInvalidJsonTestCase
dedent|''
dedent|''
name|'class'
name|'StatsInvalidJsonTestCase'
op|'('
name|'BaseTrackerTestCase'
op|')'
op|':'
...
op|':'
newline|'\n'
comment|'# should throw exception for string that does not parse as json'
nl|'\n'
indent|'        '
name|'self'
op|'.'
