...
newline|'\n'
nl|'\n'
DECL|member|test_notify_usage_exists_fail_on_deleted_instance
dedent|''
name|'def'
name|'test_notify_usage_exists_fail_on_deleted_instance'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
comment|'# notify_usage_exists should not work for a deleted VM. A'
nl|'\n'
comment|'# notification should be done before the instance is deleted in the db.'
nl|'\n'
indent|'        '
name|'instance_id'
op|'='
