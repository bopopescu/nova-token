...
op|')'
newline|'\n'
comment|'# NOTE(danms): Eventually these should all be migrated to the'
nl|'\n'
comment|'# conductor, but until then, dispatch appropriately.'
nl|'\n'
name|'cls'
op|'.'
name|'conductor_methods'
op|'='
op|'['
string|"'instance_update'"
op|','
...
name|'Exception'
op|'('
string|'\'Method "%s" not known to this test!\''
op|')'
newline|'\n'
nl|'\n'
dedent|''
