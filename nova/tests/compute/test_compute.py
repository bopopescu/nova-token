...
op|':'
newline|'\n'
comment|'# Ensure instance can be live_snapshotted.'
nl|'\n'
indent|'        '
name|'instance'
op|'='
...
newline|'\n'
nl|'\n'
DECL|member|test_snapshot_mindisk_with_bigger_flavor
dedent|''
name|'def'
name|'test_snapshot_mindisk_with_bigger_flavor'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
indent|'        '
string|'"""If minDisk is smaller than flavor root_gb, the latter should be\n        used as minDisk\n        """'
newline|'\n'
name|'self'
op|'.'
name|'fake_image'
...
newline|'\n'
nl|'\n'
DECL|member|test_cell_compute_api_class_name_deprecated
dedent|''
name|'def'
name|'test_cell_compute_api_class_name_deprecated'
op|'('
name|'self'
op|')'
op|':'
