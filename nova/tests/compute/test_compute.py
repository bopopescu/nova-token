...
newline|'\n'
nl|'\n'
DECL|member|test_attach_volume_no_bdm
dedent|''
dedent|''
name|'def'
name|'test_attach_volume_no_bdm'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_poll_bandwidth_usage_disabled
dedent|''
name|'def'
name|'test_poll_bandwidth_usage_disabled'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_instance_volume_block_device_info_passed_bdms
dedent|''
dedent|''
name|'def'
name|'test_get_instance_volume_block_device_info_passed_bdms'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
indent|'        '
string|'"""Ensure expected exception is raised if set_admin_password not\n        authorized.\n        """'
newline|'\n'
name|'exc'
op|'='
name|'exception'
...
newline|'\n'
nl|'\n'
DECL|member|_run_instance_reschedules_on_anti_affinity_violation
dedent|''
name|'def'
name|'_run_instance_reschedules_on_anti_affinity_violation'
op|'('
name|'self'
op|','
name|'group'
...
newline|'\n'
nl|'\n'
DECL|member|test_run_instance_reschedules_on_anti_affinity_violation_by_name
dedent|''
name|'def'
name|'test_run_instance_reschedules_on_anti_affinity_violation_by_name'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_run_instance_reschedules_on_anti_affinity_violation_by_uuid
dedent|''
name|'def'
name|'test_run_instance_reschedules_on_anti_affinity_violation_by_uuid'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_cleanup_running_deleted_instances_unrecognized_value
dedent|''
name|'def'
name|'test_cleanup_running_deleted_instances_unrecognized_value'
op|'('
name|'self'
op|')'
op|':'
...
op|':'
newline|'\n'
comment|'# We cannot simply use an assertRaises here because the'
nl|'\n'
comment|'# exception raised is too generally "Exception". To be sure'
nl|'\n'
comment|'# that the exception raised is the expected one, we check'
nl|'\n'
comment|'# the message.'
nl|'\n'
indent|'                '
...
name|'patch'
op|'('
string|"'nova.objects.instance.InstanceList.get_by_filters'"
op|')'
newline|'\n'
op|'@'
name|'mock'
...
op|':'
newline|'\n'
comment|'# Tests that no instances are set to error state when there is no'
nl|'\n'
comment|'# instance_build_timeout configured.'
nl|'\n'
indent|'        '
name|'self'
op|'.'
...
newline|'\n'
nl|'\n'
comment|'# need something to return from conductor_api.instance_update'
nl|'\n'
comment|'# that is defined outside the for loop and can be used in the mock'
nl|'\n'
comment|'# context'
nl|'\n'
name|'fake_instance_ref'
op|'='
op|'{'
string|"'host'"
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_instance_create_auto_creates_group
dedent|''
name|'def'
name|'test_instance_create_auto_creates_group'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
comment|'# On a second instance, make sure it gets added to the group that was'
nl|'\n'
comment|'# auto-created above'
nl|'\n'
op|'('
name|'refs2'
op|','
...
newline|'\n'
nl|'\n'
DECL|member|test_shutdown_instance_fail_instance_info_cache_not_found
dedent|''
dedent|''
name|'def'
name|'test_shutdown_instance_fail_instance_info_cache_not_found'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
comment|'# Covers the case that _shutdown_instance fails with an'
nl|'\n'
comment|'# InstanceInfoCacheNotFound exception when getting instance network'
nl|'\n'
comment|'# information prior to calling driver.destroy.'
nl|'\n'
indent|'        '
...
name|'compute'
op|','
string|"'_try_deallocate_network'"
op|')'
nl|'\n'
op|')'
name|'as'
...
op|','
nl|'\n'
name|'_get_instance_nw_info_mock'
op|','
nl|'\n'
name|'_get_instance_volume_block_device_info_mock'
op|','
nl|'\n'
name|'destroy_mock'
op|','
nl|'\n'
name|'_try_deallocate_network_mock'
nl|'\n'
op|')'
op|':'
newline|'\n'
...
op|')'
newline|'\n'
comment|'# By asserting that _try_deallocate_network_mock was called'
nl|'\n'
comment|'# exactly once, we know that _get_instance_nw_info raising'
nl|'\n'
comment|'# InstanceInfoCacheNotFound did not make _shutdown_instance error'
nl|'\n'
comment|'# out and driver.destroy was still called.'
nl|'\n'
name|'_try_deallocate_network_mock'
op|'.'
name|'assert_called_once_with'
...
newline|'\n'
nl|'\n'
DECL|member|test_no_reschedule_on_block_device_fail
dedent|''
name|'def'
name|'test_no_reschedule_on_block_device_fail'
op|'('
name|'self'
op|')'
op|':'
