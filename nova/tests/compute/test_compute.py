...
op|','
nl|'\n'
string|"'_send_volume_usage_notifications'"
op|')'
newline|'\n'
name|'self'
op|'.'
...
newline|'\n'
nl|'\n'
DECL|member|test_send_volume_usage_notifications
dedent|''
name|'def'
name|'test_send_volume_usage_notifications'
op|'('
name|'self'
op|')'
op|':'
...
name|'flavors'
op|','
string|"'delete_instance_type_info'"
op|')'
newline|'\n'
name|'self'
op|'.'
...
name|'flavors'
op|','
string|"'save_instance_type_info'"
op|')'
newline|'\n'
name|'if'
name|'revert'
...
newline|'\n'
nl|'\n'
DECL|member|test_init_instance_reverts_crashed_migrations
dedent|''
name|'def'
name|'test_init_instance_reverts_crashed_migrations'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|function|fake_extract_instance_type
name|'def'
name|'fake_extract_instance_type'
op|'('
name|'_inst'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_soft_reboot_of_rescued_instance
dedent|''
name|'def'
name|'test_soft_reboot_of_rescued_instance'
op|'('
name|'self'
op|')'
op|':'
...
nl|'\n'
nl|'\n'
DECL|class|GetAndCheckImageMetadataTest
dedent|''
dedent|''
name|'class'
name|'GetAndCheckImageMetadataTest'
op|'('
name|'test'
op|'.'
name|'TestCase'
...
newline|'\n'
nl|'\n'
DECL|member|assertCheckSucceedsWithWonkySize
dedent|''
name|'def'
name|'assertCheckSucceedsWithWonkySize'
op|'('
name|'self'
op|','
name|'size'
...
name|'compute'
op|'.'
name|'_get_and_check_image_metadata'
op|'('
nl|'\n'
name|'self'
op|'.'
...
newline|'\n'
nl|'\n'
DECL|member|test_size_not_present_on_image
dedent|''
name|'def'
name|'test_size_not_present_on_image'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_invalid_image_size
dedent|''
name|'def'
name|'test_invalid_image_size'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_image_size_present_but_empty
dedent|''
name|'def'
name|'test_image_size_present_but_empty'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_image_size_is_none
dedent|''
name|'def'
name|'test_image_size_is_none'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_root_gb_zero
dedent|''
name|'def'
name|'test_root_gb_zero'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_image_ref_is_none
dedent|''
name|'def'
name|'test_image_ref_is_none'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_image_not_too_large
dedent|''
name|'def'
name|'test_image_not_too_large'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_value_is_bool_like_string
dedent|''
name|'def'
name|'test_value_is_bool_like_string'
op|'('
name|'self'
op|')'
op|':'
...
op|':'
newline|'\n'
comment|"# NOTE(sirp): '0' and '1' could be a bool value or an ID.  Since there"
nl|'\n'
comment|"# are many other ways to specify bools (e.g. 't', 'f'), it's better to"
nl|'\n'
comment|'# treat as an ID.'
nl|'\n'
indent|'        '
name|'self'
op|'.'
