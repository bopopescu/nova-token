...
newline|'\n'
nl|'\n'
DECL|member|test_value_is_none
dedent|''
name|'def'
name|'test_value_is_none'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_bool_string_or_id
dedent|''
name|'def'
name|'test_bool_string_or_id'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_value_is_image_id
dedent|''
name|'def'
name|'test_value_is_image_id'
op|'('
name|'self'
op|')'
op|':'
