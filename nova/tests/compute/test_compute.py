...
newline|'\n'
nl|'\n'
DECL|member|test_default_block_device_names_calls_db_update
dedent|''
name|'def'
name|'test_default_block_device_names_calls_db_update'
op|'('
name|'self'
op|')'
op|':'
...
op|','
nl|'\n'
string|"'default_root_device_name'"
op|')'
newline|'\n'
name|'self'
op|'.'
...
op|','
nl|'\n'
string|"'default_device_names_for_instance'"
op|')'
newline|'\n'
name|'self'
op|'.'
