...
op|')'
newline|'\n'
comment|"# Reset this to None for this policy check. If it's set, it"
nl|'\n'
comment|"# tries to do a compute_api.update() and we're not testing for"
nl|'\n'
comment|'# that here.'
nl|'\n'
name|'instance'
...
string|"'/5StU3JCrBR2r1s1j8K1tux+5XeSvdqaM8lMFNorzbY5iyoBbRS56gy'"
string|"'1jmm43QsMPJsrpfUZKcJpRENSe3OxIIwWXRoiapZe78u/a9xKwj0avF'"
string|"'YMcws9Rk9iAB7W4K1nEJbyCPl5lRBoyqeHBqrnnuXWEgGxJCK0Ah6wc'"
string|"'OzwlEiVjdf4kxzXrwPHyi7Ea1qvnNXTziF8yYmUlH4C8UXfpTQckwSw'"
string|"'pDyxZUc63P8q+vPbs3Q2kw+/7vvkCKHJAXVI+oCiyMMfffoTq16M1xf'"
string|"'V58JstgtTqAXG+ZFpicGajREUE/E3hO5MGgcHmyzIrWHKpe1n3oEGuz'"
newline|'\n'
name|'self'
op|'.'
name|'fingerprint'
...
op|':'
newline|'\n'
DECL|function|db_key_pair_count_by_user_max
indent|'        '
name|'def'
name|'db_key_pair_count_by_user_max'
op|'('
name|'self'
op|','
name|'user_id'
