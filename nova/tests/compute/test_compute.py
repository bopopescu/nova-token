...
nl|'\n'
nl|'\n'
comment|'# NOTE(ndipanov): ATM only last ephemeral is supported.'
nl|'\n'
comment|'#                 others are ignored for now'
nl|'\n'
comment|"#{'virtual_name': 'ephemeral1', 'device_name': '/dev/sdc1'},"
nl|'\n'
comment|"#{'virtual_name': 'ephemeral2', 'device_name': '/dev/sdc2'}"
nl|'\n'
op|']'
newline|'\n'
name|'bdms'
