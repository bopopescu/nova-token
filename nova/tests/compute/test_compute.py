...
name|'compute'
op|','
string|"'_add_instance_fault_from_exc'"
op|','
nl|'\n'
name|'did_it_add_fault'
op|')'
...
newline|'\n'
nl|'\n'
DECL|member|test_create_instance_insufficient_memory
dedent|''
dedent|''
name|'def'
name|'test_create_instance_insufficient_memory'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_create_instance_insufficient_disk
dedent|''
name|'def'
name|'test_create_instance_insufficient_disk'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
comment|'# Make sure these methods work with both instance and instance_uuid'
nl|'\n'
nl|'\n'
name|'self'
op|'.'
...
newline|'\n'
nl|'\n'
comment|'# Make sure it works with both an instance and instance_uuid'
nl|'\n'
name|'self'
op|'.'
name|'compute'
...
newline|'\n'
nl|'\n'
comment|"# Fetch the instance's task_state and make sure it went to None"
nl|'\n'
name|'instance'
op|'='
name|'db'
...
name|'Exception'
op|'('
string|'"This fails every single time!"'
op|')'
newline|'\n'
nl|'\n'
dedent|''
...
name|'compute'
op|'.'
name|'_add_instance_fault_from_exc'
op|'('
name|'ctxt'
op|','
name|'instance_uuid'
