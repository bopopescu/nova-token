...
op|','
nl|'\n'
string|"'_get_instances_at_startup'"
op|')'
newline|'\n'
name|'self'
op|'.'
...
op|')'
newline|'\n'
comment|'# VerifyCall done by tearDown'
nl|'\n'
nl|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|_pretend_fake_host_exists
dedent|''
name|'def'
name|'_pretend_fake_host_exists'
op|'('
name|'self'
op|','
name|'ctxt'
