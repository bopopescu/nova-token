...
newline|'\n'
indent|'        '
string|'"""Default of memory limit=None is unlimited"""'
newline|'\n'
name|'self'
op|'.'
name|'flags'
...
newline|'\n'
indent|'        '
string|'"""Test passing of oversubscribed ram policy from the scheduler."""'
newline|'\n'
nl|'\n'
name|'self'
op|'.'
...
newline|'\n'
indent|'        '
string|'"""Test passing of oversubscribed cpu policy from the scheduler."""'
newline|'\n'
nl|'\n'
name|'self'
op|'.'
...
newline|'\n'
indent|'        '
string|'"""Test passing of oversubscribed disk policy from the scheduler."""'
newline|'\n'
nl|'\n'
name|'self'
op|'.'
...
newline|'\n'
indent|'        '
string|'"""Create instance with no image provided"""'
newline|'\n'
name|'params'
op|'='
op|'{'
...
newline|'\n'
indent|'        '
string|'"""Ensure instance can be rebuilt when started with no image"""'
newline|'\n'
name|'params'
op|'='
op|'{'
...
newline|'\n'
nl|'\n'
DECL|member|test_reboot_nwinfo
dedent|''
name|'def'
name|'test_reboot_nwinfo'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
indent|'        '
string|'"""Ensure instance network info is rehydrated in reboot"""'
newline|'\n'
name|'instance'
op|'='
name|'jsonutils'
...
newline|'\n'
nl|'\n'
comment|'# NOTE(danms): Beware the dragons ahead:'
nl|'\n'
comment|'# Since the _legacy_nw_info() method in manager runs inside a'
nl|'\n'
comment|"# try..except block, we can't assert from here. Further, this"
nl|'\n'
comment|"# will be run more than once during the operation we're about"
nl|'\n'
comment|"# to fire off, which means we need to make sure that it doesn't"
nl|'\n'
comment|'# fail any of the times it is run. Hence the obscurity below.'
nl|'\n'
DECL|function|fake_legacy_nw_info
name|'def'
name|'fake_legacy_nw_info'
op|'('
name|'network_info'
op|')'
op|':'
...
newline|'\n'
indent|'        '
string|'"""ensure that task_state is reverted after a failed operation"""'
newline|'\n'
name|'actions'
op|'='
op|'['
...
newline|'\n'
nl|'\n'
DECL|member|test_startup_conductor_ping
dedent|''
name|'def'
name|'test_startup_conductor_ping'
op|'('
name|'self'
op|')'
op|':'
...
name|'compute'
op|'.'
name|'_get_instances_at_startup'
op|'('
name|'self'
op|'.'
name|'context'
...
newline|'\n'
nl|'\n'
DECL|member|test_init_host_with_evacuated_instances_uuid_list
dedent|''
name|'def'
name|'test_init_host_with_evacuated_instances_uuid_list'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|function|fake_get_admin_context
name|'def'
name|'fake_get_admin_context'
op|'('
op|')'
op|':'
newline|'\n'
...
newline|'\n'
nl|'\n'
DECL|function|fake_list_instance_uuids
dedent|''
name|'def'
name|'fake_list_instance_uuids'
op|'('
op|')'
op|':'
newline|'\n'
...
op|','
nl|'\n'
comment|'# and this one already been evacuated to other host'
nl|'\n'
name|'evacuated_instance'
op|'['
string|"'uuid'"
...
newline|'\n'
nl|'\n'
DECL|member|test_init_host_with_evacuated_instances_names_list
dedent|''
dedent|''
name|'def'
name|'test_init_host_with_evacuated_instances_names_list'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|function|fake_list_instances
dedent|''
name|'def'
name|'fake_list_instances'
op|'('
op|')'
op|':'
newline|'\n'
...
newline|'\n'
indent|'        '
string|'"""Test an instance type with too much user data."""'
newline|'\n'
nl|'\n'
name|'inst_type'
op|'='
...
newline|'\n'
indent|'        '
string|'"""Test an instance type with malformed user data."""'
newline|'\n'
nl|'\n'
name|'inst_type'
op|'='
...
newline|'\n'
indent|'        '
string|'"""Test an instance type with ok much user data."""'
newline|'\n'
nl|'\n'
name|'inst_type'
op|'='
...
newline|'\n'
indent|'        '
string|'"""Ensure instance can be hard rebooted while soft rebooting"""'
newline|'\n'
name|'instance'
op|'='
name|'jsonutils'
...
newline|'\n'
indent|'        '
string|'"""Ensure instance can\'t be soft rebooted while rebooting"""'
newline|'\n'
name|'instance'
op|'='
name|'jsonutils'
...
newline|'\n'
indent|'        '
string|'"""Test api call to get backdoor_port"""'
newline|'\n'
...
newline|'\n'
indent|'        '
string|'"""Make sure that volumes get detached during instance termination"""'
newline|'\n'
name|'admin'
op|'='
name|'context'
...
newline|'\n'
indent|'        '
string|'"""Test handling of exception from _reschedule"""'
newline|'\n'
name|'instance_uuid'
op|'='
name|'self'
...
newline|'\n'
indent|'        '
string|'"""Test not-rescheduling, but no nested exception"""'
newline|'\n'
name|'instance_uuid'
op|'='
name|'self'
...
newline|'\n'
indent|'        '
string|'"""Test behavior when re-scheduling happens"""'
newline|'\n'
name|'instance_uuid'
op|'='
name|'self'
...
newline|'\n'
indent|'        '
string|'"""If rescheduled, the original resize exception should be logged"""'
newline|'\n'
name|'method_args'
op|'='
op|'('
...
newline|'\n'
indent|'        '
string|'"""Make sure we can\'t start an instance with a deleted image."""'
newline|'\n'
name|'inst_type'
op|'='
name|'instance_types'
