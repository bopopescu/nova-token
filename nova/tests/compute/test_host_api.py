...
newline|'\n'
nl|'\n'
DECL|member|_test_service_get_all
dedent|''
name|'def'
name|'_test_service_get_all'
op|'('
name|'self'
op|','
name|'fake_filters'
...
newline|'\n'
nl|'\n'
DECL|member|test_service_get_all_set_zones
dedent|''
name|'def'
name|'test_service_get_all_set_zones'
op|'('
name|'self'
op|')'
op|':'
...
op|':'
newline|'\n'
comment|'# The corresponding Compute test case depends on the'
nl|'\n'
