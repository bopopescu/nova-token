...
name|'patch'
op|'('
string|"'nova.objects.instance.Instance._from_db_object'"
op|')'
newline|'\n'
...
newline|'\n'
nl|'\n'
comment|'# NOTE(mriedem): Currently instance.save is only called for'
nl|'\n'
comment|"# NotImplementedError so if that's not the expected_exception then"
nl|'\n'
comment|'# we have to check update_mock.'
nl|'\n'
name|'if'
name|'expected_exception'
op|'=='
...
op|'['
nl|'\n'
comment|'# _set_instance_error_state'
nl|'\n'
name|'mock'
op|'.'
name|'call'
...
newline|'\n'
nl|'\n'
DECL|member|test_init_host_with_partial_migration
dedent|''
name|'def'
name|'test_init_host_with_partial_migration'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_build_and_run_instance_exceptions
dedent|''
name|'def'
name|'test_build_and_run_instance_exceptions'
op|'('
name|'self'
op|')'
op|':'
