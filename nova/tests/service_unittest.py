...
op|')'
newline|'\n'
comment|'#self.mox.StubOutWithMock('
nl|'\n'
comment|"#        service.task, 'LoopingCall', use_mock_anything=True)"
nl|'\n'
name|'rpc'
op|'.'
...
nl|'\n'
comment|'#service.task.LoopingCall(mox.IgnoreArg()).AndReturn('
nl|'\n'
comment|'#                service.task.LoopingCall)'
nl|'\n'
comment|'#service.task.LoopingCall.start(interval=mox.IgnoreArg(),'
nl|'\n'
comment|'#                               now=mox.IgnoreArg())'
nl|'\n'
comment|'#service.task.LoopingCall(mox.IgnoreArg()).AndReturn('
nl|'\n'
comment|'#                service.task.LoopingCall)'
