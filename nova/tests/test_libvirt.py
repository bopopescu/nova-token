...
name|'dummyjson'
op|'='
string|'\'[{"path": "%s/disk", "local_gb": 10, "type": "raw"}]\''
newline|'\n'
nl|'\n'
comment|'# Preparing mocks'
nl|'\n'
...
name|'skip_test'
op|'('
string|'"test needs rewrite: instance no longer has mac_address"'
op|')'
newline|'\n'
...
name|'skip_test'
op|'('
string|'"skip libvirt test project_get_network no longer exists"'
op|')'
newline|'\n'
