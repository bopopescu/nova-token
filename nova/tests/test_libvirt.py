...
op|':'
newline|'\n'
comment|'# TODO(sdague): there should be a cleaner way to handle this'
nl|'\n'
comment|"# in the case where libvirt python isn't installed"
nl|'\n'
indent|'    '
name|'connection'
op|'.'
...
newline|'\n'
indent|'    '
string|'"""Test for nova.virt.libvirt.connection.LibvirtDriver."""'
newline|'\n'
DECL|member|setUp
name|'def'
name|'setUp'
