...
name|'dev_str'
op|'='
string|"'/dev/disk/by-path/ip-10.0.2.15:3260-iscsi-iqn.'"
string|"'2010-10.org.openstack:%s-lun-0'"
op|'%'
name|'name'
newline|'\n'
name|'self'
...
newline|'\n'
nl|'\n'
comment|'# Assign image_ref = 3 from nova/images/fakes for testing'
nl|'\n'
comment|'# ami image'
nl|'\n'
name|'test_instance'
...
op|'='
op|'('
string|'\'[{"path": "%s/disk", "local_gb": "10G",\''
nl|'\n'
