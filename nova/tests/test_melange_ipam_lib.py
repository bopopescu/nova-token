...
newline|'\n'
nl|'\n'
DECL|member|test_get_network_id_by_cidr_finds_block
dedent|''
name|'def'
name|'test_get_network_id_by_cidr_finds_block'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_network_id_by_cidr_raises_on_not_found
dedent|''
name|'def'
name|'test_get_network_id_by_cidr_raises_on_not_found'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_tenant_id_by_net_id
dedent|''
name|'def'
name|'test_get_tenant_id_by_net_id'
op|'('
name|'self'
op|')'
op|':'
