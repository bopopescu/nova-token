...
newline|'\n'
nl|'\n'
DECL|member|test_authorize_security_group_cidr
dedent|''
name|'def'
name|'test_authorize_security_group_cidr'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
indent|'        '
string|'"""Test that we can add rules to a security group"""'
newline|'\n'
name|'self'
op|'.'
name|'expect_http'
...
newline|'\n'
nl|'\n'
DECL|member|test_authorize_security_group_foreign_group
dedent|''
name|'def'
name|'test_authorize_security_group_foreign_group'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
indent|'        '
string|'"""Test that we can grant another security group access to a security group"""'
newline|'\n'
name|'self'
op|'.'
name|'expect_http'
