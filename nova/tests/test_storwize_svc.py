...
string|'""'
op|','
string|'"CMMVC7050E The command failed because at "'
op|'+'
nl|'\n'
string|'"least one node in the I/O group does not "'
op|'+'
nl|'\n'
string|'"support compressed VDisks."'
op|')'
op|','
nl|'\n'
op|'}'
...
newline|'\n'
nl|'\n'
DECL|member|_create_test_vol
dedent|''
name|'def'
name|'_create_test_vol'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_storwize_svc_volume_params
dedent|''
name|'def'
name|'test_storwize_svc_volume_params'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
comment|'# Option test matrix'
nl|'\n'
comment|'# Option        Value   Covered by test #'
nl|'\n'
comment|'# rsize         -1      1'
nl|'\n'
comment|'# rsize         2%      2,3'
...
comment|'# warning       0       2'
nl|'\n'
comment|'# warning       80%     3'
nl|'\n'
comment|'# autoexpand    True    2'
nl|'\n'
comment|'# autoexpand    False   3'
nl|'\n'
comment|'# grainsize     32      2'
nl|'\n'
comment|'# grainsize     256     3'
nl|'\n'
comment|'# compression   True    4'
nl|'\n'
comment|'# compression   False   2,3'
nl|'\n'
comment|'# easytier      True    1,3'
nl|'\n'
comment|'# easytier      False   2'
nl|'\n'
nl|'\n'
comment|'# Test 1'
nl|'\n'
