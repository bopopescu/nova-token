...
newline|'\n'
nl|'\n'
DECL|member|test_create_delete_volume_with_metadata
dedent|''
name|'def'
name|'test_create_delete_volume_with_metadata'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_cant_delete_volume_in_use
dedent|''
name|'def'
name|'test_cant_delete_volume_in_use'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
indent|'        '
string|'"""Test volume can\'t be deleted in invalid stats."""'
newline|'\n'
comment|'# create a volume and assign to host'
nl|'\n'
name|'volume'
op|'='
name|'self'
...
newline|'\n'
nl|'\n'
comment|"# 'in-use' status raises InvalidVolume"
nl|'\n'
name|'self'
op|'.'
name|'assertRaises'
...
newline|'\n'
nl|'\n'
DECL|member|test_force_delete_volume
dedent|''
name|'def'
name|'test_force_delete_volume'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
indent|'        '
string|'"""Test volume can be forced to delete."""'
newline|'\n'
comment|'# create a volume and assign to host'
nl|'\n'
name|'volume'
...
newline|'\n'
nl|'\n'
comment|"# 'error_deleting' volumes can't be deleted"
nl|'\n'
name|'self'
op|'.'
name|'assertRaises'
...
newline|'\n'
nl|'\n'
DECL|member|test_begin_roll_detaching_volume
dedent|''
name|'def'
name|'test_begin_roll_detaching_volume'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
indent|'        '
string|'"""Test begin_detaching and roll_detaching functions."""'
newline|'\n'
name|'volume'
op|'='
name|'self'
...
newline|'\n'
nl|'\n'
DECL|member|_create_volume_from_image
dedent|''
name|'def'
name|'_create_volume_from_image'
op|'('
name|'self'
op|','
...
op|','
nl|'\n'
name|'fakeout_copy_image_to_volume'
op|'='
name|'False'
op|')'
op|':'
newline|'\n'
indent|'        '
string|'"""Call copy image to volume, Test the status of volume after calling\n        copying image to volume."""'
newline|'\n'
DECL|function|fake_local_path
name|'def'
name|'fake_local_path'
op|'('
name|'volume'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|function|fake_copy_image_to_volume
dedent|''
name|'def'
name|'fake_copy_image_to_volume'
op|'('
name|'context'
op|','
name|'volume'
...
newline|'\n'
nl|'\n'
DECL|member|test_create_volume_from_image_status_downloading
dedent|''
dedent|''
name|'def'
name|'test_create_volume_from_image_status_downloading'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
indent|'        '
string|'"""Verify that before copying image to volume, it is in downloading\n        state."""'
newline|'\n'
name|'self'
op|'.'
name|'_create_volume_from_image'
...
newline|'\n'
nl|'\n'
DECL|member|test_create_volume_from_image_status_available
dedent|''
name|'def'
name|'test_create_volume_from_image_status_available'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
indent|'        '
string|'"""Verify that before copying image to volume, it is in available\n        state."""'
newline|'\n'
name|'self'
op|'.'
name|'_create_volume_from_image'
...
newline|'\n'
nl|'\n'
DECL|member|test_create_volume_from_image_exception
dedent|''
name|'def'
name|'test_create_volume_from_image_exception'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
indent|'        '
string|'"""Verify that create volume from image, the volume status is\n        \'downloading\'."""'
newline|'\n'
name|'dst_fd'
op|','
name|'dst_path'
...
name|'image_id'
op|'='
string|"'aaaaaaaa-0000-0000-0000-000000000000'"
newline|'\n'
comment|'# creating volume testdata'
nl|'\n'
name|'volume_id'
...
newline|'\n'
nl|'\n'
DECL|member|test_copy_volume_to_image_status_available
dedent|''
name|'def'
name|'test_copy_volume_to_image_status_available'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_copy_volume_to_image_status_use
dedent|''
dedent|''
name|'def'
name|'test_copy_volume_to_image_status_use'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
comment|"#image_id = '70a599e0-31e7-49b7-b260-868f441e862b'"
nl|'\n'
name|'image_id'
op|'='
...
newline|'\n'
nl|'\n'
DECL|member|test_copy_volume_to_image_exception
dedent|''
dedent|''
name|'def'
name|'test_copy_volume_to_image_exception'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_create_volume_from_exact_sized_image
dedent|''
dedent|''
name|'def'
name|'test_create_volume_from_exact_sized_image'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
indent|'        '
string|'"""Verify that an image which is exactly the same size as the\n        volume, will work correctly."""'
newline|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|test_create_volume_from_oversized_image
dedent|''
dedent|''
name|'def'
name|'test_create_volume_from_oversized_image'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
indent|'        '
string|'"""Verify that an image which is too big will fail correctly."""'
newline|'\n'
DECL|class|_FakeImageService
name|'class'
name|'_FakeImageService'
...
newline|'\n'
indent|'        '
string|'"""Attach volumes to an instance."""'
newline|'\n'
name|'return'
op|'['
op|']'
