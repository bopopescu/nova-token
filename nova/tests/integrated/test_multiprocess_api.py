...
name|'info'
op|'('
string|'"Launched OSAPI WSGI service in process %d"'
op|','
name|'pid'
op|')'
newline|'\n'
...
name|'info'
op|'('
string|'"in tearDown(), stopping launcher pid %d with SIGTERM"'
op|','
nl|'\n'
name|'self'
op|'.'
...
name|'self'
op|'.'
name|'_wait_for_all_workers_to_end'
op|'('
op|')'
newline|'\n'
name|'self'
...
op|':'
newline|'\n'
comment|'# If the child gets stuck or is too slow in exiting'
nl|'\n'
...
name|'warn'
op|'('
string|'"got fixtures.TimeoutException during tearDown(). "'
nl|'\n'
string|'"going nuclear with SIGKILL."'
op|')'
newline|'\n'
name|'for'
name|'worker_pid'
...
name|'info'
op|'('
string|"'in _get_workers(), workers: %r for PPID %d'"
op|','
nl|'\n'
name|'workers'
op|','
...
name|'info'
op|'('
string|'"Worker: %s still around, trying again"'
op|'%'
name|'worker_pid'
op|')'
newline|'\n'
...
name|'info'
op|'('
string|'"Worker: %s successfully shut down"'
op|'%'
name|'worker_pid'
op|')'
newline|'\n'
...
name|'warning'
op|'('
string|'"got non-ESRCH errno %d when attempting "'
nl|'\n'
string|'"status of worker PID %d"'
op|','
nl|'\n'
name|'err'
op|'.'
...
newline|'\n'
nl|'\n'
DECL|member|_wait_for_all_workers_to_end
dedent|''
name|'def'
name|'_wait_for_all_workers_to_end'
op|'('
