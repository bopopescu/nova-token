...
newline|'\n'
nl|'\n'
comment|'# Wait for up to a second for workers to get started'
nl|'\n'
name|'start'
op|'='
name|'time'
...
newline|'\n'
nl|'\n'
comment|'# loop and check if new worker is spawned (for 1 second max)'
nl|'\n'
name|'start'
op|'='
name|'time'
...
newline|'\n'
nl|'\n'
comment|'# loop and check if all processes are killed (for 1 second max)'
nl|'\n'
name|'start'
op|'='
name|'time'
