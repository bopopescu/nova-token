...
newline|'\n'
indent|'        '
string|'"""Start coverage data collection"""'
newline|'\n'
name|'subs'
op|'='
op|'{'
...
newline|'\n'
indent|'        '
string|'"""Stop coverage data collection"""'
newline|'\n'
name|'subs'
op|'='
op|'{'
...
newline|'\n'
indent|'        '
string|'"""Generate a coverage report"""'
newline|'\n'
name|'subs'
op|'='
op|'{'
...
newline|'\n'
indent|'        '
string|'"""Get api sample to show quotas"""'
newline|'\n'
name|'response'
op|'='
name|'self'
...
newline|'\n'
indent|'        '
string|'"""Get api sample to show quotas defaults"""'
newline|'\n'
name|'response'
op|'='
name|'self'
...
newline|'\n'
indent|'        '
string|'"""Get api sample to update quotas"""'
newline|'\n'
name|'response'
op|'='
name|'self'
...
newline|'\n'
indent|'        '
string|'"""Get api sample to create a flavor"""'
newline|'\n'
name|'self'
op|'.'
name|'_create_flavor'
...
newline|'\n'
indent|'        '
string|'"""Get api sample to delete a flavor"""'
newline|'\n'
name|'self'
op|'.'
name|'_create_flavor'
...
op|'('
nl|'\n'
string|"'nova.api.openstack.compute.contrib.networks.Networks'"
op|')'
newline|'\n'
name|'return'
name|'f'
...
newline|'\n'
indent|'        '
string|'"""Get api sample to show flavor_disabled attr. of a flavor"""'
newline|'\n'
name|'flavor_id'
op|'='
number|'1'
...
newline|'\n'
indent|'        '
string|'"""Get api sample to show details of a flavor"""'
newline|'\n'
name|'response'
op|'='
name|'self'
...
newline|'\n'
indent|'        '
string|'"""Get api sample to show quota classes"""'
newline|'\n'
name|'response'
op|'='
name|'self'
...
newline|'\n'
indent|'        '
string|'"""Get api sample to update quota classes"""'
newline|'\n'
name|'response'
op|'='
name|'self'
