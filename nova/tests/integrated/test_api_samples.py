...
comment|'# other tests.'
nl|'\n'
comment|'# Besides that, there are some cases like Aggregates extension'
nl|'\n'
comment|'# where we got a list of strings. For those cases key will be None'
nl|'\n'
comment|"# (python's default) and the elements will be compared directly."
nl|'\n'
