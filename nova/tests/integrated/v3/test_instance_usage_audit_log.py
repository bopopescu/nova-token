...
newline|'\n'
nl|'\n'
DECL|member|test_index_instance_usage_audit_log_with_before
dedent|''
name|'def'
name|'test_index_instance_usage_audit_log_with_before'
op|'('
name|'self'
op|')'
op|':'
...
name|'_do_get'
op|'('
string|"'os-instance-usage-audit-log?before=%s'"
op|'%'
nl|'\n'
name|'urllib'
op|'.'
...
op|'('
nl|'\n'
string|"'inst-usage-audit-log-index-with-before-get-resp'"
op|','
nl|'\n'
name|'subs'
op|','
