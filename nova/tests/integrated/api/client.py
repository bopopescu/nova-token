...
nl|'\n'
nl|'\n'
DECL|class|TestOpenStackClientV3
dedent|''
dedent|''
name|'class'
name|'TestOpenStackClientV3'
op|'('
name|'TestOpenStackClient'
op|')'
op|':'
newline|'\n'
indent|'    '
string|'"""Simple OpenStack v3 API Client.\n\n    This is a really basic OpenStack API client that is under our control,\n    so we can make changes / insert hooks for testing\n\n    """'
newline|'\n'
nl|'\n'
DECL|member|get_image
name|'def'
...
nl|'\n'
nl|'\n'
DECL|class|TestOpenStackClientV3Mixin
dedent|''
dedent|''
name|'class'
