...
newline|'\n'
nl|'\n'
DECL|member|get_keys_detail
dedent|''
name|'def'
name|'get_keys_detail'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|get_volumes_detail
dedent|''
name|'def'
name|'get_volumes_detail'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|get_images_detail
dedent|''
name|'def'
name|'get_images_detail'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|get_flavors_detail
dedent|''
name|'def'
name|'get_flavors_detail'
op|'('
name|'self'
op|')'
op|':'
