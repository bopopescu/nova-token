...
newline|'\n'
nl|'\n'
comment|'# Without an image, this throws 400.'
nl|'\n'
...
newline|'\n'
nl|'\n'
comment|'# With an invalid image entity, this throws 400.'
nl|'\n'
name|'bookmark'
op|'='
op|'{'
...
newline|'\n'
nl|'\n'
comment|'# Add a valid image entity'
nl|'\n'
name|'server'
op|'['
string|"'image'"
...
newline|'\n'
nl|'\n'
comment|'# Without a flavor entity, this throws 400'
nl|'\n'
comment|'# TODO(justinsb): Check whatever the spec says should be thrown here'
nl|'\n'
name|'self'
...
newline|'\n'
nl|'\n'
comment|'# Set a valid flavor etity'
nl|'\n'
name|'server'
op|'['
string|"'flavor'"
...
newline|'\n'
nl|'\n'
comment|'# Without a name, this throws 400'
nl|'\n'
comment|'# TODO(justinsb): Check whatever the spec says should be thrown here'
nl|'\n'
name|'self'
