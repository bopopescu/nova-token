...
nl|'\n'
nl|'\n'
DECL|class|DatabasePoisonFixture
dedent|''
dedent|''
dedent|''
name|'class'
name|'DatabasePoisonFixture'
op|'('
name|'fixtures'
op|'.'
name|'Fixture'
...
op|'('
nl|'\n'
string|"'oslo_db.sqlalchemy.enginefacade._TransactionFactory.'"
nl|'\n'
...
name|'self'
op|'.'
name|'_poison_configure'
op|')'
op|')'
newline|'\n'
nl|'\n'
DECL|member|_poison_configure
dedent|''
name|'def'
name|'_poison_configure'
op|'('
...
name|'warn'
op|'('
string|"'This test uses methods that set internal oslo_db '"
nl|'\n'
string|"'state, but it does not claim to use the database. '"
nl|'\n'
string|"'This will conflict with the setup of tests that '"
nl|'\n'
string|"'do use the database and cause failures later.'"
op|')'
newline|'\n'
name|'return'
name|'mock'
...
nl|'\n'
nl|'\n'
DECL|class|DefaultFlavorsFixture
dedent|''
dedent|''
name|'class'
...
nl|'\n'
nl|'\n'
DECL|class|_FakeGreenThread
dedent|''
dedent|''
name|'class'
name|'_FakeGreenThread'
op|'('
name|'object'
op|')'
op|':'
...
op|':'
newline|'\n'
comment|"# This method doesn't make sense for a synchronous call, it's just"
nl|'\n'
comment|'# defined to satisfy the interface.'
nl|'\n'
indent|'        '
name|'pass'
newline|'\n'
...
nl|'\n'
nl|'\n'
DECL|class|EngineFacadeFixture
dedent|''
dedent|''
name|'class'
name|'EngineFacadeFixture'
op|'('
name|'fixtures'
op|'.'
name|'Fixture'
...
nl|'\n'
nl|'\n'
DECL|class|ForbidNewLegacyNotificationFixture
dedent|''
dedent|''
name|'class'
name|'ForbidNewLegacyNotificationFixture'
op|'('
name|'fixtures'
op|'.'
name|'Fixture'
...
newline|'\n'
indent|'    '
string|'"""Make sure the test fails if new legacy notification is added"""'
newline|'\n'
DECL|member|__init__
name|'def'
name|'__init__'
...
newline|'\n'
nl|'\n'
comment|'# allow the special test value used in'
nl|'\n'
comment|'# nova.tests.unit.test_notifications.NotificationsTestCase'
nl|'\n'
name|'self'
op|'.'
name|'notifier'
