...
op|')'
newline|'\n'
comment|'# NOTE(sdague): the polling behavior in oslo.messaging <='
nl|'\n'
comment|'# 1.5.1 fake driver is less than optimal, as by default the'
nl|'\n'
comment|'# polling will wait for a full second even if there are no'
nl|'\n'
comment|'# events available. Turning this down speeds up the tests'
nl|'\n'
comment|"# substantially. It should be > 0.05, because we've seen races"
nl|'\n'
comment|'# that happen if this is less than the internal polling'
nl|'\n'
comment|'# timeout in oslo.messaging.'
nl|'\n'
name|'self'
op|'.'
name|'useFixture'
...
op|'('
nl|'\n'
string|"'oslo.messaging._executors.base.POLL_TIMEOUT'"
op|','
nl|'\n'
number|'0.1'
op|')'
