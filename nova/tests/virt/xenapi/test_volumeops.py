...
newline|'\n'
nl|'\n'
DECL|member|test_connect_volume_no_hotplug
dedent|''
name|'def'
name|'test_connect_volume_no_hotplug'
op|'('
name|'self'
op|')'
op|':'
...
op|':'
newline|'\n'
comment|'# Only used for VBD.plug in this code path.'
nl|'\n'
indent|'            '
name|'called'
op|'['
...
name|'volume_utils'
op|','
string|"'introduce_sr_unless_present'"
op|')'
newline|'\n'
name|'self'
op|'.'
