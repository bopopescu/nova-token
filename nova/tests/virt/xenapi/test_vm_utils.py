...
name|'vm_utils'
op|','
string|"'get_vdi_uuid_for_volume'"
op|','
nl|'\n'
name|'return_value'
op|'='
...
name|'vm_utils'
op|','
string|"'_count_parents_children'"
op|')'
newline|'\n'
op|'@'
name|'mock'
...
op|')'
newline|'\n'
DECL|member|test_wait_for_vhd_coalesce
name|'def'
name|'test_wait_for_vhd_coalesce'
op|'('
name|'self'
op|','
name|'mock_scan_sr'
op|','
nl|'\n'
name|'mock_count_parents_children'
op|','
...
op|','
nl|'\n'
string|"'nova.virt.xenapi.driver'"
op|','
name|'group'
op|'='
string|'"xenserver"'
...
newline|'\n'
nl|'\n'
DECL|function|fake_get_vhd_parent_uuid
dedent|''
dedent|''
name|'def'
name|'fake_get_vhd_parent_uuid'
op|'('
name|'session'
op|','
name|'vdi_ref'
...
op|')'
newline|'\n'
comment|"# We'll sleep one fewer times than we scan the SR due to"
nl|'\n'
comment|'# the scan at the start'
nl|'\n'
name|'self'
op|'.'
name|'assertEqual'
...
op|')'
newline|'\n'
DECL|member|test_wait_for_vhd_coalesce_1317792
name|'def'
name|'test_wait_for_vhd_coalesce_1317792'
op|'('
name|'self'
op|','
name|'mock_scan_sr'
...
string|"'vdi_base_ref'"
op|','
string|"'vdi_coalescable_ref1'"
op|','
nl|'\n'
string|"'vdi_coalescable_ref2'"
op|','
string|"'vdi_leaf_ref'"
op|']'
newline|'\n'
...
op|')'
newline|'\n'
DECL|member|test_count_parents_children
name|'def'
name|'test_count_parents_children'
op|'('
name|'self'
op|','
name|'mock_get_parent_uuid'
op|','
nl|'\n'
...
op|')'
newline|'\n'
DECL|member|test_get_snapshots_for_vm
name|'def'
name|'test_get_snapshots_for_vm'
op|'('
name|'self'
op|','
name|'mock_find'
