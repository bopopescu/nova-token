...
newline|'\n'
nl|'\n'
DECL|member|_test_wait_for_vhd_coalesce
dedent|''
name|'def'
name|'_test_wait_for_vhd_coalesce'
op|'('
name|'self'
op|','
name|'mock_another_child_vhd'
op|','
nl|'\n'
name|'mock_get_vhd_parent_uuid'
op|','
...
newline|'\n'
nl|'\n'
DECL|function|fake_call_plugin_serialized
name|'def'
name|'fake_call_plugin_serialized'
op|'('
name|'plugin'
op|','
name|'function'
...
op|')'
newline|'\n'
DECL|member|test_wait_for_vhd_coalesce_still_gc
name|'def'
name|'test_wait_for_vhd_coalesce_still_gc'
op|'('
name|'self'
op|','
name|'mock_another_child_vhd'
