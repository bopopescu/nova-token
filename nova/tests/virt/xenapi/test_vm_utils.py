...
op|':'
newline|'\n'
DECL|member|_apply_stubouts
indent|'    '
name|'def'
name|'_apply_stubouts'
op|'('
name|'self'
op|')'
op|':'
...
name|'vm_utils'
op|','
string|"'_generate_glance_callback'"
op|')'
newline|'\n'
name|'self'
op|'.'
...
op|','
nl|'\n'
string|"'_fetch_using_dom0_plugin_with_retry'"
op|')'
newline|'\n'
name|'self'
op|'.'
...
newline|'\n'
nl|'\n'
DECL|member|_common_params_setup
dedent|''
name|'def'
name|'_common_params_setup'
op|'('
name|'self'
op|','
name|'uses_bittorrent'
op|')'
op|':'
newline|'\n'
indent|'        '
...
nl|'\n'
nl|'\n'
DECL|class|BitTorrentMiscTestCase
dedent|''
dedent|''
name|'class'
name|'BitTorrentMiscTestCase'
op|'('
name|'test'
op|'.'
name|'TestCase'
...
newline|'\n'
nl|'\n'
DECL|member|test_default_fetch_url
dedent|''
name|'def'
name|'test_default_fetch_url'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
DECL|function|mock_iter_none
indent|'        '
name|'def'
name|'mock_iter_none'
op|'('
...
newline|'\n'
nl|'\n'
DECL|member|test_more_than_one_extension
dedent|''
name|'def'
name|'test_more_than_one_extension'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_fetch_url_failure
dedent|''
name|'def'
name|'test_fetch_url_failure'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
comment|'# fetcher function fails:'
nl|'\n'
indent|'        '
name|'vm_utils'
op|'.'
