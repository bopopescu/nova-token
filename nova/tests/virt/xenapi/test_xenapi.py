...
string|"'6'"
newline|'\n'
DECL|variable|IMAGE_IPXE_ISO
name|'IMAGE_IPXE_ISO'
op|'='
string|"'7'"
newline|'\n'
DECL|variable|IMAGE_FROM_VOLUME
...
newline|'\n'
indent|'    '
string|'"""vm_utils.with_vdi_attached_here needs to be stubbed out because it\n    calls down to the filesystem to attach a vdi. This provides a\n    decorator to handle that.\n    """'
newline|'\n'
op|'@'
name|'functools'
op|'.'
...
nl|'\n'
nl|'\n'
DECL|function|get_create_system_metadata
dedent|''
name|'def'
name|'get_create_system_metadata'
op|'('
name|'context'
op|','
...
nl|'\n'
nl|'\n'
comment|'# FIXME(sirp): convert this to use XenAPITestBaseNoDB'
nl|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|test_instance_not_exists
dedent|''
name|'def'
name|'test_instance_not_exists'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|variable|expected_raw_diagnostics
dedent|''
name|'expected_raw_diagnostics'
op|'='
op|'{'
nl|'\n'
...
newline|'\n'
nl|'\n'
comment|"# Note(sulo): We don't care about session id in test"
nl|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|test_spawn_ipxe_iso_success
dedent|''
name|'def'
name|'test_spawn_ipxe_iso_success'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_spawn_ipxe_iso_no_network_name
dedent|''
name|'def'
name|'test_spawn_ipxe_iso_no_network_name'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
comment|"# call_plugin_serialized shouldn't be called"
nl|'\n'
name|'self'
op|'.'
name|'mox'
...
newline|'\n'
nl|'\n'
DECL|member|test_spawn_ipxe_iso_no_boot_menu_url
dedent|''
name|'def'
name|'test_spawn_ipxe_iso_no_boot_menu_url'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_spawn_ipxe_iso_unknown_network_name
dedent|''
name|'def'
name|'test_spawn_ipxe_iso_unknown_network_name'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_spawn_boot_from_volume_no_glance_image_meta
dedent|''
name|'def'
name|'test_spawn_boot_from_volume_no_glance_image_meta'
op|'('
name|'self'
op|')'
op|':'
...
op|':'
newline|'\n'
comment|'# Umount would normally make files in the mounted filesystem'
nl|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|test_spawn_injects_auto_disk_config_to_xenstore
dedent|''
name|'def'
name|'test_spawn_injects_auto_disk_config_to_xenstore'
op|'('
name|'self'
op|')'
op|':'
...
name|'patch'
op|'('
string|"'nova.objects.network.Network._from_db_object'"
op|')'
op|':'
newline|'\n'
indent|'            '
...
newline|'\n'
nl|'\n'
DECL|function|fake_encrypt_text
name|'def'
name|'fake_encrypt_text'
op|'('
name|'sshkey'
op|','
name|'new_pass'
...
newline|'\n'
nl|'\n'
DECL|member|test_spawn_ssh_key_injection_non_rsa
dedent|''
name|'def'
name|'test_spawn_ssh_key_injection_non_rsa'
op|'('
name|'self'
op|')'
op|':'
...
op|')'
newline|'\n'
DECL|member|test_spawn_agent_upgrade
name|'def'
name|'test_spawn_agent_upgrade'
op|'('
name|'self'
op|','
name|'mock_get'
...
op|')'
newline|'\n'
DECL|member|test_spawn_agent_upgrade_fails_silently
name|'def'
name|'test_spawn_agent_upgrade_fails_silently'
op|'('
name|'self'
op|','
name|'mock_get'
...
name|'self'
op|'.'
name|'_test_spawn_fails_silently_with'
op|'('
name|'exception'
op|'.'
name|'AgentError'
...
name|'method'
op|'='
string|'"_plugin_agent_agentupdate"'
op|','
name|'failure'
op|'='
string|'"fake_error"'
...
newline|'\n'
nl|'\n'
DECL|member|test_spawn_with_resetnetwork_alternative_returncode
dedent|''
name|'def'
name|'test_spawn_with_resetnetwork_alternative_returncode'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|function|fake_resetnetwork
name|'def'
name|'fake_resetnetwork'
op|'('
name|'self'
op|','
name|'method'
...
name|'True'
newline|'\n'
comment|'# NOTE(johngarbutt): as returned by FreeBSD and Gentoo'
nl|'\n'
name|'return'
name|'jsonutils'
op|'.'
...
op|','
nl|'\n'
string|"'_plugin_agent_resetnetwork'"
op|','
name|'fake_resetnetwork'
op|')'
newline|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|_test_spawn_fails_silently_with
dedent|''
name|'def'
name|'_test_spawn_fails_silently_with'
op|'('
name|'self'
op|','
name|'expected_exception_cls'
op|','
nl|'\n'
name|'method'
op|'='
string|'"_plugin_agent_version"'
op|','
nl|'\n'
name|'failure'
op|'='
...
newline|'\n'
nl|'\n'
DECL|function|fake_agent_call
name|'def'
name|'fake_agent_call'
op|'('
name|'self'
op|','
name|'method'
...
newline|'\n'
nl|'\n'
DECL|function|fake_add_instance_fault
name|'def'
name|'fake_add_instance_fault'
op|'('
op|'*'
name|'args'
op|','
...
name|'called'
op|'['
string|'"fake_add_instance_fault"'
op|']'
op|'='
name|'args'
op|'['
...
newline|'\n'
nl|'\n'
DECL|member|test_spawn_fails_silently_with_agent_timeout
dedent|''
name|'def'
name|'test_spawn_fails_silently_with_agent_timeout'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_spawn_fails_silently_with_agent_not_implemented
dedent|''
name|'def'
name|'test_spawn_fails_silently_with_agent_not_implemented'
op|'('
name|'self'
op|')'
op|':'
...
name|'failure'
op|'='
string|'"NOT IMPLEMENTED:fake"'
op|')'
newline|'\n'
nl|'\n'
DECL|member|test_spawn_fails_silently_with_agent_error
dedent|''
name|'def'
name|'test_spawn_fails_silently_with_agent_error'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_spawn_fails_silently_with_agent_bad_return
dedent|''
name|'def'
name|'test_spawn_fails_silently_with_agent_bad_return'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_rescue_preserve_disk_on_failure
dedent|''
name|'def'
name|'test_rescue_preserve_disk_on_failure'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
comment|'# test that the original disk is preserved if rescue setup fails'
nl|'\n'
comment|'# bug #1227898'
nl|'\n'
indent|'        '
...
newline|'\n'
nl|'\n'
comment|'# raise an error in the spawn setup process and trigger the'
nl|'\n'
comment|'# undo manager logic:'
nl|'\n'
...
newline|'\n'
nl|'\n'
comment|'# confirm original disk still exists:'
nl|'\n'
name|'vdi_ref2'
op|','
name|'vdi_rec2'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_console_output_succeeds
dedent|''
name|'def'
name|'test_get_console_output_succeeds'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_destroy_clean_up_kernel_and_ramdisk
dedent|''
name|'def'
name|'test_destroy_clean_up_kernel_and_ramdisk'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
DECL|function|fake_lookup_kernel_ramdisk
indent|'        '
name|'def'
name|'fake_lookup_kernel_ramdisk'
op|'('
name|'session'
op|','
name|'vm_ref'
...
newline|'\n'
nl|'\n'
DECL|function|fake_destroy_kernel_ramdisk
name|'def'
name|'fake_destroy_kernel_ramdisk'
op|'('
name|'session'
op|','
name|'instance'
...
newline|'\n'
nl|'\n'
DECL|member|test_migrate_disk_and_power_off_throws_on_zero_gb_resize_down
dedent|''
name|'def'
name|'test_migrate_disk_and_power_off_throws_on_zero_gb_resize_down'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_migrate_disk_and_power_off_with_zero_gb_old_and_new_works
dedent|''
name|'def'
name|'test_migrate_disk_and_power_off_with_zero_gb_old_and_new_works'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|_test_revert_migrate
dedent|''
name|'def'
name|'_test_revert_migrate'
op|'('
name|'self'
op|','
name|'power_on'
...
newline|'\n'
nl|'\n'
DECL|member|test_revert_migrate_power_on
dedent|''
name|'def'
name|'test_revert_migrate_power_on'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_revert_migrate_power_off
dedent|''
name|'def'
name|'test_revert_migrate_power_off'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|_test_finish_migrate
dedent|''
name|'def'
name|'_test_finish_migrate'
op|'('
name|'self'
op|','
name|'power_on'
...
newline|'\n'
nl|'\n'
DECL|member|test_finish_migrate_power_on
dedent|''
name|'def'
name|'test_finish_migrate_power_on'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_finish_migrate_power_off
dedent|''
name|'def'
name|'test_finish_migrate_power_off'
op|'('
name|'self'
op|')'
op|':'
...
name|'stub_vm_utils_with_vdi_attached_here'
newline|'\n'
DECL|member|test_migrate_too_many_partitions_no_resize_down
name|'def'
name|'test_migrate_too_many_partitions_no_resize_down'
op|'('
name|'self'
op|')'
op|':'
...
name|'stub_vm_utils_with_vdi_attached_here'
newline|'\n'
DECL|member|test_migrate_bad_fs_type_no_resize_down
name|'def'
name|'test_migrate_bad_fs_type_no_resize_down'
op|'('
name|'self'
op|')'
op|':'
...
op|')'
newline|'\n'
comment|'# Values from fake.create_local_srs (ext SR)'
nl|'\n'
name|'self'
op|'.'
name|'assertEqual'
...
op|')'
newline|'\n'
comment|'# Values from fake._plugin_xenhost_host_data'
nl|'\n'
name|'self'
op|'.'
name|'assertEqual'
...
newline|'\n'
nl|'\n'
DECL|member|test_host_state_vcpus_used
dedent|''
name|'def'
name|'test_host_state_vcpus_used'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_pci_passthrough_devices_whitelist
dedent|''
name|'def'
name|'test_pci_passthrough_devices_whitelist'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
comment|'# NOTE(guillaume-thouvenin): This pci whitelist will be used to'
nl|'\n'
comment|'# match with _plugin_xenhost_get_pci_device_details method in fake.py.'
nl|'\n'
indent|'        '
name|'white_list'
op|'='
string|'\'{"vendor_id":"10de", "product_id":"11bf"}\''
newline|'\n'
name|'self'
op|'.'
name|'flags'
...
newline|'\n'
nl|'\n'
DECL|member|test_pci_passthrough_devices_no_whitelist
dedent|''
name|'def'
name|'test_pci_passthrough_devices_no_whitelist'
op|'('
name|'self'
op|')'
op|':'
...
op|':'
newline|'\n'
comment|"# Must trigger construction of 'host_state' property"
nl|'\n'
comment|'# before introducing the stub which raises the error'
nl|'\n'
indent|'        '
name|'hs'
op|'='
...
newline|'\n'
nl|'\n'
DECL|member|test_update_stats_caches_hostname
dedent|''
name|'def'
name|'test_update_stats_caches_hostname'
op|'('
name|'self'
op|')'
op|':'
...
op|':'
newline|'\n'
comment|'# On the third call (the second below) change the hostname'
nl|'\n'
indent|'                '
name|'data'
op|'='
...
name|'stub_vm_utils_with_vdi_attached_here'
newline|'\n'
DECL|member|test_instance_auto_disk_config_fails_safe_two_partitions
name|'def'
name|'test_instance_auto_disk_config_fails_safe_two_partitions'
op|'('
name|'self'
op|')'
op|':'
...
name|'stub_vm_utils_with_vdi_attached_here'
newline|'\n'
DECL|member|test_instance_auto_disk_config_fails_safe_badly_numbered
name|'def'
name|'test_instance_auto_disk_config_fails_safe_badly_numbered'
op|'('
name|'self'
op|')'
op|':'
...
name|'stub_vm_utils_with_vdi_attached_here'
newline|'\n'
DECL|member|test_instance_auto_disk_config_fails_safe_bad_fstype
name|'def'
name|'test_instance_auto_disk_config_fails_safe_bad_fstype'
op|'('
name|'self'
op|')'
op|':'
...
nl|'\n'
comment|'# nova.tests.virt.test_libvirt.IPTablesFirewallDriverTestCase share a lot of'
nl|'\n'
comment|'# code.  Consider abstracting common code in a base class for firewall driver'
nl|'\n'
comment|'# testing.'
nl|'\n'
comment|'# FIXME(sirp): convert this to use XenAPITestBaseNoDB'
...
op|')'
newline|'\n'
comment|'# This test is only guaranteed if there is one host in the pool'
nl|'\n'
name|'self'
op|'.'
name|'assertEqual'
...
newline|'\n'
nl|'\n'
DECL|function|fake_create_kernel_and_ramdisk
dedent|''
name|'def'
name|'fake_create_kernel_and_ramdisk'
op|'('
name|'context'
op|','
name|'session'
...
indent|'            '
name|'return'
string|'"fake-kernel-file"'
op|','
string|'"fake-ramdisk-file"'
newline|'\n'
nl|'\n'
dedent|''
name|'fake_fw'
...
newline|'\n'
nl|'\n'
DECL|function|fake_strip_base_mirror_from_vdis
name|'def'
name|'fake_strip_base_mirror_from_vdis'
op|'('
name|'session'
op|','
name|'vm_ref'
...
name|'vm_utils'
op|','
string|'"strip_base_mirror_from_vdis"'
op|','
nl|'\n'
name|'fake_strip_base_mirror_from_vdis'
op|')'
...
newline|'\n'
nl|'\n'
DECL|member|test_check_live_migrate_destination_verifies_ip
dedent|''
name|'def'
name|'test_check_live_migrate_destination_verifies_ip'
op|'('
name|'self'
op|')'
op|':'
...
name|'return'
op|'('
string|'"fake_PV_kernel"'
op|','
string|'"fake_PV_ramdisk"'
op|')'
newline|'\n'
nl|'\n'
dedent|''
...
newline|'\n'
nl|'\n'
DECL|member|test_live_migrate_pool_migration_xapi_call_parameters
dedent|''
name|'def'
name|'test_live_migrate_pool_migration_xapi_call_parameters'
op|'('
name|'self'
op|')'
op|':'
...
name|'self'
op|'.'
name|'called_fake_get_vm_opaque_ref'
op|'='
name|'False'
newline|'\n'
nl|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|test_change_instance_metadata_not_found
dedent|''
name|'def'
name|'test_change_instance_metadata_not_found'
op|'('
name|'self'
op|')'
op|':'
...
op|':'
newline|'\n'
DECL|class|MockXapiSession
indent|'        '
name|'class'
name|'MockXapiSession'
op|'('
name|'xenapi_session'
op|'.'
name|'XenAPISession'
...
newline|'\n'
nl|'\n'
DECL|member|test_local_session
dedent|''
name|'def'
name|'test_local_session'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_remote_session
dedent|''
name|'def'
name|'test_remote_session'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_verify_plugin_version_same
dedent|''
name|'def'
name|'test_verify_plugin_version_same'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_verify_plugin_version_compatible
dedent|''
name|'def'
name|'test_verify_plugin_version_compatible'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_verify_plugin_version_bad_maj
dedent|''
name|'def'
name|'test_verify_plugin_version_bad_maj'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_verify_plugin_version_bad_min
dedent|''
name|'def'
name|'test_verify_plugin_version_bad_min'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_verify_current_version_matches
dedent|''
name|'def'
name|'test_verify_current_version_matches'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
comment|'# Import the plugin to extract its version'
nl|'\n'
name|'path'
op|'='
name|'os'
...
string|'"plugins/nova_plugin_version"'
newline|'\n'
name|'for'
name|'elem'
name|'in'
...
nl|'\n'
nl|'\n'
DECL|class|XenAPIFakeTestCase
dedent|''
dedent|''
name|'class'
name|'XenAPIFakeTestCase'
op|'('
name|'test'
op|'.'
name|'NoDBTestCase'
...
op|':'
newline|'\n'
DECL|member|test_query_matches
indent|'    '
name|'def'
name|'test_query_matches'
op|'('
name|'self'
op|')'
op|':'
...
op|','
nl|'\n'
string|'\'not field "b"="4"\''
op|':'
name|'True'
op|','
nl|'\n'
string|'\'field "a"="1" and field "b"="4"\''
op|':'
name|'False'
op|','
nl|'\n'
string|'\'field "a"="1" or field "b"="4"\''
op|':'
name|'True'
op|','
nl|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|test_query_bad_format
dedent|''
dedent|''
name|'def'
name|'test_query_bad_format'
op|'('
name|'self'
op|')'
op|':'
