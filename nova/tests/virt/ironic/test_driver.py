...
newline|'\n'
nl|'\n'
DECL|member|test__node_resource_no_instance_uuid
dedent|''
name|'def'
name|'test__node_resource_no_instance_uuid'
op|'('
name|'self'
op|')'
op|':'
...
op|')'
newline|'\n'
DECL|member|test__cleanup_deploy_good
name|'def'
name|'test__cleanup_deploy_good'
op|'('
name|'self'
op|','
name|'mock_update'
...
op|')'
newline|'\n'
DECL|member|test_destroy_ignore_unexpected_state
name|'def'
name|'test_destroy_ignore_unexpected_state'
op|'('
name|'self'
op|','
name|'mock_cleanup_deploy'
...
op|')'
newline|'\n'
DECL|member|test_destroy_unprovision_fail
name|'def'
name|'test_destroy_unprovision_fail'
op|'('
name|'self'
op|','
name|'mock_node'
