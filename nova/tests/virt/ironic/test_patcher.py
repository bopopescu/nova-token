...
newline|'\n'
nl|'\n'
DECL|member|test_create_pxe
dedent|''
name|'def'
name|'test_create_pxe'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_pxe_get_deploy_patch
dedent|''
name|'def'
name|'test_pxe_get_deploy_patch'
op|'('
name|'self'
op|')'
op|':'
...
string|"'path'"
op|':'
string|"'/driver_info/pxe_deploy_kernel'"
op|','
nl|'\n'
string|"'value'"
op|':'
...
string|"'path'"
op|':'
string|"'/driver_info/pxe_deploy_ramdisk'"
op|','
nl|'\n'
string|"'value'"
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_pxe_get_deploy_patch_no_flavor_kernel_ramdisk_ids
dedent|''
name|'def'
name|'test_pxe_get_deploy_patch_no_flavor_kernel_ramdisk_ids'
op|'('
name|'self'
op|')'
op|':'
...
op|')'
newline|'\n'
comment|"# If there's no extra_specs patch should be exactly like a"
nl|'\n'
comment|'# generic patch'
nl|'\n'
name|'self'
op|'.'
name|'assertEqual'
...
newline|'\n'
nl|'\n'
DECL|member|test_pxe_get_cleanup_patch
dedent|''
name|'def'
name|'test_pxe_get_cleanup_patch'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_pxe_get_cleanup_patch_no_flavor_kernel_ramdisk_ids
dedent|''
name|'def'
name|'test_pxe_get_cleanup_patch_no_flavor_kernel_ramdisk_ids'
op|'('
name|'self'
op|')'
op|':'
