...
newline|'\n'
nl|'\n'
DECL|member|test_inject_files_into_fs
dedent|''
name|'def'
name|'test_inject_files_into_fs'
op|'('
name|'self'
op|')'
op|':'
...
op|'['
op|'('
string|'"/path/to/not/exists/file"'
op|','
nl|'\n'
string|'"inject-file-contents"'
op|')'
op|']'
op|','
nl|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|test_inject_files_into_fs_dir_exists
dedent|''
name|'def'
name|'test_inject_files_into_fs_dir_exists'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
comment|'# test for already exists dir'
nl|'\n'
name|'diskapi'
op|'.'
name|'_inject_files_into_fs'
