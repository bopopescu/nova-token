...
op|':'
newline|'\n'
DECL|member|test_get_vcpu_pin_set_none_returns_none
indent|'    '
name|'def'
name|'test_get_vcpu_pin_set_none_returns_none'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_vcpu_pin_set_valid_syntax_works
dedent|''
name|'def'
name|'test_get_vcpu_pin_set_valid_syntax_works'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_vcpu_pin_set_invalid_syntax_raises
dedent|''
name|'def'
name|'test_get_vcpu_pin_set_invalid_syntax_raises'
op|'('
name|'self'
op|')'
op|':'
