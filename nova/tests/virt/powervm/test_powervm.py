...
newline|'\n'
nl|'\n'
comment|'# mock out the rm -f command call to vios'
nl|'\n'
name|'with'
name|'mock'
op|'.'
...
op|':'
newline|'\n'
comment|'# Tests that soft reboot is a no-op (mock out the power_off/power_on'
nl|'\n'
comment|"# methods to ensure they aren't called)"
nl|'\n'
indent|'        '
name|'self'
op|'.'
...
op|':'
newline|'\n'
comment|'# Tests that hard reboot is performed by stopping the lpar and then'
nl|'\n'
comment|'# starting it.'
nl|'\n'
indent|'        '
...
newline|'\n'
nl|'\n'
DECL|member|test_create_volume_from_image_fails_uncompressed_not_found
dedent|''
name|'def'
name|'test_create_volume_from_image_fails_uncompressed_not_found'
op|'('
name|'self'
op|')'
op|':'
...
nl|'\n'
nl|'\n'
DECL|class|IVMOperatorTestCase
dedent|''
dedent|''
name|'class'
name|'IVMOperatorTestCase'
op|'('
name|'test'
op|'.'
name|'TestCase'
...
newline|'\n'
indent|'    '
string|'"""Tests the IVMOperator class."""'
newline|'\n'
nl|'\n'
DECL|member|setUp
name|'def'
...
newline|'\n'
nl|'\n'
DECL|member|test_start_lpar
dedent|''
name|'def'
name|'test_start_lpar'
op|'('
name|'self'
op|')'
op|':'
...
name|'run_vios_command'
op|'('
string|"'chsysstate -r lpar -o on -n %s'"
op|'%'
nl|'\n'
name|'instance_name'
op|')'
...
newline|'\n'
nl|'\n'
DECL|member|test_start_lpar_timeout
dedent|''
name|'def'
name|'test_start_lpar_timeout'
op|'('
name|'self'
op|')'
op|':'
...
string|"'fake'"
newline|'\n'
comment|'# mock the remote command call'
nl|'\n'
name|'self'
op|'.'
name|'mox'
...
op|')'
newline|'\n'
comment|'# the lpar is stopped and the timeout is less than the looping call'
nl|'\n'
comment|'# interval so we timeout'
nl|'\n'
name|'lpar1'
op|'='
name|'fake_lpar'
...
name|'run_vios_command'
op|'('
string|"'chsysstate -r lpar -o shutdown '"
nl|'\n'
string|"'--immed -n %s'"
op|'%'
name|'instance_name'
...
op|')'
newline|'\n'
comment|'# the first time we check, the lpar is still running'
nl|'\n'
name|'lpar1'
op|'='
name|'fake_lpar'
...
op|')'
newline|'\n'
comment|'# the second time we check, the lpar is stopped'
nl|'\n'
name|'lpar2'
op|'='
name|'fake_lpar'
...
newline|'\n'
nl|'\n'
DECL|member|test_stop_lpar_timeout
dedent|''
name|'def'
name|'test_stop_lpar_timeout'
op|'('
name|'self'
op|')'
op|':'
...
op|')'
newline|'\n'
comment|'# the lpar is running and the timeout is less than the looping call'
nl|'\n'
comment|'# interval so we timeout'
nl|'\n'
name|'lpar1'
...
newline|'\n'
nl|'\n'
DECL|member|test_poll_for_lpar_status_no_state
dedent|''
name|'def'
name|'test_poll_for_lpar_status_no_state'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_poll_for_lpar_status_bad_state
dedent|''
name|'def'
name|'test_poll_for_lpar_status_bad_state'
op|'('
name|'self'
op|')'
op|':'
...
string|"'fake'"
op|','
string|"'bad-lpar-state-value'"
op|','
string|"'test'"
op|')'
newline|'\n'
nl|'\n'
DECL|member|test_get_hostname_returns_cached
dedent|''
name|'def'
name|'test_get_hostname_returns_cached'
op|'('
name|'self'
op|')'
op|':'
