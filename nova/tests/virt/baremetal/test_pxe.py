...
op|':'
newline|'\n'
comment|'# File injection is off by default, but we should continue to test it'
nl|'\n'
comment|'# until it is removed.'
nl|'\n'
indent|'        '
name|'CONF'
op|'.'
...
nl|'\n'
comment|'# inherited from the flavor_extra_specs table.'
nl|'\n'
name|'extra_specs'
op|'='
op|'{'
