...
op|'('
nl|'\n'
string|"'nova.virt.libvirt.driver.LibvirtDriver._get_host_uuid'"
op|','
nl|'\n'
name|'lambda'
name|'_'
...
newline|'\n'
nl|'\n'
DECL|member|_get_host_disabled
dedent|''
name|'def'
name|'_get_host_disabled'
op|'('
name|'self'
op|','
name|'host'
...
newline|'\n'
nl|'\n'
DECL|member|create_instance_obj
dedent|''
dedent|''
name|'def'
name|'create_instance_obj'
op|'('
name|'self'
op|','
name|'context'
...
newline|'\n'
nl|'\n'
comment|"# Test new verion of libvirt, should find the `aes' feature"
nl|'\n'
dedent|''
name|'with'
name|'mock'
...
newline|'\n'
nl|'\n'
comment|"# `mock` has trouble stubbing attributes that don't exist yet, so"
nl|'\n'
comment|'# fallback to plain-Python attribute setting/deleting'
nl|'\n'
name|'cap_str'
op|'='
string|"'VIR_CONNECT_BASELINE_CPU_EXPAND_FEATURES'"
...
newline|'\n'
nl|'\n'
DECL|member|test_invalid_watchdog_action
dedent|''
name|'def'
name|'test_invalid_watchdog_action'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_guest_config_with_watchdog_action_through_image_meta
dedent|''
name|'def'
name|'test_get_guest_config_with_watchdog_action_through_image_meta'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_guest_config_with_watchdog_action_meta_overrides_flavor
dedent|''
dedent|''
name|'def'
name|'test_get_guest_config_with_watchdog_action_meta_overrides_flavor'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_unsupported_video_driver_through_image_meta
dedent|''
dedent|''
name|'def'
name|'test_unsupported_video_driver_through_image_meta'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_guest_config_with_video_driver_through_image_meta
dedent|''
name|'def'
name|'test_get_guest_config_with_video_driver_through_image_meta'
op|'('
name|'self'
op|')'
op|':'
...
name|'patch'
op|'('
string|"'nova.openstack.common.fileutils.ensure_tree'"
op|')'
newline|'\n'
op|'@'
name|'mock'
...
name|'libvirt'
op|','
string|'"VIR_CONNECT_LIST_DOMAINS_ACTIVE"'
op|')'
op|':'
newline|'\n'
indent|'            '
...
name|'skipTest'
op|'('
string|'"libvirt missing VIR_CONNECT_LIST_DOMAINS_ACTIVE"'
op|')'
newline|'\n'
nl|'\n'
dedent|''
...
newline|'\n'
nl|'\n'
DECL|function|fake_list_ddoms
dedent|''
name|'def'
name|'fake_list_ddoms'
op|'('
op|')'
op|':'
newline|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|test_list_instance_domains_fallback_no_support
dedent|''
name|'def'
name|'test_list_instance_domains_fallback_no_support'
op|'('
name|'self'
op|')'
op|':'
...
name|'patch'
op|'('
string|"'nova.virt.libvirt.driver.LibvirtDriver._lookup_by_name'"
op|')'
newline|'\n'
...
name|'patch'
op|'('
string|"'nova.virt.libvirt.driver.LibvirtDriver._get_disk_xml'"
op|')'
newline|'\n'
op|'@'
name|'mock'
...
name|'conn'
op|','
string|"'_is_shared_instance_path'"
op|')'
newline|'\n'
name|'conn'
op|'.'
name|'_is_shared_instance_path'
op|'('
name|'dest_check_data'
op|')'
op|'.'
...
newline|'\n'
nl|'\n'
DECL|member|test_is_shared_block_storage_non_remote
dedent|''
name|'def'
name|'test_is_shared_block_storage_non_remote'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_is_shared_instance_path
dedent|''
dedent|''
name|'def'
name|'test_is_shared_instance_path'
op|'('
name|'self'
op|')'
op|':'
...
op|')'
newline|'\n'
DECL|member|test_live_migration_changes_listen_addresses
name|'def'
name|'test_live_migration_changes_listen_addresses'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_broken_connection_disable_service
dedent|''
dedent|''
name|'def'
name|'test_broken_connection_disable_service'
op|'('
name|'self'
op|')'
op|':'
...
name|'disable_reason'
op|'='
string|"u'Connection to libvirt lost: ERROR!'"
op|')'
newline|'\n'
nl|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|test_broken_connection_no_wrapped_conn
dedent|''
dedent|''
name|'def'
name|'test_broken_connection_no_wrapped_conn'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
comment|'# Tests that calling _close_callback when _wrapped_conn is None'
nl|'\n'
comment|"# is a no-op, i.e. set_host_enabled won't be called."
nl|'\n'
indent|'        '
name|'self'
op|'.'
...
op|')'
newline|'\n'
comment|'# conn._wrapped_conn will be None since we never call libvirt.openAuth'
nl|'\n'
name|'conn'
op|'='
name|'libvirt_driver'
...
op|')'
newline|'\n'
comment|'# create our mock connection that libvirt will send to the callback'
nl|'\n'
name|'mock_failed_conn'
op|'='
name|'mock'
op|'.'
name|'MagicMock'
...
name|'True'
newline|'\n'
comment|'# nothing should happen when calling _close_callback since'
nl|'\n'
comment|'# _wrapped_conn is None in the driver'
nl|'\n'
name|'conn'
op|'.'
name|'_init_events_pipe'
...
name|'patch'
op|'('
string|"'nova.openstack.common.loopingcall.FixedIntervalLoopingCall'"
op|')'
newline|'\n'
op|'@'
name|'mock'
...
name|'patch'
op|'('
string|"'nova.pci.pci_manager.get_instance_pci_devs'"
op|')'
newline|'\n'
op|'@'
name|'mock'
...
op|']'
op|'='
string|"'70a599e0-31e7-49b7-b260-868f221a761e'"
newline|'\n'
name|'return'
name|'instance'
newline|'\n'
...
newline|'\n'
nl|'\n'
DECL|function|count_shutdowns
name|'def'
name|'count_shutdowns'
op|'('
op|')'
op|':'
newline|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_memory_used_normal
dedent|''
name|'def'
name|'test_get_memory_used_normal'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_memory_used_xen
dedent|''
name|'def'
...
newline|'\n'
nl|'\n'
DECL|member|test_lxc_create_and_rootfs_saved
dedent|''
dedent|''
name|'def'
name|'test_lxc_create_and_rootfs_saved'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_do_refresh_security_group_rules_instance_disappeared
dedent|''
name|'def'
name|'test_do_refresh_security_group_rules_instance_disappeared'
op|'('
name|'self'
op|')'
op|':'
...
op|')'
newline|'\n'
DECL|member|test_disk_resize_raw_use_cow_images
name|'def'
name|'test_disk_resize_raw_use_cow_images'
op|'('
name|'self'
op|','
name|'mock_extend'
...
name|'patch'
op|'('
string|"'nova.virt.disk.api.is_image_partitionless'"
op|')'
newline|'\n'
op|'@'
name|'mock'
...
op|')'
newline|'\n'
DECL|member|test_disk_resize_qcow2_use_cow_images
name|'def'
name|'test_disk_resize_qcow2_use_cow_images'
op|'('
nl|'\n'
name|'self'
op|','
