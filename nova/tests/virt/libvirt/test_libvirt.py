...
string|"'fake-mini'"
op|','
string|"'Connection to libvirt lost: 1'"
op|')'
newline|'\n'
name|'conn'
op|'.'
...
string|"'fake-mini'"
op|','
string|"'Connection to libvirt lost: ERROR'"
op|')'
newline|'\n'
name|'conn'
op|'.'
...
newline|'\n'
nl|'\n'
DECL|member|test_power_off_shutdown_fails
dedent|''
name|'def'
name|'test_power_off_shutdown_fails'
op|'('
name|'self'
op|')'
op|':'
...
op|')'
newline|'\n'
comment|'#    still running after 1 sec'
nl|'\n'
name|'mock_domain'
op|'.'
name|'info'
...
op|')'
newline|'\n'
comment|'#    still running after 2 secs'
nl|'\n'
name|'mock_domain'
op|'.'
name|'info'
...
newline|'\n'
nl|'\n'
DECL|member|test_destroy_with_shutdown
dedent|''
name|'def'
name|'test_destroy_with_shutdown'
op|'('
name|'self'
op|')'
op|':'
