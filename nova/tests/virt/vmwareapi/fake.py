...
nl|'\n'
comment|"# datastore. Note that if you create a VM with vmPathName '[foo]', when"
nl|'\n'
comment|"# you retrieve vmPathName it will be '[foo] uuid/uuid.vmx'. Hence we"
nl|'\n'
comment|'# use vm_path below for the stored value of vmPathName.'
nl|'\n'
name|'if'
name|'vm_path'
op|'.'
...
newline|'\n'
nl|'\n'
DECL|member|fake_transfer_file
dedent|''
name|'def'
name|'fake_transfer_file'
op|'('
name|'self'
op|','
name|'ds_name'
