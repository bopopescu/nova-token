...
op|':'
newline|'\n'
comment|'# return fake objects in circular manner'
nl|'\n'
indent|'        '
name|'self'
op|'.'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_stats_from_cluster
dedent|''
name|'def'
name|'test_get_stats_from_cluster'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_datastore_ref_and_name_with_token
dedent|''
dedent|''
name|'def'
name|'test_get_datastore_ref_and_name_with_token'
op|'('
name|'self'
op|')'
op|':'
