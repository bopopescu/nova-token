...
newline|'\n'
nl|'\n'
DECL|member|_set_move_exception_vars
dedent|''
name|'def'
name|'_set_move_exception_vars'
op|'('
name|'self'
op|')'
op|':'
...
nl|'\n'
comment|'# self.move_exception will be checked to see that'
nl|'\n'
...
comment|'# successfully. The "MoveDatastoreFile_Task" will'
nl|'\n'
comment|'# raise a general exception. The flag self.move_exception'
nl|'\n'
...
comment|'# successfully. The "MoveDatastoreFile_Task" will'
nl|'\n'
comment|'# raise a file exists exception. The flag self.move_exception'
nl|'\n'
comment|'# will be checked to see that the exception has'
nl|'\n'
comment|'# indeed been raised.'
