...
op|')'
newline|'\n'
DECL|member|test_spawn_with_existing_directory
name|'def'
name|'test_spawn_with_existing_directory'
op|'('
name|'self'
op|','
name|'fake_path_file'
...
op|':'
newline|'\n'
comment|'# The test will validate that the spawn succeeds when'
nl|'\n'
comment|'# base folder already exists.'
nl|'\n'
indent|'        '
name|'self'
op|'.'
