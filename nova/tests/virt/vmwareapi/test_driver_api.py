...
op|'='
string|"'[%s] vmware_base/fake_image_uuid.vmdk'"
op|'%'
name|'self'
op|'.'
name|'ds'
...
op|'='
string|"'[%s] vmware_base/fake_image_uuid.80.vmdk'"
op|'%'
name|'self'
op|'.'
name|'ds'
...
name|'tmp_file'
op|'='
string|"'[%s] vmware_base/fake_image_uuid.80-flat.vmdk'"
op|'%'
name|'self'
op|'.'
name|'ds'
...
op|','
nl|'\n'
string|'"[%s] vmware-tmp/%s-flat.vmdk"'
op|'%'
op|'('
name|'self'
op|'.'
