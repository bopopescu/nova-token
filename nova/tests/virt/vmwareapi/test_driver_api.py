...
newline|'\n'
nl|'\n'
DECL|member|test_call_method_session_no_permission_exception
dedent|''
dedent|''
name|'def'
name|'test_call_method_session_no_permission_exception'
op|'('
name|'self'
op|')'
op|':'
...
name|'stubs'
op|','
string|"'fake_session_permission_exception'"
op|','
nl|'\n'
op|'*'
name|'args'
...
name|'assertEqual'
op|'('
string|'"https://www.example.com:443/sdk/vimService.wsdl"'
op|','
nl|'\n'
name|'wsdl_url'
op|')'
...
name|'assertEqual'
op|'('
string|'"https://www.example.com:443/sdk"'
op|','
name|'url'
op|')'
newline|'\n'
...
name|'assertEqual'
op|'('
string|'"https://[::1]:443/sdk/vimService.wsdl"'
op|','
nl|'\n'
name|'wsdl_url'
op|')'
...
name|'fake_wsdl'
op|'='
string|'"https://www.test.com:443/sdk/foo.wsdl"'
newline|'\n'
name|'self'
op|'.'
name|'flags'
...
newline|'\n'
nl|'\n'
DECL|member|test_configure_non_default_host_port
dedent|''
name|'def'
name|'test_configure_non_default_host_port'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|function|_fake_retrieve_service_content
dedent|''
name|'def'
name|'_fake_retrieve_service_content'
op|'('
name|'self'
op|')'
op|':'
...
name|'assertEqual'
op|'('
string|'"https://www.test.com:12345/sdk/vimService.wsdl"'
op|','
nl|'\n'
name|'vim_obj'
op|'.'
...
name|'assertEqual'
op|'('
string|'"https://www.test.com:12345/sdk"'
op|','
name|'vim_obj'
op|'.'
name|'url'
...
newline|'\n'
nl|'\n'
DECL|function|_fake_write_mock
dedent|''
name|'def'
name|'_fake_write_mock'
op|'('
name|'host'
op|','
name|'dc_name'
...
newline|'\n'
nl|'\n'
DECL|function|_fake_http_write
name|'def'
name|'_fake_http_write'
op|'('
name|'host'
op|','
...
newline|'\n'
nl|'\n'
DECL|function|fake_power_off_vm_ref
name|'def'
name|'fake_power_off_vm_ref'
op|'('
name|'vm_ref'
op|')'
op|':'
...
name|'volume_util'
op|','
string|"'_add_iscsi_send_target_host'"
op|')'
newline|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|test_rescan_iscsi_hba
dedent|''
name|'def'
name|'test_rescan_iscsi_hba'
op|'('
name|'self'
op|')'
op|':'
