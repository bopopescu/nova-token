...
newline|'\n'
nl|'\n'
DECL|member|test_use_linked_clone_override_none_true
dedent|''
name|'def'
name|'test_use_linked_clone_override_none_true'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_use_linked_clone_override_no_true
dedent|''
name|'def'
name|'test_use_linked_clone_override_no_true'
op|'('
name|'self'
op|')'
op|':'
...
op|':'
newline|'\n'
comment|'# the invalid disk format will cause an exception'
nl|'\n'
indent|'            '
name|'image_meta'
op|'='
