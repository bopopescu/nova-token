...
name|'patch'
op|'('
string|"'nova.virt.vmwareapi.vm_util.get_vm_ref'"
op|','
nl|'\n'
name|'return_value'
op|'='
...
name|'vm_util'
op|','
string|"'get_vmdk_path_and_adapter_type'"
op|','
nl|'\n'
name|'return_value'
op|'='
...
name|'as'
op|'('
name|'_get_vmdk_path_and_adapter_type'
op|','
name|'_get_vmdk_volume_disk'
op|','
nl|'\n'
...
op|','
name|'fake_vm_resize_spec'
op|','
nl|'\n'
name|'fake_get_datastore'
op|','
name|'fake_get_datacenter_ref_and_name'
op|','
nl|'\n'
name|'fake_extend_virtual_disk'
op|','
name|'fake_power_on'
op|')'
op|':'
...
name|'vm_util'
op|','
string|"'associate_vmref_for_instance'"
op|')'
newline|'\n'
op|'@'
name|'mock'
...
name|'patch'
op|'('
string|"'nova.virt.vmwareapi.volumeops.VMwareVolumeOps'"
nl|'\n'
string|"'.attach_root_volume'"
op|')'
newline|'\n'
...
op|'('
nl|'\n'
string|"'nova.virt.vmwareapi.vmops.VMwareVCVMOps.get_datacenter_ref_and_name'"
op|')'
newline|'\n'
op|'@'
name|'mock'
...
name|'patch'
op|'('
string|"'nova.virt.vmwareapi.vm_util.get_mo_id_from_instance'"
op|','
nl|'\n'
name|'return_value'
op|'='
string|"'fake_node_mo_id'"
op|')'
newline|'\n'
op|'@'
name|'mock'
...
name|'patch'
op|'('
string|"'nova.virt.vmwareapi.vm_util.get_res_pool_ref'"
op|','
nl|'\n'
name|'return_value'
op|'='
...
name|'patch'
op|'('
string|"'nova.virt.vmwareapi.vm_util.get_vnc_port'"
op|','
name|'return_value'
op|'='
number|'5900'
...
name|'patch'
op|'('
string|"'nova.virt.vmwareapi.vmops.VMwareVMOps._set_vnc_config'"
op|')'
newline|'\n'
op|'@'
name|'mock'
...
op|','
nl|'\n'
name|'mock_set_vnc_config'
op|','
nl|'\n'
name|'mock_get_vnc_port'
op|','
nl|'\n'
...
op|','
nl|'\n'
name|'mock_get_res_pool_ref'
op|','
nl|'\n'
name|'mock_get_mo_id_for_instance'
op|','
nl|'\n'
...
op|':'
newline|'\n'
comment|"# if block_device_info contains key 'block_device_mapping'"
nl|'\n'
comment|"# with any information, method mkdir wouldn't be called in"
nl|'\n'
comment|'# method self._vmops.spawn()'
nl|'\n'
indent|'                '
name|'expected_mkdir_calls'
op|'='
...
op|','
nl|'\n'
name|'mock_get_copy_virtual_disk_spec'
op|','
nl|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_spawn_vm_config_info_with_instance_name
dedent|''
name|'def'
name|'test_get_spawn_vm_config_info_with_instance_name'
op|'('
name|'self'
op|')'
op|':'
...
name|'patch'
op|'('
string|"'nova.virt.vmwareapi.driver.VMwareAPISession._get_vim_object'"
op|')'
newline|'\n'
...
op|')'
newline|'\n'
comment|'# NOTE(mdbooth): The instanceUuid behaviour below is apparently'
nl|'\n'
comment|'# deliberate.'
nl|'\n'
name|'self'
