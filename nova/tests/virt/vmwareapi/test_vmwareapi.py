...
op|':'
newline|'\n'
comment|"# Simply tests that the VMwareESXDriver doesn't implement the"
nl|'\n'
comment|'# get_diagnostics API.'
nl|'\n'
indent|'        '
name|'self'
op|'.'
...
op|':'
newline|'\n'
comment|"# Tests that the VMwareVCDriver doesn't implement get_diagnostics."
nl|'\n'
indent|'        '
name|'self'
op|'.'
