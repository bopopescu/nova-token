...
newline|'\n'
nl|'\n'
DECL|member|test_instance_get_active_by_window
dedent|''
name|'def'
name|'test_instance_get_active_by_window'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_service_get_all_compute_by_host
dedent|''
name|'def'
name|'test_service_get_all_compute_by_host'
op|'('
name|'self'
op|')'
op|':'
