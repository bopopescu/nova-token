...
newline|'\n'
nl|'\n'
DECL|member|test_compute_reboot
dedent|''
name|'def'
name|'test_compute_reboot'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_compute_stop_with_objects
dedent|''
name|'def'
name|'test_compute_stop_with_objects'
op|'('
name|'self'
op|')'
op|':'
...
op|')'
newline|'\n'
comment|'# make sure the instance object is serialized'
nl|'\n'
name|'primitive_instance'
op|'='
name|'dict'
op|'('
name|'inst_obj'
...
newline|'\n'
nl|'\n'
DECL|function|_fake_build_request_spec
name|'def'
name|'_fake_build_request_spec'
op|'('
name|'context'
op|','
name|'image'
