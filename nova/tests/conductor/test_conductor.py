...
newline|'\n'
nl|'\n'
DECL|member|test_instance_info_cache_delete_with_instance_group
dedent|''
name|'def'
name|'test_instance_info_cache_delete_with_instance_group'
op|'('
name|'self'
op|')'
op|':'
...
op|')'
newline|'\n'
comment|'# openstack.common.notifier'
nl|'\n'
name|'timeutils'
op|'.'
name|'utcnow'
...
newline|'\n'
nl|'\n'
comment|'# We need to unset and verify that we call the timutils.utcnow method'
nl|'\n'
comment|'# correctly now, as this method gets called as part of the setup'
nl|'\n'
comment|'# for the ConductorAPITestCase testcase.'
nl|'\n'
name|'self'
op|'.'
name|'mox'
...
newline|'\n'
nl|'\n'
DECL|member|test_vol_usage_update_again
dedent|''
name|'def'
name|'test_vol_usage_update_again'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
comment|'# Test updating the volume usage a second time and make sure that'
nl|'\n'
comment|'# the database queries to update and generate the volume usage'
nl|'\n'
comment|'# event payload continue to work'
nl|'\n'
indent|'        '
name|'now'
op|'='
...
op|')'
newline|'\n'
comment|'# vol_usage_update second call'
nl|'\n'
name|'timeutils'
op|'.'
name|'utcnow'
...
newline|'\n'
nl|'\n'
DECL|member|test_instance_group_member_delete
dedent|''
name|'def'
name|'test_instance_group_member_delete'
op|'('
name|'self'
op|')'
op|':'
...
op|')'
newline|'\n'
comment|'# NOTE(alaski): instance_type -> system_metadata -> instance_type loses'
nl|'\n'
comment|'# some data (extra_specs) so we need both for testing.'
nl|'\n'
name|'instance_type_extract'
op|'='
name|'flavors'
op|'.'
name|'extract_flavor'
