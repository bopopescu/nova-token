...
nl|'\n'
nl|'\n'
DECL|class|XenAPIManagedDiskTestCase
dedent|''
dedent|''
name|'class'
name|'XenAPIManagedDiskTestCase'
op|'('
name|'test'
op|'.'
name|'TestCase'
...
name|'classmethod'
newline|'\n'
DECL|function|fake_resize_partition_fs
name|'def'
name|'fake_resize_partition_fs'
op|'('
name|'cls'
op|','
name|'dev_path'
...
name|'VMHelper'
op|','
string|'"_resize_partition_and_fs"'
op|','
nl|'\n'
name|'fake_resize_partition_fs'
op|')'
...
newline|'\n'
nl|'\n'
DECL|member|test_instance_not_managed
dedent|''
name|'def'
name|'test_instance_not_managed'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
indent|'        '
string|'"""Should not partition unless instance is marked as managed_disk"""'
newline|'\n'
name|'self'
op|'.'
name|'instance_values'
...
name|'stub_vm_utils_with_vdi_attached_here'
newline|'\n'
DECL|member|test_instance_managed_doesnt_pass_fail_safes
name|'def'
name|'test_instance_managed_doesnt_pass_fail_safes'
op|'('
name|'self'
op|')'
op|':'
...
name|'classmethod'
newline|'\n'
DECL|function|fake_resize_partition_allowed
name|'def'
name|'fake_resize_partition_allowed'
op|'('
name|'cls'
op|','
name|'dev_path'
...
name|'VMHelper'
op|','
string|'"_resize_partition_allowed"'
op|','
nl|'\n'
name|'fake_resize_partition_allowed'
op|')'
...
name|'stub_vm_utils_with_vdi_attached_here'
newline|'\n'
DECL|member|test_instance_managed_passes_fail_safes
name|'def'
name|'test_instance_managed_passes_fail_safes'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
indent|'        '
string|'"""Should partition if instance is marked as managed_disk=True and\n        virt-layer specific fail-safe checks pass.\n        """'
newline|'\n'
name|'self'
op|'.'
name|'instance_values'
