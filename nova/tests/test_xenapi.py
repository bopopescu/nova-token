...
op|']'
newline|'\n'
comment|'#tcpip_data = dict([(k, v)'
nl|'\n'
comment|'#    for k, v in xenstore_value.iteritems()'
nl|'\n'
comment|'#    if k.startswith(key_prefix)])'
nl|'\n'
comment|'#LOG.debug("tcpip data: %s",tcpip_data)'
nl|'\n'
comment|"#self.assertEquals(tcpip_data['label'],'test_network')"
nl|'\n'
comment|'#self.assertEquals(tcpip_data, {'
nl|'\n'
comment|"#    'label': 'test_network',"
nl|'\n'
comment|"#    'broadcast': '10.0.0.255',"
nl|'\n'
comment|"#    'ips': [{'ip': '10.0.0.3', 'netmask':'255.255.255.0', 'enabled':'1'}],"
nl|'\n'
comment|"#    'mac': 'aa:bb:cc:dd:ee:ff',"
nl|'\n'
comment|"#    'dns': ['10.0.0.2'],"
nl|'\n'
comment|"#    'gateway': '10.0.0.1'})"
nl|'\n'
nl|'\n'
