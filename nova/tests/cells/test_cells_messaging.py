...
newline|'\n'
nl|'\n'
DECL|member|_run_compute_api_method_expects_object
dedent|''
name|'def'
name|'_run_compute_api_method_expects_object'
op|'('
name|'self'
op|','
name|'tgt_compute_api_function'
op|','
nl|'\n'
name|'method_name'
op|','
...
op|':'
newline|'\n'
comment|'# runs compute api methods which expects instance to be an object'
nl|'\n'
indent|'        '
name|'instance_uuid'
op|'='
...
comment|'#'
nl|'\n'
comment|"# self.mox.StubOutWithMock(objects, 'Instance',"
nl|'\n'
...
nl|'\n'
comment|'# instance_mock = self.mox.CreateMock(objects.Instance)'
nl|'\n'
comment|'# objects.Instance().AndReturn(instance_mock)'
nl|'\n'
comment|'#'
nl|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|test_run_compute_api_method_expects_obj_with_info_cache
dedent|''
name|'def'
name|'test_run_compute_api_method_expects_obj_with_info_cache'
op|'('
name|'self'
op|')'
op|':'
