...
name|'patch'
op|'('
string|"'nova.volume.cinder.get_cinder_client_version'"
op|')'
newline|'\n'
op|'@'
name|'mock'
...
op|')'
newline|'\n'
DECL|member|test_update_volume_metadata_delete
name|'def'
name|'test_update_volume_metadata_delete'
op|'('
name|'self'
op|','
name|'mock_cinderclient'
