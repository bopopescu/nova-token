...
newline|'\n'
nl|'\n'
DECL|member|test_cpu_count_not_implemented_returns_1
dedent|''
name|'def'
name|'test_cpu_count_not_implemented_returns_1'
op|'('
name|'self'
op|')'
op|':'
