...
newline|'\n'
nl|'\n'
DECL|member|test_get_major_minor_version_from_string
dedent|''
name|'def'
name|'test_get_major_minor_version_from_string'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_major_minor_version_from_float
dedent|''
name|'def'
name|'test_get_major_minor_version_from_float'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_major_minor_version_raises_exception
dedent|''
name|'def'
name|'test_get_major_minor_version_raises_exception'
op|'('
name|'self'
op|')'
op|':'
