...
nl|'\n'
nl|'\n'
comment|'#    Copyright 2011 Linux2Go'
nl|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|test_index_and_detail_have_same_results
dedent|''
dedent|''
name|'def'
name|'test_index_and_detail_have_same_results'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_show_by_name
dedent|''
name|'def'
name|'test_show_by_name'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|class|FakeImageTestCase
dedent|''
dedent|''
name|'class'
name|'FakeImageTestCase'
op|'('
name|'_ImageTestCase'
op|')'
op|':'
