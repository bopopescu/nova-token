...
newline|'\n'
nl|'\n'
comment|'# NOTE(bnemec): There is a bug with legacy network info that causes'
nl|'\n'
comment|'# it to inject regardless of whether the network is static or dynamic.'
nl|'\n'
comment|"# This can't be fixed without changes that would potentially break"
nl|'\n'
comment|'# existing code, so until legacy network info goes away this test'
nl|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|test_injection_static_legacy
dedent|''
name|'def'
name|'test_injection_static_legacy'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_injection_static_legacy_nogateway
dedent|''
name|'def'
name|'test_injection_static_legacy_nogateway'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_injection_static_ipv6_legacy
dedent|''
name|'def'
name|'test_injection_static_ipv6_legacy'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_injection_static_ipv6_legacy_nogateway
dedent|''
name|'def'
name|'test_injection_static_ipv6_legacy_nogateway'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_injection_dynamic_legacy
dedent|''
name|'def'
name|'test_injection_dynamic_legacy'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_injection_dynamic_legacy_nogateway
dedent|''
name|'def'
name|'test_injection_dynamic_legacy_nogateway'
op|'('
name|'self'
op|')'
op|':'
