...
newline|'\n'
nl|'\n'
DECL|member|test_cached_admin_client
dedent|''
name|'def'
name|'test_cached_admin_client'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
comment|'# should be called one time only'
nl|'\n'
name|'quantum_client'
op|'.'
name|'HTTPClient'
...
op|')'
op|'=='
string|"'pre_get_instance_nw_info'"
op|':'
newline|'\n'
indent|'                '
name|'self'
