...
nl|'\n'
nl|'\n'
DECL|class|TestQuantumv2Base
dedent|''
dedent|''
name|'class'
name|'TestQuantumv2Base'
op|'('
name|'test'
op|'.'
name|'TestCase'
...
name|'api'
op|','
string|"'_refresh_quantum_extensions_cache'"
op|')'
newline|'\n'
name|'quantumv2'
op|'.'
...
name|'api'
op|','
string|"'_populate_quantum_extension_values'"
op|')'
newline|'\n'
dedent|''
name|'self'
...
op|':'
newline|'\n'
comment|'# since _populate_quantum_extension_values() will call'
nl|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|test_refresh_quantum_extensions_cache
dedent|''
name|'def'
name|'test_refresh_quantum_extensions_cache'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_populate_quantum_extension_values_rxtx_factor
dedent|''
name|'def'
name|'test_populate_quantum_extension_values_rxtx_factor'
op|'('
name|'self'
op|')'
op|':'
...
nl|'\n'
nl|'\n'
DECL|class|TestQuantumv2ModuleMethods
dedent|''
dedent|''
name|'class'
name|'TestQuantumv2ModuleMethods'
op|'('
name|'test'
op|'.'
name|'TestCase'
...
nl|'\n'
nl|'\n'
DECL|class|TestQuantumv2Portbinding
dedent|''
dedent|''
name|'class'
name|'TestQuantumv2Portbinding'
op|'('
name|'TestQuantumv2Base'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_populate_quantum_extension_values_binding
dedent|''
name|'def'
name|'test_populate_quantum_extension_values_binding'
op|'('
name|'self'
op|')'
op|':'
