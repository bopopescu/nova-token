...
nl|'\n'
nl|'\n'
DECL|class|BackdoorPortTestCase
dedent|''
dedent|''
name|'class'
name|'BackdoorPortTestCase'
op|'('
name|'test'
op|'.'
name|'TestCase'
...
newline|'\n'
indent|'    '
string|'"""Tests nova.network.manager.get_backdoor_port."""'
newline|'\n'
DECL|member|setUp
name|'def'
name|'setUp'
...
newline|'\n'
nl|'\n'
DECL|member|test_backdoor_port
dedent|''
name|'def'
name|'test_backdoor_port'
op|'('
name|'self'
op|')'
op|':'
