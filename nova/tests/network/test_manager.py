...
newline|'\n'
indent|'        '
string|'"""Verify doesn\'t deallocate deleted fixed_ip from deleted network"""'
newline|'\n'
nl|'\n'
DECL|function|network_get
name|'def'
...
newline|'\n'
indent|'        '
string|'"""Verify IP is not deallocated if the security group refresh fails."""'
newline|'\n'
DECL|function|network_get
name|'def'
name|'network_get'
...
newline|'\n'
indent|'        '
string|'"""Make sure MAC collisions are retried"""'
newline|'\n'
name|'self'
op|'.'
name|'flags'
...
newline|'\n'
indent|'        '
string|'"""Ensure that FloatingIpNotFoundForAddress is wrapped"""'
newline|'\n'
name|'self'
op|'.'
name|'mox'
