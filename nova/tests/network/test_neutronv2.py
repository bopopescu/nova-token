...
newline|'\n'
nl|'\n'
DECL|member|test_validate_networks_duplicate_disable
dedent|''
dedent|''
name|'def'
name|'test_validate_networks_duplicate_disable'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
indent|'        '
string|'"""Verify that no duplicateNetworks exception is thrown when duplicate\n        network ids are passed to validate_networks, when nova config flag\n        allow_duplicate_networks is set to its non default value: True\n        """'
newline|'\n'
name|'self'
op|'.'
name|'flags'
...
newline|'\n'
nl|'\n'
DECL|member|test_validate_networks_ports_in_same_network_disable
dedent|''
name|'def'
name|'test_validate_networks_ports_in_same_network_disable'
op|'('
name|'self'
op|')'
op|':'
