...
newline|'\n'
nl|'\n'
DECL|member|test_withouttoken_context_is_admin
dedent|''
name|'def'
name|'test_withouttoken_context_is_admin'
op|'('
name|'self'
op|')'
op|':'
...
comment|'# are not asking for an admin client, and so we auth with'
nl|'\n'
comment|'# our own token - which is null, and so this is an error'
nl|'\n'
name|'self'
op|'.'
name|'assertRaises'
...
name|'False'
newline|'\n'
comment|'# Note: (dkehn) this option check should be removed as soon as support'
nl|'\n'
comment|'# in neutron released, see https://bugs.launchpad.net/nova/+bug/1214162'
nl|'\n'
name|'if'
op|'('
name|'cfg'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_instance_nw_info_with_nets_and_info_cache
dedent|''
name|'def'
name|'test_get_instance_nw_info_with_nets_and_info_cache'
op|'('
name|'self'
op|')'
op|':'
...
op|')'
newline|'\n'
comment|'# remove first inf and verify that the second interface is correct'
nl|'\n'
dedent|''
name|'del'
name|'nw_inf'
...
name|'message'
op|'='
string|'"Quota exceeded for resources: [\'port\']"'
op|','
nl|'\n'
name|'status_code'
op|'='
...
comment|'# two ports, where the quota is 2 and 2 ports are in use'
nl|'\n'
comment|'# but the request includes a port to be used'
nl|'\n'
comment|'#  => instances which can be created = 1'
nl|'\n'
indent|'        '
...
op|':'
newline|'\n'
DECL|member|test_get_cached_neutron_client_for_admin
indent|'    '
name|'def'
name|'test_get_cached_neutron_client_for_admin'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
comment|'# Make multiple calls and ensure we get the same'
nl|'\n'
comment|'# client back again and again'
nl|'\n'
name|'client'
op|'='
name|'neutronv2'
...
newline|'\n'
nl|'\n'
comment|'# A new client should be created now'
nl|'\n'
name|'client4'
op|'='
name|'neutronv2'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_neutron_client_for_non_admin
dedent|''
name|'def'
name|'test_get_neutron_client_for_non_admin'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
comment|'# Multiple calls should return different clients'
nl|'\n'
name|'client'
op|'='
name|'neutronv2'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_neutron_client_for_non_admin_and_no_token
dedent|''
name|'def'
name|'test_get_neutron_client_for_non_admin_and_no_token'
op|'('
name|'self'
op|')'
op|':'
