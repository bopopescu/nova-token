...
nl|'\n'
op|'['
string|"'project1-floating-ip'"
op|','
string|"'project2-floating-ip'"
op|']'
op|')'
newline|'\n'
name|'self'
...
op|','
nl|'\n'
string|"'floating_ip_get_all_by_project'"
op|')'
newline|'\n'
name|'self'
op|'.'
...
name|'patch'
op|'('
string|"'nova.objects.network.Network.get_by_id'"
op|')'
newline|'\n'
