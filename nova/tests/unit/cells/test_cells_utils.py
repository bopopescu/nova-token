...
op|':'
newline|'\n'
comment|'# Pretend we return a full list the first time otherwise we loop'
nl|'\n'
comment|'# infinitely'
nl|'\n'
indent|'            '
...
op|')'
newline|'\n'
DECL|member|_test_get_instances_pagination
name|'def'
name|'_test_get_instances_pagination'
op|'('
name|'self'
op|','
name|'mock_shuffle'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_instances_to_sync_limit
dedent|''
name|'def'
name|'test_get_instances_to_sync_limit'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_instances_to_sync_shuffle
dedent|''
name|'def'
name|'test_get_instances_to_sync_shuffle'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_instances_to_sync_updated_since
dedent|''
name|'def'
name|'test_get_instances_to_sync_updated_since'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_instances_to_sync_multiple_params
dedent|''
name|'def'
name|'test_get_instances_to_sync_multiple_params'
op|'('
name|'self'
op|')'
op|':'
