...
nl|'\n'
nl|'\n'
DECL|class|CellsTargetedMethodsWithDatabaseTestCase
dedent|''
dedent|''
dedent|''
name|'class'
name|'CellsTargetedMethodsWithDatabaseTestCase'
op|'('
name|'test'
op|'.'
name|'TestCase'
...
newline|'\n'
indent|'    '
string|'"""These tests access the database unlike the others."""'
newline|'\n'
nl|'\n'
DECL|member|setUp
name|'def'
...
op|')'
newline|'\n'
comment|'# Check that save is called with the right expected states.'
nl|'\n'
name|'mock_save'
op|'.'
name|'assert_called_once_with'
...
newline|'\n'
nl|'\n'
DECL|member|test_instance_destroy_at_top_incomplete_instance_obj
dedent|''
dedent|''
name|'def'
name|'test_instance_destroy_at_top_incomplete_instance_obj'
op|'('
name|'self'
op|')'
op|':'
...
op|')'
newline|'\n'
DECL|member|test_get_keypair_at_top_with_objects_exception
name|'def'
name|'test_get_keypair_at_top_with_objects_exception'
op|'('
name|'self'
op|','
name|'fake_get_by_name'
...
op|')'
newline|'\n'
DECL|member|test_get_keypair_at_top_with_process_response
name|'def'
name|'test_get_keypair_at_top_with_process_response'
op|'('
name|'self'
op|','
name|'fake_process'
