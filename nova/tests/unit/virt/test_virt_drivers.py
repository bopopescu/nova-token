...
nl|'\n'
string|'"required for test %(test)s"'
op|'%'
nl|'\n'
op|'{'
string|"'driver'"
...
op|'('
nl|'\n'
string|"'nova.virt.libvirt.driver.connector'"
op|','
nl|'\n'
name|'fake_os_brick_connector'
op|')'
...
newline|'\n'
nl|'\n'
DECL|function|fake_detach_device_with_retry
dedent|''
name|'def'
name|'fake_detach_device_with_retry'
op|'('
name|'_self'
op|','
...
op|':'
newline|'\n'
comment|'# Still calling detach, but instead of returning function'
nl|'\n'
comment|'# that actually checks if device is gone from XML, just continue'
nl|'\n'
comment|'# because XML never gets updated in these tests'
nl|'\n'
indent|'            '
name|'_self'
op|'.'
...
op|','
nl|'\n'
string|"'detach_device_with_retry'"
op|','
nl|'\n'
name|'fake_detach_device_with_retry'
op|')'
...
name|'catch_notimplementederror'
newline|'\n'
DECL|member|test_live_migration_abort
name|'def'
name|'test_live_migration_abort'
op|'('
name|'self'
op|')'
op|':'
...
name|'catch_notimplementederror'
newline|'\n'
DECL|member|test_get_device_name_for_instance
name|'def'
name|'test_get_device_name_for_instance'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_network_binding_host_id
dedent|''
name|'def'
name|'test_network_binding_host_id'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
comment|"# NOTE(jroll) self._get_running_instance calls spawn(), so we can't"
nl|'\n'
comment|'# use it to test this method. Make a simple object instead; we just'
nl|'\n'
comment|'# need instance.host.'
nl|'\n'
indent|'        '
name|'instance'
op|'='
...
name|'skipTest'
op|'('
string|"'Live migration is not implemented in the base '"
nl|'\n'
string|"'virt driver.'"
op|')'
newline|'\n'
...
op|')'
newline|'\n'
comment|'# This is needed for the live migration tests which spawn off the'
nl|'\n'
comment|'# operation for monitoring.'
nl|'\n'
name|'self'
op|'.'
name|'useFixture'
...
name|'skipTest'
op|'('
string|'"Tested by the nova.tests.unit.virt.libvirt suite"'
op|')'
newline|'\n'
nl|'\n'
dedent|''
...
name|'patch'
op|'('
string|'"nova.virt.libvirt.host.Host.has_min_version"'
op|')'
newline|'\n'
DECL|member|test_set_admin_password
name|'def'
