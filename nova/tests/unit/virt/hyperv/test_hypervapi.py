...
newline|'\n'
nl|'\n'
DECL|member|test_power_on_without_block_devices
dedent|''
name|'def'
name|'test_power_on_without_block_devices'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
indent|'        '
name|'fake_volume_drives'
op|'='
op|'['
string|"'fake_volume_drive'"
op|']'
newline|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|test_live_migration_with_multiple_luns_per_target
dedent|''
name|'def'
name|'test_live_migration_with_multiple_luns_per_target'
op|'('
name|'self'
op|')'
op|':'
...
op|'('
op|'('
string|"'fake_remote_vm_log_path'"
op|','
nl|'\n'
string|"'fake_remote_vm_log_path.1'"
op|')'
op|')'
newline|'\n'
nl|'\n'
...
name|'return_value'
op|'='
string|'"fake_mounted_path"'
newline|'\n'
name|'mock_set_disk_host_resource'
op|'.'
name|'return_value'
op|'='
string|'"fake_controller_path"'
newline|'\n'
nl|'\n'
name|'self'
op|'.'
...
name|'patch'
op|'('
string|"'nova.virt.hyperv.hostops.time'"
op|')'
newline|'\n'
DECL|member|test_host_uptime
name|'def'
name|'test_host_uptime'
op|'('
name|'self'
op|','
name|'mock_time'
...
name|'result_uptime'
op|'='
string|'"01:01:01 up %s,  0 users,  load average: 0, 0, 0"'
op|'%'
op|'('
nl|'\n'
name|'str'
