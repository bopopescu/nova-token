...
name|'VMUtilsV2'
op|','
string|"'_get_vm_setting_data'"
op|')'
newline|'\n'
DECL|member|_test_get_vm_generation
name|'def'
name|'_test_get_vm_generation'
op|'('
name|'self'
op|','
name|'vm_gen'
...
name|'vm_gen_string'
op|'='
string|'"Microsoft:Hyper-V:SubType:"'
op|'+'
name|'str'
op|'('
name|'vm_gen'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_vm_generation_gen2
dedent|''
name|'def'
name|'test_get_vm_generation_gen2'
op|'('
name|'self'
op|')'
op|':'
