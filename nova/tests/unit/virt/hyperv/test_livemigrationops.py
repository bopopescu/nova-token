...
name|'patch'
op|'('
string|"'nova.virt.hyperv.pathutils.PathUtils.copy_configdrive'"
op|')'
newline|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|test_live_migration_with_configdrive
dedent|''
name|'def'
name|'test_live_migration_with_configdrive'
op|'('
name|'self'
op|')'
op|':'
