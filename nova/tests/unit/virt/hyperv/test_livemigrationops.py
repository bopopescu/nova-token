...
name|'patch'
op|'('
string|"'nova.virt.hyperv.utilsfactory'"
nl|'\n'
...
name|'patch'
op|'('
string|"'nova.virt.hyperv.volumeops.VolumeOps.logout_storage_target'"
op|')'
newline|'\n'
op|'@'
name|'mock'
...
name|'self'
op|','
name|'mock_login_storage_targets'
op|','
nl|'\n'
