...
name|'patch'
op|'('
string|"'nova.virt.hyperv.volumeops.VolumeOps.get_disk_path_mapping'"
op|')'
newline|'\n'
op|'@'
name|'mock'
...
newline|'\n'
nl|'\n'
DECL|member|test_pre_live_migration_invalid_disk_mapping
dedent|''
name|'def'
name|'test_pre_live_migration_invalid_disk_mapping'
op|'('
name|'self'
op|')'
op|':'
