...
newline|'\n'
nl|'\n'
DECL|member|test_get_drive_number_from_disk_path
dedent|''
name|'def'
name|'test_get_drive_number_from_disk_path'
op|'('
name|'self'
op|')'
op|':'
...
op|'('
nl|'\n'
string|"'\\\\\\\\WIN-I5BTVHOIFGK\\\\root\\\\virtualization\\\\v2:Msvm_DiskDrive.'"
nl|'\n'
string|'\'CreationClassName="Msvm_DiskDrive",DeviceID="Microsoft:353B3BE8-\''
nl|'\n'
string|'\'310C-4cf4-839E-4E1B14616136\\\\\\\\1",SystemCreationClassName=\''
nl|'\n'
string|'\'"Msvm_ComputerSystem",SystemName="WIN-I5BTVHOIFGK"\''
op|')'
newline|'\n'
name|'expected_disk_number'
op|'='
number|'1'
newline|'\n'
nl|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_drive_number_not_found
dedent|''
name|'def'
name|'test_get_drive_number_not_found'
op|'('
name|'self'
op|')'
op|':'
