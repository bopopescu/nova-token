...
op|')'
newline|'\n'
comment|"# TODO(mriedem): Remove these stubs once we're only using fakelibvirt."
nl|'\n'
op|'@'
name|'mock'
op|'.'
...
name|'libvirt'
op|','
string|'"VIR_CONNECT_LIST_DOMAINS_INACTIVE"'
op|','
name|'new'
op|'='
number|'2'
...
op|')'
newline|'\n'
comment|"# TODO(mriedem): Remove this stub once we're only using fakelibvirt."
nl|'\n'
op|'@'
name|'mock'
op|'.'
...
op|')'
newline|'\n'
comment|"# TODO(mriedem): Remove this stub, and others like it, once we're using"
nl|'\n'
comment|'# fakelibvirt in all tests (no chance of running against a real libvirt).'
nl|'\n'
op|'@'
name|'mock'
op|'.'
...
name|'libvirt'
op|','
string|"'VIR_SECRET_USAGE_TYPE_ISCSI'"
op|','
name|'new'
op|'='
number|'3'
