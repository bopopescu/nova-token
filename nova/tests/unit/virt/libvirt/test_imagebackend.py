...
newline|'\n'
nl|'\n'
DECL|member|test_libvirt_info
dedent|''
dedent|''
name|'def'
name|'test_libvirt_info'
op|'('
name|'self'
op|')'
op|':'
...
op|'{'
nl|'\n'
string|"'quota:disk_read_bytes_sec'"
op|':'
number|'10'
op|'*'
name|'units'
...
op|','
nl|'\n'
string|"'quota:disk_read_iops_sec'"
op|':'
number|'1'
op|'*'
name|'units'
...
op|','
nl|'\n'
string|"'quota:disk_write_bytes_sec'"
op|':'
number|'20'
op|'*'
name|'units'
...
op|','
nl|'\n'
string|"'quota:disk_write_iops_sec'"
op|':'
number|'2'
op|'*'
name|'units'
...
op|','
nl|'\n'
string|"'quota:disk_total_bytes_sec'"
op|':'
number|'30'
op|'*'
name|'units'
...
op|','
nl|'\n'
string|"'quota:disk_total_iops_sec'"
op|':'
number|'3'
op|'*'
name|'units'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_parent_pool
dedent|''
name|'def'
name|'test_get_parent_pool'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_parent_pool_no_parent_info
dedent|''
dedent|''
name|'def'
name|'test_get_parent_pool_no_parent_info'
op|'('
name|'self'
op|')'
op|':'
...
name|'rbd_uri'
op|'='
string|"'rbd://%s/%s/fake-image/fake-snap'"
op|'%'
op|'('
name|'self'
op|'.'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_parent_pool_non_local_image
dedent|''
dedent|''
name|'def'
name|'test_get_parent_pool_non_local_image'
op|'('
name|'self'
op|')'
op|':'
...
name|'rbd_uri'
op|'='
string|"'rbd://remote-cluster/remote-pool/fake-image/fake-snap'"
newline|'\n'
name|'with'
name|'test'
op|'.'
...
newline|'\n'
nl|'\n'
DECL|member|test_direct_snapshot
dedent|''
dedent|''
name|'def'
name|'test_direct_snapshot'
op|'('
name|'self'
op|')'
op|':'
...
name|'test_snap'
op|'='
string|"'rbd://%s/%s/fake-image-id/snap'"
op|'%'
op|'('
name|'self'
op|'.'
...
name|'image'
op|','
string|"'cleanup_direct_snapshot'"
op|')'
nl|'\n'
op|')'
name|'as'
...
newline|'\n'
nl|'\n'
DECL|member|test_direct_snapshot_cleans_up_on_failures
dedent|''
dedent|''
name|'def'
name|'test_direct_snapshot_cleans_up_on_failures'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_cleanup_direct_snapshot
dedent|''
dedent|''
name|'def'
name|'test_cleanup_direct_snapshot'
op|'('
name|'self'
op|')'
op|':'
...
op|':'
newline|'\n'
comment|'# Ensure that the method does nothing when no location is provided'
nl|'\n'
indent|'            '
name|'image'
op|'.'
...
newline|'\n'
nl|'\n'
comment|'# Ensure that destroy_volume is not called'
nl|'\n'
name|'image'
op|'.'
name|'cleanup_direct_snapshot'
...
newline|'\n'
nl|'\n'
DECL|member|test_cleanup_direct_snapshot_destroy_volume
dedent|''
dedent|''
name|'def'
name|'test_cleanup_direct_snapshot_destroy_volume'
op|'('
name|'self'
op|')'
op|':'
...
op|':'
newline|'\n'
comment|'# Ensure that destroy_volume is called'
nl|'\n'
indent|'            '
name|'image'
op|'.'
...
newline|'\n'
nl|'\n'
DECL|member|test_image_raw_native_io
dedent|''
name|'def'
name|'test_image_raw_native_io'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_image_qcow2_native_io
dedent|''
name|'def'
name|'test_image_qcow2_native_io'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_image_lvm_native_io
dedent|''
name|'def'
name|'test_image_lvm_native_io'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
DECL|function|_test_native_io
indent|'        '
name|'def'
name|'_test_native_io'
op|'('
name|'is_sparse'
op|','
name|'driver_io'
