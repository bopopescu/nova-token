...
op|')'
newline|'\n'
DECL|member|test_copy_image_rsync_ipv6
name|'def'
name|'test_copy_image_rsync_ipv6'
op|'('
name|'self'
op|','
name|'mock_execute'
...
op|')'
newline|'\n'
DECL|member|test_copy_image_scp_ipv6
name|'def'
name|'test_copy_image_scp_ipv6'
op|'('
name|'self'
op|','
name|'mock_execute'
...
op|'('
nl|'\n'
string|"'/sys/bus/ccw/drivers/zfcp/0.0.2319/0x50014380242b9751/unit_add'"
op|','
nl|'\n'
name|'lun'
op|')'
...
op|')'
newline|'\n'
DECL|member|test_perform_unit_add_for_s390_failed
name|'def'
name|'test_perform_unit_add_for_s390_failed'
op|'('
name|'self'
op|','
name|'mock_execute'
...
op|')'
newline|'\n'
comment|'# NOTE(mriedem): A better test is to probably make sure that the stderr'
nl|'\n'
comment|'# message is logged in the warning but that gets messy with Message'
nl|'\n'
comment|'# objects and mock.call_args.'
nl|'\n'
name|'self'
op|'.'
name|'assertEqual'
...
op|')'
newline|'\n'
DECL|member|test_perform_unit_remove_for_s390_failed
name|'def'
name|'test_perform_unit_remove_for_s390_failed'
op|'('
name|'self'
op|','
name|'mock_execute'
