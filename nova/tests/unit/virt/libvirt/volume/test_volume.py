...
op|')'
newline|'\n'
DECL|member|test_libvirt_volume_driver_discard_true
name|'def'
name|'test_libvirt_volume_driver_discard_true'
op|'('
name|'self'
op|','
...
op|':'
newline|'\n'
comment|'# Check the discard attrib is present in driver section'
nl|'\n'
indent|'        '
name|'mock_has_min_version'
op|'.'
...
newline|'\n'
nl|'\n'
DECL|member|test_libvirt_volume_driver_discard_false
dedent|''
name|'def'
name|'test_libvirt_volume_driver_discard_false'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
comment|'# Check the discard attrib is not present in driver section'
nl|'\n'
indent|'        '
name|'libvirt_driver'
op|'='
...
op|')'
newline|'\n'
DECL|member|test_libvirt_volume_driver_discard_true_bad_version
name|'def'
name|'test_libvirt_volume_driver_discard_true_bad_version'
op|'('
nl|'\n'
name|'self'
op|','
