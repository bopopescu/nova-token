...
newline|'\n'
nl|'\n'
comment|'# Libvirt version to match MIN_LIBVIRT_VERSION in driver.py'
nl|'\n'
...
number|'1002001'
newline|'\n'
comment|'# Libvirt version to match MIN_QEMU_VERSION in driver.py'
nl|'\n'
DECL|variable|FAKE_QEMU_VERSION
name|'FAKE_QEMU_VERSION'
op|'='
number|'1005003'
newline|'\n'
nl|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|migrateSetMaxDowntime
dedent|''
name|'def'
name|'migrateSetMaxDowntime'
op|'('
name|'self'
op|','
name|'downtime'
...
op|':'
newline|'\n'
comment|'# NOTE(danms): This is an array of 12 integers, so just report'
nl|'\n'
comment|'# something to avoid an IndexError if we look at this'
nl|'\n'
indent|'        '
name|'return'
op|'['
