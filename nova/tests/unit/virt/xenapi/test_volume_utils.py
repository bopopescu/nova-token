...
nl|'\n'
nl|'\n'
DECL|class|IntroduceSRTestCase
dedent|''
dedent|''
name|'class'
name|'IntroduceSRTestCase'
op|'('
name|'stubs'
op|'.'
name|'XenAPITestBaseNoDB'
...
op|')'
newline|'\n'
DECL|member|test_backend_kind
name|'def'
name|'test_backend_kind'
op|'('
name|'self'
op|','
name|'create_pbd'
...
op|')'
newline|'\n'
DECL|member|test_backend_kind_upstream_fix
name|'def'
name|'test_backend_kind_upstream_fix'
op|'('
name|'self'
op|','
name|'create_pbd'
...
nl|'\n'
nl|'\n'
DECL|class|MultipleVolumesTestCase
dedent|''
dedent|''
name|'class'
name|'MultipleVolumesTestCase'
op|'('
name|'stubs'
op|'.'
name|'XenAPITestBaseNoDB'
...
op|':'
newline|'\n'
DECL|member|test_sr_info_two_luns
indent|'    '
name|'def'
name|'test_sr_info_two_luns'
op|'('
name|'self'
op|')'
op|':'
...
op|')'
newline|'\n'
DECL|member|test_purge_sr_no_VBDs
name|'def'
name|'test_purge_sr_no_VBDs'
op|'('
name|'self'
op|','
name|'mock_forget'
...
op|')'
newline|'\n'
DECL|member|test_purge_sr_in_use
name|'def'
name|'test_purge_sr_in_use'
op|'('
name|'self'
op|','
name|'mock_forget'
