...
op|')'
newline|'\n'
DECL|member|test_import_migrate_ephemeral_disks_use_old_flavor
name|'def'
name|'test_import_migrate_ephemeral_disks_use_old_flavor'
op|'('
name|'self'
op|','
nl|'\n'
...
name|'assertEqual'
op|'('
string|'"Device id 2 specified is not supported by "'
nl|'\n'
