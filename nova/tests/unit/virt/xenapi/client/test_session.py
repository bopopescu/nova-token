...
op|')'
newline|'\n'
DECL|member|test_session_login_with_timeout
name|'def'
name|'test_session_login_with_timeout'
op|'('
name|'self'
op|','
name|'mock_verify'
...
name|'XenAPISession'
op|','
string|"'_get_host_ref'"
op|')'
newline|'\n'
DECL|member|test_session_raises_exception
name|'def'
name|'test_session_raises_exception'
op|'('
name|'self'
op|','
name|'mock_ref'
...
name|'sess'
newline|'\n'
comment|'# First login fails, second login in except block succeeds,'
nl|'\n'
comment|'# third login for the pool succeeds'
nl|'\n'
name|'sess'
op|'.'
name|'login_with_password'
