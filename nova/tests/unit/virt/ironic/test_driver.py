...
newline|'\n'
nl|'\n'
DECL|member|_test_add_driver_fields
dedent|''
name|'def'
name|'_test_add_driver_fields'
op|'('
name|'self'
op|','
name|'mock_update'
...
op|':'
newline|'\n'
comment|'# assert call() is invoked with retry_on_conflict False to'
nl|'\n'
comment|'# avoid bug #1341420'
nl|'\n'
indent|'            '
name|'mock_call'
op|'.'
...
op|')'
newline|'\n'
DECL|member|test__add_driver_fields_mock_update
name|'def'
name|'test__add_driver_fields_mock_update'
op|'('
name|'self'
op|','
name|'mock_update'
...
op|')'
newline|'\n'
DECL|member|test__add_driver_fields_mock_call
name|'def'
name|'test__add_driver_fields_mock_call'
op|'('
name|'self'
op|','
name|'mock_call'
...
op|')'
newline|'\n'
DECL|member|test_spawn_node_configdrive_fail
name|'def'
name|'test_spawn_node_configdrive_fail'
op|'('
name|'self'
op|','
name|'mock_cleanup_deploy'
...
op|')'
newline|'\n'
comment|"# make the address be consistent with network_info's"
nl|'\n'
name|'port'
op|'='
name|'ironic_utils'
...
op|')'
newline|'\n'
DECL|member|test_plug_vifs_multiple_ports
name|'def'
name|'test_plug_vifs_multiple_ports'
op|'('
name|'self'
op|','
name|'mock_uvifs'
...
op|')'
newline|'\n'
name|'first_ironic_port_uuid'
op|'='
string|"'aaaaaaaa-bbbb-1111-dddd-eeeeeeeeeeee'"
newline|'\n'
name|'first_port'
op|'='
name|'ironic_utils'
...
name|'address'
op|'='
string|"'11:FF:FF:FF:FF:FF'"
op|')'
newline|'\n'
name|'second_ironic_port_uuid'
op|'='
string|"'aaaaaaaa-bbbb-2222-dddd-eeeeeeeeeeee'"
newline|'\n'
name|'second_port'
op|'='
name|'ironic_utils'
...
name|'first_vif_id'
op|'='
string|"'aaaaaaaa-vv11-cccc-dddd-eeeeeeeeeeee'"
newline|'\n'
name|'second_vif_id'
op|'='
string|"'aaaaaaaa-vv22-cccc-dddd-eeeeeeeeeeee'"
newline|'\n'
name|'first_vif'
op|'='
name|'ironic_utils'
...
op|')'
newline|'\n'
DECL|member|_test_network_binding_host_id
name|'def'
name|'_test_network_binding_host_id'
op|'('
name|'self'
op|','
name|'is_neutron'
...
newline|'\n'
nl|'\n'
DECL|member|test_network_binding_host_id_neutron
dedent|''
name|'def'
name|'test_network_binding_host_id_neutron'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_network_binding_host_id_none
dedent|''
name|'def'
name|'test_network_binding_host_id_none'
op|'('
name|'self'
op|')'
op|':'
