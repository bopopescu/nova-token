...
op|','
nl|'\n'
comment|'# a node in deploying but no instance yet'
nl|'\n'
op|'{'
string|"'uuid'"
op|':'
...
op|','
nl|'\n'
comment|'# a node that made it to cleaning before losing its instance uuid'
nl|'\n'
op|'{'
string|"'uuid'"
op|':'
...
op|')'
newline|'\n'
DECL|member|test_destroy_node_in_maintenance
name|'def'
name|'test_destroy_node_in_maintenance'
op|'('
name|'self'
op|','
name|'mock_node'
...
op|')'
newline|'\n'
DECL|member|test_destroy_cleaning
name|'def'
name|'test_destroy_cleaning'
op|'('
name|'self'
op|','
name|'mock_cleanup_deploy'
