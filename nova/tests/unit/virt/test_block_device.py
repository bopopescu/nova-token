...
newline|'\n'
nl|'\n'
comment|'# Test the save method with no context passed'
nl|'\n'
dedent|''
name|'with'
name|'mock'
...
newline|'\n'
nl|'\n'
DECL|member|check_volume_attach_check_attach_fails
dedent|''
name|'def'
name|'check_volume_attach_check_attach_fails'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|check_volume_attach_driver_attach_fails
dedent|''
name|'def'
name|'check_volume_attach_driver_attach_fails'
op|'('
name|'self'
op|')'
op|':'
