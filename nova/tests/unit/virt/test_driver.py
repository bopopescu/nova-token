...
op|'['
nl|'\n'
string|"'key1=nova.tests.unit.virt.test_driver.FakeDriver'"
op|','
nl|'\n'
string|"'key2=nova.tests.unit.virt.test_driver.FakeDriver2'"
op|','
nl|'\n'
op|']'
op|','
...
nl|'\n'
nl|'\n'
DECL|class|DriverMethodTestCase
dedent|''
dedent|''
name|'class'
name|'DriverMethodTestCase'
op|'('
name|'test'
op|'.'
name|'NoDBTestCase'
...
newline|'\n'
nl|'\n'
DECL|member|test_is_xenapi_true
dedent|''
name|'def'
name|'test_is_xenapi_true'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_is_xenapi_false
dedent|''
name|'def'
name|'test_is_xenapi_false'
op|'('
name|'self'
op|')'
op|':'
...
op|','
nl|'\n'
string|"'ironic.IronicDriver'"
op|','
string|"'vmwareapi.VMwareVCDriver'"
op|','
nl|'\n'
string|"'hyperv.HyperVDriver'"
op|','
name|'None'
op|')'
newline|'\n'
