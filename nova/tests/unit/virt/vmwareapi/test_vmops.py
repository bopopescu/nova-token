...
nl|'\n'
string|'"flavor:name:m1.micro\\n"'
nl|'\n'
string|'"flavor:memory_mb:6\\n"'
nl|'\n'
string|'"flavor:vcpus:28\\n"'
nl|'\n'
string|'"flavor:ephemeral_gb:8128\\n"'
nl|'\n'
string|'"flavor:root_gb:496\\n"'
nl|'\n'
string|'"flavor:swap:33550336\\n"'
nl|'\n'
string|'"imageid:70a599e0-31e7-49b7-b260-868f441e862b\\n"'
nl|'\n'
string|'"package:%s\\n"'
op|'%'
name|'version'
...
op|')'
newline|'\n'
DECL|member|test_get_info_instance_deleted
name|'def'
name|'test_get_info_instance_deleted'
op|'('
name|'self'
op|','
name|'mock_get_vm_ref'
...
op|','
nl|'\n'
string|"'_resize_create_ephemerals_and_swap'"
op|')'
op|','
nl|'\n'
name|'mock'
...
name|'as'
op|'('
name|'fake_resize_create_ephemerals_and_swap'
op|','
nl|'\n'
...
op|')'
newline|'\n'
DECL|member|_test_resize_create_ephemerals
name|'def'
name|'_test_resize_create_ephemerals'
op|'('
name|'self'
op|','
name|'vmdk'
...
op|','
nl|'\n'
name|'mock_get_vmdk_info'
op|','
nl|'\n'
name|'mock_get_datastore_by_ref'
op|','
nl|'\n'
name|'mock_create_ephemeral'
op|','
nl|'\n'
name|'mock_create_swap'
op|')'
op|':'
newline|'\n'
indent|'        '
...
newline|'\n'
nl|'\n'
DECL|member|test_resize_create_ephemerals
dedent|''
dedent|''
dedent|''
name|'def'
name|'test_resize_create_ephemerals'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_resize_create_ephemerals_no_root
dedent|''
name|'def'
name|'test_resize_create_ephemerals_no_root'
op|'('
name|'self'
op|')'
op|':'
...
name|'VMwareVMOps'
op|','
string|"'_remove_ephemerals_and_swap'"
op|')'
newline|'\n'
op|'@'
name|'mock'
...
op|','
nl|'\n'
name|'fake_remove_ephemerals_and_swap'
op|','
nl|'\n'
name|'fake_resize_create_ephemerals_and_swap'
op|','
...
string|"'projectname:None\\n'"
nl|'\n'
string|"'flavor:name:m1.small\\n'"
nl|'\n'
string|"'flavor:memory_mb:512\\n'"
nl|'\n'
string|"'flavor:vcpus:1\\n'"
nl|'\n'
string|"'flavor:ephemeral_gb:0\\n'"
nl|'\n'
string|"'flavor:root_gb:10\\n'"
nl|'\n'
string|"'flavor:swap:0\\n'"
nl|'\n'
string|"'imageid:70a599e0-31e7-49b7-b260-868f441e862b\\n'"
nl|'\n'
string|"'package:%s\\n'"
...
name|'vm_util'
op|','
string|"'get_ephemerals'"
op|')'
newline|'\n'
DECL|member|test_remove_ephemerals_and_swap
name|'def'
name|'test_remove_ephemerals_and_swap'
op|'('
name|'self'
op|','
name|'get_ephemerals'
...
newline|'\n'
nl|'\n'
DECL|member|test_migrate_disk_and_power_off_zero_disk_flavor
dedent|''
name|'def'
name|'test_migrate_disk_and_power_off_zero_disk_flavor'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_migrate_disk_and_power_off_disk_shrink
dedent|''
name|'def'
name|'test_migrate_disk_and_power_off_disk_shrink'
op|'('
name|'self'
op|')'
op|':'
...
string|'"flavor:swap:0\\n"'
nl|'\n'
string|'"imageid:%(image_id)s\\n"'
nl|'\n'
string|'"package:%(version)s\\n"'
op|'%'
op|'{'
nl|'\n'
string|"'image_id'"
...
name|'fake_path'
op|'='
string|"'[fake_ds] %(uuid)s/%(uuid)s.vmdk'"
op|'%'
op|'{'
string|"'uuid'"
op|':'
...
newline|'\n'
nl|'\n'
comment|'# Last call should be renaming the instance'
nl|'\n'
dedent|''
name|'expected_methods'
op|'.'
...
op|'('
nl|'\n'
string|"'nova.virt.vmwareapi.vmops.VMwareVMOps._update_vnic_index'"
op|')'
newline|'\n'
op|'@'
name|'mock'
...
op|','
nl|'\n'
name|'mock_update_vnic_index'
op|','
nl|'\n'
name|'mock_create_folders'
op|','
nl|'\n'
name|'block_device_info'
op|'='
...
newline|'\n'
nl|'\n'
DECL|member|test_spawn_with_block_device_info_swap
dedent|''
name|'def'
name|'test_spawn_with_block_device_info_swap'
op|'('
name|'self'
op|')'
op|':'
...
name|'VMwareVMOps'
op|','
string|"'_create_and_attach_thin_disk'"
op|')'
newline|'\n'
op|'@'
name|'mock'
...
op|')'
newline|'\n'
DECL|member|test_spawn_with_ephemerals_and_swap
name|'def'
name|'test_spawn_with_ephemerals_and_swap'
op|'('
name|'self'
op|','
name|'from_image'
...
op|','
nl|'\n'
name|'create_and_attach_thin_disk'
op|','
nl|'\n'
name|'power_on_instance'
op|','
...
newline|'\n'
nl|'\n'
comment|'# _create_and_attach_thin_disk should be called for each ephemeral'
nl|'\n'
comment|'# and swap disk'
nl|'\n'
name|'eph0_path'
op|'='
name|'str'
...
op|')'
newline|'\n'
DECL|member|test_create_and_attach_thin_disk
name|'def'
name|'test_create_and_attach_thin_disk'
op|'('
name|'self'
op|','
name|'mock_create'
...
op|','
nl|'\n'
string|"'[fake_ds] %s/ephemeral_0.vmdk'"
op|'%'
name|'self'
op|'.'
name|'_uuid'
...
newline|'\n'
nl|'\n'
DECL|member|_test_create_swap_from_instance
dedent|''
name|'def'
name|'_test_create_swap_from_instance'
op|'('
name|'self'
op|','
name|'bdi'
...
newline|'\n'
nl|'\n'
DECL|member|test_create_swap_with_bdi
dedent|''
dedent|''
name|'def'
name|'test_create_swap_with_bdi'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_create_swap_with_no_bdi
dedent|''
name|'def'
name|'test_create_swap_with_no_bdi'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_spawn_memory_limit
dedent|''
name|'def'
name|'test_spawn_memory_limit'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_spawn_memory_reservation
dedent|''
name|'def'
name|'test_spawn_memory_reservation'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_spawn_memory_allocations
dedent|''
name|'def'
name|'test_spawn_memory_allocations'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_spawn_memory_shares_level
dedent|''
name|'def'
name|'test_spawn_memory_shares_level'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_spawn_memory_shares_custom
dedent|''
name|'def'
name|'test_spawn_memory_shares_custom'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_spawn_vif_limit
dedent|''
name|'def'
name|'test_spawn_vif_limit'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_spawn_vif_reservation
dedent|''
name|'def'
name|'test_spawn_vif_reservation'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_spawn_vif_shares_level
dedent|''
name|'def'
name|'test_spawn_vif_shares_level'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_spawn_vif_shares_custom
dedent|''
name|'def'
name|'test_spawn_vif_shares_custom'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_esx_host_and_cookies
dedent|''
name|'def'
name|'test_get_esx_host_and_cookies'
op|'('
name|'self'
op|')'
op|':'
...
name|'method'
op|'=='
string|"'AcquireGenericServiceTicket'"
op|':'
newline|'\n'
indent|'                '
name|'ticket'
...
newline|'\n'
nl|'\n'
DECL|member|test_fetch_vsphere_image
dedent|''
dedent|''
name|'def'
name|'test_fetch_vsphere_image'
op|'('
name|'self'
op|')'
op|':'
...
name|'vsphere_location'
op|'='
string|"'vsphere://my?dcPath=mycenter&dsName=mystore'"
newline|'\n'
name|'vi'
op|'='
name|'self'
...
name|'VMwareVMOps'
op|','
string|"'_get_esx_host_and_cookies'"
op|')'
newline|'\n'
...
op|','
nl|'\n'
name|'mock_get_esx_host_and_cookies'
op|','
nl|'\n'
...
op|')'
newline|'\n'
DECL|member|test_fetch_image_as_file_exception
name|'def'
name|'test_fetch_image_as_file_exception'
op|'('
name|'self'
op|','
nl|'\n'
...
op|')'
newline|'\n'
DECL|member|test_fetch_image_as_ova
name|'def'
name|'test_fetch_image_as_ova'
op|'('
name|'self'
op|','
name|'mock_fetch_image'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_instance_metadata
dedent|''
name|'def'
name|'test_get_instance_metadata'
op|'('
name|'self'
op|')'
op|':'
...
name|'vm_util'
op|','
string|"'get_network_attach_config_spec'"
op|','
nl|'\n'
name|'return_value'
op|'='
string|"'fake-attach-spec'"
op|')'
newline|'\n'
op|'@'
name|'mock'
...
op|','
nl|'\n'
name|'mock_get_attach_port_index'
op|','
nl|'\n'
name|'mock_get_network_attach_config_spec'
op|','
nl|'\n'
name|'mock_reconfigure_vm'
op|')'
op|':'
newline|'\n'
indent|'        '
...
name|'vm_util'
op|','
string|"'get_network_detach_config_spec'"
op|','
nl|'\n'
name|'return_value'
op|'='
string|"'fake-detach-spec'"
op|')'
newline|'\n'
op|'@'
name|'mock'
...
name|'vm_util'
op|','
string|"'get_vm_detach_port_index'"
op|','
name|'return_value'
op|'='
number|'1'
...
op|','
nl|'\n'
name|'mock_get_detach_port_index'
op|','
nl|'\n'
name|'mock_get_network_detach_config_spec'
op|','
nl|'\n'
name|'mock_reconfigure_vm'
op|','
nl|'\n'
name|'mock_get_network_device'
op|')'
op|':'
newline|'\n'
indent|'        '
...
newline|'\n'
nl|'\n'
DECL|member|test_get_cores_per_socket
dedent|''
dedent|''
name|'def'
name|'test_get_cores_per_socket'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_folder_name
dedent|''
name|'def'
name|'test_get_folder_name'
op|'('
name|'self'
op|')'
op|':'
