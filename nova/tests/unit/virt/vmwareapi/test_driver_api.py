...
newline|'\n'
nl|'\n'
DECL|member|test_normalize_nodename_old
dedent|''
name|'def'
name|'test_normalize_nodename_old'
op|'('
name|'self'
op|')'
op|':'
...
name|'conn'
op|'.'
name|'_normalize_nodename'
op|'('
name|'old_format'
op|')'
op|','
nl|'\n'
string|"'VC driver failed to normalize cluster name %s'"
op|'%'
nl|'\n'
name|'cluster_name'
op|')'
newline|'\n'
nl|'\n'
DECL|member|test_normalize_nodename_new
dedent|''
dedent|''
name|'def'
name|'test_normalize_nodename_new'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
comment|"# Assert that _normalize_nodename doesn't touch the new format"
nl|'\n'
indent|'        '
name|'test_mor'
op|'='
