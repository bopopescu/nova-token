...
op|')'
newline|'\n'
DECL|member|test_cleanup_host_direct
name|'def'
name|'test_cleanup_host_direct'
op|'('
name|'self'
op|','
name|'mock_init'
...
op|')'
newline|'\n'
DECL|member|test_cleanup_host_direct_with_bad_logout
name|'def'
name|'test_cleanup_host_direct_with_bad_logout'
op|'('
name|'self'
op|','
name|'mock_init'
...
newline|'\n'
nl|'\n'
DECL|member|test_configuration_linked_clone
dedent|''
name|'def'
name|'test_configuration_linked_clone'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|_spawn_power_state
dedent|''
name|'def'
name|'_spawn_power_state'
op|'('
name|'self'
op|','
name|'power_on'
...
newline|'\n'
nl|'\n'
DECL|member|destroy_rescued
dedent|''
name|'def'
name|'destroy_rescued'
op|'('
name|'self'
op|','
name|'fake_method'
...
op|')'
newline|'\n'
comment|'# Unrescue does not power on with destroy'
nl|'\n'
name|'self'
op|'.'
name|'assertFalse'
...
newline|'\n'
nl|'\n'
DECL|member|test_destroy_rescued
dedent|''
dedent|''
name|'def'
name|'test_destroy_rescued'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_destroy_rescued_with_exception
dedent|''
name|'def'
name|'test_destroy_rescued_with_exception'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_destroy_instance_without_vm_ref_with_resize
dedent|''
name|'def'
name|'test_destroy_instance_without_vm_ref_with_resize'
op|'('
name|'self'
op|')'
op|':'
...
op|':'
newline|'\n'
comment|'# NOTE(dims): driver unrescue ends up eventually in vmops.unrescue'
nl|'\n'
comment|'# with power_on=True, the test_destroy_rescued tests the'
nl|'\n'
comment|'# vmops.unrescue with power_on=False'
nl|'\n'
indent|'        '
name|'self'
op|'.'
...
newline|'\n'
nl|'\n'
DECL|function|fake_power_off_instance
name|'def'
name|'fake_power_off_instance'
op|'('
name|'session'
op|','
name|'instance'
...
op|':'
newline|'\n'
comment|'# This is called so that we actually poweroff the simulated vm.'
nl|'\n'
comment|'# The reason for this is that there is a validation in destroy'
nl|'\n'
comment|'# that the instance is not powered on.'
nl|'\n'
indent|'            '
name|'self'
op|'.'
...
op|')'
newline|'\n'
comment|'# Ensure ESX driver throws an error'
nl|'\n'
name|'self'
op|'.'
name|'assertRaises'
...
newline|'\n'
nl|'\n'
DECL|member|test_list_instances_from_nodes
dedent|''
name|'def'
name|'test_list_instances_from_nodes'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
comment|'# Create instance on node1'
nl|'\n'
indent|'        '
name|'self'
op|'.'
...
op|')'
newline|'\n'
comment|'# Create instances on the other node'
nl|'\n'
name|'self'
op|'.'
name|'_create_vm'
...
op|','
nl|'\n'
string|'"These should be different"'
op|')'
newline|'\n'
nl|'\n'
DECL|member|test_disassociate_vmref_from_instance
dedent|''
name|'def'
name|'test_disassociate_vmref_from_instance'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_clone_vmref_for_instance
dedent|''
name|'def'
name|'test_clone_vmref_for_instance'
op|'('
name|'self'
op|')'
op|':'
...
op|','
nl|'\n'
string|'"Reference for the cloned VM should be different"'
op|')'
newline|'\n'
name|'vm_obj'
op|'='
...
op|','
nl|'\n'
string|'"Original VM name should be with suffix -backup"'
op|')'
newline|'\n'
name|'self'
op|'.'
...
op|','
nl|'\n'
string|'"VM name does not match instance[\'uuid\']"'
op|')'
newline|'\n'
name|'self'
op|'.'
...
newline|'\n'
nl|'\n'
DECL|member|test_associate_vmref_for_instance
dedent|''
name|'def'
name|'test_associate_vmref_for_instance'
op|'('
name|'self'
op|')'
op|':'
...
op|')'
newline|'\n'
comment|'# First disassociate the VM from the instance so that we have a VM'
nl|'\n'
comment|'# to later associate using the associate_vmref_for_instance method'
nl|'\n'
name|'vm_util'
op|'.'
name|'disassociate_vmref_from_instance'
...
op|')'
newline|'\n'
comment|'# Ensure that the VM is indeed disassociated and that we cannot find'
nl|'\n'
comment|'# the VM using the get_vm_ref method'
nl|'\n'
name|'self'
op|'.'
name|'assertRaises'
...
op|')'
newline|'\n'
comment|'# Associate the VM back to the instance'
nl|'\n'
name|'vm_util'
op|'.'
...
op|')'
newline|'\n'
comment|'# Verify if we can get the VM reference'
nl|'\n'
name|'self'
op|'.'
name|'assertIsNotNone'
...
newline|'\n'
indent|'        '
string|'"""Tests the finish_migration method on VC Driver."""'
newline|'\n'
...
newline|'\n'
indent|'        '
string|'"""Tests the finish_revert_migration method on VC Driver."""'
newline|'\n'
nl|'\n'
comment|'# setup the test instance in the database'
nl|'\n'
