...
name|'stub_out'
op|'('
string|"'nova.tests.unit.virt.vmwareapi.fake.FakeVim._login'"
op|','
nl|'\n'
name|'_fake_login'
op|')'
...
name|'stub_out'
op|'('
string|"'nova.tests.unit.virt.vmwareapi.'"
nl|'\n'
string|"'fake.FakeVim._check_session'"
op|','
nl|'\n'
name|'_fake_check_session'
op|')'
...
name|'stub_out'
op|'('
string|"'nova.virt.vmwareapi.vmops._attach_cdrom_to_vm'"
op|','
nl|'\n'
name|'fake_attach_cdrom'
op|')'
...
op|')'
newline|'\n'
DECL|member|test_destroy_with_attached_volumes_with_disk_not_found
name|'def'
name|'test_destroy_with_attached_volumes_with_disk_not_found'
op|'('
nl|'\n'
name|'self'
op|','
...
name|'patch'
op|'('
string|"'nova.virt.vmwareapi.driver.VMwareVCDriver.detach_volume'"
op|')'
newline|'\n'
DECL|member|test_detach_instance_volumes
name|'def'
name|'test_detach_instance_volumes'
op|'('
nl|'\n'
name|'self'
op|','
...
name|'stub_out'
op|'('
string|"'nova.virt.vmwareapi.vmops._create_config_drive'"
op|','
nl|'\n'
name|'fake_create_config_drive'
op|')'
...
name|'stub_out'
op|'('
string|"'nova.virt.vmwareapi.volumeops.'"
nl|'\n'
string|"'VMwareVolumeOps.attach_disk_to_vm'"
op|','
nl|'\n'
name|'fake_attach_disk_to_vm'
op|')'
...
name|'stub_out'
op|'('
string|"'nova.virt.vmwareapi.imagecache.'"
nl|'\n'
string|"'ImageCacheManager._get_timestamp_filename'"
op|','
nl|'\n'
name|'_fake_get_timestamp_filename'
op|')'
...
op|','
string|"'fake_block_device_info'"
op|','
nl|'\n'
string|"'fake_network_info'"
op|','
string|"'fake_disk_info'"
op|')'
newline|'\n'
nl|'\n'
...
string|"'fake_dest'"
op|','
string|"'fake_post_method'"
op|','
nl|'\n'
string|"'fake_recover_method'"
op|')'
newline|'\n'
nl|'\n'
