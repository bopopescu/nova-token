...
newline|'\n'
nl|'\n'
DECL|member|test_use_vsphere_location
dedent|''
name|'def'
name|'test_use_vsphere_location'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_vsphere_location
dedent|''
name|'def'
name|'test_get_vsphere_location'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_no_vsphere_location
dedent|''
dedent|''
name|'def'
name|'test_get_no_vsphere_location'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_vsphere_location_no_image
dedent|''
dedent|''
name|'def'
name|'test_get_vsphere_location_no_image'
op|'('
name|'self'
op|')'
op|':'
