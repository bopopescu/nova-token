...
newline|'\n'
nl|'\n'
DECL|member|test_get_network_ref_bridge_from_opaque
dedent|''
name|'def'
name|'test_get_network_ref_bridge_from_opaque'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_network_ref_multiple_bridges_from_opaque
dedent|''
name|'def'
name|'test_get_network_ref_multiple_bridges_from_opaque'
op|'('
name|'self'
op|')'
op|':'
