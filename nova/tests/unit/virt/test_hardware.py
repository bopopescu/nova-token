...
op|'{'
nl|'\n'
comment|'# CPU thread pinning override set to default value'
nl|'\n'
string|'"flavor"'
op|':'
name|'objects'
...
op|'{'
nl|'\n'
comment|'# Invalid vCPUs mask with realtime'
nl|'\n'
string|'"flavor"'
op|':'
name|'objects'
...
newline|'\n'
nl|'\n'
DECL|member|_topo_usage_reserved_page_size
dedent|''
name|'def'
name|'_topo_usage_reserved_page_size'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_numa_get_reserved_huge_pages
dedent|''
name|'def'
name|'test_numa_get_reserved_huge_pages'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_reserved_hugepgaes_success
dedent|''
name|'def'
name|'test_reserved_hugepgaes_success'
op|'('
name|'self'
op|')'
op|':'
...
op|')'
newline|'\n'
comment|'# 128 already used + 128 used by instance + 128 reserved'
nl|'\n'
name|'self'
op|'.'
name|'assertEqual'
...
op|')'
newline|'\n'
comment|'# 2 already used + 1 used by instance + 1 reserved'
nl|'\n'
name|'self'
op|'.'
name|'assertEqual'
...
newline|'\n'
nl|'\n'
DECL|member|test_reserved_huge_pages_invalid_format
dedent|''
name|'def'
name|'test_reserved_huge_pages_invalid_format'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_reserved_huge_pages_invalid_value
dedent|''
name|'def'
name|'test_reserved_huge_pages_invalid_value'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_cell_accepts_request_remainder_memory
dedent|''
name|'def'
name|'test_cell_accepts_request_remainder_memory'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
comment|"# Test memory can't be divided with no rem by mempage's size_kb"
nl|'\n'
indent|'        '
name|'inst_cell'
op|'='
...
newline|'\n'
nl|'\n'
DECL|member|test_cell_accepts_request_host_mempages
dedent|''
name|'def'
name|'test_cell_accepts_request_host_mempages'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
comment|"# Test pagesize not in host's mempages"
nl|'\n'
indent|'        '
name|'inst_cell'
op|'='
...
op|','
nl|'\n'
string|'"Seems threads were not preferred by the pinning "'
nl|'\n'
string|'"logic."'
op|')'
newline|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_pinning_isolate_policy_too_few_fully_free_cores
dedent|''
name|'def'
name|'test_get_pinning_isolate_policy_too_few_fully_free_cores'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_pinning_isolate_policy_no_fully_free_cores
dedent|''
name|'def'
name|'test_get_pinning_isolate_policy_no_fully_free_cores'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_pinning_isolate_policy_fits
dedent|''
name|'def'
name|'test_get_pinning_isolate_policy_fits'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_pinning_isolate_policy_fits_ht_host
dedent|''
name|'def'
name|'test_get_pinning_isolate_policy_fits_ht_host'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_pinning_isolate_policy_fits_w_usage
dedent|''
name|'def'
name|'test_get_pinning_isolate_policy_fits_w_usage'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_host_usage_from_instances_isolate
dedent|''
name|'def'
name|'test_host_usage_from_instances_isolate'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_host_usage_from_instances_isolate_free
dedent|''
name|'def'
name|'test_host_usage_from_instances_isolate_free'
op|'('
name|'self'
op|')'
op|':'
