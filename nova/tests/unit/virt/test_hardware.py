...
newline|'\n'
nl|'\n'
DECL|member|test_topo_usage_reserved_page_size
dedent|''
name|'def'
name|'test_topo_usage_reserved_page_size'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
comment|'# reserved_page_size is using a global variable so we prefer'
nl|'\n'
comment|'# to create tests in a same context to avoid errors when'
nl|'\n'
comment|'# running unit tests in parallel'
nl|'\n'
nl|'\n'
DECL|function|test_success
name|'def'
name|'test_success'
op|'('
op|')'
...
op|')'
newline|'\n'
comment|'# 128 reserved + 128 used by instance'
nl|'\n'
name|'self'
op|'.'
name|'assertEqual'
...
op|')'
newline|'\n'
comment|'# 1 reserved + 1 used by instance + 2 already used:'
nl|'\n'
name|'self'
op|'.'
name|'assertEqual'
...
newline|'\n'
nl|'\n'
DECL|function|test_invalid_format
dedent|''
name|'def'
...
newline|'\n'
nl|'\n'
DECL|function|test_invalid_value
dedent|''
name|'def'
