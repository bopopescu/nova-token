...
newline|'\n'
nl|'\n'
comment|"# NOTE(thomasem): Not adding any commands in this case, because we're"
nl|'\n'
comment|'# not expecting an additional umount for LocalBlockImages. This is to'
nl|'\n'
comment|'# assert that no additional commands are run in this case.'
nl|'\n'
name|'disk_api'
op|'.'
name|'teardown_container'
op|'('
string|"'/dev/volume-group/uuid_disk'"
op|')'
newline|'\n'
nl|'\n'
name|'self'
