...
name|'patch'
op|'('
string|"'nova.filters.BaseFilter._filter_one'"
op|')'
newline|'\n'
...
name|'stub_out'
op|'('
string|"'nova.loadables.BaseLoader.__init__'"
op|','
nl|'\n'
name|'_fake_base_loader_init'
op|')'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_filtered_objects_compatible_with_filt_props_dicts
dedent|''
dedent|''
name|'def'
name|'test_get_filtered_objects_compatible_with_filt_props_dicts'
op|'('
name|'self'
op|')'
op|':'
