...
name|'patch'
op|'('
string|"'nova.virt.hardware.instance_topology_from_instance'"
op|')'
newline|'\n'
op|'@'
name|'mock'
...
name|'return_value'
op|'='
string|"'fake-consumed-once'"
newline|'\n'
name|'numa_fit_mock'
op|'.'
name|'return_value'
op|'='
string|"'fake-fitted-once'"
newline|'\n'
name|'instance_topo_mock'
op|'.'
name|'return_value'
...
name|'return_value'
op|'='
string|"'fake-consumed-twice'"
newline|'\n'
name|'numa_fit_mock'
op|'.'
name|'return_value'
op|'='
string|"'fake-fitted-twice'"
newline|'\n'
name|'host'
op|'.'
name|'consume_from_instance'
...
op|')'
newline|'\n'
comment|'# NOTE(sbauza): FilterSchedule._schedule() rehydrates pci_requests'
nl|'\n'
name|'req_spec'
op|'['
