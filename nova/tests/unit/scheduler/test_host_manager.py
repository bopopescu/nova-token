...
name|'warning'
op|'('
string|'"No service record found for host %(host)s "'
nl|'\n'
string|'"on %(topic)s topic"'
op|','
nl|'\n'
op|'{'
string|"'host'"
...
newline|'\n'
nl|'\n'
DECL|member|test_update_from_compute_node_resets_stashed_numa
dedent|''
name|'def'
name|'test_update_from_compute_node_resets_stashed_numa'
op|'('
name|'self'
op|')'
op|':'
