...
nl|'\n'
nl|'\n'
DECL|class|SchedulerManagerInitTestCase
name|'class'
name|'SchedulerManagerInitTestCase'
op|'('
name|'test'
op|'.'
name|'NoDBTestCase'
...
newline|'\n'
indent|'    '
string|'"""Test case for scheduler manager initiation."""'
newline|'\n'
...
op|')'
newline|'\n'
DECL|member|test_init_using_default_schedulerdriver
name|'def'
name|'test_init_using_default_schedulerdriver'
op|'('
name|'self'
op|','
nl|'\n'
...
op|')'
newline|'\n'
DECL|member|test_init_using_chance_schedulerdriver
name|'def'
name|'test_init_using_chance_schedulerdriver'
op|'('
name|'self'
op|','
nl|'\n'
...
op|')'
newline|'\n'
DECL|member|test_init_using_caching_schedulerdriver
name|'def'
name|'test_init_using_caching_schedulerdriver'
op|'('
name|'self'
op|','
nl|'\n'
...
op|')'
newline|'\n'
DECL|member|test_init_nonexist_schedulerdriver
name|'def'
name|'test_init_nonexist_schedulerdriver'
op|'('
name|'self'
op|','
nl|'\n'
...
newline|'\n'
nl|'\n'
comment|'# NOTE(Yingxin): Loading full class path is deprecated and should be'
nl|'\n'
comment|'# removed in the N release.'
nl|'\n'
dedent|''
op|'@'
name|'mock'
...
op|')'
newline|'\n'
DECL|member|test_init_using_classpath_to_schedulerdriver
name|'def'
name|'test_init_using_classpath_to_schedulerdriver'
op|'('
name|'self'
op|','
nl|'\n'
...
name|'FakeScheduler'
newline|'\n'
DECL|variable|driver_plugin_name
name|'driver_plugin_name'
op|'='
string|"'fake_scheduler'"
newline|'\n'
nl|'\n'
op|'@'
name|'mock'
...
nl|'\n'
nl|'\n'
DECL|class|SchedulerInitTestCase
dedent|''
dedent|''
dedent|''
name|'class'
name|'SchedulerInitTestCase'
op|'('
name|'test'
op|'.'
name|'NoDBTestCase'
...
newline|'\n'
indent|'    '
string|'"""Test case for base scheduler driver initiation."""'
newline|'\n'
nl|'\n'
DECL|variable|driver_cls
name|'driver_cls'
...
op|')'
newline|'\n'
DECL|member|test_init_using_default_hostmanager
name|'def'
name|'test_init_using_default_hostmanager'
op|'('
name|'self'
op|','
nl|'\n'
...
op|')'
newline|'\n'
DECL|member|test_init_using_ironic_hostmanager
name|'def'
name|'test_init_using_ironic_hostmanager'
op|'('
name|'self'
op|','
nl|'\n'
...
op|')'
newline|'\n'
DECL|member|test_init_nonexist_hostmanager
name|'def'
name|'test_init_nonexist_hostmanager'
op|'('
name|'self'
op|','
nl|'\n'
...
op|')'
newline|'\n'
DECL|member|test_init_using_classpath_to_hostmanager
name|'def'
name|'test_init_using_classpath_to_hostmanager'
op|'('
name|'self'
op|','
nl|'\n'
...
op|'='
nl|'\n'
string|"'nova.scheduler.ironic_host_manager.IronicHostManager'"
op|')'
newline|'\n'
name|'manager'
op|'='
...
name|'patch'
op|'('
string|"'nova.objects.ServiceList.get_by_topic'"
op|')'
newline|'\n'
op|'@'
name|'mock'
...
name|'self'
op|','
name|'mock_service_is_up'
op|','
name|'mock_get_by_topic'
op|')'
op|':'
newline|'\n'
indent|'        '
