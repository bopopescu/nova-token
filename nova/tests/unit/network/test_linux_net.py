...
name|'compile'
op|'('
string|'"OVS configuration failed with: .*specific_error.*"'
op|','
nl|'\n'
name|'re'
op|'.'
...
newline|'\n'
nl|'\n'
DECL|member|test_ovs_vif_port_cmd
dedent|''
dedent|''
name|'def'
name|'test_ovs_vif_port_cmd'
op|'('
name|'self'
op|')'
op|':'
...
op|')'
newline|'\n'
DECL|member|test_ovs_vif_port_with_type_vhostuser
name|'def'
name|'test_ovs_vif_port_with_type_vhostuser'
op|'('
name|'self'
op|','
