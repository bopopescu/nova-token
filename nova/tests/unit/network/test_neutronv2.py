...
string|"'id'"
op|':'
string|"'test_secgroup_id1'"
op|','
nl|'\n'
string|"'name'"
op|':'
string|"'test_secgroup_name'"
op|'}'
op|']'
newline|'\n'
name|'self'
...
newline|'\n'
nl|'\n'
DECL|member|test_allocate_for_instance_with_sec_groups
dedent|''
name|'def'
name|'test_allocate_for_instance_with_sec_groups'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
comment|'# Test that allocate_for_instance handles security groups if provided'
nl|'\n'
indent|'        '
name|'self'
op|'.'
...
newline|'\n'
nl|'\n'
DECL|member|test_allocate_for_instance_with_sec_groups_and_port_id
dedent|''
name|'def'
name|'test_allocate_for_instance_with_sec_groups_and_port_id'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
comment|'# Test that allocate_for_instance raises if security groups are'
nl|'\n'
comment|'# provided together with port_id'
nl|'\n'
indent|'        '
name|'requested_networks'
op|'='
