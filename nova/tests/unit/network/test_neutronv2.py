...
name|'ks_loading'
op|','
string|"'load_auth_from_conf_options'"
op|')'
newline|'\n'
DECL|member|test_load_auth_plugin_failed
name|'def'
name|'test_load_auth_plugin_failed'
op|'('
name|'self'
op|','
name|'mock_load_from_conf'
op|')'
op|':'
newline|'\n'
indent|'        '
...
op|']'
newline|'\n'
comment|'# A network with non-blank dns_domain to test _update_port_dns_name'
nl|'\n'
name|'self'
op|'.'
name|'nets11'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_instance_nw_info_ignores_neutron_ports_empty_cache
dedent|''
name|'def'
name|'test_get_instance_nw_info_ignores_neutron_ports_empty_cache'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
comment|'# Tests that ports returned from neutron that match the same'
nl|'\n'
comment|'# instance_id/device_id are ignored when the instance info cache is'
nl|'\n'
comment|'# empty.'
nl|'\n'
indent|'        '
...
newline|'\n'
nl|'\n'
DECL|member|test_allocate_for_instance_with_no_subnet_defined
dedent|''
name|'def'
name|'test_allocate_for_instance_with_no_subnet_defined'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
comment|'# net_id=4 does not specify subnet and does not set the option'
nl|'\n'
comment|'# port_security_disabled to True, so Neutron will not been'
nl|'\n'
comment|'# able to associate the default security group to the port'
nl|'\n'
comment|'# requested to be created. We expect an exception to be'
nl|'\n'
comment|'# raised.'
nl|'\n'
indent|'        '
...
newline|'\n'
nl|'\n'
DECL|member|_test_nw_info_build_custom_bridge
dedent|''
name|'def'
name|'_test_nw_info_build_custom_bridge'
op|'('
name|'self'
op|','
name|'vif_type'
...
newline|'\n'
nl|'\n'
DECL|member|test_nw_info_build_custom_ovs_bridge
dedent|''
name|'def'
name|'test_nw_info_build_custom_ovs_bridge'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_nw_info_build_custom_ovs_bridge_vhostuser
dedent|''
name|'def'
name|'test_nw_info_build_custom_ovs_bridge_vhostuser'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_nw_info_build_custom_lb_bridge
dedent|''
name|'def'
name|'test_nw_info_build_custom_lb_bridge'
op|'('
name|'self'
op|')'
op|':'
...
op|':'
newline|'\n'
comment|'# An empty instance info network cache should not be populated from'
nl|'\n'
comment|'# ports found in Neutron.'
nl|'\n'
indent|'        '
name|'api'
op|'='
...
op|')'
newline|'\n'
DECL|member|test_get_instance_nw_info_verify_duplicates_ignored
name|'def'
name|'test_get_instance_nw_info_verify_duplicates_ignored'
op|'('
name|'self'
op|','
name|'mock_log'
...
newline|'\n'
nl|'\n'
name|'instance_networks'
op|'='
op|'['
op|'{'
string|'"id"'
op|':'
string|'"instance_network_1"'
op|','
nl|'\n'
string|'"name"'
op|':'
...
op|']'
newline|'\n'
name|'instance_port_ids'
op|'='
op|'['
string|'"instance_port_1"'
op|']'
newline|'\n'
nl|'\n'
name|'network_info'
...
newline|'\n'
nl|'\n'
DECL|member|test_allocate_floating_ip_no_ipv4_subnet
dedent|''
dedent|''
name|'def'
name|'test_allocate_floating_ip_no_ipv4_subnet'
op|'('
name|'self'
op|')'
op|':'
...
op|'='
op|'('
string|"'Bad floatingip request: Network %s does not contain '"
nl|'\n'
string|"'any IPv4 subnet'"
op|'%'
name|'net_id'
op|')'
newline|'\n'
...
op|')'
newline|'\n'
DECL|member|test_unbind_ports_no_port_ids
name|'def'
name|'test_unbind_ports_no_port_ids'
op|'('
name|'self'
op|','
name|'mock_has_ext'
...
op|':'
newline|'\n'
comment|'# Tests that None entries in the ports list are filtered out.'
nl|'\n'
indent|'        '
name|'mock_client'
op|'='
...
name|'patch'
op|'('
string|"'nova.network.neutronv2.api.API._process_requested_networks'"
op|')'
newline|'\n'
op|'@'
name|'mock'
...
op|')'
newline|'\n'
DECL|member|test_allocate_port_for_instance_no_networks
name|'def'
name|'test_allocate_port_for_instance_no_networks'
op|'('
name|'self'
op|','
nl|'\n'
...
op|','
nl|'\n'
name|'mock_process_request_net'
op|')'
op|':'
newline|'\n'
indent|'        '
string|'"""Tests that if no networks are requested and no networks are\n        available, we fail with InterfaceAttachFailedNoNetwork.\n        """'
newline|'\n'
name|'instance'
op|'='
name|'fake_instance'
...
op|'('
nl|'\n'
string|'"No specific network was requested and none are available for "'
nl|'\n'
...
op|')'
newline|'\n'
DECL|member|test_port_binding_failed_created_port
name|'def'
name|'test_port_binding_failed_created_port'
op|'('
name|'self'
op|','
name|'mock_ntrn'
...
name|'patch'
op|'('
string|"'nova.network.neutronv2.api.API._show_port'"
op|')'
newline|'\n'
op|'@'
name|'mock'
...
op|')'
newline|'\n'
DECL|member|test_port_binding_failed_with_request
name|'def'
name|'test_port_binding_failed_with_request'
op|'('
name|'self'
op|','
name|'mock_ntrn'
...
op|')'
newline|'\n'
DECL|member|test_get_floating_ip_by_address_not_found_neutron_not_found
name|'def'
name|'test_get_floating_ip_by_address_not_found_neutron_not_found'
op|'('
name|'self'
op|','
nl|'\n'
...
op|')'
newline|'\n'
DECL|member|test_get_floating_ip_by_address_not_found_neutron_raises_non404
name|'def'
name|'test_get_floating_ip_by_address_not_found_neutron_raises_non404'
op|'('
name|'self'
op|','
nl|'\n'
...
op|')'
newline|'\n'
DECL|member|test_get_floating_ips_by_project_not_found
name|'def'
name|'test_get_floating_ips_by_project_not_found'
op|'('
name|'self'
op|','
name|'mock_ntrn'
...
op|')'
newline|'\n'
DECL|member|test_get_floating_ips_by_project_not_found_legacy
name|'def'
name|'test_get_floating_ips_by_project_not_found_legacy'
op|'('
name|'self'
op|','
name|'mock_ntrn'
...
op|':'
newline|'\n'
comment|'# FIXME(danms): Remove this test along with the code path it tests'
nl|'\n'
comment|'# when bug 1513879 is fixed.'
nl|'\n'
indent|'        '
name|'mock_nc'
op|'='
...
name|'mock_nc'
newline|'\n'
comment|"# neutronclient doesn't raise NotFound in this scenario, it raises a"
nl|'\n'
comment|'# NeutronClientException with status_code=404'
nl|'\n'
name|'notfound'
op|'='
name|'exceptions'
...
op|')'
newline|'\n'
DECL|member|test_get_floating_ips_by_project_raises_non404
name|'def'
name|'test_get_floating_ips_by_project_raises_non404'
op|'('
name|'self'
op|','
name|'mock_ntrn'
...
newline|'\n'
nl|'\n'
DECL|member|test_unbind_ports_reset_dns_name
dedent|''
name|'def'
name|'test_unbind_ports_reset_dns_name'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|_populate_mac_address_fakes
dedent|''
name|'def'
name|'_populate_mac_address_fakes'
op|'('
name|'self'
op|')'
op|':'
...
name|'pci_utils'
op|','
string|"'get_mac_by_pci_address'"
op|')'
newline|'\n'
DECL|member|test_populate_mac_address_pf
name|'def'
name|'test_populate_mac_address_pf'
op|'('
name|'self'
op|','
name|'mock_get_mac_by_pci_address'
op|','
nl|'\n'
name|'mock_get_instance_pci_devs'
op|')'
...
name|'return_value'
op|'='
string|"'fake-mac-address'"
newline|'\n'
name|'expected_port_req_body'
op|'='
op|'{'
string|"'port'"
op|':'
...
op|')'
newline|'\n'
DECL|member|test_populate_mac_address_vf
name|'def'
name|'test_populate_mac_address_vf'
op|'('
name|'self'
op|','
name|'mock_get_mac_by_pci_address'
...
op|')'
newline|'\n'
DECL|member|test_populate_mac_address_vf_fail
name|'def'
name|'test_populate_mac_address_vf_fail'
op|'('
name|'self'
op|','
name|'mock_get_mac_by_pci_address'
...
op|')'
newline|'\n'
DECL|member|test_populate_mac_address_no_device
name|'def'
name|'test_populate_mac_address_no_device'
op|'('
name|'self'
op|','
name|'mock_get_instance_pci_devs'
...
nl|'\n'
nl|'\n'
DECL|class|TestNeutronv2NeutronHostnameDNS
dedent|''
dedent|''
name|'class'
name|'TestNeutronv2NeutronHostnameDNS'
op|'('
name|'TestNeutronv2Base'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_allocate_for_instance_create_port
dedent|''
name|'def'
name|'test_allocate_for_instance_create_port'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
comment|"# The port's dns_name attribute should be set by the port create"
nl|'\n'
comment|'# request in allocate_for_instance'
nl|'\n'
indent|'        '
name|'self'
op|'.'
...
newline|'\n'
nl|'\n'
DECL|member|test_allocate_for_instance_with_requested_port
dedent|''
name|'def'
name|'test_allocate_for_instance_with_requested_port'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
comment|"# The port's dns_name attribute should be set by the port update"
nl|'\n'
comment|'# request in allocate_for_instance'
nl|'\n'
indent|'        '
...
newline|'\n'
nl|'\n'
DECL|member|test_allocate_for_instance_port_dns_name_preset_equal_hostname
dedent|''
name|'def'
name|'test_allocate_for_instance_port_dns_name_preset_equal_hostname'
op|'('
name|'self'
op|')'
op|':'
...
comment|"# The port's dns_name attribute should be set by the port update"
nl|'\n'
comment|"# request in allocate_for_instance. The port's dns_name was preset by"
nl|'\n'
comment|"# the user with a value equal to the instance's hostname"
nl|'\n'
indent|'        '
name|'requested_networks'
op|'='
...
newline|'\n'
nl|'\n'
DECL|member|test_allocate_for_instance_port_dns_name_preset_noteq_hostname
dedent|''
name|'def'
name|'test_allocate_for_instance_port_dns_name_preset_noteq_hostname'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
comment|'# If a pre-existing port has dns_name set, an exception should be'
nl|'\n'
comment|"# raised if dns_name is not equal to the instance's hostname"
nl|'\n'
indent|'        '
name|'requested_networks'
op|'='
...
nl|'\n'
nl|'\n'
DECL|class|TestNeutronv2NeutronHostnameDNSPortbinding
dedent|''
dedent|''
name|'class'
name|'TestNeutronv2NeutronHostnameDNSPortbinding'
op|'('
name|'TestNeutronv2Base'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_allocate_for_instance_create_port_with_dns_domain
dedent|''
name|'def'
name|'test_allocate_for_instance_create_port_with_dns_domain'
op|'('
name|'self'
op|')'
op|':'
...
comment|"# The port's dns_name attribute should be set by the port update"
nl|'\n'
comment|'# request in _update_port_dns_name. This should happen only when the'
nl|'\n'
comment|"# port binding extension is enabled and the port's network has a"
nl|'\n'
comment|'# non-blank dns_domain attribute'
nl|'\n'
indent|'        '
name|'self'
op|'.'
...
newline|'\n'
nl|'\n'
DECL|member|test_allocate_for_instance_with_requested_port_with_dns_domain
dedent|''
name|'def'
name|'test_allocate_for_instance_with_requested_port_with_dns_domain'
op|'('
name|'self'
op|')'
op|':'
...
op|')'
newline|'\n'
comment|'# NOTE(morganfainberg): The real configuration fixture here is used'
nl|'\n'
comment|'# instead o the already existing fixtures to ensure that the new'
nl|'\n'
comment|'# config options are automatically deregistered at the end of the'
nl|'\n'
comment|'# test run. Without the use of this fixture, the config options'
nl|'\n'
comment|'# from the plugin(s) would persist for all subsequent tests from when'
nl|'\n'
comment|'# these are run (due to glonal conf object) and not be fully'
nl|'\n'
comment|'# representative of a "clean" slate at the start of a test.'
nl|'\n'
name|'self'
op|'.'
name|'config_fixture'
...
nl|'\n'
nl|'\n'
DECL|class|TestNeutronPortSecurity
dedent|''
dedent|''
name|'class'
name|'TestNeutronPortSecurity'
op|'('
name|'test'
op|'.'
name|'NoDBTestCase'
...
name|'API'
op|','
string|"'_process_security_groups'"
op|')'
newline|'\n'
op|'@'
name|'mock'
...
name|'API'
op|','
string|"'_process_requested_networks'"
op|')'
newline|'\n'
op|'@'
name|'mock'
...
op|')'
newline|'\n'
DECL|member|test_no_security_groups_requested
name|'def'
name|'test_no_security_groups_requested'
op|'('
nl|'\n'
name|'self'
op|','
name|'mock_get_client'
op|','
name|'mock_has_port_binding_extension'
op|','
nl|'\n'
name|'mock_process_requested_networks'
op|','
name|'mock_get_available_networks'
op|','
nl|'\n'
name|'mock_process_security_groups'
op|','
name|'mock_check_external_network_attach'
op|','
nl|'\n'
name|'mock_populate_neutron_extension_values'
op|','
name|'mock_create_port'
op|','
nl|'\n'
name|'mock_update_port_dns_name'
op|','
name|'mock_get_instance_nw_info'
op|')'
op|':'
newline|'\n'
indent|'        '
...
string|"'default'"
op|']'
comment|"# Nova API provides the 'default'"
newline|'\n'
nl|'\n'
name|'mock_process_requested_networks'
op|'.'
...
op|')'
newline|'\n'
DECL|member|test_security_groups_requested
name|'def'
name|'test_security_groups_requested'
op|'('
nl|'\n'
name|'self'
op|','
...
op|')'
newline|'\n'
DECL|member|test_port_security_disabled_no_security_groups_requested
name|'def'
name|'test_port_security_disabled_no_security_groups_requested'
op|'('
nl|'\n'
name|'self'
op|','
...
op|')'
newline|'\n'
DECL|member|test_port_security_disabled_and_security_groups_requested
name|'def'
name|'test_port_security_disabled_and_security_groups_requested'
op|'('
nl|'\n'
name|'self'
op|','
