...
newline|'\n'
nl|'\n'
DECL|member|test_oslo_namespace_imports_check_2
dedent|''
name|'def'
name|'test_oslo_namespace_imports_check_2'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_oslo_namespace_imports_check_3
dedent|''
name|'def'
name|'test_oslo_namespace_imports_check_3'
op|'('
name|'self'
op|')'
op|':'
...
name|'filename'
op|'='
string|'"nova/api/openstack/compute/plugins/v3/test.py"'
newline|'\n'
name|'self'
op|'.'
name|'_assert_has_no_errors'
...
name|'filename'
op|'='
string|'"nova/api/openstack/compute/contrib/test.py"'
newline|'\n'
name|'self'
op|'.'
name|'_assert_has_no_errors'
