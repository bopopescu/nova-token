...
op|')'
newline|'\n'
DECL|member|test_update_pci_for_instance_with_numa
name|'def'
name|'test_update_pci_for_instance_with_numa'
op|'('
name|'self'
op|','
name|'mock_get'
...
op|')'
newline|'\n'
DECL|member|test_update_pci_for_instance_with_numa_fail
name|'def'
name|'test_update_pci_for_instance_with_numa_fail'
op|'('
name|'self'
op|','
name|'mock_get'
