...
name|'enginefacade'
op|'.'
name|'_TransactionContextManager'
op|','
string|"'using'"
op|')'
newline|'\n'
...
op|')'
newline|'\n'
DECL|member|test_select_db_reader_mode_select_sync
name|'def'
name|'test_select_db_reader_mode_select_sync'
op|'('
name|'self'
op|','
name|'mock_clone'
...
op|')'
newline|'\n'
DECL|member|test_select_db_reader_mode_select_async
name|'def'
name|'test_select_db_reader_mode_select_async'
op|'('
name|'self'
op|','
name|'mock_clone'
...
op|')'
newline|'\n'
DECL|member|test_select_db_reader_mode_no_use_slave_select_sync
name|'def'
name|'test_select_db_reader_mode_no_use_slave_select_sync'
op|'('
name|'self'
op|','
name|'mock_clone'
...
name|'sqlalchemy_api'
op|','
string|"'_get_regexp_op_for_connection'"
op|','
nl|'\n'
...
op|')'
newline|'\n'
DECL|class|UnsupportedDbRegexpTestCase
name|'class'
name|'UnsupportedDbRegexpTestCase'
op|'('
name|'DbTestCase'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_instance_get_deleted_by_filters_sort_keys_paginate
dedent|''
dedent|''
dedent|''
dedent|''
name|'def'
name|'test_instance_get_deleted_by_filters_sort_keys_paginate'
op|'('
name|'self'
op|','
nl|'\n'
...
newline|'\n'
indent|'        '
string|"'''Verifies sort order with pagination for deleted instances.'''"
newline|'\n'
name|'ctxt'
op|'='
name|'context'
...
op|')'
newline|'\n'
DECL|member|test_model_query_use_context_session
name|'def'
name|'test_model_query_use_context_session'
op|'('
name|'self'
op|','
name|'mock_model_query'
op|')'
op|':'
newline|'\n'
indent|'        '
...
nl|'\n'
nl|'\n'
DECL|class|EngineFacadeTestCase
dedent|''
dedent|''
name|'class'
name|'EngineFacadeTestCase'
op|'('
name|'DbTestCase'
op|')'
op|':'
newline|'\n'
DECL|member|test_use_single_context_session_writer
indent|'    '
name|'def'
name|'test_use_single_context_session_writer'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
comment|'# Checks that session in context would not be overwritten by'
nl|'\n'
comment|'# annotation @sqlalchemy_api.main_context_manager.writer if annotation'
nl|'\n'
comment|'# is used twice.'
nl|'\n'
nl|'\n'
indent|'        '
op|'@'
...
name|'writer'
newline|'\n'
DECL|function|fake_parent_method
name|'def'
name|'fake_parent_method'
op|'('
name|'context'
op|')'
op|':'
...
name|'writer'
newline|'\n'
DECL|function|fake_child_method
name|'def'
name|'fake_child_method'
op|'('
name|'context'
...
newline|'\n'
nl|'\n'
DECL|member|test_use_single_context_session_reader
dedent|''
name|'def'
name|'test_use_single_context_session_reader'
op|'('
name|'self'
op|')'
op|':'
...
comment|'# Checks that session in context would not be overwritten by'
nl|'\n'
comment|'# annotation @sqlalchemy_api.main_context_manager.reader if annotation'
nl|'\n'
comment|'# is used twice.'
nl|'\n'
nl|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|test_aggregate_metadata_add_empty_metadata
dedent|''
name|'def'
name|'test_aggregate_metadata_add_empty_metadata'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_convert_objects_related_datetimes_with_strings
dedent|''
name|'def'
name|'test_convert_objects_related_datetimes_with_strings'
op|'('
name|'self'
op|')'
op|':'
...
name|'t1'
op|'='
string|"'2015-05-28T17:15:53.000000'"
newline|'\n'
name|'t2'
op|'='
string|"'2012-04-21T18:25:43-05:00'"
newline|'\n'
name|'t3'
op|'='
string|"'2012-04-23T18:25:43.511Z'"
newline|'\n'
nl|'\n'
name|'datetime_keys'
op|'='
...
newline|'\n'
nl|'\n'
DECL|member|test_get_regexp_op_for_database_sqlite
dedent|''
name|'def'
name|'test_get_regexp_op_for_database_sqlite'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_regexp_op_for_database_mysql
dedent|''
name|'def'
name|'test_get_regexp_op_for_database_mysql'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_regexp_op_for_database_postgresql
dedent|''
name|'def'
name|'test_get_regexp_op_for_database_postgresql'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_regexp_op_for_database_unknown
dedent|''
name|'def'
name|'test_get_regexp_op_for_database_unknown'
op|'('
name|'self'
op|')'
op|':'
...
op|','
nl|'\n'
string|"'get_legacy_facade'"
op|')'
newline|'\n'
DECL|member|test_get_engine
name|'def'
name|'test_get_engine'
op|'('
name|'self'
op|','
name|'mock_create_facade'
op|')'
op|':'
newline|'\n'
indent|'        '
...
newline|'\n'
nl|'\n'
DECL|member|test_get_db_conf_with_connection
dedent|''
name|'def'
name|'test_get_db_conf_with_connection'
op|'('
name|'self'
op|')'
op|':'
...
name|'sqlalchemy_api'
op|','
string|"'_instances_fill_metadata'"
op|')'
newline|'\n'
op|'@'
name|'mock'
...
name|'patch'
op|'('
string|"'oslo_db.sqlalchemy.utils.paginate_query'"
op|')'
newline|'\n'
DECL|member|test_instance_get_all_by_filters_paginated_allows_deleted_marker
name|'def'
name|'test_instance_get_all_by_filters_paginated_allows_deleted_marker'
op|'('
nl|'\n'
name|'self'
op|','
...
newline|'\n'
nl|'\n'
DECL|member|test_get_migrations_by_filters_with_multiple_statuses
dedent|''
dedent|''
name|'def'
name|'test_get_migrations_by_filters_with_multiple_statuses'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_migrations_by_filters_with_type
dedent|''
dedent|''
name|'def'
name|'test_get_migrations_by_filters_with_type'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_migrations_by_filters_source_compute
dedent|''
name|'def'
name|'test_get_migrations_by_filters_source_compute'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_migration_get_in_progress_by_instance
dedent|''
name|'def'
name|'test_migration_get_in_progress_by_instance'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_migration_get_in_progress_by_instance_not_in_progress
dedent|''
name|'def'
name|'test_migration_get_in_progress_by_instance_not_in_progress'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_migration_get_in_progress_by_instance_not_live_migration
dedent|''
name|'def'
name|'test_migration_get_in_progress_by_instance_not_live_migration'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_migration_for_instance
dedent|''
name|'def'
name|'test_get_migration_for_instance'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_migration_for_instance_not_found
dedent|''
name|'def'
name|'test_get_migration_for_instance_not_found'
op|'('
name|'self'
op|')'
op|':'
...
nl|'\n'
nl|'\n'
DECL|class|RefreshUsageTestCase
dedent|''
dedent|''
name|'class'
name|'RefreshUsageTestCase'
op|'('
name|'test'
op|'.'
name|'TestCase'
...
newline|'\n'
indent|'    '
string|'"""Tests for the db.api.quota_usage_refresh method. """'
newline|'\n'
nl|'\n'
DECL|member|setUp
name|'def'
...
newline|'\n'
indent|'        '
string|'"""Refresh the in_use count on the QuotaUsage objects.\n           The QuotaUsage objects are created if they don\'t exist.\n        """'
newline|'\n'
DECL|function|get_sync
name|'def'
name|'get_sync'
...
newline|'\n'
nl|'\n'
DECL|member|_compare_resource_usages
dedent|''
name|'def'
name|'_compare_resource_usages'
op|'('
name|'self'
op|','
name|'keys'
...
newline|'\n'
nl|'\n'
DECL|member|test_refresh_created_project_usages
dedent|''
dedent|''
name|'def'
name|'test_refresh_created_project_usages'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
comment|'# The refresh will create the usages and then sync'
nl|'\n'
comment|'# in_use from 0 to 3 for fixed_ips and 0 to 4 for floating_ips.'
nl|'\n'
indent|'        '
name|'keys'
op|'='
...
op|','
nl|'\n'
comment|'# User ID will be none for per-project resources'
nl|'\n'
string|"'user_id'"
op|':'
name|'None'
...
newline|'\n'
nl|'\n'
DECL|member|test_refresh_created_user_usages
dedent|''
name|'def'
name|'test_refresh_created_user_usages'
op|'('
name|'self'
op|')'
op|':'
...
comment|'# The refresh will create the usages and then sync'
nl|'\n'
comment|'# in_use from 0 to 1 for resource0 and 0 to 2 for resource1.'
nl|'\n'
indent|'        '
name|'keys'
op|'='
...
newline|'\n'
nl|'\n'
DECL|member|test_security_group_rule_get_by_instance
dedent|''
name|'def'
name|'test_security_group_rule_get_by_instance'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_security_group_ensure_default_until_refresh
dedent|''
name|'def'
name|'test_security_group_ensure_default_until_refresh'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_instance_get_all_by_filters_empty_list_filter
dedent|''
name|'def'
name|'test_instance_get_all_by_filters_empty_list_filter'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_instance_get_all_by_grantee_security_groups
dedent|''
name|'def'
name|'test_instance_get_all_by_grantee_security_groups'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_instance_get_all_by_grantee_security_groups_empty_group_ids
dedent|''
name|'def'
name|'test_instance_get_all_by_grantee_security_groups_empty_group_ids'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_delete_block_device_mapping_on_instance_destroy
dedent|''
name|'def'
name|'test_delete_block_device_mapping_on_instance_destroy'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
comment|'# Makes sure that the block device mapping is deleted when the'
nl|'\n'
comment|'# related instance is deleted.'
nl|'\n'
indent|'        '
name|'ctxt'
op|'='
...
op|')'
newline|'\n'
comment|'# make sure the bdm is deleted as well'
nl|'\n'
name|'bdms'
op|'='
name|'db'
...
newline|'\n'
nl|'\n'
DECL|member|test_delete_instance_group_member_on_instance_destroy
dedent|''
name|'def'
name|'test_delete_instance_group_member_on_instance_destroy'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_instance_update_and_get_original
dedent|''
name|'def'
name|'test_instance_update_and_get_original'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_instance_update_and_get_original_conflict_race
dedent|''
dedent|''
name|'def'
name|'test_instance_update_and_get_original_conflict_race'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
comment|'# Ensure that we retry if update_on_match fails for no discernable'
nl|'\n'
comment|'# reason'
nl|'\n'
indent|'        '
...
newline|'\n'
nl|'\n'
comment|'# Reproduce the conditions of a race between fetching and updating the'
nl|'\n'
comment|'# instance by making update_on_match fail for no discernable reason the'
nl|'\n'
comment|'# first time it is called, but work normally the second time.'
nl|'\n'
name|'with'
name|'mock'
op|'.'
...
newline|'\n'
nl|'\n'
DECL|member|test_instance_update_and_get_original_conflict_race_fallthrough
dedent|''
dedent|''
name|'def'
name|'test_instance_update_and_get_original_conflict_race_fallthrough'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
comment|'# Ensure that is update_match continuously fails for no discernable'
nl|'\n'
comment|'# reason, we evantually raise UnknownInstanceUpdateConflict'
nl|'\n'
indent|'        '
name|'instance'
op|'='
...
comment|'# Reproduce the conditions of a race between fetching and updating the'
nl|'\n'
comment|'# instance by making update_on_match fail for no discernable reason.'
nl|'\n'
name|'with'
name|'mock'
op|'.'
...
newline|'\n'
nl|'\n'
DECL|member|test_instance_update_and_get_original_expected_host
dedent|''
dedent|''
name|'def'
name|'test_instance_update_and_get_original_expected_host'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
comment|'# Ensure that we allow update when expecting a host field'
nl|'\n'
indent|'        '
name|'instance'
op|'='
...
newline|'\n'
nl|'\n'
DECL|member|test_instance_update_and_get_original_expected_host_fail
dedent|''
name|'def'
name|'test_instance_update_and_get_original_expected_host_fail'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
comment|'# Ensure that we detect a changed expected host and raise'
nl|'\n'
comment|'# InstanceUpdateConflict'
nl|'\n'
indent|'        '
name|'instance'
op|'='
...
name|'fail'
op|'('
string|"'InstanceUpdateConflict was not raised'"
op|')'
newline|'\n'
nl|'\n'
DECL|member|test_instance_update_and_get_original_expected_host_none
dedent|''
dedent|''
name|'def'
name|'test_instance_update_and_get_original_expected_host_none'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
comment|'# Ensure that we allow update when expecting a host field of None'
nl|'\n'
indent|'        '
name|'instance'
op|'='
...
newline|'\n'
nl|'\n'
DECL|member|test_instance_update_and_get_original_expected_host_none_fail
dedent|''
name|'def'
name|'test_instance_update_and_get_original_expected_host_none_fail'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
comment|'# Ensure that we detect a changed expected host of None and raise'
nl|'\n'
comment|'# InstanceUpdateConflict'
nl|'\n'
indent|'        '
...
newline|'\n'
nl|'\n'
DECL|member|test_instance_update_and_get_original_expected_task_state_single_fail
dedent|''
dedent|''
name|'def'
name|'test_instance_update_and_get_original_expected_task_state_single_fail'
op|'('
name|'self'
op|')'
op|':'
comment|'# noqa'
newline|'\n'
comment|'# Ensure that we detect a changed expected task and raise'
nl|'\n'
comment|'# UnexpectedTaskStateError'
nl|'\n'
indent|'        '
name|'instance'
op|'='
...
name|'fail'
op|'('
string|"'UnexpectedTaskStateError was not raised'"
op|')'
newline|'\n'
nl|'\n'
DECL|member|test_instance_update_and_get_original_expected_task_state_single_pass
dedent|''
dedent|''
name|'def'
name|'test_instance_update_and_get_original_expected_task_state_single_pass'
op|'('
name|'self'
op|')'
op|':'
comment|'# noqa'
newline|'\n'
comment|'# Ensure that we allow an update when expected task is correct'
nl|'\n'
indent|'        '
name|'instance'
op|'='
...
newline|'\n'
nl|'\n'
DECL|member|test_instance_update_and_get_original_expected_task_state_multi_fail
dedent|''
name|'def'
name|'test_instance_update_and_get_original_expected_task_state_multi_fail'
op|'('
name|'self'
op|')'
op|':'
...
comment|'# Ensure that we detect a changed expected task and raise'
nl|'\n'
comment|'# UnexpectedTaskStateError when there are multiple potential expected'
nl|'\n'
comment|'# tasks'
nl|'\n'
indent|'        '
...
newline|'\n'
nl|'\n'
DECL|member|test_instance_update_and_get_original_expected_task_state_multi_pass
dedent|''
dedent|''
name|'def'
name|'test_instance_update_and_get_original_expected_task_state_multi_pass'
op|'('
name|'self'
op|')'
op|':'
comment|'# noqa'
newline|'\n'
comment|'# Ensure that we allow an update when expected task is in a list of'
nl|'\n'
comment|'# expected tasks'
nl|'\n'
indent|'        '
name|'instance'
op|'='
...
newline|'\n'
nl|'\n'
DECL|member|test_instance_update_and_get_original_expected_task_state_deleting
dedent|''
name|'def'
name|'test_instance_update_and_get_original_expected_task_state_deleting'
op|'('
name|'self'
op|')'
op|':'
comment|'# noqa'
newline|'\n'
comment|'# Ensure that we raise UnepectedDeletingTaskStateError when task state'
nl|'\n'
comment|'# is not as expected, and it is DELETING'
nl|'\n'
indent|'        '
name|'instance'
op|'='
...
name|'fail'
op|'('
string|"'UnexpectedDeletingTaskStateError was not raised'"
op|')'
newline|'\n'
nl|'\n'
...
name|'patch'
op|'('
string|"'nova.db.sqlalchemy.api._check_instance_exists_in_project'"
op|','
nl|'\n'
name|'return_value'
op|'='
...
newline|'\n'
nl|'\n'
DECL|member|test_check_instance_exists
dedent|''
name|'def'
name|'test_check_instance_exists'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_check_instance_exists_non_existing_instance
dedent|''
dedent|''
name|'def'
name|'test_check_instance_exists_non_existing_instance'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_check_instance_exists_from_different_tenant
dedent|''
dedent|''
name|'def'
name|'test_check_instance_exists_from_different_tenant'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_check_instance_exists_admin_context
dedent|''
dedent|''
name|'def'
name|'test_check_instance_exists_admin_context'
op|'('
name|'self'
op|')'
op|':'
...
op|':'
newline|'\n'
comment|'# Check that method works correctly with admin context'
nl|'\n'
indent|'            '
name|'self'
op|'.'
...
newline|'\n'
nl|'\n'
DECL|member|test_instance_extra_update_by_uuid_and_create
dedent|''
name|'def'
name|'test_instance_extra_update_by_uuid_and_create'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_service_create_disabled
dedent|''
dedent|''
name|'def'
name|'test_service_create_disabled'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_service_update_with_set_forced_down
dedent|''
name|'def'
name|'test_service_update_with_set_forced_down'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_service_update_with_unset_forced_down
dedent|''
name|'def'
name|'test_service_update_with_unset_forced_down'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_service_get_minimum_version
dedent|''
name|'def'
name|'test_service_get_minimum_version'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_service_get_by_host_and_binary_raises
dedent|''
name|'def'
name|'test_service_get_by_host_and_binary_raises'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_service_get_all_by_binary
dedent|''
name|'def'
name|'test_service_get_all_by_binary'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_service_get_all_by_binary_include_disabled
dedent|''
name|'def'
name|'test_service_get_all_by_binary_include_disabled'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_instance_action_event_start_with_different_request_id
dedent|''
name|'def'
name|'test_instance_action_event_start_with_different_request_id'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
comment|'# init_host case'
nl|'\n'
name|'fake_admin_context'
op|'='
name|'context'
op|'.'
name|'get_admin_context'
...
newline|'\n'
nl|'\n'
DECL|member|test_instance_action_event_finish_with_different_request_id
dedent|''
name|'def'
name|'test_instance_action_event_finish_with_different_request_id'
op|'('
name|'self'
op|')'
op|':'
...
name|'patch'
op|'('
string|"'sqlalchemy.orm.query.Query.all'"
op|','
name|'return_value'
op|'='
op|'['
...
op|')'
newline|'\n'
DECL|member|test_flavor_create_with_extra_specs_duplicate
name|'def'
name|'test_flavor_create_with_extra_specs_duplicate'
op|'('
name|'self'
op|','
name|'mock_all'
...
newline|'\n'
nl|'\n'
DECL|member|test_fixed_ip_associate_succeeds_retry_on_deadlock
dedent|''
name|'def'
name|'test_fixed_ip_associate_succeeds_retry_on_deadlock'
op|'('
name|'self'
op|')'
op|':'
...
name|'patch'
op|'('
string|"'sqlalchemy.orm.query.Query.first'"
op|','
nl|'\n'
name|'side_effect'
op|'='
...
newline|'\n'
nl|'\n'
DECL|member|test_fixed_ip_associate_succeeds_retry_on_no_rows_updated
dedent|''
name|'def'
name|'test_fixed_ip_associate_succeeds_retry_on_no_rows_updated'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_fixed_ip_associate_succeeds_retry_limit_exceeded
dedent|''
name|'def'
name|'test_fixed_ip_associate_succeeds_retry_limit_exceeded'
op|'('
name|'self'
op|')'
op|':'
...
op|')'
newline|'\n'
comment|'# 5 reties + initial attempt'
nl|'\n'
name|'self'
op|'.'
name|'assertEqual'
...
newline|'\n'
nl|'\n'
DECL|member|test_fixed_ip_associate_ip_not_in_network_with_no_retries
dedent|''
dedent|''
name|'def'
name|'test_fixed_ip_associate_ip_not_in_network_with_no_retries'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_fixed_ip_associate_no_network_id_with_no_retries
dedent|''
dedent|''
name|'def'
name|'test_fixed_ip_associate_no_network_id_with_no_retries'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
comment|'# Tests that trying to associate an instance to a fixed IP on a network'
nl|'\n'
comment|'# but without specifying the network ID during associate will fail.'
nl|'\n'
indent|'        '
name|'instance_uuid'
op|'='
...
newline|'\n'
nl|'\n'
DECL|member|test_fixed_ip_associate_with_vif
dedent|''
dedent|''
name|'def'
name|'test_fixed_ip_associate_with_vif'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_fixed_ip_associate_not_allocated_without_vif
dedent|''
name|'def'
name|'test_fixed_ip_associate_not_allocated_without_vif'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_fixed_ip_associate_pool_ignores_leased_addresses
dedent|''
name|'def'
name|'test_fixed_ip_associate_pool_ignores_leased_addresses'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_fixed_ip_associate_pool_order
dedent|''
name|'def'
name|'test_fixed_ip_associate_pool_order'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_fixed_ip_associate_pool_succeeds_fip_ref_network_id_is_none
dedent|''
name|'def'
name|'test_fixed_ip_associate_pool_succeeds_fip_ref_network_id_is_none'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_fixed_ip_associate_pool_succeeds_retry
dedent|''
name|'def'
name|'test_fixed_ip_associate_pool_succeeds_retry'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_fixed_ip_associate_pool_retry_limit_exceeded
dedent|''
name|'def'
name|'test_fixed_ip_associate_pool_retry_limit_exceeded'
op|'('
name|'self'
op|')'
op|':'
...
op|')'
newline|'\n'
comment|'# 5 retries + initial attempt'
nl|'\n'
name|'self'
op|'.'
name|'assertEqual'
...
newline|'\n'
nl|'\n'
DECL|member|test_floating_ip_allocate_address_succeeds_retry
dedent|''
name|'def'
name|'test_floating_ip_allocate_address_succeeds_retry'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_floating_ip_allocate_address_retry_limit_exceeded
dedent|''
name|'def'
name|'test_floating_ip_allocate_address_retry_limit_exceeded'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_floating_ip_allocate_address_no_more_ips_with_no_retries
dedent|''
dedent|''
name|'def'
name|'test_floating_ip_allocate_address_no_more_ips_with_no_retries'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_floating_ip_associate_failed
dedent|''
name|'def'
name|'test_floating_ip_associate_failed'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_floating_ip_deallocate_address_associated_ip
dedent|''
name|'def'
name|'test_floating_ip_deallocate_address_associated_ip'
op|'('
name|'self'
op|')'
op|':'
...
nl|'\n'
comment|'# right after an instance has rebooted / recovered and before'
nl|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|test_block_device_mapping_get_all_by_instance_uuids
dedent|''
name|'def'
name|'test_block_device_mapping_get_all_by_instance_uuids'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_block_device_mapping_get_all_by_volume_id
dedent|''
name|'def'
name|'test_block_device_mapping_get_all_by_volume_id'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_block_device_mapping_get_all_by_volume_id_join_instance
dedent|''
name|'def'
name|'test_block_device_mapping_get_all_by_volume_id_join_instance'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_block_device_mapping_get_by_instance_and_volume_id
dedent|''
name|'def'
name|'test_block_device_mapping_get_by_instance_and_volume_id'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_block_device_mapping_get_by_instance_and_volume_id_multiplebdms
dedent|''
name|'def'
name|'test_block_device_mapping_get_by_instance_and_volume_id_multiplebdms'
op|'('
nl|'\n'
name|'self'
op|')'
...
newline|'\n'
nl|'\n'
DECL|member|test_block_device_mapping_get_by_instance_and_volume_id_multiattach
dedent|''
name|'def'
name|'test_block_device_mapping_get_by_instance_and_volume_id_multiattach'
op|'('
nl|'\n'
name|'self'
op|')'
...
newline|'\n'
nl|'\n'
DECL|member|test_network_set_host_already_set_correct
dedent|''
name|'def'
name|'test_network_set_host_already_set_correct'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_network_set_host_already_set_incorrect
dedent|''
name|'def'
name|'test_network_set_host_already_set_incorrect'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_network_set_host_succeeds_retry_on_deadlock
dedent|''
name|'def'
name|'test_network_set_host_succeeds_retry_on_deadlock'
op|'('
name|'self'
op|')'
op|':'
...
name|'patch'
op|'('
string|"'sqlalchemy.orm.query.Query.update'"
op|','
nl|'\n'
name|'side_effect'
op|'='
...
newline|'\n'
nl|'\n'
DECL|member|test_network_set_host_succeeds_retry_on_no_rows_updated
dedent|''
dedent|''
name|'def'
name|'test_network_set_host_succeeds_retry_on_no_rows_updated'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_network_set_host_failed_with_retry_on_no_rows_updated
dedent|''
dedent|''
name|'def'
name|'test_network_set_host_failed_with_retry_on_no_rows_updated'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_project_user_quota_usages_in_order
dedent|''
name|'def'
name|'test_get_project_user_quota_usages_in_order'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_calculate_overquota_unlimited_user_quota
dedent|''
name|'def'
name|'test_calculate_overquota_unlimited_user_quota'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_calculate_overquota_unlimited_project_quota
dedent|''
name|'def'
name|'test_calculate_overquota_unlimited_project_quota'
op|'('
name|'self'
op|')'
op|':'
...
op|']'
newline|'\n'
comment|'# TODO(jaypipes): Remove once the compute node inventory migration has'
nl|'\n'
comment|'# been completed and the scheduler uses the inventories and allocations'
nl|'\n'
comment|'# tables directly.'
nl|'\n'
DECL|variable|_ignored_temp_resource_providers_keys
name|'_ignored_temp_resource_providers_keys'
op|'='
op|'['
nl|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|test_compute_node_select_schema
dedent|''
name|'def'
name|'test_compute_node_select_schema'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
comment|'# We here test that compute nodes that have inventory and allocation'
nl|'\n'
comment|'# entries under the new resource-providers schema return non-None'
nl|'\n'
comment|'# values for the inv_* fields in the returned list of dicts from'
nl|'\n'
comment|'# _compute_node_select().'
nl|'\n'
indent|'        '
name|'nodes'
op|'='
...
name|'writer'
newline|'\n'
DECL|function|create_resource_provider
name|'def'
name|'create_resource_provider'
op|'('
name|'context'
op|')'
op|':'
...
name|'writer'
newline|'\n'
DECL|function|create_inventory
name|'def'
...
name|'writer'
newline|'\n'
DECL|function|create_allocation
name|'def'
...
newline|'\n'
nl|'\n'
comment|'# Now add an inventory record for memory and check there is a non-None'
nl|'\n'
comment|"# value for the inv_memory_mb field. Don't yet add an allocation record"
nl|'\n'
comment|'# for RAM_MB yet so ensure inv_memory_mb_used remains None.'
nl|'\n'
dedent|''
name|'rp_id'
op|'='
...
newline|'\n'
nl|'\n'
comment|'# Now add an allocation record for an instance consuming some memory'
nl|'\n'
comment|'# and check there is a non-None value for the inv_memory_mb_used field.'
nl|'\n'
name|'create_allocation'
op|'('
name|'self'
...
newline|'\n'
nl|'\n'
comment|"# Because of the complex join conditions, it's best to also test the"
nl|'\n'
comment|'# other two resource classes and ensure that the joins are correct.'
nl|'\n'
name|'self'
op|'.'
name|'assertIsNone'
...
op|')'
newline|'\n'
comment|'# Check to make sure the other resources stayed the same...'
nl|'\n'
name|'self'
op|'.'
name|'assertEqual'
...
newline|'\n'
nl|'\n'
DECL|member|test_compute_node_statistics_no_resource_providers
dedent|''
name|'def'
name|'test_compute_node_statistics_no_resource_providers'
op|'('
name|'self'
op|')'
op|':'
...
op|')'
newline|'\n'
comment|'# Define the various values for the new compute node'
nl|'\n'
name|'new_vcpus'
op|'='
number|'4'
...
number|'1'
newline|'\n'
name|'new_memory_mb_used'
op|'='
number|'1024'
newline|'\n'
name|'new_local_gb_used'
op|'='
number|'100'
newline|'\n'
name|'new_free_ram_mb'
op|'='
number|'3072'
newline|'\n'
name|'new_free_disk_gb'
op|'='
number|'1948'
newline|'\n'
name|'new_running_vms'
op|'='
number|'1'
newline|'\n'
name|'new_current_workload'
op|'='
number|'0'
newline|'\n'
nl|'\n'
comment|'# Calculate the expected values by adding the values for the new'
nl|'\n'
comment|'# compute node to those for self.item'
nl|'\n'
name|'itm'
op|'='
name|'self'
...
newline|'\n'
nl|'\n'
comment|'# Create the new compute node'
nl|'\n'
name|'compute_node_dict'
op|'='
name|'dict'
...
newline|'\n'
nl|'\n'
comment|'# Get the stats, and make sure the stats agree with the expected'
nl|'\n'
comment|'# amounts.'
nl|'\n'
name|'stats'
...
newline|'\n'
nl|'\n'
DECL|member|test_compute_node_statistics_with_other_service
dedent|''
name|'def'
name|'test_compute_node_statistics_with_other_service'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_service_destroy_with_compute_node
dedent|''
name|'def'
name|'test_service_destroy_with_compute_node'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_service_destroy_with_old_compute_node
dedent|''
name|'def'
name|'test_service_destroy_with_old_compute_node'
op|'('
name|'self'
op|')'
op|':'
...
nl|'\n'
indent|'        '
name|'compute_node_old_host_dict'
op|'='
name|'self'
op|'.'
name|'compute_node_dict'
...
name|'patch'
op|'('
string|'"nova.db.sqlalchemy.api.compute_node_get_model"'
op|')'
newline|'\n'
DECL|member|test_dbapi_compute_node_get_model
name|'def'
name|'test_dbapi_compute_node_get_model'
op|'('
name|'self'
op|','
name|'mock_get_model'
...
name|'patch'
op|'('
string|'"nova.db.sqlalchemy.api.model_query"'
op|')'
newline|'\n'
DECL|member|test_compute_node_get_model
name|'def'
name|'test_compute_node_get_model'
op|'('
name|'self'
op|','
name|'mock_model_query'
...
newline|'\n'
nl|'\n'
DECL|member|_test_bw_usage_update
dedent|''
dedent|''
name|'def'
name|'_test_bw_usage_update'
op|'('
name|'self'
op|','
op|'**'
...
newline|'\n'
nl|'\n'
DECL|member|test_bw_usage_update_new
dedent|''
name|'def'
name|'test_bw_usage_update_new'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_bw_usage_update_existing
dedent|''
name|'def'
name|'test_bw_usage_update_existing'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|_assert_shadow_tables_empty_except
dedent|''
dedent|''
name|'def'
name|'_assert_shadow_tables_empty_except'
op|'('
name|'self'
op|','
op|'*'
...
nl|'\n'
comment|'# NOTE(cdent): migration 314 introduced three new'
nl|'\n'
comment|"# ('resource_providers', 'allocations' and 'inventories')"
nl|'\n'
...
newline|'\n'
nl|'\n'
comment|'# Ensure only deleted rows were deleted'
nl|'\n'
name|'self'
op|'.'
name|'_assert_shadow_tables_empty_except'
...
newline|'\n'
comment|'# NOTE(cdent): migration 314 adds the resource_providers'
nl|'\n'
comment|'# table with a uuid column that does not archive, so skip.'
nl|'\n'
name|'skip_tables'
op|'='
op|'['
...
newline|'\n'
nl|'\n'
DECL|member|_get_new_default_values
dedent|''
name|'def'
name|'_get_new_default_values'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_instance_group_get_by_other_project_user
dedent|''
name|'def'
name|'test_instance_group_get_by_other_project_user'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_instance_group_delete_by_other_project_user
dedent|''
name|'def'
name|'test_instance_group_delete_by_other_project_user'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_instance_group_get_by_admin
dedent|''
name|'def'
name|'test_instance_group_get_by_admin'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_instance_group_delete_by_admin
dedent|''
name|'def'
name|'test_instance_group_delete_by_admin'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_pci_device_get_all_by_parent_addr
dedent|''
name|'def'
name|'test_pci_device_get_all_by_parent_addr'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_pci_device_get_all_by_parent_addr_empty
dedent|''
name|'def'
name|'test_pci_device_get_all_by_parent_addr_empty'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|_create_fake_pci_devs_old_format
dedent|''
name|'def'
name|'_create_fake_pci_devs_old_format'
op|'('
name|'self'
op|')'
op|':'
...
op|')'
newline|'\n'
DECL|member|test_pcidevice_online_mig_not_ready
name|'def'
name|'test_pcidevice_online_mig_not_ready'
op|'('
name|'self'
op|','
name|'mock_should_migrate'
op|')'
op|':'
newline|'\n'
indent|'        '
...
op|')'
newline|'\n'
DECL|member|test_pcidevice_online_mig_data_migrated_limit
name|'def'
name|'test_pcidevice_online_mig_data_migrated_limit'
op|'('
name|'self'
op|','
nl|'\n'
...
op|')'
newline|'\n'
DECL|member|test_pcidevice_online_mig
name|'def'
name|'test_pcidevice_online_mig'
op|'('
name|'self'
op|','
name|'mock_should_migrate'
...
newline|'\n'
nl|'\n'
DECL|member|test_migrate_aggregates
dedent|''
name|'def'
name|'test_migrate_aggregates'
op|'('
name|'self'
op|')'
op|':'
...
name|'patch'
op|'('
string|"'nova.db.sqlalchemy.models.Tag.__table__.insert'"
op|','
nl|'\n'
name|'return_value'
op|'='
...
op|')'
newline|'\n'
DECL|member|test_instance_tag_set_empty_add
name|'def'
name|'test_instance_tag_set_empty_add'
op|'('
name|'self'
op|','
name|'mock_insert'
...
newline|'\n'
nl|'\n'
comment|"# Check insert() was called to insert 'tag1' and 'tag2'"
nl|'\n'
name|'mock_insert'
op|'.'
name|'assert_called_once_with'
...
newline|'\n'
nl|'\n'
comment|"# Check insert() wasn't called because there are no tags for creation"
nl|'\n'
name|'mock_insert'
op|'.'
...
name|'patch'
op|'('
string|"'sqlalchemy.orm.query.Query.delete'"
op|')'
newline|'\n'
DECL|member|test_instance_tag_set_empty_delete
name|'def'
name|'test_instance_tag_set_empty_delete'
op|'('
name|'self'
op|','
name|'mock_delete'
...
newline|'\n'
nl|'\n'
comment|"# Check delete() wasn't called because there are no tags for deletion"
nl|'\n'
name|'mock_delete'
op|'.'
name|'assert_not_called'
...
newline|'\n'
nl|'\n'
comment|"# Check delete() was called to delete 'tag2'"
nl|'\n'
name|'mock_delete'
op|'.'
name|'assert_called_once_with'
...
newline|'\n'
nl|'\n'
DECL|member|test_instance_tag_exists
dedent|''
name|'def'
name|'test_instance_tag_exists'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
comment|"# NOTE(snikitin): Make sure it's actually a bool"
nl|'\n'
name|'self'
op|'.'
name|'assertTrue'
...
newline|'\n'
nl|'\n'
DECL|member|test_instance_tag_exists_non_existing_instance
dedent|''
name|'def'
name|'test_instance_tag_exists_non_existing_instance'
op|'('
name|'self'
op|')'
op|':'
...
nl|'\n'
nl|'\n'
DECL|class|TestInstanceInfoCache
dedent|''
dedent|''
name|'class'
name|'TestInstanceInfoCache'
op|'('
name|'test'
op|'.'
name|'TestCase'
...
newline|'\n'
nl|'\n'
DECL|member|test_instance_info_cache_get
dedent|''
name|'def'
name|'test_instance_info_cache_get'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_instance_info_cache_update_duplicate
dedent|''
name|'def'
name|'test_instance_info_cache_update_duplicate'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
comment|'# updating of instance_uuid causes unique constraint failure,'
nl|'\n'
comment|'# using of savepoint helps to continue working with existing session'
nl|'\n'
comment|'# after DB errors, so exception was successfully handled'
nl|'\n'
name|'db'
op|'.'
name|'instance_info_cache_update'
...
newline|'\n'
nl|'\n'
DECL|member|test_instance_info_cache_create_using_update
dedent|''
name|'def'
name|'test_instance_info_cache_create_using_update'
op|'('
name|'self'
op|')'
op|':'
...
nl|'\n'
nl|'\n'
DECL|class|TestInstanceTagsFiltering
dedent|''
dedent|''
name|'class'
name|'TestInstanceTagsFiltering'
op|'('
name|'test'
op|'.'
name|'TestCase'
...
newline|'\n'
nl|'\n'
DECL|member|_create_instance_with_kwargs
dedent|''
name|'def'
name|'_create_instance_with_kwargs'
op|'('
name|'self'
op|','
op|'**'
...
newline|'\n'
nl|'\n'
DECL|member|_assertEqualInstanceUUIDs
dedent|''
name|'def'
name|'_assertEqualInstanceUUIDs'
op|'('
name|'self'
op|','
name|'expected_uuids'
op|','
name|'observed_instances'
op|')'
op|':'
newline|'\n'
indent|'        '
...
newline|'\n'
nl|'\n'
DECL|member|test_instance_get_all_by_filters_tags_and_project_id
dedent|''
name|'def'
name|'test_instance_get_all_by_filters_tags_and_project_id'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_instance_get_all_by_filters_not_tags
dedent|''
name|'def'
name|'test_instance_get_all_by_filters_not_tags'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_instance_get_all_by_filters_not_tags_any
dedent|''
name|'def'
name|'test_instance_get_all_by_filters_not_tags_any'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_instance_get_all_by_filters_not_tags_and_tags
dedent|''
name|'def'
name|'test_instance_get_all_by_filters_not_tags_and_tags'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_instance_get_all_by_filters_tags_contradictory
dedent|''
name|'def'
name|'test_instance_get_all_by_filters_tags_contradictory'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_instance_get_all_by_filters_not_tags_and_tags_any
dedent|''
name|'def'
name|'test_instance_get_all_by_filters_not_tags_and_tags_any'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_instance_get_all_by_filters_not_tags_and_not_tags_any
dedent|''
name|'def'
name|'test_instance_get_all_by_filters_not_tags_and_not_tags_any'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_instance_get_all_by_filters_all_tag_filters
dedent|''
name|'def'
name|'test_instance_get_all_by_filters_all_tag_filters'
op|'('
name|'self'
op|')'
op|':'
