...
newline|'\n'
nl|'\n'
DECL|member|test_flavor_extra_specs_get_item
dedent|''
dedent|''
name|'def'
name|'test_flavor_extra_specs_get_item'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_ec2_instance_id_by_uuid
dedent|''
name|'def'
name|'test_get_ec2_instance_id_by_uuid'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_ec2_instance_id_by_uuid_not_found
dedent|''
name|'def'
name|'test_get_ec2_instance_id_by_uuid_not_found'
op|'('
name|'self'
op|')'
op|':'
