...
newline|'\n'
nl|'\n'
DECL|member|test_migrate_computenode
dedent|''
name|'def'
name|'test_migrate_computenode'
op|'('
name|'self'
op|')'
op|':'
...
name|'db'
op|'.'
name|'computenode_uuids_online_data_migration'
op|'('
nl|'\n'
name|'self'
op|'.'
...
op|')'
newline|'\n'
DECL|member|test_instance_info_cache_retried_on_deadlock
name|'def'
name|'test_instance_info_cache_retried_on_deadlock'
op|'('
name|'self'
op|','
name|'update'
...
op|')'
newline|'\n'
DECL|member|test_instance_info_cache_not_retried_on_deadlock_forever
name|'def'
name|'test_instance_info_cache_not_retried_on_deadlock_forever'
op|'('
name|'self'
op|','
name|'update'
