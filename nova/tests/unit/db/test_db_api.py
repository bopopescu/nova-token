...
op|':'
newline|'\n'
DECL|member|test_augment_flavor_to_migrate_no_extra_specs
indent|'    '
name|'def'
name|'test_augment_flavor_to_migrate_no_extra_specs'
op|'('
name|'self'
op|')'
op|':'
...
name|'sqlalchemy_api'
op|'.'
name|'_augment_flavor_to_migrate'
op|'('
name|'flavor'
op|','
name|'full_flavor'
...
newline|'\n'
nl|'\n'
DECL|member|test_augment_flavor_to_migrate_extra_specs_merge
dedent|''
name|'def'
name|'test_augment_flavor_to_migrate_extra_specs_merge'
op|'('
name|'self'
op|')'
op|':'
...
name|'patch'
op|'('
string|"'nova.db.sqlalchemy.api._augment_flavor_to_migrate'"
op|')'
newline|'\n'
DECL|member|test_augment_flavors_to_migrate
name|'def'
name|'test_augment_flavors_to_migrate'
op|'('
name|'self'
op|','
name|'mock_augment'
...
name|'sqlalchemy_api'
op|'.'
name|'_augment_flavors_to_migrate'
op|'('
name|'instance'
op|','
nl|'\n'
...
op|')'
newline|'\n'
DECL|member|test_augment_flavors_to_migrate_uses_cache
name|'def'
name|'test_augment_flavors_to_migrate_uses_cache'
op|'('
name|'self'
op|','
name|'mock_get'
...
newline|'\n'
nl|'\n'
DECL|member|test_migrate_flavor
dedent|''
name|'def'
name|'test_migrate_flavor'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_migrate_flavor_honors_limit
dedent|''
name|'def'
name|'test_migrate_flavor_honors_limit'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|_test_migrate_flavor_states
dedent|''
name|'def'
name|'_test_migrate_flavor_states'
op|'('
name|'self'
op|','
name|'force'
...
newline|'\n'
nl|'\n'
DECL|member|test_migrate_flavor_honors_states
dedent|''
dedent|''
name|'def'
name|'test_migrate_flavor_honors_states'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_migrate_flavor_force_states
dedent|''
name|'def'
name|'test_migrate_flavor_force_states'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_migrate_flavor_gets_missing_extra_rows
dedent|''
name|'def'
name|'test_migrate_flavor_gets_missing_extra_rows'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_migrate_flavor_with_deleted_things
dedent|''
name|'def'
name|'test_migrate_flavor_with_deleted_things'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
comment|'# Instance with some deleted metadata bits. We create'
nl|'\n'
comment|'# with a flavor, then change one of the keys so that'
nl|'\n'
comment|'# we end up with a soft-deleted row for that value.'
nl|'\n'
name|'values'
op|'='
op|'{'
...
newline|'\n'
nl|'\n'
comment|'# Deleted instance. Without a full flavor in sysmeta,'
nl|'\n'
comment|"# if this is hit in the migration, we'll explode trying"
nl|'\n'
comment|'# to construct the full flavor.'
nl|'\n'
name|'values'
op|'='
op|'{'
...
newline|'\n'
nl|'\n'
comment|'# Instance that has only deleted flavor metadata. This'
nl|'\n'
comment|'# looks like an instance that previously had flavor stuff'
nl|'\n'
comment|'# in sysmeta, but has since been converted. Since extra.flavor'
nl|'\n'
comment|"# is not a legitimate structure, we'll explode if the migration"
nl|'\n'
comment|'# code tries to hit this.'
nl|'\n'
name|'values'
op|'='
op|'{'
...
op|')'
newline|'\n'
DECL|member|_test_migrate_flavor_with_no_sysmeta
name|'def'
name|'_test_migrate_flavor_with_no_sysmeta'
op|'('
name|'self'
op|','
name|'flavor'
...
newline|'\n'
nl|'\n'
comment|'# NOTE(danms): Fetch the pieces to make sure the sans-sysmeta'
nl|'\n'
comment|'# instance is actually migrated in the database'
nl|'\n'
name|'extra'
op|'='
name|'db'
...
newline|'\n'
nl|'\n'
DECL|member|test_migrate_flavor_with_no_sysmeta_first
dedent|''
name|'def'
name|'test_migrate_flavor_with_no_sysmeta_first'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_migrate_flavor_with_no_sysmeta_last
dedent|''
name|'def'
name|'test_migrate_flavor_with_no_sysmeta_last'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_migrate_flavor_with_no_sysmeta_alone
dedent|''
name|'def'
name|'test_migrate_flavor_with_no_sysmeta_alone'
op|'('
name|'self'
op|')'
op|':'
...
op|')'
newline|'\n'
DECL|member|test_migrate_flavor_with_no_sysmeta_no_flavor
name|'def'
name|'test_migrate_flavor_with_no_sysmeta_no_flavor'
op|'('
name|'self'
op|','
name|'mock_get_flavor'
...
op|')'
newline|'\n'
DECL|member|test_migrate_flavor_with_missing_flavor
name|'def'
name|'test_migrate_flavor_with_missing_flavor'
op|'('
name|'self'
op|','
name|'mock_save'
