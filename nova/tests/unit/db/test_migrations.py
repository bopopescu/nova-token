...
name|'engine'
op|','
string|"'shadow_aggregates'"
op|','
string|"'uuid'"
op|')'
newline|'\n'
nl|'\n'
DECL|member|_check_318
dedent|''
name|'def'
name|'_check_318'
op|'('
...
op|':'
newline|'\n'
comment|'# Just a sanity-check migration'
nl|'\n'
indent|'        '
name|'pass'
newline|'\n'
nl|'\n'
DECL|member|_check_331
dedent|''
name|'def'
name|'_check_331'
op|'('
