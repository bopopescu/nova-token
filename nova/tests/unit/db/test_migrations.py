...
op|':'
newline|'\n'
comment|'# NOTE(nic): This is a MySQL-specific migration, and is a no-op from'
nl|'\n'
comment|'# the point-of-view of unit tests, since they use SQLite'
nl|'\n'
indent|'        '
name|'pass'
newline|'\n'
nl|'\n'
DECL|member|filter_metadata_diff
dedent|''
name|'def'
name|'filter_metadata_diff'
op|'('
name|'self'
op|','
name|'diff'
...
op|':'
newline|'\n'
comment|'# Overriding the parent method to decide on certain attributes'
nl|'\n'
comment|'# that maybe present in the DB but not in the models.py'
nl|'\n'
nl|'\n'
DECL|function|removed_column
indent|'        '
name|'def'
name|'removed_column'
op|'('
...
op|':'
newline|'\n'
comment|'# Define a whitelist of columns that would be removed from the'
nl|'\n'
comment|'# DB at a later release.'
nl|'\n'
indent|'            '
...
name|'patch'
op|'('
string|"'nova.db.sqlalchemy.migration._schedule_schema_changes'"
op|')'
newline|'\n'
op|'@'
name|'mock'
...
name|'patch'
op|'('
string|"'nova.db.sqlalchemy.migration._find_migrate_repo'"
op|')'
newline|'\n'
DECL|member|test_dryrun
name|'def'
name|'test_dryrun'
op|'('
name|'self'
...
op|':'
newline|'\n'
comment|"# we shouldn't lock the sqlalchemy migrate table on a dry run"
nl|'\n'
indent|'        '
name|'schedule'
op|'.'
