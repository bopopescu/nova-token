...
newline|'\n'
nl|'\n'
DECL|member|_post_downgrade_272
dedent|''
name|'def'
name|'_post_downgrade_272'
op|'('
name|'self'
op|','
name|'engine'
...
newline|'\n'
nl|'\n'
DECL|member|test_migration_272
dedent|''
name|'def'
name|'test_migration_272'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
comment|'# This is separate from test_walk_versions so we can test that the'
nl|'\n'
comment|'# previous keypair entries will have the default value set in the'
nl|'\n'
comment|'# new column.'
nl|'\n'
indent|'        '
...
newline|'\n'
nl|'\n'
comment|'# Now run the 272 upgrade again.'
nl|'\n'
name|'self'
op|'.'
name|'migration_api'
