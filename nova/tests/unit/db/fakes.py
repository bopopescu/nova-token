...
newline|'\n'
nl|'\n'
DECL|variable|virtual_interface_fields
...
op|']'
newline|'\n'
DECL|variable|virtual_interfacees
...
op|','
nl|'\n'
string|"'nova.db.api.fixed_ip_get_by_instance'"
op|':'
name|'fake_fixed_ip_get_by_instance'
op|','
nl|'\n'
