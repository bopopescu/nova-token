...
nl|'\n'
nl|'\n'
DECL|class|TestNewtonCheck
dedent|''
dedent|''
name|'class'
name|'TestNewtonCheck'
op|'('
name|'test'
op|'.'
name|'TestCase'
...
string|"'nova.db.sqlalchemy.migrate_repo.versions.'"
nl|'\n'
string|"'330_enforce_mitaka_online_migrations'"
op|')'
newline|'\n'
name|'self'
op|'.'
...
newline|'\n'
nl|'\n'
DECL|member|test_all_migrated
dedent|''
name|'def'
name|'test_all_migrated'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_cn_not_migrated
dedent|''
name|'def'
name|'test_cn_not_migrated'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_aggregate_not_migrated
dedent|''
name|'def'
name|'test_aggregate_not_migrated'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_pci_device_not_migrated
dedent|''
name|'def'
name|'test_pci_device_not_migrated'
op|'('
name|'self'
op|')'
op|':'
