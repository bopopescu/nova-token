...
nl|'\n'
nl|'\n'
comment|"# FIXME(danms): We shouldn't be overriding any of this, but need to"
nl|'\n'
comment|"# for the moment because of the mocks in the base fixture that don't"
nl|'\n'
comment|'# hit our registry subclass.'
nl|'\n'
...
op|')'
newline|'\n'
DECL|member|test_object_tree_backport
name|'def'
name|'test_object_tree_backport'
op|'('
name|'self'
op|','
name|'mock_get_versions'
op|')'
op|':'
newline|'\n'
comment|'# Test the full client backport path all the way from the serializer'
nl|'\n'
comment|'# to the conductor and back.'
nl|'\n'
indent|'        '
name|'self'
op|'.'
...
newline|'\n'
nl|'\n'
comment|'# NOTE(danms): Actually register a complex set of objects,'
nl|'\n'
comment|'# two versions of the same parent object which contain a'
nl|'\n'
comment|'# child sub object.'
nl|'\n'
op|'@'
name|'base'
op|'.'
...
newline|'\n'
nl|'\n'
comment|"# NOTE(danms): Since we're on the same node as conductor,"
nl|'\n'
comment|'# return a fake version manifest so that we confirm that it'
nl|'\n'
comment|'# actually honors what the client asked for and not just what'
nl|'\n'
comment|'# it sees in the local machine state.'
nl|'\n'
dedent|''
name|'mock_get_versions'
op|'.'
...
newline|'\n'
nl|'\n'
DECL|function|fake_obj_from_primitive
name|'def'
name|'fake_obj_from_primitive'
op|'('
op|'*'
name|'a'
op|','
...
op|':'
newline|'\n'
comment|'# NOTE(danms): We need the first call to this to report an'
nl|'\n'
comment|'# incompatible object version, but subsequent calls must'
nl|'\n'
comment|"# succeed. Since we're testing the backport path all the"
nl|'\n'
comment|"# way through conductor and RPC, we can't fully break this"
nl|'\n'
comment|'# method, we just need it to fail once to trigger the'
nl|'\n'
comment|'# backport.'
nl|'\n'
indent|'            '
...
newline|'\n'
nl|'\n'
comment|'# Our newest version (and what we passed back) of Parent'
nl|'\n'
comment|'# is 1.1, make sure that the manifest version is honored'
nl|'\n'
name|'self'
op|'.'
name|'assertEqual'
...
newline|'\n'
nl|'\n'
comment|'# Our newest version (and what we passed back) of Child'
nl|'\n'
comment|'# is 1.10, make sure that the manifest version is honored'
nl|'\n'
name|'self'
op|'.'
name|'assertEqual'
...
name|'patch'
op|'('
string|"'nova.objects.base.objects'"
op|')'
newline|'\n'
DECL|member|test_hook_chooses_newer_properly
name|'def'
name|'test_hook_chooses_newer_properly'
op|'('
name|'self'
op|','
name|'mock_objects'
...
op|')'
newline|'\n'
DECL|member|test_hook_keeps_newer_properly
name|'def'
name|'test_hook_keeps_newer_properly'
op|'('
name|'self'
op|','
name|'mock_objects'
...
string|"'BuildRequest'"
op|':'
string|"'1.0-fea0b079bddc45f3150f16be5515a2a8'"
op|','
nl|'\n'
string|"'CellMapping'"
op|':'
...
string|"'ComputeNode'"
op|':'
string|"'1.16-2436e5b836fa0306a3c4e6d9e5ddacec'"
op|','
nl|'\n'
...
string|"'EventType'"
op|':'
string|"'1.0-21dc35de314fc5fc0a7965211c0c00f7'"
op|','
nl|'\n'
string|"'FixedIP'"
op|':'
string|"'1.14-53e1c10b539f1a82fe83b1af4720efae'"
op|','
nl|'\n'
string|"'FixedIPList'"
op|':'
string|"'1.14-87a39361c8f08f059004d6b15103cdfd'"
op|','
nl|'\n'
string|"'Flavor'"
op|':'
...
string|"'FloatingIP'"
op|':'
string|"'1.10-52a67d52d85eb8b3f324a5b7935a335b'"
op|','
nl|'\n'
string|"'FloatingIPList'"
op|':'
string|"'1.11-7f2ba670714e1b7bab462ab3290f7159'"
op|','
nl|'\n'
string|"'HostMapping'"
op|':'
...
string|"'ImageMeta'"
op|':'
string|"'1.8-642d1b2eb3e880a367f37d72dd76162d'"
op|','
nl|'\n'
...
string|"'Instance'"
op|':'
string|"'2.2-ab450ec9c1f4d429755c48d492b823f0'"
op|','
nl|'\n'
...
op|':'
string|"'1.0-65de80c491f54d19374703c0753c4d47'"
op|','
nl|'\n'
...
string|"'Inventory'"
op|':'
string|"'1.0-f4160797d47a533a58700e9ddcc9c5e2'"
op|','
nl|'\n'
string|"'InventoryList'"
op|':'
string|"'1.0-de53f0fd078c27cc1d43400f4e8bcef8'"
op|','
nl|'\n'
...
op|':'
string|"'1.0-bbbc1402fb0e443a3eb227cc52b61545'"
op|','
nl|'\n'
string|"'NUMACell'"
op|':'
...
op|':'
string|"'1.3-52ff14355491c8c580bdc0ba34c26210'"
op|','
nl|'\n'
...
op|':'
string|"'1.0-57a9a344b0faed9cf6d6811835b6deb6'"
op|','
nl|'\n'
...
op|':'
string|"'1.0-a5e7b4fd6cc5581be45b31ff1f3a3f7f'"
op|','
nl|'\n'
string|"'TaskLog'"
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_notification_payload_version_depends_on_the_schema
dedent|''
name|'def'
name|'test_notification_payload_version_depends_on_the_schema'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
comment|'# Get the SCHEMA items to add to the fingerprint'
nl|'\n'
comment|'# if we are looking at a notification'
nl|'\n'
name|'if'
name|'issubclass'
op|'('
