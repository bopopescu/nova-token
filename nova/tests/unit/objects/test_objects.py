...
string|"'Agent'"
op|':'
string|"'1.0-cf1b002f0e50f5333e0f33588f6c2d57'"
op|','
nl|'\n'
string|"'AgentList'"
op|':'
...
string|"'Aggregate'"
op|':'
string|"'1.1-7b3f04af5342ba544955d01c9c954fa5'"
op|','
nl|'\n'
...
op|':'
string|"'1.2-e7d3b3a5c3950cc67c99bc26a1075a70'"
op|','
nl|'\n'
...
op|':'
string|"'1.9-c87e9c7e5cfd6a402f32727aa74aca95'"
op|','
nl|'\n'
...
string|"'ComputeNode'"
op|':'
string|"'1.11-5f8cd6948ad98fcc0c39b79d49acc4b6'"
op|','
nl|'\n'
...
string|"'EC2Ids'"
op|':'
string|"'1.0-8e193896fa01cec598b875aea94da608'"
op|','
nl|'\n'
string|"'EC2InstanceMapping'"
op|':'
string|"'1.0-e9c3257badcc3aa14089b0a62f163108'"
op|','
nl|'\n'
string|"'EC2SnapshotMapping'"
op|':'
string|"'1.0-a545acd0d1519d4316b9b00f30e59b4d'"
op|','
nl|'\n'
string|"'EC2VolumeMapping'"
op|':'
string|"'1.0-15710aa212b5cbfdb155fdc81cce4ede'"
op|','
nl|'\n'
string|"'FixedIP'"
op|':'
string|"'1.10-4e8060f91f6c94ae73d557708ec62f56'"
op|','
nl|'\n'
string|"'FixedIPList'"
op|':'
...
string|"'Flavor'"
op|':'
string|"'1.1-01ed47361fbe76bf728edf667d3f45d3'"
op|','
nl|'\n'
string|"'FlavorList'"
op|':'
...
string|"'FloatingIP'"
op|':'
string|"'1.6-24c614d2c3d4887254a679be65c11de5'"
op|','
nl|'\n'
...
string|"'ImageMeta'"
op|':'
string|"'1.0-dbbf573f58eb5f874e2a10aee54394dd'"
op|','
nl|'\n'
string|"'ImageMetaProps'"
op|':'
string|"'1.0-5da0eea4eeca04fcd9c7f255c2a43eaa'"
op|','
nl|'\n'
string|"'Instance'"
op|':'
string|"'1.20-0991d6bd300ebf35ec19d7d68922e69b'"
op|','
nl|'\n'
string|"'InstanceAction'"
op|':'
string|"'1.1-866fb0235d45ab51cc299b8726303d9c'"
op|','
nl|'\n'
string|"'InstanceActionEvent'"
op|':'
string|"'1.1-538698f30974064543134784c5da6056'"
op|','
nl|'\n'
...
op|':'
string|"'1.2-090c74b3833c715845ec2cf24a686aaf'"
op|','
nl|'\n'
...
op|':'
string|"'1.9-a77a59735d62790dcaa413a21acfaa73'"
op|','
nl|'\n'
...
op|':'
string|"'1.5-ef7394dae46cff2dd560324555cb85cf'"
op|','
nl|'\n'
string|"'InstanceList'"
op|':'
...
op|':'
string|"'1.1-b6fab68a3f0f1dfab4c98a236d29839a'"
op|','
nl|'\n'
...
op|':'
string|"'1.1-4825b599f000538991fdc9972a92c2c6'"
op|','
nl|'\n'
string|"'KeyPair'"
op|':'
...
string|"'MyObj'"
op|':'
string|"'1.6-fce707f79d6fee00f0ebbac98816a380'"
op|','
nl|'\n'
string|"'MyOwnedObject'"
op|':'
...
string|"'Network'"
op|':'
string|"'1.2-141c797b794a4f8dbe251f929dc15268'"
op|','
nl|'\n'
string|"'NetworkList'"
op|':'
...
string|"'PciDevice'"
op|':'
string|"'1.3-6d37f795ee934e7db75b5a6a1926def0'"
op|','
nl|'\n'
...
op|':'
string|"'1.1-2f352e08e128ec5bc84bc3007936cc6d'"
op|','
nl|'\n'
...
string|"'Quotas'"
op|':'
string|"'1.2-615ed622082c92d938119fd49e6d84ee'"
op|','
nl|'\n'
string|"'QuotasNoOp'"
op|':'
...
op|':'
string|"'1.0-56d23342db8131d826797c7229dc4050'"
op|','
nl|'\n'
string|"'SecurityGroup'"
op|':'
string|"'1.1-cd2f3c063640723b584634fa1075be77'"
op|','
nl|'\n'
...
op|':'
string|"'1.1-38290b6f9a35e416c2bcab5f18708967'"
op|','
nl|'\n'
...
string|"'Service'"
op|':'
string|"'1.12-1a34a387914f90aacc33c8c43d45d0b3'"
op|','
nl|'\n'
string|"'ServiceList'"
op|':'
...
string|"'Tag'"
op|':'
string|"'1.0-521693d0515aa031dff2b8ae3f86c8e0'"
op|','
nl|'\n'
string|"'TagList'"
op|':'
...
op|':'
string|"'1.6-d0f7f126f87433003c4d2ced202d6c86'"
op|','
nl|'\n'
...
op|':'
string|"'1.0-d3d14066c99b8ae4d5204059fb147279'"
op|','
nl|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|test_registry_matches_metaclass
dedent|''
name|'def'
name|'test_registry_matches_metaclass'
op|'('
name|'self'
op|')'
op|':'
...
op|')'
newline|'\n'
comment|"# NOTE(danms): In the new registry, we don't implicitly track test"
nl|'\n'
comment|'# objects, so make sure that the difference between the metaclass and'
nl|'\n'
comment|'# the opt-in registry is the set of test objects.'
nl|'\n'
name|'self'
op|'.'
name|'assertEqual'
