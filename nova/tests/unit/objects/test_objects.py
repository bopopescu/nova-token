...
string|"'ImageMeta'"
op|':'
string|"'1.7-642d1b2eb3e880a367f37d72dd76162d'"
op|','
nl|'\n'
string|"'ImageMetaProps'"
op|':'
string|"'1.7-f12fc4cf3e25d616f69a66fb9d2a7aa6'"
op|','
nl|'\n'
string|"'Instance'"
op|':'
...
op|':'
newline|'\n'
comment|"# NOTE(danms): We're moving to using manifest-based backports,"
nl|'\n'
comment|"# which don't depend on relationships. Given that we only had"
nl|'\n'
comment|'# one major version of each object before that change, we can'
nl|'\n'
comment|'# make sure to pull the older version of objects that have'
nl|'\n'
comment|'# a 2.0 version while calculating the old-style relationship'
nl|'\n'
comment|'# mapping. Once we drop all the 1.x versions, we can drop this'
nl|'\n'
comment|'# relationship test altogether.'
nl|'\n'
indent|'        '
name|'new_objects'
op|'='
...
newline|'\n'
nl|'\n'
DECL|member|_get_obj_same_major
dedent|''
name|'def'
name|'_get_obj_same_major'
op|'('
name|'self'
op|','
name|'this_cls'
...
op|':'
newline|'\n'
comment|'# NOTE(danms): Objects with major versions >=2 will'
nl|'\n'
comment|'# use version_manifest for backports, which is a'
nl|'\n'
comment|'# different test than this one, so skip.'
nl|'\n'
indent|'                    '
name|'continue'
newline|'\n'
