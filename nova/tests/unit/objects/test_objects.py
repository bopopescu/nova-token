...
string|"'PciDevice'"
op|':'
string|"'1.4-4f54e80054bbb6414e17eb9babc97a44'"
op|','
nl|'\n'
...
name|'checker'
op|'='
name|'NotificationAwareObjectVersionChecker'
op|'('
nl|'\n'
name|'base'
op|'.'
...
nl|'\n'
nl|'\n'
DECL|class|NotificationAwareObjectVersionChecker
dedent|''
dedent|''
dedent|''
name|'class'
...
op|':'
newline|'\n'
comment|'# Note(gibi): to make NotificationPayload version dependent on the'
nl|'\n'
comment|'# SCHEMA of the payload we inject the SCHEMA content to the hash'
nl|'\n'
comment|'# calculation algorithm'
nl|'\n'
indent|'            '
name|'extra_relevant_data'
op|'='
name|'collections'
op|'.'
name|'OrderedDict'
