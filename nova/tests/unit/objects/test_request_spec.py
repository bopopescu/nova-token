...
newline|'\n'
nl|'\n'
DECL|member|test_from_components
dedent|''
name|'def'
name|'test_from_components'
op|'('
name|'self'
op|')'
op|':'
...
name|'patch'
op|'('
string|"'nova.objects.RequestSpec._populate_group_info'"
op|')'
newline|'\n'
DECL|member|test_from_components_with_instance_group
name|'def'
name|'test_from_components_with_instance_group'
op|'('
name|'self'
op|','
name|'mock_pgi'
...
op|':'
newline|'\n'
comment|"# This test makes sure that we don't overwrite instance group passed"
nl|'\n'
comment|'# to from_components'
nl|'\n'
indent|'        '
name|'ctxt'
op|'='
...
op|')'
newline|'\n'
DECL|member|test_from_components_without_instance_group
name|'def'
name|'test_from_components_without_instance_group'
op|'('
name|'self'
op|','
name|'mock_pgi'
...
op|':'
newline|'\n'
comment|'# This test makes sure that we populate instance group if not'
nl|'\n'
comment|'# present'
nl|'\n'
indent|'        '
...
newline|'\n'
nl|'\n'
DECL|member|test_reset_forced_destinations
dedent|''
dedent|''
name|'def'
name|'test_reset_forced_destinations'
op|'('
name|'self'
op|')'
op|':'
...
op|')'
newline|'\n'
comment|'# Making sure the fake object has forced hosts and nodes'
nl|'\n'
name|'self'
op|'.'
