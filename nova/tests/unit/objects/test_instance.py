...
op|':'
newline|'\n'
comment|"# FIXME(danms): This isn't implemented yet, but is handled"
nl|'\n'
comment|'# in the lazy-load code, so code can act like it is (although'
nl|'\n'
comment|'# this test is being pedantic).'
nl|'\n'
indent|'                '
name|'continue'
newline|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|test_set_flavor_namespace
dedent|''
name|'def'
name|'test_set_flavor_namespace'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
comment|'# The system_metadata flavor should be gone'
nl|'\n'
name|'self'
op|'.'
name|'assertNotIn'
...
newline|'\n'
nl|'\n'
comment|'# The flavors should all be set, and match what we expect'
nl|'\n'
name|'self'
op|'.'
name|'assertEqual'
...
newline|'\n'
nl|'\n'
comment|'# inst.flavor should have merged extra_specs, with its overridden'
nl|'\n'
comment|'# value for hw:numa_cpus.1'
nl|'\n'
name|'self'
op|'.'
name|'assertEqual'
...
newline|'\n'
nl|'\n'
comment|'# inst.old_flavor did not have an overridden version'
nl|'\n'
name|'self'
op|'.'
name|'assertEqual'
...
newline|'\n'
nl|'\n'
DECL|member|test_migrate_flavor_save_load
dedent|''
name|'def'
name|'test_migrate_flavor_save_load'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_migrate_flavor_on_save_when_not_loaded_on_get
dedent|''
name|'def'
name|'test_migrate_flavor_on_save_when_not_loaded_on_get'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_lazy_load_flavor_from_existing_sysmeta
dedent|''
name|'def'
name|'test_lazy_load_flavor_from_existing_sysmeta'
op|'('
name|'self'
op|')'
op|':'
...
op|')'
newline|'\n'
comment|"# NOTE(danms): Don't set a context to prove we don't require one"
nl|'\n'
comment|"# in the case where we're loading purely from sysmeta"
nl|'\n'
name|'inst'
op|'='
name|'objects'
...
newline|'\n'
nl|'\n'
DECL|member|test_backport_flavor
dedent|''
name|'def'
name|'test_backport_flavor'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_migrate_flavor_older_instance
dedent|''
name|'def'
name|'test_migrate_flavor_older_instance'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_migrate_flavor_instance_no_extra
dedent|''
name|'def'
name|'test_migrate_flavor_instance_no_extra'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_without_extra_record
dedent|''
name|'def'
name|'test_without_extra_record'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_with_null_extra_record
dedent|''
dedent|''
name|'def'
name|'test_with_null_extra_record'
op|'('
name|'self'
op|')'
op|':'
...
op|':'
newline|'\n'
DECL|member|test_flavor_shows_up_in_lazy_loaded_sysmeta_for_old_instance
indent|'    '
name|'def'
name|'test_flavor_shows_up_in_lazy_loaded_sysmeta_for_old_instance'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_flavor_shows_up_in_sysmeta_for_old_instance
dedent|''
name|'def'
name|'test_flavor_shows_up_in_sysmeta_for_old_instance'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_compat_instance
dedent|''
name|'def'
name|'test_compat_instance'
op|'('
name|'self'
op|')'
op|':'
...
op|']'
op|'['
string|"'old_instance_type_flavorid'"
op|']'
op|')'
newline|'\n'
name|'self'
...
newline|'\n'
nl|'\n'
DECL|member|test_compat_instance_noninstance
dedent|''
name|'def'
name|'test_compat_instance_noninstance'
op|'('
name|'self'
op|')'
op|':'
