...
newline|'\n'
nl|'\n'
DECL|member|test_volume_backed_image
dedent|''
name|'def'
name|'test_volume_backed_image'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_null_substitution
dedent|''
name|'def'
name|'test_null_substitution'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_legacy_compat_vmware_adapter_types
dedent|''
name|'def'
name|'test_legacy_compat_vmware_adapter_types'
op|'('
name|'self'
op|')'
op|':'
