...
nl|'\n'
nl|'\n'
DECL|function|fake_network_obj
dedent|''
name|'def'
...
op|':'
newline|'\n'
comment|'# test is an instance of nova.test.TestCase'
nl|'\n'
...
name|'stub_out'
op|'('
string|"'nova.network.api.API.deallocate_for_instance'"
op|','
nl|'\n'
name|'lambda'
op|'*'
...
name|'stub_out'
op|'('
string|"'nova.compute.manager.ComputeManager._allocate_network'"
op|','
nl|'\n'
name|'fake_async_networkinfo'
op|')'
...
name|'stub_out'
op|'('
string|"'nova.compute.manager.ComputeManager._deallocate_network'"
op|','
nl|'\n'
name|'lambda'
op|'*'
