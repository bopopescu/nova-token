...
newline|'\n'
nl|'\n'
comment|'# NOTE(jaypipes): This fixture should go bye-bye once bauzas implements'
nl|'\n'
comment|'#                 the detach-compute-node-from-service blueprint.'
nl|'\n'
...
op|','
nl|'\n'
comment|"# Yes, it's a list. Yes, it's a singular form of compute_node, not a"
nl|'\n'
comment|"# pluralized form. No, it doesn't matter, because this will all be removed"
nl|'\n'
comment|'# when the above blueprint is implemented.'
nl|'\n'
string|"'compute_node'"
op|':'
name|'_COMPUTE_NODE_FIXTURES'
...
newline|'\n'
nl|'\n'
comment|'# NOTE(jaypipes): RT._get_service() calls the conductor right now to'
nl|'\n'
comment|'#                 get the service for a compute host. Yes, this is odd,'
nl|'\n'
comment|'#                 and yes, bauzas is fixing this problem in the'
nl|'\n'
comment|'#                 detach-compute-node-from-service blueprint.'
nl|'\n'
name|'capi'
