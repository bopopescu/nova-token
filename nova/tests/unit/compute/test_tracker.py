...
name|'patch'
op|'('
string|"'nova.pci.manager.PciDevTracker.claim_instance'"
op|')'
newline|'\n'
op|'@'
name|'mock'
...
op|')'
newline|'\n'
DECL|member|test_claim_with_pci
name|'def'
name|'test_claim_with_pci'
op|'('
name|'self'
op|','
name|'migr_mock'
...
op|','
nl|'\n'
name|'pci_manager_mock'
op|','
name|'pci_stats_mock'
op|')'
op|':'
newline|'\n'
comment|'# Test that a claim involving PCI requests correctly claims'
nl|'\n'
comment|'# PCI devices on the host and sends an updated pci_device_pools'
nl|'\n'
comment|'# attribute of the ComputeNode object.'
nl|'\n'
indent|'        '
name|'self'
op|'.'
...
newline|'\n'
nl|'\n'
comment|'# TODO(jaypipes): Remove once the PCI tracker is always created'
nl|'\n'
comment|'# upon the resource tracker being initialized...'
nl|'\n'
name|'self'
op|'.'
name|'rt'
...
nl|'\n'
nl|'\n'
DECL|function|_update_compute_node
dedent|''
dedent|''
name|'def'
name|'_update_compute_node'
