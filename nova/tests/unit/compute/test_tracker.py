...
nl|'\n'
comment|'#                 passed to _update() like all the other'
nl|'\n'
comment|'#                 resources are. Instead, _update()'
nl|'\n'
...
op|'}'
newline|'\n'
comment|'# We need to do this because _update() actually modifies'
nl|'\n'
...
op|')'
newline|'\n'
comment|'# NOTE(pmurray): This will go away when the ComputeNode object is used'
nl|'\n'
name|'expected_resources'
op|'['
string|"'stats'"
...
string|"'fake-host'"
newline|'\n'
comment|'# pci_passthrough_devices should is not held in compute nodes'
nl|'\n'
name|'del'
name|'expected_resources'
op|'['
