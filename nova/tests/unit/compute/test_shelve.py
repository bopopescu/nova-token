...
name|'patch'
op|'('
string|"'oslo_utils.timeutils.is_older_than'"
op|')'
newline|'\n'
...
name|'patch'
op|'('
string|"'oslo_utils.timeutils.parse_strtime'"
op|')'
newline|'\n'
DECL|member|test_shelved_poll_filters_task_state
name|'def'
name|'test_shelved_poll_filters_task_state'
op|'('
name|'self'
op|','
name|'mock_parse'
...
op|')'
newline|'\n'
DECL|member|test_shelved_poll_checks_task_state_on_save
name|'def'
name|'test_shelved_poll_checks_task_state_on_save'
op|'('
name|'self'
op|','
name|'mock_parse'
...
newline|'\n'
nl|'\n'
DECL|function|fake_parse_hook
name|'def'
name|'fake_parse_hook'
op|'('
name|'timestring'
op|')'
op|':'
