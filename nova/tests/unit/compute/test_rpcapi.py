...
name|'patch'
op|'('
string|"'nova.objects.migrate_data.LiveMigrateData.from_legacy_dict'"
op|')'
newline|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|test_check_can_live_migrate_destination_old_compute
dedent|''
name|'def'
name|'test_check_can_live_migrate_destination_old_compute'
op|'('
name|'self'
op|')'
op|':'
