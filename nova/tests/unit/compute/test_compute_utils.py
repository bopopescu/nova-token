...
op|':'
newline|'\n'
DECL|member|test_exception_to_dict_with_long_message
indent|'    '
name|'def'
name|'test_exception_to_dict_with_long_message'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
comment|'# Generate Russian byte message whose length is 300'
nl|'\n'
indent|'        '
name|'msg'
op|'='
