...
op|')'
newline|'\n'
DECL|member|test_get_image_meta_with_image_id_none
name|'def'
name|'test_get_image_meta_with_image_id_none'
op|'('
name|'self'
op|','
name|'mock_flavor_get'
op|')'
op|':'
newline|'\n'
indent|'        '
...
name|'utils'
op|','
string|'"get_system_metadata_from_image"'
nl|'\n'
op|')'
name|'as'
name|'mock_get_sys_metadata'
op|':'
newline|'\n'
indent|'                '
name|'image_meta'
...
newline|'\n'
nl|'\n'
comment|'# Checking mock_image_api_get is called with 0 image_id'
nl|'\n'
comment|'# as 0 is a valid image ID'
nl|'\n'
dedent|''
dedent|''
name|'image_meta'
...
newline|'\n'
nl|'\n'
DECL|member|_test_get_image_meta_exception
dedent|''
name|'def'
name|'_test_get_image_meta_exception'
op|'('
name|'self'
op|','
name|'error'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_image_meta_not_authorized
dedent|''
name|'def'
name|'test_get_image_meta_not_authorized'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_image_meta_bad_request
dedent|''
name|'def'
name|'test_get_image_meta_bad_request'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_image_meta_unexpected_exception
dedent|''
name|'def'
name|'test_get_image_meta_unexpected_exception'
op|'('
name|'self'
op|')'
op|':'
