...
nl|'\n'
nl|'\n'
DECL|class|ComputeUtilsMigrationTestCase
dedent|''
dedent|''
name|'class'
name|'ComputeUtilsMigrationTestCase'
op|'('
name|'test'
op|'.'
name|'TestCase'
...
newline|'\n'
nl|'\n'
DECL|member|_test_get_resources
dedent|''
name|'def'
name|'_test_get_resources'
op|'('
name|'self'
op|')'
op|':'
...
op|')'
newline|'\n'
DECL|member|test_get_inst_attrs_from_migration
name|'def'
name|'test_get_inst_attrs_from_migration'
op|'('
name|'self'
op|','
name|'mock_get_flavor'
...
op|')'
newline|'\n'
DECL|member|test_get_inst_attrs_from_migration_flavor_not_found
name|'def'
name|'test_get_inst_attrs_from_migration_flavor_not_found'
op|'('
nl|'\n'
name|'self'
op|','
