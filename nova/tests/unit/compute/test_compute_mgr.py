...
newline|'\n'
nl|'\n'
DECL|member|_make_compute_node
dedent|''
name|'def'
...
op|')'
newline|'\n'
DECL|member|test_update_available_resource_for_node
name|'def'
name|'test_update_available_resource_for_node'
op|'('
nl|'\n'
name|'self'
op|','
...
name|'compute'
op|'.'
name|'update_available_resource_for_node'
op|'('
name|'self'
op|'.'
name|'context'
...
newline|'\n'
nl|'\n'
comment|'# Update ComputeHostNotFound'
nl|'\n'
name|'self'
op|'.'
name|'compute'
...
op|')'
newline|'\n'
DECL|member|test_init_instance_complete_partial_deletion
name|'def'
name|'test_init_instance_complete_partial_deletion'
op|'('
nl|'\n'
name|'self'
op|','
...
op|','
nl|'\n'
name|'mock_inst_destroy'
op|','
name|'mock_obj_load_attr'
op|','
name|'mock_get_by_instance_uuid'
op|','
nl|'\n'
name|'mock_bdm_destroy'
op|')'
op|':'
newline|'\n'
indent|'        '
string|'"""Test to complete deletion for instances in DELETED status but not\n        marked as deleted in the DB\n        """'
newline|'\n'
name|'instance'
op|'='
name|'fake_instance'
...
newline|'\n'
nl|'\n'
comment|"# Make sure instance vm_state is marked as 'DELETED' but instance is"
nl|'\n'
comment|'# not destroyed from db.'
nl|'\n'
name|'self'
op|'.'
name|'assertEqual'
...
newline|'\n'
nl|'\n'
DECL|function|fake_inst_destroy
name|'def'
name|'fake_inst_destroy'
op|'('
op|')'
op|':'
newline|'\n'
...
newline|'\n'
nl|'\n'
comment|'# Make sure that instance.destroy method was called and'
nl|'\n'
comment|'# instance was deleted from db.'
nl|'\n'
name|'self'
op|'.'
name|'assertTrue'
...
op|')'
newline|'\n'
DECL|member|test_init_instance_complete_partial_deletion_raises_exception
name|'def'
name|'test_init_instance_complete_partial_deletion_raises_exception'
op|'('
nl|'\n'
name|'self'
op|','
...
name|'msg'
op|'='
string|"u'Failed to complete a deletion'"
newline|'\n'
name|'mock_log'
op|'.'
name|'exception'
...
name|'patch'
op|'('
string|"'nova.virt.fake.FakeDriver.get_volume_connector'"
op|')'
newline|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|test_shutdown_instance_other_exception
dedent|''
name|'def'
name|'test_shutdown_instance_other_exception'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_init_instance_retries_reboot_pending_soft_became_hard
dedent|''
dedent|''
name|'def'
name|'test_init_instance_retries_reboot_pending_soft_became_hard'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
comment|'# Short circuit DB call, get_by_filters should not be called'
nl|'\n'
dedent|''
name|'self'
op|'.'
...
op|')'
newline|'\n'
DECL|member|_test_cleanup_incomplete_migrations
name|'def'
name|'_test_cleanup_incomplete_migrations'
op|'('
name|'self'
op|','
name|'inst_host'
op|','
nl|'\n'
name|'mock_inst_get_by_filters'
op|','
nl|'\n'
name|'mock_migration_get_by_filters'
op|','
nl|'\n'
name|'mock_save'
op|','
...
newline|'\n'
nl|'\n'
comment|"# Ensure that migration status is set to 'failed' after instance"
nl|'\n'
comment|'# files deletion for those instances whose instance.host is not'
nl|'\n'
comment|'# same as compute host where periodic task is running.'
nl|'\n'
dedent|''
name|'for'
name|'inst'
...
newline|'\n'
nl|'\n'
comment|'# Make sure we filtered the instances by host in the DB query.'
nl|'\n'
dedent|''
dedent|''
dedent|''
...
newline|'\n'
nl|'\n'
DECL|member|test_cleanup_incomplete_migrations_dest_node
dedent|''
name|'def'
name|'test_cleanup_incomplete_migrations_dest_node'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_cleanup_incomplete_migrations_source_node
dedent|''
name|'def'
name|'test_cleanup_incomplete_migrations_source_node'
op|'('
name|'self'
op|')'
op|':'
...
op|','
nl|'\n'
name|'supports_attach_interface'
op|'='
name|'True'
op|')'
op|':'
...
string|"'nova.db.'"
nl|'\n'
string|"'block_device_mapping_get_by_instance_and_volume_id'"
op|','
nl|'\n'
name|'lambda'
name|'x'
...
name|'patch'
op|'('
string|"'nova.db.block_device_mapping_get_by_instance_and_volume_id'"
op|')'
newline|'\n'
op|'@'
name|'mock'
...
name|'patch'
op|'('
string|"'nova.virt.libvirt.LibvirtDriver.get_volume_connector'"
op|')'
newline|'\n'
op|'@'
name|'mock'
...
name|'patch'
op|'('
string|"'nova.compute.manager.ComputeManager._swap_volume'"
op|')'
newline|'\n'
DECL|member|test_swap_volume_delete_on_termination_flag
name|'def'
name|'test_swap_volume_delete_on_termination_flag'
op|'('
name|'self'
op|','
name|'swap_volume_mock'
op|','
nl|'\n'
name|'volume_connector_mock'
op|','
nl|'\n'
name|'get_volume_mock'
op|','
nl|'\n'
name|'update_bdm_mock'
op|','
nl|'\n'
name|'get_bdm_mock'
op|')'
op|':'
newline|'\n'
comment|'# This test ensures that delete_on_termination flag arguments'
nl|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|test_can_live_migrate_source_for_cinder_client_exception
dedent|''
name|'def'
name|'test_can_live_migrate_source_for_cinder_client_exception'
op|'('
name|'self'
op|')'
op|':'
...
name|'do_test'
op|'('
name|'mock_block_info'
op|','
name|'mock_volume_backed'
op|','
nl|'\n'
name|'mock_inst_fault'
op|','
name|'mock_event'
op|')'
op|':'
...
op|')'
newline|'\n'
comment|'# call it again to make sure we handle that gracefully'
nl|'\n'
name|'self'
op|'.'
name|'compute'
...
newline|'\n'
nl|'\n'
DECL|member|test_detach_volume_evacuate
dedent|''
dedent|''
dedent|''
dedent|''
name|'def'
name|'test_detach_volume_evacuate'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
indent|'        '
string|'"""For evacuate, terminate_connection is called with original host."""'
newline|'\n'
name|'expected_connector'
op|'='
op|'{'
string|"'host'"
op|':'
string|"'evacuated-host'"
op|'}'
newline|'\n'
name|'conn_info_str'
op|'='
string|'\'{"connector": {"host": "evacuated-host"}}\''
newline|'\n'
name|'self'
op|'.'
name|'_test_detach_volume_evacuate'
op|'('
name|'conn_info_str'
op|','
nl|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|test_detach_volume_evacuate_legacy
dedent|''
name|'def'
name|'test_detach_volume_evacuate_legacy'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_detach_volume_evacuate_mismatch
dedent|''
name|'def'
name|'test_detach_volume_evacuate_mismatch'
op|'('
name|'self'
op|')'
op|':'
...
op|')'
newline|'\n'
DECL|member|_test_detach_volume_evacuate
name|'def'
name|'_test_detach_volume_evacuate'
op|'('
name|'self'
...
newline|'\n'
nl|'\n'
DECL|member|test__driver_detach_volume_return
dedent|''
dedent|''
dedent|''
name|'def'
name|'test__driver_detach_volume_return'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
indent|'        '
string|'"""_driver_detach_volume returns the connection_info from loads()."""'
newline|'\n'
name|'with'
name|'mock'
op|'.'
...
name|'conn_info_str'
op|'='
string|"'test-expected-loads-param'"
newline|'\n'
name|'bdm'
op|'='
name|'mock'
...
op|'='
op|'{'
string|"'test-loads-key'"
op|':'
string|"'test loads return value'"
op|'}'
newline|'\n'
name|'instance'
op|'='
...
op|')'
newline|'\n'
comment|'# Consider the migration successful'
nl|'\n'
name|'migration'
op|'.'
name|'status'
...
newline|'\n'
nl|'\n'
DECL|member|_test_rebuild_ex
dedent|''
name|'def'
name|'_test_rebuild_ex'
op|'('
name|'self'
op|','
name|'instance'
...
op|':'
newline|'\n'
comment|'# Test that we do not raise on certain exceptions'
nl|'\n'
indent|'        '
name|'with'
name|'test'
...
newline|'\n'
nl|'\n'
DECL|member|test_rebuild_deleting
dedent|''
dedent|''
name|'def'
name|'test_rebuild_deleting'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_rebuild_notfound
dedent|''
name|'def'
name|'test_rebuild_notfound'
op|'('
name|'self'
op|')'
op|':'
...
nl|'\n'
comment|'# the future, so what last_refreshed is irrelevant.'
nl|'\n'
name|'bw_usage_update'
op|'.'
name|'assert_called_once_with'
...
newline|'\n'
nl|'\n'
DECL|member|test_reset_reloads_rpcapi
dedent|''
dedent|''
name|'def'
name|'test_reset_reloads_rpcapi'
op|'('
name|'self'
op|')'
op|':'
...
name|'patch'
op|'('
string|"'nova.compute.manager.ComputeManager._delete_instance'"
op|')'
newline|'\n'
DECL|member|test_terminate_instance_no_bdm_volume_id
name|'def'
name|'test_terminate_instance_no_bdm_volume_id'
op|'('
name|'self'
op|','
name|'mock_delete_instance'
op|','
nl|'\n'
name|'mock_bdm_get_by_inst'
op|')'
op|':'
newline|'\n'
comment|'# Tests that we refresh the bdm list if a volume bdm does not have the'
nl|'\n'
comment|'# volume_id set.'
nl|'\n'
indent|'        '
name|'instance'
op|'='
...
op|')'
newline|'\n'
comment|"# since the bdms passed in don't have a volume_id, we'll go back to the"
nl|'\n'
comment|'# database looking for updated versions'
nl|'\n'
name|'mock_bdm_get_by_inst'
op|'.'
name|'return_value'
...
name|'self'
op|'.'
name|'_test_build_and_run_instance'
op|'('
op|')'
newline|'\n'
nl|'\n'
DECL|member|test_build_and_run_instance_with_unlimited_max_concurrent_builds
dedent|''
name|'def'
name|'test_build_and_run_instance_with_unlimited_max_concurrent_builds'
op|'('
name|'self'
op|')'
op|':'
...
op|')'
newline|'\n'
DECL|member|_test_build_and_run_instance
name|'def'
name|'_test_build_and_run_instance'
op|'('
name|'self'
...
op|')'
newline|'\n'
DECL|member|test_rescheduled_exception_with_sriov_network_allocated
name|'def'
name|'test_rescheduled_exception_with_sriov_network_allocated'
op|'('
name|'self'
op|','
nl|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|test_build_and_run_flavor_disk_smaller_image_exception
dedent|''
name|'def'
name|'test_build_and_run_flavor_disk_smaller_image_exception'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_build_and_run_flavor_disk_smaller_min_disk
dedent|''
name|'def'
name|'test_build_and_run_flavor_disk_smaller_min_disk'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_build_and_run_invalid_disk_info_exception
dedent|''
name|'def'
name|'test_build_and_run_invalid_disk_info_exception'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_access_ip_set_when_instance_set_to_active
dedent|''
dedent|''
name|'def'
name|'test_access_ip_set_when_instance_set_to_active'
op|'('
name|'self'
op|')'
op|':'
...
name|'db'
op|','
string|"'instance_extra_update_by_uuid'"
op|')'
newline|'\n'
op|'@'
name|'mock'
...
op|')'
newline|'\n'
DECL|function|_check_access_ip
name|'def'
name|'_check_access_ip'
op|'('
name|'mock_notify'
op|','
name|'mock_extra'
...
name|'instance'
op|','
string|"'revert_migration_context'"
op|')'
newline|'\n'
op|'@'
name|'mock'
...
newline|'\n'
nl|'\n'
DECL|member|test_check_migrate_source_converts_object
dedent|''
name|'def'
name|'test_check_migrate_source_converts_object'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
comment|'# NOTE(danms): Make sure that we legacy-ify any data objects'
nl|'\n'
comment|'# the drivers give us back, if we were passed a non-object'
nl|'\n'
indent|'        '
name|'data'
op|'='
...
newline|'\n'
nl|'\n'
DECL|member|test_pre_live_migration_handles_dict
dedent|''
name|'def'
name|'test_pre_live_migration_handles_dict'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_live_migration_handles_dict
dedent|''
name|'def'
name|'test_live_migration_handles_dict'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_rollback_live_migration_handles_dict
dedent|''
name|'def'
name|'test_rollback_live_migration_handles_dict'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_live_migration_force_complete_succeeded
dedent|''
name|'def'
name|'test_live_migration_force_complete_succeeded'
op|'('
name|'self'
op|')'
op|':'
...
op|','
nl|'\n'
string|"'live.migration.force.complete.start'"
op|')'
op|','
nl|'\n'
name|'mock'
...
op|','
nl|'\n'
string|"'live.migration.force.complete.end'"
op|')'
nl|'\n'
op|']'
newline|'\n'
...
op|')'
newline|'\n'
DECL|member|test_live_migration_pause_vm_invalid_migration_state
name|'def'
name|'test_live_migration_pause_vm_invalid_migration_state'
op|'('
nl|'\n'
name|'self'
op|','
...
newline|'\n'
nl|'\n'
DECL|member|test_post_live_migration_at_destination_success
dedent|''
name|'def'
name|'test_post_live_migration_at_destination_success'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_post_live_migration_at_destination_compute_not_found
dedent|''
name|'def'
name|'test_post_live_migration_at_destination_compute_not_found'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_post_live_migration_at_destination_unexpected_exception
dedent|''
name|'def'
name|'test_post_live_migration_at_destination_unexpected_exception'
op|'('
name|'self'
op|')'
op|':'
...
op|','
nl|'\n'
string|"'live.migration.abort.start'"
op|')'
op|','
nl|'\n'
name|'mock'
...
op|','
nl|'\n'
string|"'live.migration.abort.end'"
op|')'
op|']'
newline|'\n'
nl|'\n'
...
op|')'
newline|'\n'
DECL|member|test_live_migration_abort_not_supported
name|'def'
name|'test_live_migration_abort_not_supported'
op|'('
name|'self'
op|','
nl|'\n'
...
op|')'
newline|'\n'
DECL|member|test_live_migration_abort_wrong_migration_state
name|'def'
name|'test_live_migration_abort_wrong_migration_state'
op|'('
name|'self'
op|','
nl|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|test_live_migration_cleanup_flags_block_migrate_libvirt
dedent|''
name|'def'
name|'test_live_migration_cleanup_flags_block_migrate_libvirt'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_live_migration_cleanup_flags_shared_block_libvirt
dedent|''
name|'def'
name|'test_live_migration_cleanup_flags_shared_block_libvirt'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_live_migration_cleanup_flags_shared_path_libvirt
dedent|''
name|'def'
name|'test_live_migration_cleanup_flags_shared_path_libvirt'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_live_migration_cleanup_flags_shared_libvirt
dedent|''
name|'def'
name|'test_live_migration_cleanup_flags_shared_libvirt'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_live_migration_cleanup_flags_block_migrate_xenapi
dedent|''
name|'def'
name|'test_live_migration_cleanup_flags_block_migrate_xenapi'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_live_migration_cleanup_flags_live_migrate_xenapi
dedent|''
name|'def'
name|'test_live_migration_cleanup_flags_live_migrate_xenapi'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_live_migration_cleanup_flags_live_migrate
dedent|''
name|'def'
name|'test_live_migration_cleanup_flags_live_migrate'
op|'('
name|'self'
op|')'
op|':'
...
nl|'\n'
nl|'\n'
DECL|class|ComputeManagerInstanceUsageAuditTestCase
dedent|''
dedent|''
name|'class'
name|'ComputeManagerInstanceUsageAuditTestCase'
op|'('
name|'test'
op|'.'
name|'TestCase'
...
name|'patch'
op|'('
string|"'nova.objects.TaskLog'"
op|')'
newline|'\n'
DECL|member|test_deleted_instance
name|'def'
name|'test_deleted_instance'
op|'('
name|'self'
op|','
name|'mock_task_log'
...
newline|'\n'
nl|'\n'
comment|'# fudge beginning and ending time by a second (backwards and forwards,'
nl|'\n'
comment|"# respectively) so they differ from the instance's launch and"
nl|'\n'
comment|'# termination times when sub-seconds are truncated and fall within the'
nl|'\n'
...
name|'stub_out'
op|'('
string|"'nova.utils.last_completed_audit_period'"
op|','
nl|'\n'
name|'fake_last_completed_audit_period'
op|')'
...
op|','
nl|'\n'
string|"'the deleted test instance was not found in the audit'"
nl|'\n'
string|"' period'"
op|')'
newline|'\n'
...
op|','
nl|'\n'
string|"'an error was encountered processing the deleted test'"
nl|'\n'
string|"' instance'"
op|')'
newline|'\n'
