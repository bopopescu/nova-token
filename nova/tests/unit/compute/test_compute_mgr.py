...
name|'patch'
op|'('
string|"'nova.virt.fake.SmallFakeDriver.get_volume_connector'"
op|')'
newline|'\n'
op|'@'
name|'mock'
...
op|')'
newline|'\n'
DECL|member|test_shutdown_instance_no_bdm_volume_id
name|'def'
name|'test_shutdown_instance_no_bdm_volume_id'
op|'('
name|'self'
op|','
name|'mock_terminate'
...
nl|'\n'
comment|'# database looking for updated versions which will be the same so we'
nl|'\n'
comment|'# get the warning'
nl|'\n'
name|'mock_bdm_get_by_inst'
op|'.'
name|'return_value'
