...
name|'patch'
op|'('
string|"'nova.compute.manager.ComputeManager._get_instances_on_driver'"
op|')'
newline|'\n'
DECL|member|test_evacuate_disabled
name|'def'
name|'test_evacuate_disabled'
op|'('
name|'self'
op|','
name|'mock_giod'
...
newline|'\n'
nl|'\n'
DECL|member|test_revert_resize_instance_destroy_disks
dedent|''
dedent|''
name|'def'
name|'test_revert_resize_instance_destroy_disks'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
comment|'# inform compute that this instance uses shared storage'
nl|'\n'
name|'_is_instance_storage_shared'
op|'.'
name|'return_value'
...
newline|'\n'
nl|'\n'
comment|'# since shared storage is used, we should not be instructed to'
nl|'\n'
comment|'# destroy disks here'
nl|'\n'
name|'destroy'
op|'.'
name|'assert_called_once_with'
