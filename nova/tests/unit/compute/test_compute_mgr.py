...
nl|'\n'
comment|"# the drivers give us back, until we're ready for them"
nl|'\n'
indent|'        '
name|'data'
op|'='
...
newline|'\n'
nl|'\n'
DECL|member|test_check_migrate_destination_converts_object
dedent|''
name|'def'
name|'test_check_migrate_destination_converts_object'
op|'('
name|'self'
op|')'
op|':'
