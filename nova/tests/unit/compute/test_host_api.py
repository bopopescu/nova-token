...
name|'_do_test'
op|'('
name|'mock_assert_host_exists'
op|','
name|'mock_set_host_enabled'
op|')'
op|':'
newline|'\n'
indent|'            '
...
op|','
name|'mock_service_get_by_compute_host'
op|')'
op|':'
newline|'\n'
indent|'            '
...
name|'mock_assert_host_exists'
op|','
name|'mock_host_maintenance_mode'
op|')'
op|':'
newline|'\n'
indent|'            '
...
name|'_do_test'
op|'('
name|'mock_service_update'
op|','
name|'mock_service_get_by_host_and_binary'
op|')'
op|':'
newline|'\n'
indent|'            '
