...
newline|'\n'
nl|'\n'
comment|'# Cells return services with full cell_path prepended to IDs'
nl|'\n'
name|'fake_service'
op|'='
name|'dict'
...
newline|'\n'
nl|'\n'
DECL|member|test_service_get_by_compute_host_with_compute_node
dedent|''
name|'def'
name|'test_service_get_by_compute_host_with_compute_node'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
comment|'# Cells return services and compute_nodes with full cell_path prepended'
nl|'\n'
comment|'# to IDs'
nl|'\n'
...
name|'id'
op|'='
string|"'region!child@1'"
op|')'
newline|'\n'
name|'exp_compute_node'
op|'='
name|'fake_compute_node'
op|'.'
name|'copy'
...
newline|'\n'
nl|'\n'
comment|'# NOTE: Testing equality of a compute node obj and dict requires'
nl|'\n'
comment|'# multiple comparator methods.  So here we just test that the proxy'
nl|'\n'
comment|"# object correctly replaces the 'id'."
nl|'\n'
name|'self'
op|'.'
name|'assertEqual'
...
op|'='
string|"'cell1@42'"
comment|'# Cells prepend full cell path to ID'
newline|'\n'
nl|'\n'
name|'update_result'
op|'='
