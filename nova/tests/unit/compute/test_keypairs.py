...
newline|'\n'
nl|'\n'
DECL|member|assertKeypairRaises
name|'def'
name|'assertKeypairRaises'
op|'('
name|'self'
op|','
name|'exc_class'
...
newline|'\n'
nl|'\n'
DECL|member|test_success_ssh
dedent|''
name|'def'
name|'test_success_ssh'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_success_x509
dedent|''
name|'def'
name|'test_success_x509'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_x509_subject_too_long
dedent|''
name|'def'
name|'test_x509_subject_too_long'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
comment|"# X509 keypairs will fail if the Subject they're created with"
nl|'\n'
comment|'# is longer than 64 characters. The previous unit tests could not'
nl|'\n'
comment|'# detect the issue because the ctxt.user_id was too short.'
nl|'\n'
comment|'# This unit tests is added to prove this issue.'
nl|'\n'
indent|'        '
name|'self'
op|'.'
