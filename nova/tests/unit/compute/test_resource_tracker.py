...
name|'stub_out'
op|'('
string|"'nova.db.compute_node_get_by_host_and_nodename'"
op|','
nl|'\n'
name|'self'
op|'.'
...
newline|'\n'
nl|'\n'
DECL|member|_fake_compute_node_get
dedent|''
name|'def'
name|'_fake_compute_node_get'
op|'('
...
name|'stub_out'
op|'('
string|"'nova.db.migration_get_in_progress_by_host_and_node'"
op|','
nl|'\n'
name|'self'
op|'.'
...
name|'stub_out'
op|'('
string|"'nova.objects.resource_provider._create_inventory_in_db'"
op|','
nl|'\n'
name|'self'
op|'.'
name|'_fake_inventory_create'
op|')'
newline|'\n'
name|'self'
op|'.'
name|'stub_out'
op|'('
string|"'nova.objects.resource_provider._create_rp_in_db'"
op|','
nl|'\n'
name|'self'
op|'.'
name|'_fake_rp_create'
op|')'
newline|'\n'
nl|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|_fake_inventory_create
dedent|''
name|'def'
name|'_fake_inventory_create'
op|'('
...
newline|'\n'
nl|'\n'
DECL|member|test_unset_instance_host_and_node
dedent|''
name|'def'
name|'test_unset_instance_host_and_node'
op|'('
name|'self'
op|')'
op|':'
...
name|'tracker'
op|','
string|"'_pair_instances_to_migrations'"
nl|'\n'
op|')'
name|'as'
name|'mock_pair'
...
newline|'\n'
nl|'\n'
DECL|member|test_pair_instances_to_migrations
dedent|''
name|'def'
name|'test_pair_instances_to_migrations'
op|'('
name|'self'
op|')'
op|':'
...
name|'patch'
op|'('
string|"'nova.objects.ComputeNode._create_inventory'"
op|')'
newline|'\n'
DECL|member|test_additive_claims
name|'def'
