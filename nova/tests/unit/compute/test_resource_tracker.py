...
op|':'
newline|'\n'
comment|'# NOTE(danms): Remove this when all the compute_node stuff is'
nl|'\n'
comment|'# converted to objects'
nl|'\n'
nl|'\n'
...
newline|'\n'
nl|'\n'
comment|'# NOTE(danms): PciDeviceStats only supports iteration, so we have to'
nl|'\n'
comment|'# listify it before we can examine the contents by index.'
nl|'\n'
name|'pools'
op|'='
name|'list'
