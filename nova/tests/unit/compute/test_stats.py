...
newline|'\n'
nl|'\n'
DECL|member|test_update_stats_for_instance_offloaded
dedent|''
name|'def'
name|'test_update_stats_for_instance_offloaded'
op|'('
name|'self'
op|')'
op|':'
