...
op|':'
newline|'\n'
comment|'# NOTE(tojuvone) Some test cases break utcnow() by calling'
nl|'\n'
comment|'# timeutils.set_time_override() with some own time. Have to issue a'
nl|'\n'
comment|'# bug to fix those cases to reset time back like line below so next'
nl|'\n'
comment|'# test cases will work.'
nl|'\n'
indent|'        '
name|'timeutils'
op|'.'
