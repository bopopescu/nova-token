...
newline|'\n'
nl|'\n'
DECL|member|test_delete_forced_when_task_state_deleting
dedent|''
dedent|''
name|'def'
name|'test_delete_forced_when_task_state_deleting'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_no_delete_when_task_state_deleting
dedent|''
dedent|''
name|'def'
name|'test_no_delete_when_task_state_deleting'
op|'('
name|'self'
op|')'
op|':'
...
op|':'
newline|'\n'
comment|"# In 'api' cell, the callback terminate_instance will"
nl|'\n'
comment|'# get called, and quota will be committed before returning.'
nl|'\n'
comment|"# It doesn't check for below condition, hence skipping the test."
nl|'\n'
indent|'            '
...
name|'skipTest'
op|'('
string|'"API cell doesn\'t delete instance directly."'
op|')'
newline|'\n'
nl|'\n'
dedent|''
...
op|':'
newline|'\n'
comment|'# when instance in SHELVED_OFFLOADED state, we assume the'
nl|'\n'
comment|'# instance cannot be in deleting task state, this is same to'
nl|'\n'
comment|'# the case that instance.host is down, deleting locally.'
nl|'\n'
indent|'                '
name|'continue'
newline|'\n'
...
newline|'\n'
nl|'\n'
comment|'# Check that the mappgins from the image properties are included'
nl|'\n'
name|'self'
op|'.'
name|'compute_api'
