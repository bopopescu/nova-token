...
newline|'\n'
nl|'\n'
DECL|member|_obj_to_list_obj
dedent|''
name|'def'
name|'_obj_to_list_obj'
op|'('
name|'self'
op|','
name|'list_obj'
...
newline|'\n'
nl|'\n'
DECL|member|_test_create_max_net_count
dedent|''
dedent|''
dedent|''
name|'def'
name|'_test_create_max_net_count'
op|'('
name|'self'
op|','
name|'max_net_count'
...
op|','
nl|'\n'
name|'check_auto_disk_config'
op|','
nl|'\n'
name|'validate_and_build_base_options'
nl|'\n'
op|')'
op|':'
newline|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|test_max_net_count_zero
dedent|''
dedent|''
name|'def'
name|'test_max_net_count_zero'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
comment|'# Test when max_net_count is zero.'
nl|'\n'
indent|'        '
name|'max_net_count'
op|'='
...
newline|'\n'
nl|'\n'
DECL|member|test_max_net_count_less_than_min_count
dedent|''
name|'def'
name|'test_max_net_count_less_than_min_count'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
comment|'# Test when max_net_count is nonzero but less than min_count.'
nl|'\n'
indent|'        '
name|'max_net_count'
op|'='
...
op|')'
newline|'\n'
DECL|member|test_create_volume_bdm_call_reserve_dev_name
name|'def'
name|'test_create_volume_bdm_call_reserve_dev_name'
op|'('
name|'self'
op|','
name|'mock_reserve'
...
op|')'
newline|'\n'
DECL|member|test_create_volume_bdm_local_creation
name|'def'
name|'test_create_volume_bdm_local_creation'
op|'('
name|'self'
op|','
name|'bdm_create'
...
op|')'
newline|'\n'
DECL|member|test_attach_volume_reserve_fails
name|'def'
name|'test_attach_volume_reserve_fails'
op|'('
name|'self'
op|','
name|'mock_attach'
...
name|'patch'
op|'('
string|"'nova.compute.rpcapi.ComputeAPI.trigger_crash_dump'"
op|')'
newline|'\n'
...
op|':'
newline|'\n'
comment|'# cell api has not been implemented.'
nl|'\n'
indent|'            '
name|'pass'
newline|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|test_trigger_crash_dump_invalid_state
dedent|''
name|'def'
name|'test_trigger_crash_dump_invalid_state'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_trigger_crash_dump_no_host
dedent|''
name|'def'
name|'test_trigger_crash_dump_no_host'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_trigger_crash_dump_locked
dedent|''
name|'def'
name|'test_trigger_crash_dump_locked'
op|'('
name|'self'
op|')'
op|':'
...
name|'compute_api'
op|'.'
name|'_local_cleanup_bdm_volumes'
op|'('
op|'['
op|']'
op|','
...
op|')'
newline|'\n'
DECL|member|test_resize_quota_exceeds_fails_instance
name|'def'
name|'test_resize_quota_exceeds_fails_instance'
op|'('
name|'self'
op|','
name|'mock_reserve'
...
op|')'
newline|'\n'
DECL|member|test_live_migrate_messaging_timeout
name|'def'
name|'test_live_migrate_messaging_timeout'
op|'('
name|'self'
op|','
name|'_save'
...
newline|'\n'
nl|'\n'
comment|'# Check that the mappings from the image properties are not included'
nl|'\n'
name|'self'
op|'.'
name|'compute_api'
...
newline|'\n'
nl|'\n'
DECL|member|test_snapshot_volume_backed_with_quiesce_suspended
dedent|''
name|'def'
name|'test_snapshot_volume_backed_with_quiesce_suspended'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_snapshot_volume_backed_with_suspended
dedent|''
name|'def'
name|'test_snapshot_volume_backed_with_suspended'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_provision_instances_creates_request_spec
dedent|''
name|'def'
name|'test_provision_instances_creates_request_spec'
op|'('
name|'self'
op|')'
op|':'
...
name|'compute_api'
op|','
string|"'_check_num_instances_quota'"
op|')'
newline|'\n'
op|'@'
name|'mock'
...
name|'compute_api'
op|','
string|"'_create_block_device_mapping'"
op|')'
newline|'\n'
op|'@'
name|'mock'
...
name|'do_test'
op|'('
name|'_mock_inst_mapping_create'
op|','
name|'_mock_build_req'
op|','
nl|'\n'
name|'mock_req_spec_from_components'
op|','
name|'_mock_create_bdm'
op|','
nl|'\n'
name|'_mock_validate_bdm'
op|','
name|'_mock_ensure_default'
op|','
name|'_mock_create'
op|','
nl|'\n'
name|'mock_check_num_inst_quota'
op|')'
op|':'
newline|'\n'
indent|'            '
...
name|'patch'
op|'('
string|"'nova.objects.RequestSpec.from_components'"
op|')'
newline|'\n'
op|'@'
name|'mock'
...
name|'patch'
op|'('
string|"'nova.objects.InstanceMapping.create'"
op|')'
newline|'\n'
DECL|member|test_provision_instances_with_keypair
name|'def'
name|'test_provision_instances_with_keypair'
op|'('
name|'self'
op|','
name|'mock_im'
...
newline|'\n'
nl|'\n'
DECL|member|test_provision_instances_creates_destroys_build_request
dedent|''
name|'def'
name|'test_provision_instances_creates_destroys_build_request'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_provision_instances_creates_instance_mapping
dedent|''
name|'def'
name|'test_provision_instances_creates_instance_mapping'
op|'('
name|'self'
op|')'
op|':'
...
name|'patch'
op|'('
string|"'nova.objects.InstanceMapping'"
op|')'
newline|'\n'
DECL|function|do_test
name|'def'
...
newline|'\n'
nl|'\n'
DECL|member|test_check_and_transform_bdm_source_volume
dedent|''
name|'def'
name|'test_check_and_transform_bdm_source_volume'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_check_and_transform_bdm_source_snapshot
dedent|''
name|'def'
name|'test_check_and_transform_bdm_source_snapshot'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_metadata_invalid_return_empty_object
dedent|''
name|'def'
name|'test_metadata_invalid_return_empty_object'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_metadata_invalid_return_empty_list
dedent|''
name|'def'
name|'test_metadata_invalid_return_empty_list'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_populate_instance_names_host_name
dedent|''
name|'def'
name|'test_populate_instance_names_host_name'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_populate_instance_names_host_name_is_empty
dedent|''
name|'def'
name|'test_populate_instance_names_host_name_is_empty'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_populate_instance_names_host_name_multi
dedent|''
name|'def'
name|'test_populate_instance_names_host_name_multi'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_populate_instance_names_host_name_is_empty_multi
dedent|''
dedent|''
name|'def'
name|'test_populate_instance_names_host_name_is_empty_multi'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_host_statuses
dedent|''
dedent|''
name|'def'
name|'test_host_statuses'
op|'('
name|'self'
op|')'
op|':'
...
op|')'
newline|'\n'
DECL|member|test_live_migrate_force_complete_succeeded
name|'def'
name|'test_live_migrate_force_complete_succeeded'
op|'('
nl|'\n'
name|'self'
op|','
...
op|')'
newline|'\n'
DECL|member|test_live_migrate_force_complete_invalid_migration_state
name|'def'
name|'test_live_migrate_force_complete_invalid_migration_state'
op|'('
nl|'\n'
name|'self'
op|','
...
newline|'\n'
nl|'\n'
DECL|member|test_live_migrate_force_complete_invalid_vm_state
dedent|''
name|'def'
name|'test_live_migrate_force_complete_invalid_vm_state'
op|'('
name|'self'
op|')'
op|':'
...
op|')'
newline|'\n'
DECL|member|test_live_migrate_abort_succeeded
name|'def'
name|'test_live_migrate_abort_succeeded'
op|'('
name|'self'
op|','
nl|'\n'
name|'mock_get_migration'
op|','
nl|'\n'
name|'mock_lm_abort'
op|','
nl|'\n'
name|'mock_rec_action'
op|')'
op|':'
newline|'\n'
indent|'        '
...
op|')'
newline|'\n'
DECL|member|test_live_migration_abort_wrong_migration_status
name|'def'
name|'test_live_migration_abort_wrong_migration_status'
op|'('
name|'self'
op|','
nl|'\n'
...
op|')'
newline|'\n'
comment|"# In the cells rpcapi there isn't the call for the"
nl|'\n'
comment|'# reserve_block_device_name so the volume_bdm returned'
nl|'\n'
comment|'# by the _create_volume_bdm is None'
nl|'\n'
name|'result'
op|'='
name|'self'
...
name|'skipTest'
op|'('
string|'"Reserve is never done in the API cell."'
op|')'
newline|'\n'
nl|'\n'
nl|'\n'
...
name|'patch'
op|'('
string|"'nova.objects.security_group.make_secgroup_list'"
op|')'
newline|'\n'
