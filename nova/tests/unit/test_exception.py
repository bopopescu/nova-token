...
name|'msg_fmt'
op|'='
string|'"default message: %(misspelled_code)s"'
newline|'\n'
nl|'\n'
dedent|''
name|'exc'
...
nl|'\n'
nl|'\n'
DECL|class|ConvertedExceptionTestCase
dedent|''
dedent|''
name|'class'
name|'ConvertedExceptionTestCase'
op|'('
name|'test'
op|'.'
name|'NoDBTestCase'
...
newline|'\n'
nl|'\n'
DECL|member|test_instantiate_without_title_known_code
dedent|''
name|'def'
name|'test_instantiate_without_title_known_code'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_instantiate_without_title_unknown_code
dedent|''
name|'def'
name|'test_instantiate_without_title_unknown_code'
op|'('
name|'self'
op|')'
op|':'
...
name|'title'
op|','
string|"'Unknown Client Error'"
op|')'
newline|'\n'
nl|'\n'
DECL|member|test_instantiate_bad_code
dedent|''
name|'def'
name|'test_instantiate_bad_code'
op|'('
name|'self'
op|')'
op|':'
