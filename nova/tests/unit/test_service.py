...
op|':'
newline|'\n'
comment|'# Test if a Service object is correctly represented, for example in'
nl|'\n'
comment|'# log files.'
nl|'\n'
indent|'        '
...
name|'exp'
op|'='
string|'"<Service: host=foo, binary=nova-fake, "'
string|'"manager_class_name=nova.tests.unit.test_service.FakeManager>"'
newline|'\n'
name|'self'
op|'.'
name|'assertEqual'
...
op|')'
newline|'\n'
DECL|member|test_start_updates_version
name|'def'
name|'test_start_updates_version'
op|'('
name|'self'
op|','
name|'mock_get_by_host_and_binary'
op|')'
op|':'
newline|'\n'
comment|'# test that the service version gets updated on services startup'
nl|'\n'
indent|'        '
name|'service_obj'
op|'='
...
newline|'\n'
nl|'\n'
comment|'# test service version got updated and saved:'
nl|'\n'
name|'service_obj'
op|'.'
name|'save'
...
op|')'
newline|'\n'
DECL|member|test_service_start_creates_record
name|'def'
name|'test_service_start_creates_record'
op|'('
name|'self'
op|','
name|'mock_create'
...
op|')'
newline|'\n'
DECL|member|test_service_start_does_not_create_record
name|'def'
name|'test_service_start_does_not_create_record'
op|'('
name|'self'
op|','
name|'mock_create'
