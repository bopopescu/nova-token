...
newline|'\n'
nl|'\n'
DECL|member|test_format_checker_failed_with_non_string
dedent|''
name|'def'
name|'test_format_checker_failed_with_non_string'
op|'('
name|'self'
op|')'
op|':'
...
name|'assertEqual'
op|'('
string|'"An invalid \'name\' value was provided. The name "'
nl|'\n'
string|'"must be: printable characters. "'
nl|'\n'
string|'"Can not start or end with whitespace."'
op|','
nl|'\n'
