...
op|'='
op|'('
string|'u"Invalid input for field/attribute foo. Value:  ."'
nl|'\n'
...
op|'='
op|'('
string|'"Invalid input for field/attribute foo. Value:  server."'
nl|'\n'
string|'" \' server\' does not match .*"'
op|')'
newline|'\n'
name|'self'
op|'.'
...
op|'='
op|'('
string|'"Invalid input for field/attribute foo. Value:  a."'
nl|'\n'
string|'" \' a\' does not match .*"'
op|')'
newline|'\n'
name|'self'
op|'.'
...
newline|'\n'
nl|'\n'
comment|'# NOTE(stpierre): Quoting for the unicode values in the error'
nl|'\n'
comment|'# messages below gets *really* messy, so we just wildcard it'
nl|'\n'
comment|"# out. (e.g., '.* does not match'). In practice, we don't"
nl|'\n'
comment|'# particularly care about that part of the error message.'
nl|'\n'
nl|'\n'
...
op|'='
op|'('
string|'u"Invalid input for field/attribute foo. Value: a\\xa0."'
nl|'\n'
string|"u' .* does not match .*'"
op|')'
newline|'\n'
name|'self'
op|'.'
...
string|'u"Invalid input for field/attribute foo. Value: "'
nl|'\n'
string|'u"\\U00010000. .* does not match .*"'
op|')'
newline|'\n'
name|'self'
op|'.'
