...
op|'='
string|"'nova.tests.unit.fake_volume.API'"
op|')'
newline|'\n'
name|'self'
op|'.'
...
newline|'\n'
nl|'\n'
comment|'# Stub out the notification service so we use the no-op serializer'
nl|'\n'
comment|'# and avoid lazy-load traces with the wrap_exception decorator in'
nl|'\n'
comment|'# the compute service.'
nl|'\n'
name|'fake_notifier'
op|'.'
name|'stub_notifier'
...
op|','
nl|'\n'
string|"'_delete_scheduler_instance_info'"
op|','
name|'dumb'
op|')'
newline|'\n'
...
op|','
nl|'\n'
string|"'_sync_scheduler_instance_info'"
op|','
name|'dumb'
op|')'
newline|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|test_describe_addresses_in_neutron
dedent|''
name|'def'
name|'test_describe_addresses_in_neutron'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
comment|'# There are no longer any pools since the last one was destroyed above'
nl|'\n'
name|'pools'
op|'='
name|'db'
...
newline|'\n'
nl|'\n'
DECL|member|test_delete_security_group_policy_not_allowed
dedent|''
name|'def'
name|'test_delete_security_group_policy_not_allowed'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_authorize_security_group_ingress_policy_not_allowed
dedent|''
dedent|''
name|'def'
name|'test_authorize_security_group_ingress_policy_not_allowed'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_revoke_security_group_ingress_policy_not_allowed
dedent|''
name|'def'
name|'test_revoke_security_group_ingress_policy_not_allowed'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|assertEqualSorted
dedent|''
name|'def'
name|'assertEqualSorted'
op|'('
name|'self'
op|','
name|'x'
...
newline|'\n'
nl|'\n'
DECL|member|test_describe_instances_with_filters_tags
dedent|''
name|'def'
name|'test_describe_instances_with_filters_tags'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|function|_normalize_reservation_set
name|'def'
name|'_normalize_reservation_set'
op|'('
...
newline|'\n'
nl|'\n'
DECL|function|_compare_reservation_set
dedent|''
dedent|''
dedent|''
name|'def'
name|'_compare_reservation_set'
op|'('
name|'expected'
op|','
name|'actual'
...
newline|'\n'
nl|'\n'
comment|'# Confirm deletion of tags'
nl|'\n'
comment|"# Check for format 'tag:'"
nl|'\n'
name|'self'
op|'.'
name|'cloud'
...
newline|'\n'
nl|'\n'
DECL|member|test_describe_instances_dnsName_set
dedent|''
name|'def'
name|'test_describe_instances_dnsName_set'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
comment|"# Verifies dnsName doesn't get set if floating IP is set."
nl|'\n'
indent|'        '
name|'self'
op|'.'
...
newline|'\n'
nl|'\n'
DECL|member|test_describe_instances_booting_from_a_volume
dedent|''
name|'def'
name|'test_describe_instances_booting_from_a_volume'
op|'('
name|'self'
op|')'
op|':'
...
op|','
nl|'\n'
string|"'_generate_key_pair'"
op|')'
name|'as'
name|'mock_generate_key_pair'
op|':'
newline|'\n'
indent|'            '
name|'mock_generate_key_pair'
...
newline|'\n'
nl|'\n'
DECL|member|test_run_instances_invalid_maxcount
dedent|''
name|'def'
name|'test_run_instances_invalid_maxcount'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_run_instances_invalid_mincount
dedent|''
name|'def'
name|'test_run_instances_invalid_mincount'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_run_instances_invalid_count
dedent|''
name|'def'
name|'test_run_instances_invalid_count'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_empty_reservation_id_from_token
dedent|''
name|'def'
name|'test_empty_reservation_id_from_token'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|function|fake_get_all_system_metadata
name|'def'
name|'fake_get_all_system_metadata'
op|'('
name|'context'
op|','
name|'search_filts'
...
name|'compute_api'
op|','
string|"'get_all_system_metadata'"
op|','
nl|'\n'
name|'fake_get_all_system_metadata'
op|')'
...
newline|'\n'
nl|'\n'
DECL|member|test_run_instances_idempotent
dedent|''
name|'def'
name|'test_run_instances_idempotent'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
comment|'# Ensure subsequent run_instances calls with same client token'
nl|'\n'
comment|'# are idempotent and that ones with different client_token are not'
nl|'\n'
nl|'\n'
indent|'        '
name|'kwargs'
...
newline|'\n'
nl|'\n'
comment|'# make sure terminated instances lose their client tokens'
nl|'\n'
name|'self'
op|'.'
name|'cloud'
...
newline|'\n'
nl|'\n'
DECL|member|test_start_instances_policy_failed
dedent|''
name|'def'
name|'test_start_instances_policy_failed'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_stop_instances_policy_failed
dedent|''
name|'def'
name|'test_stop_instances_policy_failed'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
indent|'        '
string|'"""Ensure CreateImage fails as expected for an instance-store-backed\n        instance\n        """'
newline|'\n'
comment|'# enforce periodic tasks run in short time to avoid wait for 60s.'
nl|'\n'
name|'self'
...
newline|'\n'
nl|'\n'
DECL|function|fake_ec2_instance_get_by_id
name|'def'
name|'fake_ec2_instance_get_by_id'
op|'('
name|'ctxt'
op|','
name|'int_id'
...
newline|'\n'
nl|'\n'
comment|'# NOTE(yamahata): create ami-3 ... ami-7'
nl|'\n'
...
newline|'\n'
nl|'\n'
comment|'# Multiple filters (AND): no match'
nl|'\n'
name|'tags'
op|'='
name|'self'
...
newline|'\n'
nl|'\n'
comment|'# Multiple filters (AND): match'
nl|'\n'
name|'tags'
op|'='
name|'self'
...
op|')'
newline|'\n'
DECL|member|test_detach_volume_unattched_error
name|'def'
name|'test_detach_volume_unattched_error'
op|'('
name|'self'
op|','
name|'mock_ec2_vol_id_to_uuid'
op|')'
op|':'
newline|'\n'
comment|"# Validates that VolumeUnattached is raised if the volume doesn't"
nl|'\n'
comment|'# have an instance_uuid value.'
nl|'\n'
indent|'        '
name|'ec2_volume_id'
op|'='
string|"'vol-987654321'"
newline|'\n'
nl|'\n'
name|'with'
name|'mock'
...
nl|'\n'
nl|'\n'
DECL|class|CloudTestCaseNeutronProxy
dedent|''
dedent|''
dedent|''
name|'class'
name|'CloudTestCaseNeutronProxy'
op|'('
name|'test'
op|'.'
name|'NoDBTestCase'
...
op|')'
newline|'\n'
comment|'# Get id from neutron since cloud.create_security_group'
nl|'\n'
...
nl|'\n'
nl|'\n'
DECL|class|FormatMappingTestCase
dedent|''
dedent|''
name|'class'
name|'FormatMappingTestCase'
op|'('
name|'test'
op|'.'
name|'NoDBTestCase'
...
newline|'\n'
indent|'        '
name|'id_to_ec2_snap_id_map'
op|'='
op|'{'
nl|'\n'
string|"'993b31ac-452e-4fed-b745-7718385f1811'"
op|':'
string|"'snap-00000001'"
op|','
nl|'\n'
string|"'b409a2de-1c79-46bf-aa7e-ebdb4bf427ef'"
op|':'
string|"'snap-00000002'"
op|','
nl|'\n'
...
string|"'checksum'"
op|':'
string|"'50bdc35edb03a38d91b1b071afb20a3c'"
op|','
nl|'\n'
string|"'min_ram'"
op|':'
...
string|"'image_name'"
op|':'
string|"'cirros-0.3.0-x86_64-disk'"
op|','
string|"'bdm_v2'"
op|':'
string|"'True'"
...
string|"'image_id'"
op|':'
string|"'4fce9db9-d89e-4eea-8d20-e2bae15292c1'"
op|','
nl|'\n'
string|"'root_device_name'"
op|':'
...
string|"'imageOwnerId'"
op|':'
string|"'9fd1513f52f14fe49fa1c83e40c63541'"
op|','
nl|'\n'
string|"'isPublic'"
op|':'
