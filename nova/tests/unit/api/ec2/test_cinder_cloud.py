...
op|')'
newline|'\n'
comment|"# Here,the status should be 'attaching',but it can be 'attached' in"
nl|'\n'
comment|'# unittest scenario if the attach action is very fast.'
nl|'\n'
name|'self'
op|'.'
name|'assertIn'
...
newline|'\n'
nl|'\n'
comment|"# Here,the status should be 'detaching',but it can be 'detached' in"
nl|'\n'
comment|'# unittest scenario if the detach action is very fast.'
nl|'\n'
name|'self'
op|'.'
name|'assertIn'
