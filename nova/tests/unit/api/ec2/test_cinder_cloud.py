...
newline|'\n'
nl|'\n'
DECL|member|test_volume_status_of_attaching_volume
dedent|''
name|'def'
name|'test_volume_status_of_attaching_volume'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
indent|'        '
string|'"""Test the volume\'s status in response when attaching a volume."""'
newline|'\n'
name|'vol1'
op|'='
name|'self'
...
newline|'\n'
nl|'\n'
comment|'# NOTE(ft): Since fake attach action is very fast, we replace it to'
nl|'\n'
comment|"# empty function to check EC2 API results at 'attaching' stage"
nl|'\n'
name|'self'
op|'.'
name|'stubs'
...
newline|'\n'
nl|'\n'
DECL|member|test_volume_status_of_detaching_volume
dedent|''
name|'def'
name|'test_volume_status_of_detaching_volume'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
indent|'        '
string|'"""Test the volume\'s status in response when detaching a volume."""'
newline|'\n'
name|'vol1'
op|'='
name|'self'
...
newline|'\n'
nl|'\n'
comment|'# NOTE(ft): Since fake detach action is very fast, we replace it to'
nl|'\n'
comment|"# empty function to check EC2 API results at 'detaching' stage"
nl|'\n'
name|'self'
op|'.'
name|'stubs'
...
newline|'\n'
nl|'\n'
DECL|variable|_expected_instance_bdm0
dedent|''
dedent|''
name|'_expected_instance_bdm0'
op|'='
op|'{'
nl|'\n'
string|"'instanceId'"
...
newline|'\n'
nl|'\n'
DECL|member|test_format_instance_bdm_while_attaching_volume
dedent|''
name|'def'
name|'test_format_instance_bdm_while_attaching_volume'
op|'('
name|'self'
op|')'
op|':'
