...
name|'patch'
op|'('
string|"'oslo_log.versionutils.report_deprecated_feature'"
op|')'
newline|'\n'
DECL|member|test_pipeline_factory_legacy_v2_deprecated
name|'def'
name|'test_pipeline_factory_legacy_v2_deprecated'
op|'('
name|'self'
op|','
nl|'\n'
name|'mock_report_deprecated'
op|')'
op|':'
newline|'\n'
indent|'        '
