...
newline|'\n'
nl|'\n'
DECL|member|test_xml_contains_unicode
dedent|''
name|'def'
name|'test_xml_contains_unicode'
op|'('
name|'self'
op|')'
op|':'
...
name|'expected_xml'
op|'='
string|"'<test>\\xe8\\xa7\\xa3\\xe7\\xa0\\x81</test>'"
newline|'\n'
name|'serializer'
op|'='
name|'wsgi'
...
string|'\'{"badRequest": \''
nl|'\n'
string|'\'{"message": "The request body invalid", "code": 400}}\''
op|')'
newline|'\n'
name|'self'
op|'.'
...
string|'\'{"badRequest": \''
nl|'\n'
string|'\'{"message": "Unsupported Content-Type", "code": 400}}\''
op|')'
newline|'\n'
name|'self'
op|'.'
