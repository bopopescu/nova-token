...
name|'stub_out'
op|'('
string|"'oslo_utils.netutils.get_my_ipv4'"
op|','
name|'get_my_ip'
op|')'
newline|'\n'
...
op|':'
newline|'\n'
comment|'#  This ensures services there if one wanted so'
nl|'\n'
indent|'        '
name|'inst'
op|'.'
...
nl|'\n'
nl|'\n'
DECL|function|stub_bdm_get_all_by_instance_uuids
dedent|''
name|'def'
name|'stub_bdm_get_all_by_instance_uuids'
op|'('
name|'context'
op|','
name|'instance_uuids'
...
op|')'
op|':'
comment|'# add two BDMs per instance'
newline|'\n'
indent|'            '
name|'result'
op|'.'
