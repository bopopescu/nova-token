...
nl|'\n'
nl|'\n'
comment|'# TODO(jogo) dedup these across nova.api.openstack.contrib.test_flavor*'
nl|'\n'
...
nl|'\n'
nl|'\n'
DECL|class|FlavorSwapTestV21
dedent|''
name|'class'
name|'FlavorSwapTestV21'
op|'('
name|'test'
op|'.'
name|'NoDBTestCase'
...
newline|'\n'
nl|'\n'
DECL|member|assertFlavorSwap
dedent|''
name|'def'
name|'assertFlavorSwap'
op|'('
name|'self'
op|','
name|'flavor'
...
nl|'\n'
nl|'\n'
DECL|class|FlavorSwapTestV2
dedent|''
dedent|''
name|'class'
name|'FlavorSwapTestV2'
op|'('
name|'FlavorSwapTestV21'
op|')'
op|':'
