...
op|'='
op|'{'
string|'"compute_extension:v3:os-admin-actions:reset_network"'
op|':'
nl|'\n'
...
op|'='
op|'{'
string|'"compute_extension:v3:os-admin-actions:inject_network_info"'
op|':'
nl|'\n'
string|'"project:non_fake"'
op|'}'
...
op|'='
op|'{'
string|'"compute_extension:v3:os-admin-actions:reset_state"'
op|':'
nl|'\n'
string|'"project:non_fake"'
op|'}'
