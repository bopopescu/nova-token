...
name|'CONF'
newline|'\n'
DECL|variable|FAKE_NETWORK_PROJECT_ID
name|'FAKE_NETWORK_PROJECT_ID'
op|'='
string|"'6133f8b603924f45bc0c9e21f6df12fa'"
newline|'\n'
nl|'\n'
DECL|variable|UTC
name|'UTC'
...
newline|'\n'
nl|'\n'
comment|"# NOTE: On v2.1 code, delete method doesn't return anything and"
nl|'\n'
comment|'# the status code is decorated on wsgi_code of the method.'
nl|'\n'
name|'self'
op|'.'
name|'assertIsNone'
