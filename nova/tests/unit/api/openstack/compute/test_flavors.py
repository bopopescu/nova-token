...
nl|'\n'
nl|'\n'
DECL|function|fake_get_limit_and_marker
dedent|''
name|'def'
name|'fake_get_limit_and_marker'
op|'('
name|'request'
op|','
name|'max_limit'
...
newline|'\n'
nl|'\n'
DECL|member|_set_expected_body
dedent|''
name|'def'
name|'_set_expected_body'
op|'('
name|'self'
op|','
name|'expected'
...
op|':'
newline|'\n'
comment|'# NOTE(oomichi): On v2.1 API, some extensions of v2.0 are merged'
nl|'\n'
comment|'# as core features and we can get the following parameters as the'
nl|'\n'
comment|'# default.'
nl|'\n'
indent|'        '
...
op|'+'
nl|'\n'
string|"'/flavors?limit=1&marker=2'"
op|','
nl|'\n'
string|"'rel'"
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_flavor_with_default_limit
dedent|''
name|'def'
name|'test_get_flavor_with_default_limit'
op|'('
name|'self'
op|')'
op|':'
...
nl|'\n'
nl|'\n'
DECL|class|DisabledFlavorsWithRealDBTestV21
dedent|''
dedent|''
name|'class'
name|'DisabledFlavorsWithRealDBTestV21'
op|'('
name|'test'
op|'.'
name|'TestCase'
...
nl|'\n'
nl|'\n'
DECL|class|DisabledFlavorsWithRealDBTestV20
dedent|''
dedent|''
name|'class'
name|'DisabledFlavorsWithRealDBTestV20'
op|'('
name|'DisabledFlavorsWithRealDBTestV21'
op|')'
op|':'
...
nl|'\n'
nl|'\n'
DECL|class|ParseIsPublicTestV21
dedent|''
name|'class'
name|'ParseIsPublicTestV21'
op|'('
name|'test'
op|'.'
name|'TestCase'
...
nl|'\n'
nl|'\n'
DECL|class|ParseIsPublicTestV20
dedent|''
dedent|''
name|'class'
name|'ParseIsPublicTestV20'
op|'('
name|'ParseIsPublicTestV21'
op|')'
op|':'
