...
newline|'\n'
nl|'\n'
DECL|member|_test_view_builder_osapi_compute_link_prefix
dedent|''
name|'def'
name|'_test_view_builder_osapi_compute_link_prefix'
op|'('
name|'self'
op|','
nl|'\n'
...
op|':'
op|'('
string|'"application/vnd.openstack."'
nl|'\n'
string|'"compute+json;version=2.1"'
op|')'
nl|'\n'
op|'}'
nl|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|test_view_builder_with_osapi_compute_link_prefix
dedent|''
name|'def'
name|'test_view_builder_with_osapi_compute_link_prefix'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_view_builder_without_osapi_compute_link_prefix
dedent|''
name|'def'
name|'test_view_builder_without_osapi_compute_link_prefix'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_generate_href_with_path
dedent|''
name|'def'
name|'test_generate_href_with_path'
op|'('
name|'self'
op|')'
op|':'
...
name|'expected'
op|'='
string|'"http://example.org/app/v2/%s"'
op|'%'
name|'path'
newline|'\n'
name|'builder'
...
newline|'\n'
nl|'\n'
DECL|member|test_generate_href_with_empty_path
dedent|''
name|'def'
name|'test_generate_href_with_empty_path'
op|'('
name|'self'
op|')'
op|':'
