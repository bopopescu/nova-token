...
op|':'
newline|'\n'
comment|'# Add a check whether the size is an empty string'
nl|'\n'
...
op|':'
newline|'\n'
comment|'# Add a check whether the size is zero in V2.1 API only.'
nl|'\n'
comment|'# So this test is skipped in V2.0 API'
nl|'\n'
indent|'        '
name|'pass'
newline|'\n'
...
op|':'
newline|'\n'
comment|'# Add a check whether size is greater than the limit'
nl|'\n'
comment|'# in V2.1 API only. So this test is skipped in V2.0 API'
nl|'\n'
indent|'        '
