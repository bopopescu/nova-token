...
nl|'\n'
nl|'\n'
DECL|function|fake_instance_get_all_with_description
dedent|''
name|'def'
name|'fake_instance_get_all_with_description'
op|'('
name|'context'
op|','
name|'list_desc'
...
nl|'\n'
nl|'\n'
DECL|class|ServersControllerTestV219
dedent|''
dedent|''
dedent|''
name|'class'
name|'ServersControllerTestV219'
op|'('
name|'ServersControllerTest'
op|')'
op|':'
...
op|')'
newline|'\n'
DECL|member|_test_get_server_with_description
name|'def'
name|'_test_get_server_with_description'
op|'('
name|'self'
op|','
name|'description'
...
op|')'
newline|'\n'
DECL|member|_test_list_server_detail_with_descriptions
name|'def'
name|'_test_list_server_detail_with_descriptions'
op|'('
name|'self'
op|','
nl|'\n'
...
op|')'
newline|'\n'
comment|"# Check that each returned server has the same 'description' value"
nl|'\n'
comment|"# and 'id' as they were created."
nl|'\n'
name|'for'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_server_with_description
dedent|''
dedent|''
name|'def'
name|'test_get_server_with_description'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_list_server_detail_with_descriptions
dedent|''
name|'def'
name|'test_list_server_detail_with_descriptions'
op|'('
name|'self'
op|')'
op|':'
...
nl|'\n'
nl|'\n'
DECL|class|ServersControllerTestV226
dedent|''
dedent|''
name|'class'
name|'ServersControllerTestV226'
op|'('
name|'ControllerTest'
op|')'
op|':'
...
op|')'
newline|'\n'
DECL|member|test_get_server_with_tags_by_id
name|'def'
name|'test_get_server_with_tags_by_id'
op|'('
name|'self'
op|','
name|'mock_get'
...
op|')'
newline|'\n'
DECL|member|_test_get_servers_allows_tag_filters
name|'def'
name|'_test_get_servers_allows_tag_filters'
op|'('
name|'self'
op|','
name|'filter_name'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_servers_allows_tags_filter
dedent|''
name|'def'
name|'test_get_servers_allows_tags_filter'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_servers_allows_tags_any_filter
dedent|''
name|'def'
name|'test_get_servers_allows_tags_any_filter'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_servers_allows_not_tags_filter
dedent|''
name|'def'
name|'test_get_servers_allows_not_tags_filter'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_servers_allows_not_tags_any_filter
dedent|''
name|'def'
name|'test_get_servers_allows_not_tags_any_filter'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_rebuild_instance_name_with_leading_trailing_spaces_compat_mode
dedent|''
name|'def'
name|'test_rebuild_instance_name_with_leading_trailing_spaces_compat_mode'
op|'('
nl|'\n'
name|'self'
op|')'
...
nl|'\n'
nl|'\n'
DECL|class|ServersControllerRebuildTestV219
dedent|''
dedent|''
name|'class'
name|'ServersControllerRebuildTestV219'
op|'('
name|'ServersControllerRebuildInstanceTest'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_rebuild_server_empty_description
dedent|''
name|'def'
name|'test_rebuild_server_empty_description'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_rebuild_server_without_description
dedent|''
name|'def'
name|'test_rebuild_server_without_description'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_rebuild_server_remove_description
dedent|''
name|'def'
name|'test_rebuild_server_remove_description'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_rebuild_server_description_too_long
dedent|''
name|'def'
name|'test_rebuild_server_description_too_long'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_rebuild_server_description_invalid
dedent|''
name|'def'
name|'test_rebuild_server_description_invalid'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
comment|'# Invalid non-printable control char in the desc.'
nl|'\n'
indent|'        '
name|'self'
op|'.'
...
newline|'\n'
nl|'\n'
DECL|member|test_update_server_name_with_leading_trailing_spaces_compat_mode
dedent|''
name|'def'
name|'test_update_server_name_with_leading_trailing_spaces_compat_mode'
op|'('
name|'self'
op|')'
op|':'
...
nl|'\n'
nl|'\n'
DECL|class|ServersControllerTriggerCrashDumpTest
dedent|''
dedent|''
name|'class'
name|'ServersControllerTriggerCrashDumpTest'
op|'('
name|'ControllerTest'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_trigger_crash_dump_policy_failed
dedent|''
name|'def'
name|'test_trigger_crash_dump_policy_failed'
op|'('
name|'self'
op|')'
op|':'
...
op|')'
newline|'\n'
DECL|member|test_trigger_crash_dump_not_ready
name|'def'
name|'test_trigger_crash_dump_not_ready'
op|'('
name|'self'
op|')'
op|':'
...
op|')'
newline|'\n'
DECL|member|test_trigger_crash_dump_locked_server
name|'def'
name|'test_trigger_crash_dump_locked_server'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_trigger_crash_dump_with_bogus_id
dedent|''
name|'def'
name|'test_trigger_crash_dump_with_bogus_id'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_trigger_crash_dump_schema_invalid_type
dedent|''
name|'def'
name|'test_trigger_crash_dump_schema_invalid_type'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_trigger_crash_dump_schema_extra_property
dedent|''
name|'def'
name|'test_trigger_crash_dump_schema_extra_property'
op|'('
name|'self'
op|')'
op|':'
...
name|'def'
name|'test_trigger_crash_dump_not_supported'
op|'('
name|'self'
op|','
name|'mock_trigger_crash_dump'
...
nl|'\n'
nl|'\n'
DECL|class|ServersControllerUpdateTestV219
dedent|''
dedent|''
name|'class'
name|'ServersControllerUpdateTestV219'
op|'('
name|'ServersControllerUpdateTest'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|_update_server_desc
dedent|''
name|'def'
name|'_update_server_desc'
op|'('
name|'self'
op|','
name|'set_desc'
...
newline|'\n'
nl|'\n'
DECL|member|test_update_server_description
dedent|''
name|'def'
name|'test_update_server_description'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_update_server_empty_description
dedent|''
name|'def'
name|'test_update_server_empty_description'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_update_server_without_description
dedent|''
name|'def'
name|'test_update_server_without_description'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_update_server_remove_description
dedent|''
name|'def'
name|'test_update_server_remove_description'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_update_server_description_too_long
dedent|''
name|'def'
name|'test_update_server_description_too_long'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_update_server_description_invalid
dedent|''
name|'def'
name|'test_update_server_description_invalid'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_create_instance_with_none_value_port
dedent|''
name|'def'
name|'test_create_instance_with_none_value_port'
op|'('
name|'self'
op|')'
op|':'
...
nl|'\n'
comment|'#     req.body = jsonutils.dump_as_bytes(body)'
nl|'\n'
...
comment|'#'
nl|'\n'
comment|"#     self.stub_out('nova.db.key_pair_get', key_pair_get)"
nl|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|test_create_instance_secgroup_leading_trailing_spaces
dedent|''
name|'def'
name|'test_create_instance_secgroup_leading_trailing_spaces'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_create_instance_secgroup_leading_trailing_spaces_compat_mode
dedent|''
name|'def'
name|'test_create_instance_secgroup_leading_trailing_spaces_compat_mode'
op|'('
nl|'\n'
name|'self'
op|')'
...
newline|'\n'
nl|'\n'
DECL|member|test_create_instance_name_with_leading_trailing_spaces_in_compat_mode
dedent|''
name|'def'
name|'test_create_instance_name_with_leading_trailing_spaces_in_compat_mode'
op|'('
nl|'\n'
name|'self'
op|')'
...
newline|'\n'
nl|'\n'
DECL|member|test_create_az_with_leading_trailing_spaces
dedent|''
name|'def'
name|'test_create_az_with_leading_trailing_spaces'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_create_az_with_leading_trailing_spaces_in_compat_mode
dedent|''
name|'def'
name|'test_create_az_with_leading_trailing_spaces_in_compat_mode'
op|'('
nl|'\n'
name|'self'
op|')'
...
newline|'\n'
nl|'\n'
DECL|member|test_create_instance_with_group_hint_group_not_found
dedent|''
name|'def'
name|'test_create_instance_with_group_hint_group_not_found'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_create_instance_with_group_hint_wrong_uuid_format
dedent|''
name|'def'
name|'test_create_instance_with_group_hint_wrong_uuid_format'
op|'('
name|'self'
op|')'
op|':'
...
op|')'
newline|'\n'
DECL|member|test_create_instance_raise_invalid_bdm_ephsize
name|'def'
name|'test_create_instance_raise_invalid_bdm_ephsize'
op|'('
name|'self'
op|','
name|'mock_create'
...
op|')'
newline|'\n'
DECL|member|test_create_instance_raise_invalid_bdm_format
name|'def'
name|'test_create_instance_raise_invalid_bdm_format'
op|'('
name|'self'
op|','
name|'mock_create'
...
op|')'
newline|'\n'
DECL|member|test_create_instance_raise_invalid_bdm_swapsize
name|'def'
name|'test_create_instance_raise_invalid_bdm_swapsize'
op|'('
name|'self'
op|','
name|'mock_create'
...
op|')'
newline|'\n'
DECL|member|test_create_instance_raise_invalid_bdm
name|'def'
name|'test_create_instance_raise_invalid_bdm'
op|'('
name|'self'
op|','
name|'mock_create'
...
op|')'
newline|'\n'
DECL|member|test_create_instance_raise_image_bad_request
name|'def'
name|'test_create_instance_raise_image_bad_request'
op|'('
name|'self'
op|','
name|'mock_create'
...
op|')'
newline|'\n'
DECL|member|test_create_instance_raise_fixed_ip_not_found_bad_request
name|'def'
name|'test_create_instance_raise_fixed_ip_not_found_bad_request'
op|'('
name|'self'
op|','
nl|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|test_create_instance_without_personality_should_get_empty_list
dedent|''
name|'def'
name|'test_create_instance_without_personality_should_get_empty_list'
op|'('
name|'self'
op|')'
op|':'
...
nl|'\n'
nl|'\n'
DECL|class|ServersControllerCreateTestV219
dedent|''
dedent|''
name|'class'
name|'ServersControllerCreateTestV219'
op|'('
name|'ServersControllerCreateTest'
op|')'
op|':'
newline|'\n'
DECL|member|_create_instance_req
indent|'    '
name|'def'
name|'_create_instance_req'
op|'('
name|'self'
op|','
name|'set_desc'
...
newline|'\n'
nl|'\n'
DECL|member|test_create_instance_with_description
dedent|''
name|'def'
name|'test_create_instance_with_description'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_create_instance_with_none_description
dedent|''
name|'def'
name|'test_create_instance_with_none_description'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_create_instance_with_empty_description
dedent|''
name|'def'
name|'test_create_instance_with_empty_description'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_create_instance_without_description
dedent|''
name|'def'
name|'test_create_instance_without_description'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_create_instance_description_too_long
dedent|''
name|'def'
name|'test_create_instance_description_too_long'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_create_instance_description_invalid
dedent|''
name|'def'
name|'test_create_instance_description_invalid'
op|'('
name|'self'
op|')'
op|':'
...
number|'1'
newline|'\n'
DECL|variable|fake_schema
name|'fake_schema'
op|'='
op|'{'
string|"'fake_ext_attr'"
op|':'
op|'{'
string|"'type'"
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|fake_schema_extension_point
dedent|''
name|'def'
name|'fake_schema_extension_point'
op|'('
name|'self'
op|','
name|'version'
...
op|'}'
newline|'\n'
comment|'# This fake method should reuturn the schema for expected version'
nl|'\n'
comment|'# Return None will make the tests failed, that means there is something'
nl|'\n'
comment|'# in the code.'
nl|'\n'
dedent|''
