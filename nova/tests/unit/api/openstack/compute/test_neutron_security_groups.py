...
dedent|''
name|'class'
name|'TestNeutronSecurityGroupsV21'
op|'('
nl|'\n'
name|'test_security_groups'
op|'.'
...
op|','
nl|'\n'
DECL|class|TestNeutronSecurityGroupsV21
name|'TestNeutronSecurityGroupsTestCase'
op|')'
op|':'
newline|'\n'
...
name|'patch'
op|'('
string|"'nova.compute.utils.refresh_info_cache_for_instance'"
op|')'
newline|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|test_associate_duplicate_names
dedent|''
name|'def'
name|'test_associate_duplicate_names'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_raises_no_unique_match_error
dedent|''
name|'def'
name|'test_get_raises_no_unique_match_error'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
nl|'\n'
DECL|function|fake_find_resourceid_by_name_or_id
indent|'        '
name|'def'
name|'fake_find_resourceid_by_name_or_id'
op|'('
name|'client'
op|','
name|'param'
...
name|'neutronv20'
op|','
string|"'find_resourceid_by_name_or_id'"
op|','
nl|'\n'
name|'fake_find_resourceid_by_name_or_id'
op|')'
...
name|'patch'
op|'('
string|"'nova.network.security_group.neutron_driver.SecurityGroupAPI.'"
nl|'\n'
...
nl|'\n'
nl|'\n'
DECL|class|TestNeutronSecurityGroupsV2
dedent|''
dedent|''
name|'class'
name|'TestNeutronSecurityGroupsV2'
op|'('
name|'TestNeutronSecurityGroupsV21'
op|')'
op|':'
...
nl|'\n'
nl|'\n'
DECL|class|_TestNeutronSecurityGroupRulesBase
dedent|''
dedent|''
name|'class'
name|'_TestNeutronSecurityGroupRulesBase'
op|'('
name|'object'
op|')'
op|':'
...
dedent|''
name|'class'
name|'TestNeutronSecurityGroupRulesV2'
op|'('
nl|'\n'
name|'_TestNeutronSecurityGroupRulesBase'
op|','
...
op|','
nl|'\n'
DECL|class|TestNeutronSecurityGroupRulesV2
name|'TestNeutronSecurityGroupRulesTestCase'
op|')'
op|':'
newline|'\n'
...
dedent|''
name|'class'
name|'TestNeutronSecurityGroupRulesV21'
op|'('
nl|'\n'
name|'_TestNeutronSecurityGroupRulesBase'
op|','
...
op|','
nl|'\n'
DECL|class|TestNeutronSecurityGroupRulesV21
name|'TestNeutronSecurityGroupRulesTestCase'
op|')'
op|':'
newline|'\n'
...
op|'='
op|'('
string|"'BadRequest: Invalid input for name. Reason: '"
nl|'\n'
string|"'None is not a valid string.'"
op|')'
newline|'\n'
name|'raise'
name|'n_exc'
...
op|'='
op|'('
string|"'BadRequest: Invalid input for description. Reason: '"
nl|'\n'
string|"'None is not a valid string.'"
op|')'
newline|'\n'
...
op|':'
newline|'\n'
comment|'# neutronv2/api.py _get_available_networks calls this assuming'
nl|'\n'
comment|'# search_opts filter "shared" is implemented and not ignored'
nl|'\n'
indent|'        '
name|'shared'
op|'='
