...
nl|'\n'
nl|'\n'
DECL|class|ConsolesControllerTestV21
dedent|''
name|'class'
name|'ConsolesControllerTestV21'
op|'('
name|'test'
op|'.'
name|'NoDBTestCase'
...
newline|'\n'
nl|'\n'
DECL|member|_test_fail_policy
dedent|''
name|'def'
name|'_test_fail_policy'
op|'('
name|'self'
op|','
name|'rule'
...
newline|'\n'
nl|'\n'
DECL|member|test_delete_console_fail_policy
dedent|''
dedent|''
name|'def'
name|'test_delete_console_fail_policy'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_create_console_fail_policy
dedent|''
name|'def'
name|'test_create_console_fail_policy'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_index_console_fail_policy
dedent|''
name|'def'
name|'test_index_console_fail_policy'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_show_console_fail_policy
dedent|''
name|'def'
name|'test_show_console_fail_policy'
op|'('
name|'self'
op|')'
op|':'
...
nl|'\n'
nl|'\n'
DECL|class|ConsolesControllerTestV2
dedent|''
dedent|''
name|'class'
name|'ConsolesControllerTestV2'
op|'('
name|'ConsolesControllerTestV21'
op|')'
op|':'
...
op|':'
newline|'\n'
comment|"# V2 API don't have policy"
nl|'\n'
indent|'        '
name|'pass'
newline|'\n'
