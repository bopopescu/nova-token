...
name|'net_uuid'
op|'='
string|"'22222222-2222-2222-2222-22222222222222222'"
newline|'\n'
name|'vif'
op|'.'
name|'uuid'
...
name|'net_uuid'
op|'='
string|"'33333333-3333-3333-3333-33333333333333333'"
newline|'\n'
name|'vif'
op|'.'
name|'uuid'
...
newline|'\n'
nl|'\n'
DECL|member|test_list_vifs_neutron_notimplemented
dedent|''
name|'def'
name|'test_list_vifs_neutron_notimplemented'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
indent|'        '
string|'"""Tests that a 400 is returned when using neutron as the backend"""'
newline|'\n'
comment|'# unset the get_vifs_by_instance stub from setUp'
nl|'\n'
name|'self'
op|'.'
name|'mox'
...
op|')'
newline|'\n'
comment|'# reset the controller to use the neutron network API'
nl|'\n'
name|'self'
op|'.'
name|'_set_controller'
...
nl|'\n'
nl|'\n'
DECL|class|ServerVirtualInterfaceTestV212
dedent|''
dedent|''
name|'class'
name|'ServerVirtualInterfaceTestV212'
op|'('
name|'ServerVirtualInterfaceTestV21'
op|')'
op|':'
