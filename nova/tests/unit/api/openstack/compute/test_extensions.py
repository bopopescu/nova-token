...
newline|'\n'
nl|'\n'
DECL|member|_test_extension_authorizer_throws_exception_if_policy_fails
dedent|''
name|'def'
name|'_test_extension_authorizer_throws_exception_if_policy_fails'
op|'('
name|'self'
op|','
nl|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|test_os_compute_api_authorizer_throws_exception_if_policy_fails
dedent|''
name|'def'
name|'test_os_compute_api_authorizer_throws_exception_if_policy_fails'
op|'('
name|'self'
op|')'
op|':'
...
op|'('
nl|'\n'
string|'"compute_extension:v3:used_limits_for_admin"'
op|','
nl|'\n'
name|'authorize'
op|')'
newline|'\n'
nl|'\n'
DECL|member|_test_core_authorizer_throws_exception_if_policy_fails
dedent|''
name|'def'
name|'_test_core_authorizer_throws_exception_if_policy_fails'
op|'('
name|'self'
op|','
nl|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|test_os_compute_api_core_authorizer_throws_exception_if_policy_fails
dedent|''
name|'def'
name|'test_os_compute_api_core_authorizer_throws_exception_if_policy_fails'
op|'('
nl|'\n'
name|'self'
op|')'
...
op|'('
nl|'\n'
string|'"compute:v3:used_limits_for_admin"'
op|','
name|'authorize'
op|')'
newline|'\n'
