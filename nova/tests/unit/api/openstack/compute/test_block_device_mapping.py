...
newline|'\n'
nl|'\n'
DECL|member|_test_create_instance_with_destination_type_error
dedent|''
name|'def'
name|'_test_create_instance_with_destination_type_error'
op|'('
name|'self'
op|','
nl|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|test_create_instance_with_destination_type_empty_string
dedent|''
name|'def'
name|'test_create_instance_with_destination_type_empty_string'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_create_instance_with_invalid_destination_type
dedent|''
name|'def'
name|'test_create_instance_with_invalid_destination_type'
op|'('
name|'self'
op|')'
op|':'
...
op|':'
newline|'\n'
comment|'# Add a check whether the destination type is an empty string'
nl|'\n'
comment|'# in V2.1 API only. So this test is skipped in V2.0 API'
nl|'\n'
indent|'        '
name|'pass'
newline|'\n'
...
op|':'
newline|'\n'
comment|'# Add a check whether the destination type is invalid'
nl|'\n'
comment|'# in V2.1 API only. So this test is skipped in V2.0 API'
nl|'\n'
indent|'        '
