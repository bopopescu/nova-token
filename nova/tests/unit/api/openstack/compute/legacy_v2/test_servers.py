...
op|')'
newline|'\n'
comment|'# Server sort keys extension is not enabled in v2 test so no sort'
nl|'\n'
comment|'# data is passed to the instance API and the non-sorted DB API is'
nl|'\n'
comment|'# invoked'
nl|'\n'
name|'self'
...
op|')'
newline|'\n'
comment|'# Retrieve the parameters from the next link, they should contain the'
nl|'\n'
comment|'# same limit, filter, and sort information as the original request as'
nl|'\n'
comment|'# well as a marker; this ensures that the caller can simply use the'
nl|'\n'
comment|'# "next" link and that they do not need to manually insert the limit'
nl|'\n'
comment|'# and sort information.'
nl|'\n'
name|'href_parts'
op|'='
name|'urlparse'
...
op|')'
newline|'\n'
DECL|member|test_get_servers_with_sorting_enabled
name|'def'
name|'test_get_servers_with_sorting_enabled'
op|'('
name|'self'
op|','
name|'mock_compute_get_all'
op|')'
op|':'
newline|'\n'
indent|'        '
string|"'''Sorting params honored if os-server-sort-keys is loaded.'''"
newline|'\n'
name|'self'
op|'.'
name|'ext_mgr'
...
op|')'
newline|'\n'
comment|'# Ensure that sort_dirs and sort_dirs is correct'
nl|'\n'
name|'kwargs'
op|'='
name|'mock_compute_get_all'
...
op|')'
newline|'\n'
DECL|member|test_get_servers_with_sorting_disabled
name|'def'
name|'test_get_servers_with_sorting_disabled'
op|'('
name|'self'
op|','
name|'mock_compute_get_all'
...
newline|'\n'
indent|'        '
string|"'''Sorting params ignored if os-server-sort-keys is not loaded.'''"
newline|'\n'
name|'self'
op|'.'
name|'ext_mgr'
...
op|')'
newline|'\n'
comment|'# Ensure that sort_dirs and sort_dirs is None'
nl|'\n'
name|'kwargs'
op|'='
name|'mock_compute_get_all'
...
name|'blank'
op|'('
string|"'/fake/servers/detail?flavor=abcde'"
op|')'
newline|'\n'
name|'with'
name|'mock'
...
op|')'
newline|'\n'
DECL|member|test_get_servers_allows_multi_status
name|'def'
name|'test_get_servers_allows_multi_status'
op|'('
name|'self'
op|','
name|'get_all_mock'
...
op|'('
nl|'\n'
string|"'/fake/servers?status=active&status=error'"
op|')'
newline|'\n'
name|'servers'
op|'='
...
op|')'
newline|'\n'
DECL|member|test_get_servers_system_metadata_filter
name|'def'
name|'test_get_servers_system_metadata_filter'
op|'('
name|'self'
op|','
name|'get_all_mock'
...
op|')'
newline|'\n'
name|'expected_system_metadata'
op|'='
string|'u\'{"some_value": "some_key"}\''
newline|'\n'
name|'db_list'
op|'='
op|'['
...
op|'('
nl|'\n'
string|"'/fake/servers?status=active&status=error&system_metadata='"
op|'+'
nl|'\n'
name|'urllib'
op|'.'
...
op|')'
newline|'\n'
DECL|member|test_get_servers_allows_invalid_status
name|'def'
name|'test_get_servers_allows_invalid_status'
op|'('
name|'self'
op|','
name|'get_all_mock'
...
op|'('
nl|'\n'
string|"'/fake/servers?status=active&status=invalid'"
op|')'
newline|'\n'
name|'servers'
op|'='
...
op|':'
newline|'\n'
comment|"# patch load_extension because it's expensive in fakes.wsgi_app"
nl|'\n'
indent|'            '
name|'return'
name|'fakes'
...
newline|'\n'
nl|'\n'
DECL|member|test_update_server_name_with_leading_trailing_spaces
dedent|''
name|'def'
name|'test_update_server_name_with_leading_trailing_spaces'
op|'('
name|'self'
op|')'
op|':'
...
nl|'\n'
comment|"#        self.stub_out('nova.db.instance_get',"
nl|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|test_delete_server_instance_while_deleting_host_up
dedent|''
name|'def'
name|'test_delete_server_instance_while_deleting_host_up'
op|'('
name|'self'
op|')'
op|':'
...
name|'classmethod'
newline|'\n'
DECL|function|fake_get_by_compute_host
name|'def'
name|'fake_get_by_compute_host'
op|'('
name|'cls'
op|','
name|'context'
...
newline|'\n'
nl|'\n'
DECL|member|test_delete_server_instance_while_deleting_host_down
dedent|''
name|'def'
name|'test_delete_server_instance_while_deleting_host_down'
op|'('
name|'self'
op|')'
op|':'
...
op|')'
newline|'\n'
comment|"# Delete request would be ignored, because it's been accepted before"
nl|'\n'
comment|'# but since the host is down, api should remove the instance anyway.'
nl|'\n'
name|'self'
op|'.'
name|'assertTrue'
...
name|'stub_out'
op|'('
string|"'nova.db.instance_destroy'"
op|','
name|'instance_destroy_mock'
op|')'
newline|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|test_rebuild_instance_name_with_leading_trailing_spaces
dedent|''
name|'def'
name|'test_rebuild_instance_name_with_leading_trailing_spaces'
op|'('
name|'self'
op|')'
op|':'
...
op|':'
newline|'\n'
comment|"# NOTE(alex_xu): V2 API rebuild didn't strip the leading/trailing"
nl|'\n'
comment|'# spaces.'
nl|'\n'
indent|'            '
...
newline|'\n'
nl|'\n'
DECL|member|test_rebuild_instance_name_with_spaces_in_middle
dedent|''
dedent|''
name|'def'
name|'test_rebuild_instance_name_with_spaces_in_middle'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_rebuild_instance_with_null_image_ref
dedent|''
dedent|''
name|'def'
name|'test_rebuild_instance_with_null_image_ref'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_create_instance_sg_with_leading_trailing_spaces
dedent|''
name|'def'
name|'test_create_instance_sg_with_leading_trailing_spaces'
op|'('
name|'self'
op|')'
op|':'
...
op|')'
newline|'\n'
DECL|member|test_create_instance_raise_auto_disk_config_exc
name|'def'
name|'test_create_instance_raise_auto_disk_config_exc'
op|'('
name|'self'
op|','
name|'mock_create'
...
newline|'\n'
nl|'\n'
DECL|member|test_create_instance_name_with_spaces_in_middle
dedent|''
name|'def'
name|'test_create_instance_name_with_spaces_in_middle'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_create_instance_name_with_leading_trailing_spaces
dedent|''
name|'def'
name|'test_create_instance_name_with_leading_trailing_spaces'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_create_instance_az_with_leading_trailing_spaces
dedent|''
name|'def'
name|'test_create_instance_az_with_leading_trailing_spaces'
op|'('
name|'self'
op|')'
op|':'
...
name|'patch'
op|'('
string|"'nova.compute.api.API.create'"
op|','
nl|'\n'
name|'side_effect'
op|'='
...
op|')'
newline|'\n'
DECL|member|test_create_instance_empty_key_name
name|'def'
name|'test_create_instance_empty_key_name'
op|'('
name|'self'
op|','
name|'mock_create'
...
newline|'\n'
nl|'\n'
DECL|member|test_create_instance_above_quota_group_members
dedent|''
name|'def'
name|'test_create_instance_above_quota_group_members'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_resolve_exception
dedent|''
name|'def'
name|'test_resolve_exception'
op|'('
name|'self'
op|')'
op|':'
...
op|')'
newline|'\n'
comment|'# Since CC is the most specific, we always expect that returned.'
nl|'\n'
name|'self'
op|'.'
name|'assertEqual'
