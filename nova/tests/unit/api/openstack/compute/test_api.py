...
newline|'\n'
nl|'\n'
comment|'# TODO(alex_xu): Get rid of the case translate NovaException to'
nl|'\n'
comment|'# HTTPException after V2 api code removed. Because V2.1 API required raise'
nl|'\n'
comment|"# HTTPException explicitly, so V2.1 API needn't such translation."
nl|'\n'
dedent|''
dedent|''
endmarker|''
