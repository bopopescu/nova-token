...
newline|'\n'
nl|'\n'
DECL|member|test_agents_delete_string_id
dedent|''
dedent|''
name|'def'
name|'test_agents_delete_string_id'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_agents_update_with_string_id
dedent|''
name|'def'
name|'test_agents_update_with_string_id'
op|'('
name|'self'
op|')'
op|':'
