...
nl|'\n'
nl|'\n'
DECL|class|DiskConfigTestCaseV21
dedent|''
name|'class'
name|'DiskConfigTestCaseV21'
op|'('
name|'test'
op|'.'
name|'TestCase'
...
newline|'\n'
nl|'\n'
DECL|member|_get_expected_msg_for_invalid_disk_config
dedent|''
name|'def'
name|'_get_expected_msg_for_invalid_disk_config'
op|'('
name|'self'
op|')'
op|':'
...
name|'return'
op|'('
string|'\'{{"badRequest": {{"message": "Invalid input for\''
nl|'\n'
string|"' field/attribute {0}. Value: {1}. u\\'{1}\\' is'"
nl|'\n'
string|'\' not one of [\\\'AUTO\\\', \\\'MANUAL\\\']", "code": 400}}}}\''
op|')'
newline|'\n'
nl|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|_test_update_server_disk_config
dedent|''
name|'def'
name|'_test_update_server_disk_config'
op|'('
name|'self'
op|','
name|'uuid'
...
newline|'\n'
nl|'\n'
DECL|member|test_update_server_override_auto
dedent|''
name|'def'
name|'test_update_server_override_auto'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_update_server_override_manual
dedent|''
name|'def'
name|'test_update_server_override_manual'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|_test_rebuild_server_disk_config
dedent|''
name|'def'
name|'_test_rebuild_server_disk_config'
op|'('
name|'self'
op|','
name|'uuid'
...
newline|'\n'
nl|'\n'
DECL|member|test_rebuild_server_override_auto
dedent|''
name|'def'
name|'test_rebuild_server_override_auto'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_rebuild_server_override_manual
dedent|''
name|'def'
name|'test_rebuild_server_override_manual'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_create_server_with_auto_disk_config
dedent|''
name|'def'
name|'test_create_server_with_auto_disk_config'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_rebuild_server_with_auto_disk_config
dedent|''
name|'def'
name|'test_rebuild_server_with_auto_disk_config'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_resize_server_with_auto_disk_config
dedent|''
name|'def'
name|'test_resize_server_with_auto_disk_config'
op|'('
name|'self'
op|')'
op|':'
...
nl|'\n'
nl|'\n'
DECL|class|DiskConfigTestCaseV2
dedent|''
dedent|''
name|'class'
name|'DiskConfigTestCaseV2'
op|'('
name|'DiskConfigTestCaseV21'
op|')'
op|':'
...
name|'return'
op|'('
string|'\'{{"badRequest": {{"message": "{0} must be either\''
nl|'\n'
