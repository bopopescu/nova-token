...
newline|'\n'
nl|'\n'
DECL|function|mock_local_delete
name|'def'
...
op|')'
newline|'\n'
comment|'# Delete should be allowed in any case, even during resizing,'
nl|'\n'
