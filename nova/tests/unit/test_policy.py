...
op|','
nl|'\n'
string|'"os_compute_api:os-config-drive:discoverable"'
op|','
nl|'\n'
...
op|','
nl|'\n'
string|'"os_compute_api:os-server-tags:delete"'
op|','
nl|'\n'
string|'"os_compute_api:os-server-tags:delete_all"'
op|','
nl|'\n'
string|'"os_compute_api:os-server-tags:index"'
op|','
nl|'\n'
string|'"os_compute_api:os-server-tags:show"'
op|','
nl|'\n'
string|'"os_compute_api:os-server-tags:update"'
op|','
nl|'\n'
string|'"os_compute_api:os-server-tags:update_all"'
op|','
nl|'\n'
...
op|','
nl|'\n'
string|'"os_compute_api:os-console-auth-tokens:discoverable"'
op|','
nl|'\n'
string|'"os_compute_api:os-server-external-events:discoverable"'
op|','
nl|'\n'
op|')'
newline|'\n'
...
op|':'
newline|'\n'
comment|"# Parsed rules substitute '@' for '', so we need to look at the raw"
nl|'\n'
comment|'# policy definitions'
nl|'\n'
comment|'# CONF.oslo_policy.policy_file has been set to the sample file by'
nl|'\n'
comment|'# the RealPolicyFixture used in setUp'
nl|'\n'
indent|'        '
name|'with'
name|'open'
