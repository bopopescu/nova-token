...
name|'def'
name|'test_service_update_time_big'
op|'('
name|'self'
op|','
name|'mock_prepare'
...
name|'def'
name|'test_service_update_time_small'
op|'('
name|'self'
op|','
name|'mock_prepare'
...
name|'def'
name|'test_service_update_no_time'
op|'('
name|'self'
op|','
name|'mock_prepare'
...
op|')'
newline|'\n'
DECL|member|test_migrate_server_deals_with_instancenotrunning_exception
name|'def'
name|'test_migrate_server_deals_with_instancenotrunning_exception'
op|'('
name|'self'
op|','
nl|'\n'
