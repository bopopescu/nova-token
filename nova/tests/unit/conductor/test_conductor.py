...
nl|'\n'
nl|'\n'
DECL|class|ConductorV3ManagerProxyTestCase
dedent|''
dedent|''
name|'class'
name|'ConductorV3ManagerProxyTestCase'
op|'('
name|'test'
op|'.'
name|'NoDBTestCase'
...
op|':'
newline|'\n'
DECL|member|test_v3_manager_proxy
indent|'    '
name|'def'
name|'test_v3_manager_proxy'
op|'('
name|'self'
op|')'
op|':'
...
nl|'\n'
op|'('
string|"'object_class_action_versions'"
op|','
number|'5'
op|')'
op|','
