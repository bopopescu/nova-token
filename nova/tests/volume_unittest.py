...
newline|'\n'
indent|'        '
string|'"""Ensure that NoMoreBlades is raised when we run out of volumes"""'
newline|'\n'
name|'vols'
op|'='
op|'['
...
newline|'\n'
indent|'        '
string|'"""Ensure multiple concurrent volumes get different blades"""'
newline|'\n'
name|'volume_ids'
op|'='
op|'['
...
newline|'\n'
indent|'            '
string|'"""Make sure blades aren\'t duplicated"""'
newline|'\n'
name|'volume_ids'
op|'.'
name|'append'
