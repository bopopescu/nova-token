...
newline|'\n'
indent|'        '
string|'"""Ensure we warn for use of a missing base image."""'
newline|'\n'
nl|'\n'
name|'img'
op|'='
...
newline|'\n'
nl|'\n'
comment|'# Fake base directory existance'
nl|'\n'
dedent|''
name|'orig_exists'
op|'='
...
string|"'/instance_path/_base/'"
nl|'\n'
string|"'92cfceb39d57d914ed8b14d0e37643de0797ae56.sha1'"
op|')'
op|']'
op|':'
newline|'\n'
...
string|"'/instance_path/_base/'"
nl|'\n'
string|"'92cfceb39d57d914ed8b14d0e37643de0797ae56_sm'"
op|')'
op|']'
op|':'
newline|'\n'
...
name|'fail'
op|'('
string|"'Unexpected path existance check: %s'"
op|'%'
name|'path'
op|')'
newline|'\n'
...
newline|'\n'
nl|'\n'
comment|'# Fake the image service call which lists all registered images'
nl|'\n'
