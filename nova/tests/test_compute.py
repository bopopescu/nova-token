...
newline|'\n'
nl|'\n'
comment|"# Make sure Compute API doesn't try to update the image_ref."
nl|'\n'
comment|"# It should be done on the manager side.  We can't check the DB"
nl|'\n'
comment|"# at the end of this test method because we've called the"
nl|'\n'
comment|'# manager by that point..'
nl|'\n'
name|'orig_update'
op|'='
name|'self'
