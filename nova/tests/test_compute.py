...
newline|'\n'
nl|'\n'
DECL|member|test_reboot_soft_api
dedent|''
name|'def'
name|'test_reboot_soft_api'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_reboot_hard_api
dedent|''
name|'def'
name|'test_reboot_hard_api'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_set_admin_password_api
dedent|''
name|'def'
name|'test_set_admin_password_api'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_snapshot_conflict_backup
dedent|''
name|'def'
name|'test_snapshot_conflict_backup'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_snapshot_conflict_snapshot
dedent|''
name|'def'
name|'test_snapshot_conflict_snapshot'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
indent|'        '
string|'"""Ensure vm_state is ERROR when MigrationError occurs"""'
newline|'\n'
...
nl|'\n'
nl|'\n'
DECL|class|ComputeTestMinRamMinDisk
dedent|''
dedent|''
name|'class'
name|'ComputeTestMinRamMinDisk'
op|'('
name|'test'
op|'.'
name|'TestCase'
