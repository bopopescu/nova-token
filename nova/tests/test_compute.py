...
newline|'\n'
nl|'\n'
DECL|member|test_instance_set_to_error_on_deleted_instance_doesnt_raise
dedent|''
name|'def'
name|'test_instance_set_to_error_on_deleted_instance_doesnt_raise'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|function|fake_allocate_network
name|'def'
name|'fake_allocate_network'
op|'('
name|'context'
op|','
name|'instance'
...
op|':'
newline|'\n'
comment|'# Remove the instance to simulate race condition'
nl|'\n'
indent|'            '
name|'self'
op|'.'
...
newline|'\n'
nl|'\n'
comment|'# NOTE(jkoelker) There is a bit of a stubbing issue here.'
nl|'\n'
comment|'#                fake_network stubs out a bunch of stuff which'
nl|'\n'
comment|'#                this functional test expects to be acting on'
nl|'\n'
comment|'#                the db or the stubs it sets.'
nl|'\n'
dedent|''
name|'self'
op|'.'
