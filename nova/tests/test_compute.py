...
newline|'\n'
nl|'\n'
DECL|member|test_reservation_ids_two_instances_no_wait
dedent|''
dedent|''
dedent|''
name|'def'
name|'test_reservation_ids_two_instances_no_wait'
op|'('
name|'self'
op|')'
op|':'
