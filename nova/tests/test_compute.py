...
newline|'\n'
nl|'\n'
DECL|member|test_update_service_exception
dedent|''
name|'def'
name|'test_update_service_exception'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_update_service_success
dedent|''
name|'def'
name|'test_update_service_success'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_update_available_resource_exception
dedent|''
name|'def'
name|'test_update_available_resource_exception'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
indent|'        '
string|'"""a testcase of update_available_resource raises exception"""'
newline|'\n'
name|'host'
op|'='
string|"'foo'"
...
name|'msg'
op|'='
string|"'Cannot update resource info.'"
newline|'\n'
name|'c1'
op|'='
op|'('
...
newline|'\n'
nl|'\n'
DECL|member|test_update_available_resource_success
dedent|''
name|'def'
name|'test_update_available_resource_success'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
indent|'        '
string|'"""a testcase of update_available_resource finishes with no errors"""'
newline|'\n'
nl|'\n'
DECL|function|dic_key_check
name|'def'
...
string|"'vcpus_avail'"
op|','
string|"'memory_mb_avail'"
op|','
string|"'local_gb_avail'"
op|']'
newline|'\n'
name|'return'
op|'('
...
name|'error'
op|'('
string|"'Pre live migration for %s failed at %s'"
op|','
nl|'\n'
name|'instance_ref'
op|'['
