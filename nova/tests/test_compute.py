...
newline|'\n'
nl|'\n'
DECL|member|test_live_migration_instance_has_no_volume
dedent|''
name|'def'
name|'test_live_migration_instance_has_no_volume'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
indent|'        '
string|'"""Simpler than test_live_migration_instance_has_volume."""'
newline|'\n'
name|'i_ref'
op|'='
name|'self'
...
newline|'\n'
indent|'        '
string|'"""post_live_migration works as expected correctly """'
newline|'\n'
nl|'\n'
name|'i_ref'
op|'='
...
op|')'
newline|'\n'
comment|'# first 2 messages are checked.'
nl|'\n'
name|'compute_manager'
op|'.'
name|'LOG'
