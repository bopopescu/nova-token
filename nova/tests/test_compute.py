...
newline|'\n'
nl|'\n'
DECL|member|test_get_all_by_display_name_regexp
dedent|''
name|'def'
name|'test_get_all_by_display_name_regexp'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
indent|'        '
string|'"""Test searching instances by display_name"""'
newline|'\n'
name|'c'
op|'='
name|'context'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_all_by_server_name_regexp
dedent|''
name|'def'
name|'test_get_all_by_server_name_regexp'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
indent|'        '
string|'"""Test searching instances by server_name"""'
newline|'\n'
name|'c'
op|'='
name|'context'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_all_by_ip_regex
dedent|''
name|'def'
name|'test_get_all_by_ip_regex'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_all_by_ipv6_regex
dedent|''
name|'def'
name|'test_get_all_by_ipv6_regex'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
DECL|function|fake_ipv6_get_by_instance_ref
name|'def'
name|'fake_ipv6_get_by_instance_ref'
op|'('
name|'context'
op|','
name|'instance'
...
name|'sqlalchemy_api'
op|','
string|"'_ipv6_get_by_instance_ref'"
op|','
nl|'\n'
name|'fake_ipv6_get_by_instance_ref'
op|')'
