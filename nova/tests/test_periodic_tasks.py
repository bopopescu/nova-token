...
newline|'\n'
nl|'\n'
comment|'# Ensure initial values are correct'
nl|'\n'
name|'self'
op|'.'
name|'assertEqual'
...
newline|'\n'
nl|'\n'
comment|"# Test the manager's representation of those values"
nl|'\n'
name|'self'
op|'.'
name|'assertEqual'
...
newline|'\n'
nl|'\n'
DECL|member|test_periodic_tasks_immediate_runs_now
dedent|''
name|'def'
name|'test_periodic_tasks_immediate_runs_now'
op|'('
name|'self'
op|')'
op|':'
