...
op|'('
string|"'Am I a useless argument?'"
op|','
name|'True'
op|')'
newline|'\n'
...
newline|'\n'
nl|'\n'
comment|"# Before long, we'll add the real hypervisor drivers here as well"
nl|'\n'
comment|'# with whatever instrumentation they need to work independently of'
nl|'\n'
comment|'# their hypervisor. This way, we can verify that they all act the'
nl|'\n'
comment|'# same.'
nl|'\n'
dedent|''
