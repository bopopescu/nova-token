...
nl|'\n'
nl|'\n'
DECL|class|NovaDBAPITestCase
dedent|''
dedent|''
name|'class'
name|'NovaDBAPITestCase'
op|'('
name|'test'
op|'.'
name|'TestCase'
...
op|':'
newline|'\n'
DECL|member|test_nova_db_api_common
indent|'    '
name|'def'
name|'test_nova_db_api_common'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
comment|'# get access to some db-api method'
nl|'\n'
name|'nova_db_api'
op|'.'
name|'instance_group_get'
newline|'\n'
comment|'# CONF.database.use_tpool is False, so we have no proxy in this case'
nl|'\n'
name|'self'
op|'.'
name|'assertIsInstance'
...
newline|'\n'
nl|'\n'
DECL|member|test_nova_db_api_config_change
dedent|''
name|'def'
name|'test_nova_db_api_config_change'
op|'('
name|'self'
op|')'
op|':'
...
name|'instance_group_get'
newline|'\n'
comment|'# CONF.database.use_tpool is True, so we get tpool proxy in this case'
nl|'\n'
name|'self'
op|'.'
name|'assertIsInstance'
