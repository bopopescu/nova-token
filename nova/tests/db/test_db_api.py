...
newline|'\n'
indent|'        '
string|'"""Test sorting getting all flavours."""'
newline|'\n'
...
newline|'\n'
indent|'        '
string|'"""Check a limit can be applied to db.flavor_get_all."""'
newline|'\n'
...
newline|'\n'
indent|'        '
string|'"""Check results can be returned after marker"""'
newline|'\n'
name|'all_flavors'
op|'='
name|'db'
...
newline|'\n'
nl|'\n'
DECL|member|test_instance_type_extra_specs_update_or_create_retry
dedent|''
name|'def'
name|'test_instance_type_extra_specs_update_or_create_retry'
op|'('
name|'self'
op|')'
op|':'
...
op|','
nl|'\n'
string|"'_instance_type_get_id_from_flavor'"
op|','
name|'get_id'
op|')'
newline|'\n'
