...
newline|'\n'
nl|'\n'
DECL|variable|MULTIPATH_WWID_REGEX
name|'MULTIPATH_WWID_REGEX'
op|'='
name|'re'
op|'.'
name|'compile'
...
newline|'\n'
nl|'\n'
comment|'# Use the device name, be it the WWID, mpathN or custom alias of'
nl|'\n'
comment|'# a device to build the device path. This should be the first item'
nl|'\n'
comment|'# on the first line of output from `multipath -l /dev/${path}`.'
nl|'\n'
indent|'            '
name|'mdev_name'
op|'='
...
newline|'\n'
nl|'\n'
comment|'# Find the WWID for the LUN if we are using mpathN or aliases.'
nl|'\n'
name|'wwid_search'
op|'='
name|'MULTIPATH_WWID_REGEX'
...
newline|'\n'
nl|'\n'
comment|'# Confirm that the device is present.'
nl|'\n'
dedent|''
name|'try'
op|':'
...
name|'_LW'
op|'('
string|'\'Skip faulty line "%(dev_line)s" of\''
nl|'\n'
string|"' multipath device %(mdev)s'"
op|')'
op|','
nl|'\n'
op|'{'
