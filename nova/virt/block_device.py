...
name|'_LI'
op|'('
string|"'Booting with volume %(volume_id)s at '"
nl|'\n'
string|"'%(mountpoint)s'"
op|')'
op|','
...
name|'_LI'
op|'('
string|"'Booting with volume snapshot %(snapshot_id)s at '"
nl|'\n'
string|"'%(mountpoint)s'"
op|')'
op|','
...
name|'_LI'
op|'('
string|"'Booting with volume-backed-image %(image_id)s at '"
nl|'\n'
string|"'%(mountpoint)s'"
op|')'
op|','
...
name|'_LI'
op|'('
string|"'Booting with blank volume at %(mountpoint)s'"
op|')'
op|','
nl|'\n'
op|'{'
