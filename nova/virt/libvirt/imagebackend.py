...
newline|'\n'
nl|'\n'
DECL|member|import_file_cleanup
dedent|''
name|'def'
name|'import_file_cleanup'
op|'('
name|'self'
op|','
name|'local_file'
...
newline|'\n'
indent|'        '
string|'"""Once an import has run, we many no longer need the local file.\n\n        :param local_file: path to the file that was imported.\n        """'
newline|'\n'
nl|'\n'
comment|'# NOTE(mikal): this is a noop for most backends, as they don\'t "import"'
nl|'\n'
comment|'# the file into some sort of storage system.'
nl|'\n'
name|'pass'
newline|'\n'
nl|'\n'
