...
name|'_LE'
op|'('
string|"'Cannot block migrate instance %s with '"
nl|'\n'
string|"'mapped volumes'"
op|')'
op|','
nl|'\n'
name|'instance'
...
name|'_'
op|'('
string|"'Cannot block migrate instance %s with mapped '"
nl|'\n'
string|"'volumes'"
op|')'
op|'%'
...
op|':'
newline|'\n'
comment|'# TODO(berrange) This is following the current'
nl|'\n'
comment|'# (stupid) default logic in libvirt for selecting'
nl|'\n'
comment|'# which disks are copied. In the future, when we'
nl|'\n'
comment|'# can use a libvirt which accepts a list of disks'
nl|'\n'
comment|'# to copy, we will need to adjust this to use a'
nl|'\n'
comment|'# different rule.'
nl|'\n'
comment|'#'
nl|'\n'
comment|'# Our future goal is that a disk needs to be copied'
nl|'\n'
comment|'# if it is a non-cinder volume which is not backed'
nl|'\n'
comment|'# by shared storage. eg it may be an LVM block dev,'
nl|'\n'
comment|'# or a raw/qcow2 file on a local filesystem. We'
nl|'\n'
comment|'# never want to copy disks on NFS, or RBD or any'
nl|'\n'
comment|'# cinder volume'
nl|'\n'
indent|'            '
name|'if'
name|'dev'
