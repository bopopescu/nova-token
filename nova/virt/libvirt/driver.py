...
nl|'\n'
string|'\'to "host-passthrough" to use the host CPU model \''
nl|'\n'
string|'\'exactly; or to "custom" to use a named CPU model. Only \''
nl|'\n'
string|'\'has effect if libvirt_type="kvm|qemu"\''
op|')'
op|','
nl|'\n'
name|'cfg'
