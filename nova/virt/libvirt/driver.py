...
comment|'#'
nl|'\n'
comment|'# TODO(berrange) find out what min version ppc64 needs as it'
nl|'\n'
comment|'# almost certainly wants something newer than this....'
nl|'\n'
...
name|'self'
op|'.'
name|'_do_migration_flag_warnings'
op|'('
op|')'
newline|'\n'
nl|'\n'
...
name|'_'
op|'('
string|"'Running Nova with qemu/kvm virt_type on s390/s390x '"
nl|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|_do_migration_flag_warnings
dedent|''
dedent|''
name|'def'
name|'_do_migration_flag_warnings'
...
nl|'\n'
string|"'option which contains %(flag)s '"
nl|'\n'
...
nl|'\n'
string|"'option which does not contain %(flag)s '"
nl|'\n'
...
name|'_'
op|'('
string|'"Unknown libvirt live migration flag \'%s\'"'
op|')'
op|'%'
name|'s'
newline|'\n'
