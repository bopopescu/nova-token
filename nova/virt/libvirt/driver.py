...
op|','
nl|'\n'
string|"'nfs=nova.virt.libvirt.volume_nfs.NfsVolumeDriver'"
nl|'\n'
op|']'
op|','
nl|'\n'
...
newline|'\n'
nl|'\n'
comment|'# NOTE(bfilippov): save lvm as raw'
nl|'\n'
name|'if'
name|'image_format'
op|'=='
...
name|'_'
op|'('
string|"'Creating ephemeral disk named %(disk_name)s of size '"
nl|'\n'
string|"'%(size_in_gb)s gb at %(fname)s'"
op|')'
op|','
name|'locals'
op|'('
...
newline|'\n'
nl|'\n'
comment|"# NOTE(mikal): we don't go through imagebackend here, as ephemeral"
nl|'\n'
comment|"# disks aren't cached in _base, they're new images each time"
nl|'\n'
dedent|''
name|'ephemeral_gb'
op|'='
...
nl|'\n'
string|'"been detached. Code=%(errcode)s Error=%(e)s"'
op|')'
nl|'\n'
op|'%'
name|'locals'
