...
op|')'
newline|'\n'
comment|'# missing libvirt cpu pinning support'
nl|'\n'
...
newline|'\n'
nl|'\n'
comment|'# TODO(sahid): This method is targetted for removal when the tests'
nl|'\n'
...
name|'id'
newline|'\n'
comment|'# TODO(sahid): A method shutdown should be dressed in Guest'
nl|'\n'
comment|'# to handle when we needto destroy a domain in libvirt.'
nl|'\n'
name|'virt_dom'
op|'='
name|'guest'
...
newline|'\n'
nl|'\n'
comment|'# TODO(sahid): Should be moved in Guest object.'
nl|'\n'
name|'xml'
op|'='
name|'guest'
...
newline|'\n'
nl|'\n'
comment|'# TODO(sahid): This method should return the Guest object'
nl|'\n'
dedent|''
name|'return'
name|'guest'
