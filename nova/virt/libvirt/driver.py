...
nl|'\n'
string|"'Value is per GiB of guest RAM, with lower bound of a '"
nl|'\n'
string|"'minimum of 2 GiB'"
op|'%'
name|'LIVE_MIGRATION_DOWNTIME_DELAY_MIN'
op|')'
op|','
...
nl|'\n'
string|"'operation. Value is per GiB of guest RAM, with lower '"
nl|'\n'
string|"'bound of a minimum of 2 GiB. Should usually be larger '"
nl|'\n'
string|"'than downtime delay * downtime steps. Set to 0 to '"
nl|'\n'
string|"'disable timeouts.'"
op|')'
op|','
nl|'\n'
name|'cfg'
...
newline|'\n'
nl|'\n'
comment|'# TODO(berrange) calculate size of any disks when doing'
nl|'\n'
comment|'# a block migration'
nl|'\n'
dedent|''
name|'return'
name|'ram_gb'
