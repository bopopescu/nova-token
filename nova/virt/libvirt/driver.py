...
newline|'\n'
nl|'\n'
comment|'# NOTE(mdbooth): The 2 lines below look wrong, but are actually'
nl|'\n'
...
nl|'\n'
comment|'# and is therefore undesirable to developers. It also introduces a'
nl|'\n'
comment|'# bug, as it converts all disks to qcow2 regardless of their'
nl|'\n'
comment|'# intended format (config disks are always supposed to be raw). We'
nl|'\n'
comment|'# should aim to remove it. This will not be possible, though, until'
nl|'\n'
comment|'# we can represent the storage layout of a specific instance'
nl|'\n'
