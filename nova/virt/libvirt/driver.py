...
string|"'1.2.2'"
op|','
comment|'# Must always match the version in the gate'
nl|'\n'
DECL|variable|help
name|'help'
op|'='
string|"'Limit use of features from newer libvirt versions. '"
nl|'\n'
string|"'Defaults to the version that is used for automated '"
nl|'\n'
string|"'testing of OpenStack.'"
op|')'
op|','
nl|'\n'
name|'cfg'
...
newline|'\n'
indent|'        '
string|'"""Efficient override of base get_num_instances method."""'
newline|'\n'
name|'return'
name|'self'
op|'.'
...
nl|'\n'
DECL|member|_list_instance_ids
dedent|''
name|'def'
...
newline|'\n'
nl|'\n'
DECL|member|_get_host_cpu_for_guest
dedent|''
name|'def'
name|'_get_host_cpu_for_guest'
op|'('
name|'self'
op|')'
op|':'
...
name|'_LE'
op|'('
string|'"An error occurred while trying to define "'
nl|'\n'
string|'"a domain with xml: %s"'
op|')'
op|','
name|'xml'
op|')'
...
name|'_LE'
op|'('
string|'"An error occurred while enabling hairpin "'
nl|'\n'
string|'"mode on domain with xml: %s"'
op|')'
op|','
nl|'\n'
name|'domain'
