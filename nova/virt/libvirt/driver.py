...
op|')'
newline|'\n'
comment|'# libvirt mempage size report'
nl|'\n'
DECL|variable|MIN_LIBVIRT_MEMPAGES_VERSION
name|'MIN_LIBVIRT_MEMPAGES_VERSION'
op|'='
op|'('
number|'1'
op|','
...
op|')'
newline|'\n'
comment|'# libvirt memory allocation policy for each guest NUMA node'
nl|'\n'
DECL|variable|MIN_LIBVIRT_MEMNODE_VERSION
name|'MIN_LIBVIRT_MEMNODE_VERSION'
op|'='
op|'('
number|'1'
op|','
...
op|')'
newline|'\n'
comment|'# NOTE(stpierre): In certain cases -- e.g., when booting a'
nl|'\n'
comment|'#                 guest to restore its state after restarting'
nl|'\n'
comment|'#                 Nova compute -- the context is not'
nl|'\n'
comment|'#                 populated, which causes this (and'
nl|'\n'
comment|'#                 _create_images_and_backing below) to error.'
nl|'\n'
name|'if'
name|'not'
name|'image_meta'
...
nl|'\n'
comment|"# or we can't find a single cell to acomodate the instance"
nl|'\n'
...
name|'self'
op|'.'
name|'_get_guest_numa_tune_memnodes'
op|'('
nl|'\n'
name|'guest_cpu_numa_config'
op|','
...
newline|'\n'
nl|'\n'
DECL|member|_get_guest_numa_tune_memnodes
dedent|''
dedent|''
dedent|''
name|'def'
...
nl|'\n'
string|'"memory %(progress)d%% remaining; "'
nl|'\n'
string|'"(bytes processed=%(processed)d, "'
nl|'\n'
string|'"remaining=%(remaining)d, "'
nl|'\n'
string|'"total=%(total)d)"'
op|')'
op|','
nl|'\n'
op|'{'
