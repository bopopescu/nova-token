...
op|':'
newline|'\n'
comment|'# TODO(sahid): We should pass a guest object.'
nl|'\n'
indent|'        '
name|'guest'
op|'='
...
op|')'
newline|'\n'
comment|'# TODO(sahid): Need to use guest.get_info. currently to many'
nl|'\n'
comment|'# tests to have to be updated, will do the change soon.'
nl|'\n'
name|'info'
op|'='
name|'guest'
