...
op|','
nl|'\n'
string|"'glusterfs=nova.virt.libvirt.volume.LibvirtGlusterfsVolumeDriver'"
op|','
nl|'\n'
string|"'fibre_channel=nova.virt.libvirt.volume.LibvirtFibreChannelVolumeDriver'"
op|','
nl|'\n'
string|"'scality=nova.virt.libvirt.volume.LibvirtScalityVolumeDriver'"
op|','
nl|'\n'
string|"'gpfs=nova.virt.libvirt.volume.LibvirtGPFSVolumeDriver'"
op|','
nl|'\n'
string|"'quobyte=nova.virt.libvirt.volume.LibvirtQuobyteVolumeDriver'"
op|','
nl|'\n'
op|']'
newline|'\n'
