...
name|'_'
op|'('
string|'"No Volume Connector found."'
op|')'
newline|'\n'
name|'LOG'
op|'.'
...
newline|'\n'
nl|'\n'
DECL|function|_wait_for_block_job
dedent|''
name|'def'
...
name|'_'
op|'('
string|'"List of domains returned by libVirt: %s"'
op|')'
nl|'\n'
op|'%'
name|'dom_ids'
...
newline|'\n'
indent|'        '
string|'"""Preparation for block migration."""'
newline|'\n'
comment|'# NOTE (rmk): When preparing for a block migration, the instance dir'
nl|'\n'
comment|'#             should not exist on the destination hypervisor.'
nl|'\n'
name|'instance_dir'
op|'='
name|'libvirt_utils'
...
name|'_'
op|'('
string|"'skipping disk for %(instance_name)s as it'"
nl|'\n'
string|"' does not have a path'"
op|')'
op|'%'
nl|'\n'
name|'locals'
...
name|'_'
op|'('
string|"'Checking instance files accessability'"
nl|'\n'
string|"'%(instance_path)s'"
op|')'
nl|'\n'
op|'%'
name|'locals'
