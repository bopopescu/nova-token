...
newline|'\n'
nl|'\n'
comment|'# TODO(sdague): remove in Juno'
nl|'\n'
DECL|function|belongs_to_instance_legacy
name|'def'
name|'belongs_to_instance_legacy'
op|'('
name|'disk'
op|')'
op|':'
newline|'\n'
comment|"# We don't want to leak old disks, but at the same time, we"
nl|'\n'
comment|"# don't want to do an unsafe thing. So we will only handle"
nl|'\n'
comment|"# the old filter if it's the system default still."
nl|'\n'
indent|'                '
name|'pattern'
op|'='
...
name|'_LW'
op|'('
string|"'Volume %(disk)s possibly unsafe to '"
nl|'\n'
string|"'remove, please clean up manually'"
op|')'
op|','
nl|'\n'
op|'{'
...
newline|'\n'
nl|'\n'
DECL|function|dummy_fetch_func
dedent|''
dedent|''
name|'def'
name|'dummy_fetch_func'
op|'('
name|'target'
op|','
op|'*'
...
op|':'
newline|'\n'
comment|'# NOTE(sileht): this is never called because the'
nl|'\n'
comment|'# the target have already been created by'
nl|'\n'
comment|'# cdb.make_drive call'
nl|'\n'
indent|'                    '
name|'pass'
newline|'\n'
...
name|'self'
op|'.'
name|'_get_configdrive_image_type'
op|'('
op|')'
newline|'\n'
name|'backend'
...
name|'staticmethod'
newline|'\n'
DECL|member|_get_configdrive_image_type
name|'def'
name|'_get_configdrive_image_type'
op|'('
op|')'
op|':'
newline|'\n'
comment|'# NOTE(sileht): a configdrive is a raw image'
nl|'\n'
comment|'# it works well with rbd, lvm and raw images_type'
nl|'\n'
comment|'# but we must force to raw image_type if the desired'
nl|'\n'
comment|'# images_type is qcow2'
nl|'\n'
indent|'        '
name|'if'
name|'CONF'
...
op|':'
newline|'\n'
comment|'# TODO(ndipanov): Remove this check once the tests are fixed, in'
nl|'\n'
comment|'# reality all code paths should be using instance objects now.'
nl|'\n'
indent|'        '
name|'if'
name|'isinstance'
...
newline|'\n'
nl|'\n'
DECL|member|_is_shared_instance_path
dedent|''
name|'def'
name|'_is_shared_instance_path'
op|'('
...
newline|'\n'
indent|'        '
string|'"""Check if instance path is shared between source and\n        destination of a live migration.\n        """'
newline|'\n'
name|'return'
name|'self'
op|'.'
