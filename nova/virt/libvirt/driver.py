...
op|')'
newline|'\n'
comment|'#NOTE(haomai): destory volumes if needed'
nl|'\n'
name|'if'
name|'CONF'
op|'.'
...
nl|'\n'
comment|'# so forbiden detach if not had this version'
nl|'\n'
indent|'        '
name|'if'
name|'not'
...
op|':'
newline|'\n'
comment|'# We should get image metadata everytime for generating xml'
nl|'\n'
indent|'        '
name|'if'
name|'image_meta'
...
newline|'\n'
nl|'\n'
DECL|member|_pci_device_assignbale
dedent|''
name|'def'
name|'_pci_device_assignbale'
op|'('
name|'self'
op|','
name|'device'
