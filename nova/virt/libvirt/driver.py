...
name|'_'
op|'('
string|'"Shuting down instance from state %s"'
op|')'
op|'%'
name|'state'
op|','
...
newline|'\n'
nl|'\n'
comment|'# NOTE(PhilD): Because the call to get_info can be slow we'
nl|'\n'
comment|"#              don't want to depend just on counting calls"
nl|'\n'
comment|'#              to sleep(1).  Keep the loop count as a backstop'
nl|'\n'
comment|'#              to avoid an infinite while loop, but also break'
nl|'\n'
comment|'#              on the elapsed time.'
nl|'\n'
dedent|''
name|'start_time'
op|'='
...
newline|'\n'
nl|'\n'
DECL|function|_reboot_after_shutdown
name|'def'
name|'_reboot_after_shutdown'
op|'('
name|'dom'
op|')'
op|':'
