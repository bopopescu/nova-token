...
op|':'
newline|'\n'
comment|'# Instance was deleted while listing... ignore it'
nl|'\n'
indent|'                '
name|'pass'
newline|'\n'
...
op|':'
newline|'\n'
comment|'# NOTE(justinsb): We remove the domain definition.'
nl|'\n'
indent|'                '
name|'virt_dom'
op|'.'
...
op|':'
newline|'\n'
comment|'# If we fail to get rid of the directory'
nl|'\n'
comment|"# tree, this shouldn't block deletion of"
nl|'\n'
comment|'# the instance as whole.'
nl|'\n'
indent|'            '
name|'try'
op|':'
...
name|'_'
op|'('
string|'"Failed to cleanup directory %(target)s: %(e)s"'
op|')'
op|'%'
nl|'\n'
name|'locals'
...
newline|'\n'
nl|'\n'
comment|'#NOTE(bfilippov): destroy all LVM disks for this instance'
nl|'\n'
dedent|''
dedent|''
name|'self'
...
newline|'\n'
nl|'\n'
comment|'# TODO(danms) once libvirt has support for LXC hotplug,'
nl|'\n'
comment|'# replace this re-define with use of the'
nl|'\n'
comment|'# VIR_DOMAIN_AFFECT_LIVE & VIR_DOMAIN_AFFECT_CONFIG flags with'
nl|'\n'
comment|'# attachDevice()'
nl|'\n'
dedent|''
dedent|''
dedent|''
...
newline|'\n'
nl|'\n'
comment|'# NOTE(dprince): reset was added in Libvirt 0.9.7'
nl|'\n'
dedent|''
name|'if'
name|'hasattr'
...
newline|'\n'
nl|'\n'
comment|'# Are we using a config drive?'
nl|'\n'
dedent|''
name|'using_config_drive'
op|'='
name|'False'
newline|'\n'
name|'if'
...
newline|'\n'
nl|'\n'
comment|'# target partition for file injection'
nl|'\n'
dedent|''
...
op|':'
newline|'\n'
comment|"# We're using config_drive, so put the files there instead"
nl|'\n'
indent|'                '
name|'cdb'
op|'.'
...
op|':'
newline|'\n'
comment|"# NOTE(mikal): Render the config drive. We can't add instance"
nl|'\n'
comment|'# metadata here until after file injection, as the file injection'
nl|'\n'
comment|'# creates state the openstack metadata relies on.'
nl|'\n'
indent|'            '
name|'cdb'
op|'.'
...
nl|'\n'
comment|'# so we could just return the raw capabilties XML'
nl|'\n'
...
name|'self'
op|'.'
name|'_assert_compute_node_has_enough_disk'
op|'('
name|'ctxt'
op|','
nl|'\n'
...
newline|'\n'
indent|'        '
string|'"""Get compute host\'s information specified by key"""'
newline|'\n'
name|'compute_node_ref'
op|'='
name|'db'
...
newline|'\n'
nl|'\n'
DECL|member|_assert_compute_node_has_enough_disk
dedent|''
name|'def'
name|'_assert_compute_node_has_enough_disk'
op|'('
...
newline|'\n'
indent|'        '
string|'"""Checks if host has enough disk for block migration."""'
newline|'\n'
...
name|'_'
op|'('
string|'"Live Migration failure: %(e)s"'
op|')'
op|'%'
name|'locals'
op|'('
...
newline|'\n'
indent|'            '
string|'""" get the list of io devices from the\n            xml document."""'
newline|'\n'
name|'result'
op|'='
op|'{'
...
newline|'\n'
indent|'        '
string|'"""only used for Resource Pools"""'
newline|'\n'
name|'pass'
newline|'\n'
nl|'\n'
