...
op|','
nl|'\n'
string|"'Override the default disk prefix for the devices '"
nl|'\n'
string|"'attached to a server, which is dependent on '"
nl|'\n'
string|"'libvirt_type. (valid options are: sd, xvd, uvd, vd)'"
op|')'
newline|'\n'
nl|'\n'
nl|'\n'
...
name|'self'
op|','
string|"'_libvirt_xml_cache_info'"
op|')'
op|':'
newline|'\n'
indent|'            '
...
name|'self'
op|','
string|"'_cpuinfo_xml_cache_info'"
op|')'
op|':'
newline|'\n'
indent|'            '
...
nl|'\n'
string|'"removal %(instance_name)s. Code=%(errcode)s"'
nl|'\n'
string|'" Error=%(e)s"'
op|')'
op|'%'
