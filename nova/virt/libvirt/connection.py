...
newline|'\n'
nl|'\n'
DECL|member|setup_vif_network
dedent|''
name|'def'
name|'setup_vif_network'
op|'('
name|'self'
op|','
name|'ctxt'
...
newline|'\n'
comment|'# FIXME: this is dying because DB has no networks for instances'
nl|'\n'
comment|'#networks = db.network_get_all_by_instance(ctxt, instance_id)'
nl|'\n'
comment|'#for network in networks:'
nl|'\n'
comment|'#    self.vif_driver.plug(network)'
nl|'\n'
name|'pass'
newline|'\n'
nl|'\n'
