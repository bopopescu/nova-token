...
name|'help'
op|'='
string|"'Range of ports that ajaxterm should try to bind'"
op|')'
op|','
nl|'\n'
name|'cfg'
...
op|':'
newline|'\n'
comment|"# For raw it's quicker to generate both"
nl|'\n'
comment|'# FIXME(p-draigbrady) the first call here is probably'
nl|'\n'
comment|"# redundant, as it's of no benefit to cache in base?"
nl|'\n'
indent|'                '
name|'call_if_not_exists'
op|'('
...
comment|'# FIXME(p-draigbrady) the first call here is probably'
nl|'\n'
comment|"# redundant, as it's of no benefit have full size in base?"
nl|'\n'
indent|'                    '
name|'disk'
op|'.'
...
newline|'\n'
indent|'        '
string|'"""Grab image to raw format"""'
newline|'\n'
name|'images'
op|'.'
name|'fetch_to_raw'
