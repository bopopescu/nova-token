...
name|'find'
op|'('
string|'"./devices/console[@type=\'file\']/source"'
op|')'
newline|'\n'
name|'if'
name|'node'
...
newline|'\n'
nl|'\n'
comment|'# else if there is a PTY, then try to read latest data from that'
nl|'\n'
dedent|''
name|'node'
op|'='
...
name|'find'
op|'('
string|'"./devices/console[@type=\'pty\']/source"'
op|')'
newline|'\n'
name|'if'
name|'node'
...
name|'_'
op|'('
string|'"Instance %s: Starting migrate_disk_and_power_off"'
op|')'
op|','
nl|'\n'
name|'instance'
...
name|'_'
op|'('
string|'"Instance %s: Starting finish_migration"'
op|')'
op|','
nl|'\n'
name|'instance'
...
name|'_'
op|'('
string|'"Instance %s: Starting finish_revert_migration"'
op|')'
op|','
nl|'\n'
name|'instance'
