...
nl|'\n'
comment|'# NOTE(masumotok): Migrated instances does not have domain'
nl|'\n'
comment|'# definitions.'
nl|'\n'
indent|'                '
...
newline|'\n'
nl|'\n'
comment|'# block migration does not migrate libvirt.xml,'
nl|'\n'
comment|'# to avoid any confusion of admins, create it now.'
nl|'\n'
dedent|''
dedent|''
name|'xml'
