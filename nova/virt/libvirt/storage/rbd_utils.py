...
newline|'\n'
indent|'        '
string|'"""Create a snapshot on an RBD object.\n\n        :volume: Name of RBD object\n        :name: Name of snapshot\n        """'
newline|'\n'
name|'LOG'
op|'.'
name|'debug'
...
name|'debug'
op|'('
string|"'removing snapshot(%(snap)s) on rbd image(%(img)s)'"
op|','
nl|'\n'
op|'{'
string|"'snap'"
...
name|'_LW'
op|'('
string|"'no snapshot(%(snap)s) found on '"
nl|'\n'
string|"'image(%(img)s)'"
op|')'
op|','
