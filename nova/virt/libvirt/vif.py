...
newline|'\n'
nl|'\n'
comment|'# The following classes were removed in the transition from Havana to'
nl|'\n'
comment|'# Icehouse, but may still be referenced in configuration files.  The'
nl|'\n'
comment|'# following stubs allow those configurations to work while logging a'
nl|'\n'
comment|'# deprecation warning.'
nl|'\n'
nl|'\n'
nl|'\n'
DECL|class|_LibvirtDeprecatedDriver
dedent|''
dedent|''
name|'class'
name|'_LibvirtDeprecatedDriver'
op|'('
name|'LibvirtGenericVIFDriver'
op|')'
op|':'
...
name|'_LW'
op|'('
string|'\'VIF driver \\"%s\\" is marked as deprecated and will be \''
nl|'\n'
string|"'removed in the Juno release.'"
op|')'
op|','
nl|'\n'
name|'self'
