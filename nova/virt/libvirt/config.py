...
op|':'
newline|'\n'
comment|'# strip the 0x prefix on each attribute since'
nl|'\n'
comment|'# format_dom puts them back on - note that'
nl|'\n'
comment|'# LibvirtConfigGuestHostdevPCI does not do this...'
nl|'\n'
indent|'                            '
name|'self'
op|'.'
...
op|':'
newline|'\n'
comment|'# NOTE(mriedem): The vlan element can have multiple tag'
nl|'\n'
comment|"# sub-elements but we're currently only storing a single tag"
nl|'\n'
comment|'# id in the vlan attribute.'
nl|'\n'
indent|'                '
name|'for'
name|'sub'
...
op|':'
newline|'\n'
comment|'# Note that only average is mandatory, burst and peak are'
nl|'\n'
comment|'# optional (and all are ints).'
nl|'\n'
indent|'                    '
name|'if'
name|'sub'
...
nl|'\n'
nl|'\n'
DECL|class|LibvirtConfigGuestCPUTuneVCPUSched
dedent|''
dedent|''
name|'class'
...
op|':'
newline|'\n'
comment|'# Generate XML nodes for UEFI boot.'
nl|'\n'
indent|'            '
name|'if'
name|'self'
...
nl|'\n'
comment|'#                            LibvirtConfigGuestInterface'
nl|'\n'
