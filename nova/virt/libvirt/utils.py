...
op|':'
newline|'\n'
comment|'# NOTE(nic): the rbd command supports two methods for'
nl|'\n'
comment|'# specifying a pool name: the "-p" flag, and using the volume'
nl|'\n'
comment|'# name notation "pool_name/volume_name"'
nl|'\n'
comment|'# The latter method supercedes the former, so to guard'
nl|'\n'
comment|'# against slashes in the volume name confusing things, always'
nl|'\n'
comment|'# use the path notation'
nl|'\n'
indent|'        '
name|'rbd_remove'
op|'='
