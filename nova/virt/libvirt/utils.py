...
op|':'
newline|'\n'
comment|'# Systems implementing the S390 architecture support virtual HBAs'
nl|'\n'
comment|'# may be online, or offline. This function should only return'
nl|'\n'
comment|'# virtual HBAs in the online state'
nl|'\n'
indent|'        '
name|'if'
op|'('
...
nl|'\n'
nl|'\n'
DECL|function|perform_unit_add_for_s390
dedent|''
name|'def'
...
newline|'\n'
indent|'    '
string|'"""Write the LUN to the port\'s unit_add attribute."""'
newline|'\n'
comment|'# NOTE If LUN scanning is turned off on systems following the s390,'
nl|'\n'
comment|'# or s390x architecture LUNs need to be added to the configuration'
nl|'\n'
comment|'# using the unit_add call. The unit_add call may fail if a target_wwn'
nl|'\n'
comment|'# is not accessible for the HBA specified by the device_number.'
nl|'\n'
comment|'# This can be an expected situation in multipath configurations.'
nl|'\n'
comment|'# This method will thus only log a warning message in case the'
nl|'\n'
comment|'# unit_add call fails.'
nl|'\n'
name|'LOG'
op|'.'
name|'debug'
op|'('
string|'"perform unit_add for s390: device_number=(%(device_num)s) "'
nl|'\n'
string|'"target_wwn=(%(target_wwn)s) target_lun=(%(target_lun)s)"'
op|','
nl|'\n'
op|'{'
string|"'device_num'"
...
op|')'
newline|'\n'
name|'zfcp_device_command'
op|'='
op|'('
string|'"/sys/bus/ccw/drivers/zfcp/%s/%s/unit_add"'
op|'%'
nl|'\n'
op|'('
name|'device_number'
...
name|'_LW'
op|'('
string|'"unit_add call failed; exit code (%(code)s), "'
nl|'\n'
...
nl|'\n'
nl|'\n'
DECL|function|perform_unit_remove_for_s390
dedent|''
dedent|''
name|'def'
...
newline|'\n'
indent|'    '
string|'"""Write the LUN to the port\'s unit_remove attribute."""'
newline|'\n'
comment|'# If LUN scanning is turned off on systems following the s390, or s390x'
nl|'\n'
comment|'# architecture LUNs need to be removed from the configuration using the'
nl|'\n'
comment|'# unit_remove call. The unit_remove call may fail if the LUN is not'
nl|'\n'
comment|'# part of the configuration anymore. This may be an expected situation.'
nl|'\n'
comment|'# For exmple, if LUN scanning is turned on.'
nl|'\n'
comment|'# This method will thus only log a warning message in case the'
nl|'\n'
comment|'# unit_remove call fails.'
nl|'\n'
name|'LOG'
op|'.'
name|'debug'
op|'('
string|'"perform unit_remove for s390: device_number=(%(device_num)s) "'
nl|'\n'
string|'"target_wwn=(%(target_wwn)s) target_lun=(%(target_lun)s)"'
op|','
nl|'\n'
...
op|'='
op|'('
string|'"/sys/bus/ccw/drivers/zfcp/%s/%s/unit_remove"'
op|'%'
nl|'\n'
op|'('
name|'device_number'
...
name|'_LW'
op|'('
string|'"unit_remove call failed; exit code (%(code)s), "'
nl|'\n'
string|'"stderr (%(stderr)s)"'
op|')'
op|','
