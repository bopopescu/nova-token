...
name|'help'
op|'='
string|"'The iSCSI transport to use to connect to target in case '"
nl|'\n'
string|"'offload support is desired. Supported transports are '"
nl|'\n'
string|"'be2iscsi, bnx2i, cxgb3i, cxgb4i, qla4xx and ocs. '"
nl|'\n'
