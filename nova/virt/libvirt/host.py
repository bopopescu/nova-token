...
op|')'
newline|'\n'
comment|"# NOTE(mriedem): Don't attempt to get baseline CPU features"
nl|'\n'
comment|"# if libvirt can't determine the host cpu model."
nl|'\n'
name|'if'
op|'('
name|'hasattr'
...
newline|'\n'
nl|'\n'
DECL|member|is_cpu_control_policy_capable
dedent|''
name|'def'
...
op|':'
newline|'\n'
comment|'# mount options and split options'
nl|'\n'
indent|'                    '
name|'bits'
op|'='
...
newline|'\n'
nl|'\n'
DECL|member|is_migratable_xml_flag
dedent|''
dedent|''
name|'def'
...
newline|'\n'
indent|'        '
string|'"""Determines whether libvirt is supporting dump XML suitable for\n        migration.\n        """'
newline|'\n'
name|'return'
name|'getattr'
op|'('
