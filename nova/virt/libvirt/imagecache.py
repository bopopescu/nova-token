...
newline|'\n'
indent|'        '
string|'"""Store base swap images for later examination."""'
newline|'\n'
name|'names'
op|'='
name|'ent'
...
name|'debug'
op|'('
string|"'Adding %s into backend swap images'"
op|','
name|'ent'
op|')'
newline|'\n'
...
name|'debug'
op|'('
string|"'Failed to get disk backing file: %s'"
op|','
nl|'\n'
name|'disk_path'
op|')'
...
name|'_LI'
op|'('
string|"'%(id)s (%(base_file)s): generating '"
nl|'\n'
string|"'checksum'"
op|')'
op|','
...
newline|'\n'
nl|'\n'
DECL|member|_remove_old_enough_file
dedent|''
name|'def'
...
newline|'\n'
indent|'        '
string|'"""Remove a single swap or base file if it is old enough."""'
newline|'\n'
name|'exists'
op|','
name|'age'
...
op|')'
newline|'\n'
DECL|function|_inner_remove_old_enough_file
name|'def'
name|'_inner_remove_old_enough_file'
op|'('
op|')'
op|':'
newline|'\n'
comment|'# NOTE(mikal): recheck that the file is old enough, as a new'
nl|'\n'
comment|'# user of the file might have come along while we were waiting'
nl|'\n'
...
name|'_LI'
op|'('
string|"'Removing base or swap file: %s'"
op|')'
op|','
name|'base_file'
op|')'
...
name|'_LI'
op|'('
string|"'Base or swap file too young to remove: %s'"
op|')'
op|','
nl|'\n'
name|'base_file'
...
op|':'
newline|'\n'
comment|'# NOTE(jichenjc) The lock file will be constructed first'
nl|'\n'
comment|'# time the image file was accessed. the lock file looks'
nl|'\n'
comment|'# like nova-9e881789030568a317fad9daae82c5b1c65e0d4a'
nl|'\n'
comment|'# or nova-03d8e206-6500-4d91-b47d-ee74897f9b4e'
nl|'\n'
comment|'# according to the original file name'
nl|'\n'
indent|'                    '
name|'lockutils'
op|'.'
...
name|'debug'
op|'('
string|"'Failed to remove %(lock_file)s, '"
nl|'\n'
string|"'error was %(error)s'"
op|','
nl|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|_remove_swap_file
dedent|''
dedent|''
dedent|''
dedent|''
name|'def'
name|'_remove_swap_file'
op|'('
name|'self'
op|','
name|'base_file'
...
newline|'\n'
indent|'        '
string|'"""Remove a single swap base file if it is old enough."""'
newline|'\n'
name|'maxage'
op|'='
name|'CONF'
...
newline|'\n'
nl|'\n'
DECL|member|_age_and_verify_swap_images
dedent|''
dedent|''
dedent|''
dedent|''
...
name|'_LW'
op|'('
string|"'%s swap image was used by instance'"
nl|'\n'
string|"' but no back files existing!'"
op|')'
op|','
name|'error_image'
op|')'
