...
nl|'\n'
nl|'\n'
DECL|function|_lock_for_refresh
dedent|''
name|'def'
name|'_lock_for_refresh'
op|'('
name|'base_file'
op|')'
op|':'
...
nl|'\n'
nl|'\n'
DECL|function|refresh_timestamp
dedent|''
name|'def'
...
newline|'\n'
indent|'    '
string|'"""Update age of a file not to removed from the cache."""'
newline|'\n'
nl|'\n'
op|'@'
name|'_lock_for_refresh'
...
op|')'
newline|'\n'
DECL|function|inner_refresh_timestamp
name|'def'
name|'inner_refresh_timestamp'
op|'('
op|')'
op|':'
newline|'\n'
...
newline|'\n'
nl|'\n'
comment|'# TODO(arata): If the lock is already owned by other process'
nl|'\n'
comment|'# (or thread), it means the process is refreshing or removing'
nl|'\n'
comment|'# the base file. Then, this process has nothing to do after'
nl|'\n'
comment|'# the lock is acquired, because the base file is already'
nl|'\n'
comment|'# refreshed (and should not be removed) or removed.'
nl|'\n'
comment|'# So, unless the lock is immediately acquired, this method'
nl|'\n'
comment|'# should return immediately instead of blocking meaninglessly.'
nl|'\n'
nl|'\n'
op|'@'
name|'_lock_for_refresh'
...
op|')'
newline|'\n'
DECL|function|inner_remove_base_file
name|'def'
name|'inner_remove_base_file'
op|'('
op|')'
op|':'
newline|'\n'
...
op|')'
newline|'\n'
comment|'# TODO(arata): Should not block to acquire the lock here'
nl|'\n'
comment|'# as well in _remove_base_file()'
nl|'\n'
name|'refresh_timestamp'
op|'('
name|'base_file'
