...
op|':'
newline|'\n'
comment|'# NOTE(mriedem): In case the image_meta object was constructed from'
nl|'\n'
comment|'# an empty dict, like in the case of evacuate, we have to first check'
nl|'\n'
comment|'# if disk_format is set on the ImageMeta object.'
nl|'\n'
indent|'        '
name|'if'
op|'('
