...
newline|'\n'
nl|'\n'
DECL|variable|SHOULD_LOG_DISCARD_WARNING
name|'SHOULD_LOG_DISCARD_WARNING'
op|'='
name|'True'
newline|'\n'
nl|'\n'
...
newline|'\n'
nl|'\n'
comment|'# Configure usage of discard'
nl|'\n'
dedent|''
dedent|''
name|'if'
...
name|'_LW'
op|'('
string|"'Unable to attach %(type)s volume '"
nl|'\n'
string|"'%(serial)s with discard enabled: qemu '"
nl|'\n'
string|"'%(qemu)s and libvirt %(libvirt)s or '"
nl|'\n'
string|"'later are required.'"
op|')'
op|','
nl|'\n'
op|'{'
