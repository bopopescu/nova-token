...
nl|'\n'
nl|'\n'
string|'"""Libvirt volume driver for ScaleIO."""'
newline|'\n'
nl|'\n'
name|'from'
name|'os_brick'
...
nl|'\n'
nl|'\n'
DECL|class|LibvirtScaleIOVolumeDriver
name|'class'
...
name|'debug'
op|'('
string|'"Attached ScaleIO volume %s."'
op|','
name|'device_info'
op|')'
newline|'\n'
