...
newline|'\n'
comment|'# TODO(mriedem): change the scality volume driver in cinder to set'
nl|'\n'
comment|'# the export and name keys rather than the sofs_path so this is'
nl|'\n'
...
newline|'\n'
indent|'        '
string|'"""Detects whether Scality SOFS is already mounted."""'
newline|'\n'
name|'mount_path'
op|'='
name|'CONF'
