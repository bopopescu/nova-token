...
name|'Exception'
op|'('
string|"'Unable to create VDI on SR %s'"
op|'%'
name|'sr_ref'
op|')'
newline|'\n'
...
name|'Exception'
op|'('
string|"'Unable to create VBD on SR %s'"
op|'%'
name|'sr_ref'
op|')'
newline|'\n'
...
op|')'
newline|'\n'
comment|'# TODO: there might be some timing issues here'
nl|'\n'
name|'self'
op|'.'
name|'_conn'
...
nl|'\n'
comment|'#yield self._destroy_vdbs(sr_ref)'
nl|'\n'
comment|'#yield self._destroy_vdis(sr_ref)'
nl|'\n'
comment|'# Destroy PDBs'
nl|'\n'
indent|'        '
name|'pbds'
op|'='
