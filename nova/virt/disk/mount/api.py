...
op|':'
newline|'\n'
comment|'# TODO(berrange) we could mount images of'
nl|'\n'
comment|'# type LocalBlockImage directly without'
nl|'\n'
comment|'# involving loop or nbd devices'
nl|'\n'
comment|'#'
nl|'\n'
comment|'# We could also mount RBDImage directly'
nl|'\n'
