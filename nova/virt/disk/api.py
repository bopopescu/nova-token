...
newline|'\n'
nl|'\n'
DECL|variable|SUPPORTED_FS_TO_EXTEND
name|'SUPPORTED_FS_TO_EXTEND'
op|'='
op|'('
nl|'\n'
name|'FS_FORMAT_EXT2'
...
newline|'\n'
nl|'\n'
DECL|variable|_DEFAULT_FILE_SYSTEM
...
nl|'\n'
nl|'\n'
DECL|function|get_file_extension_for_os_type
dedent|''
name|'def'
...
newline|'\n'
nl|'\n'
comment|'# Currently can only resize FS in local images'
nl|'\n'
name|'if'
name|'not'
name|'isinstance'
...
nl|'\n'
nl|'\n'
DECL|function|is_image_extendable
dedent|''
name|'def'
name|'is_image_extendable'
op|'('
...
newline|'\n'
indent|'    '
string|'"""Check whether we can extend the image."""'
newline|'\n'
name|'LOG'
op|'.'
name|'debug'
op|'('
string|"'Checking if we can extend filesystem inside %(image)s.'"
op|','
nl|'\n'
op|'{'
string|"'image'"
...
newline|'\n'
nl|'\n'
comment|'# For anything except a local raw file we must'
nl|'\n'
comment|'# go via the VFS layer'
nl|'\n'
name|'if'
op|'('
name|'not'
...
op|':'
newline|'\n'
comment|'# FIXME(sahid): At this step we probably want to break the'
nl|'\n'
comment|'# process if something wrong happens however our CI'
nl|'\n'
comment|'# provides a bad configuration for libguestfs reported in'
nl|'\n'
comment|'# the bug lp#1413142. When resolved we should remove this'
nl|'\n'
comment|'# except to let the error to be propagated.'
nl|'\n'
indent|'            '
name|'LOG'
op|'.'
...
name|'debug'
op|'('
string|"'No device found for path: %s'"
op|','
name|'mount_dir'
op|')'
newline|'\n'
...
nl|'\n'
string|'"files=%(files)s partition=%(partition)s"'
op|','
nl|'\n'
op|'{'
string|"'image'"
...
name|'debug'
op|'('
string|"'No release necessary for block device %s'"
op|'%'
nl|'\n'
name|'container_root_device'
op|')'
...
name|'_LE'
op|'('
string|"'Failed to teardown container filesystem'"
op|')'
op|')'
newline|'\n'
nl|'\n'
...
name|'_LE'
op|'('
string|"'Failed to umount container filesystem'"
op|')'
op|')'
newline|'\n'
nl|'\n'
...
name|'_LW'
op|'('
string|"'Ignoring error injecting %(inject)s into '"
nl|'\n'
string|"'image (%(e)s)'"
op|')'
op|','
