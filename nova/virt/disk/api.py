...
name|'_'
op|'('
string|"'Cannot resize filesystem %s to a smaller size.'"
op|')'
op|','
nl|'\n'
name|'image'
...
name|'_'
op|'('
string|"'Checking if we can resize the COW image %s.'"
op|')'
op|','
name|'image'
op|')'
...
name|'_'
op|'('
string|"'File injection failed for image %(image)s with '"
nl|'\n'
...
name|'_'
op|'('
string|"'Checking if we can resize the non-COW image %s.'"
op|')'
op|','
name|'image'
op|')'
...
newline|'\n'
indent|'    '
string|'"""Bind device to a filesystem"""'
newline|'\n'
name|'if'
name|'src'
op|':'
...
nl|'\n'
string|'"metadata=%(metadata)s admin_password=ha-ha-not-telling-you "'
nl|'\n'
...
nl|'\n'
string|'"admin_passwd=ha-ha-not-telling-you"'
op|')'
op|'%'
nl|'\n'
name|'locals'
