...
newline|'\n'
indent|'    '
string|'"""Base Exception class for all hyper-v errors."""'
newline|'\n'
...
nl|'\n'
nl|'\n'
DECL|class|VmResourceAllocationError
dedent|''
dedent|''
name|'class'
name|'VmResourceAllocationError'
op|'('
name|'HyperVError'
op|')'
op|':'
newline|'\n'
indent|'    '
string|'"""Raised when Hyper-V is unable to create or add a resource to\n    a VM\n    """'
newline|'\n'
DECL|member|__init__
name|'def'
name|'__init__'
...
nl|'\n'
nl|'\n'
DECL|class|VmOperationError
dedent|''
dedent|''
name|'class'
name|'VmOperationError'
op|'('
name|'HyperVError'
op|')'
op|':'
newline|'\n'
indent|'    '
string|'"""Raised when Hyper-V is unable to change the state of\n    a VM (start/stop/reboot/destroy)\n    """'
newline|'\n'
DECL|member|__init__
name|'def'
name|'__init__'
...
name|'Duplicate'
op|'('
string|"'Attempted to create duplicate name %s'"
op|'%'
nl|'\n'
name|'instance'
op|'.'
...
indent|'            '
name|'raise'
name|'VmResourceAllocationException'
op|'('
...
name|'error'
op|'('
string|'"Failed creating a new port on the external vswitch"'
op|')'
newline|'\n'
name|'raise'
name|'VmResourceAllocationError'
...
nl|'\n'
comment|'#\\\\WIN-P5IG7367DAG\\root\\virtualization:Msvm_ConcreteJob.InstanceID="8A496B9C-AF4D-4E98-BD3C-1128CD85320D"'
nl|'\n'
name|'inst_id'
op|'='
name|'jobpath'
