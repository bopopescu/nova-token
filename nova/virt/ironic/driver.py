...
op|')'
newline|'\n'
comment|'# TODO(mrda): It would be better to use instance.get_flavor() here'
nl|'\n'
comment|"# but right now that doesn't include extra_specs which are required"
nl|'\n'
name|'flavor'
op|'='
name|'objects'
...
name|'debug'
op|'('
string|'"Ironic node %(node)s is now unprovisioned"'
op|','
nl|'\n'
name|'dict'
op|'('
...
newline|'\n'
indent|'        '
string|'"""Return the currently known stats for all Ironic nodes.\n\n        :param refresh: Boolean value; If True run update first. Ignored by\n            this driver.\n        :returns: a list of dictionaries; each dictionary contains the\n            stats for a node.\n\n        """'
newline|'\n'
name|'caps'
op|'='
op|'['
