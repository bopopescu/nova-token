...
newline|'\n'
nl|'\n'
DECL|variable|_UNPROVISION_STATES
...
newline|'\n'
nl|'\n'
DECL|member|_validate_instance_and_node
dedent|''
name|'def'
...
newline|'\n'
nl|'\n'
comment|"# add this key because it's different in instance_info for some reason"
nl|'\n'
name|'props'
op|'['
string|"'vcpus'"
...
op|':'
newline|'\n'
comment|'# FIXME(lucasagomes): The "retry_on_conflict" parameter was added'
nl|'\n'
comment|'# to basically causes the deployment to fail faster in case the'
nl|'\n'
comment|'# node picked by the scheduler is already associated with another'
nl|'\n'
comment|'# instance due bug #1341420.'
nl|'\n'
indent|'            '
name|'self'
op|'.'
...
name|'_LE'
op|'('
string|'"Failed to build configdrive: %s"'
op|')'
op|'%'
nl|'\n'
name|'six'
...
op|':'
newline|'\n'
comment|'# flat network, go ahead and allow the port to be bound'
nl|'\n'
indent|'            '
name|'return'
name|'super'
