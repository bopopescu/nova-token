...
newline|'\n'
nl|'\n'
comment|'# Always checking allows us to catch the case where Nova thinks there'
nl|'\n'
comment|'# are available resources on the Node, but Ironic does not (because it'
nl|'\n'
comment|'# is not in a usable state): https://launchpad.net/bugs/1503453'
nl|'\n'
dedent|''
name|'if'
name|'self'
