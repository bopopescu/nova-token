...
name|'_'
op|'('
string|'"The password-based access to VNC consoles will be "'
nl|'\n'
string|'"removed in the next release. Please, switch to "'
nl|'\n'
string|'"using the default value (this will disable password "'
nl|'\n'
string|'"protection on the VNC console)."'
op|')'
op|')'
newline|'\n'
name|'opt_pass'
