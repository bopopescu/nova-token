...
nl|'\n'
nl|'\n'
DECL|function|_is_valid_ds_record
dedent|''
name|'def'
name|'_is_valid_ds_record'
op|'('
name|'ds'
op|','
...
op|':'
newline|'\n'
comment|'# Total vcpus is the sum of all pCPUs of individual'
nl|'\n'
comment|'# hosts. The overcommitment ratio is factored in by the'
nl|'\n'
comment|'# scheduler'
nl|'\n'
indent|'                        '
