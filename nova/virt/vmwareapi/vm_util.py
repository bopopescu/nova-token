...
op|':'
newline|'\n'
comment|'# TODO(hartsocks): refactor get_datastore_ref_and_name and Datastore object'
nl|'\n'
comment|'# such that this does not need to exist and the Datastore object holds the'
nl|'\n'
comment|'# correct values pulled in by dynamic properties calls.'
nl|'\n'
comment|'# Look to move to ds_util module.'
nl|'\n'
indent|'    '
name|'ds'
op|'='
