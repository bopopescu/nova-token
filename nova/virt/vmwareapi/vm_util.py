...
newline|'\n'
indent|'        '
string|'"""CpuLimits object holds instance cpu limits for convenience."""'
newline|'\n'
name|'self'
op|'.'
name|'cpu_limit'
