...
newline|'\n'
nl|'\n'
comment|'# A simple cache for storing inventory folder references.'
nl|'\n'
comment|'# Format: {inventory_path: folder_ref}'
nl|'\n'
DECL|variable|_FOLDER_PATH_REF_MAPPING
name|'_FOLDER_PATH_REF_MAPPING'
op|'='
op|'{'
op|'}'
newline|'\n'
...
number|'0'
newline|'\n'
comment|"# The VirtualEthernetCardResourceAllocation has 'share' instead of"
nl|'\n'
comment|"# 'shares'."
nl|'\n'
dedent|''
...
nl|'\n'
nl|'\n'
DECL|function|create_serial_port_spec
dedent|''
name|'def'
name|'create_serial_port_spec'
op|'('
...
newline|'\n'
indent|'    '
string|'"""Creates config spec for serial port."""'
newline|'\n'
name|'if'
name|'not'
name|'CONF'
...
name|'create'
op|'('
string|"'ns0:VirtualSerialPortURIBackingInfo'"
op|')'
newline|'\n'
name|'backing'
op|'.'
...
name|'backing'
newline|'\n'
comment|'# we are using unique negative integers as temporary keys'
nl|'\n'
name|'serial_port'
op|'.'
name|'key'
...
op|':'
newline|'\n'
comment|'# externalId is only supported from vCenter 6.0 onwards'
nl|'\n'
indent|'            '
name|'if'
name|'hasattr'
...
newline|'\n'
nl|'\n'
comment|'# vnic limits are only supported from version 6.0'
nl|'\n'
name|'if'
name|'vif_limits'
name|'and'
...
name|'_'
op|'('
string|"'Limits only supported from vCenter 6.0 and above'"
op|')'
newline|'\n'
name|'raise'
name|'exception'
...
nl|'\n'
nl|'\n'
DECL|function|_get_bus_number_for_scsi_controller
dedent|''
name|'def'
...
newline|'\n'
indent|'    '
string|'"""Return usable bus number when create new SCSI controller."""'
newline|'\n'
comment|'# Every SCSI controller will take a unique bus number'
nl|'\n'
name|'taken'
op|'='
op|'['
...
op|']'
newline|'\n'
comment|'# The max bus number for SCSI controllers is 3'
nl|'\n'
name|'for'
name|'i'
name|'in'
...
name|'constants'
op|'.'
name|'SCSI_MAX_CONTROLLER_NUMBER'
op|')'
op|':'
newline|'\n'
indent|'        '
...
name|'_'
op|'('
string|"'Only %d SCSI controllers are allowed to be '"
nl|'\n'
string|"'created on this instance.'"
op|')'
op|'%'
name|'constants'
op|'.'
...
newline|'\n'
nl|'\n'
comment|'# Get free bus number for new SCSI controller.'
nl|'\n'
name|'bus_number'
op|'='
number|'0'
...
nl|'\n'
nl|'\n'
DECL|function|get_cluster_ref_by_name
dedent|''
dedent|''
name|'def'
...
newline|'\n'
indent|'    '
string|'"""Get reference to the vCenter cluster with the specified name."""'
newline|'\n'
name|'all_clusters'
op|'='
name|'get_all_cluster_mors'
...
name|'session'
op|','
name|'parent_folder_ref'
op|','
name|'name'
op|')'
op|':'
newline|'\n'
comment|'# Get list of child entities for the parent folder'
nl|'\n'
indent|'    '
name|'prop_val'
op|'='
...
newline|'\n'
nl|'\n'
comment|'# Return if the child folder with input name is already present'
nl|'\n'
name|'for'
name|'child_entity'
name|'in'
...
name|'debug'
op|'('
string|'"Creating folder: %(name)s. Parent ref: %(parent)s."'
op|','
nl|'\n'
op|'{'
string|"'name'"
...
name|'_LI'
op|'('
string|'"Created folder: %(name)s in parent %(parent)s."'
op|')'
op|','
nl|'\n'
op|'{'
...
name|'debug'
op|'('
string|'"Folder already exists: %(name)s. Parent ref: %(parent)s."'
op|','
nl|'\n'
op|'{'
string|"'name'"
...
nl|'\n'
nl|'\n'
DECL|function|folder_ref_cache_update
dedent|''
name|'def'
...
nl|'\n'
nl|'\n'
DECL|function|folder_ref_cache_get
dedent|''
name|'def'
