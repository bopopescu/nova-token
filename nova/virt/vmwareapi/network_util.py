...
nl|'\n'
nl|'\n'
DECL|function|_get_network_obj
name|'def'
name|'_get_network_obj'
op|'('
name|'session'
op|','
...
op|'}'
newline|'\n'
comment|'# network_objects is actually a RetrieveResult object from vSphere API call'
nl|'\n'
name|'for'
name|'obj_content'
name|'in'
...
op|')'
newline|'\n'
comment|'# NOTE(asomya): This only works on ESXi if the port binding'
nl|'\n'
comment|'# is set to ephemeral'
nl|'\n'
comment|'# For a VLAN the network name will be the UUID. For a VXLAN'
nl|'\n'
comment|'# network this will have a VXLAN prefix and then the'
nl|'\n'
...
name|'debug'
op|'('
string|'"Network %s not found on cluster!"'
op|','
name|'network_name'
op|')'
newline|'\n'
...
newline|'\n'
indent|'    '
string|'"""Get the vlan id and vswitch associated with the port group."""'
newline|'\n'
name|'host_mor'
op|'='
name|'vm_util'
