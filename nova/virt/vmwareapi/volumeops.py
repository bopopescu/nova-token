...
name|'_'
op|'('
string|"'%s does not support disk '"
nl|'\n'
string|"'hotplug.'"
op|')'
op|'%'
...
newline|'\n'
nl|'\n'
comment|"# Remove key-value pair <volume_id, vmdk_uuid> from instance's"
nl|'\n'
comment|'# extra config. Setting value to empty string will remove the key.'
nl|'\n'
name|'self'
op|'.'
name|'_update_volume_details'
