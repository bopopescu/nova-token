...
name|'classmethod'
newline|'\r\n'
DECL|member|get_vswitches_for_vlan_interface
name|'def'
...
newline|'\r\n'
indent|'        '
string|'""" Gets the list of vswitches associated with the physical\r\n        network adapter with the name supplied"""'
newline|'\r\n'
...
newline|'\r\n'
name|'vswicthes_conn_to_physical_nic'
op|'='
op|'['
op|']'
newline|'\r\n'
comment|'#For each vSwitch check  if it is associated with the network adapter'
nl|'\r\n'
name|'for'
name|'elem'
name|'in'
...
name|'classmethod'
newline|'\r\n'
DECL|member|check_if_vlan_id_is_proper
name|'def'
...
newline|'\r\n'
indent|'        '
string|'""" Check if the vlan id associated with the port group matches the\r\n        vlan tag supplied """'
newline|'\r\n'
name|'host_mor'
op|'='
name|'session'
