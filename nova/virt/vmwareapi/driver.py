...
op|')'
newline|'\n'
comment|'# TODO(garyk): Update this with oslo.vmware method. The session.pbm'
nl|'\n'
comment|'# is lazy loaded so this enables us to update this entry on the fly'
nl|'\n'
dedent|''
name|'self'
op|'.'
...
name|'_LW'
op|'('
string|"'Instance cannot be found in host, or in an '"
nl|'\n'
