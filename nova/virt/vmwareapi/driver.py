...
name|'_LW'
op|'('
string|'\'The "cluster_name" setting should have only one \''
nl|'\n'
string|"'cluster name. The capability of allowing '"
nl|'\n'
string|"'multiple clusters may be dropped in the '"
nl|'\n'
string|"'Liberty release.'"
op|')'
op|')'
newline|'\n'
nl|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|_normalize_nodename
dedent|''
name|'def'
...
newline|'\n'
nl|'\n'
comment|"# Return it unmodified if it's not in the legacy format"
nl|'\n'
name|'if'
name|'match'
name|'is'
...
newline|'\n'
indent|'        '
string|'"""Retrieve vmops object for this node."""'
newline|'\n'
name|'resource'
op|'='
name|'self'
...
newline|'\n'
indent|'        '
string|'"""Retrieve VCState object for this node."""'
newline|'\n'
name|'resource'
op|'='
name|'self'
...
op|')'
newline|'\n'
comment|'# TODO(garyk): update the volumeops to read the state form the'
nl|'\n'
comment|'# VM instead of relying on a instance flag'
nl|'\n'
name|'instance'
op|'.'
name|'vm_state'
