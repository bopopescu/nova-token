...
newline|'\n'
nl|'\n'
comment|'# TODO(kirankv) we can avoid creating multiple vmops and volumeops'
nl|'\n'
comment|'# if we make them utility class so that cluster is passed as a'
nl|'\n'
comment|'# parameter to the method'
nl|'\n'
name|'added_nodes'
op|'='
name|'set'
...
name|'_'
op|'('
string|'"Removing node %s since its removed from"'
nl|'\n'
string|'" nova.conf"'
op|')'
op|'%'
