...
newline|'\r\n'
indent|'    '
string|'"""Start the data transfer from the read handle to the write handle."""'
newline|'\r\n'
...
newline|'\r\n'
indent|'    '
string|'""" Download a fake image from the nova local file repository for testing\r\n    purposes.\r\n    """'
newline|'\r\n'
name|'LOG'
op|'.'
name|'debug'
...
newline|'\r\n'
indent|'    '
string|'""" Upload a dummy vmdk from the ESX host to the local file repository of\r\n    the nova node for testing purposes.\r\n    """'
newline|'\r\n'
name|'LOG'
op|'.'
name|'debug'
