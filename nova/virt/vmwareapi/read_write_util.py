...
newline|'\r\n'
indent|'        '
string|'"""Initialize the file handle."""'
newline|'\r\n'
name|'self'
op|'.'
name|'eof'
...
newline|'\r\n'
indent|'        '
string|'"""Destructor. Close the file handle if the same has been forgotten."""'
newline|'\r\n'
name|'self'
op|'.'
name|'close'
...
newline|'\r\n'
indent|'        '
string|'"""Initialize with the glance host specifics."""'
newline|'\r\n'
name|'base_url'
op|'='
...
newline|'\r\n'
indent|'        '
string|'"""Get the image properties like say OS Type and the Adapter Type"""'
newline|'\r\n'
name|'return'
op|'{'
...
newline|'\r\n'
indent|'    '
string|'"""Local file read handler class"""'
newline|'\r\n'
nl|'\r\n'
DECL|member|__init__
name|'def'
...
newline|'\r\n'
indent|'        '
string|'"""Initialize the file path"""'
newline|'\r\n'
name|'self'
op|'.'
name|'path'
...
newline|'\r\n'
indent|'    '
string|'"""Local file write handler Class"""'
newline|'\r\n'
nl|'\r\n'
DECL|member|__init__
name|'def'
...
newline|'\r\n'
indent|'        '
string|'"""Intialize the file handle."""'
newline|'\r\n'
name|'self'
op|'.'
name|'eof'
...
newline|'\r\n'
indent|'        '
string|'"""Initialize the file specifics."""'
newline|'\r\n'
name|'base_url'
op|'='
string|'"%s://%s/folder/%s"'
