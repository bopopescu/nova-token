...
name|'value'
newline|'\n'
comment|'# Managed Object Reference _type'
nl|'\n'
...
newline|'\n'
nl|'\n'
comment|'# A managed object is a local representation of a'
nl|'\n'
comment|'# remote object that you can reference using the'
nl|'\n'
...
newline|'\n'
nl|'\n'
comment|'# we use __setattr__ here because below the'
nl|'\n'
comment|'# default setter has been altered for this class.'
nl|'\n'
dedent|''
name|'object'
op|'.'
