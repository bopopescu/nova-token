...
name|'_'
op|'('
string|'"No files have been added yet"'
op|')'
op|')'
newline|'\r\n'
...
name|'_'
op|'('
string|'"File- \'%s\' is not there in the datastore"'
op|')'
op|'%'
name|'file_path'
op|')'
...
name|'_'
op|'('
string|'"Virtual Machine with ref %s is not there"'
op|')'
op|'%'
name|'vm_ref'
op|')'
...
name|'_'
op|'('
string|'" No Virtual Machine has been registered yet"'
op|')'
op|')'
newline|'\r\n'
dedent|''
...
nl|'\r\n'
comment|'#dataobects of the type in the inventory'
nl|'\r\n'
name|'if'
name|'obj_ref'
op|'=='
