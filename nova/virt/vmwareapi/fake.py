...
nl|'\n'
comment|"# data objects of the specified 'type' in the entire inventory."
nl|'\n'
comment|'# This gets invoked by vim_util.get_objects.'
nl|'\n'
indent|'                    '
name|'mdo_refs'
op|'='
...
nl|'\n'
comment|'# the above will retrieve all datastores in the given cluster.'
nl|'\n'
indent|'                    '
name|'parent_mdo'
op|'='
...
op|':'
newline|'\n'
comment|'# This means that we are retrieving props of the given managed'
nl|'\n'
comment|'# data object. This gets invoked by'
nl|'\n'
