...
nl|'\r\n'
nl|'\r\n'
DECL|function|build_selcetion_spec
name|'def'
name|'build_selcetion_spec'
op|'('
name|'client_factory'
op|','
name|'name'
...
newline|'\r\n'
indent|'    '
string|'""" Builds the Recursive Traversal Spec to traverse the object managed\r\n    object hierarchy """'
newline|'\r\n'
...
op|')'
newline|'\r\n'
comment|'#For getting to hostFolder from datacnetr'
nl|'\r\n'
name|'dc_to_hf'
op|'='
name|'build_traversal_spec'
