...
newline|'\r\n'
indent|'    '
string|'"""ThreadSafePipe class queues the chunk data"""'
newline|'\r\n'
nl|'\r\n'
...
newline|'\r\n'
indent|'        '
string|'"""Writes the chunk data to the queue"""'
newline|'\r\n'
name|'self'
op|'.'
name|'put'
...
newline|'\r\n'
indent|'        '
string|'"""Retrieves the chunk data from the queue"""'
newline|'\r\n'
name|'return'
name|'self'
op|'.'
...
newline|'\r\n'
indent|'        '
string|'"""Sets EOF to mark reading of input file finishes"""'
newline|'\r\n'
name|'self'
op|'.'
name|'eof'
...
newline|'\r\n'
indent|'        '
string|'"""Returns whether EOF reached."""'
newline|'\r\n'
name|'return'
name|'self'
op|'.'
...
newline|'\r\n'
indent|'    '
string|'"""IOThread reads chunks from input file and pipes it to output file till\r\n    it reaches the transferable size\r\n    """'
newline|'\r\n'
nl|'\r\n'
DECL|member|__init__
name|'def'
...
newline|'\r\n'
indent|'        '
string|'"""Pipes the input chunk read to the output file till it reaches\r\n        a transferable size\r\n        """'
newline|'\r\n'
name|'try'
op|':'
newline|'\r\n'
...
name|'_'
op|'('
string|'"Not enough data (%(read_size)d "'
nl|'\r\n'
string|'"of %(transfer_size)d bytes)"'
op|')'
op|'%'
op|'('
op|'{'
...
newline|'\r\n'
indent|'        '
string|'"""Set the stop flag to true, which causes the thread to stop\r\n        safely\r\n        """'
newline|'\r\n'
name|'self'
op|'.'
name|'_stop_transfer'
...
newline|'\r\n'
indent|'        '
string|'"""Returns the traceback exception string"""'
newline|'\r\n'
name|'return'
name|'self'
op|'.'
...
newline|'\r\n'
indent|'        '
string|'"""Checks whether transfer is complete"""'
newline|'\r\n'
name|'return'
name|'self'
op|'.'
