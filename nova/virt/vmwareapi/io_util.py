...
newline|'\r\n'
indent|'    '
string|'"""ThreadSafePipe class queue\'s the chunk data."""'
newline|'\r\n'
nl|'\r\n'
...
name|'_'
op|'('
string|'"Not enough data (%(read_size)d of "'
nl|'\r\n'
string|'"%(transfer_size)d bytes)"'
op|')'
op|'%'
nl|'\r\n'
op|'{'
...
newline|'\r\n'
indent|'        '
string|'"""Set stop flag to true, which causes the thread to stop safely."""'
newline|'\r\n'
name|'self'
op|'.'
name|'_stop_transfer'
