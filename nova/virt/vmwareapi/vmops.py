...
newline|'\n'
nl|'\n'
DECL|member|create_cache_folder
dedent|''
name|'def'
...
op|':'
newline|'\n'
comment|'# NOTE(hartsocks): if the temp folder already exists, that'
nl|'\n'
comment|'# just means the temp folder was prepped by another process.'
nl|'\n'
indent|'            '
name|'pass'
newline|'\n'
