...
op|':'
newline|'\n'
comment|'# TODO(hartsocks): Refactor this section image handling section.'
nl|'\n'
comment|'# The next section handles manipulating various image types'
nl|'\n'
comment|"# as well as preparing those image's virtual disks for mounting"
nl|'\n'
comment|'# in our virtual machine.'
nl|'\n'
nl|'\n'
indent|'            '
name|'upload_name'
...
newline|'\n'
nl|'\n'
comment|'# Check if the image exists in the datastore cache. If not the'
nl|'\n'
comment|'# image will be uploaded and cached.'
nl|'\n'
dedent|''
dedent|''
name|'if'
...
op|':'
newline|'\n'
comment|'# Create a flat virtual disk and retain the metadata'
nl|'\n'
comment|'# file. This will be done in the unique temporary'
nl|'\n'
comment|'# directory.'
nl|'\n'
indent|'                        '
...
name|'debug'
op|'('
string|'"Create virtual disk on %s"'
op|','
nl|'\n'
name|'datastore'
op|'.'
...
name|'debug'
op|'('
string|'"Virtual disk created on %s."'
op|','
nl|'\n'
name|'datastore'
op|'.'
...
newline|'\n'
nl|'\n'
comment|'# Delete the temp upload folder'
nl|'\n'
dedent|''
name|'self'
op|'.'
...
op|')'
newline|'\n'
comment|'# Create the blank virtual disk for the VM'
nl|'\n'
name|'LOG'
op|'.'
name|'debug'
op|'('
string|'"Create blank virtual disk on %s"'
op|','
nl|'\n'
name|'datastore'
op|'.'
...
name|'debug'
op|'('
string|'"Blank virtual disk created on %s."'
op|','
nl|'\n'
name|'datastore'
op|'.'
...
newline|'\n'
nl|'\n'
comment|'# Create a copy of the base image, ensuring we'
nl|'\n'
comment|'# clean up on failure'
nl|'\n'
name|'try'
op|':'
newline|'\n'
...
op|')'
newline|'\n'
comment|'# Note(vui): handle snapshot cleanup on exceptions.'
nl|'\n'
name|'self'
op|'.'
name|'_delete_vm_snapshot'
...
newline|'\n'
indent|'        '
string|'"""Return connection info for a vnc console using ESX logic."""'
newline|'\n'
name|'vnc_console'
op|'='
name|'self'
