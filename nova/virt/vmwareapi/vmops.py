...
op|':'
newline|'\n'
comment|'# When VM deletion is triggered in middle of VM resize before VM'
nl|'\n'
comment|'# arrive RESIZED state, uuid-orig VM need to deleted to avoid'
nl|'\n'
comment|'# VM leak. Within method _destroy_instance it will check vmref'
nl|'\n'
comment|'# exist or not before attempt deletion.'
nl|'\n'
indent|'            '
