...
newline|'\n'
indent|'            '
string|'"""Get the Size of the flat vmdk file that is there on the storage\n            repository.\n            """'
newline|'\n'
name|'image_ref'
op|'='
name|'instance'
