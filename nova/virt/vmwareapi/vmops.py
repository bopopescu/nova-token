...
newline|'\n'
nl|'\n'
comment|'# In the case of a rescue disk the instance_name is not the same as'
nl|'\n'
comment|'# instance UUID. In this case the VM reference is accessed via the'
nl|'\n'
...
newline|'\n'
indent|'        '
string|'"""Destroy a VM instance. Steps followed are:\n        1. Power off the VM, if it is in poweredOn state.\n        2. Destroy the VM.\n        """'
newline|'\n'
name|'try'
op|':'
newline|'\n'
