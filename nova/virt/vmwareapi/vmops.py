...
name|'_'
op|'('
string|'"Attempted to create a VM with a name"'
nl|'\r\n'
string|'" %s, but that already exists on the host"'
op|')'
op|'%'
name|'instance'
op|'.'
...
name|'_'
op|'('
string|'"Network with the name \'%s\' doesn\'t"'
nl|'\r\n'
string|'" exist on the ESX host"'
op|')'
op|'%'
name|'net_name'
op|')'
...
name|'_'
op|'('
string|'"Downloading image file data %(image_id)s to the ESX "'
nl|'\r\n'
...
name|'_'
op|'('
string|'"Downloaded image file data %(image_id)s to the ESX "'
nl|'\r\n'
string|'"data store %(data_store_name)s"'
op|')'
op|'%'
...
op|':'
newline|'\r\n'
comment|'#Attach the vmdk uploaded to the VM. VM reconfigure is done'
nl|'\r\n'
comment|'#to do so.'
nl|'\r\n'
indent|'            '
...
name|'_'
op|'('
string|'"Failed to get the datastore "'
nl|'\r\n'
string|'"reference(s) which the VM uses"'
op|')'
op|')'
newline|'\r\n'
dedent|''
...
name|'_'
op|'('
string|'"instance - %s not poweredOn. So can\'t "'
nl|'\r\n'
string|'"be rebooted."'
op|')'
op|'%'
...
name|'_'
op|'('
string|'"instance - %s is poweredOff and hence "'
nl|'\r\n'
string|'" can\'t be suspended."'
op|')'
op|'%'
name|'instance'
op|'.'
...
name|'_'
op|'('
string|'"instance - %s not in Suspended state "'
nl|'\r\n'
string|'"and hence can\'t be Resumed."'
op|')'
op|'%'
name|'instance'
op|'.'
...
newline|'\r\n'
indent|'        '
string|'""" Set the machine id of the VM for guest tools to pick up and change\r\n        the IP """'
newline|'\r\n'
name|'vm_ref'
op|'='
name|'self'
