...
name|'_'
op|'('
string|'"Creating Virtual Disk of size %sKB and adapter type %s on"'
nl|'\r\n'
...
name|'_'
op|'('
string|'"Downloading image file %s to the ESX data store %s "'
op|')'
op|'%'
op|'('
name|'instance'
...
name|'_'
op|'('
string|'"Downloaded image file %s to the ESX data store %s "'
op|')'
op|'%'
op|'('
name|'instance'
...
name|'_'
op|'('
string|'"Deleting contents of the VM %s from "'
nl|'\r\n'
string|'"datastore %s"'
op|')'
op|'%'
...
name|'_'
op|'('
string|'"Deleted contents of the VM %s from "'
nl|'\r\n'
string|'"datastore %s"'
op|')'
op|'%'
