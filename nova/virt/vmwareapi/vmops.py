...
newline|'\r\n'
indent|'        '
string|'"""Waits for the task to finish and does a callback after"""'
newline|'\r\n'
name|'ret'
op|'='
name|'None'
...
name|'_'
op|'('
string|'"Creating Virtual Disk of size %(vmdk_file_size_in_kb)sKB"'
nl|'\r\n'
string|'" and adapter type %(adapter_type)s on"'
nl|'\r\n'
...
name|'_'
op|'('
string|'"Created Virtual Disk of size %(vmdk_file_size_in_kb)s KB"'
nl|'\r\n'
string|'" on the ESX host local store %(data_store_name)s "'
op|')'
op|'%'
nl|'\r\n'
op|'{'
...
name|'_'
op|'('
string|'"Deleting the file %(flat_uploaded_vmdk_path)s on "'
nl|'\r\n'
string|'"the ESX host local store %(data_store_names)s"'
op|')'
op|'%'
nl|'\r\n'
op|'{'
...
name|'_'
op|'('
string|'"Deleted the file %(flat_uploaded_vmdk_path)s on "'
nl|'\r\n'
string|'"the ESX host local store %(data_store_name)s "'
op|')'
op|'%'
...
name|'_'
op|'('
string|'"Downloading image file %(image_id)s to the "'
nl|'\r\n'
string|'"ESX data store %(datastore_name)s "'
op|')'
op|'%'
nl|'\r\n'
op|'{'
...
name|'_'
op|'('
string|'"Downloaded image file %(image_id)s to the ESX data "'
nl|'\r\n'
...
name|'_'
op|'('
string|'"Copying disk data before snapshot of "'
nl|'\r\n'
string|'"the VM instance %s"'
op|')'
op|'%'
name|'instance'
op|'.'
...
name|'_'
op|'('
string|'"Copied disk data before snapshot of "'
nl|'\r\n'
string|'"the VM instance %s"'
op|')'
op|'%'
...
nl|'\r\n'
string|'"while un-registering the VM: "'
op|')'
op|'+'
name|'str'
op|'('
...
name|'_'
op|'('
string|'"Deleting contents of the VM %(instance.name)s "'
nl|'\r\n'
string|'"from datastore %(datastore_name)s"'
op|')'
op|'%'
nl|'\r\n'
op|'{'
...
name|'_'
op|'('
string|'"Deleted contents of the VM %(instance_name)s "'
nl|'\r\n'
string|'"from datastore %(datastore_name)s"'
op|')'
op|'%'
...
name|'_'
op|'('
string|'"Reconfiguring VM instance %(instance_name)s to set "'
nl|'\r\n'
string|'"the machine id with ip - %(ip_addr)s"'
op|')'
op|'%'
nl|'\r\n'
op|'{'
...
name|'_'
op|'('
string|'"Reconfigured VM instance %(instance_name)s to set "'
nl|'\r\n'
string|'"the machine id with ip - %(ip_addr)s"'
op|')'
op|'%'
...
newline|'\r\n'
indent|'        '
string|'"""Create a dummy VM for testing purpose"""'
newline|'\r\n'
name|'vm_ref'
op|'='
name|'self'
...
newline|'\r\n'
indent|'        '
string|'"""Gets reference to network whose name is passed as the argument."""'
newline|'\r\n'
name|'datacenters'
op|'='
name|'self'
