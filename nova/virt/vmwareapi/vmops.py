...
newline|'\n'
nl|'\n'
DECL|member|_create_and_attach_ephemeral_disk
dedent|''
dedent|''
dedent|''
name|'def'
...
op|')'
newline|'\n'
comment|'# Read flavors for extra_specs'
nl|'\n'
name|'if'
name|'flavor'
name|'is'
...
newline|'\n'
nl|'\n'
DECL|member|_remove_ephemerals
dedent|''
dedent|''
name|'def'
name|'_remove_ephemerals'
op|'('
name|'self'
op|','
name|'vm_ref'
...
newline|'\n'
nl|'\n'
DECL|member|_resize_create_ephemerals
dedent|''
dedent|''
name|'def'
name|'_resize_create_ephemerals'
op|'('
name|'self'
op|','
name|'vm_ref'
...
newline|'\n'
nl|'\n'
comment|'# 4. Purge ephemeral disks'
nl|'\n'
name|'self'
op|'.'
name|'_remove_ephemerals'
