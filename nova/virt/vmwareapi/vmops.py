...
op|':'
newline|'\n'
comment|'# Maximum folder length must be less than 80 characters.'
nl|'\n'
comment|"# The 'id' length is 36. The maximum prefix for name is 40."
nl|'\n'
comment|"# We cannot truncate the 'id' as this is unique across OpenStack."
nl|'\n'
indent|'        '
name|'return'
string|"'%s (%s)'"
...
newline|'\n'
nl|'\n'
DECL|member|_fetch_vsphere_image
dedent|''
name|'def'
...
newline|'\n'
indent|'        '
string|'"""Fetch image which is located on a vSphere datastore."""'
newline|'\n'
name|'location'
op|'='
name|'vi'
...
name|'debug'
op|'('
string|'"Using vSphere location: %s"'
op|','
name|'location'
op|')'
newline|'\n'
...
name|'debug'
op|'('
string|'"Copying image file data %(image_id)s to "'
nl|'\n'
...
name|'debug'
op|'('
string|'"Copied image file data %(image_id)s to "'
nl|'\n'
string|'"%(file_path)s on the data store "'
nl|'\n'
string|'"%(datastore_name)s"'
...
op|')'
newline|'\n'
comment|'# The size of the image is different from the size of the virtual disk.'
nl|'\n'
comment|'# We want to use the latter. On vSAN this is the only way to get this'
nl|'\n'
comment|'# size because there is no VMDK descriptor.'
nl|'\n'
name|'vi'
op|'.'
name|'ii'
...
newline|'\n'
nl|'\n'
comment|'# The size of the sparse image is different from the size of the'
nl|'\n'
comment|'# virtual disk. We want to use the latter.'
nl|'\n'
dedent|''
name|'if'
name|'vi'
...
newline|'\n'
nl|'\n'
comment|'# Rename the VM. This is done after the spec is created to ensure'
nl|'\n'
comment|'# that all of the files for the instance are under the directory'
nl|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|_revert_migration_update_disks
dedent|''
dedent|''
name|'def'
name|'_revert_migration_update_disks'
op|'('
name|'self'
op|','
name|'vm_ref'
...
name|'value'
newline|'\n'
comment|"# Ignore VM's that do not have nvp.vm-uuid defined"
nl|'\n'
dedent|''
dedent|''
name|'if'
