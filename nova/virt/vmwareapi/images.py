...
nl|'\n'
nl|'\n'
DECL|function|get_vsphere_location
dedent|''
dedent|''
name|'def'
name|'get_vsphere_location'
...
newline|'\n'
indent|'    '
string|'"""Get image location in vsphere or None."""'
newline|'\n'
comment|'# image_id can be None if the instance is booted using a volume.'
nl|'\n'
name|'if'
name|'image_id'
op|':'
