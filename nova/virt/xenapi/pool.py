...
op|':'
newline|'\n'
comment|'# this is the first host of the pool -> make it main'
nl|'\n'
indent|'            '
name|'self'
op|'.'
...
op|')'
newline|'\n'
comment|'# save metadata so that we can find the main again'
nl|'\n'
name|'metadata'
op|'='
op|'{'
...
op|':'
newline|'\n'
comment|'# this is the main ->  do a pool-join'
nl|'\n'
comment|'# To this aim, nova compute on the subordinate has to go down.'
nl|'\n'
...
op|':'
newline|'\n'
comment|'# send rpc cast to main, asking to add the following'
nl|'\n'
...
op|':'
newline|'\n'
comment|'# this is the main -> instruct it to eject a host from the pool'
nl|'\n'
indent|'            '
name|'host_uuid'
op|'='
...
op|':'
newline|'\n'
comment|'# Remove main from its own pool -> destroy pool only if the'
nl|'\n'
comment|'# main is on its own, otherwise raise fault. Destroying a'
nl|'\n'
comment|'# pool made only by main is fictional'
nl|'\n'
indent|'            '
name|'if'
name|'len'
...
op|':'
newline|'\n'
comment|'# NOTE: this could be avoided by doing a main'
nl|'\n'
...
op|':'
newline|'\n'
comment|'# A main exists -> forward pool-eject request to main'
nl|'\n'
indent|'            '
name|'subordinate_info'
op|'='
...
string|"'Unable to eject %s '"
nl|'\n'
string|"'from the pool; No main found'"
op|')'
nl|'\n'
op|'%'
name|'host'
...
newline|'\n'
indent|'        '
string|'"""Joins a subordinate into a XenServer resource pool."""'
newline|'\n'
name|'try'
op|':'
newline|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|_eject_subordinate
dedent|''
dedent|''
name|'def'
name|'_eject_subordinate'
...
newline|'\n'
indent|'        '
string|'"""Eject a subordinate from a XenServer resource pool."""'
newline|'\n'
name|'try'
op|':'
newline|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|_create_subordinate_info
dedent|''
dedent|''
name|'def'
name|'_create_subordinate_info'
