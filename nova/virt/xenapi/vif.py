...
op|':'
newline|'\n'
comment|'# with OVS model, always plug into OVS integration bridge'
nl|'\n'
indent|'        '
name|'network_ref'
op|'='
...
op|':'
newline|'\n'
comment|'# nothing to do, as this driver assumes that integration bridge'
nl|'\n'
comment|'# was created by administrator'
nl|'\n'
indent|'        '
name|'pass'
newline|'\n'
