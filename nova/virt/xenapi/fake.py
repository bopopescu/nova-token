...
nl|'\n'
nl|'\n'
DECL|function|after_VIF_create
dedent|''
dedent|''
name|'def'
name|'after_VIF_create'
op|'('
name|'vif_ref'
op|','
name|'vif_rec'
...
newline|'\n'
indent|'    '
string|'"""Create backref from VM to VIF when VIF is created.\n    """'
newline|'\n'
name|'vm_ref'
op|'='
name|'vif_rec'
...
name|'_plugin_pickle_noop'
newline|'\n'
DECL|variable|_plugin_glance_upload_vhd2
name|'_plugin_glance_upload_vhd2'
op|'='
name|'_plugin_pickle_noop'
newline|'\n'
...
string|"'host_uuid'"
op|':'
string|"'fb97583b-baa1-452d-850e-819d95285def'"
op|','
nl|'\n'
...
op|':'
string|"'Default install of XenServer'"
op|','
nl|'\n'
...
op|':'
op|'['
string|"'xen-3.0-x86_64'"
op|','
nl|'\n'
string|"'xen-3.0-x86_32p'"
op|','
nl|'\n'
string|"'hvm-3.0-x86_32'"
op|','
nl|'\n'
string|"'hvm-3.0-x86_32p'"
op|','
nl|'\n'
string|"'hvm-3.0-x86_64'"
op|']'
op|','
nl|'\n'
...
string|"'iscsi_iqn'"
op|':'
string|"'iqn.2014-10.org.example:39fa9ee3'"
op|','
nl|'\n'
string|"'boot_time'"
op|':'
...
op|'{'
nl|'\n'
string|"'physical_features'"
op|':'
string|"'0098e3fd-bfebfbff-00000001-28100800'"
op|','
nl|'\n'
string|"'modelname'"
op|':'
...
string|"'flags'"
op|':'
string|"'fpu de tsc msr pae mce cx8 apic sep mtrr mca '"
nl|'\n'
string|"'cmov pat clflush acpi mmx fxsr sse sse2 ss ht '"
nl|'\n'
string|"'nx constant_tsc nonstop_tsc aperfmperf pni vmx '"
nl|'\n'
string|"'est ssse3 sse4_1 sse4_2 popcnt hypervisor ida '"
nl|'\n'
string|"'tpr_shadow vnmi flexpriority ept vpid'"
op|','
nl|'\n'
string|"'stepping'"
op|':'
