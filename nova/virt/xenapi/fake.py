...
nl|'\n'
nl|'\n'
DECL|function|VM_get_xenstore_data
dedent|''
name|'def'
...
nl|'\n'
nl|'\n'
DECL|function|VM_remove_from_xenstore_data
dedent|''
name|'def'
...
newline|'\n'
nl|'\n'
DECL|function|VM_add_to_xenstore_data
dedent|''
name|'def'
...
name|'debug'
op|'('
string|'"ADDING TO XENSTORE DATA %s %s"'
op|','
name|'key'
op|','
name|'value'
