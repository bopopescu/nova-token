...
newline|'\n'
indent|'    '
string|'"""Create read-only fields and backref from VM to VBD when VBD is\n    created."""'
newline|'\n'
name|'vbd_rec'
op|'['
string|"'currently_attached'"
...
nl|'\n'
nl|'\n'
DECL|function|_create_local_sr
dedent|''
dedent|''
name|'def'
name|'_create_local_sr'
...
name|'debug'
op|'('
string|'"ENTERING _create_object:%s"'
op|','
name|'obj'
op|')'
newline|'\n'
...
name|'debug'
op|'('
string|'"ENTERING FAKE CREATE VLAN"'
op|')'
newline|'\n'
name|'pif_rec'
op|'='
...
name|'_'
op|'('
string|"'Calling %(localname)s %(impl)s'"
op|')'
op|'%'
name|'locals'
op|'('
