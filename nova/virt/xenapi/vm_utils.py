...
name|'CONF'
newline|'\n'
comment|'# xenapi_vm_utils options in the DEFAULT group were deprecated in Icehouse'
nl|'\n'
name|'CONF'
op|'.'
name|'register_opts'
...
newline|'\n'
indent|'    '
string|'"""prepares the ssh key and the network configuration file to be\n    injected into the disk image\n    """'
newline|'\n'
