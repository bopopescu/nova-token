...
op|':'
newline|'\n'
comment|"#we need to invoke a plugin for copying VDI's content into proper path"
nl|'\n'
indent|'            '
name|'fn'
op|'='
...
op|')'
newline|'\n'
comment|'#TODO(salvatore-orlando): remove the VDI as it is not needed anymore'
nl|'\n'
name|'return'
name|'filename'
newline|'\n'
...
name|'debug'
op|'('
string|"'Writing partition table %d %d to %s...'"
op|','
nl|'\n'
name|'primary_first'
op|','
