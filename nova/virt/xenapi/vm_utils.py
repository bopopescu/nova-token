...
nl|'\n'
nl|'\n'
DECL|function|_retry_glance_download_vhd
dedent|''
dedent|''
name|'def'
name|'_retry_glance_download_vhd'
op|'('
name|'context'
op|','
name|'session'
...
name|'_'
op|'('
string|"'download_vhd %(image)s '"
nl|'\n'
string|"'attempt %(attempt_num)d/%(max_attempts)d '"
nl|'\n'
string|"'from %(glance_host)s:%(glance_port)s'"
op|')'
op|'%'
name|'locals'
op|'('
...
nl|'\n'
nl|'\n'
DECL|function|_fetch_image_glance_vhd
dedent|''
name|'def'
name|'_fetch_image_glance_vhd'
op|'('
...
newline|'\n'
nl|'\n'
comment|"# 'download_vhd' will return a list of dictionaries describing VDIs."
nl|'\n'
comment|"# The dictionary will contain 'vdi_type' and 'vdi_uuid' keys."
nl|'\n'
comment|"# 'vdi_type' can be 'root' or 'swap' right now."
nl|'\n'
name|'for'
name|'vdi'
name|'in'
...
nl|'\n'
nl|'\n'
DECL|function|_fetch_image_glance_disk
dedent|''
dedent|''
name|'def'
name|'_fetch_image_glance_disk'
...
name|'_'
op|'('
string|'"Fetching image %(image)s, type %(image_type_str)s"'
op|')'
op|','
nl|'\n'
name|'locals'
...
nl|'\n'
nl|'\n'
DECL|function|safe_find_iso_sr
dedent|''
name|'def'
name|'safe_find_iso_sr'
op|'('
