...
name|'_'
op|'('
string|'"Xapi \'get_vdi\' returned VDI UUID %(vdi_uuid)s"'
op|')'
op|'%'
name|'locals'
op|'('
...
name|'_'
op|'('
string|'"Instance %(instance_id)s will use DISK format"'
op|')'
op|'%'
nl|'\n'
name|'locals'
...
name|'_'
op|'('
string|'"Instance %(instance_id)s will use DISK_VHD format"'
op|')'
op|'%'
nl|'\n'
name|'locals'
...
name|'_'
op|'('
string|'"Instance %(instance_id)s will use DISK_RAW format"'
op|')'
op|'%'
nl|'\n'
name|'locals'
