...
newline|'\n'
indent|'                '
string|'"""Callback whioch runds with the image VDI attached"""'
newline|'\n'
nl|'\n'
name|'dev_path'
op|'='
...
op|':'
newline|'\n'
comment|'# Mount only Linux filesystems, to avoid disturbing'
nl|'\n'
comment|'# NTFS images'
nl|'\n'
indent|'                    '
...
op|':'
newline|'\n'
comment|'# The presence of the xe-update-networking'
nl|'\n'
comment|'# file indicates that this guest agent can'
nl|'\n'
...
newline|'\n'
indent|'        '
string|'"""Sets xenstore values to modify the image behaviour after\n        VM start.\n        """'
newline|'\n'
nl|'\n'
name|'xenstore_types'
op|'='
...
name|'_'
op|'('
string|"'Networking device %s not found '"
nl|'\n'
string|"'in VM'"
op|')'
op|')'
...
op|':'
newline|'\n'
comment|"# NB: The xenstore_key part of the instance_key isn't used but"
nl|'\n'
comment|'# must be unique.  We set it to xenstore_key as a convenient'
nl|'\n'
comment|'#  unique name...The xenstore_key value takes effect in the'
nl|'\n'
