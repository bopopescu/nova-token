...
name|'_'
op|'('
string|"'download_vhd %(image_id)s, attempt '"
nl|'\n'
string|"'%(attempt_num)d/%(max_attempts)d, params: %(params)s'"
op|')'
op|','
nl|'\n'
op|'{'
...
name|'callback'
op|'='
name|'_generate_glance_callback'
op|'('
name|'context'
op|')'
newline|'\n'
...
nl|'\n'
nl|'\n'
DECL|function|_generate_glance_callback
dedent|''
name|'def'
name|'_generate_glance_callback'
op|'('
...
nl|'\n'
nl|'\n'
DECL|variable|_TORRENT_URL_FN
dedent|''
name|'_TORRENT_URL_FN'
op|'='
name|'None'
comment|'# driver function to determine torrent URL to use'
newline|'\n'
nl|'\n'
nl|'\n'
DECL|function|_lookup_torrent_url_fn
name|'def'
...
newline|'\n'
indent|'    '
string|'"""Load a "fetcher" func to get the right torrent URL via entrypoints."""'
newline|'\n'
name|'namespace'
op|'='
...
name|'_'
op|'('
string|'"No torrent URL fetcher extension found."'
op|')'
op|')'
newline|'\n'
name|'return'
...
name|'_'
op|'('
string|'"Loading torrent URL fetcher from entry points %(ep)s"'
op|')'
op|','
nl|'\n'
op|'{'
...
nl|'\n'
nl|'\n'
DECL|function|_add_torrent_url
dedent|''
name|'def'
name|'_add_torrent_url'
op|'('
...
name|'_'
op|'('
string|'"No torrent URL fetcher installed."'
op|')'
op|')'
newline|'\n'
name|'_TORRENT_URL_FN'
op|'='
name|'get_torrent_url'
comment|'# default'
newline|'\n'
dedent|''
name|'else'
...
name|'_'
op|'('
string|'"Failed to get torrent URL for image %s"'
op|')'
op|'%'
name|'image_id'
op|')'
...
name|'return'
name|'False'
comment|'# fall back to using glance'
newline|'\n'
nl|'\n'
nl|'\n'
DECL|function|get_torrent_url
dedent|''
dedent|''
name|'def'
name|'get_torrent_url'
...
nl|'\n'
nl|'\n'
DECL|function|_add_bittorrent_params
dedent|''
name|'def'
name|'_add_bittorrent_params'
op|'('
...
name|'_'
op|'('
string|'"Image format is None: trying to determine PV status "'
nl|'\n'
string|'"using pygrub; if instance with vdi %s does not boot "'
nl|'\n'
string|'"correctly, try with image metadata."'
op|')'
op|'%'
name|'vdi_ref'
op|')'
...
name|'_'
op|'('
string|'"Error while executing pygrub! Please, ensure the "'
nl|'\n'
string|'"binary is installed correctly, and available in your "'
nl|'\n'
string|'"PATH; on some Linux distros, pygrub may be installed "'
nl|'\n'
string|'"in /usr/lib/xen-X.Y/bin/pygrub. Attempting to boot "'
nl|'\n'
string|'"in HVM mode."'
op|')'
op|')'
...
nl|'\n'
string|'"%(left) bytes left to copy"'
op|')'
op|','
nl|'\n'
op|'{'
