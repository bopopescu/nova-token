...
name|'_'
op|'('
string|'"xapi \'download_vhd\' returned VDI UUID "'
nl|'\n'
string|'"%(primary_vdi_uuid)s"'
op|')'
op|'%'
name|'locals'
op|'('
...
name|'_'
op|'('
string|'"xapi \'download_vhd\' returned SWAP VDI UUID "'
nl|'\n'
string|'"%(swap_vdi_uuid)s"'
op|')'
op|'%'
name|'locals'
op|'('
