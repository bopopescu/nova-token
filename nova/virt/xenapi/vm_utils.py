...
name|'classmethod'
newline|'\n'
DECL|member|create_managed_disk
name|'def'
...
newline|'\n'
indent|'        '
string|'"""A \'managed disk\' means that we\'ll resize the partition and fs to\n        match the size specified by instance_types.local_gb.\n        """'
newline|'\n'
name|'with'
...
name|'cls'
op|'.'
name|'_resize_partition_allowed'
op|'('
name|'dev_path'
op|','
name|'partition_path'
...
name|'classmethod'
newline|'\n'
DECL|member|_resize_partition_allowed
name|'def'
name|'_resize_partition_allowed'
op|'('
name|'cls'
...
name|'_'
op|'('
string|'"Found %(num_partitions)s partitions, the first with"'
nl|'\n'
string|'" fs_type \'%(fs_type)s\'"'
op|')'
op|'%'
name|'locals'
op|'('
...
name|'classmethod'
newline|'\n'
DECL|member|_resize_partition_and_fs
name|'def'
name|'_resize_partition_and_fs'
op|'('
name|'cls'
...
newline|'\n'
comment|'# 1. Delete and recreate partition to end of disk'
nl|'\n'
name|'root_helper'
op|'='
name|'FLAGS'
...
name|'cmd'
op|'='
string|'"""echo "d\nn\np\n1\n\n\nw\n" | %(root_helper)s fdisk %(dev_path)s"""'
op|'%'
name|'locals'
op|'('
op|')'
...
newline|'\n'
nl|'\n'
comment|'# 2. Remove ext3 journal (making it ext2)'
nl|'\n'
name|'utils'
op|'.'
name|'execute'
...
newline|'\n'
nl|'\n'
comment|'# 3. fsck the disk'
nl|'\n'
comment|'# NOTE(sirp): using -p here to automatically repair filesystem, is'
nl|'\n'
comment|'# this okay?'
nl|'\n'
name|'utils'
...
op|':'
newline|'\n'
comment|'# 3. Create swap partition'
nl|'\n'
nl|'\n'
...
newline|'\n'
nl|'\n'
DECL|function|determine_from_image_meta
dedent|''
name|'def'
name|'determine_from_image_meta'
op|'('
op|')'
op|':'
newline|'\n'
...
newline|'\n'
indent|'    '
string|'"""Same as find_iso_sr except raises a NotFound exception if SR cannot be\n    determined\n    """'
newline|'\n'
name|'sr_ref'
op|'='
name|'find_iso_sr'
