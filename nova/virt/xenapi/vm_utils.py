...
op|','
nl|'\n'
comment|"#            'other_config': {'allowvssprovider': False},"
nl|'\n'
string|"'other_config'"
op|':'
op|'{'
...
newline|'\n'
nl|'\n'
comment|'# TODO(dubs): os_type is currently defaulting to linux, we actually'
nl|'\n'
comment|'# want to make this a NOT NULL column and require it to be specified.'
nl|'\n'
name|'params'
op|'='
op|'{'
