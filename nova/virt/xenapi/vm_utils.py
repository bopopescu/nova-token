...
newline|'\n'
nl|'\n'
comment|'# NOTE(sirp): The Glance plugin runs under Python 2.4 which'
nl|'\n'
comment|'# does not have the `uuid` module. To work around this, we'
nl|'\n'
comment|'# generate the uuids here (under Python 2.6+) and pass them'
nl|'\n'
...
indent|'                '
name|'pass'
comment|'# ignore failures in retrieving VDI'
newline|'\n'
dedent|''
name|'raise'
name|'e'
...
name|'_'
op|'('
string|'"Unrecognized image type \'%(type_)s\'"'
op|')'
op|'%'
name|'locals'
op|'('
