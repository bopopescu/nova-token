...
name|'_'
op|'('
string|'"Loading image of size %(virtual_size)d. Full set of"'
nl|'\n'
string|'"properties is %(meta)s"'
op|'%'
name|'locals'
op|'('
op|')'
...
op|')'
newline|'\n'
comment|"#TODO: use ['other_config']['il8n-key-iso-sr'] == 'local-storage'"
nl|'\n'
comment|'#    or something similar to identify the iso sr'
nl|'\n'
name|'if'
name|'not'
op|'('
