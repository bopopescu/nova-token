...
name|'debug'
op|'('
string|'"Entering lookup for instance:%s"'
op|','
name|'str'
op|'('
name|'i'
...
name|'debug'
op|'('
string|'"Running preconfigure_instance"'
op|')'
newline|'\n'
name|'mount_required'
op|'='
...
name|'debug'
op|'('
string|'"Going to inject data in filesystem"'
op|')'
newline|'\n'
name|'disk'
op|'.'
...
name|'execute'
op|'('
string|"'sudo parted --script %s mklabel msdos'"
op|'%'
name|'dest'
op|')'
newline|'\n'
name|'execute'
op|'('
string|"'sudo parted --script %s mkpart primary %ds %ds'"
op|'%'
nl|'\n'
op|'('
name|'dest'
