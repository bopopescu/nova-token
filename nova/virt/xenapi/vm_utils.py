...
nl|'\n'
nl|'\n'
DECL|function|_get_snapshots_for_vm
dedent|''
dedent|''
name|'def'
...
name|'debug'
op|'('
string|'"More snapshots than expected, only deleting one."'
op|','
nl|'\n'
name|'instance'
op|'='
...
op|')'
newline|'\n'
comment|'# TODO(johnthetubaguy): we could look for older snapshots too'
nl|'\n'
name|'LOG'
op|'.'
name|'debug'
op|'('
string|'"Removed one old snapshot."'
op|','
name|'instance'
op|'='
name|'instance'
...
op|':'
newline|'\n'
comment|'# Ensure no VHDs will vanish while we migrate them'
nl|'\n'
indent|'        '
...
name|'_'
op|'('
string|'"Retry SR scan due to error: %s"'
op|')'
nl|'\n'
op|'%'
name|'exc'
...
nl|'\n'
nl|'\n'
DECL|function|_count_parents_children
dedent|''
name|'def'
...
newline|'\n'
comment|"# NOTE(bobba): If we don't have any VDIs in the target list, then no"
nl|'\n'
comment|"# coalescing can be guaranteed (e.g. file based SRs don't do leaf"
nl|'\n'
comment|'# coalescing)'
nl|'\n'
name|'if'
...
newline|'\n'
nl|'\n'
comment|'# Check if we have siblings. If so, coalesce will not take place.'
nl|'\n'
dedent|''
name|'if'
name|'_count_parents_children'
...
nl|'\n'
string|'" %(vdi_uuid_list)s, waiting for coalesce..."'
op|','
nl|'\n'
op|'{'
string|"'parent_uuid'"
