...
name|'import'
name|'time'
comment|'#FIXME(sirp): take this out, replace with greenthread.sleep'
newline|'\n'
name|'import'
name|'logging'
newline|'\n'
...
nl|'\n'
nl|'\n'
comment|'#TODO(sirp): Make safe_lookup_vdi for assert?'
nl|'\n'
name|'vdi_refs'
op|'='
name|'VMHelper'
...
name|'Exception'
op|'('
string|'"Unexpected number of VDIs (%s) found for VM %s"'
nl|'\n'
op|'%'
op|'('
name|'len'
...
newline|'\n'
nl|'\n'
comment|'#NOTE(sirp): We may need to wait for our parent to coalese with his '
nl|'\n'
comment|'# parent'
nl|'\n'
...
name|'debug'
op|'('
string|'"Asking xapi to upload %s as \'%s\'"'
op|','
name|'vdi_uuids'
op|','
nl|'\n'
...
newline|'\n'
indent|'    '
string|'""" TODO Explain why coalescing has to occur here """'
newline|'\n'
comment|'#TODO(sirp): we need to timeout this req after a while'
nl|'\n'
comment|"#NOTE(sirp): for some reason re-scan wasn't occuring automatically on "
nl|'\n'
comment|'# XS5.6'
nl|'\n'
comment|'#TODO(sirp): clean this up, perhaps use LoopingCall'
nl|'\n'
DECL|function|_get_vhd_parent_uuid_with_refresh
name|'def'
name|'_get_vhd_parent_uuid_with_refresh'
op|'('
name|'first_time'
op|')'
op|':'
...
op|':'
newline|'\n'
comment|'#TODO(sirp): should this interval be a gflag?'
nl|'\n'
comment|'#TODO(sirp): make this non-blocking'
nl|'\n'
indent|'            '
name|'time'
op|'.'
