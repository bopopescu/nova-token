...
nl|'\n'
nl|'\n'
DECL|function|_system_metadata_to_dict
dedent|''
dedent|''
name|'def'
name|'_system_metadata_to_dict'
op|'('
...
op|')'
newline|'\n'
comment|'# Try introducing SR if it is not present'
nl|'\n'
name|'if'
name|'not'
name|'sr_ref'
...
newline|'\n'
nl|'\n'
comment|'# NOTE(mikal): libvirt supports injecting the admin password as'
nl|'\n'
comment|'# well. This is not currently implemented for xenapi as it is not'
nl|'\n'
comment|'# supported by the existing file injection'
nl|'\n'
name|'extra_md'
op|'='
op|'{'
