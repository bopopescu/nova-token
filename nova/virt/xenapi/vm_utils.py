...
op|'}'
newline|'\n'
comment|'#TODO: if there is no kernel we need to call a plugin to understand whether '
nl|'\n'
comment|'#the VM should be launched as PV or HVM'
nl|'\n'
name|'if'
op|'('
name|'instance'
...
name|'debug'
op|'('
string|'"A kernel (and hopefully a ramdisk) have been provided"'
op|')'
newline|'\n'
name|'rec'
op|'['
...
name|'debug'
op|'('
string|'"This a raw image, hopefully HVM"'
op|')'
newline|'\n'
comment|'#TODO: Windows needs a platform flag... '
nl|'\n'
name|'rec'
op|'['
string|"'HVM_boot_policy'"
...
name|'debug'
op|'('
string|'"Salvatore: args[\'add_partition\']=%s"'
op|','
name|'args'
op|'['
string|"'add_partition'"
