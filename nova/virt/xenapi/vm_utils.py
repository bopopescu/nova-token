...
newline|'\n'
nl|'\n'
comment|"#### raw_image=validate_bool(args, 'raw', 'false')"
nl|'\n'
comment|"#### add_partition = validate_bool(args, 'add_partition', 'false')"
nl|'\n'
nl|'\n'
dedent|''
dedent|''
