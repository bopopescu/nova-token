...
name|'_'
op|'('
string|"'Failed to query agent version: %r'"
op|')'
op|','
nl|'\n'
name|'resp'
...
name|'_'
op|'('
string|"'Failed to update agent: %r'"
op|')'
op|','
name|'resp'
op|','
...
name|'_'
op|'('
string|"'Failed to exchange keys: %r'"
op|')'
op|'%'
name|'resp'
newline|'\n'
...
name|'_'
op|'('
string|"'Failed to inject file: %r'"
op|')'
op|','
name|'resp'
op|','
...
name|'_'
op|'('
string|"'Failed to reset network: %r'"
op|')'
op|','
name|'resp'
op|','
