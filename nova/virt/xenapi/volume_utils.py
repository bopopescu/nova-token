...
nl|'\n'
comment|'# happening at once per VM due to a bug in XenServer 6.1 and greater'
nl|'\n'
comment|'# where there is a race condition in VBD.plug that causes tapdisk to hang'
nl|'\n'
dedent|''
name|'synchronized_plug'
op|'('
