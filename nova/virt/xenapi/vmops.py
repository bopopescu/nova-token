...
op|')'
newline|'\n'
comment|'# If there is no associated VDI, skip it'
nl|'\n'
name|'if'
string|"'vdi_uuid'"
name|'not'
...
name|'_'
op|'('
string|'"BDM contains no vdi_uuid"'
op|')'
op|','
name|'instance'
op|'='
...
name|'_'
op|'('
string|'"VM is not present, skipping power off..."'
op|')'
op|','
nl|'\n'
name|'instance'
...
newline|'\n'
comment|"# NOTE(johannes): This can fail if the VM object hasn't been created"
nl|'\n'
comment|'# yet on the dom0. Since that step happens fairly late in the build'
nl|'\n'
comment|"# process, there's a potential for a race condition here. Until the"
nl|'\n'
comment|'# VM object is created, return back a 409 error instead of a 404'
nl|'\n'
comment|'# error.'
nl|'\n'
name|'try'
...
name|'_'
op|'('
string|"'Fetching VM ref while BUILDING failed'"
op|')'
op|','
nl|'\n'
name|'instance'
