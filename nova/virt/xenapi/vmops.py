...
op|':'
newline|'\n'
comment|"# FIXME(sirp): for now we're taking a KISS approach to"
nl|'\n'
comment|'# instance-build-progress:'
nl|'\n'
...
comment|'#'
nl|'\n'
comment|'# For a first cut this should be fine, however, as image size'
nl|'\n'
comment|'# grows, the _create_disks step begins to dominate the equation. A'
nl|'\n'
comment|'# better approximation would reflect the percentage of the image'
nl|'\n'
comment|'# that has been streamed to the host machine.'
nl|'\n'
indent|'            '
name|'progress'
op|'['
