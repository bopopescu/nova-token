...
name|'_'
op|'('
string|'"Managed disk set for instance %(instance_id)s,"'
nl|'\n'
string|'" attempting to resize partition"'
op|')'
op|'%'
name|'locals'
op|'('
...
name|'_'
op|'('
string|'"Managed disk NOT set for instance"'
nl|'\n'
string|'" %(instance_id)s, skipping resize partition"'
op|')'
nl|'\n'
op|'%'
name|'locals'
...
name|'_'
op|'('
string|'"Updating instance \'%(instance_id)s\' progress to"'
nl|'\n'
string|'" %(progress)d"'
op|')'
op|'%'
