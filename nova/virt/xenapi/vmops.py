...
op|':'
newline|'\n'
comment|'# There was some sort of error'
nl|'\n'
indent|'            '
name|'raise'
name|'RuntimeError'
...
op|':'
newline|'\n'
comment|'# Not a valid JSON value'
nl|'\n'
indent|'            '
name|'return'
name|'ret'
...
newline|'\n'
indent|'        '
string|'"""Abstracts out the interaction with the xenstore xenapi plugin."""'
newline|'\n'
name|'return'
name|'self'
op|'.'
...
newline|'\n'
comment|'#    def __init__(self, prime=None, base=None):'
nl|'\n'
comment|'#        """You can specify the values for prime and base if you wish;'
nl|'\n'
comment|'#        otherwise, reasonable default values will be used.'
nl|'\n'
comment|'#        """'
nl|'\n'
comment|'#        if prime is None:'
nl|'\n'
comment|'#            self._prime = 162259276829213363391578010288127'
nl|'\n'
comment|'#        else:'
nl|'\n'
comment|'#            self._prime = prime'
nl|'\n'
comment|'#        if base is None:'
nl|'\n'
comment|'#            self._base = 5'
nl|'\n'
comment|'#        else:'
nl|'\n'
comment|'#            self._base = base'
nl|'\n'
comment|'#        self._secret = random.randint(5000, 15000)'
nl|'\n'
comment|'#        self._shared = self._public = None'
nl|'\n'
DECL|member|__init__
name|'def'
name|'__init__'
