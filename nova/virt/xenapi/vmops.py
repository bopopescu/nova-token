...
name|'_'
op|'('
string|"'instance %(name)s: not enough free memory'"
op|')'
nl|'\n'
op|'%'
name|'locals'
...
name|'DISK_RAW'
newline|'\n'
comment|'# TODO: Coalesce fetch_image, lookup_image and'
nl|'\n'
comment|'# manipulate_root_image so requires a single VDI mount/umount'
nl|'\n'
comment|'# sequence'
nl|'\n'
dedent|''
...
newline|'\n'
nl|'\n'
comment|'# Alter the image before VM start for, e.g. network injection'
nl|'\n'
comment|'#TODO(salvatore-orlando): do this only if flag is true'
nl|'\n'
name|'LOG'
op|'.'
name|'debug'
op|'('
string|'"About to run preconfigure_instance"'
op|')'
newline|'\n'
name|'if'
name|'FLAGS'
...
name|'debug'
op|'('
string|'"About to run inject_network_info"'
op|')'
newline|'\n'
name|'networks'
op|'='
...
name|'name'
newline|'\n'
comment|'#fake xenapi does not use OpaqueRef as a prefix'
nl|'\n'
comment|'#when running tests we will always end up here '
nl|'\n'
dedent|''
dedent|''
name|'vm'
...
name|'mac_id'
newline|'\n'
comment|'#TODO(salvatore-orlando): key for broadcast address'
nl|'\n'
comment|"#provisionally set to 'broadcast'"
nl|'\n'
name|'mapping'
op|'='
op|'{'
...
name|'debug'
op|'('
string|'"About to run write_to_xenstore"'
op|')'
newline|'\n'
name|'self'
op|'.'
