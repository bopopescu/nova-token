...
newline|'\n'
nl|'\n'
comment|'#this will return the bridge name in nova db'
nl|'\n'
dedent|''
name|'bridge'
op|'='
...
nl|'\n'
comment|'#TODO: avoid unnecessary call to find_network_with_bridge'
nl|'\n'
comment|'#when VLAN manager is being used (and not just use an if)'
nl|'\n'
name|'network_ref'
op|'='
name|'None'
