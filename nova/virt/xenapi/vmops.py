...
name|'CONF'
newline|'\n'
comment|'# xenapi_vmops options in the DEFAULT group were deprecated in Icehouse'
nl|'\n'
name|'CONF'
op|'.'
name|'register_opts'
...
newline|'\n'
nl|'\n'
DECL|member|_ensure_not_resize_ephemeral
dedent|''
name|'def'
name|'_ensure_not_resize_ephemeral'
op|'('
name|'self'
op|','
name|'instance'
...
name|'_'
op|'('
string|'"Unable to resize ephemeral disks"'
op|')'
newline|'\n'
name|'raise'
name|'exception'
...
newline|'\n'
nl|'\n'
comment|'#TODO(johngarbutt) resize ephemeral disks too'
nl|'\n'
nl|'\n'
DECL|member|reboot
dedent|''
