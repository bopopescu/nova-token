...
op|']'
newline|'\n'
comment|'#this will return the appropriate network'
nl|'\n'
comment|'#TODO(salvatore-orlando): avoid unnecessary call to'
nl|'\n'
comment|'#find_network_with_bridge when VLAN manager is being used'
nl|'\n'
nl|'\n'
name|'network_ref'
op|'='
...
op|':'
newline|'\n'
comment|'#try to get name with name_label'
nl|'\n'
indent|'                '
name|'network_ref'
op|'='
