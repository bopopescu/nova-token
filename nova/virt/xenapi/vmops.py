...
op|')'
newline|'\n'
comment|'#target_vm = self.compute_api.create('
nl|'\n'
comment|'#    context=context.get_admin_context(),'
nl|'\n'
comment|'#    instance_type="m1.tiny",'
nl|'\n'
comment|'#    image_id=1,'
nl|'\n'
comment|'#    kernel_id=3,'
nl|'\n'
comment|'#    ramdisk_id=2,'
nl|'\n'
comment|'#    display_name="test",'
nl|'\n'
comment|'#    display_description="test")'
nl|'\n'
comment|'#print context.get_admin_context().__dict__'
nl|'\n'
comment|'#print target_vm'
nl|'\n'
nl|'\n'
name|'vbd'
op|'='
