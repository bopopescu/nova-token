...
op|':'
newline|'\n'
comment|'# if the spawn process fails here it will be necessary to'
nl|'\n'
comment|'# clean up kernel and ramdisk (only files in dom0)'
nl|'\n'
indent|'            '
name|'LOG'
op|'.'
...
op|')'
newline|'\n'
comment|'#extract resource dictionary from spawn error'
nl|'\n'
dedent|''
name|'if'
name|'len'
