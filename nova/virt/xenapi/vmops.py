...
name|'None'
newline|'\n'
comment|'#assume instance_or_vm is an instance object'
nl|'\n'
name|'try'
op|':'
newline|'\n'
...
name|'instance_or_vm'
newline|'\n'
comment|'#try to lookup instance'
nl|'\n'
dedent|''
dedent|''
name|'vm'
...
op|')'
newline|'\n'
comment|'#if vm=None might be a VM ref'
nl|'\n'
name|'if'
name|'vm'
op|'=='
...
name|'vm'
newline|'\n'
comment|'#if we end up here instance_or_vm is neither an instance id or VM ref'
nl|'\n'
dedent|''
name|'raise'
name|'exception'
...
name|'mac_id'
newline|'\n'
comment|'#salvatore-orlando: key for broadcast address'
nl|'\n'
