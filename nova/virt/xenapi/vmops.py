...
newline|'\n'
nl|'\n'
comment|'#self._shutdown(instance, vm)'
nl|'\n'
comment|'#target_vm = VMHelper.lookup(self._session, "instance-00000012")'
nl|'\n'
name|'target_vm'
op|'='
name|'self'
...
newline|'\n'
nl|'\n'
comment|'#vbd = self._session.get_xenapi().VM.get_VBDs(vm)[0]'
nl|'\n'
comment|'#vdi_ref = self._session.get_xenapi().VBD.get_record(vbd)["VDI"]'
nl|'\n'
comment|'#vbd_ref = VMHelper.create_vbd('
nl|'\n'
comment|'#    self._session,'
nl|'\n'
comment|'#    target_vm,'
nl|'\n'
comment|'#    vdi_ref,'
...
nl|'\n'
nl|'\n'
comment|'# Plug the VBD into the target instance'
nl|'\n'
comment|'#self._session.call_xenapi("Async.VBD.plug", vbd_ref)'
nl|'\n'
nl|'\n'
