...
newline|'\n'
nl|'\n'
comment|'# Plan of action'
nl|'\n'
comment|'# Create `instance` object for rescue_vm'
nl|'\n'
comment|'# rescue_instance = self._make_rescue_instance() # Write this'
nl|'\n'
