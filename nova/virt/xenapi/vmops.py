...
op|','
nl|'\n'
string|"'number of seconds to wait for agent to be fully '"
nl|'\n'
string|"'operational'"
op|')'
newline|'\n'
...
op|','
nl|'\n'
string|"'number of seconds to wait for instance to go to '"
nl|'\n'
...
op|','
nl|'\n'
string|"'Whether to generate swap (False means fetching it'"
nl|'\n'
string|"' from OVA)'"
op|')'
newline|'\n'
