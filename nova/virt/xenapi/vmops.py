...
newline|'\n'
indent|'        '
string|'"""Returns a dict of all the keys in the xenstore for the given instance\n        that begin with the key_prefix.\n        """'
newline|'\n'
name|'data'
op|'='
name|'self'
...
newline|'\n'
indent|'        '
string|'"""Takes a key/value pair and adds it to the xenstore record\n        for the given vm instance. If the key exists in xenstore, it is\n        overwritten"""'
newline|'\n'
name|'vm'
op|'='
name|'self'
