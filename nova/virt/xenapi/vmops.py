...
op|':'
newline|'\n'
comment|'# TODO(jk0): clean_shutdown is only supported if XenTools is'
nl|'\n'
comment|'# installed and running. What we want to do eventually is try'
nl|'\n'
comment|'# this first, and only issue the hard_shutdown if clean_shutdown'
nl|'\n'
