...
name|'step'
newline|'\n'
DECL|function|start_paused_step
name|'def'
name|'start_paused_step'
op|'('
name|'undo_mgr'
op|','
name|'vm_ref'
...
name|'step'
newline|'\n'
DECL|function|boot_and_configure_instance_step
name|'def'
name|'boot_and_configure_instance_step'
op|'('
name|'undo_mgr'
op|','
name|'vm_ref'
...
newline|'\n'
nl|'\n'
comment|'# if use neutron, prepare waiting event from neutron'
nl|'\n'
comment|'# first_boot is True in new booted instance'
nl|'\n'
comment|"# first_boot is False in migration and we don't waiting"
nl|'\n'
comment|'# for neutron event regardless of whether or not it is'
nl|'\n'
comment|'# migrated to another host, if unplug VIFs locally, the'
nl|'\n'
comment|'# port status may not changed in neutron side and we'
nl|'\n'
comment|'# cannot get the vif plug event from neturon'
nl|'\n'
name|'timeout'
op|'='
name|'CONF'
...
name|'debug'
op|'('
string|'"wait for instance event:%s"'
op|','
name|'events'
op|')'
newline|'\n'
...
name|'self'
op|'.'
name|'_handle_neutron_event_timeout'
op|'('
name|'instance'
op|','
name|'undo_mgr'
...
newline|'\n'
nl|'\n'
DECL|member|_handle_neutron_event_timeout
dedent|''
dedent|''
name|'def'
name|'_handle_neutron_event_timeout'
...
op|':'
newline|'\n'
comment|"# We didn't get callback from Neutron within given time"
nl|'\n'
indent|'        '
name|'LOG'
op|'.'
...
name|'_LW'
op|'('
string|"'Timeout waiting for vif plugging callback'"
op|')'
op|','
nl|'\n'
name|'instance'
...
name|'debug'
op|'('
string|'"Update instance when power on"'
op|','
name|'instance'
op|'='
name|'instance'
...
name|'_LW'
op|'('
string|"'Neutron Reported failure on event %(event)s'"
op|')'
op|','
nl|'\n'
op|'{'
...
op|':'
newline|'\n'
comment|"# Only get network-vif-plugged events with VIF's status is not active."
nl|'\n'
comment|'# With VIF whose status is active, neutron may not notify such event.'
nl|'\n'
indent|'        '
name|'timeout'
op|'='
...
op|'('
nl|'\n'
string|"'XenAPI requires migrate data'"
op|')'
newline|'\n'
nl|'\n'
dedent|''
