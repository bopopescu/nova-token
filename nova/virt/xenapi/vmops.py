...
op|':'
newline|'\n'
comment|'#TODO(johngarbutt) clean up the move_disks if this is not run'
nl|'\n'
indent|'            '
name|'root_vdi'
op|'='
...
newline|'\n'
nl|'\n'
DECL|function|undo_attach_root_disk
name|'def'
name|'undo_attach_root_disk'
op|'('
op|')'
op|':'
newline|'\n'
comment|'# destroy the vbd in preparation to re-attach the VDI'
nl|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|_attach_orig_disk_for_rescue
dedent|''
dedent|''
name|'def'
name|'_attach_orig_disk_for_rescue'
...
name|'step'
newline|'\n'
DECL|function|fake_step_to_be_executed_by_finish_migration
name|'def'
name|'fake_step_to_be_executed_by_finish_migration'
op|'('
op|')'
op|':'
newline|'\n'
...
name|'step'
newline|'\n'
DECL|function|power_down_instance
name|'def'
name|'power_down_instance'
op|'('
op|')'
op|':'
newline|'\n'
...
name|'step'
newline|'\n'
DECL|function|transfer_leaf_vhd
name|'def'
name|'transfer_leaf_vhd'
op|'('
name|'leaf_vdi_uuid'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|_resize_up_root_vdi
dedent|''
dedent|''
name|'def'
name|'_resize_up_root_vdi'
