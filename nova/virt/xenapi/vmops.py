...
name|'error'
op|'('
string|'"ZZZZ opaq instance_or_vm=%s"'
op|'%'
name|'instance_or_vm'
op|')'
newline|'\n'
...
op|':'
newline|'\n'
comment|'# Not a string; must be a vm instance'
nl|'\n'
indent|'            '
name|'instance_name'
op|'='
...
name|'error'
op|'('
string|'"ZZZZ opaq instance, name=%s"'
op|'%'
name|'instance_name'
op|')'
newline|'\n'
...
name|'error'
op|'('
string|'"ZZZZ get_info instance=%s"'
op|'%'
name|'instance'
op|')'
newline|'\n'
