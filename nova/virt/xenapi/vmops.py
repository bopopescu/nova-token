...
name|'_'
op|'('
string|'"Instance %(instance_uuid)s: Failed to spawn, rolling"'
nl|'\n'
string|'" back."'
op|')'
op|'%'
...
name|'_'
op|'('
string|'"Instance %(instance_uuid)s in ERROR state"'
op|')'
newline|'\n'
name|'_set_migration_to_error'
op|'('
...
name|'_'
op|'('
string|'"Instance %(instance_uuid)s in %(task_state)s "'
nl|'\n'
string|'"task_state, not RESIZE_VERIFY."'
op|')'
newline|'\n'
name|'_set_migration_to_error'
op|'('
...
name|'_'
op|'('
string|'"Error auto-confirming resize for instance "'
nl|'\n'
string|'"%(instance_uuid)s: %(e)s.  Will retry later."'
op|')'
newline|'\n'
name|'LOG'
op|'.'
...
nl|'\n'
string|"' path=%(path)s; args=%(args)r'"
op|')'
op|'%'
name|'locals'
op|'('
