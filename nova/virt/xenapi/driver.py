...
newline|'\n'
nl|'\n'
DECL|variable|OVERHEAD_BASE
name|'OVERHEAD_BASE'
op|'='
number|'3'
newline|'\n'
DECL|variable|OVERHEAD_PER_MB
name|'OVERHEAD_PER_MB'
op|'='
number|'0.00781'
newline|'\n'
DECL|variable|OVERHEAD_PER_VCPU
...
nl|'\n'
comment|'# Some padding is done to each value to fit all available VM data'
nl|'\n'
name|'memory_mb'
op|'='
name|'instance_info'
...
newline|'\n'
nl|'\n'
DECL|member|_get_block_storage_ip
dedent|''
name|'def'
name|'_get_block_storage_ip'
op|'('
...
op|':'
newline|'\n'
comment|'# If CONF.my_block_storage_ip is set, use it.'
nl|'\n'
indent|'        '
name|'if'
name|'CONF'
...
newline|'\n'
indent|'        '
string|'"""Performs a live migration rollback.\n\n        :param context: security context\n        :param instance: instance object that was being migrated\n        :param network_info: instance network information\n        :param block_device_info: instance block device information\n        :param destroy_disks:\n            if true, destroy disks at destination during cleanup\n        :param migrate_data: A XenapiLiveMigrateData object\n        """'
newline|'\n'
nl|'\n'
comment|'# NOTE(johngarbutt) Destroying the VM is not appropriate here'
nl|'\n'
comment|'# and in the cases where it might make sense,'
nl|'\n'
comment|'# XenServer has already done it.'
nl|'\n'
comment|'# NOTE(sulo): The only cleanup we do explicitly is to forget'
nl|'\n'
comment|'# any volume that was attached to the destination during'
nl|'\n'
comment|'# live migration. XAPI should take care of all other cleanup.'
nl|'\n'
name|'self'
op|'.'
name|'_vmops'
