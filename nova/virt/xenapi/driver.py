...
op|':'
newline|'\n'
comment|"# Verify that we're using the right version of the plugins"
nl|'\n'
indent|'        '
name|'returned_version'
op|'='
name|'self'
op|'.'
...
newline|'\n'
nl|'\n'
comment|"# Can't use vmops.cmp_version because that tolerates differences in"
nl|'\n'
