...
nl|'\n'
comment|'# it the caller does not provide template object and data'
nl|'\n'
comment|'# we will import the Cheetah template module and load the'
nl|'\n'
comment|'# data from the file specified by injected_network_template flag'
nl|'\n'
indent|'    '
name|'if'
name|'not'
