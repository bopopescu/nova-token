...
name|'StrOpt'
op|'('
string|"'dnsmasq_pid_dir'"
op|','
nl|'\n'
DECL|variable|default
name|'default'
op|'='
string|"'$state_path/baremetal/dnsmasq'"
op|','
nl|'\n'
DECL|variable|help
name|'help'
op|'='
string|"'path to directory stores pidfiles of dnsmasq'"
op|')'
op|','
nl|'\n'
name|'cfg'
...
name|'help'
op|'='
string|"'path to directory stores leasefiles of dnsmasq'"
op|')'
op|','
nl|'\n'
name|'cfg'
...
name|'default'
op|'='
string|"'/usr/lib/syslinux/pxelinux.0'"
op|','
nl|'\n'
DECL|variable|help
name|'help'
op|'='
string|"'path to pxelinux.0'"
op|')'
op|','
nl|'\n'
op|']'
...
newline|'\n'
nl|'\n'
comment|'# NOTE(deva): is there a way to get swap_mb directly from instance?'
nl|'\n'
name|'swap_mb'
op|'='
name|'instance_types'
...
newline|'\n'
nl|'\n'
DECL|member|_generate_udev_rules
dedent|''
name|'def'
...
comment|'# TODO(deva): fix assumption that device names begin with "eth"'
nl|'\n'
comment|'#             and fix assumption of ordering'
nl|'\n'
indent|'        '
name|'macs'
op|'='
...
name|'rules'
op|'+='
string|'\'SUBSYSTEM=="net", ACTION=="add", DRIVERS=="?*", \''
string|'\'ATTR{address}=="%(mac)s", ATTR{dev_id}=="0x0", \''
string|'\'ATTR{type}=="1", KERNEL=="eth*", NAME="%(name)s"\\n\''
op|'%'
op|'{'
string|"'mac'"
op|':'
