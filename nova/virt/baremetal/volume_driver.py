...
name|'BoolOpt'
op|'('
string|"'baremetal_use_unsafe_iscsi'"
op|','
nl|'\n'
...
name|'StrOpt'
op|'('
string|"'baremetal_iscsi_iqn_prefix'"
op|','
nl|'\n'
DECL|variable|default
name|'default'
...
nl|'\n'
nl|'\n'
DECL|function|_get_baremetal_node_by_instance_name
name|'def'
name|'_get_baremetal_node_by_instance_name'
op|'('
name|'virtapi'
op|','
name|'instance_name'
...
op|')'
newline|'\n'
comment|'# TODO(deva): optimize this DB query.'
nl|'\n'
comment|"#             I don't think it should be _get_all"
nl|'\n'
name|'for'
name|'node'
name|'in'
...
newline|'\n'
nl|'\n'
comment|'# raise exception if we found no matching instance'
nl|'\n'
dedent|''
dedent|''
name|'raise'
...
name|'CONF'
op|'.'
name|'baremetal_iscsi_iqn_prefix'
op|','
nl|'\n'
name|'instance_name'
op|','
...
name|'CONF'
op|'.'
name|'baremetal_use_unsafe_iscsi'
op|':'
newline|'\n'
indent|'                '
name|'raise'
...
nl|'\n'
comment|'# to the volume. Do not set CONF.baremetal_use_unsafe_iscsi'
nl|'\n'
