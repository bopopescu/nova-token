...
op|':'
newline|'\n'
comment|'# NOTE(r-mibu): Since ipmitool hangs with an empty password file,'
nl|'\n'
comment|"#               we have to write '\\0' if password was empty."
nl|'\n'
comment|'# see https://bugs.launchpad.net/nova/+bug/1237802 for more details'
nl|'\n'
indent|'        '
name|'f'
op|'.'
