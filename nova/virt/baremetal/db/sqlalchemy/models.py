...
op|')'
newline|'\n'
DECL|variable|preserve_ephemeral
...
op|')'
newline|'\n'
comment|'# root_mb, swap_mb and ephemeral_mb are cached flavor values for the'
nl|'\n'
comment|'# current deployment not attributes of the node.'
nl|'\n'
