...
op|')'
newline|'\n'
comment|"# Note that baremetal doesn't have a read-only connection"
nl|'\n'
comment|'# mode, so the read_only parameter is ignored'
nl|'\n'
name|'super'
op|'('
name|'BareMetalDriver'
...
name|'_'
op|'('
string|'"Baremetal assignment is overcommitted."'
op|')'
op|','
nl|'\n'
name|'instance'
