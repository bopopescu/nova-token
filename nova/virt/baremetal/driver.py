...
name|'_LW'
op|'('
string|"'The baremetal driver is deprecated in Juno and will be '"
nl|'\n'
string|"'removed before the next release. Please plan to '"
nl|'\n'
string|"'transition to Ironic as soon as possible. See '"
nl|'\n'
string|"'https://wiki.openstack.org/wiki/Ironic for more '"
nl|'\n'
string|"'information'"
op|')'
op|')'
