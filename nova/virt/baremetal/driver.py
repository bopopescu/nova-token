...
name|'BoolOpt'
op|'('
string|"'baremetal_inject_password'"
op|','
nl|'\n'
...
name|'StrOpt'
op|'('
string|"'baremetal_volume_driver'"
op|','
nl|'\n'
DECL|variable|default
name|'default'
...
nl|'\n'
nl|'\n'
DECL|function|_update_baremetal_state
dedent|''
name|'def'
name|'_update_baremetal_state'
op|'('
name|'context'
op|','
name|'node'
...
name|'_'
op|'('
string|'"Baremetal node id not supplied"'
nl|'\n'
string|'" to driver"'
op|')'
op|')'
...
name|'_'
op|'('
string|'"Baremetal node %s already"'
nl|'\n'
string|'" in use"'
op|')'
op|'%'
...
newline|'\n'
nl|'\n'
comment|'# TODO(deva): split this huge try: block into manageable parts'
nl|'\n'
dedent|''
name|'try'
op|':'
...
op|':'
newline|'\n'
comment|'# TODO(deva): add tooling that can revert a failed spawn'
nl|'\n'
indent|'            '
name|'_update_baremetal_state'
op|'('
