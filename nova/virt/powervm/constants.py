...
newline|'\n'
DECL|variable|POWERVM_SHUTTING_DOWN
name|'POWERVM_SHUTTING_DOWN'
op|'='
string|"'Shutting Down'"
newline|'\n'
DECL|variable|POWERVM_ERROR
name|'POWERVM_ERROR'
op|'='
string|"'Error'"
newline|'\n'
DECL|variable|POWERVM_NOT_AVAILABLE
name|'POWERVM_NOT_AVAILABLE'
op|'='
string|"'Not Available'"
newline|'\n'
DECL|variable|POWERVM_OPEN_FIRMWARE
name|'POWERVM_OPEN_FIRMWARE'
op|'='
