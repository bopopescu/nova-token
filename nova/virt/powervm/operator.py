...
newline|'\n'
nl|'\n'
DECL|member|_poll_for_lpar_status
dedent|''
name|'def'
...
newline|'\n'
nl|'\n'
comment|"# raise the given timeout exception if the loop call doesn't complete"
nl|'\n'
comment|'# in the specified timeout'
nl|'\n'
dedent|''
...
op|':'
newline|'\n'
DECL|function|_wait_for_lpar_status
indent|'            '
name|'def'
name|'_wait_for_lpar_status'
op|'('
name|'instance_name'
op|','
name|'status'
...
newline|'\n'
indent|'                '
string|'"""Called at an interval until the status is reached."""'
newline|'\n'
name|'lpar_obj'
op|'='
name|'self'
...
op|')'
newline|'\n'
comment|'# poll instance until running or raise exception'
nl|'\n'
name|'self'
op|'.'
name|'_poll_for_lpar_status'
