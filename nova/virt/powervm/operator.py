...
nl|'\n'
comment|'#             prefix already exists on the system (1 in 2^28)'
nl|'\n'
dedent|''
name|'except'
name|'nova_exception'
...
nl|'\n'
comment|'#               that can be used.  Retain the 0xfe as noted above,'
nl|'\n'
comment|'#               but ensure the final 3 hex values represent a value'
nl|'\n'
comment|'#               between 32 and 64 so we can assign as the slot id on'
nl|'\n'
comment|'#               the system.'
nl|'\n'
comment|'#               FA:xx:xx:xx:x0:[32-64]'
nl|'\n'
nl|'\n'
name|'macs'
op|'='
