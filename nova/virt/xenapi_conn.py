...
name|'error'
op|'('
string|'"ZZZZ conn get_info id=%s"'
op|'%'
name|'instance_id'
op|')'
newline|'\n'
...
op|')'
newline|'\n'
comment|'#           import sqlalchemy'
nl|'\n'
comment|'#           from sqlalchemy.exc import IntegrityError as IntegrityError'
nl|'\n'
comment|'#           try:'
nl|'\n'
comment|'#               db.instance_action_create(context.get_admin_context(), action)'
nl|'\n'
comment|'#           except IntegrityError:'
nl|'\n'
comment|"#               # Some methods don't pass unique IDs, so the call to"
nl|'\n'
comment|'#               # instance_action_create() will raise IntegrityErrors. Rather'
nl|'\n'
comment|"#               # than bomb out, I'm explicitly silencing them so that the"
nl|'\n'
comment|'#               # code can continue to work until they fix that method.'
nl|'\n'
comment|'#               pass'
nl|'\n'
nl|'\n'
