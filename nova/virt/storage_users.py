...
nl|'\n'
comment|'# config option import is avoided here since it is'
nl|'\n'
...
name|'_LW'
op|'('
string|'"Cannot decode JSON from %(id_path)s"'
op|')'
op|','
nl|'\n'
op|'{'
...
newline|'\n'
nl|'\n'
comment|'# See comments above method register_storage_use'
nl|'\n'
nl|'\n'
name|'LOCK_PATH'
op|'='
