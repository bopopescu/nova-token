...
newline|'\n'
nl|'\n'
DECL|member|_validate_content_type
dedent|''
name|'def'
...
op|':'
newline|'\n'
comment|'# Docker does not return always the correct Content-Type.'
nl|'\n'
comment|'# Lets try to parse the response anyway since json is requested.'
nl|'\n'
indent|'        '
name|'if'
name|'self'
...
name|'_'
op|'('
string|'"Content-Type of response is not application/json"'
nl|'\n'
string|'" (Docker bug?). Requested URL %s"'
op|')'
op|'%'
name|'self'
op|'.'
...
op|')'
newline|'\n'
comment|'# Do not catch ValueError or SyntaxError since that'
nl|'\n'
comment|'# just hides the root cause of errors.'
nl|'\n'
name|'return'
name|'jsonutils'
op|'.'
...
op|','
nl|'\n'
string|"'/v1.7/containers/ps?all={0}'"
op|'.'
name|'format'
op|'('
name|'int'
...
op|','
nl|'\n'
string|"'/v1.7/containers/{0}/start'"
op|'.'
name|'format'
op|'('
name|'container_id'
...
op|','
nl|'\n'
string|"'/v1.7/containers/{0}/stop?t={1}'"
op|'.'
name|'format'
op|'('
name|'container_id'
...
name|'url'
op|'='
string|"'/v1.7/images/create?fromImage={0}'"
op|'.'
name|'format'
op|'('
name|'parts'
...
name|'url'
op|'='
string|"'/v1.7/commit?container={0}&repo={1}'"
op|'.'
name|'format'
op|'('
name|'container_id'
...
nl|'\n'
op|'('
string|"'/v1.7/containers/{0}/attach'"
nl|'\n'
