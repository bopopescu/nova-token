...
newline|'\n'
nl|'\n'
DECL|variable|_MAX_CONSOLE_BYTES
name|'_MAX_CONSOLE_BYTES'
op|'='
name|'units'
op|'.'
name|'Mi'
...
op|':'
newline|'\n'
comment|'# Differencing vhdx images can be resized, so we use'
nl|'\n'
comment|'# the flavor size when creating the root image'
nl|'\n'
indent|'                    '
...
op|':'
newline|'\n'
comment|'# The base image had already been resized'
nl|'\n'
indent|'                    '
name|'self'
op|'.'
...
nl|'\n'
comment|'# If it was not shutdown, retry until it succeded or a maximum of'
nl|'\n'
