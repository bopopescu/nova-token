...
newline|'\n'
nl|'\n'
comment|'# NOTE(lpetrut): Checking the namespace is needed as the'
nl|'\n'
comment|'# following method is not yet implemented in vhdutilsv2.'
nl|'\n'
name|'if'
name|'not'
name|'isinstance'
...
nl|'\n'
string|'" original size is %(base_vhd_size)s, the"'
nl|'\n'
string|'" newer size is %(root_vhd_size)s"'
nl|'\n'
op|')'
op|'%'
op|'{'
string|"'base_vhd_size'"
op|':'
name|'base_vhd_size'
op|','
nl|'\n'
