...
nl|'\n'
nl|'\n'
DECL|function|get_network_driver
name|'def'
name|'get_network_driver'
op|'('
op|')'
op|':'
newline|'\n'
indent|'    '
string|'""""Return the correct network module"""'
newline|'\n'
name|'if'
name|'nova'
op|'.'
...
op|':'
newline|'\n'
comment|'# this is an unknown network type, not neutron or nova'
nl|'\n'
indent|'        '
name|'raise'
name|'KeyError'
...
op|':'
newline|'\n'
comment|'# The manager can call the stop API after receiving instance'
nl|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|_check_hotplug_available
dedent|''
dedent|''
name|'def'
...
newline|'\n'
indent|'        '
string|'"""Check whether attaching an interface is possible for the given\n        instance.\n\n        :returns: True if attaching / detaching interfaces is possible for the\n                  given instance.\n        """'
newline|'\n'
name|'vm_state'
op|'='
name|'self'
...
op|':'
newline|'\n'
comment|'# can attach / detach interface to stopped VMs.'
nl|'\n'
indent|'            '
name|'return'
name|'True'
...
op|':'
newline|'\n'
comment|'# TODO(claudiub): add set log level to error after string freeze.'
nl|'\n'
indent|'            '
name|'LOG'
op|'.'
name|'debug'
op|'('
string|'"vNIC hot plugging is supported only in newer "'
nl|'\n'
string|'"versions than Windows Hyper-V / Server 2012 R2."'
op|')'
newline|'\n'
name|'return'
name|'False'
...
name|'debug'
op|'('
string|'"Cannot hot plug vNIC to a first generation VM."'
op|','
nl|'\n'
name|'instance'
op|'='
...
name|'debug'
op|'('
string|'"Instance not found during detach interface. It "'
nl|'\n'
string|'"might have been destroyed beforehand."'
op|','
nl|'\n'
name|'instance'
op|'='
