...
op|':'
newline|'\n'
comment|'# While the snapshot operation is not synchronized within the manager,'
nl|'\n'
comment|"# attempting to destroy an instance while it's being snapshoted fails."
nl|'\n'
indent|'        '
op|'@'
name|'utils'
...
op|')'
newline|'\n'
DECL|function|instance_synchronized_snapshot
name|'def'
name|'instance_synchronized_snapshot'
op|'('
op|')'
op|':'
newline|'\n'
...
op|':'
newline|'\n'
comment|'# the instance might disappear before starting the operation.'
nl|'\n'
indent|'            '
name|'raise'
name|'exception'
...
name|'debug'
op|'('
string|'"Merging diff disk %s into its parent."'
op|','
nl|'\n'
name|'dest_vhd_path'
op|')'
