...
name|'_'
op|'('
string|'"The SMB WMI namespace is not "'
nl|'\n'
string|'"available on this OS version."'
op|')'
op|')'
newline|'\n'
nl|'\n'
DECL|member|_set_smb_conn
dedent|''
name|'def'
name|'_set_smb_conn'
op|'('
...
op|':'
newline|'\n'
comment|'# The following namespace is not available prior to Windows'
nl|'\n'
comment|'# Server 2012. utilsfactory is not used in order to avoid a'
nl|'\n'
...
name|'debug'
op|'('
string|"'Copying file from %s to %s'"
op|','
name|'src'
op|','
name|'dest'
