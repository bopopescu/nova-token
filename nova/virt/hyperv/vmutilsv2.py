...
newline|'\n'
nl|'\n'
DECL|variable|_VIRTUAL_SYSTEM_SUBTYPE
name|'_VIRTUAL_SYSTEM_SUBTYPE'
op|'='
...
op|':'
newline|'\n'
comment|'# A separate WMI class for VM serial ports has been introduced'
nl|'\n'
comment|'# in Windows 10 / Windows Server 2016'
nl|'\n'
indent|'            '
name|'if'
name|'hostutils'
...
op|':'
newline|'\n'
comment|"# expected format: 'Microsoft:Hyper-V:SubType:2'"
nl|'\n'
indent|'            '
name|'return'
name|'int'
