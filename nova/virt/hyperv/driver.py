...
op|')'
newline|'\n'
comment|'# NOTE(claudiub): Python 3 raises the exception object given as'
nl|'\n'
comment|'# the second argument in six.reraise.'
nl|'\n'
comment|'# The original message will be maintained by passing the original'
nl|'\n'
comment|'# exception.'
nl|'\n'
name|'exc'
...
nl|'\n'
comment|'# Log an error, letting users know that this version is not'
nl|'\n'
