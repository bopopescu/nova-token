...
newline|'\n'
nl|'\n'
comment|'# check if the current version is older than kernel version 6.2'
nl|'\n'
...
op|':'
newline|'\n'
comment|'# the version is Windows Server 2008 R2. Log a warning, letting'
nl|'\n'
comment|'# users know that this version is deprecated in Liberty.'
nl|'\n'
indent|'            '
name|'LOG'
op|'.'
...
name|'_LW'
op|'('
string|"'You are running nova-compute on Windows / Hyper-V Server '"
nl|'\n'
string|"'2008 R2. This version of Windows is deprecated in the '"
nl|'\n'
string|"'current version of OpenStack and the support for it will '"
nl|'\n'
string|"'be removed in the next cycle.'"
op|')'
op|')'
newline|'\n'
nl|'\n'
