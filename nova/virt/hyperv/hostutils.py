...
newline|'\n'
nl|'\n'
DECL|variable|_HOST_FORCED_REBOOT
indent|'    '
name|'_HOST_FORCED_REBOOT'
op|'='
number|'6'
newline|'\n'
DECL|variable|_HOST_FORCED_SHUTDOWN
name|'_HOST_FORCED_SHUTDOWN'
op|'='
number|'12'
newline|'\n'
DECL|variable|_DEFAULT_VM_GENERATION
name|'_DEFAULT_VM_GENERATION'
op|'='
name|'constants'
op|'.'
...
newline|'\n'
indent|'        '
string|'"""Returns a tuple with total visible memory and free physical memory\n        expressed in kB.\n        """'
newline|'\n'
name|'mem_info'
op|'='
name|'self'
...
newline|'\n'
indent|'        '
string|'"""Returns a tuple with total size and free space\n        expressed in bytes.\n        """'
newline|'\n'
name|'logical_disk'
op|'='
name|'self'
...
newline|'\n'
nl|'\n'
DECL|member|get_host_tick_count64
dedent|''
name|'def'
...
name|'_'
op|'('
string|'"Host %(action)s is not supported by the Hyper-V driver"'
op|')'
op|'%'
nl|'\n'
op|'{'
...
newline|'\n'
nl|'\n'
DECL|member|get_supported_vm_types
dedent|''
dedent|''
name|'def'
...
newline|'\n'
nl|'\n'
DECL|member|get_default_vm_generation
dedent|''
dedent|''
name|'def'
