...
string|'"Msvm_ResourceAllocationSettingData "'
nl|'\n'
string|'"WHERE ResourceSubType LIKE "'
nl|'\n'
...
string|'"Msvm_ResourceAllocationSettingData "'
nl|'\n'
string|'"WHERE ResourceSubType = \'Microsoft "'
nl|'\n'
string|'"Synthetic SCSI Controller\' AND "'
nl|'\n'
string|'"InstanceID LIKE \'%Default%\'"'
op|')'
op|'['
...
string|'"\'Microsoft Physical Disk Drive\' "'
nl|'\n'
string|'"AND InstanceID LIKE \'%Default%\'"'
op|')'
op|'['
number|'0'
op|']'
...
string|'"WHERE ResourceSubType="'
nl|'\n'
string|'"\'Microsoft Physical Disk Drive\' AND "'
nl|'\n'
string|'"Parent=\'%s\'"'
op|'%'
name|'controller_path'
