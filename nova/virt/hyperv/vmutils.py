...
newline|'\n'
nl|'\n'
DECL|member|get_vm_iscsi_controller
dedent|''
name|'def'
...
newline|'\n'
nl|'\n'
comment|'#Collect volumes information before destroying the VM.'
nl|'\n'
...
name|'_'
op|'('
string|'"Deleting disk file: %(disk)s"'
op|')'
op|'%'
name|'locals'
op|'('
...
name|'query'
op|'('
string|'"Select * from CIM_DataFile where "'
nl|'\n'
string|'"Name = \'%s\'"'
op|'%'
name|'path'
