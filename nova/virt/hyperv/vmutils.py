...
name|'_'
op|'('
string|'"WMI job failed with status %(job_state)d. "'
nl|'\n'
string|'"Error details: %(err_sum_desc)s - %(err_desc)s - "'
nl|'\n'
...
string|'"WMI job failed with status %(job_state)d. "'
nl|'\n'
string|'"No error description available"'
op|')'
op|'%'
name|'locals'
op|'('
...
newline|'\n'
nl|'\n'
DECL|member|modify_virt_resource
dedent|''
dedent|''
name|'def'
