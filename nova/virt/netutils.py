...
nl|'\n'
nl|'\n'
DECL|function|get_non_legacy_network_template
dedent|''
name|'def'
name|'get_non_legacy_network_template'
op|'('
name|'network_info'
op|','
name|'use_ipv6'
...
newline|'\n'
nl|'\n'
comment|"# If we're passed new network_info, make use of it instead of forcing"
nl|'\n'
comment|'# it to the legacy format required below.'
nl|'\n'
dedent|''
name|'if'
name|'isinstance'
