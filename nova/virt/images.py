...
nl|'\n'
nl|'\n'
DECL|function|_remove_image_on_exec
dedent|''
name|'def'
name|'_remove_image_on_exec'
op|'('
name|'context'
op|','
name|'image_href'
...
op|':'
newline|'\n'
comment|'# The loop will stop when the handle function returns success.'
nl|'\n'
indent|'        '
name|'handler'
op|'.'
...
newline|'\n'
indent|'    '
string|'"""Fetch image and returns whether the image was stored locally."""'
newline|'\n'
name|'imagehandler_args'
op|'='
name|'imagehandler_args'
