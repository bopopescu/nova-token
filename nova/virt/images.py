...
newline|'\n'
indent|'    '
string|'"""Return a dict containing the parsed output from qemu-img info."""'
newline|'\n'
nl|'\n'
name|'out'
op|','
...
nl|'\n'
comment|'# except when its in the snapshot listing mode'
nl|'\n'
name|'data'
op|'='
op|'{'
...
op|':'
newline|'\n'
comment|'# Skip everything after the snapshot list'
nl|'\n'
comment|'# which is safe to do since the code prints'
nl|'\n'
comment|'# these out at the end and nobody currently'
nl|'\n'
comment|'# uses this information in openstack as-is.'
nl|'\n'
indent|'            '
name|'break'
newline|'\n'
