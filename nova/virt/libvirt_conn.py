...
name|'DEFINE_string'
op|'('
string|"'live_migration_timeout_sec'"
op|','
number|'10'
op|','
nl|'\n'
string|"'Timeout second for pre_live_migration is completed.'"
op|')'
newline|'\n'
name|'flags'
op|'.'
...
name|'_'
op|'('
string|"'Invalid xml: topology(%s) must have %s'"
op|')'
newline|'\n'
name|'raise'
name|'exception'
...
nl|'\n'
string|'""""topology":{"cores":"%s", "threads":"%s", "sockets":"%s"}, """'
nl|'\n'
string|'""""features":[%s]}"""'
op|')'
newline|'\n'
...
name|'_'
op|'('
string|"'Checking cpu_info: instance was launched this cpu.\\n: %s '"
op|')'
newline|'\n'
name|'LOG'
op|'.'
...
name|'_'
op|'('
string|"'Timeout migrating for %s(%s)'"
op|')'
newline|'\n'
name|'raise'
name|'exception'
...
op|'('
op|'('
string|'"""Known error: the below error is nomally occurs.\\n"""'
nl|'\n'
string|'"""Just check if iinstance is successfully migrated.\\n"""'
nl|'\n'
...
op|'='
op|'['
string|"':nova-ipv4-fallback - [0:0]'"
op|']'
newline|'\n'
name|'our_rules'
op|'='
op|'['
string|"'-A nova-ipv4-fallback -j DROP'"
op|']'
newline|'\n'
nl|'\n'
name|'our_chains'
...
op|'+='
op|'['
string|"'-A %s -j nova-ipv4-fallback'"
op|'%'
op|'('
name|'chain_name'
op|','
