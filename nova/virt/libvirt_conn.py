...
name|'_'
op|'('
string|'"Invalid xml: topology(%(topology)s) "'
nl|'\n'
string|'"must have %(ks)s"'
op|')'
op|'%'
name|'locals'
op|'('
...
name|'_'
op|'('
string|"'Compute_service record is created for %s '"
op|')'
op|'%'
name|'host'
op|')'
...
name|'_'
op|'('
string|"'Compute_service record is updated for %s '"
op|')'
op|'%'
name|'host'
op|')'
