...
nl|'\n'
string|"'%(instance_name)s is not found.'"
op|')'
op|'%'
name|'locals'
op|'('
...
op|':'
newline|'\n'
comment|'# This will happen if called by IptablesFirewallDriver'
nl|'\n'
indent|'            '
name|'LOG'
op|'.'
...
name|'_'
op|'('
string|"'The nwfilter(%(instance_secgroup_filter_name)s) for '"
nl|'\n'
string|"'%(instance_name)s is not found.'"
op|')'
op|'%'
