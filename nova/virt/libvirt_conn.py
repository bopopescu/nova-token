...
nl|'\n'
nl|'\n'
DECL|function|wrap_image_cache
dedent|''
name|'def'
name|'wrap_image_cache'
op|'('
name|'key'
op|')'
op|':'
...
name|'execute'
op|'('
string|"'dd if=/dev/zero of=%s bs=1M count=1 '"
nl|'\n'
string|"'seek=%s'"
op|'%'
op|'('
