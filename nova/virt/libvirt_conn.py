...
op|'+'
nl|'\n'
string|'"  <filterref filter=\'nova-base-filter\' />\\n"'
nl|'\n'
op|')'
op|'%'
name|'instance'
...
nl|'\n'
nl|'\n'
DECL|function|_nwfilter_name_for_security_group
dedent|''
name|'def'
name|'_nwfilter_name_for_security_group'
op|'('
name|'self'
op|','
name|'security_group_id'
...
nl|'\n'
nl|'\n'
comment|'# TODO(soren): Should override be the default (and should it even'
nl|'\n'
comment|'#              be optional? We save a bit of processing time in'
nl|'\n'
comment|'#              libvirt by only defining this conditionally, but'
nl|'\n'
comment|'#              we still have to go and ask libvirt if the group'
nl|'\n'
comment|"#              is already defined, and there's the off chance of"
nl|'\n'
comment|'#              of inconsitencies having snuck in which would get'
nl|'\n'
comment|'#              fixed by just redefining the filter.'
nl|'\n'
DECL|function|define_filter
dedent|''
name|'def'
name|'define_filter'
op|'('
...
op|':'
newline|'\n'
DECL|function|_already_exists_check
indent|'            '
name|'def'
name|'_already_exists_check'
op|'('
name|'filterlist'
op|','
name|'filter'
...
op|':'
newline|'\n'
comment|"# Pretend we looked it up and it wasn't defined"
nl|'\n'
indent|'            '
name|'d'
op|'='
...
op|')'
newline|'\n'
DECL|function|_define_if_not_exists
dedent|''
name|'def'
name|'_define_if_not_exists'
op|'('
name|'exists'
op|','
name|'xml_generator'
...
nl|'\n'
nl|'\n'
DECL|function|ensure_base_filter
dedent|''
name|'def'
name|'ensure_base_filter'
op|'('
...
nl|'\n'
nl|'\n'
DECL|function|ensure_security_group_filter
dedent|''
name|'def'
name|'ensure_security_group_filter'
op|'('
...
nl|'\n'
nl|'\n'
DECL|function|security_group_to_nwfilter_xml
dedent|''
name|'def'
name|'security_group_to_nwfilter_xml'
op|'('
...
name|'rule_xml'
op|'+='
string|'"<rule action=\'accept\' direction=\'in\' priority=\'900\'>"'
newline|'\n'
name|'if'
name|'rule'
op|'.'
...
name|'info'
op|'('
string|"'rule.protocol: %r, rule.from_port: %r, rule.to_port: %r'"
op|'%'
op|'('
name|'rule'
op|'.'
...
name|'xml'
op|'='
string|"'''<filter name='nova-secgroup-%s' chain='root'>%s</filter>'''"
op|'%'
op|'('
name|'security_group_id'
op|','
