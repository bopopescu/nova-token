...
nl|'\n'
nl|'\n'
comment|'# TODO(ewindisch): broken /w execvp patch.'
nl|'\n'
comment|'# subprocess lets us do this, but utils.execute'
nl|'\n'
comment|'# abstracts it away from us'
nl|'\n'
name|'cmd'
op|'='
string|"'netcat'"
