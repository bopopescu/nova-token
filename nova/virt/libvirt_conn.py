...
newline|'\n'
nl|'\n'
comment|'# NOTE(justinsb): We no longer delete these instances,'
nl|'\n'
comment|'# the user may want to power them back on'
nl|'\n'
comment|'#if state == power_state.SHUTOFF:'
nl|'\n'
...
nl|'\n'
comment|"#    db.instance_destroy(ctxt, instance['id'])"
nl|'\n'
nl|'\n'
name|'if'
name|'state'
...
name|'_'
op|'('
string|'"Error from libvirt during lookup: %s"'
op|')'
op|'%'
name|'e'
op|')'
