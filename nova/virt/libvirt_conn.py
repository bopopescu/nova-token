...
nl|'\n'
comment|'# device_path : /dev/etherd/e0.1, etc'
nl|'\n'
comment|'# mountpoint  :  /dev/sdh'
nl|'\n'
comment|'# dev_path is not stored anywhere, and it has driver'
nl|'\n'
comment|'# specific format. Therefore, noway other than calling'
nl|'\n'
comment|'# discover_driver here.'
nl|'\n'
indent|'                        '
name|'dev_path'
op|'='
