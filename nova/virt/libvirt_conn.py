...
op|':'
newline|'\n'
comment|'#            LOG.debug(_("re-attaching: %s") % vol[\'ec2_id\'])'
nl|'\n'
comment|'# instance-id : instance-00000001'
nl|'\n'
comment|'# device_path : /dev/etherd/e0.1, /dev/mapper/nova--volumes-volume--00000001'
nl|'\n'
comment|'# mountpoint  :  sdh'
nl|'\n'
comment|'# BTW, is iSCSI working?'
nl|'\n'
indent|'            '
name|'LOG'
op|'.'
...
name|'_'
op|'('
string|'"instance_id: %s, volume_id: %s, mountpoint: %s"'
op|')'
op|'%'
nl|'\n'
op|'('
...
op|')'
newline|'\n'
comment|"#            self.attach_volume(instance['name'], vol['id'], vol['mountpoint'])"
nl|'\n'
nl|'\n'
name|'self'
op|'.'
...
op|','
nl|'\n'
string|"'/dev/mapper/nova--volumes-volume--00000001'"
op|','
nl|'\n'
string|"'vdb'"
op|')'
