...
name|'_'
op|'('
string|'"Error while waiting for VM shutdown: %s"'
op|')'
op|'%'
name|'ex'
newline|'\n'
...
name|'_'
op|'('
string|'"VM %s was shut down cleanly."'
op|')'
op|'%'
name|'name'
newline|'\n'
...
name|'_'
op|'('
string|'"Error encountered creating VM \'%(name)s\': %(ex)s"'
op|')'
newline|'\n'
name|'LOG'
op|'.'
...
name|'_'
op|'('
string|'"VM %s successfully created."'
op|')'
op|'%'
name|'name'
op|')'
...
newline|'\n'
indent|'            '
string|'"""Check to see if the VM is running."""'
newline|'\n'
name|'try'
op|':'
newline|'\n'
...
name|'_'
op|'('
string|'"Error while waiting for VM \'%(_id)s\' to run: %(ex)s"'
op|')'
newline|'\n'
name|'LOG'
op|'.'
