...
name|'_'
op|'('
string|"'Invalid xml: topology(%(topology)s) must have %(ks)s'"
op|')'
newline|'\n'
name|'raise'
name|'exception'
...
nl|'\n'
string|'""" Because no service record found."""'
op|')'
op|')'
newline|'\n'
name|'raise'
...
name|'_'
op|'('
string|"'Migrating %(ec2_id)s to %(dest)s finishes successfully'"
op|')'
newline|'\n'
name|'LOG'
op|'.'
