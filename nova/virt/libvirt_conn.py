...
name|'retval'
op|'='
string|'"<filter name=\'nova-project-%s-v6\' chain=\'ipv6\'>"'
op|'%'
name|'project'
newline|'\n'
name|'for'
...
name|'retval'
op|'+='
string|'"""<rule action=\'accept\' direction=\'inout\' priority=\'200\'>\n                           <%s srcipaddr=\'%s\' srcipmask=\'%s\' />\n                         </rule>"""'
op|'%'
op|'('
name|'protocol'
op|','
...
name|'nwfilter_xml'
op|'+='
string|'"  <filterref filter=\'nova-project-%s-v6\' />\\n"'
op|'%'
name|'instance'
op|'['
string|"'project_id'"
