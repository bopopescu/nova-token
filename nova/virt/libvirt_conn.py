...
op|':'
newline|'\n'
comment|'# This is weird looking, but NWFilter is libvirt specific'
nl|'\n'
comment|'# and requires more cooperation between the two.'
nl|'\n'
indent|'            '
name|'self'
op|'.'
