...
name|'self'
op|'.'
name|'intermediate_filters_configured'
op|'='
name|'False'
newline|'\n'
name|'self'
...
name|'info'
op|'('
string|"'ensuring intermediate filters'"
op|')'
newline|'\n'
name|'self'
op|'.'
name|'_ensure_intermediate_filters'
op|'('
op|')'
newline|'\n'
nl|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|_ensure_intermediate_filters
dedent|''
name|'def'
name|'_ensure_intermediate_filters'
op|'('
...
op|'+='
op|'['
string|"':nova-provider - [0:0]'"
op|']'
newline|'\n'
name|'our_rules'
op|'+='
op|'['
string|"'-A FORWARD -j nova-provider'"
op|']'
newline|'\n'
nl|'\n'
comment|'# Build all the provider-level drops, then jump to local'
nl|'\n'
name|'rules'
op|'='
name|'db'
...
op|'+='
op|'['
string|"'-A nova-provider -j nova-local'"
op|']'
newline|'\n'
nl|'\n'
