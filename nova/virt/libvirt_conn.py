...
op|':'
newline|'\n'
comment|'#TODO(ilyaalekseyev) If we will keep this function'
nl|'\n'
...
name|'None'
newline|'\n'
comment|'#network_ref = db.network_get_by_instance(context.get_admin_context(),'
nl|'\n'
comment|"#                                         inst['id'])"
nl|'\n'
nl|'\n'
...
newline|'\n'
nl|'\n'
comment|'#TODO(ilyaalekseyev) remove network_info creation code'
nl|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|_all_ra_servers_for_instance
dedent|''
name|'def'
name|'_all_ra_servers_for_instance'
op|'('
name|'selfself'
op|','
name|'instance'
...
op|':'
newline|'\n'
comment|'#ra_server = self._ra_server_for_instance(instance)'
nl|'\n'
indent|'            '
name|'ra_servers'
op|'='
