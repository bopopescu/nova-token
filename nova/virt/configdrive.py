...
string|"'vfat'"
newline|'\n'
DECL|variable|FS_FORMAT_ISO9660
name|'FS_FORMAT_ISO9660'
op|'='
string|"'iso9660'"
newline|'\n'
nl|'\n'
DECL|variable|IMAGE_TYPE_RAW
name|'IMAGE_TYPE_RAW'
op|'='
string|"'raw'"
newline|'\n'
DECL|variable|IMAGE_TYPE_PLOOP
...
newline|'\n'
nl|'\n'
DECL|member|_make_ext4_ploop
dedent|''
dedent|''
dedent|''
dedent|''
name|'def'
name|'_make_ext4_ploop'
op|'('
name|'self'
op|','
name|'path'
