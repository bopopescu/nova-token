...
string|"'RSA-PSS'"
newline|'\n'
comment|'# ECC Options -- note that only those with key sizes >=384 are included'
nl|'\n'
DECL|variable|ECC_SECT571K1
name|'ECC_SECT571K1'
op|'='
string|"'ECC_SECT571K1'"
newline|'\n'
DECL|variable|ECC_SECT409K1
name|'ECC_SECT409K1'
op|'='
string|"'ECC_SECT409K1'"
newline|'\n'
DECL|variable|ECC_SECT571R1
name|'ECC_SECT571R1'
op|'='
string|"'ECC_SECT571R1'"
newline|'\n'
DECL|variable|ECC_SECT409R1
name|'ECC_SECT409R1'
op|'='
string|"'ECC_SECT409R1'"
newline|'\n'
DECL|variable|ECC_SECP521R1
name|'ECC_SECP521R1'
op|'='
string|"'ECC_SECP521R1'"
newline|'\n'
DECL|variable|ECC_SECP384R1
name|'ECC_SECP384R1'
op|'='
...
newline|'\n'
nl|'\n'
comment|'# This includes the supported public key type for the signature key type'
nl|'\n'
DECL|variable|SIGNATURE_KEY_TYPES
...
newline|'\n'
nl|'\n'
comment|'# map the key type to the verifier function to use'
nl|'\n'
DECL|variable|KEY_TYPE_METHODS
dedent|''
name|'KEY_TYPE_METHODS'
op|'='
op|'{'
nl|'\n'
name|'RSA_PSS'
...
nl|'\n'
nl|'\n'
DECL|function|should_verify_signature
name|'def'
...
nl|'\n'
string|"' do not exist. Cannot verify signature.'"
op|')'
op|')'
newline|'\n'
nl|'\n'
...
nl|'\n'
nl|'\n'
DECL|function|get_signature_key_type
dedent|''
name|'def'
name|'get_signature_key_type'
op|'('
