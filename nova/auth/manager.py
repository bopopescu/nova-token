...
name|'True'
op|','
string|"'Support per-project vpns'"
op|')'
newline|'\n'
name|'flags'
op|'.'
...
string|"'auth_driver'"
op|','
string|"'nova.auth.ldapdriver.AuthDriver'"
op|','
nl|'\n'
...
newline|'\n'
indent|'    '
string|'"""Manages vpn ips and ports for projects"""'
newline|'\n'
DECL|member|__init__
name|'def'
name|'__init__'
...
name|'Error'
op|'('
string|"'Auth driver %s cannot be found'"
nl|'\n'
op|'%'
name|'FLAGS'
op|'.'
...
newline|'\n'
indent|'        '
string|'"""Retrieves list of all projects"""'
newline|'\n'
name|'with'
name|'self'
op|'.'
...
name|'Error'
op|'('
string|'"No vpn data allocated for project %s"'
op|'%'
nl|'\n'
name|'project'
op|'.'
