...
name|'_'
op|'('
string|"'User %(uid)s is not a member of'"
nl|'\n'
string|"' project %(pjid)s'"
op|')'
op|'%'
name|'locals'
op|'('
...
name|'utils'
op|'.'
name|'get_secondary_server_string'
op|'('
name|'server_string'
op|')'
newline|'\n'
...
op|')'
newline|'\n'
comment|'# NOTE(itoumsn): RightAWS success case.'
nl|'\n'
dedent|''
dedent|''
name|'LOG'
