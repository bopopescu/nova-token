...
name|'help'
op|'='
string|"'This flag must be set to use old style auth'"
op|')'
op|','
nl|'\n'
name|'cfg'
...
name|'help'
op|'='
string|"'Filename of rc in credentials zip %s will be replaced by '"
nl|'\n'
string|"'name of the region (nova by default)'"
op|')'
op|','
nl|'\n'
name|'cfg'
...
op|')'
newline|'\n'
comment|'# NOTE(vish): Deprecated auth uses an access key, no auth uses a'
nl|'\n'
comment|'#             the user_id in place of it.'
nl|'\n'
name|'if'
name|'FLAGS'
op|'.'
