...
name|'_'
op|'('
string|'"failed authorization: no project named %s (user=%s)"'
op|')'
op|','
nl|'\n'
name|'project_id'
...
name|'_'
op|'('
string|'"Failed authorization: user %s not admin and not "'
nl|'\n'
string|'"member of project %s"'
op|')'
op|','
name|'user'
op|'.'
...
name|'_'
op|'('
string|'"Adding role %s to user %s in project %s"'
op|')'
op|','
name|'role'
op|','
...
name|'_'
op|'('
string|'"Removing role %s from user %s on project %s"'
op|')'
op|','
nl|'\n'
name|'role'
...
name|'_'
op|'('
string|'"Created project %s with manager %s"'
op|')'
op|','
name|'name'
op|','
...
name|'_'
op|'('
string|'"Remove user %s from project %s"'
op|')'
op|','
name|'User'
op|'.'
...
name|'_'
op|'('
string|'"Admin status set to %r for user %s"'
op|')'
op|','
name|'admin'
op|','
