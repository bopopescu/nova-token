...
indent|'        '
name|'return'
string|'"/C=US/ST=California/L=Mountain View/O=Anso Labs/OU=Nova Dev/CN=%s-%s"'
op|'%'
op|'('
name|'uid'
op|','
...
newline|'\n'
nl|'\n'
DECL|member|find_groups_with_member
dedent|''
name|'def'
name|'find_groups_with_member'
op|'('
name|'self'
op|','
name|'tree'
...
name|'debug'
op|'('
string|'"Attempted to remove the last member of a group.  Deleting the group instead."'
op|')'
newline|'\n'
name|'self'
op|'.'
