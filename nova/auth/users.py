...
op|':'
newline|'\n'
comment|'# TODO (vish): get list of vpn ips from redis'
nl|'\n'
indent|'        '
name|'for'
name|'ip'
...
op|':'
newline|'\n'
comment|'# TODO(vish): the redis access should be refactored into a'
nl|'\n'
comment|'#             base class'
nl|'\n'
indent|'        '
...
op|':'
newline|'\n'
comment|'# NOTE(vish): try to associate a vpn ip and port first because'
nl|'\n'
comment|'#             if it throws an exception, we save having to'
nl|'\n'
comment|'#             create and destroy a project'
nl|'\n'
indent|'            '
name|'Vpn'
op|'.'
...
op|':'
newline|'\n'
comment|'# NOTE(vish): if the project creation fails, we delete'
nl|'\n'
comment|'#             the user and return an exception'
nl|'\n'
indent|'                '
name|'try'
op|':'
