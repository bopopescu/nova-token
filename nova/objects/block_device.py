...
nl|'\n'
comment|'# Version 1.16: Deprecate get_by_volume_id(), add'
nl|'\n'
comment|'#               get_by_volume() and get_by_volume_and_instance()'
nl|'\n'
comment|'# Version 1.17: Added tag field'
nl|'\n'
...
newline|'\n'
nl|'\n'
comment|'# NOTE(danms): This method is deprecated and will be removed in'
nl|'\n'
comment|'# v2.0 of the object'
nl|'\n'
dedent|''
dedent|''
op|'@'
...
name|'_LW'
op|'('
string|"'Legacy get_by_volume_id() call found multiple '"
nl|'\n'
string|"'BDMs for volume %(volume)s'"
op|')'
op|','
nl|'\n'
op|'{'
...
name|'remotable_classmethod'
newline|'\n'
DECL|member|get_by_volume_and_instance
name|'def'
...
nl|'\n'
comment|'# Version 1.2: Added use_subordinate to get_by_instance_uuid'
nl|'\n'
...
newline|'\n'
DECL|member|_db_block_device_mapping_get_all_by_instance_uuids
name|'def'
name|'_db_block_device_mapping_get_all_by_instance_uuids'
op|'('
nl|'\n'
name|'context'
op|','
...
name|'select_db_reader_mode'
newline|'\n'
DECL|member|_db_block_device_mapping_get_all_by_instance
name|'def'
name|'_db_block_device_mapping_get_all_by_instance'
op|'('
nl|'\n'
name|'context'
op|','
