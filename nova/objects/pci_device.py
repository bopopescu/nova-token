...
nl|'\n'
comment|'# Version 1.5: Added 2 new device statuses: UNCLAIMABLE and UNAVAILABLE'
nl|'\n'
...
name|'reason'
op|'='
string|"'status=%s not supported in version %s'"
op|'%'
op|'('
nl|'\n'
name|'status'
...
newline|'\n'
nl|'\n'
comment|"# NOTE(ndipanov): This needs to be set as it's accessed when matching"
nl|'\n'
name|'dev_dict'
op|'.'
name|'setdefault'
...
name|'staticmethod'
newline|'\n'
DECL|member|_bulk_update_status
name|'def'
name|'_bulk_update_status'
op|'('
name|'dev_list'
op|','
name|'status'
...
op|':'
newline|'\n'
comment|'# Update PF status to CLAIMED if all of it dependants are free'
nl|'\n'
comment|'# and set their status to UNCLAIMABLE'
nl|'\n'
indent|'            '
name|'vfs_list'
op|'='
...
op|':'
newline|'\n'
comment|"# Update VF status to CLAIMED if it's parent has not been"
nl|'\n'
comment|'# previuosly allocated or claimed'
nl|'\n'
comment|"# When claiming/allocating a VF, it's parent PF becomes"
nl|'\n'
comment|'# unclaimable/unavailable. Therefore, it is expected to find the'
nl|'\n'
comment|'# parent PF in an unclaimable/unavailable state for any following'
nl|'\n'
comment|'# claims to a sibling VF'
nl|'\n'
nl|'\n'
indent|'            '
name|'parent_ok_statuses'
op|'='
op|'('
name|'fields'
op|'.'
...
name|'debug'
op|'('
string|"'Physical function addr: %(pf_addr)s parent of '"
nl|'\n'
string|"'VF addr: %(vf_addr)s was not found'"
op|','
nl|'\n'
op|'{'
string|"'pf_addr'"
...
op|':'
newline|'\n'
comment|'# Set all PF dependants status to AVAILABLE'
nl|'\n'
indent|'            '
name|'vfs_list'
op|'='
...
op|':'
newline|'\n'
comment|"# Set PF status to AVAILABLE if all of it's VFs are free"
nl|'\n'
indent|'            '
name|'vfs_list'
op|'='
