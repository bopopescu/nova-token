...
newline|'\n'
nl|'\n'
DECL|member|reset_forced_destinations
dedent|''
name|'def'
...
name|'None'
newline|'\n'
comment|"# NOTE(sbauza): Make sure we don't persist this, we need to keep the"
nl|'\n'
comment|'# original request for the forced hosts'
nl|'\n'
name|'self'
op|'.'
name|'obj_reset_changes'
