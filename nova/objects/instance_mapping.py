...
newline|'\n'
nl|'\n'
DECL|member|_update_with_cell_id
name|'def'
name|'_update_with_cell_id'
op|'('
name|'self'
op|','
name|'updates'
...
op|':'
newline|'\n'
comment|'# cell_mapping can be None indicating that the instance has'
nl|'\n'
comment|'# not been scheduled yet.'
nl|'\n'
indent|'                '
name|'if'
name|'db_value'
...
nl|'\n'
comment|'# cell_mapping on the object later because we never need an'
nl|'\n'
comment|'# InstanceMapping without the CellMapping.'
nl|'\n'
name|'db_mapping'
op|'.'
name|'cell_mapping'
