...
newline|'\n'
nl|'\n'
comment|'# NOTE(danms): Remove this conditional load (and remove uuid from'
nl|'\n'
comment|"# the list of special_cases above) once we're in Newton and have"
nl|'\n'
comment|'# enforced that all UUIDs in the database are not NULL.'
nl|'\n'
name|'if'
name|'db_compute'
op|'.'
...
newline|'\n'
nl|'\n'
comment|'# NOTE(danms): This needs to come after obj_reset_changes() to make'
nl|'\n'
comment|'# sure we only save the uuid, if we generate one.'
nl|'\n'
comment|'# FIXME(danms): Remove this in Newton once we have enforced that'
nl|'\n'
comment|'# all compute nodes have uuids set in the database.'
nl|'\n'
name|'if'
string|"'uuid'"
name|'not'
...
name|'debug'
op|'('
string|"'Generated UUID %(uuid)s for compute node %(id)i'"
op|','
nl|'\n'
name|'dict'
op|'('
