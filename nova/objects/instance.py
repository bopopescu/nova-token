...
nl|'\n'
comment|'# NOTE(vish): pci_devices is a list object so we must pull the'
nl|'\n'
comment|'#             underlying primitive out of the nova_object_data.'
nl|'\n'
indent|'            '
name|'self'
op|'.'
...
op|':'
newline|'\n'
comment|'# NOTE(danms): We handle fault differently here so that we'
nl|'\n'
