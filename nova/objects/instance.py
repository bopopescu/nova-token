...
op|')'
newline|'\n'
comment|"# FIXME(danms): Unfortunately NovaObject doesn't have"
nl|'\n'
comment|'# a __del__ which means we have to peer behind the'
nl|'\n'
comment|'# facade here to get these attributes deleted. Since'
nl|'\n'
comment|'# they\'re stored as "_$name" we can do that here, but'
nl|'\n'
comment|'# I need to follow up with a proper handler on the'
nl|'\n'
comment|'# base class.'
nl|'\n'
name|'del'
