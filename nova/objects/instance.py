...
nl|'\n'
nl|'\n'
comment|'# These are fields that can be specified as expected_attrs but are'
nl|'\n'
comment|'# also joined often by default.'
nl|'\n'
DECL|variable|INSTANCE_OPTIONAL_COMMON_FIELDS
name|'INSTANCE_OPTIONAL_COMMON_FIELDS'
op|'='
op|'['
string|"'metadata'"
op|','
