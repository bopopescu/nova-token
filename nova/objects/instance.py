...
nl|'\n'
comment|'# Version 1.23: Added migration_context'
nl|'\n'
...
op|':'
newline|'\n'
comment|'# NOTE(danms): Special case to backport to 1.x. Serialize'
nl|'\n'
comment|'# ourselves, change the version, deserialize that, and get'
nl|'\n'
comment|'# that to continue the backport of this primitive to'
nl|'\n'
comment|'# whatever 1.x version was actually requested.  We can get'
nl|'\n'
comment|'# away with this because InstanceV2 is structurally a'
nl|'\n'
comment|'# subset of V1.'
nl|'\n'
comment|'# FIXME(danms): Remove this when we drop v1.x compatibility'
nl|'\n'
indent|'            '
name|'my_prim'
op|'='
...
nl|'\n'
nl|'\n'
comment|'# NOTE(danms): For the unit tests...'
nl|'\n'
...
nl|'\n'
nl|'\n'
DECL|class|_BaseInstanceList
dedent|''
name|'class'
name|'_BaseInstanceList'
op|'('
name|'base'
op|'.'
name|'ObjectListBase'
...
nl|'\n'
comment|'# Version 1.21: New method get_by_grantee_security_group_ids()'
nl|'\n'
comment|'# Version 1.22: Instance <= version 1.23'
nl|'\n'
DECL|variable|VERSION
indent|'    '
name|'VERSION'
...
newline|'\n'
nl|'\n'
DECL|variable|NOVA_OBJ_INSTANCE_CLS
name|'NOVA_OBJ_INSTANCE_CLS'
op|'='
name|'InstanceV1'
newline|'\n'
