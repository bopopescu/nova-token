...
nl|'\n'
comment|'# Version 1.3: Add cpu_policy and cpu_thread_policy fields'
nl|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|clear_host_pinning
dedent|''
dedent|''
name|'def'
...
newline|'\n'
indent|'        '
string|'"""Clear any data related to how instance is pinned to the host.\n\n        Needed for aborting claims as we do not want to keep stale data around.\n        """'
newline|'\n'
name|'for'
name|'cell'
name|'in'
