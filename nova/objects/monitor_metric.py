...
newline|'\n'
nl|'\n'
comment|'# NOTE(suro-patz): While instantiating the MonitorMetric() from'
nl|'\n'
comment|'#                  JSON-ified string, we need to re-convert the'
nl|'\n'
comment|'#                  normalized metrics to avoid truncation to 0 by'
nl|'\n'
comment|'#                  typecasting into an integer.'
nl|'\n'
name|'metric_list'
op|'='
op|'['
