...
nl|'\n'
comment|'# Version 1.1: Add use_subordinate to get_by_instance_uuid_and_mac'
nl|'\n'
...
newline|'\n'
DECL|member|_db_bw_usage_get
name|'def'
name|'_db_bw_usage_get'
op|'('
name|'context'
op|','
name|'uuid'
...
comment|'# Version 1.0: Initial version'
nl|'\n'
comment|'# Version 1.1: Add use_subordinate to get_by_uuids'
nl|'\n'
...
name|'select_db_reader_mode'
newline|'\n'
DECL|member|_db_bw_usage_get_by_uuids
name|'def'
name|'_db_bw_usage_get_by_uuids'
op|'('
name|'context'
op|','
name|'uuids'
