...
op|','
nl|'\n'
comment|'# Version 10: Compute node conversion to Inventories'
nl|'\n'
op|'{'
string|"'compute_rpc'"
op|':'
...
nl|'\n'
comment|'# Version 1.4: Added use_subordinate to get_by_compute_host'
nl|'\n'
...
nl|'\n'
comment|'# Version 1.20: Added get_minimum_version_multi()'
nl|'\n'
...
newline|'\n'
DECL|member|_db_service_get_by_compute_host
name|'def'
name|'_db_service_get_by_compute_host'
op|'('
name|'context'
op|','
name|'host'
...
name|'select_db_reader_mode'
newline|'\n'
DECL|member|_db_service_get_minimum_version
name|'def'
name|'_db_service_get_minimum_version'
op|'('
name|'context'
op|','
name|'binaries'
...
name|'remotable_classmethod'
newline|'\n'
DECL|member|get_minimum_version_multi
name|'def'
...
nl|'\n'
comment|'# Version 1.18: Added include_disabled parameter to get_by_binary()'
nl|'\n'
DECL|variable|VERSION
indent|'    '
name|'VERSION'
...
newline|'\n'
nl|'\n'
comment|'# NOTE(paul-carlton2): In v2.0 of the object the include_disabled flag'
nl|'\n'
comment|'# will be removed so both enabled and disabled hosts are returned'
nl|'\n'
dedent|''
op|'@'
name|'base'
