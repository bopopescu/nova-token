...
name|'_'
op|'('
string|'"Hypervisr virt type \'%s\' is not valid"'
op|')'
op|'%'
name|'value'
newline|'\n'
...
nl|'\n'
nl|'\n'
comment|'# This is a strict interpretation of boolean'
nl|'\n'
comment|"# values using Python's semantics for truth/falsehood"
nl|'\n'
