...
name|'IPAddressField'
newline|'\n'
DECL|variable|IPV4AddressField
...
name|'IPV4AddressField'
newline|'\n'
DECL|variable|IPV6AddressField
...
name|'IPNetworkField'
newline|'\n'
DECL|variable|IPV4NetworkField
...
name|'IPV4NetworkField'
newline|'\n'
DECL|variable|IPV6NetworkField
...
nl|'\n'
comment|'#  retains the legacy behavior, whereby siblings are preferred when'
nl|'\n'
...
newline|'\n'
indent|'    '
string|'"""Classes of resources provided to consumers."""'
newline|'\n'
nl|'\n'
DECL|variable|VCPU
name|'VCPU'
...
string|"'MEMORY_MB'"
newline|'\n'
DECL|variable|DISK_GB
name|'DISK_GB'
op|'='
string|"'DISK_GB'"
newline|'\n'
DECL|variable|PCI_DEVICE
name|'PCI_DEVICE'
op|'='
string|"'PCI_DEVICE'"
newline|'\n'
DECL|variable|SRIOV_NET_VF
name|'SRIOV_NET_VF'
op|'='
string|"'SRIOV_NET_VF'"
newline|'\n'
DECL|variable|NUMA_SOCKET
name|'NUMA_SOCKET'
op|'='
string|"'NUMA_SOCKET'"
newline|'\n'
DECL|variable|NUMA_CORE
name|'NUMA_CORE'
op|'='
string|"'NUMA_CORE'"
newline|'\n'
DECL|variable|NUMA_THREAD
name|'NUMA_THREAD'
op|'='
string|"'NUMA_THREAD'"
newline|'\n'
DECL|variable|NUMA_MEMORY_MB
name|'NUMA_MEMORY_MB'
op|'='
string|"'NUMA_MEMORY_MB'"
newline|'\n'
DECL|variable|IPV4_ADDRESS
name|'IPV4_ADDRESS'
op|'='
string|"'IPV4_ADDRESS'"
newline|'\n'
nl|'\n'
comment|'# The ordering here is relevant. If you must add a value, only'
nl|'\n'
comment|'# append.'
nl|'\n'
DECL|variable|ALL
...
newline|'\n'
indent|'        '
string|'"""Return an index into the Enum given a value."""'
newline|'\n'
name|'return'
name|'cls'
op|'.'
...
newline|'\n'
indent|'        '
string|'"""Return the Enum value at a given index."""'
newline|'\n'
name|'return'
name|'cls'
op|'.'
...
name|'PATTERN'
op|'='
string|"'[a-f0-9]{4}:[a-f0-9]{2}:[a-f0-9]{2}.[a-f0-9]'"
newline|'\n'
nl|'\n'
op|'@'
name|'staticmethod'
...
name|'PATTERN'
op|'='
string|"'[a-f0-9]+:[a-f0-9]+:[a-f0-9]+:[a-f0-9]+'"
newline|'\n'
nl|'\n'
op|'@'
name|'staticmethod'
