...
nl|'\n'
nl|'\n'
comment|"# We don't want to register this object because it will not be passed"
nl|'\n'
comment|'# around on RPC, it just makes our lives a lot easier in the API when'
nl|'\n'
comment|'# dealing with floating IP operations'
nl|'\n'
dedent|''
dedent|''
op|'@'
