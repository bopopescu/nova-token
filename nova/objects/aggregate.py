...
nl|'\n'
comment|'# Version 1.2: Added uuid field'
nl|'\n'
...
newline|'\n'
nl|'\n'
comment|'# NOTE(danms): Remove this conditional load (and remove uuid'
nl|'\n'
comment|"# special cases above) once we're in Newton and have enforced"
nl|'\n'
comment|'# that all UUIDs in the database are not NULL.'
nl|'\n'
dedent|''
name|'if'
name|'db_aggregate'
...
nl|'\n'
comment|'# all aggregates have uuids set in the database.'
nl|'\n'
name|'if'
string|"'uuid'"
name|'not'
...
name|'debug'
op|'('
string|"'Generating UUID %(uuid)s for aggregate %(agg)i'"
op|','
nl|'\n'
name|'dict'
op|'('
...
name|'debug'
op|'('
string|"'Generated uuid %(uuid)s for aggregate'"
op|','
nl|'\n'
name|'dict'
op|'('
