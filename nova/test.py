...
op|')'
newline|'\n'
comment|'# NOTE(danms): Flavors are encoded in our original migration'
nl|'\n'
comment|'# which means we have no real option other than to migrate them'
nl|'\n'
comment|'# onlineish every time we build a new database (for now).'
nl|'\n'
name|'ctxt'
op|'='
name|'context'
...
name|'mismatch'
newline|'\n'
comment|'# inverting the observed / expected because testtools'
nl|'\n'
comment|'# error messages assume expected is second. Possibly makes'
nl|'\n'
comment|'# reading the error messages less confusing.'
nl|'\n'
name|'raise'
name|'testtools'
op|'.'
