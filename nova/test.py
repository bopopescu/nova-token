...
newline|'\n'
nl|'\n'
comment|'# NOTE(rpodolyaka): this attribute can be overridden in subclasses in order'
nl|'\n'
comment|'#                   to scale the global test timeout value set for each'
nl|'\n'
comment|'#                   test case separately. Use 0 value to disable timeout.'
nl|'\n'
...
name|'ValueError'
op|'('
string|"'TIMEOUT_SCALING_FACTOR value must be >= 0'"
op|')'
newline|'\n'
nl|'\n'
dedent|''
...
newline|'\n'
nl|'\n'
DECL|function|_cleanup_lock_path
name|'def'
name|'_cleanup_lock_path'
op|'('
op|')'
op|':'
newline|'\n'
comment|'# because CONF is a global object, we actually have to'
nl|'\n'
comment|'# explicitly zero it out afterwards'
nl|'\n'
indent|'                '
name|'CONF'
op|'.'
