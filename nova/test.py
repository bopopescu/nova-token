...
name|'self'
op|'.'
name|'_original_flags_verbosity'
op|'='
name|'FLAGS'
op|'.'
name|'verbose'
...
op|':'
newline|'\n'
comment|"# Store original flag value if it's not been overriden yet"
nl|'\n'
indent|'            '
name|'if'
name|'k'
...
newline|'\n'
nl|'\n'
DECL|member|set_flags_verbosity
dedent|''
name|'def'
...
newline|'\n'
indent|'        '
string|'"""Set the FLAGS verbosity for a test"""'
newline|'\n'
name|'FLAGS'
op|'.'
name|'verbose'
