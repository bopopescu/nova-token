...
newline|'\n'
nl|'\n'
DECL|member|_apply_multistring_defaults
dedent|''
name|'def'
name|'_apply_multistring_defaults'
op|'('
name|'self'
op|','
name|'values'
...
comment|'#'
nl|'\n'
comment|'# This horrendous hack is to stop optparse appending'
nl|'\n'
comment|'# values to the default value. See:'
nl|'\n'
comment|'#   http://bugs.python.org/issue5088'
nl|'\n'
comment|'#'
nl|'\n'
indent|'        '
...
comment|'#'
nl|'\n'
comment|'# This horrendous hack is needed because optparse only'
nl|'\n'
comment|'# shallow copies its defaults dict before parsing'
nl|'\n'
comment|'#'
nl|'\n'
name|'defaults'
...
comment|'#'
nl|'\n'
comment|"# FIXME(markmc): this doesn't support --boolflag=true/false/t/f/1/0"
nl|'\n'
comment|'#'
nl|'\n'
indent|'        '
