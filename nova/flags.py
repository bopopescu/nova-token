...
name|'help'
op|'='
string|"'URL of ajax console proxy, in the form http://host:port'"
op|')'
op|','
nl|'\n'
name|'cfg'
...
name|'help'
op|'='
string|"'the VC image ID (for a VC image that exists in Glance)'"
op|')'
op|','
nl|'\n'
name|'cfg'
...
name|'help'
op|'='
string|"'Key/Multi-value list with the capabilities of the zone'"
op|')'
op|','
nl|'\n'
name|'cfg'
