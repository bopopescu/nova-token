...
op|'}'
newline|'\n'
comment|"# If someone wants to pretend they're hitting the OSAPI subdomain"
nl|'\n'
comment|"# on their local box, they can set FAKE_subdomain to 'api', which"
nl|'\n'
comment|'# removes subdomain restrictions from the OpenStack API routes below.'
nl|'\n'
name|'if'
name|'FLAGS'
op|'.'
