...
newline|'\n'
nl|'\n'
comment|'#        mapper.connect("/", controller=self.osapi_versions,'
nl|'\n'
comment|'#                       conditions=osapi_subdomain)'
nl|'\n'
comment|'#        mapper.connect("/v1.0/{path_info:.*}", controller=openstack.API(),'
nl|'\n'
comment|'#                       conditions=osapi_subdomain)'
nl|'\n'
comment|'#'
nl|'\n'
comment|'#        mapper.connect("/", controller=self.ec2api_versions,'
nl|'\n'
comment|'#                       conditions=ec2api_subdomain)'
nl|'\n'
comment|'#        mapper.connect("/services/{path_info:.*}", controller=ec2.API(),'
nl|'\n'
comment|'#                       conditions=ec2api_subdomain)'
nl|'\n'
nl|'\n'
