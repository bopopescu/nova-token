...
name|'getLogger'
op|'('
string|'"nova.api.openstack.v2.contrib.security_groups"'
op|')'
newline|'\n'
DECL|variable|FLAGS
name|'FLAGS'
...
nl|'\n'
nl|'\n'
DECL|class|SecurityGroupXMLSerializer
dedent|''
dedent|''
name|'class'
name|'SecurityGroupXMLSerializer'
op|'('
name|'xmlutil'
op|'.'
...
nl|'\n'
nl|'\n'
DECL|class|SecurityGroupRulesXMLSerializer
dedent|''
dedent|''
name|'class'
name|'SecurityGroupRulesXMLSerializer'
op|'('
name|'xmlutil'
op|'.'
name|'XMLTemplateSerializer'
