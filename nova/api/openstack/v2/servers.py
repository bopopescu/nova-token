...
name|'getLogger'
op|'('
string|"'nova.api.openstack.v2.servers'"
op|')'
newline|'\n'
DECL|variable|FLAGS
name|'FLAGS'
...
nl|'\n'
nl|'\n'
comment|'# NOTE(bcwaldon): expose the message generated below in order'
nl|'\n'
comment|'# to better explain how the quota was exceeded'
nl|'\n'
...
name|'_'
op|'('
string|'"Unable to delete instance when %s"'
op|')'
op|'%'
name|'state'
newline|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|_add_server_location
indent|'    '
name|'def'
name|'_add_server_location'
op|'('
name|'self'
op|','
name|'response'
...
op|':'
newline|'\n'
comment|'# FIXME(jerdfelt): This is kind of a hack. Unfortunately the original'
nl|'\n'
comment|"# action requested isn't available to us, so we need to look at the"
nl|'\n'
comment|'# response to see if it looks like a rebuild response.'
nl|'\n'
indent|'        '
name|'if'
name|'data'
...
newline|'\n'
nl|'\n'
comment|'# Attach security groups node'
nl|'\n'
name|'secgrps'
op|'='
name|'SecurityGroupsTemplateElement'
