...
nl|'\n'
comment|'# +microversions because the keypair creation finishes when returning'
nl|'\n'
comment|'# a response.'
nl|'\n'
dedent|''
...
nl|'\n'
comment|'# +microversions because the resource keypair has been deleted completely'
nl|'\n'
...
op|':'
newline|'\n'
comment|'# Since this method returns the whole object, functional test'
nl|'\n'
comment|'# test_keypairs_get is failing, receiving an unexpected field'
nl|'\n'
comment|"# 'type', which was added to the keypair object."
nl|'\n'
comment|'# TODO(claudiub): Revert the changes in the next commit, which will'
nl|'\n'
comment|'# enable nova-api to return the keypair type.'
nl|'\n'
indent|'            '
name|'keypair'
op|'='
