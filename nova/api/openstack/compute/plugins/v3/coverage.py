...
nl|'\n'
nl|'\n'
DECL|function|_import_coverage
name|'def'
name|'_import_coverage'
op|'('
op|')'
op|':'
newline|'\n'
indent|'    '
string|'"""This function ensures loading coverage module from python-coverage."""'
newline|'\n'
name|'try'
op|':'
newline|'\n'
...
op|':'
newline|'\n'
comment|'# To avoid importing this module itself, it need to remove current'
nl|'\n'
comment|'# directory from search path.'
nl|'\n'
indent|'            '
name|'path'
op|'.'
...
name|'_'
op|'('
string|'"Can\'t load coverage module: %s"'
op|')'
op|','
name|'e'
op|')'
...
newline|'\n'
nl|'\n'
DECL|member|_check_coverage_module_loaded
dedent|''
name|'def'
name|'_check_coverage_module_loaded'
op|'('
name|'self'
op|')'
op|':'
