...
op|')'
newline|'\n'
DECL|variable|VALID_DATETIME_FORMAT
...
name|'_'
op|'('
string|'"Start time is invalid format, valid "'
nl|'\n'
string|'"formats are %s"'
op|')'
op|'%'
name|'VALID_DATETIME_FORMAT'
newline|'\n'
...
name|'_'
op|'('
string|'"Stop time is invalid format, valid "'
nl|'\n'
string|'"formats are %s"'
op|')'
op|'%'
...
nl|'\n'
string|'"os-simple-tenant-usage/api/v3"'
op|')'
newline|'\n'
