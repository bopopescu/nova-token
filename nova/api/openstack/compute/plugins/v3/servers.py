...
nl|'\n'
comment|'# Replace with an entry point when the OS-SCH-HNT extension is'
nl|'\n'
comment|'# ported'
nl|'\n'
comment|'#scheduler_hints = self._extract_scheduler_hints(server_node)'
nl|'\n'
comment|'#if scheduler_hints:'
nl|'\n'
comment|"#    server['OS-SCH-HNT:scheduler_hints'] = scheduler_hints"
nl|'\n'
nl|'\n'
dedent|''
name|'metadata_node'
...
comment|'# TODO(cyeoh): bp v3-api-core-as-extensions'
nl|'\n'
comment|'# Replace with an extension point when the disk_config'
nl|'\n'
comment|'# extension is ported'
nl|'\n'
comment|"# auto_disk_config = server_node.getAttribute('auto_disk_config')"
nl|'\n'
comment|'#if auto_disk_config:'
nl|'\n'
comment|"#    server['OS-DCF:diskConfig'] = auto_disk_config"
nl|'\n'
nl|'\n'
comment|"# auto_disk_config = server_node.getAttribute('OS-DCF:diskConfig')"
nl|'\n'
comment|'#if auto_disk_config:'
nl|'\n'
comment|"#    server['OS-DCF:diskConfig'] = auto_disk_config"
...
comment|'# extension is ported'
nl|'\n'
comment|"#config_drive = server_node.getAttribute('config_drive')"
nl|'\n'
comment|'#if config_drive:'
nl|'\n'
comment|"#    server['config_drive'] = config_drive"
nl|'\n'
nl|'\n'
dedent|''
name|'return'
...
comment|'# extension is ported'
nl|'\n'
comment|'# if node.hasAttribute("auto_disk_config"):'
nl|'\n'
comment|"#     rebuild['OS-DCF:diskConfig'] = node.getAttribute("
nl|'\n'
comment|'#         "auto_disk_config")'
nl|'\n'
nl|'\n'
comment|'# if node.hasAttribute("OS-DCF:diskConfig"):'
nl|'\n'
comment|"#     rebuild['OS-DCF:diskConfig'] = node.getAttribute("
nl|'\n'
comment|'#         "OS-DCF:diskConfig")'
nl|'\n'
nl|'\n'
dedent|''
name|'metadata_node'
...
comment|'# if node.hasAttribute("auto_disk_config"):'
nl|'\n'
comment|"#     resize['OS-DCF:diskConfig'] = node.getAttribute("
nl|'\n'
comment|'#                                       "auto_disk_config")'
nl|'\n'
nl|'\n'
...
op|':'
newline|'\n'
comment|'# Filter out for the existence of server_create here'
nl|'\n'
comment|"# rather than on every request. We don't have a new"
nl|'\n'
comment|'# abstract base class to reduce duplication in the'
nl|'\n'
comment|'# extensions as they may want to implement multiple'
nl|'\n'
comment|'# server (and other) entry points'
nl|'\n'
indent|'                '
name|'if'
name|'hasattr'
...
name|'_'
op|'('
string|"'server create extension %s detected'"
op|')'
op|','
nl|'\n'
name|'ext'
...
name|'_'
op|'('
string|"'extension %s is missing server_create'"
op|')'
op|','
name|'ext'
op|'.'
...
op|':'
newline|'\n'
comment|'# port parameter is only for quantum v2.0'
nl|'\n'
indent|'                        '
name|'msg'
op|'='
...
comment|'# TODO(cyeoh): bp v3-api-core-as-extensions'
nl|'\n'
comment|'# Replace with an extension point when the config_drive'
nl|'\n'
comment|'# extension is ported'
nl|'\n'
comment|"# if self.ext_mgr.is_loaded('os-config-drive'):"
nl|'\n'
comment|"#    config_drive = server_dict.get('config_drive')"
nl|'\n'
nl|'\n'
name|'injected_files'
op|'='
...
nl|'\n'
comment|'# to take into account _is_quantum_v2'
nl|'\n'
comment|"#if (self.ext_mgr.is_loaded('os-networks')"
nl|'\n'
comment|'#        or self._is_quantum_v2()):'
nl|'\n'
...
comment|'# TODO(cyeoh): bp v3-api-core-as-extensions'
nl|'\n'
comment|'# Replace with an extension point when the os-user-data'
nl|'\n'
comment|'# extension is ported'
nl|'\n'
comment|"#if self.ext_mgr.is_loaded('os-user-data'):"
nl|'\n'
comment|"#    user_data = server_dict.get('user_data')"
nl|'\n'
comment|'#self._validate_user_data(user_data)'
nl|'\n'
nl|'\n'
...
comment|'# TODO(cyeoh): bp v3-api-core-as-extensions'
nl|'\n'
comment|'# Replace with an extension point when the'
nl|'\n'
comment|'# os-availability-zone extension is ported'
nl|'\n'
comment|"#if self.ext_mgr.is_loaded('os-availability-zone'):"
nl|'\n'
comment|"#    availability_zone = server_dict.get('availability_zone')"
nl|'\n'
nl|'\n'
name|'block_device_mapping'
op|'='
...
comment|'# TODO(cyeoh): bp v3-api-core-as-extensions'
nl|'\n'
comment|'# Replace with an extension point when the OS-DCF extension is'
nl|'\n'
comment|'# ported'
nl|'\n'
comment|"#if self.ext_mgr.is_loaded('OS-DCF'):"
nl|'\n'
comment|"#    auto_disk_config = server_dict.get('auto_disk_config')"
nl|'\n'
nl|'\n'
name|'scheduler_hints'
op|'='
...
comment|'# TODO(cyeoh): bp v3-api-core-as-extensions'
nl|'\n'
comment|'# Replace with an extension point when the scheduler hints'
nl|'\n'
comment|'# extension is ported'
nl|'\n'
comment|"#if self.ext_mgr.is_loaded('OS-SCH-HNT'):"
nl|'\n'
comment|"#    scheduler_hints = server_dict.get('scheduler_hints', {})"
nl|'\n'
nl|'\n'
name|'try'
op|':'
