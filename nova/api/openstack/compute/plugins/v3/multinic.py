...
name|'_'
op|'('
string|'"Missing \'network_id\' argument for add_fixed_ip"'
op|')'
newline|'\n'
name|'raise'
name|'exc'
...
name|'_'
op|'('
string|'"Missing \'address\' argument for remove_fixed_ip"'
op|')'
newline|'\n'
name|'raise'
name|'exc'
...
name|'namespace'
op|'='
string|'"http://docs.openstack.org/compute/ext/multinic/api/v3"'
newline|'\n'
