...
newline|'\n'
indent|'    '
string|'"""Stores information about a limit for HTTP requests."""'
newline|'\n'
nl|'\n'
DECL|variable|UNITS
name|'UNITS'
...
newline|'\n'
indent|'        '
string|'"""Represents a call to this limit from a relevant request.\n\n        @param verb: string http verb (POST, GET, etc.)\n        @param url: string URL\n        """'
newline|'\n'
name|'if'
name|'self'
op|'.'
...
newline|'\n'
indent|'    '
string|'"""Rate-limits requests passing through this middleware. All limit\n    information is stored in memory for this implementation.\n    """'
newline|'\n'
nl|'\n'
DECL|member|__init__
name|'def'
...
newline|'\n'
indent|'    '
string|'"""Rate-limit checking class which handles limits in memory."""'
newline|'\n'
nl|'\n'
DECL|member|__init__
name|'def'
...
newline|'\n'
indent|'        '
string|'"""Initialize the new `Limiter`.\n\n        @param limits: List of `Limit` objects\n        """'
newline|'\n'
name|'self'
op|'.'
name|'limits'
...
newline|'\n'
indent|'        '
string|'"""Return the limits for a given user."""'
newline|'\n'
name|'return'
op|'['
name|'limit'
...
newline|'\n'
indent|'        '
string|'"""Check the given verb/user/user triplet for limit.\n\n        @return: Tuple of delay (in seconds) and error message (or None, None)\n        """'
newline|'\n'
name|'delays'
op|'='
op|'['
...
newline|'\n'
indent|'        '
string|'"""Initialize the new `WsgiLimiter`.\n\n        @param limits: List of `Limit` objects\n        """'
newline|'\n'
name|'self'
op|'.'
name|'_limiter'
...
newline|'\n'
indent|'    '
string|'"""Rate-limit requests based on answers from a remote source."""'
newline|'\n'
nl|'\n'
DECL|member|__init__
name|'def'
...
newline|'\n'
indent|'        '
string|'"""Initialize the new `WsgiLimiterProxy`.\n\n        @param limiter_address: IP/port combination of where to request limit\n        """'
newline|'\n'
name|'self'
op|'.'
name|'limiter_address'
...
newline|'\n'
indent|'        '
string|'"""Ignore a limits string--simply doesn\'t apply for the limit\n        proxy.\n\n        @return: Empty list.\n        """'
newline|'\n'
nl|'\n'
name|'return'
op|'['
