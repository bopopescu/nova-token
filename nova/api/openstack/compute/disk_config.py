...
newline|'\n'
nl|'\n'
comment|'# Extend server for the 4 extended points'
nl|'\n'
...
newline|'\n'
nl|'\n'
comment|'# Extend schema for the 4 extended points'
nl|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|get_server_resize_schema
dedent|''
name|'def'
