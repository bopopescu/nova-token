...
newline|'\n'
indent|'        '
string|'"""Creates an aggregate, given its name and availablity_zone."""'
newline|'\n'
name|'context'
op|'='
name|'_get_context'
...
name|'_'
op|'('
string|'"Cannot create aggregate with name %(name)s and "'
nl|'\n'
string|'"availability zone %(avail_zone)s"'
op|')'
op|'%'
name|'locals'
op|'('
...
name|'_'
op|'('
string|'"Cannot show aggregate: %(id)s"'
op|')'
op|'%'
name|'locals'
op|'('
...
newline|'\n'
indent|'        '
string|'"""Updates the name and/or availbility_zone of given aggregate."""'
newline|'\n'
name|'context'
op|'='
name|'_get_context'
...
name|'_'
op|'('
string|'"Cannot update aggregate: %(id)s"'
op|')'
op|'%'
name|'locals'
op|'('
...
name|'_'
op|'('
string|'"Cannot delete aggregate: %(id)s"'
op|')'
op|'%'
name|'locals'
op|'('
