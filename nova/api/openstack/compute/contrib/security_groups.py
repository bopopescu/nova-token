...
newline|'\n'
nl|'\n'
comment|'# TODO(arosen): if we first look up the security group information for'
nl|'\n'
comment|'# the group_id before creating the rule we can avoid the case that'
nl|'\n'
comment|'# the remote group (group_id) has been deleted when we go to look'
nl|'\n'
comment|"# up it's name."
nl|'\n'
dedent|''
name|'with'
name|'translate_exceptions'
