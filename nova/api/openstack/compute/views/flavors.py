...
newline|'\n'
nl|'\n'
comment|'# NOTE(sirp): disabled attribute is namespaced for now for'
nl|'\n'
comment|'# compatability with the OpenStack API. This should ultimately be made'
nl|'\n'
comment|'# a first class attribute.'
nl|'\n'
name|'flavor_dict'
op|'['
string|'"flavor"'
op|']'
op|'['
string|'"OS-FLV-DISABLED:disabled"'
op|']'
op|'='
name|'flavor'
op|'.'
