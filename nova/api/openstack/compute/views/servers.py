...
newline|'\n'
nl|'\n'
comment|'# These are the lazy-loadable instance attributes required for showing'
nl|'\n'
comment|'# details about an instance. Add to this list as new things need to be'
nl|'\n'
comment|'# shown.'
nl|'\n'
DECL|variable|_show_expected_attrs
name|'_show_expected_attrs'
op|'='
op|'['
string|"'flavor'"
op|','
...
newline|'\n'
nl|'\n'
DECL|member|get_show_expected_attrs
dedent|''
name|'def'
...
op|']'
newline|'\n'
comment|'# NOTE(mriedem): We sort the list so we can have predictable test'
nl|'\n'
comment|'# results.'
nl|'\n'
dedent|''
...
newline|'\n'
indent|'    '
string|'"""Model a server v2.1 API response as a python dictionary."""'
newline|'\n'
nl|'\n'
DECL|member|__init__
name|'def'
...
op|')'
newline|'\n'
comment|'# TODO(alex_xu): In V3 API, we correct the image bookmark link to'
nl|'\n'
comment|'# use glance endpoint. We revert back it to use nova endpoint for v2.1.'
nl|'\n'
name|'self'
op|'.'
name|'_image_builder'
...
op|','
nl|'\n'
comment|"# TODO(alex_xu): '_get_image' return {} when there image_ref"
nl|'\n'
comment|'# isn\'t existed in V3 API, we revert it back to return "" in'
nl|'\n'
comment|'# V2.1.'
nl|'\n'
string|'"image"'
