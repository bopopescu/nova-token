...
newline|'\n'
comment|'# NOTE(cyeoh) The V3 version of _get_bookmark_link should'
nl|'\n'
comment|'# only ever be called with images as the'
nl|'\n'
comment|'# collection_name. The images API has been removed in the'
nl|'\n'
comment|'# V3 API and the V3 version of the view only exists for'
nl|'\n'
comment|'# the servers view to be able to generate the appropriate'
nl|'\n'
comment|'# bookmark link for the image of the instance.'
nl|'\n'
dedent|''
dedent|''
dedent|''
