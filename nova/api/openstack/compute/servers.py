...
op|':'
newline|'\n'
comment|'# NOTE(dprince): neutronclient is not a requirement'
nl|'\n'
indent|'        '
name|'if'
name|'self'
...
newline|'\n'
nl|'\n'
comment|"# NOTE (ndipanov) Don't allow empty device_name values"
nl|'\n'
comment|'#                 for now until we can handle it on the'
nl|'\n'
comment|'#                 compute side.'
nl|'\n'
name|'if'
name|'any'
op|'('
...
name|'_'
op|'('
string|"'Missing device_name in some block devices.'"
op|')'
newline|'\n'
name|'raise'
name|'exc'
