...
newline|'\n'
nl|'\n'
DECL|member|_validate_int_value
dedent|''
name|'def'
name|'_validate_int_value'
op|'('
name|'self'
op|','
name|'str_value'
...
newline|'\n'
nl|'\n'
DECL|member|_validate_block_device
dedent|''
name|'def'
name|'_validate_block_device'
op|'('
name|'self'
op|','
name|'bd'
...
op|':'
newline|'\n'
comment|'# Ignore empty volume size'
nl|'\n'
indent|'                '
name|'if'
string|"'volume_size'"
...
newline|'\n'
nl|'\n'
comment|'# FIXME(danms): Until compute_api.update() is object-aware,'
nl|'\n'
comment|'# we need to apply the updates to the instance object so'
nl|'\n'
comment|'# that views will return the new data'
nl|'\n'
dedent|''
name|'instance'
op|'.'
