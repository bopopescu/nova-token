...
name|'self'
op|'.'
name|'_versions_multi_choice'
op|'('
name|'request'
op|')'
newline|'\n'
nl|'\n'
DECL|member|_versions_list
dedent|''
dedent|''
name|'def'
name|'_versions_list'
...
newline|'\n'
nl|'\n'
DECL|member|_versions_multi_choice
dedent|''
name|'def'
name|'_versions_multi_choice'
op|'('
...
newline|'\n'
nl|'\n'
DECL|member|_create_media_types
dedent|''
name|'def'
name|'_create_media_types'
op|'('
name|'self'
op|','
name|'media_types'
...
name|'xmlns'
op|'='
string|'"http://docs.openstack.org/common/api/%s"'
op|'%'
name|'version'
op|'['
string|"'id'"
...
newline|'\n'
nl|'\n'
DECL|member|_create_list_meta
dedent|''
name|'def'
name|'_create_list_meta'
op|'('
name|'self'
op|','
name|'root'
