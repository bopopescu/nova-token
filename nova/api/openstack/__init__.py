...
name|'DEFINE_list'
op|'('
string|"'nova_api_permitted_operations'"
op|','
nl|'\n'
op|'['
op|']'
op|','
nl|'\n'
string|"'A comma-separated list of permitted api operations. Empty for all.'"
op|')'
newline|'\n'
nl|'\n'
DECL|class|API
...
name|'debug'
op|'('
string|'"Permitted operation set: %s"'
op|'%'
op|'('
name|'permitted'
op|','
...
name|'warning'
op|'('
string|'"Unknown option in nova_api_permitted_operations: \'%s\' (skipping)"'
op|'%'
op|'('
name|'command'
op|','
