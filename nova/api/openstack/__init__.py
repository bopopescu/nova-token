...
name|'help'
op|'='
string|"'DEPRECATED: Whether the V2.1 API is enabled or not. '"
nl|'\n'
...
name|'_LI'
op|'('
string|'"V2.1 API has been disabled by configuration"'
op|')'
op|')'
newline|'\n'
name|'LOG'
...
name|'_LW'
op|'('
string|'"In the M release you must run the v2.1 API."'
op|')'
op|')'
newline|'\n'
name|'return'
