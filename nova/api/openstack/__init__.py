...
newline|'\n'
indent|'        '
string|'"""Routes common to all versions."""'
newline|'\n'
nl|'\n'
name|'server_members'
op|'='
...
string|'"metadata"'
op|','
string|'"/{tenant_id}/images/{image_id}/metadata"'
op|','
nl|'\n'
name|'controller'
op|'='
...
string|'"metadata"'
op|','
string|'"/{tenant_id}/servers/{server_id}/metadata"'
op|','
nl|'\n'
name|'controller'
op|'='
