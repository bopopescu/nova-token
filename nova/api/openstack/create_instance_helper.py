...
newline|'\n'
indent|'        '
string|'"""Retrieve an image entity from the server node"""'
newline|'\n'
name|'image_node'
op|'='
name|'self'
...
newline|'\n'
indent|'        '
string|'"""Retrieve a flavor entity from the server node"""'
newline|'\n'
name|'flavor_node'
op|'='
name|'self'
...
newline|'\n'
nl|'\n'
DECL|member|_extract_links_from_node
dedent|''
name|'def'
name|'_extract_links_from_node'
op|'('
...
newline|'\n'
indent|'        '
string|'"""Retrieve link entities from a links container provided node"""'
newline|'\n'
name|'links'
op|'='
op|'['
