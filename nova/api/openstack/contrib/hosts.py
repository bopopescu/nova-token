...
op|':'
newline|'\n'
comment|"# The only valid values for 'state' are 'reboot' or"
nl|'\n'
comment|"# 'shutdown'. For completeness' sake there is the"
nl|'\n'
comment|"# 'startup' option to start up a host, but this is not"
nl|'\n'
comment|'# technically feasible now, as we run the host on the'
nl|'\n'
comment|'# XenServer box.'
nl|'\n'
indent|'                    '
name|'msg'
op|'='
...
op|']'
newline|'\n'
comment|"# If we are not in an admin env, don't add the resource. Regular users"
nl|'\n'
comment|"# shouldn't have access to the host."
nl|'\n'
name|'if'
name|'FLAGS'
op|'.'
