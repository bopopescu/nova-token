...
name|'_'
op|'('
string|'"Security group id is not integer"'
op|')'
newline|'\n'
name|'return'
name|'exc'
...
name|'self'
op|'.'
name|'_validate_security_group_name'
op|'('
name|'group_name'
op|')'
newline|'\n'
name|'self'
op|'.'
name|'_validate_security_group_description'
op|'('
name|'group_description'
op|')'
newline|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|_validate_security_group_name
dedent|''
name|'def'
name|'_validate_security_group_name'
op|'('
...
name|'_'
op|'('
string|'"Security group name is mandatory"'
op|')'
newline|'\n'
name|'raise'
name|'exc'
...
name|'_'
op|'('
string|'"Security group name is not a string or unicode"'
op|')'
newline|'\n'
name|'raise'
name|'exc'
...
name|'_'
op|'('
string|'"Security group name is an empty string"'
op|')'
newline|'\n'
name|'raise'
name|'exc'
...
name|'_'
op|'('
string|'"Security group name should not be greater "'
nl|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|_validate_security_group_description
dedent|''
dedent|''
name|'def'
name|'_validate_security_group_description'
...
name|'_'
op|'('
string|'"Security group description is mandatory"'
op|')'
newline|'\n'
name|'raise'
name|'exc'
...
name|'_'
op|'('
string|'"Security group description is not a string or unicode"'
op|')'
newline|'\n'
name|'raise'
name|'exc'
...
name|'_'
op|'('
string|'"Security group description is an empty string"'
op|')'
newline|'\n'
name|'raise'
name|'exc'
...
name|'_'
op|'('
string|'"Security group description should not be "'
nl|'\n'
string|'"greater than 255 characters"'
op|')'
newline|'\n'
name|'raise'
name|'exc'
