...
newline|'\n'
nl|'\n'
comment|'# TODO(ja): the keypair crud logic should be in nova.compute.API?'
nl|'\n'
nl|'\n'
...
string|'"""\n        Generate a key\n        """'
newline|'\n'
comment|'# TODO(ja): crypto.generate_key_pair is currently a slow method'
nl|'\n'
comment|'#           and should probably be moved to a process pool?'
nl|'\n'
name|'private_key'
op|','
name|'public_key'
...
newline|'\n'
nl|'\n'
comment|'# NOTE(ja): generation is slow, so shortcut invalid key_name exception'
nl|'\n'
name|'try'
op|':'
newline|'\n'
