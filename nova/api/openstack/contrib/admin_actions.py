...
name|'getLogger'
op|'('
string|'"nova.api.openstack.contrib.admin_actions"'
op|')'
newline|'\n'
nl|'\n'
nl|'\n'
...
newline|'\n'
indent|'    '
string|'"""Adds a set of admin-only actions to servers"""'
newline|'\n'
nl|'\n'
...
indent|'        '
name|'return'
string|'"Adds admin-only server actions: pause, unpause, "'
op|'+'
string|'"suspend, resume, migrate, resetNetwork, "'
op|'+'
string|'"injectNetworkInfo, lock and unlock"'
newline|'\n'
nl|'\n'
