...
name|'_'
op|'('
string|"'marker param must be positive'"
op|')'
op|')'
newline|'\n'
nl|'\n'
...
name|'_'
op|'('
string|"'marker param must be an integer'"
op|')'
op|')'
newline|'\n'
nl|'\n'
...
name|'_'
op|'('
string|'"Requested image_id has wrong format: %s,"'
nl|'\n'
string|'"should have numerical format"'
op|')'
op|'%'
name|'image_id'
newline|'\n'
...
nl|'\n'
nl|'\n'
DECL|class|OpenstackController
dedent|''
dedent|''
name|'class'
