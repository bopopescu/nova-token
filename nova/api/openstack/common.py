...
nl|'\n'
nl|'\n'
DECL|function|get_networks_for_instance_from_cache
dedent|''
name|'def'
name|'get_networks_for_instance_from_cache'
op|'('
name|'instance'
op|')'
op|':'
...
nl|'\n'
nl|'\n'
DECL|function|get_networks_for_instance_from_nwinfo
dedent|''
name|'def'
name|'get_networks_for_instance_from_nwinfo'
op|'('
name|'context'
op|','
name|'instance'
...
nl|'\n'
comment|'#                fail fall back to calling out the the'
nl|'\n'
comment|'#                network api'
nl|'\n'
indent|'        '
