...
op|')'
newline|'\n'
comment|"# Only add same IPv6 address once.  It's possible we've"
nl|'\n'
comment|'# seen it before if there was a previous fixed_ip with'
nl|'\n'
comment|'# same network and vif as this one'
nl|'\n'
name|'if'
name|'not'
name|'ipv6_addrs_seen'
