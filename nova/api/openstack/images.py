...
op|']'
newline|'\n'
comment|'#TODO(sirp): removing for glance'
nl|'\n'
comment|'#items = [_translate_status(item) for item in items]'
nl|'\n'
name|'return'
name|'dict'
op|'('
...
newline|'\n'
nl|'\n'
comment|'#TODO(sirp): need to map Glance attrs to OpenStackAPI attrs'
nl|'\n'
name|'return'
name|'dict'
op|'('
