...
newline|'\n'
indent|'    '
string|'""" Coerces a list of images into proper dictionary format\n        entities is a list of entities (dicts) """'
newline|'\n'
name|'return'
name|'dict'
op|'('
...
nl|'\n'
comment|'# fix once the local image service is working'
nl|'\n'
name|'mapped_keys'
op|'='
op|'{'
...
newline|'\n'
indent|'    '
string|'""" Filters all model attributes for keys\n        inst is a single entity (dict) """'
newline|'\n'
name|'return'
name|'dict'
op|'('
