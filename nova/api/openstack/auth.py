...
op|':'
newline|'\n'
comment|'# (dragondm) punt and try to determine account.'
nl|'\n'
comment|'# this is something of a hack, but a user on 1 account is a'
nl|'\n'
comment|'# common case, and is the way the current RS code works.'
nl|'\n'
indent|'            '
name|'accounts'
op|'='
...
op|':'
newline|'\n'
comment|"#we can't tell what account they are logging in for."
nl|'\n'
indent|'                '
name|'return'
name|'None'
...
string|"''"
newline|'\n'
comment|'# auth url + project (account) id, e.g.'
nl|'\n'
comment|'# http://foo.org:8774/baz/v1.0/myacct/'
nl|'\n'
name|'os_url'
op|'='
string|"'%s%s%s/'"
