...
name|'_'
op|'('
string|'"%(user)s could not be found with token \'%(token)s\'"'
op|')'
newline|'\n'
name|'LOG'
op|'.'
...
op|':'
newline|'\n'
comment|'#we are punting on this til auth is settled,'
nl|'\n'
comment|'#and possibly til api v1.1 (mdragon)'
nl|'\n'
indent|'            '
name|'account'
op|'='
...
name|'_'
op|'('
string|'"%(user)s must be an admin or a member of %(account)s"'
op|')'
newline|'\n'
name|'LOG'
op|'.'
...
name|'_'
op|'('
string|'"Authentication requests must be made against /<version>"'
op|')'
newline|'\n'
name|'LOG'
op|'.'
