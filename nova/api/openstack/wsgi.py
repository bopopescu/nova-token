...
nl|'\n'
nl|'\n'
DECL|class|LazySerializationMiddleware
dedent|''
dedent|''
dedent|''
name|'class'
...
newline|'\n'
indent|'    '
string|'"""Lazy serialization middleware."""'
newline|'\n'
op|'@'
name|'webob'
op|'.'
...
op|':'
newline|'\n'
comment|'# Request lazy serialization'
nl|'\n'
indent|'        '
name|'req'
op|'.'
...
newline|'\n'
nl|'\n'
comment|"# See if we're using the simple serialization driver"
nl|'\n'
name|'simple_serial'
op|'='
name|'req'
...
newline|'\n'
nl|'\n'
comment|"# See if there's a serializer..."
nl|'\n'
dedent|''
name|'serializer'
op|'='
...
newline|'\n'
nl|'\n'
comment|'# OK, build up the arguments for the serialize() method'
nl|'\n'
dedent|''
name|'kwargs'
op|'='
...
op|':'
newline|'\n'
comment|'# TODO(Vek): When lazy serialization is retired, so can'
nl|'\n'
comment|"#            this inner 'if'..."
nl|'\n'
indent|'            '
name|'lazy_serialize'
op|'='
...
name|'serializer'
newline|'\n'
comment|'# NOTE(Vek): Temporary ugly hack to support xml'
nl|'\n'
comment|'#            templates in extensions, until we can'
nl|'\n'
comment|'#            fold extensions into Resource and do away'
nl|'\n'
comment|'#            with lazy serialization...'
nl|'\n'
name|'if'
name|'_MEDIA_TYPE_MAP'
op|'.'
...
newline|'\n'
indent|'        '
string|'"""Look up the action-specific method."""'
newline|'\n'
nl|'\n'
name|'if'
name|'self'
