...
name|'_'
op|'('
string|'"Invalid XML in request body"'
op|')'
newline|'\n'
name|'return'
name|'Fault'
...
name|'_'
op|'('
string|'"Action: \'%(action)s\', body: %(body)s"'
op|')'
op|'%'
name|'locals'
op|'('
...
name|'_'
op|'('
string|'"API request failed, fault raised to the top of"'
nl|'\n'
string|'" the stack. Detailed stacktrace %s"'
op|')'
op|'%'
nl|'\n'
name|'explanation'
