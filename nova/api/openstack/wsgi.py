...
newline|'\n'
nl|'\n'
DECL|variable|_SUPPORTED_XML_CONTENT_TYPES
name|'_SUPPORTED_XML_CONTENT_TYPES'
op|'='
op|'('
nl|'\n'
...
newline|'\n'
nl|'\n'
DECL|variable|_MEDIA_XML_TYPE_MAP
name|'_MEDIA_XML_TYPE_MAP'
op|'='
op|'{'
nl|'\n'
string|"'application/vnd.openstack.compute+xml'"
...
nl|'\n'
nl|'\n'
comment|'# TODO(dims): Temporary, we already deprecated the v2 XML API in'
nl|'\n'
comment|'# Juno, we should remove this before Kilo'
nl|'\n'
DECL|variable|DISABLE_XML_V2_API
name|'DISABLE_XML_V2_API'
op|'='
name|'True'
newline|'\n'
nl|'\n'
