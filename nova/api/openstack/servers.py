...
newline|'\n'
indent|'        '
name|'mapping_filename'
op|'='
name|'FLAGS'
op|'.'
name|'os_krm_mapping_file'
newline|'\n'
nl|'\n'
name|'with'
name|'open'
...
name|'_'
op|'('
string|'"No entry for image \'%s\' in mapping file \'%s\'"'
op|')'
op|'%'
nl|'\n'
op|'('
...
op|']'
newline|'\n'
comment|'# The ID passed in is actually the internal_id of the'
nl|'\n'
comment|'# instance, not the value of the id column in the DB.'
nl|'\n'
name|'self'
op|'.'
name|'compute_api'
