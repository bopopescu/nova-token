...
nl|'\n'
nl|'\n'
DECL|function|novaclient_exception_converter
dedent|''
dedent|''
name|'def'
name|'novaclient_exception_converter'
op|'('
name|'f'
op|')'
op|':'
...
name|'debug'
op|'('
string|'"**** NOVACLIENT EXCEPTION CONVERTER >>>>"'
op|')'
newline|'\n'
name|'ret'
op|'='
...
name|'debug'
op|'('
string|'"**** NOVACLIENT EXCEPTION CONVERTER- RERAISING"'
op|')'
newline|'\n'
name|'raise'
name|'ConvertedException'
