...
name|'_'
op|'('
string|'"Error encountered attempting to rebuild instance "'
nl|'\n'
string|'"%(instance_id): %(ex)"'
op|')'
op|'%'
name|'locals'
op|'('
...
newline|'\n'
nl|'\n'
DECL|member|_check_metadata
dedent|''
name|'def'
name|'_check_metadata'
op|'('
name|'self'
op|','
name|'metadata'
...
newline|'\n'
indent|'        '
string|'"""Ensure that the metadata given is of the correct type."""'
newline|'\n'
name|'try'
op|':'
newline|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|_check_personalities
dedent|''
dedent|''
name|'def'
name|'_check_personalities'
op|'('
name|'self'
op|','
name|'personalities'
...
newline|'\n'
indent|'        '
string|'"""Ensure the given personalities have valid paths and contents."""'
newline|'\n'
name|'for'
name|'personality'
name|'in'
