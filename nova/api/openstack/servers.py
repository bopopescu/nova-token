...
newline|'\n'
indent|'            '
name|'security_groups_node'
op|'='
name|'self'
op|'.'
name|'_create_security_groups_node'
op|'('
name|'xml_doc'
op|','
nl|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|_security_group_to_xml
dedent|''
name|'def'
name|'_security_group_to_xml'
op|'('
name|'self'
op|','
name|'doc'
...
newline|'\n'
nl|'\n'
DECL|member|_create_security_groups_node
dedent|''
name|'def'
name|'_create_security_groups_node'
op|'('
