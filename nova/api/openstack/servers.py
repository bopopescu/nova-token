...
nl|'\n'
nl|'\n'
DECL|function|check_option_permissions
name|'def'
name|'check_option_permissions'
op|'('
name|'context'
op|','
name|'specified_options'
op|','
nl|'\n'
name|'user_api_options'
op|','
name|'admin_api_options'
op|')'
op|':'
newline|'\n'
indent|'    '
string|'"""Check whether or not entries in \'specified_options\' are valid\n    based on the allowed \'user_api_options\' and \'admin_api_options\'.\n\n    All inputs are lists of option names\n\n    Returns: exception.InvalidInput for an invalid option or\n             exception.AdminRequired for needing admin privs\n    """'
newline|'\n'
nl|'\n'
comment|"# We pretend we don't know about admin_api_options if the admin"
nl|'\n'
comment|'# API is not enabled.'
nl|'\n'
name|'if'
name|'FLAGS'
op|'.'
...
newline|'\n'
nl|'\n'
comment|'# Check for unknown query string params.'
nl|'\n'
dedent|''
name|'spec_unknown_opts'
op|'='
op|'['
name|'opt'
name|'for'
...
name|'_'
op|'('
string|'"Received request for unknown options "'
nl|'\n'
string|'"\'%(unknown_opt_str)s\'"'
op|')'
op|'%'
name|'locals'
op|'('
...
newline|'\n'
nl|'\n'
comment|'# Check for admin context for the admin commands'
nl|'\n'
dedent|''
name|'if'
name|'not'
...
name|'_'
op|'('
string|'"Received request for admin options "'
nl|'\n'
string|'"\'%(admin_opt_str)s\' from non-admin context"'
op|')'
op|'%'
nl|'\n'
name|'locals'
...
newline|'\n'
indent|'        '
string|'"""Returns a list of servers.\n\n        builder - the response model builder\n        """'
newline|'\n'
nl|'\n'
name|'if'
name|'search_opts'
...
newline|'\n'
nl|'\n'
comment|"# Don't pass these along to compute API, if they exist."
nl|'\n'
dedent|''
dedent|''
name|'search_opts'
...
op|':'
newline|'\n'
comment|'# NOTE(comstud): I refactored code in here to support'
nl|'\n'
comment|'# new search options, and the original code ignored'
nl|'\n'
comment|"# invalid options.  So, I've left it this way for now."
nl|'\n'
comment|'# The v1.1 implementation will return an error in this'
nl|'\n'
comment|'# case..'
nl|'\n'
indent|'            '
...
op|')'
newline|'\n'
comment|'# convert flavor into an int'
nl|'\n'
name|'if'
string|"'flavor'"
name|'in'
...
newline|'\n'
nl|'\n'
comment|'# NOTE(comstud): Making recurse_zones always be True in v1.1'
nl|'\n'
dedent|''
name|'search_opts'
op|'['
