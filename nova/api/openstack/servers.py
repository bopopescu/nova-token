...
nl|'\n'
nl|'\n'
DECL|function|check_admin_search_options
name|'def'
name|'check_admin_search_options'
op|'('
name|'context'
op|','
name|'search_options'
...
op|':'
newline|'\n'
comment|'# Remove any admin_api_options from search_options'
nl|'\n'
indent|'        '
name|'for'
name|'option'
...
newline|'\n'
nl|'\n'
comment|'# allow_admin_api is True and admin context?  Any command is okay.'
nl|'\n'
dedent|''
name|'if'
name|'context'
...
name|'_'
op|'('
string|'"Received request for admin-only search options "'
nl|'\n'
