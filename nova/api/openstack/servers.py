...
name|'_'
op|'('
string|'"Failed to read private ip"'
op|')'
op|')'
newline|'\n'
nl|'\n'
...
name|'_'
op|'('
string|'"Failed to read public ip(s)"'
op|')'
op|')'
newline|'\n'
nl|'\n'
...
newline|'\n'
comment|'# FIXME(sirp): Currently Nova requires us to specify the `null_kernel`'
nl|'\n'
comment|"# identifier ('nokernel') to indicate a RAW (or VHD) image.  It would"
nl|'\n'
comment|'# be better if we could omit the kernel_id and ramdisk_id properties'
nl|'\n'
...
name|'_'
op|'('
string|'"%(param)s property not found for image %(_image_id)s"'
op|')'
op|'%'
nl|'\n'
name|'locals'
...
op|')'
newline|'\n'
comment|'#TODO(sandy): rebuild/resize not supported.'
nl|'\n'
name|'try'
op|':'
newline|'\n'
