...
newline|'\n'
nl|'\n'
comment|'# These are a list of possible query string paramters to the'
nl|'\n'
comment|'# /servers query that a user should be able to do.  Specify this'
nl|'\n'
comment|'# in your subclasses.  When admin api is off, unknown options will'
nl|'\n'
comment|'# get filtered out without error.'
nl|'\n'
DECL|variable|servers_search_options
name|'servers_search_options'
op|'='
op|'['
op|']'
newline|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|_remove_invalid_options
dedent|''
name|'def'
name|'_remove_invalid_options'
op|'('
name|'self'
op|','
name|'context'
...
name|'_'
op|'('
string|'"Stripping out options \'%(unk_opt_str)s\' from servers "'
nl|'\n'
string|'"query"'
op|')'
op|'%'
...
newline|'\n'
nl|'\n'
DECL|member|_servers_search
dedent|''
name|'def'
name|'_servers_search'
op|'('
name|'self'
op|','
name|'context'
...
newline|'\n'
nl|'\n'
DECL|member|_servers_from_request
dedent|''
name|'def'
name|'_servers_from_request'
op|'('
...
comment|'# These are a list of possible query string paramters to the'
nl|'\n'
comment|'# /servers query that a user should be able to do. When admin api'
nl|'\n'
comment|'# is off, unknown options will get filtered out without error.'
nl|'\n'
DECL|variable|servers_search_options
name|'servers_search_options'
op|'='
