...
nl|'\n'
nl|'\n'
DECL|class|LimitsXMLSerializer
dedent|''
dedent|''
name|'class'
...
newline|'\n'
nl|'\n'
DECL|member|_create_rates_node
dedent|''
name|'def'
name|'_create_rates_node'
op|'('
name|'self'
op|','
name|'rates'
...
newline|'\n'
nl|'\n'
DECL|member|_create_absolute_node
dedent|''
name|'def'
name|'_create_absolute_node'
op|'('
name|'self'
op|','
name|'absolute_dict'
...
newline|'\n'
indent|'        '
string|'"""Populate a limits xml element from a dict."""'
newline|'\n'
nl|'\n'
name|'rates_elem'
op|'='
