...
op|')'
newline|'\n'
comment|'# parse_qs returns a dict where the values are lists,'
nl|'\n'
comment|'# since query strings can have multiple values for the'
nl|'\n'
comment|'# same key. We need to convert that to single values.'
nl|'\n'
name|'for'
name|'key'
name|'in'
