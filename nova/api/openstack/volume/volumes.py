...
name|'_'
op|'('
string|'"Invalid request body. \'volume\' not found"'
op|')'
newline|'\n'
name|'raise'
name|'exc'
...
name|'_'
op|'('
string|'"Invalid request body. \'size\' not found"'
op|')'
newline|'\n'
name|'raise'
name|'exc'
...
name|'_'
op|'('
string|'"Snapshot and image cannot be specified together."'
op|')'
newline|'\n'
name|'raise'
name|'exc'
