...
nl|'\n'
nl|'\n'
DECL|class|XMLTemplateSerializer
dedent|''
dedent|''
name|'class'
...
newline|'\n'
indent|'        '
string|'"""Retrieve the template to use for serialization."""'
newline|'\n'
nl|'\n'
name|'return'
name|'self'
...
newline|'\n'
nl|'\n'
comment|'# No template provided, look one up'
nl|'\n'
name|'if'
name|'template'
name|'is'
...
newline|'\n'
nl|'\n'
comment|"# Still couldn't find a template; try the base"
nl|'\n'
comment|'# XMLDictSerializer'
nl|'\n'
dedent|''
name|'if'
name|'template'
...
newline|'\n'
nl|'\n'
comment|'# Serialize the template'
nl|'\n'
dedent|''
name|'return'
name|'template'
...
newline|'\n'
indent|'        '
string|'"""Retrieve the default template to use."""'
newline|'\n'
nl|'\n'
name|'return'
name|'None'
