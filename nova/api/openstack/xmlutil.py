...
nl|'\n'
nl|'\n'
DECL|function|get_items_without_dict
dedent|''
name|'def'
name|'get_items_without_dict'
op|'('
name|'obj'
op|')'
op|':'
newline|'\n'
indent|'    '
string|'"""Get items in obj but omit any items containing a dict."""'
newline|'\n'
nl|'\n'
name|'obj_list'
op|'='
...
newline|'\n'
indent|'    '
string|'"""Attach an Atom <links> element to the parent."""'
newline|'\n'
nl|'\n'
name|'elem'
op|'='
