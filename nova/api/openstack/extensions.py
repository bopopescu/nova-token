...
newline|'\n'
indent|'    '
string|'"""This is the base class that defines the contract for extensions"""'
newline|'\n'
nl|'\n'
...
op|'['
op|']'
comment|'# TODO: implement extension links'
newline|'\n'
name|'return'
name|'ext_data'
newline|'\n'
...
op|':'
newline|'\n'
comment|"# NOTE: the extensions alias is used as the 'id' for show"
nl|'\n'
indent|'        '
name|'ext'
op|'='
...
op|':'
newline|'\n'
comment|"# NOTE: Extension aren't required to have resource extensions"
nl|'\n'
indent|'                '
name|'pass'
newline|'\n'
...
op|':'
newline|'\n'
comment|"# NOTE: Extension aren't required to have action extensions"
nl|'\n'
indent|'                '
name|'pass'
newline|'\n'
...
op|':'
newline|'\n'
comment|"# NOTE: Extension aren't required to have response extensions"
nl|'\n'
indent|'                '
name|'pass'
newline|'\n'
...
name|'self'
op|'.'
name|'_load_extensions_under_path'
op|'('
name|'self'
op|'.'
name|'path'
...
newline|'\n'
nl|'\n'
DECL|member|_load_extensions_under_path
dedent|''
name|'def'
name|'_load_extensions_under_path'
op|'('
...
name|'_'
op|'('
string|"'Extensions directory not found: %s'"
op|')'
op|'%'
name|'path'
op|')'
...
name|'_'
op|'('
string|"'Looking for extensions in: %s'"
op|')'
op|'%'
name|'path'
op|')'
...
name|'_'
op|'('
string|"'Checking extension file: %s'"
op|')'
op|','
name|'ext_path'
op|')'
...
newline|'\n'
nl|'\n'
comment|"#NOTE(justinsb): It seems that python modules aren't great"
nl|'\n'
comment|'#  If you have two identically named modules, the classes'
nl|'\n'
comment|'#  from both are mixed in.  So name your extension based'
nl|'\n'
comment|"#  on the alias, not 'extension.py'!"
nl|'\n'
comment|'#TODO(justinsb): Any way to work around this?'
nl|'\n'
nl|'\n'
dedent|''
name|'if'
...
name|'_'
op|'('
string|"'Not a ExtensionDescriptor: %s'"
op|')'
op|','
name|'cls'
op|')'
