...
nl|'\n'
nl|'\n'
DECL|class|ResponseExtensionResource
dedent|''
dedent|''
name|'class'
name|'ResponseExtensionResource'
op|'('
name|'wsgi'
op|'.'
name|'Resource'
...
newline|'\n'
indent|'        '
string|'"""Return a dict of ActionExtensionResource objects by collection."""'
newline|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|_response_ext_resources
dedent|''
name|'def'
name|'_response_ext_resources'
op|'('
name|'self'
op|','
name|'application'
...
newline|'\n'
indent|'        '
string|'"""Returns a dict of ResponseExtensionResource objects by collection."""'
newline|'\n'
name|'response_ext_resources'
op|'='
op|'{'
op|'}'
newline|'\n'
...
newline|'\n'
indent|'    '
string|'"""Add data to responses from core nova OpenStack API resources."""'
newline|'\n'
nl|'\n'
DECL|member|__init__
name|'def'
