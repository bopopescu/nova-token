...
newline|'\n'
indent|'        '
string|'"""Create an extension xml element from a dict."""'
newline|'\n'
name|'ext_elem'
op|'='
name|'ElementTree'
...
newline|'\n'
indent|'        '
string|'"""Convert the xml tree object to an xml string."""'
newline|'\n'
name|'root'
op|'.'
name|'set'
