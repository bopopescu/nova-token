...
newline|'\n'
nl|'\n'
DECL|member|_request_ext_controllers
dedent|''
name|'def'
name|'_request_ext_controllers'
op|'('
name|'self'
op|','
name|'application'
...
newline|'\n'
indent|'        '
string|'"""Returns a dict of RequestExtensionController-s by collection."""'
newline|'\n'
name|'request_ext_controllers'
op|'='
op|'{'
op|'}'
newline|'\n'
