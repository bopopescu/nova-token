...
name|'getLogger'
op|'('
string|"'nova.api.openstack.extensions'"
op|')'
newline|'\n'
nl|'\n'
nl|'\n'
...
newline|'\n'
nl|'\n'
comment|'# This attribute causes the extension to load only when'
nl|'\n'
comment|'# the admin api is enabled'
nl|'\n'
...
newline|'\n'
indent|'        '
string|'"""List of extensions.RequestExtension extension objects.\n\n        Request extensions are used to handle custom request data.\n\n        """'
newline|'\n'
name|'request_exts'
op|'='
op|'['
...
newline|'\n'
nl|'\n'
DECL|member|add_pre_handler
dedent|''
name|'def'
name|'add_pre_handler'
op|'('
name|'self'
op|','
name|'pre_handler'
...
newline|'\n'
nl|'\n'
comment|"# Don't call extensions if the main application returned an"
nl|'\n'
comment|'# unsuccessful status'
nl|'\n'
name|'successful'
op|'='
number|'200'
...
newline|'\n'
nl|'\n'
comment|'# Deserialize the response body, if any'
nl|'\n'
dedent|''
name|'body'
op|'='
...
newline|'\n'
nl|'\n'
comment|'# Reserialize the response body'
nl|'\n'
dedent|''
name|'if'
name|'body'
...
newline|'\n'
nl|'\n'
comment|"# Don't load admin api extensions if the admin api isn't enabled"
nl|'\n'
dedent|''
name|'if'
name|'not'
...
name|'deprecated'
op|'('
string|'"Superseded by ControllerExtension"'
op|')'
newline|'\n'
