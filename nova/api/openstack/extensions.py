...
newline|'\n'
nl|'\n'
DECL|member|_actions_by_collection
dedent|''
name|'def'
name|'_actions_by_collection'
op|'('
name|'self'
op|','
name|'application'
...
newline|'\n'
nl|'\n'
DECL|member|_responses_by_collection
dedent|''
name|'def'
name|'_responses_by_collection'
op|'('
name|'self'
op|','
name|'application'
...
name|'_'
op|'('
string|"'Extended collection/action: %s/%s'"
op|')'
op|','
nl|'\n'
name|'action'
