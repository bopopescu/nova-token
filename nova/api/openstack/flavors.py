...
newline|'\n'
comment|'# FIXME(kpepple) do we really need admin context here ?'
nl|'\n'
name|'ctxt'
op|'='
name|'context'
...
op|')'
newline|'\n'
comment|'# FIXME(kpepple) refactor db call to return dict'
nl|'\n'
comment|'# v = val.values()[0]'
nl|'\n'
comment|"# item = dict(ram=v['memory_mb'], disk=v['local_gb'],"
nl|'\n'
comment|"#             id=v['flavorid'], name=val.keys()[0])"
nl|'\n'
name|'return'
name|'dict'
op|'('
...
newline|'\n'
comment|'#TODO(jk0): Finish this later'
nl|'\n'
comment|'#instance_types.create('
nl|'\n'
comment|'#    name,'
nl|'\n'
comment|'#    memory,'
...
newline|'\n'
indent|'        '
string|'"""Delete a flavor."""'
newline|'\n'
comment|'#TODO(jk0): Finish this later'
nl|'\n'
comment|'#instance_type.destroy(name)'
nl|'\n'
name|'return'
string|'"DELETE! %s %s"'
op|'%'
