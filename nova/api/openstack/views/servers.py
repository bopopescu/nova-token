...
newline|'\n'
nl|'\n'
DECL|member|_build_image_data
dedent|''
name|'def'
name|'_build_image_data'
op|'('
name|'self'
op|','
name|'response'
...
op|':'
newline|'\n'
DECL|member|_decorate_response
indent|'    '
name|'def'
name|'_decorate_response'
op|'('
