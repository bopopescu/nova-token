...
newline|'\n'
indent|'        '
string|"''' Returns a dict that represenst a server '''"
newline|'\n'
name|'if'
name|'is_detail'
op|':'
...
newline|'\n'
indent|'        '
string|"''' Returns a simple model of a server '''"
newline|'\n'
name|'return'
name|'dict'
op|'('
...
newline|'\n'
indent|'        '
string|"''' Returns the image sub-resource of a server '''"
newline|'\n'
name|'raise'
...
newline|'\n'
indent|'        '
string|"''' Returns the flavor sub-resource of a server '''"
newline|'\n'
name|'raise'
name|'NotImplementedError'
op|'('
...
newline|'\n'
indent|'    '
string|"''' Models an Openstack API V1.0 server response '''"
newline|'\n'
nl|'\n'
DECL|member|_build_image
name|'def'
