...
newline|'\n'
comment|'#instance = db.instance_get(_context, instance_id)'
nl|'\n'
nl|'\n'
...
string|'" -w 2  < /dev/null"'
newline|'\n'
comment|'# this Popen  will exit with 0 only if the port is in use, '
nl|'\n'
...
op|')'
op|'+'
string|'"tools/ajaxterm//ajaxterm.py --command \'ssh root@"'
op|'+'
name|'host'
op|'+'
string|'"\' -t "'
...
name|'token'
op|'}'
comment|'#TODO - s/tonbuntu/api_server_public_ip'
newline|'\n'
nl|'\n'
dedent|''
dedent|''
