...
name|'msg'
op|'='
string|"'Improper input. Please provide a valid cidr: '"
string|"'e.g. 121.12.10.11/24.'"
newline|'\n'
name|'failed'
op|'['
string|"'message'"
...
name|'failed'
newline|'\n'
comment|"#Normalizing cidr. e.g. '20.20.20.11/24' -> '20.20.20.0/24', so that"
nl|'\n'
comment|"#db values stay in sync with filters' values (e.g. in iptables)"
nl|'\n'
dedent|''
name|'cidr'
op|'='
...
newline|'\n'
nl|'\n'
DECL|member|remove_external_address_block
dedent|''
name|'def'
...
name|'_'
op|'('
string|"'Removing ip block from %s'"
op|')'
op|','
name|'cidr'
op|','
...
op|')'
newline|'\n'
comment|'# Catch the exception and LOG for improper or malicious inputs.'
nl|'\n'
comment|'# Also return a proper status and message in that case'
nl|'\n'
name|'failed'
op|'='
op|'{'
...
name|'msg'
op|'='
string|"'No such CIDR currently blocked.'"
newline|'\n'
name|'failed'
op|'['
string|"'message'"
