...
name|'_'
op|'('
string|'"Adding role %s to user %s for project %s"'
op|')'
op|','
name|'role'
op|','
...
name|'_'
op|'('
string|'"Adding sitewide role %s to user %s"'
op|')'
op|','
name|'role'
op|','
...
name|'_'
op|'('
string|'"Removing role %s from user %s for project %s"'
op|')'
op|','
nl|'\n'
name|'role'
...
name|'_'
op|'('
string|'"Removing sitewide role %s from user %s"'
op|')'
op|','
name|'role'
op|','
...
name|'_'
op|'('
string|'"Getting x509 for user: %s on project: %s"'
op|')'
op|','
name|'name'
op|','
...
name|'_'
op|'('
string|'"Create project %s managed by %s"'
op|')'
op|','
name|'name'
op|','
...
name|'_'
op|'('
string|'"Adding user %s to project %s"'
op|')'
op|','
name|'user'
op|','
...
name|'_'
op|'('
string|'"Removing user %s from project %s"'
op|')'
op|','
name|'user'
op|','
...
name|'_'
op|'('
string|'"Blocking access to all projects incoming from %s"'
op|')'
op|','
nl|'\n'
name|'cidr'
...
name|'_'
op|'('
string|'"Awaiting implementation."'
op|')'
op|')'
newline|'\n'
comment|'# TODO(todd): implement'
nl|'\n'
comment|"# return {'status': 'OK', 'message': 'Disabled (number) IPs'}"
nl|'\n'
dedent|''
dedent|''
endmarker|''
