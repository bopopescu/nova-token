...
nl|'\n'
comment|'# parse multi dot-separted argument.'
nl|'\n'
comment|'# EBS boot uses multi dot-separeted arguments like'
nl|'\n'
comment|'# BlockDeviceMapping.1.DeviceName=snap-id'
nl|'\n'
comment|'# Convert the above into'
nl|'\n'
comment|"# {'block_device_mapping': {'1': {'device_name': snap-id}}}"
nl|'\n'
name|'if'
name|'len'
op|'('
