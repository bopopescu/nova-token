...
op|':'
newline|'\n'
comment|'# Raise NotImplemented exception for Admin specific request if'
nl|'\n'
comment|'# admin flag is set to false in nova.conf'
nl|'\n'
indent|'            '
name|'if'
op|'('
...
name|'FLAGS'
op|'.'
name|'allow_ec2_admin_api'
op|')'
op|')'
op|':'
newline|'\n'
comment|'## Raise InvalidRequest exception for EC2 Admin interface ##'
nl|'\n'
indent|'                '
name|'LOG'
op|'.'
name|'exception'
op|'('
string|'"Unsupported API request"'
op|')'
newline|'\n'
name|'raise'
name|'exception'
