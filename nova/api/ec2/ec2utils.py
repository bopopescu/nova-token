...
nl|'\n'
nl|'\n'
DECL|function|get_ip_for_instance_from_nwinfo
dedent|''
name|'def'
name|'get_ip_for_instance_from_nwinfo'
op|'('
name|'context'
op|','
name|'instance'
...
op|':'
newline|'\n'
comment|'# NOTE(jkoelker) When the network_api starts returning the model, this'
nl|'\n'
comment|'#                can be refactored out into the above function'
nl|'\n'
indent|'    '
name|'network_api'
op|'='
