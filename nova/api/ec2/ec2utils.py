...
newline|'\n'
indent|'    '
string|'"""Convert an ec2 ID into an instance UUID"""'
newline|'\n'
name|'instance_id'
op|'='
name|'ec2_id_to_id'
...
newline|'\n'
indent|'    '
string|'"""Get the cooresponding UUID for the given ec2-id."""'
newline|'\n'
name|'ctxt'
op|'='
name|'context'
...
nl|'\n'
nl|'\n'
DECL|function|ec2_instance_id_to_uuid
dedent|''
name|'def'
