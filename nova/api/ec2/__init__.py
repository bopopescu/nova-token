...
string|"'ssl'"
op|','
string|"'nova.openstack.common.sslutils'"
op|')'
newline|'\n'
nl|'\n'
nl|'\n'
...
op|':'
newline|'\n'
comment|'# NOTE(alevine) We need to calculate the hash here because'
nl|'\n'
comment|'# subsequent access to request modifies the req.body so the hash'
nl|'\n'
comment|'# calculation will yield invalid results.'
nl|'\n'
indent|'        '
name|'body_hash'
op|'='
...
name|'_'
op|'('
string|'"Failure parsing response from keystone: %s"'
op|')'
op|'%'
name|'e'
newline|'\n'
...
op|':'
newline|'\n'
comment|'# Not all arguments are mandatory with v4 signatures, as some data is'
nl|'\n'
comment|'# passed in the header, not query arguments.'
nl|'\n'
indent|'        '
name|'required_args'
op|'='
...
nl|'\n'
comment|'# If not present assume v4'
nl|'\n'
name|'version'
op|'='
name|'req'
