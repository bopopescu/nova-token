...
name|'_'
op|'('
string|"'Access key %s has had %d failed authentications'"
nl|'\n'
string|"' and will be locked out for %d minutes.'"
op|')'
op|','
nl|'\n'
name|'access_key'
...
name|'_'
op|'('
string|"'Authenticated Request For %s:%s)'"
op|')'
op|','
name|'user'
op|'.'
...
name|'_'
op|'('
string|'"Unauthorized request for controller=%s "'
nl|'\n'
string|'"and action=%s"'
op|')'
op|','
...
nl|'\n'
nl|'\n'
DECL|function|request_logging_factory
dedent|''
dedent|''
name|'def'
name|'request_logging_factory'
op|'('
name|'global_args'
op|','
op|'**'
...
nl|'\n'
nl|'\n'
DECL|function|authenticate_factory
dedent|''
name|'def'
name|'authenticate_factory'
op|'('
name|'global_args'
op|','
op|'**'
...
nl|'\n'
nl|'\n'
DECL|function|authorizer_factory
dedent|''
name|'def'
name|'authorizer_factory'
op|'('
name|'global_args'
op|','
op|'**'
...
nl|'\n'
nl|'\n'
DECL|function|executor_factory
dedent|''
name|'def'
...
nl|'\n'
nl|'\n'
DECL|function|requestify_factory
dedent|''
name|'def'
name|'requestify_factory'
op|'('
name|'global_args'
op|','
op|'**'
...
nl|'\n'
nl|'\n'
DECL|function|lockout_factory
dedent|''
name|'def'
name|'lockout_factory'
op|'('
name|'global_args'
op|','
op|'**'
