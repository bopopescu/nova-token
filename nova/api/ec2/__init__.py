...
newline|'\n'
indent|'    '
string|'"""Helper to send an ec2_compatible error"""'
newline|'\n'
name|'LOG'
op|'.'
name|'error'
...
newline|'\n'
indent|'    '
string|'"""Deprecated, only here to make merging easier."""'
newline|'\n'
nl|'\n'
op|'@'
name|'webob'
...
name|'warning'
op|'('
string|'"Configuration setting for keystone_ec2_url needs "'
nl|'\n'
string|'"to be updated to /tokens only. The /ec2 prefix is "'
nl|'\n'
string|'"being deprecated"'
op|')'
newline|'\n'
...
newline|'\n'
nl|'\n'
comment|'# Disable "has no x member" pylint error'
nl|'\n'
comment|'# for httplib and urlparse'
nl|'\n'
...
newline|'\n'
nl|'\n'
comment|'# NOTE(vish): We could save a call to keystone by'
nl|'\n'
comment|'#             having keystone return token, tenant,'
nl|'\n'
comment|'#             user, and roles from this call.'
nl|'\n'
nl|'\n'
name|'result'
op|'='
...
name|'_'
op|'('
string|"'InvalidParameterValue raised: %s'"
op|')'
op|','
name|'unicode'
op|'('
...
name|'_'
op|'('
string|"'InvalidPortRange raised: %s'"
op|')'
op|','
name|'unicode'
op|'('
...
name|'_'
op|'('
string|"'InvalidRequest raised: %s'"
op|')'
op|','
name|'unicode'
op|'('
...
name|'_'
op|'('
string|"'ValidatorError raised: %s'"
op|')'
op|','
name|'unicode'
op|'('
