...
newline|'\n'
nl|'\n'
DECL|member|ec2_id_to_internal_id
dedent|''
name|'def'
...
newline|'\n'
comment|'# TODO(gundlach): Maybe this should actually work?'
nl|'\n'
name|'return'
name|'ec2_id'
op|'['
...
newline|'\n'
nl|'\n'
DECL|member|internal_id_to_ec2_id
dedent|''
name|'def'
...
newline|'\n'
comment|'# TODO(gundlach): Yo maybe this should actually convert to base 36'
nl|'\n'
name|'return'
string|'"i-%d"'
op|'%'
...
op|':'
newline|'\n'
comment|'# ec2_id_list is passed in as a list of instances'
nl|'\n'
indent|'        '
name|'ec2_id'
op|'='
