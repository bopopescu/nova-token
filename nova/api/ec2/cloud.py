...
nl|'\n'
comment|'# pending | running | shutting-down | terminated | stopping | stopped'
nl|'\n'
...
nl|'\n'
nl|'\n'
DECL|function|state_description_from_vm_state
name|'def'
name|'state_description_from_vm_state'
op|'('
name|'vm_state'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|_get_floaters_for_fixed_ip
dedent|''
dedent|''
name|'def'
name|'_get_floaters_for_fixed_ip'
op|'('
name|'self'
op|','
name|'context'
...
newline|'\n'
indent|'        '
string|'"""Return all floating IPs given a fixed IP"""'
newline|'\n'
name|'return'
name|'self'
op|'.'
...
newline|'\n'
nl|'\n'
DECL|member|_get_fixed_ips_for_instance
dedent|''
name|'def'
name|'_get_fixed_ips_for_instance'
op|'('
name|'self'
op|','
name|'context'
...
newline|'\n'
nl|'\n'
DECL|member|_get_floaters_for_instance
dedent|''
name|'def'
name|'_get_floaters_for_instance'
op|'('
name|'self'
op|','
name|'context'
...
newline|'\n'
indent|'        '
string|'"""Return all floating IPs for an instance"""'
newline|'\n'
nl|'\n'
name|'ret_floaters'
op|'='
...
op|']'
newline|'\n'
comment|'# only loop through ipv4 addresses'
nl|'\n'
name|'fixed_ips'
op|'='
name|'self'
...
op|')'
newline|'\n'
comment|'# Allows a short circuit if we just need any floater.'
nl|'\n'
name|'if'
name|'floaters'
name|'and'
...
op|']'
newline|'\n'
comment|'# Now look for a floater.'
nl|'\n'
name|'for'
name|'ip'
name|'in'
...
op|')'
newline|'\n'
comment|'# NOTE(comstud): Will it float?'
nl|'\n'
name|'if'
name|'floating_ips'
op|':'
...
op|','
nl|'\n'
comment|'# NOTE(comstud): Unfortunately, EC2 requires that the'
nl|'\n'
comment|'# instance DB entries have been created..'
nl|'\n'
