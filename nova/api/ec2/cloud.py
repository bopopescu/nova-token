...
newline|'\n'
nl|'\n'
DECL|member|_get_ip_info_for_instance
dedent|''
dedent|''
name|'def'
name|'_get_ip_info_for_instance'
op|'('
name|'self'
op|','
name|'context'
...
newline|'\n'
nl|'\n'
comment|'# NOTE(bcwaldon): We need access to the image uuid since we directly'
nl|'\n'
comment|'# call the compute api from this class'
nl|'\n'
DECL|member|_get_image_uuid
dedent|''
name|'def'
name|'_get_image_uuid'
op|'('
...
newline|'\n'
nl|'\n'
comment|'# NOTE(bcwaldon): We also need to be able to map image uuids to integers'
nl|'\n'
DECL|member|_get_image_id
dedent|''
name|'def'
name|'_get_image_id'
op|'('
