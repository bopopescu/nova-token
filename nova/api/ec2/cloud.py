...
op|')'
newline|'\n'
comment|"# NOTE(justinsb): the EC2 API doesn't support metadata here, but this"
nl|'\n'
comment|"#  is needed for the unit tests.  Maybe the unit tests shouldn't be"
nl|'\n'
comment|'#  calling the EC2 code'
nl|'\n'
name|'instances'
op|'='
name|'self'
