...
name|'_'
op|'('
string|'"Create volume of %s GB associated with VSA "'
string|'"(to: %d, from: %d)"'
op|')'
op|','
nl|'\n'
...
name|'_'
op|'('
string|'"Create VSA %(display_name)s vc_count:%(vc_count)d "'
string|'"vc_type:%(vc_type)s storage:%(_storage)s"'
op|')'
op|','
name|'locals'
op|'('
...
op|':'
newline|'\n'
comment|'#        LOG.debug(_("vsa_id=%s, status=%s, az=%s"),'
nl|'\n'
comment|'#                    (vsa_id, status, availability_zone))'
nl|'\n'
indent|'        '
name|'result'
op|'='
...
newline|'\n'
nl|'\n'
DECL|member|create_drive_type
dedent|''
name|'def'
name|'create_drive_type'
op|'('
name|'self'
op|','
name|'context'
...
name|'_'
op|'('
string|'"Create Drive Type %(name)s: %(type)s %(size_gb)d "'
string|'"%(rpm)s %(capabilities)s %(visible)s"'
op|')'
op|','
nl|'\n'
name|'locals'
...
newline|'\n'
nl|'\n'
DECL|member|update_drive_type
dedent|''
name|'def'
name|'update_drive_type'
op|'('
name|'self'
op|','
name|'context'
...
newline|'\n'
nl|'\n'
DECL|member|rename_drive_type
dedent|''
name|'def'
name|'rename_drive_type'
op|'('
name|'self'
op|','
name|'context'
...
newline|'\n'
nl|'\n'
DECL|member|delete_drive_type
dedent|''
name|'def'
name|'delete_drive_type'
op|'('
name|'self'
op|','
name|'context'
...
newline|'\n'
nl|'\n'
DECL|member|describe_drive_types
dedent|''
name|'def'
name|'describe_drive_types'
op|'('
name|'self'
op|','
name|'context'
...
newline|'\n'
nl|'\n'
comment|'# VP-TODO: Change it later to EC2 compatible func (output)'
nl|'\n'
nl|'\n'
dedent|''
name|'return'
...
nl|'\n'
comment|'# BlockDevicedMapping.<N>.DeviceName'
nl|'\n'
comment|'# BlockDevicedMapping.<N>.Ebs.SnapshotId'
nl|'\n'
comment|'# BlockDevicedMapping.<N>.Ebs.VolumeSize'
nl|'\n'
comment|'# BlockDevicedMapping.<N>.Ebs.DeleteOnTermination'
nl|'\n'
comment|'# BlockDevicedMapping.<N>.VirtualName'
nl|'\n'
comment|'# => remove .Ebs and allow volume id in SnapshotId'
nl|'\n'
indent|'            '
name|'ebs'
op|'='
