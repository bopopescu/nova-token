...
newline|'\n'
nl|'\n'
comment|'# aggregate based availability_zones'
nl|'\n'
dedent|''
dedent|''
name|'metadata'
...
op|')'
newline|'\n'
comment|'# aggregate based available_zones'
nl|'\n'
dedent|''
name|'metadata'
op|'='
...
op|')'
newline|'\n'
comment|'#  metdata:  {machine: set( az1, az2 )}'
nl|'\n'
name|'for'
name|'host'
op|','
...
op|':'
newline|'\n'
comment|'# NOTE(dprince): project_id and host_id are unset w/ Cinder'
nl|'\n'
indent|'            '
name|'v'
op|'['
...
nl|'\n'
nl|'\n'
DECL|class|CloudSecurityGroupAPI
dedent|''
dedent|''
name|'class'
name|'CloudSecurityGroupAPI'
