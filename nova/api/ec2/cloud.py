...
nl|'\n'
nl|'\n'
comment|'# EC2 ID can return the following error codes:'
nl|'\n'
comment|'# http://docs.aws.amazon.com/AWSEC2/latest/APIReference/api-error-codes.html'
nl|'\n'
comment|'# Validate methods are split to return valid EC2 error codes for different'
nl|'\n'
comment|'# resource types'
nl|'\n'
DECL|function|_validate_ec2_id
name|'def'
name|'_validate_ec2_id'
op|'('
name|'val'
op|')'
op|':'
...
nl|'\n'
nl|'\n'
DECL|function|validate_volume_id
dedent|''
name|'def'
name|'validate_volume_id'
op|'('
name|'volume_id'
op|')'
op|':'
...
nl|'\n'
nl|'\n'
DECL|function|validate_instance_id
dedent|''
dedent|''
name|'def'
...
name|'self'
op|'.'
name|'_get_volume_attach_status'
op|'('
nl|'\n'
name|'volume'
op|')'
...
newline|'\n'
nl|'\n'
DECL|member|_format_stop_instances
dedent|''
name|'def'
name|'_format_stop_instances'
op|'('
name|'self'
op|','
name|'context'
...
newline|'\n'
nl|'\n'
DECL|member|_format_start_instances
dedent|''
name|'def'
name|'_format_start_instances'
op|'('
name|'self'
op|','
name|'context'
...
name|'staticmethod'
newline|'\n'
DECL|member|_get_volume_attach_status
name|'def'
name|'_get_volume_attach_status'
op|'('
name|'volume'
...
name|'get'
op|'('
string|"'instance_initiated_shutdown_behavior'"
op|','
string|"'stop'"
op|')'
newline|'\n'
...
nl|'\n'
comment|'# TODO(mriedem): Consider auto-locking the instance when stopping it and'
nl|'\n'
comment|'# doing the snapshot, then unlock it when that is done. Locking the'
nl|'\n'
comment|'# instance in the database would prevent other APIs from changing the state'
nl|'\n'
comment|'# of the instance during this operation for non-admin users.'
nl|'\n'
...
name|'True'
newline|'\n'
comment|"# NOTE(mriedem): We do a call here so that we're sure the"
nl|'\n'
comment|'# stop request is complete before we begin polling the state.'
nl|'\n'
name|'self'
op|'.'
name|'compute_api'
...
newline|'\n'
nl|'\n'
comment|'# wait instance for really stopped (and not transitioning tasks)'
nl|'\n'
dedent|''
name|'start_time'
op|'='
...
name|'_'
op|'('
string|'"Couldn\'t stop instance %(instance)s within "'
nl|'\n'
string|'"1 hour. Current vm_state: %(vm_state)s, "'
nl|'\n'
