...
name|'cmd'
op|'='
string|'"%s/tools/ajaxterm/ajaxterm.py --command \'virsh console instance-%d\' -t %s -p %s"'
op|'%'
op|'('
name|'utils'
op|'.'
...
op|'='
string|"'tonbuntu'"
comment|'#TODO put correct value for dmz'
newline|'\n'
name|'return'
op|'{'
string|"'url'"
op|':'
string|"'http://%s:%s/?token=%s&host=%s&port=%s'"
op|'%'
op|'('
name|'dmz'
op|','
