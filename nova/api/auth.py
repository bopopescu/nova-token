...
name|'_LW'
op|'('
string|'"The legacy V2 API code tree has been removed in Newton. "'
nl|'\n'
string|'"Please remove legacy v2 API entry from api-paste.ini, and use "'
nl|'\n'
string|'"V2.1 API or V2.1 API compat mode instead"'
op|')'
nl|'\n'
op|')'
newline|'\n'
