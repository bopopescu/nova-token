...
newline|'\n'
nl|'\n'
DECL|function|_image_id_translator
dedent|''
name|'def'
name|'_image_id_translator'
op|'('
op|')'
op|':'
newline|'\n'
...
newline|'\n'
nl|'\n'
comment|"#TODO(dietz) These are the attributes I'm unsure of"
nl|'\n'
name|'inst'
op|'['
...
nl|'\n'
nl|'\n'
comment|'#TODO(dietz): This seems necessary. How do these apply across'
nl|'\n'
comment|'#the Rackspace implementation?'
nl|'\n'
name|'inst'
op|'['
string|"'project_id'"
