...
name|'logprefix'
op|'='
string|'"vendordata_jsonfile_path[%s]:"'
op|'%'
name|'fpath'
newline|'\n'
name|'if'
...
name|'_LW'
op|'('
string|'"%(logprefix)s file does not exist"'
op|')'
op|','
nl|'\n'
op|'{'
...
name|'_LW'
op|'('
string|'"%(logprefix)s unexpected IOError when "'
nl|'\n'
string|'"reading"'
op|')'
op|','
...
name|'_LW'
op|'('
string|'"%(logprefix)s failed to load json"'
op|')'
op|','
nl|'\n'
op|'{'
