...
nl|'\n'
comment|'# I610deb44f33a966de50296272ab0bfa35462eec9'
nl|'\n'
name|'if'
op|'('
string|"'nova/tests/unit/scheduler/test_host_manager.py'"
name|'in'
name|'filename'
name|'or'
nl|'\n'
string|"'nova/tests/unit/volume/encryptors/test_base.py'"
name|'in'
name|'filename'
name|'or'
nl|'\n'
string|"'nova/tests/unit/virt/xenapi/test_vm_utils.py'"
name|'in'
name|'filename'
op|')'
op|':'
