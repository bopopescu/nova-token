...
op|'='
op|'('
string|"'N325 str() cannot be used on an exception.  '"
nl|'\n'
string|"'Remove or use six.text_type()'"
op|')'
newline|'\n'
nl|'\n'
DECL|member|__init__
