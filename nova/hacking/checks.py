...
name|'compile'
op|'('
string|'r"from[\\s]*oslo[.]"'
nl|'\n'
string|'r"(concurrency|config|context|db|i18n|"'
nl|'\n'
string|'r"log|messaging|middleware|rootwrap|"'
nl|'\n'
string|'r"serialization|utils|vmware)"'
op|')'
newline|'\n'
DECL|variable|oslo_namespace_imports_2
name|'oslo_namespace_imports_2'
op|'='
name|'re'
op|'.'
name|'compile'
op|'('
string|'r"from[\\s]*oslo[\\s]*import[\\s]*"'
nl|'\n'
string|'r"(concurrency|config|context|db|i18n|"'
nl|'\n'
string|'r"log|messaging|middleware|rootwrap|"'
...
op|')'
newline|'\n'
DECL|variable|oslo_namespace_imports_3
name|'oslo_namespace_imports_3'
op|'='
name|'re'
op|'.'
name|'compile'
op|'('
string|'r"import[\\s]*oslo\\."'
nl|'\n'
string|'r"(concurrency|config|context|db|i18n|"'
nl|'\n'
string|'r"log|messaging|middleware|rootwrap|"'
...
op|'='
op|'('
string|'"N333: \'module %s should not be imported "'
nl|'\n'
string|'"from oslo namespace."'
op|')'
op|'%'
name|'match'
op|'.'
