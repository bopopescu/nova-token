...
op|')'
newline|'\n'
DECL|variable|greenthread_spawn_re
name|'greenthread_spawn_re'
op|'='
name|'re'
op|'.'
name|'compile'
op|'('
string|'r".*greenthread.spawn\\(.*\\)"'
op|')'
newline|'\n'
DECL|variable|greenthread_spawn_n_re
name|'greenthread_spawn_n_re'
op|'='
name|'re'
op|'.'
name|'compile'
op|'('
string|'r".*greenthread.spawn_n\\(.*\\)"'
op|')'
newline|'\n'
nl|'\n'
nl|'\n'
...
newline|'\n'
indent|'    '
string|'"""Check for use of greenthread.spawn() and greenthread.spawn_n()\n\n    N340\n    """'
newline|'\n'
name|'msg'
op|'='
op|'('
