...
nl|'\n'
comment|"# NOTE(sbauza): We're lazily loading the compute_node field here but"
nl|'\n'
comment|'# we will change that later to get the ComputeNode object by using'
nl|'\n'
comment|'# the Service host field'
nl|'\n'
name|'compute_ref'
op|'='
name|'service_ref'
