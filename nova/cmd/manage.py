...
op|'='
op|'('
string|"'DEPRECATED: Use the nova flavor-* commands from '"
nl|'\n'
string|"'python-novaclient instead. The flavor subcommand will be '"
nl|'\n'
string|"'removed in the 2015.1 release'"
op|')'
newline|'\n'
nl|'\n'
DECL|member|_print_flavors
name|'def'
name|'_print_flavors'
op|'('
name|'self'
...
name|'_'
op|'('
string|'"Must supply valid parameters to create flavor"'
op|')'
op|')'
newline|'\n'
name|'print'
...
name|'_'
op|'('
string|'"Please ensure flavor name and flavorid are "'
nl|'\n'
string|'"unique."'
op|')'
op|')'
...
name|'_'
op|'('
string|'"Currently defined flavor names and flavorids:"'
op|')'
op|')'
newline|'\n'
name|'print'
...
newline|'\n'
indent|'        '
string|'"""Marks flavors as deleted."""'
newline|'\n'
name|'try'
op|':'
newline|'\n'
...
name|'_'
op|'('
string|'"Valid flavor name is required"'
op|')'
op|')'
newline|'\n'
name|'return'
...
newline|'\n'
indent|'        '
string|'"""Lists all active or specific flavors."""'
newline|'\n'
name|'try'
op|':'
newline|'\n'
...
newline|'\n'
indent|'        '
string|'"""Add key/value pair to specified flavor\'s extra_specs."""'
newline|'\n'
name|'try'
op|':'
newline|'\n'
...
newline|'\n'
indent|'        '
string|'"""Delete the specified extra spec for flavor."""'
newline|'\n'
name|'try'
op|':'
newline|'\n'
...
name|'_'
op|'('
string|'"Key %(key)s on flavor %(name)s unset"'
op|')'
op|'%'
nl|'\n'
op|'{'
