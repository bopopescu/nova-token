...
name|'_'
op|'('
string|"'max rows must be <= %(max_value)d'"
op|')'
op|'%'
nl|'\n'
op|'{'
...
name|'_'
op|'('
string|'"Error attempting to run %(method)s"'
op|')'
op|'%'
name|'dict'
op|'('
...
name|'_'
op|'('
string|"'%(total)i rows matched query %(meth)s, %(done)i '"
nl|'\n'
string|"'migrated'"
op|')'
op|'%'
...
name|'help'
op|'='
string|"'Maximum number of objects to consider'"
op|')'
newline|'\n'
DECL|member|online_data_migrations
name|'def'
...
name|'_'
op|'('
string|"'Must supply a positive value for max_number'"
op|')'
op|')'
newline|'\n'
name|'return'
...
name|'_'
op|'('
string|"'Running batches of %i until complete'"
op|')'
op|'%'
name|'max_count'
op|')'
...
name|'help'
op|'='
string|"'The database connection url for cell0. '"
nl|'\n'
string|"'This is optional. If not provided, a standard database '"
nl|'\n'
string|"'connection will be used based on the API database connection '"
nl|'\n'
string|"'from the Nova configuration.'"
nl|'\n'
op|')'
newline|'\n'
DECL|member|map_cell0
name|'def'
name|'map_cell0'
op|'('
name|'self'
...
newline|'\n'
indent|'        '
string|'"""Create a cell mapping for cell0.\n\n        cell0 is used for instances that have not been scheduled to any cell.\n        This generally applies to instances that have encountered an error\n        before they have been scheduled.\n\n        This command creates a cell mapping for this special cell which\n        requires a database to store the instance data.\n        """'
newline|'\n'
DECL|function|cell0_default_connection
name|'def'
name|'cell0_default_connection'
op|'('
op|')'
op|':'
newline|'\n'
comment|'# If no database connection is provided one is generated'
nl|'\n'
comment|'# based on the API database connection url.'
nl|'\n'
comment|'# The cell0 database will use the same database scheme and'
nl|'\n'
comment|'# netloc as the API database, with a related path.'
nl|'\n'
indent|'            '
name|'scheme'
op|','
...
op|')'
newline|'\n'
comment|"# A transport url of 'none://' is provided for cell0. RPC should not"
nl|'\n'
comment|'# be used to access cell0 objects. Cells transport switching will'
nl|'\n'
comment|"# ignore any 'none' transport type."
nl|'\n'
name|'cell_mapping'
op|'='
name|'objects'
...
name|'help'
op|'='
string|"'Unmigrated instances will be mapped to the cell with the '"
nl|'\n'
string|"'uuid provided.'"
op|')'
newline|'\n'
op|'@'
name|'args'
...
op|')'
newline|'\n'
comment|'# Validate the cell exists'
nl|'\n'
name|'cell_mapping'
op|'='
name|'objects'
...
newline|'\n'
nl|'\n'
comment|'# TODO(melwitt): Remove this when the oslo.messaging function'
nl|'\n'
comment|'# for assembling a transport url from ConfigOpts is available'
nl|'\n'
dedent|''
dedent|''
op|'@'
...
name|'help'
op|'='
string|"'The transport url for the cell message queue'"
op|')'
newline|'\n'
op|'@'
name|'args'
...
name|'help'
op|'='
string|"'Return and output the uuid of the created cell'"
op|')'
newline|'\n'
DECL|member|map_cell_and_hosts
name|'def'
...
name|'None'
newline|'\n'
comment|'# First, try to detect if a CellMapping has already been created'
nl|'\n'
name|'compute_nodes'
op|'='
name|'objects'
...
op|'('
nl|'\n'
string|"'Host %(host)s is already mapped to cell %(uuid)s'"
nl|'\n'
op|')'
op|'%'
op|'{'
...
op|')'
newline|'\n'
comment|'# Re-using the existing UUID in case there is already a mapping'
nl|'\n'
comment|'# NOTE(sbauza): There could be possibly multiple CellMappings'
nl|'\n'
comment|'# if the operator provides another configuration file and moves'
nl|'\n'
comment|"# the hosts to another cell v2, but that's not really something"
nl|'\n'
comment|'# we should support.'
nl|'\n'
dedent|''
name|'cell_mapping_uuid'
op|'='
...
op|')'
newline|'\n'
comment|'# Create the cell mapping in the API database'
nl|'\n'
dedent|''
name|'if'
name|'cell_mapping_uuid'
...
op|')'
newline|'\n'
comment|'# Pull the hosts from the cell database and create the host mappings'
nl|'\n'
dedent|''
name|'for'
name|'compute_node'
