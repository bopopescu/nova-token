...
name|'help'
op|'='
string|"'Print SQL statements instead of executing'"
op|')'
newline|'\n'
DECL|member|expand
name|'def'
...
name|'args'
op|'('
string|"'--force-experimental-contract'"
op|','
name|'action'
op|'='
string|"'store_true'"
...
name|'dest'
op|'='
string|"'force_experimental_contract'"
op|','
nl|'\n'
name|'help'
op|'='
string|'"Force experimental contract operation to run *VOLATILE*"'
op|')'
newline|'\n'
DECL|member|contract
name|'def'
name|'contract'
op|'('
name|'self'
...
name|'dry_run'
op|','
name|'force_experimental_contract'
op|'='
name|'False'
op|')'
op|':'
...
name|'print'
op|'('
string|'\'The "contract" command is experimental and potentially \''
nl|'\n'
string|"'dangerous. As such, it is disabled by default. Enable using '"
nl|'\n'
string|'\'"--force-experimental".\''
op|')'
newline|'\n'
nl|'\n'
DECL|member|version
...
name|'help'
op|'='
string|"'Maximum number of instances to consider'"
op|')'
newline|'\n'
op|'@'
name|'args'
...
name|'help'
op|'='
string|"'Force instances to migrate (even if they may be performing '"
nl|'\n'
string|"'another operation). Warning, this is potentially dangerous.'"
op|')'
newline|'\n'
DECL|member|migrate_flavor_data
name|'def'
