...
nl|'\n'
string|"'%(user_id)s %(project_id)s] %(message)s'"
op|','
nl|'\n'
DECL|variable|help
name|'help'
...
newline|'\n'
nl|'\n'
comment|'#NOTE(ameade): The following calls to _log must be maintained as direct'
nl|'\n'
comment|'#calls. _log introspects the call stack to get information such as the'
nl|'\n'
comment|'#filename and line number the logging method was called from.'
nl|'\n'
nl|'\n'
DECL|member|log
dedent|''
...
newline|'\n'
indent|'    '
string|'"""Shortcut for logging to root log with severity \'AUDIT\'."""'
newline|'\n'
name|'logging'
op|'.'
name|'root'
