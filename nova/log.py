...
nl|'\n'
nl|'\n'
DECL|function|_get_level_from_flags
dedent|''
name|'def'
...
op|')'
newline|'\n'
DECL|variable|_filelog
name|'_filelog'
op|'='
name|'None'
newline|'\n'
DECL|variable|_streamlog
name|'_streamlog'
op|'='
name|'StreamHandler'
op|'('
...
name|'self'
op|'.'
name|'_setup_from_flags'
op|'('
op|')'
newline|'\n'
nl|'\n'
DECL|member|_setup_from_flags
dedent|''
dedent|''
name|'def'
name|'_setup_from_flags'
...
newline|'\n'
indent|'        '
string|'"""Reset level after flags have been loaded"""'
newline|'\n'
name|'if'
name|'not'
name|'self'
