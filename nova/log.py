...
name|'flags'
newline|'\n'
comment|'# TODO(todd): fix after version.py merge'
nl|'\n'
comment|'# from nova import version'
nl|'\n'
nl|'\n'
nl|'\n'
DECL|variable|FLAGS
...
comment|'# TODO(todd): fix after version.py merge'
nl|'\n'
comment|"# '(%(name)s %(nova_version)s): %(levelname)s '"
nl|'\n'
name|'flags'
op|'.'
name|'DEFINE_string'
...
comment|'# TODO(todd): fix after version.py merge'
nl|'\n'
comment|"# '(%(name)s %(nova_version)s): %(levelname)s [N/A] '"
nl|'\n'
name|'flags'
op|'.'
name|'DEFINE_string'
...
comment|'# TODO(todd): fix after version.py merge'
nl|'\n'
comment|'#extra.update({"nova_version": version.string_with_vcs()})'
nl|'\n'
dedent|''
name|'logging'
op|'.'
