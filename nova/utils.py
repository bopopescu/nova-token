...
op|':'
newline|'\n'
comment|'# using non-blocking version since green threads are not'
nl|'\n'
comment|'# patched to deal with blocking fcntl calls'
nl|'\n'
indent|'                '
name|'fcntl'
op|'.'
...
name|'_'
op|'('
string|'"Could not release the aquired lock `%s`"'
op|')'
nl|'\n'
op|'%'
name|'self'
