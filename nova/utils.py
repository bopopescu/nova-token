...
newline|'\n'
indent|'    '
string|'"""A looping call which happens at a fixed interval."""'
newline|'\n'
nl|'\n'
DECL|member|start
name|'def'
...
newline|'\n'
indent|'    '
string|'"""A looping call which happens sleeps until the next known event.\n\n    The function called should return how long to sleep for before being\n    called again.\n    """'
newline|'\n'
nl|'\n'
DECL|member|start
name|'def'
...
name|'_'
op|'('
string|"'Periodic task processor sleeping for %.02f '"
nl|'\n'
string|"'seconds'"
op|')'
op|','
...
newline|'\n'
indent|'    '
string|'"""Try to turn a string into a number of bytes. Looks at the last\n    characters of the text to determine what conversion is needed to\n    turn the input text into a byte number.\n\n    Supports: B/b, K/k, M/m, G/g, T/t (or the same with b/B on the end)\n\n    """'
newline|'\n'
comment|"# Take off everything not number 'like' (which should leave"
nl|'\n'
comment|"# only the byte 'identifier' left)"
nl|'\n'
name|'mult_key_org'
op|'='
name|'text'
...
op|':'
newline|'\n'
comment|"# Empty cases shouldn't cause text[0:-0]"
nl|'\n'
indent|'            '
name|'text'
op|'='
...
newline|'\n'
indent|'    '
string|'"""Returns the IP version of a network (IPv4 or IPv6). Raises\n    AddrFormatError if invalid network."""'
newline|'\n'
name|'if'
name|'netaddr'
op|'.'
...
name|'_'
op|'('
string|'"%(name)s has less than %(min_length)s "'
nl|'\n'
string|'"characters."'
op|')'
op|'%'
