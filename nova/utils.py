...
op|':'
newline|'\n'
comment|'# Class member variables not supported.'
nl|'\n'
indent|'        '
name|'return'
name|'to_primitive'
...
newline|'\n'
indent|'    '
string|'"""For our purposes, a UUID is a string in canoical form:\n\n        aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa\n    """'
newline|'\n'
name|'if'
name|'not'
name|'isinstance'
...
newline|'\n'
indent|'    '
string|'"""Provides environment bootstrapping capabilities for entry points."""'
newline|'\n'
nl|'\n'
op|'@'
name|'staticmethod'
newline|'\n'
DECL|member|bootstrap_binary
name|'def'
...
newline|'\n'
indent|'        '
string|'"""Initialize the Nova environment using command line arguments."""'
newline|'\n'
name|'Bootstrapper'
op|'.'
name|'setup_flags'
...
newline|'\n'
indent|'        '
string|'"""Initialize logging and log a message indicating the Nova version."""'
newline|'\n'
name|'logging'
op|'.'
name|'setup'
...
newline|'\n'
indent|'        '
string|'"""Initialize flags, load flag file, and print help if needed."""'
newline|'\n'
name|'default_flagfile'
op|'('
name|'args'
...
newline|'\n'
indent|'        '
string|'"""Log the list of all active flags being used."""'
newline|'\n'
name|'logging'
op|'.'
name|'audit'
