...
name|'condition'
op|'='
string|'"\\s+inet6\\s+addr:\\s+([0-9a-f:]+/\\d+)\\s+Scope:Link"'
newline|'\n'
name|'links'
op|'='
op|'['
...
name|'_'
op|'('
string|'"Couldn\'t parse command from get Link Local IP of %s :%s"'
op|')'
op|','
name|'interface'
op|','
...
name|'_'
op|'('
string|'"Couldn\'t execute command to get Link Local IP of %s :%s"'
op|')'
op|','
name|'interface'
op|','
