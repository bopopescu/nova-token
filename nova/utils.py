...
name|'_'
op|'('
string|"'The root_helper option (which lets you specify a '"
nl|'\n'
string|"'root wrapper different from nova-rootwrap, and '"
nl|'\n'
string|"'defaults to using sudo) is now deprecated. You '"
nl|'\n'
string|"'should use the rootwrap_config option instead.'"
op|')'
op|')'
newline|'\n'
nl|'\n'
...
nl|'\n'
nl|'\n'
DECL|function|sys_platform_translate
dedent|''
name|'def'
...
newline|'\n'
indent|'    '
string|'"""Translate cpu architecture into supported platforms."""'
newline|'\n'
name|'if'
op|'('
name|'arch'
