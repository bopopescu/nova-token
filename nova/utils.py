...
op|')'
newline|'\n'
comment|'#exit_code = subprocess.call(cmd.split(" "))'
nl|'\n'
comment|'#logging.debug(prompt % (exit_code))'
nl|'\n'
comment|'#if check_exit_code and exit_code != 0:'
nl|'\n'
comment|'#    raise ProcessExecutionError(exit_code=exit_code,'
nl|'\n'
comment|'#                                stdout=None,'
nl|'\n'
comment|'#                                stderr=None,'
