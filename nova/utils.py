...
op|':'
newline|'\n'
comment|'#modified by masumotok'
nl|'\n'
comment|"#characters = '01234567890abcdefghijklmnopqrstuvwxyz'"
nl|'\n'
comment|'#choices = [random.choice(characters) for x in xrange(size)]'
nl|'\n'
comment|"#return '%s-%s' % (topic, ''.join(choices))"
nl|'\n'
indent|'    '
name|'if'
name|'topic'
