...
newline|'\n'
indent|'    '
string|'"""Return two dicts, one containing only `keys` the other containing\n    everything but `keys`\n    """'
newline|'\n'
name|'intersection'
op|'='
op|'{'
...
newline|'\n'
indent|'    '
string|'"""Return a dictionary in which the dictionaries keys are mapped to\n    new keys.\n    """'
newline|'\n'
name|'mapped'
op|'='
op|'{'
...
nl|'\n'
nl|'\n'
DECL|function|get_secondary_server_string
dedent|''
name|'def'
...
newline|'\n'
indent|'    '
string|'"""Returns host part only of the given server_string if it\'s a combination\n    of host part and port. Otherwise, return null string."""'
newline|'\n'
nl|'\n'
