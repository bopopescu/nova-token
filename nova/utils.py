...
name|'_'
op|'('
string|"'The root_helper option (which lets you specify '"
nl|'\n'
string|"'a root wrapper different from nova-rootwrap, '"
nl|'\n'
string|"'and defaults to using sudo) is now deprecated. '"
nl|'\n'
string|"'You should use the rootwrap_config option '"
nl|'\n'
string|"'instead.'"
op|')'
op|')'
