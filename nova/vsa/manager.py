...
name|'_'
op|'('
string|'"VSA ID %(vsa_id)s: Drive %(vol_id)s created. "'
nl|'\n'
...
name|'_'
op|'('
string|'"Drive %(vol_name)s (%(vol_disp_name)s) still "'
nl|'\n'
...
name|'_'
op|'('
string|'"VSA ID %(vsa_id)d: Drive %(vol_name)s "'
nl|'\n'
