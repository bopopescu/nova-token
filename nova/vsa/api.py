...
newline|'\n'
nl|'\n'
comment|'# find DB record for this disk'
nl|'\n'
dedent|''
name|'try'
op|':'
...
op|':'
newline|'\n'
comment|'# VP-TODO: potentialy may conflict with previous volumes'
nl|'\n'
indent|'                '
name|'volume_name'
op|'='
...
name|'_'
op|'('
string|'"Adding %(add_cnt)d VCs to VSA %(vsa_name)s."'
op|')'
op|','
nl|'\n'
name|'locals'
...
name|'_'
op|'('
string|'"Deleting %(add_cnt)d VCs from VSA %(vsa_name)s."'
op|')'
op|','
nl|'\n'
name|'locals'
...
op|':'
newline|'\n'
comment|'# Volume not yet assigned to host'
nl|'\n'
...
name|'_'
op|'('
string|'"VSA ID %(vsa_id)s: Deleting BE volume "'
string|'"%(vol_name)s"'
op|')'
op|','
name|'locals'
...
name|'_'
op|'('
string|'"VSA ID %(vsa_id)s: Forced delete. BE volume "'
string|'"%(vol_name)s"'
op|')'
op|','
name|'locals'
...
newline|'\n'
nl|'\n'
comment|'# allow deletion of volumes in "abnormal" state'
nl|'\n'
nl|'\n'
comment|'# Delete all FE volumes'
nl|'\n'
name|'fe_volumes'
op|'='
name|'self'
...
name|'_'
op|'('
string|'"VSA ID %(vsa_id)s: Deleting FE volume "'
string|'"%(vol_name)s"'
op|')'
op|','
name|'locals'
...
newline|'\n'
nl|'\n'
DECL|member|generate_user_data
dedent|''
name|'def'
