...
name|'_'
op|'('
string|'"Unauthorized attempt to get object %s from bucket "'
nl|'\n'
string|'"%s"'
op|')'
op|','
...
name|'_'
op|'('
string|'"Unauthorized attempt to upload object %s to bucket "'
nl|'\n'
string|'"%s"'
op|')'
op|','
...
name|'_'
op|'('
string|'"Unauthorized attempt to delete object "'
nl|'\n'
string|'"%(object)s from bucket %(bucket)s"'
op|')'
op|'%'
nl|'\n'
op|'{'
...
name|'_'
op|'('
string|'"Toggling publicity flag of image %s %r"'
op|')'
op|','
name|'image_id'
op|','
