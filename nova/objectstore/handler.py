...
name|'debug'
op|'('
string|'"not authorized for handle_POST in images"'
op|')'
newline|'\n'
name|'raise'
name|'exception'
...
op|':'
newline|'\n'
comment|'# field implies user field editing (value can be blank)'
nl|'\n'
indent|'            '
name|'logging'
op|'.'
...
name|'debug'
op|'('
string|'"unknown action for handle_POST in images"'
op|')'
newline|'\n'
nl|'\n'
dedent|''
