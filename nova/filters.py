...
nl|'\n'
comment|'# NOTE(sbauza): Since the Cells scheduler still provides a legacy'
nl|'\n'
comment|'# dictionary for filter_props, and since we agreed on not modifying'
nl|'\n'
comment|'# the Cells scheduler to support that because of Cells v2, we'
nl|'\n'
comment|'# prefer to define a compatible way to address both types'
nl|'\n'
indent|'            '
name|'if'
name|'isinstance'
