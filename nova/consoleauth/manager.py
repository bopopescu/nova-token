...
nl|'\n'
nl|'\n'
DECL|class|_ConsoleAuthManagerV2Proxy
dedent|''
dedent|''
name|'class'
name|'_ConsoleAuthManagerV2Proxy'
...
op|':'
newline|'\n'
comment|'# Notes for changes since 1.X'
nl|'\n'
comment|'# - removed get_backdoor_port()'
nl|'\n'
comment|'# - instance_uuid required for authorize_console()'
nl|'\n'
nl|'\n'
DECL|variable|RPC_API_VERSION
indent|'    '
