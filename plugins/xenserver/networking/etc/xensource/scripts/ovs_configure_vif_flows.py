...
nl|'\n'
string|'"arp_sha=%(VIF_MAC)s,nw_src=%(VIF_IPv4)s,actions=normal"'
op|')'
newline|'\n'
nl|'\n'
name|'ovs'
...
string|'"priority=3,in_port=%(VIF_OFPORT)s,dl_src=%(VIF_MAC)s,arp,"'
nl|'\n'
string|'"arp_sha=%(VIF_MAC)s,nw_src=0.0.0.0,actions=normal"'
op|')'
newline|'\n'
nl|'\n'
...
nl|'\n'
string|'"nw_src=%(VIF_IPv4)s,actions=normal"'
op|')'
newline|'\n'
nl|'\n'
nl|'\n'
...
string|'"priority=6,in_port=%(VIF_OFPORT)s,dl_src=%(VIF_MAC)s,icmp6,"'
nl|'\n'
string|'"ipv6_src=%(VIF_LOCAL_IPv6)s,icmp_type=135,actions=normal"'
op|')'
newline|'\n'
name|'ovs'
op|'.'
...
string|'"priority=6,in_port=%(VIF_OFPORT)s,dl_src=%(VIF_MAC)s,icmp6,"'
nl|'\n'
string|'"ipv6_src=%(VIF_GLOBAL_IPv6)s,icmp_type=135,actions=normal"'
op|')'
newline|'\n'
nl|'\n'
...
nl|'\n'
string|'"nd_target=%(VIF_LOCAL_IPv6)s,actions=normal"'
op|')'
newline|'\n'
name|'ovs'
op|'.'
...
string|'"priority=6,in_port=%(VIF_OFPORT)s,dl_src=%(VIF_MAC)s,icmp6,"'
nl|'\n'
string|'"ipv6_src=%(VIF_LOCAL_IPv6)s,icmp_type=136,actions=normal"'
op|')'
newline|'\n'
name|'ovs'
op|'.'
...
nl|'\n'
string|'"nd_target=%(VIF_GLOBAL_IPv6)s,actions=normal"'
op|')'
newline|'\n'
name|'ovs'
op|'.'
...
string|'"priority=6,in_port=%(VIF_OFPORT)s,dl_src=%(VIF_MAC)s,icmp6,"'
nl|'\n'
string|'"ipv6_src=%(VIF_GLOBAL_IPv6)s,icmp_type=136,actions=normal"'
op|')'
newline|'\n'
nl|'\n'
...
name|'add'
op|'('
string|'"priority=5,in_port=%(VIF_OFPORT)s,icmp6,icmp_type=135,actions=drop"'
op|')'
newline|'\n'
name|'ovs'
op|'.'
name|'add'
op|'('
string|'"priority=5,in_port=%(VIF_OFPORT)s,icmp6,icmp_type=136,actions=drop"'
op|')'
newline|'\n'
nl|'\n'
...
name|'add'
op|'('
string|'"priority=5,in_port=%(VIF_OFPORT)s,icmp6,icmp_type=134,actions=drop"'
op|')'
newline|'\n'
...
name|'add'
op|'('
string|'"priority=5,in_port=%(VIF_OFPORT)s,icmp6,icmp_type=137,actions=drop"'
op|')'
newline|'\n'
...
name|'add'
op|'('
string|'"priority=5,in_port=%(VIF_OFPORT)s,icmp6,icmp_type=146,actions=drop"'
op|')'
newline|'\n'
...
name|'add'
op|'('
string|'"priority=5,in_port=%(VIF_OFPORT)s,icmp6,icmp_type=147,actions=drop"'
op|')'
newline|'\n'
...
name|'add'
op|'('
string|'"priority=5,in_port=%(VIF_OFPORT)s,icmp6,icmp_type=151,actions=drop"'
op|')'
newline|'\n'
...
name|'add'
op|'('
string|'"priority=5,in_port=%(VIF_OFPORT)s,icmp6,icmp_type=152,actions=drop"'
op|')'
newline|'\n'
...
name|'add'
op|'('
string|'"priority=5,in_port=%(VIF_OFPORT)s,icmp6,icmp_type=153,actions=drop"'
op|')'
newline|'\n'
nl|'\n'
...
nl|'\n'
string|'"ipv6_src=%(VIF_GLOBAL_IPv6)s,icmp6,actions=normal"'
op|')'
newline|'\n'
name|'ovs'
op|'.'
...
string|'"priority=4,in_port=%(VIF_OFPORT)s,dl_src=%(VIF_MAC)s,"'
nl|'\n'
string|'"ipv6_src=%(VIF_LOCAL_IPv6)s,icmp6,actions=normal"'
op|')'
newline|'\n'
name|'ovs'
op|'.'
...
string|'"priority=4,in_port=%(VIF_OFPORT)s,dl_src=%(VIF_MAC)s,"'
nl|'\n'
string|'"ipv6_src=%(VIF_GLOBAL_IPv6)s,tcp6,actions=normal"'
op|')'
newline|'\n'
name|'ovs'
op|'.'
...
string|'"priority=4,in_port=%(VIF_OFPORT)s,dl_src=%(VIF_MAC)s,"'
nl|'\n'
string|'"ipv6_src=%(VIF_LOCAL_IPv6)s,tcp6,actions=normal"'
op|')'
newline|'\n'
name|'ovs'
op|'.'
...
string|'"priority=4,in_port=%(VIF_OFPORT)s,dl_src=%(VIF_MAC)s,"'
nl|'\n'
string|'"ipv6_src=%(VIF_GLOBAL_IPv6)s,udp6,actions=normal"'
op|')'
newline|'\n'
name|'ovs'
op|'.'
...
string|'"priority=4,in_port=%(VIF_OFPORT)s,dl_src=%(VIF_MAC)s,"'
nl|'\n'
string|'"ipv6_src=%(VIF_LOCAL_IPv6)s,udp6,actions=normal"'
op|')'
newline|'\n'
