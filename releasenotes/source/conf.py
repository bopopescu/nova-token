...
comment|'#'
nl|'\n'
comment|'# Nova Release Notes documentation build configuration file, created by'
nl|'\n'
comment|'# sphinx-quickstart on Thu Nov  5 11:50:32 2015.'
nl|'\n'
comment|'#'
nl|'\n'
comment|'# This file is execfile()d with the current directory set to its'
nl|'\n'
comment|'# containing dir.'
nl|'\n'
comment|'#'
nl|'\n'
...
name|'project'
op|'='
string|"u'Nova Release Notes'"
newline|'\n'
DECL|variable|copyright
name|'copyright'
op|'='
string|"u'2015, Nova developers'"
newline|'\n'
nl|'\n'
...
string|"'index'"
op|','
string|"'NovaReleaseNotes.tex'"
op|','
string|"u'Nova Release Notes Documentation'"
op|','
nl|'\n'
string|"u'Nova developers'"
op|','
string|"'manual'"
op|')'
op|','
...
string|"'NovaReleaseNotes'"
op|','
string|"'One line description of project.'"
op|','
nl|'\n'
