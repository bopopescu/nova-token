...
newline|'\n'
indent|'    '
string|'r"""Check for import module only.\n\n    nova HACKING guide recommends importing only modules:\n    Do not import objects, only modules\n\n    Okay: from os import path\n    Okay: import os.path\n    N302: from os.path import dirname as dirname2\n    N303  from os.path import *\n    N304  import flakes\n    """'
newline|'\n'
comment|'# N302 import only modules'
nl|'\n'
comment|'# N303 Invalid Import'
nl|'\n'
comment|'# N304 Relative Import'
nl|'\n'
nl|'\n'
comment|'# TODO(sdague) actually get these tests working'
nl|'\n'
comment|'# TODO(jogo) simplify this code'
nl|'\n'
DECL|function|import_module_check
name|'def'
name|'import_module_check'
op|'('
name|'mod'
op|','
name|'parent'
...
op|':'
newline|'\n'
comment|'# TODO(jogo): handle "from x import *, by checking all'
nl|'\n'
comment|'#           "objects in x"'
nl|'\n'
indent|'                '
name|'return'
newline|'\n'
...
nl|'\n'
nl|'\n'
DECL|function|in_docstring_position
dedent|''
dedent|''
dedent|''
name|'def'
name|'in_docstring_position'
op|'('
name|'previous_logical'
op|')'
op|':'
...
newline|'\n'
indent|'    '
string|'r"""Check that we only use newlines not cariage returns.\n\n    Okay: import os\\nimport sys\n    # pep8 doesn\'t yet replace \\r in strings, will work on an\n    # upstream fix\n    N901 import os\\r\\nimport sys\n    """'
newline|'\n'
name|'pos'
op|'='
name|'physical_line'
