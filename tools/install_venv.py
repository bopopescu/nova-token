...
newline|'\n'
nl|'\n'
DECL|member|install_m2crypto
dedent|''
name|'def'
name|'install_m2crypto'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
indent|'    '
string|'"""Oneiric specific installation steps"""'
newline|'\n'
nl|'\n'
DECL|member|install_m2crypto
name|'def'
...
newline|'\n'
name|'print'
string|'"Attempting to install \'python-m2crypto\' via apt-get"'
newline|'\n'
name|'run_command'
op|'('
op|'['
...
comment|'#'
nl|'\n'
comment|'# pip install M2Crypto fails on Fedora because of'
nl|'\n'
comment|'# weird differences with OpenSSL headers'
nl|'\n'
comment|'#'
nl|'\n'
DECL|member|install_m2crypto
