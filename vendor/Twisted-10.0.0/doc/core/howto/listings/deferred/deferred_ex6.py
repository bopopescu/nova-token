...
newline|'\n'
nl|'\n'
DECL|function|noDecisionPassthru
dedent|''
name|'def'
name|'noDecisionPassthru'
op|'('
name|'result'
op|')'
op|':'
...
newline|'\n'
name|'print'
string|'"\\t*doh*! a failure! don\'t know what to do, returning failure!"'
newline|'\n'
name|'return'
name|'result'
newline|'\n'
...
newline|'\n'
nl|'\n'
comment|'# noDecisionPassthru will be called'
nl|'\n'
name|'d'
op|'.'
name|'addCallbacks'
