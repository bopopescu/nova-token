...
newline|'\n'
nl|'\n'
DECL|function|doThisNoMatterWhat
dedent|''
name|'def'
name|'doThisNoMatterWhat'
op|'('
name|'arg'
op|')'
op|':'
...
newline|'\n'
name|'print'
string|'"\\tdoing something very important"'
newline|'\n'
comment|'# we pass the argument we received to the next phase here'
nl|'\n'
name|'return'
name|'arg'
newline|'\n'
...
nl|'\n'
nl|'\n'
comment|'# ---- this is equivalent to addBoth(doThisNoMatterWhat)'
nl|'\n'
nl|'\n'
dedent|''
name|'if'
