...
op|':'
newline|'\n'
comment|'# Unfortunately, not all errors which result in a reactor'
nl|'\n'
comment|'# being unusable are detectable without actually'
nl|'\n'
comment|'# instantiating the reactor.  So we catch some more here'
nl|'\n'
comment|'# and skip the test if necessary.  We also log it to aid'
nl|'\n'
comment|'# with debugging, but flush the logged error so the test'
nl|'\n'
...
name|'None'
op|','
string|'"Failed to install reactor"'
op|')'
newline|'\n'
name|'self'
op|'.'
