begin_unit
comment|'# -*- test-case-name: twisted.internet.test -*-'
nl|'\n'
...
op|':'
newline|'\n'
comment|'# Let the base class do its thing, but pygtk is probably'
nl|'\n'
comment|'# going to stomp on us so go beyond that and set up some'
nl|'\n'
comment|"# signal handling which pygtk won't mess with.  This would"
nl|'\n'
comment|'# be better done by letting this reactor select a'
nl|'\n'
comment|'# different implementation of installHandler for'
nl|'\n'
comment|'# _SIGCHLDWaker to use.  Then, at least, we could fall'
nl|'\n'
comment|'# back to our extension module.  See #4286.'
nl|'\n'
indent|'            '
name|'from'
name|'twisted'
...
op|')'
newline|'\n'
comment|'# Like the base, reap processes now in case a process'
nl|'\n'
comment|'# exited before the handlers above were installed.'
nl|'\n'
dedent|''
name|'_reapAllProcesses'
op|'('
