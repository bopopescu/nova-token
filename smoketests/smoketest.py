...
op|':'
newline|'\n'
comment|'# Wait for the volume to be reported to cloud'
nl|'\n'
nl|'\n'
indent|'        '
name|'time'
...
newline|'\n'
nl|'\n'
comment|'# fixme: test cannot delete attached volume!'
nl|'\n'
nl|'\n'
...
op|':'
newline|'\n'
comment|'# Wait for the instance to ACTUALLY have ssh running'
nl|'\n'
indent|'        '
name|'time'
op|'.'
