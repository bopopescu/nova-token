...
op|':'
newline|'\n'
comment|'# FIXME: registration should verify that bucket/manifest exists before returning successfully!'
nl|'\n'
indent|'        '
name|'kernel_id'
op|'='
...
nl|'\n'
comment|"#    self.assertRaises(paramiko.SSHException, self.connect_ssh, data['my_private_ip'], 'mykey')"
nl|'\n'
nl|'\n'
...
op|')'
newline|'\n'
comment|"# HACK: the tiny image doesn't create the node properly"
nl|'\n'
...
name|'exec_command'
op|'('
string|'\'grep %s /proc/partitions | `awk \\\'{print "mknod /dev/"$4" b "$1" "$2}\\\'`\''
op|'%'
name|'DEVICE'
op|')'
newline|'\n'
