...
comment|'#'
nl|'\n'
comment|'# This is mostly stolen from bzrlib.log.GnuChangelogLogFormatter'
nl|'\n'
comment|'# The difference is that it logs the author rather than the committer'
nl|'\n'
comment|'# which for Nova always is Tarmac.'
nl|'\n'
comment|'#'
nl|'\n'
